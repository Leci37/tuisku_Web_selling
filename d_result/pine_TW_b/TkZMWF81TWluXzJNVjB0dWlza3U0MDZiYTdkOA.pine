...
decision_tree_0_NFLX_5Min_406ba7d8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( VIP > 1.02868 )
		if( VIP_VIM <= -0.472353 )
			if( Negative_Money_Flow_Sum <= 5.39881e+06 )
				if( VIM <= 2.62625 )
					if( Positive_Money_Flow_Sum <= 4.38201e+06 )
						ret := 0.680672
					if( Positive_Money_Flow_Sum > 4.38201e+06 )
						ret := -0.019231
				if( VIM > 2.62625 )
					if( Typical_Price <= 414.175 )
						ret := 0.455556
					if( Typical_Price > 414.175 )
						ret := 0.155435
			if( Negative_Money_Flow_Sum > 5.39881e+06 )
				if( Negative_Money_Flow_Sum <= 6.99966e+06 )
					if( Typical_Price <= 551.448 )
						ret := 0.018868
					if( Typical_Price > 551.448 )
						ret := -0.500000
				if( Negative_Money_Flow_Sum > 6.99966e+06 )
					if( Negative_Money_Flow <= 3.73329e+07 )
						ret := 0.175084
					if( Negative_Money_Flow > 3.73329e+07 )
						ret := -0.434783
		if( VIP_VIM > -0.472353 )
			if( Negative_Money_Flow <= 5.82645e+07 )
				if( Negative_Money_Flow_Sum <= 7.1587e+07 )
					if( VIP_VIM <= 0.754045 )
						ret := 0.014801
					if( VIP_VIM > 0.754045 )
						ret := -0.158285
				if( Negative_Money_Flow_Sum > 7.1587e+07 )
					if( Negative_Money_Flow_Sum <= 1.29027e+08 )
						ret := 0.118604
					if( Negative_Money_Flow_Sum > 1.29027e+08 )
						ret := 0.021228
			if( Negative_Money_Flow > 5.82645e+07 )
				if( Negative_Money_Flow_Sum <= 8.37167e+07 )
					if( Positive_Money_Flow_Sum <= 2.544e+06 )
						ret := 0.666667
					if( Positive_Money_Flow_Sum > 2.544e+06 )
						ret := -0.800000 // sell
				if( Negative_Money_Flow_Sum > 8.37167e+07 )
					if( Positive_Money_Flow_Sum <= 5.81422e+08 )
						ret := 0.146667
					if( Positive_Money_Flow_Sum > 5.81422e+08 )
						ret := -0.501946
...
float op_operation = decision_tree_0_NFLX_5Min_406ba7d8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
