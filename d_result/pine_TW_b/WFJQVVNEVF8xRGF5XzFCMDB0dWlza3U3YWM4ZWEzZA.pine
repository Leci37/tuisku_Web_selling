		...
		if( bullPower <= 0.073297 )
			if( bbm <= 0.00797 )
				...
				if( bbp > 0.001323 )
					ret := 0.780488 // buy
			if( bbm > 0.00797 )
				if( bullPower <= 0.020036 )
					if( bullPower <= 0.00089 )
						ret := 0.156716
					if( bullPower > 0.00089 )
						ret := -0.083756
				if( bullPower > 0.020036 )
					if( bearPower <= -0.015143 )
						ret := -0.032258
					if( bearPower > -0.015143 )
						ret := 0.233553
		if( bullPower > 0.073297 )
			if( bearPower <= 0.076733 )
				if( bearPower <= 0.043742 )
					if( bbm <= 0.179412 )
						ret := 0.039216
					if( bbm > 0.179412 )
						ret := -0.837838 // sell
				if( bearPower > 0.043742 )
					if( bullPower <= 0.160704 )
						ret := -0.855263 // sell
					if( bullPower > 0.160704 )
						ret := -0.523810
			if( bearPower > 0.076733 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_7ac8ea3d(bbp, bullPower, BBPower_Color, bearPower, bbm)
