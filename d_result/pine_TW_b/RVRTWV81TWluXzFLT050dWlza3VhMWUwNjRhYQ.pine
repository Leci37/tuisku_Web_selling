			...
			if( marron_mean > 6.65275 )
				...
				if( pvimax > -0.119421 )
					...
					if( pvi > 0.236475 )
						ret := -0.295775
	if( marron > 3.67675 )
		if( media_azul <= -0.8309 )
			if( marron <= 18.332 )
				if( tprice <= 70.387 )
					if( azul_mean <= 8.45297 )
						ret := -0.121212
					if( azul_mean > 8.45297 )
						ret := 0.672727
				if( tprice > 70.387 )
					if( verde_mean <= -22.4884 )
						ret := -0.531915
					if( verde_mean > -22.4884 )
						ret := 0.276596
			if( marron > 18.332 )
				if( xrsi <= 54.8526 )
					if( media_azul <= -23.5995 )
						ret := 0.066456
					if( media_azul > -23.5995 )
						ret := -0.363636
				if( xrsi > 54.8526 )
					if( verde_azul <= 86.3324 )
						ret := -0.644110
					if( verde_azul > 86.3324 )
						ret := 0.466667
		if( media_azul > -0.8309 )
			if( media_azul <= 116.311 )
				if( verde_media <= 17.5968 )
					if( pvimin <= -0.383433 )
						ret := 0.312698
					if( pvimin > -0.383433 )
						ret := 0.007352
...
float op_operation = decision_tree_0_ETSY_5Min_a1e064aa(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
