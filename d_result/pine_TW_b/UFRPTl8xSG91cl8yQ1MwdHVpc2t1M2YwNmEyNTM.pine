				...
				if( rsi1 > 23.847 )
					...
					if( ad > 1375.35 )
						...
						if( ad_mf > 1560.19 )
							ret := -0.013448
		if( ad_mf > 15809.5 )
			if( smoothD_d <= 86.1781 )
				if( ad <= 17155.3 )
					if( ad <= 16209.1 )
						if( smoothK_k <= 58.1415 )
							ret := 0.586207
						if( smoothK_k > 58.1415 )
							ret := -0.750000 // sell
					if( ad > 16209.1 )
...
float op_operation = decision_tree_0_PTON_1Hour_3f06a253(mf, ad_mf, ad, d, d_k, smoothK_k, k, rsi1, smoothD_d)
