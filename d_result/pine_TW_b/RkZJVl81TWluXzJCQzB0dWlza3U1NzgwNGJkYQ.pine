...
decision_tree_0_FFIV_5Min_57804bda(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)=>
	...
	if( bullPower > 0.562767 )
		if( ad_mf <= 10101.1 )
			...
			if( ad_mf > -12304.9 )
				if( bearPower <= 1.061 )
					if( bearPower <= 0.927642 )
						if( bearPower <= -1.17805 )
							ret := 0.928571 // buy
						if( bearPower > -1.17805 )
							ret := -0.120392
					if( bearPower > 0.927642 )
						if( bearPower <= 1.01501 )
							ret := 0.711864 // buy
						if( bearPower > 1.01501 )
							ret := -0.090909
				if( bearPower > 1.061 )
					if( ad_mf <= 8572.8 )
						if( bullPower <= 2.74696 )
							ret := -0.297203
						if( bullPower > 2.74696 )
							ret := -0.871795 // sell
					if( ad_mf > 8572.8 )
...
float op_operation = decision_tree_0_FFIV_5Min_57804bda(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
