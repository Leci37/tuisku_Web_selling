...
decision_tree_0_ADBE_1Hour_e0895b1c(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( k <= 87.592 )
		...
		if( rsi1 > 11.5547 )
			...
			if( smoothK_k > 0.012584 )
				if( mf <= 0.182345 )
					if( ad_mf <= -1.61677e+06 )
						if( smoothD_d <= 71.0735 )
							ret := 0.958333 // buy
						if( smoothD_d > 71.0735 )
							ret := 0.750000 // buy
					if( ad_mf > -1.61677e+06 )
			...
			if( ad_mf > -177.663 )
				if( ad_mf <= -0.453164 )
					...
					if( smoothK_k > 95.3474 )
						ret := 0.000000
				if( ad_mf > -0.453164 )
					if( smoothD_d <= 87.0375 )
						if( smoothD_d <= 84.8022 )
							ret := -0.142857
						if( smoothD_d > 84.8022 )
							ret := 1.000000 // buy
					if( smoothD_d > 87.0375 )
...
float op_operation = decision_tree_0_ADBE_1Hour_e0895b1c(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)
