			...
			if( Negative_Money_Flow_Sum > 1.09209e+08 )
				...
				if( MFI_High > -43.4651 )
					...
					if( tema > 112.504 )
						ret := -0.675000
	if( ema12 > 0.264297 )
		if( Raw_Money_Flow <= 6.48918e+06 )
			if( Negative_Money_Flow_Sum <= 3.2787e+07 )
				if( MFI_Low <= 31.5422 )
					if( Typical_Price <= 113.393 )
						ret := -0.727273 // sell
					if( Typical_Price > 113.393 )
						if( tema <= 130.279 )
							ret := 0.493088
						if( tema > 130.279 )
							ret := -0.769231 // sell
				if( MFI_Low > 31.5422 )
					if( Negative_Money_Flow_Sum <= 2.10403e+07 )
						if( ema2 <= 125.027 )
							ret := -0.279618
						if( ema2 > 125.027 )
							ret := 0.000000
					if( Negative_Money_Flow_Sum > 2.10403e+07 )
						if( Positive_Money_Flow_Sum <= 4.12578e+07 )
							ret := -0.875000 // sell
						if( Positive_Money_Flow_Sum > 4.12578e+07 )
							ret := 0.982456 // buy
			if( Negative_Money_Flow_Sum > 3.2787e+07 )
				if( Negative_Money_Flow_Sum <= 8.90582e+07 )
					ret := -0.877193 // sell
				if( Negative_Money_Flow_Sum > 8.90582e+07 )
					ret := 0.103448
		if( Raw_Money_Flow > 6.48918e+06 )
			if( Money_Flow_Ratio <= 2.43945 )
				ret := -0.045455
			if( Money_Flow_Ratio > 2.43945 )
				ret := -0.854369 // sell
...
float op_operation = decision_tree_0_DDOG_1Min_dda88d47(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
