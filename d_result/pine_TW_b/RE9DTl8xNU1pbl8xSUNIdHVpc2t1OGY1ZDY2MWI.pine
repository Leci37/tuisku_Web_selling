		...
		if( tenkan_sen > 54.9742 )
			if( basis_max <= -0.476363 )
				...
				if( basis_max > -0.570861 )
					ret := 0.379747
			if( basis_max > -0.476363 )
				if( senkou_span_b_displaced <= 61.1784 )
					if( senkou_span_b <= 60.5011 )
						if( basis_minus <= -0.1547 )
							ret := -0.364780
						if( basis_minus > -0.1547 )
							ret := -0.680851
					if( senkou_span_b > 60.5011 )
				...
				if( senkou_span_b_displaced > 61.1784 )
					ret := -0.894410 // sell
	if( chinkou_span > 57.4127 )
		if( kinjun_sen <= 57.6587 )
			if( basis_minus <= 2.01477 )
				ret := 0.699588
			if( basis_minus > 2.01477 )
				ret := 0.020619
		if( kinjun_sen > 57.6587 )
			if( senkou_span_a_displaced <= 56.2693 )
				ret := -0.717647 // sell
			if( senkou_span_a_displaced > 56.2693 )
				if( basis_minus <= -2.10691 )
					if( basis_minus <= -3.09367 )
						if( senkou_span_a_displaced <= 75.7044 )
							ret := 0.648649
						if( senkou_span_a_displaced > 75.7044 )
							ret := -0.131474
					if( basis_minus > -3.09367 )
						if( basis_max <= 0.276629 )
							ret := -0.628959
						if( basis_max > 0.276629 )
							ret := -0.186667
				if( basis_minus > -2.10691 )
					if( senkou_span_a_displaced <= 129.846 )
						if( chinkou_span <= 111.273 )
							ret := 0.092210
						if( chinkou_span > 111.273 )
							ret := 0.409615
					if( senkou_span_a_displaced > 129.846 )
...
float op_operation = decision_tree_0_DOCN_15Min_8f5d661b(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
