...
decision_tree_0_GOOG_1Hour_155c19ab(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Positive_Money_Flow_Sum > 1.52429e+09 )
		...
		if( Short_Long_Diff > -55.6757 )
			if( Long_MA <= 94.633 )
				if( Money_Flow_Ratio <= 4.24619 )
					if( Short_MA <= 92.0145 )
						ret := -0.119403
					if( Short_MA > 92.0145 )
						ret := 0.339623
				if( Money_Flow_Ratio > 4.24619 )
					if( Negative_Money_Flow_Sum <= 4.85598e+06 )
						ret := 0.200000
					if( Negative_Money_Flow_Sum > 4.85598e+06 )
						ret := 0.761905 // buy
			if( Long_MA > 94.633 )
				if( Money_Flow_Ratio <= 0.489716 )
					if( Negative_Money_Flow_Sum <= 4.24197e+09 )
						ret := 0.523438
					if( Negative_Money_Flow_Sum > 4.24197e+09 )
						ret := 0.000000
				if( Money_Flow_Ratio > 0.489716 )
					if( Positive_Money_Flow_Sum <= 1.66705e+09 )
						ret := -0.209607
					if( Positive_Money_Flow_Sum > 1.66705e+09 )
						ret := -0.042588
...
float op_operation = decision_tree_0_GOOG_1Hour_155c19ab(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
