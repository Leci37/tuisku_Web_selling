			...
			if( Short_Long_Diff <= -6.30629 )
				...
				if( Short_Long_Diff > -8.80105 )
					...
					if( Short_MA > 115.658 )
						ret := 0.400000
			if( Short_Long_Diff > -6.30629 )
				if( Raw_Money_Flow <= 2.54669e+08 )
					if( Positive_Money_Flow <= 2.17685e+08 )
						ret := 0.928571 // buy
					if( Positive_Money_Flow > 2.17685e+08 )
						ret := 0.000000
				if( Raw_Money_Flow > 2.54669e+08 )
					if( Short_Long_Diff <= -2.4673 )
						ret := 0.685714
					if( Short_Long_Diff > -2.4673 )
						ret := -0.375000
		if( MFI_High > -48.0741 )
			if( Long_MA <= 297.711 )
				if( Short_Long_Diff <= -12.8425 )
					if( Typical_Price <= 187.309 )
						ret := 0.000000
					if( Typical_Price > 187.309 )
						ret := -0.983607 // sell
				if( Short_Long_Diff > -12.8425 )
					if( Negative_Money_Flow_Sum <= 2.53919e+09 )
						ret := -0.166304
					if( Negative_Money_Flow_Sum > 2.53919e+09 )
						ret := 0.089716
			if( Long_MA > 297.711 )
				if( Money_Flow_Ratio <= 0.740321 )
					if( Typical_Price <= 777.364 )
						ret := 0.865672 // buy
					if( Typical_Price > 777.364 )
						ret := 0.000000
				if( Money_Flow_Ratio > 0.740321 )
					if( Positive_Money_Flow_Sum <= 3.34254e+09 )
						ret := -0.866667 // sell
					if( Positive_Money_Flow_Sum > 3.34254e+09 )
						ret := 0.127479
...
float op_operation = decision_tree_0_TTD_1Day_cf6af61c(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
