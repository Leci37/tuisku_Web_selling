			...
			if( d_k > 14.6686 )
				...
				if( smoothD_d > 50.4612 )
					...
					if( rsi1 > 50.0977 )
						ret := -0.228261
	if( smoothK_k > 87.3731 )
		if( smoothK_k <= 95.0832 )
			if( d_k <= 1.91181 )
				if( d <= 89.8466 )
					if( smoothD_d <= 80.5272 )
						ret := -0.568966
					if( smoothD_d > 80.5272 )
						ret := 0.169492
				if( d > 89.8466 )
			...
			if( d_k > 1.91181 )
				if( rsi1 <= 82.6191 )
					if( smoothD_d <= 94.4634 )
						ret := -0.384615
					if( smoothD_d > 94.4634 )
						ret := 0.727273 // buy
				if( rsi1 > 82.6191 )
					if( smoothK_k <= 90.9628 )
						ret := 1.000000 // buy
					if( smoothK_k > 90.9628 )
						ret := 0.000000
		if( smoothK_k > 95.0832 )
...
float op_operation = decision_tree_0_MSFT_1Day_fa7270fd(d, d_k, smoothK_k, k, rsi1, smoothD_d)
