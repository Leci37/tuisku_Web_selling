			...
			if( Negative_Money_Flow_Sum <= 3.02279e+09 )
				if( Positive_Money_Flow_Sum <= 4.84237e+09 )
					...
					if( Raw_Money_Flow > 8.3144e+08 )
						ret := 0.722222 // buy
				if( Positive_Money_Flow_Sum > 4.84237e+09 )
					if( Typical_Price <= 19.7233 )
						ret := 0.769231 // buy
					if( Typical_Price > 19.7233 )
						ret := 0.000000
			if( Negative_Money_Flow_Sum > 3.02279e+09 )
				if( MFI_Low <= 19.5801 )
					if( Typical_Price <= 10.2422 )
						ret := 0.360000
					if( Typical_Price > 10.2422 )
						ret := -0.345794
				if( MFI_Low > 19.5801 )
					if( Typical_Price <= 13.4561 )
						ret := 0.656489
					if( Typical_Price > 13.4561 )
						ret := 0.118644
		if( MFI_High > -13.094 )
			if( Positive_Money_Flow <= 6.39719e+09 )
				if( Positive_Money_Flow <= 6.4907e+08 )
					if( Typical_Price <= 12.6943 )
						ret := -0.793103 // sell
					if( Typical_Price > 12.6943 )
						ret := -0.186047
				if( Positive_Money_Flow > 6.4907e+08 )
					if( Positive_Money_Flow_Sum <= 6.24727e+09 )
						ret := -0.100000
					if( Positive_Money_Flow_Sum > 6.24727e+09 )
						ret := -0.677165
			if( Positive_Money_Flow > 6.39719e+09 )
...
float op_operation = decision_tree_0_SNAP_1Day_988295ed(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
