...
decision_tree_0_UNIUSDT_1Day_50559604(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)=>
	...
	if( BBupper > 19.6748 )
		...
		if( dif_source_BBupper > -22.2908 )
			if( BBupper <= 33.6489 )
				if( dif_source_BBlower <= 2.80392 )
					if( dif_source_BBupper <= -18.5819 )
						ret := -0.481481
					if( dif_source_BBupper > -18.5819 )
						ret := 0.032787
				if( dif_source_BBlower > 2.80392 )
					...
					if( vrsi > 79.1538 )
						ret := -0.940000 // sell
			if( BBupper > 33.6489 )
				if( dif_source_BBlower <= 14.6696 )
					if( dif_source_BBupper <= -16.9011 )
						ret := 0.875000 // buy
					if( dif_source_BBupper > -16.9011 )
						ret := -0.122222
				if( dif_source_BBlower > 14.6696 )
...
float op_operation = decision_tree_0_UNIUSDT_1Day_50559604(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
