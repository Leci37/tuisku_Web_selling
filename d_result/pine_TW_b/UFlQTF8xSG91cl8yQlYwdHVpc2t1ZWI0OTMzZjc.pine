...
decision_tree_0_PYPL_1Hour_eb4933f7(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)=>
	...
	if( bbp > 4.02894 )
		if( bbp <= 11.2664 )
			if( bullPower <= 2.62943 )
				if( VIP <= 1.25675 )
					ret := 0.385714
				if( VIP > 1.25675 )
					if( bullPower <= 2.51196 )
						if( VIM <= 0.719757 )
							ret := -0.620690
						if( VIM > 0.719757 )
							ret := 0.448980
			...
			if( bullPower > 2.62943 )
				if( VIM <= 0.853885 )
					...
					if( bearPower > 3.7051 )
						ret := 0.853333 // buy
				if( VIM > 0.853885 )
					if( bearPower <= 3.31928 )
						if( bullPower <= 3.03703 )
							ret := -0.321739
						if( bullPower > 3.03703 )
							ret := 0.287105
					if( bearPower > 3.31928 )
...
float op_operation = decision_tree_0_PYPL_1Hour_eb4933f7(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
