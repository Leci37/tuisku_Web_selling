...
decision_tree_0_UBER_1Day_c3f76ae8(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)=>
	...
	if( smoothedDirectionalMovementPlus > 0.223067 )
		...
		if( smoothedDirectionalMovementMinus > 0.811366 )
			if( diPlus <= 14.4741 )
				if( trueRange <= 2.80899 )
					if( smoothedDirectionalMovementMinus <= 0.891533 )
						ret := 1.000000 // buy
					if( smoothedDirectionalMovementMinus > 0.891533 )
						ret := 0.416667
				if( trueRange > 2.80899 )
...
float op_operation = decision_tree_0_UBER_1Day_c3f76ae8(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
