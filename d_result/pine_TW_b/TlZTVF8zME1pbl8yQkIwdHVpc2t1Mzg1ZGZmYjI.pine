			...
			if( Upper_Band > 41.4311 )
				if( Lower_Band <= 39.1787 )
					...
					if( bullPower > -0.162763 )
						ret := 0.942857 // buy
				if( Lower_Band > 39.1787 )
					if( Upper_Band <= 49.2202 )
						if( Lower_Band <= 40.8673 )
							ret := -0.301413
						if( Lower_Band > 40.8673 )
							ret := -0.090312
					if( Upper_Band > 49.2202 )
						ret := 0.153846
		if( bbp > 0.85507 )
			if( Lower_Band <= 33.9766 )
				if( Lower_Band <= 12.8634 )
					if( bullPower <= 0.662912 )
						ret := -1.000000 // sell
					if( bullPower > 0.662912 )
						ret := 0.838710 // buy
				if( Lower_Band > 12.8634 )
					if( bbp <= 1.35577 )
						if( Upper_Band <= 35.1863 )
							ret := -0.351695
						if( Upper_Band > 35.1863 )
							ret := 0.480769
					if( bbp > 1.35577 )
						ret := -0.819512 // sell
			if( Lower_Band > 33.9766 )
				if( Upper_Band <= 46.0174 )
					if( Upper_Band <= 44.9022 )
						if( Lower_Band <= 40.0915 )
							ret := 0.115385
						if( Lower_Band > 40.0915 )
							ret := -0.474684
					if( Upper_Band > 44.9022 )
...
float op_operation = decision_tree_0_NVST_30Min_385dffb2(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
