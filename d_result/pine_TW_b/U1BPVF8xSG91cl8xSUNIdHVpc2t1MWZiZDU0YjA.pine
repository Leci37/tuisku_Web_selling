			...
			if( tenkan_sen > 136.408 )
				if( basis_minus <= 1.68432 )
					...
					if( senkou_span_b > 148.565 )
						ret := -0.400000
				if( basis_minus > 1.68432 )
					if( senkou_span_b_displaced <= 141.215 )
						if( tenkan_sen <= 144.625 )
							ret := 0.061441
						if( tenkan_sen > 144.625 )
							ret := 0.690476
					if( senkou_span_b_displaced > 141.215 )
						ret := -0.616438
		if( kinjun_sen > 145.118 )
			if( tenkan_sen <= 339.863 )
				if( senkou_span_a_displaced <= 143.63 )
					ret := -0.416667
				if( senkou_span_a_displaced > 143.63 )
					if( chinkou_span <= 263.916 )
						if( senkou_span_b <= 265.868 )
							ret := 0.021047
						if( senkou_span_b > 265.868 )
							ret := -0.538578
					if( chinkou_span > 263.916 )
						if( senkou_span_a <= 277.45 )
							ret := 0.368217
						if( senkou_span_a > 277.45 )
							ret := 0.049210
			if( tenkan_sen > 339.863 )
				if( senkou_span_a_displaced <= 351.588 )
					if( senkou_span_b <= 352.741 )
						if( chinkou_span <= 337.59 )
							ret := -0.672269
						if( chinkou_span > 337.59 )
							ret := 0.135870
					if( senkou_span_b > 352.741 )
...
float op_operation = decision_tree_0_SPOT_1Hour_1fbd54b0(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
