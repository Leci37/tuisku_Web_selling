		...
		if( chinkou_span <= 49.4677 )
			...
			if( senkou_span_b > 49.3229 )
				if( chinkou_span <= 46.6895 )
					ret := -0.830861 // sell
				if( chinkou_span > 46.6895 )
					if( basis_minus <= -0.799952 )
						ret := -0.339506
					if( basis_minus > -0.799952 )
						ret := -0.707729 // sell
		if( chinkou_span > 49.4677 )
			if( kinjun_sen <= 53.0412 )
				if( chinkou_span <= 56.006 )
					if( tenkan_sen <= 49.7163 )
						if( chinkou_span <= 50.1925 )
							ret := 0.138235
						if( chinkou_span > 50.1925 )
							ret := 0.588101
					if( tenkan_sen > 49.7163 )
				...
				if( chinkou_span > 56.006 )
					ret := 0.662791
			if( kinjun_sen > 53.0412 )
				if( chinkou_span <= 57.0761 )
					if( tenkan_sen <= 55.6083 )
						if( chinkou_span <= 52.645 )
							ret := -0.413127
						if( chinkou_span > 52.645 )
							ret := 0.142568
					if( tenkan_sen > 55.6083 )
						if( tenkan_sen <= 58.7025 )
							ret := -0.394161
						if( tenkan_sen > 58.7025 )
							ret := -0.770492 // sell
				if( chinkou_span > 57.0761 )
					if( tenkan_sen <= 60.5216 )
						if( chinkou_span <= 64.0556 )
							ret := 0.180539
						if( chinkou_span > 64.0556 )
							ret := 0.816667 // buy
					if( tenkan_sen > 60.5216 )
						if( chinkou_span <= 61.9121 )
							ret := -0.346359
						if( chinkou_span > 61.9121 )
							ret := 0.009949
...
float op_operation = decision_tree_0_TTD_30Min_5770ecac(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
