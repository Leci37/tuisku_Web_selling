				...
				if( BollOsc > -46.8101 )
					...
					if( azul > 10.7722 )
						...
						if( source > 99.515 )
							ret := 0.074033
		if( oscp > -12.8154 )
			if( azul_mean <= 25.1185 )
				if( pvimax <= 1.63676 )
					if( verde_azul <= -0.382072 )
						if( pvim <= -0.101015 )
							ret := 0.266667
						if( pvim > -0.101015 )
							ret := -0.532203
			...
			if( azul_mean > 25.1185 )
				if( pvimax <= 0.859073 )
					if( stoc <= 75.7186 )
						if( media_azul <= 39.9453 )
							ret := 0.295082
						if( media_azul > 39.9453 )
							ret := -0.175573
					if( stoc > 75.7186 )
						if( verde_mean <= 121.501 )
							ret := -0.353398
						if( verde_mean > 121.501 )
							ret := 0.127042
				if( pvimax > 0.859073 )
...
float op_operation = decision_tree_0_AAVEUSDT_1Hour_861f2845(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
