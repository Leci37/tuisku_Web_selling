...
decision_tree_0_DOTUSDT_1Day_1edb3ab8(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( Color_con1 > -34.0927 )
		...
		if( wvf > 30.9767 )
			...
			if( upperBand > 58.8491 )
				if( wvf <= 55.2276 )
					if( Color_con1 <= -20.802 )
						ret := -0.814815 // sell
					if( Color_con1 > -20.802 )
						ret := 0.238095
				if( wvf > 55.2276 )
					if( lowerBand <= -5.10025 )
						ret := 0.625000
					if( lowerBand > -5.10025 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_DOTUSDT_1Day_1edb3ab8(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
