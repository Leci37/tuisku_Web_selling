			...
			if( bbm > 0.044449 )
				...
				if( MFI_High > -75.8087 )
					...
					if( Positive_Money_Flow_Sum > 5.387e+07 )
						ret := -0.274457
	if( Money_Flow_Ratio > 0.417034 )
		if( bullPower <= 0.002358 )
			if( Positive_Money_Flow_Sum <= 4.7218e+06 )
				if( Typical_Price <= 1.85037 )
					if( Typical_Price <= 1.50663 )
						ret := 0.237288
					if( Typical_Price > 1.50663 )
						ret := 0.698324
				if( Typical_Price > 1.85037 )
					if( Negative_Money_Flow_Sum <= 2.83381e+06 )
						ret := 0.072289
					if( Negative_Money_Flow_Sum > 2.83381e+06 )
						ret := 0.361076
			if( Positive_Money_Flow_Sum > 4.7218e+06 )
				if( Raw_Money_Flow <= 5.53281e+07 )
					if( Positive_Money_Flow_Sum <= 3.20435e+08 )
						ret := 0.047959
					if( Positive_Money_Flow_Sum > 3.20435e+08 )
						ret := 0.864865 // buy
				if( Raw_Money_Flow > 5.53281e+07 )
					...
					if( MFI > 30.168 )
						ret := -0.718750 // sell
		if( bullPower > 0.002358 )
			if( Negative_Money_Flow_Sum <= 1.7757e+08 )
				if( Raw_Money_Flow <= 31140.8 )
					if( Positive_Money_Flow <= 15.6015 )
						ret := 0.135068
					if( Positive_Money_Flow > 15.6015 )
						ret := -0.227820
				if( Raw_Money_Flow > 31140.8 )
					if( Positive_Money_Flow_Sum <= 1.74588e+06 )
						ret := 0.258258
					if( Positive_Money_Flow_Sum > 1.74588e+06 )
						ret := -0.007415
			if( Negative_Money_Flow_Sum > 1.7757e+08 )
				if( MFI_Low <= 30.7271 )
					if( Positive_Money_Flow_Sum <= 1.80591e+08 )
						ret := 0.341667
					if( Positive_Money_Flow_Sum > 1.80591e+08 )
						ret := -0.600000
				if( MFI_Low > 30.7271 )
					if( Typical_Price <= 64.0408 )
						ret := 0.409091
					if( Typical_Price > 64.0408 )
						ret := 0.918367 // buy
...
float op_operation = decision_tree_0_APPS_1Hour_54a5bec3(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
