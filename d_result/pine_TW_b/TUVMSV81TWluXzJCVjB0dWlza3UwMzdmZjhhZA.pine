...
decision_tree_0_MELI_5Min_037ff8ad(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)=>
	...
	if( bullPower > -4.90648 )
		...
		if( bullPower > -4.03774 )
			if( bbm <= 2.73141 )
				if( bbp <= 48.4257 )
					if( bearPower <= -4.49062 )
						if( VIP_VIM <= -0.449051 )
							ret := -0.427184
						if( VIP_VIM > -0.449051 )
							ret := -0.059081
					if( bearPower > -4.49062 )
						if( bullPower <= 3.24235 )
							ret := 0.009872
						if( bullPower > 3.24235 )
							ret := -0.084570
				if( bbp > 48.4257 )
...
float op_operation = decision_tree_0_MELI_5Min_037ff8ad(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
