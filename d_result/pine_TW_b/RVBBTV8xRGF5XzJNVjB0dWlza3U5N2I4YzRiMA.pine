			...
			if( MFI_High > -42.6798 )
				...
				if( Positive_Money_Flow_Sum > 1.60805e+09 )
					...
					if( Negative_Money_Flow_Sum > 2.22303e+09 )
						ret := 0.818182 // buy
	if( VIP_VIM > 0.106937 )
		if( Typical_Price <= 378.415 )
			if( Typical_Price <= 329.199 )
				if( Negative_Money_Flow <= 9.50048e+07 )
					if( Negative_Money_Flow_Sum <= 1.40063e+08 )
						ret := -0.368132
					if( Negative_Money_Flow_Sum > 1.40063e+08 )
						ret := -0.101124
				if( Negative_Money_Flow > 9.50048e+07 )
					if( Raw_Money_Flow <= 3.02569e+08 )
						ret := 0.270833
					if( Raw_Money_Flow > 3.02569e+08 )
						ret := 0.937500 // buy
			if( Typical_Price > 329.199 )
				if( Positive_Money_Flow_Sum <= 8.70705e+08 )
					if( Positive_Money_Flow <= 2.53926e+07 )
						ret := -0.666667
					if( Positive_Money_Flow > 2.53926e+07 )
						ret := 0.437500
				if( Positive_Money_Flow_Sum > 8.70705e+08 )
					if( Money_Flow_Ratio <= 4.23072 )
						ret := -0.767296 // sell
					if( Money_Flow_Ratio > 4.23072 )
						ret := 1.000000 // buy
		if( Typical_Price > 378.415 )
			if( Positive_Money_Flow_Sum <= 1.68778e+09 )
				if( Raw_Money_Flow <= 8.39339e+07 )
					if( MFI_High <= -12.5236 )
						ret := -0.833333 // sell
					if( MFI_High > -12.5236 )
						ret := 0.000000
				if( Raw_Money_Flow > 8.39339e+07 )
					if( Positive_Money_Flow_Sum <= 1.11652e+09 )
						ret := 0.755102 // buy
					if( Positive_Money_Flow_Sum > 1.11652e+09 )
						ret := 0.397436
			if( Positive_Money_Flow_Sum > 1.68778e+09 )
				if( Negative_Money_Flow <= 3.6951e+07 )
					if( Positive_Money_Flow_Sum <= 2.81153e+09 )
						ret := -0.315789
					if( Positive_Money_Flow_Sum > 2.81153e+09 )
						ret := -0.909091 // sell
				if( Negative_Money_Flow > 3.6951e+07 )
					if( Raw_Money_Flow <= 2.30927e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 2.30927e+08 )
						ret := 0.666667
...
float op_operation = decision_tree_0_EPAM_1Day_97b8c4b0(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
