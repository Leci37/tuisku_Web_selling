			...
			if( upperBand <= 25.2149 )
				...
				if( Color_con1 > -7.59078 )
					...
					if( sDev > 7.78828 )
						ret := 0.059740
			if( upperBand > 25.2149 )
				if( lowerBand <= -3.05316 )
					if( Color_con1 <= -1.98765 )
						ret := -0.715847 // sell
					if( Color_con1 > -1.98765 )
						ret := -0.058824
				if( lowerBand > -3.05316 )
					if( Color_con2 <= -20.593 )
						ret := 0.538462
					if( Color_con2 > -20.593 )
						ret := -0.221751
		if( wvf > 31.2822 )
			if( Color_con1 <= -5.62174 )
				if( upperBand <= 50.3658 )
					if( Color_con1 <= -15.7549 )
						ret := -0.285714
					if( Color_con1 > -15.7549 )
						ret := 0.628099
				if( upperBand > 50.3658 )
					if( upperBand <= 78.1519 )
						ret := 0.976744 // buy
					if( upperBand > 78.1519 )
						ret := 0.428571
			if( Color_con1 > -5.62174 )
...
float op_operation = decision_tree_0_RUN_1Day_d34e644f(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
