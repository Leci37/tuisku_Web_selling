				...
				if( senkou_span_b > 44.6872 )
					...
					if( chinkou_span > 47.3085 )
						...
						if( senkou_span_a > 44.6887 )
							ret := 0.266667
			if( kinjun_sen > 46.7989 )
				if( tenkan_sen <= 45.7323 )
					ret := 0.116279
				if( tenkan_sen > 45.7323 )
					ret := -0.777202 // sell
		if( chinkou_span > 47.8926 )
			if( tenkan_sen <= 51.0507 )
				if( tenkan_sen <= 46.5394 )
					ret := 0.803030 // buy
				if( tenkan_sen > 46.5394 )
					if( kinjun_sen <= 51.0967 )
						if( senkou_span_b <= 50.8869 )
							ret := 0.362348
						if( senkou_span_b > 50.8869 )
							ret := -0.245902
					if( kinjun_sen > 51.0967 )
						ret := 0.916667 // buy
			if( tenkan_sen > 51.0507 )
				if( chinkou_span <= 70.1647 )
					if( kinjun_sen <= 67.4204 )
						if( basis_minus <= 1.44425 )
							ret := 0.033467
						if( basis_minus > 1.44425 )
							ret := -0.305512
					if( kinjun_sen > 67.4204 )
						if( senkou_span_a_displaced <= 601.42 )
							ret := -0.461702
						if( senkou_span_a_displaced > 601.42 )
							ret := 1.000000 // buy
				if( chinkou_span > 70.1647 )
					if( senkou_span_b <= 72.896 )
						if( tenkan_sen <= 70.8748 )
							ret := 0.674086
						if( tenkan_sen > 70.8748 )
							ret := 0.290965
					if( senkou_span_b > 72.896 )
						if( senkou_span_b_displaced <= 930.305 )
							ret := 0.006576
						if( senkou_span_b_displaced > 930.305 )
							ret := -0.792079 // sell
...
float op_operation = decision_tree_0_TTD_1Hour_40fd81ba(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
