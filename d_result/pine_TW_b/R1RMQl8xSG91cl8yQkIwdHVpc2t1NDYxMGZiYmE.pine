				...
				if( basis > 43.533 )
					...
					if( bearPower > 0.760164 )
						...
						if( Lower_Band > 41.9625 )
							ret := -0.480000
	if( Lower_Band > 43.9387 )
		if( bullPower <= -2.78162 )
			if( bearPower <= -7.18371 )
				ret := -0.300000
			if( bearPower > -7.18371 )
				if( bearPower <= -3.45778 )
					ret := 0.793388 // buy
				if( bearPower > -3.45778 )
					ret := -0.250000
		if( bullPower > -2.78162 )
			if( Upper_Band <= 57.7601 )
				if( Lower_Band <= 44.1631 )
					ret := -0.460674
				if( Lower_Band > 44.1631 )
					if( bearPower <= 0.613123 )
						if( bullPower <= 0.082545 )
							ret := -0.049875
						if( bullPower > 0.082545 )
							ret := 0.135514
					if( bearPower > 0.613123 )
						if( Upper_Band <= 57.3386 )
							ret := -0.263027
						if( Upper_Band > 57.3386 )
							ret := 0.642857
			if( Upper_Band > 57.7601 )
...
float op_operation = decision_tree_0_GTLB_1Hour_4610fbba(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
