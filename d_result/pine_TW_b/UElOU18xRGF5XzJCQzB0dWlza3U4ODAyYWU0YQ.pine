...
decision_tree_0_PINS_1Day_8802ae4a(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)=>
	...
	if( mf > -0.16328 )
		...
		if( bbm > 1.83727 )
			...
			if( ad_mf > -2.37454e+06 )
				if( ad <= -575999 )
					if( ad_mf <= -1.24327e+06 )
						ret := 0.000000
					if( ad_mf > -1.24327e+06 )
						ret := 1.000000 // buy
				if( ad > -575999 )
					if( ad_mf <= 1.38471e+07 )
						ret := 0.017937
					if( ad_mf > 1.38471e+07 )
						ret := -0.466667
...
float op_operation = decision_tree_0_PINS_1Day_8802ae4a(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
