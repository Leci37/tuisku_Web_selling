...
decision_tree_0_GTLB_15Min_d8d6e6d1(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
				...
				if( Typical_Price > 56.3744 )
					...
					if( Negative_Money_Flow_Sum > 5.20545e+06 )
						...
						if( Negative_Money_Flow_Sum > 1.06497e+07 )
							ret := -0.190867
			if( Raw_Money_Flow > 3.36032e+06 )
				if( Raw_Money_Flow <= 1.91918e+07 )
					if( MFI_High <= -28.9669 )
						if( Negative_Money_Flow_Sum <= 1.10813e+07 )
							ret := -0.443182
						if( Negative_Money_Flow_Sum > 1.10813e+07 )
							ret := 0.193548
					if( MFI_High > -28.9669 )
	...
	if( rsi1 > 46.2056 )
		...
		if( MFI_Low > -2.57514 )
			if( MFI_High <= 19.4804 )
				if( Raw_Money_Flow <= 531440 )
					if( Positive_Money_Flow <= 4.08438 )
						if( Positive_Money_Flow_Sum <= 5.39884e+07 )
							ret := -0.002812
						if( Positive_Money_Flow_Sum > 5.39884e+07 )
							ret := 0.378109
					if( Positive_Money_Flow > 4.08438 )
						if( Negative_Money_Flow_Sum <= 3.94126e+07 )
							ret := -0.180705
						if( Negative_Money_Flow_Sum > 3.94126e+07 )
							ret := -0.550781
				if( Raw_Money_Flow > 531440 )
					if( Negative_Money_Flow <= 1.40929e+07 )
						if( Typical_Price <= 44.244 )
							ret := 0.098837
						if( Typical_Price > 44.244 )
							ret := -0.022635
					if( Negative_Money_Flow > 1.40929e+07 )
...
float op_operation = decision_tree_0_GTLB_15Min_d8d6e6d1(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
