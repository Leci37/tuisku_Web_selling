	...
	if( source > 97.7003 )
		if( pvimin <= 1.54097 )
			if( nvi_ema <= 0.185757 )
				if( tprice <= 107.137 )
					if( azul <= 20.6876 )
						if( azul_mean <= 9.69325 )
							ret := -0.067024
						if( azul_mean > 9.69325 )
							ret := 0.519231
					if( azul > 20.6876 )
						if( media_azul <= 30.8812 )
							ret := 0.142857
						if( media_azul > 30.8812 )
							ret := -0.897959 // sell
				if( tprice > 107.137 )
		...
		if( pvimin > 1.54097 )
			if( source <= 130.026 )
				if( oscp <= 2.81982 )
					if( verde_azul <= -7.63448 )
						if( pvi_ema <= 2.00756 )
							ret := -0.616822
						if( pvi_ema > 2.00756 )
							ret := -0.112637
					if( verde_azul > -7.63448 )
						if( verde_media <= 9.09802 )
							ret := 0.144787
						if( verde_media > 9.09802 )
							ret := -0.165017
				if( oscp > 2.81982 )
...
float op_operation = decision_tree_0_DDOG_1Hour_feb83c4a(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
