	...
	if( ad > 5.13854e+06 )
		if( ad <= 1.53784e+07 )
			if( ad_mf <= 7.29209e+06 )
				if( ad_mf <= 5.76402e+06 )
					if( ad_mf <= 5.59142e+06 )
						ret := -0.735294 // sell
					if( ad_mf > 5.59142e+06 )
						ret := -0.333333
				if( ad_mf > 5.76402e+06 )
					if( ad_mf <= 6.21352e+06 )
						ret := 0.823529 // buy
					if( ad_mf > 6.21352e+06 )
						ret := 0.142857
			if( ad_mf > 7.29209e+06 )
				if( ad_mf <= 7.7518e+06 )
					if( ad_mf <= 7.49177e+06 )
						ret := -0.818182 // sell
					if( ad_mf > 7.49177e+06 )
						ret := -1.000000 // sell
				if( ad_mf > 7.7518e+06 )
					...
					if( mf > -0.005498 )
						ret := -0.641509
		if( ad > 1.53784e+07 )
			if( ad_mf <= 9.82518e+07 )
				if( ad <= 2.31858e+07 )
					if( ad_mf <= 2.21705e+07 )
						ret := 0.205882
					if( ad_mf > 2.21705e+07 )
						ret := 0.800000 // buy
				if( ad > 2.31858e+07 )
					if( ad_mf <= 4.18341e+07 )
						ret := -0.362416
					if( ad_mf > 4.18341e+07 )
						ret := 0.121212
			if( ad_mf > 9.82518e+07 )
...
float op_operation = decision_tree_0_AMZN_1Day_5c050ff0(ad, mf, ad_mf)
