...
decision_tree_0_RUN_1Day_309109fa(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)=>
	...
	if( Negative_Money_Flow_Sum > 1.73782e+09 )
		if( MFI_Low <= 4.70797 )
			if( Raw_Money_Flow <= 1.39027e+08 )
				if( Negative_Money_Flow_Sum <= 1.8915e+09 )
					ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 1.8915e+09 )
					if( Positive_Money_Flow_Sum <= 4.63419e+08 )
						ret := 0.500000
					if( Positive_Money_Flow_Sum > 4.63419e+08 )
						ret := 0.000000
			if( Raw_Money_Flow > 1.39027e+08 )
				if( Positive_Money_Flow <= 1.62565e+08 )
					if( Short_Long_Diff <= -5.29563 )
						ret := 0.000000
					if( Short_Long_Diff > -5.29563 )
						ret := 0.750000 // buy
				if( Positive_Money_Flow > 1.62565e+08 )
					...
					if( Short_MA > 22.3211 )
						ret := -1.000000 // sell
		if( MFI_Low > 4.70797 )
			if( Negative_Money_Flow_Sum <= 2.44588e+09 )
				if( Positive_Money_Flow_Sum <= 7.23281e+08 )
					if( Typical_Price <= 21.8674 )
						ret := 0.875000 // buy
					if( Typical_Price > 21.8674 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 7.23281e+08 )
					if( Negative_Money_Flow <= 8.74224e+08 )
						ret := -0.634146
					if( Negative_Money_Flow > 8.74224e+08 )
						ret := 1.000000 // buy
			if( Negative_Money_Flow_Sum > 2.44588e+09 )
				if( MFI_Low <= 23.7174 )
					if( Negative_Money_Flow <= 5.78867e+07 )
						ret := 0.050000
					if( Negative_Money_Flow > 5.78867e+07 )
						ret := 0.761905 // buy
				if( MFI_Low > 23.7174 )
					if( Typical_Price <= 60.6806 )
						ret := -0.217391
					if( Typical_Price > 60.6806 )
						ret := -0.809524 // sell
...
float op_operation = decision_tree_0_RUN_1Day_309109fa(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
