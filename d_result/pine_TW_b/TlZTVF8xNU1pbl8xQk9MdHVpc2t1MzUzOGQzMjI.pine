	...
	if( BBlower > 11.4793 )
		...
		if( dif_source_BBupper > -0.859447 )
			if( BBupper <= 18.7084 )
				...
				if( BBupper > 17.5894 )
					if( vrsi <= 33.2095 )
						if( dif_source_BBupper <= -0.332709 )
							ret := -0.615385
						if( dif_source_BBupper > -0.332709 )
							ret := 0.350000
					if( vrsi > 33.2095 )
			...
			if( BBupper > 18.7084 )
				...
				if( BBlower > 20.0252 )
					if( BBupper <= 44.0971 )
						if( dif_source_BBupper <= -0.554619 )
							ret := 0.039442
						if( dif_source_BBupper > -0.554619 )
							ret := -0.055634
					if( BBupper > 44.0971 )
...
float op_operation = decision_tree_0_NVST_15Min_3538d322(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
