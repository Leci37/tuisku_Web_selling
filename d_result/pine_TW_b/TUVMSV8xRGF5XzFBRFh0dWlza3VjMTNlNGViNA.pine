			...
			if( smoothedDirectionalMovementPlus > 0.658071 )
				if( directionalMovementPlus <= 7.34664 )
					...
					if( trueRange > 7.5145 )
						ret := -0.166031
				if( directionalMovementPlus > 7.34664 )
					if( smoothedTrueRange <= 33.0126 )
						ret := 0.011364
					if( smoothedTrueRange > 33.0126 )
						ret := 0.413978
		if( smoothedTrueRange > 50.4609 )
			if( diPlus <= 34.1095 )
				if( trueRange <= 123.398 )
					if( diMinus <= 31.1215 )
						ret := -0.147186
					if( diMinus > 31.1215 )
						ret := -0.944444 // sell
...
float op_operation = decision_tree_0_MELI_1Day_c13e4eb4(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
