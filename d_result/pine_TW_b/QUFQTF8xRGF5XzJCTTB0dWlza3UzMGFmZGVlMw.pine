			...
			if( Typical_Price <= 140.876 )
				...
				if( Negative_Money_Flow > 1.60483e+10 )
					...
					if( bbp > -66.5689 )
						ret := 0.903226 // buy
			if( Typical_Price > 140.876 )
				if( Negative_Money_Flow_Sum <= 1.81629e+11 )
					if( Negative_Money_Flow_Sum <= 8.85754e+10 )
						ret := -0.219048
					if( Negative_Money_Flow_Sum > 8.85754e+10 )
						ret := -0.648734
				if( Negative_Money_Flow_Sum > 1.81629e+11 )
					...
					if( bbp > -61.7376 )
						ret := 0.461538
		if( MFI > 43.704 )
			if( Positive_Money_Flow_Sum <= 1.139e+11 )
				if( Negative_Money_Flow_Sum <= 8.86616e+10 )
					if( BBPower_Color <= 0.5 )
						ret := -0.236749
					if( BBPower_Color > 0.5 )
						ret := 0.175655
				if( Negative_Money_Flow_Sum > 8.86616e+10 )
					if( Typical_Price <= 151.804 )
						ret := 0.545455
					if( Typical_Price > 151.804 )
						ret := 0.909091 // buy
			if( Positive_Money_Flow_Sum > 1.139e+11 )
				if( Typical_Price <= 156.42 )
					if( Negative_Money_Flow_Sum <= 8.56754e+10 )
						ret := -0.282609
					if( Negative_Money_Flow_Sum > 8.56754e+10 )
						ret := -0.698276
				if( Typical_Price > 156.42 )
					if( Negative_Money_Flow <= 9.12724e+09 )
						ret := 0.223938
					if( Negative_Money_Flow > 9.12724e+09 )
						ret := -0.363636
...
float op_operation = decision_tree_0_AAPL_1Day_30afdee3(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
