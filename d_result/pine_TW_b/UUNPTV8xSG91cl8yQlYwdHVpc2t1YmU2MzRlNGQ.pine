...
decision_tree_0_QCOM_1Hour_be634e4d(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)=>
	...
	if( bearPower > -4.80161 )
		if( bbm <= 0.055936 )
			if( bearPower <= 0.724769 )
				if( VIP <= 0.882044 )
					if( VIM <= 1.39489 )
						if( bearPower <= -0.271615 )
							ret := -0.370607
						if( bearPower > -0.271615 )
							ret := 0.021739
					if( VIM > 1.39489 )
						if( bearPower <= -0.228415 )
							ret := 0.428571
						if( bearPower > -0.228415 )
							ret := 0.857143 // buy
				if( VIP > 0.882044 )
				...
				if( VIP_VIM <= 0.403158 )
					...
					if( VIP_VIM > -0.04998 )
						...
						if( VIP_VIM > 0.242099 )
							ret := -0.333333
				if( VIP_VIM > 0.403158 )
					if( bullPower <= 0.791199 )
						if( VIM <= 0.762326 )
							ret := -0.894737 // sell
						if( VIM > 0.762326 )
							ret := -0.466667
					if( bullPower > 0.791199 )
						if( bearPower <= 0.950639 )
							ret := 0.626374
						if( bearPower > 0.950639 )
							ret := -0.130769
		if( bbm > 0.055936 )
			if( VIM <= 1.27249 )
				if( bullPower <= 0.038163 )
					if( bbm <= 0.37658 )
						if( VIP <= 0.863969 )
							ret := -0.244300
						if( VIP > 0.863969 )
				...
				if( bullPower > 0.038163 )
					...
					if( VIP > 1.01318 )
						...
						if( VIP_VIM > 0.799192 )
							ret := 0.290557
			if( VIM > 1.27249 )
				if( bullPower <= 0.306936 )
					if( bearPower <= -1.59886 )
						if( bearPower <= -1.65576 )
							ret := 0.110614
						if( bearPower > -1.65576 )
							ret := 0.773333 // buy
					if( bearPower > -1.59886 )
...
float op_operation = decision_tree_0_QCOM_1Hour_be634e4d(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)
