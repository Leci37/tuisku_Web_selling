		...
		if( BBlower > 106.445 )
			if( vrsi <= 25.7156 )
				if( dif_source_BBupper <= -25.2233 )
					if( BBupper <= 202.268 )
						if( dif_source_BBlower <= -0.861214 )
							ret := -0.114286
						if( dif_source_BBlower > -0.861214 )
							ret := 0.816514 // buy
					if( BBupper > 202.268 )
						if( dif_source_BBlower <= -0.084606 )
							ret := 0.428571
						if( dif_source_BBlower > -0.084606 )
							ret := -0.761905 // sell
				if( dif_source_BBupper > -25.2233 )
					if( vrsi <= 19.0792 )
						...
						if( BBlower > 182.404 )
							ret := -0.807339 // sell
					if( vrsi > 19.0792 )
						if( dif_source_BBupper <= -19.9903 )
							ret := -0.797297 // sell
						if( dif_source_BBupper > -19.9903 )
							ret := -0.276281
			if( vrsi > 25.7156 )
				if( dif_source_BBupper <= -25.8518 )
					if( vrsi <= 35.3251 )
						ret := 0.608247
					if( vrsi > 35.3251 )
						if( BBupper <= 198.787 )
						...
						if( BBupper > 198.787 )
							ret := -0.119816
				if( dif_source_BBupper > -25.8518 )
					if( dif_source_BBupper <= -22.6375 )
						if( dif_source_BBlower <= 0.112534 )
							ret := -0.913793 // sell
						if( dif_source_BBlower > 0.112534 )
							ret := -0.178862
					if( dif_source_BBupper > -22.6375 )
...
float op_operation = decision_tree_0_QCOM_1Hour_8324848c(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
