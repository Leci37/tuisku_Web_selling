			...
			if( Typical_Price <= 110.719 )
				if( Negative_Money_Flow_Sum <= 1.54288e+10 )
					...
					if( Positive_Money_Flow_Sum > 2.44478e+10 )
						ret := -0.607143
				if( Negative_Money_Flow_Sum > 1.54288e+10 )
					if( Raw_Money_Flow <= 2.94139e+09 )
						ret := -0.806723 // sell
					if( Raw_Money_Flow > 2.94139e+09 )
						ret := 0.217391
			if( Typical_Price > 110.719 )
				if( Positive_Money_Flow_Sum <= 1.69579e+10 )
					if( rsi1 <= 27.2511 )
						ret := -0.241379
					if( rsi1 > 27.2511 )
						ret := 0.509804
...
float op_operation = decision_tree_0_BABA_1Day_73272908(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
