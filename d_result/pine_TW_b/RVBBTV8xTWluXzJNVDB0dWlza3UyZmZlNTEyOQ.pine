				...
				if( Positive_Money_Flow > 4713.8 )
					...
					if( ema2 > 200.466 )
						...
						if( ema12 > 0.356352 )
							ret := 0.439560
			if( Positive_Money_Flow_Sum > 1.55295e+06 )
				if( Positive_Money_Flow_Sum <= 5.06519e+06 )
					if( MFI_High <= 1.77332 )
						if( Negative_Money_Flow_Sum <= 3.05907e+07 )
							ret := 0.047982
						if( Negative_Money_Flow_Sum > 3.05907e+07 )
							ret := 0.676923
					if( MFI_High > 1.77332 )
				...
				if( Positive_Money_Flow_Sum > 5.06519e+06 )
					if( MFI_High <= -11.1599 )
						ret := 0.318814
					if( MFI_High > -11.1599 )
						if( Negative_Money_Flow_Sum <= 766234 )
							ret := 0.583333
						if( Negative_Money_Flow_Sum > 766234 )
							ret := 0.015719
		if( Positive_Money_Flow_Sum > 6.83006e+06 )
			if( ema12 <= 0.633885 )
				if( Money_Flow_Ratio <= 0.265673 )
					ret := 0.732143 // buy
				if( Money_Flow_Ratio > 0.265673 )
					if( Raw_Money_Flow <= 3.69573e+06 )
						if( MFI <= 55.1738 )
							ret := -0.363551
						if( MFI > 55.1738 )
							ret := -0.144858
					if( Raw_Money_Flow > 3.69573e+06 )
						ret := 0.166667
			if( ema12 > 0.633885 )
				if( Positive_Money_Flow_Sum <= 7.91802e+06 )
					ret := -0.857143 // sell
				if( Positive_Money_Flow_Sum > 7.91802e+06 )
					ret := 0.250575
...
float op_operation = decision_tree_0_EPAM_1Min_2ffe5129(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
