...
decision_tree_0_DOTUSDT_1Hour_b75a3aad(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)=>
	...
	if( marron > 6.64325 )
				...
				if( pvimax > 1.00166 )
					...
					if( media_azul > 26.6112 )
						...
						if( pvimin > 0.608602 )
							ret := -0.290960
			if( pvimin > 0.929293 )
				if( verde_media <= 24.6903 )
					if( oscp <= 12.4694 )
						if( azul_mean <= 2.30786 )
							ret := -0.001776
						if( azul_mean > 2.30786 )
							ret := 0.375358
					if( oscp > 12.4694 )
						if( verde_azul <= 118.943 )
							ret := 0.896104 // buy
						if( verde_azul > 118.943 )
							ret := 0.625000
				if( verde_media > 24.6903 )
					if( marron <= 118.694 )
						if( media_azul <= 86.4936 )
							ret := -0.083700
						if( media_azul > 86.4936 )
							ret := -0.680556
					if( marron > 118.694 )
		...
		if( source > 34.1395 )
			if( pvimax <= 1.50277 )
				if( xrsi <= 56.6729 )
					if( verde_media <= -14.8959 )
						if( azul_mean <= -17.7071 )
							ret := -0.598765
						if( azul_mean > -17.7071 )
							ret := -0.091964
					if( verde_media > -14.8959 )
				...
				if( xrsi > 56.6729 )
					if( xrsi <= 81.1778 )
						...
						if( oscp > -2.07968 )
							ret := -0.293666
					if( xrsi > 81.1778 )
						if( verde_azul <= 163.698 )
							ret := 0.804878 // buy
						if( verde_azul > 163.698 )
							ret := -0.272727
			if( pvimax > 1.50277 )
				if( azul_mean <= 40.2329 )
					if( media <= 18.7691 )
						ret := 0.764706 // buy
					if( media > 18.7691 )
						if( media <= 106.374 )
...
float op_operation = decision_tree_0_DOTUSDT_1Hour_b75a3aad(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
