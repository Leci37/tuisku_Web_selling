	...
	if( Negative_Money_Flow_Sum > 1.76048e+09 )
		if( Negative_Money_Flow_Sum <= 2.24492e+09 )
			if( Positive_Money_Flow_Sum <= 9.01869e+08 )
				if( MFI_Low <= 6.09801 )
					if( Typical_Price <= 22.18 )
						ret := 0.818182 // buy
					if( Typical_Price > 22.18 )
						ret := -0.952381 // sell
				if( MFI_Low > 6.09801 )
					if( Negative_Money_Flow_Sum <= 2.0277e+09 )
						ret := 0.894737 // buy
					if( Negative_Money_Flow_Sum > 2.0277e+09 )
						ret := 0.100000
			if( Positive_Money_Flow_Sum > 9.01869e+08 )
				if( Negative_Money_Flow_Sum <= 1.85227e+09 )
					if( Positive_Money_Flow_Sum <= 1.83209e+09 )
						ret := -0.418605
					if( Positive_Money_Flow_Sum > 1.83209e+09 )
						ret := 0.571429
				if( Negative_Money_Flow_Sum > 1.85227e+09 )
					if( Negative_Money_Flow_Sum <= 2.13632e+09 )
						ret := -0.743056 // sell
					if( Negative_Money_Flow_Sum > 2.13632e+09 )
						ret := -0.309524
		if( Negative_Money_Flow_Sum > 2.24492e+09 )
			if( Typical_Price <= 60.8094 )
				if( Negative_Money_Flow_Sum <= 2.44517e+09 )
					if( Positive_Money_Flow_Sum <= 1.34541e+09 )
						ret := -0.320000
					if( Positive_Money_Flow_Sum > 1.34541e+09 )
						ret := 0.233333
				if( Negative_Money_Flow_Sum > 2.44517e+09 )
					if( Negative_Money_Flow <= 4.83525e+06 )
						ret := 0.192308
					if( Negative_Money_Flow > 4.83525e+06 )
						ret := 0.673913
			if( Typical_Price > 60.8094 )
				if( MFI_Low <= 23.5438 )
					ret := 0.625000
				if( MFI_Low > 23.5438 )
					if( Negative_Money_Flow_Sum <= 2.61129e+09 )
						ret := -0.500000
					if( Negative_Money_Flow_Sum > 2.61129e+09 )
						ret := -0.833333 // sell
...
float op_operation = decision_tree_0_RUN_1Day_b77d422c(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
