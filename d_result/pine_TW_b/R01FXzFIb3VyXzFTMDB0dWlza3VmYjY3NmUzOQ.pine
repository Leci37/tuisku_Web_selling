...
decision_tree_0_GME_1Hour_fb676e39(d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( d > 56.3252 )
		...
		if( smoothK_k > 42.0412 )
			if( rsi1 <= 88.9989 )
				if( smoothD_d <= 79.3207 )
					if( smoothD_d <= 74.7415 )
						if( rsi1 <= 57.0149 )
							ret := -0.011990
						if( rsi1 > 57.0149 )
							ret := 0.119362
				...
				if( smoothD_d > 79.3207 )
					if( rsi1 <= 85.7756 )
						if( smoothK_k <= 70.3832 )
							ret := 0.366142
						if( smoothK_k > 70.3832 )
							ret := 0.069737
					if( rsi1 > 85.7756 )
						if( smoothK_k <= 94.1629 )
							ret := 0.254237
						if( smoothK_k > 94.1629 )
							ret := 0.788321 // buy
			if( rsi1 > 88.9989 )
				if( smoothK_k <= 92.5918 )
					ret := -0.701149 // sell
				if( smoothK_k > 92.5918 )
					if( d <= 99.0954 )
						ret := 0.256098
...
float op_operation = decision_tree_0_GME_1Hour_fb676e39(d, d_k, smoothK_k, k, rsi1, smoothD_d)
