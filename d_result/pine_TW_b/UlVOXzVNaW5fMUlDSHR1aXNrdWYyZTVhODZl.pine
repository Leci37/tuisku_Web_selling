				...
				if( chinkou_span > 11.6145 )
					...
					if( basis_max > 0.018941 )
						...
						if( senkou_span_b > 12.4197 )
							ret := -0.874214 // sell
		if( chinkou_span > 11.9097 )
			if( tenkan_sen <= 11.8174 )
				if( tenkan_sen <= 11.5087 )
					if( kinjun_sen <= 11.5324 )
						if( basis_minus <= 0.061858 )
							ret := 0.750000 // buy
						if( basis_minus > 0.061858 )
							ret := -0.400000
					if( kinjun_sen > 11.5324 )
						ret := -0.947368 // sell
				if( tenkan_sen > 11.5087 )
					if( senkou_span_a_displaced <= 11.8263 )
						if( chinkou_span <= 12.8827 )
							ret := 0.741124 // buy
						if( chinkou_span > 12.8827 )
							ret := -0.222222
					if( senkou_span_a_displaced > 11.8263 )
						if( senkou_span_b_displaced <= 12.2066 )
							ret := 0.207101
						if( senkou_span_b_displaced > 12.2066 )
							ret := 0.868217 // buy
			if( tenkan_sen > 11.8174 )
				if( chinkou_span <= 12.1307 )
					if( tenkan_sen <= 12.1427 )
						if( senkou_span_b_displaced <= 12.5475 )
							ret := -0.007084
						if( senkou_span_b_displaced > 12.5475 )
							ret := -0.627451
					if( tenkan_sen > 12.1427 )
						if( senkou_span_a_displaced <= 11.8087 )
							ret := 0.229167
						if( senkou_span_a_displaced > 11.8087 )
							ret := -0.601681
				if( chinkou_span > 12.1307 )
					if( tenkan_sen <= 12.1655 )
						if( basis_max <= -0.004987 )
							ret := 0.259557
						if( basis_max > -0.004987 )
							ret := 0.554054
					if( tenkan_sen > 12.1655 )
						if( chinkou_span <= 12.3553 )
							ret := -0.340688
						if( chinkou_span > 12.3553 )
							ret := 0.011077
...
float op_operation = decision_tree_0_RUN_5Min_f2e5a86e(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
