			...
			if( Typical_Price <= 4.3691 )
				if( Typical_Price <= 2.77307 )
					...
					if( bullPower > 0.249296 )
						ret := 0.277778
				if( Typical_Price > 2.77307 )
					if( Raw_Money_Flow <= 1.66431e+08 )
						ret := 0.313953
					if( Raw_Money_Flow > 1.66431e+08 )
						ret := 0.833333 // buy
			if( Typical_Price > 4.3691 )
				if( Money_Flow_Ratio <= 1.96827 )
					if( Raw_Money_Flow <= 4.91719e+08 )
						ret := -0.267123
					if( Raw_Money_Flow > 4.91719e+08 )
						ret := 0.562500
				if( Money_Flow_Ratio > 1.96827 )
					if( Raw_Money_Flow <= 3.06929e+08 )
						ret := 0.576923
					if( Raw_Money_Flow > 3.06929e+08 )
						ret := 1.000000 // buy
		if( bullPower > 0.549475 )
			if( Negative_Money_Flow_Sum <= 8.44437e+09 )
				if( Typical_Price <= 14.38 )
					if( Raw_Money_Flow <= 1.02244e+09 )
						ret := 0.014019
					if( Raw_Money_Flow > 1.02244e+09 )
						ret := 0.655172
				if( Typical_Price > 14.38 )
...
float op_operation = decision_tree_0_NIO_1Day_26376b97(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
