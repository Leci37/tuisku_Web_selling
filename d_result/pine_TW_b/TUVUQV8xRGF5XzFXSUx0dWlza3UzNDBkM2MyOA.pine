			...
			if( midLine > 12.0275 )
				if( wvf <= 35.4282 )
					...
					if( midLine > 14.542 )
						ret := -0.413462
				if( wvf > 35.4282 )
					if( upperBand <= 37.1903 )
						ret := 0.000000
					if( upperBand > 37.1903 )
						ret := 1.000000 // buy
		if( midLine > 21.0245 )
			if( wvf <= 33.844 )
				if( Color_con1 <= -28.5118 )
					if( upperBand <= 50.543 )
						ret := 1.000000 // buy
					if( upperBand > 50.543 )
						ret := 0.000000
				if( Color_con1 > -28.5118 )
					if( Color_con1 <= -20.0939 )
						ret := -0.409091
					if( Color_con1 > -20.0939 )
						ret := 0.896552 // buy
			if( wvf > 33.844 )
...
float op_operation = decision_tree_0_META_1Day_340d3c28(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
