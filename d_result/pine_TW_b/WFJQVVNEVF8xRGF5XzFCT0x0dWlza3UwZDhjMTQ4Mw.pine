			...
			if( BBlower > 0.313033 )
				if( BBupper <= 0.701119 )
					...
					if( BBlower > 0.447788 )
						ret := -0.600000
				if( BBupper > 0.701119 )
					if( dif_source_BBlower <= 0.302804 )
						ret := -0.400000
					if( dif_source_BBlower > 0.302804 )
						ret := -0.833333 // sell
...
float op_operation = decision_tree_0_XRPUSDT_1Day_0d8c1483(BBupper, BBlower, crossover_rsi_bblowerInt, vrsi, dif_source_BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower)
