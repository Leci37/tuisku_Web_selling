				...
				if( rangema <= 5.22618 )
					...
					if( rangema > 4.37516 )
						...
						if( val > -0.777296 )
							ret := -0.764259 // sell
				if( rangema > 5.22618 )
					if( priceRange <= 4.07737 )
						if( dev <= 5.7354 )
							ret := 0.307692
						if( dev > 5.7354 )
							ret := -0.725000 // sell
					if( priceRange > 4.07737 )
						if( avgHighLow <= 188.08 )
							ret := 0.554054
						if( avgHighLow > 188.08 )
							ret := 0.000000
		if( dev > 6.72386 )
				...
				if( sqzOnInt <= 0.5 )
					if( val <= 0.56083 )
						...
						if( basis > 136.898 )
							ret := -0.056135
					if( val > 0.56083 )
						if( avgHighLow <= 218.335 )
							ret := 0.445415
						if( avgHighLow > 218.335 )
							ret := -0.777778 // sell
				if( sqzOnInt > 0.5 )
					if( avgHighLow <= 163.125 )
						if( basis <= 138.91 )
							ret := 0.923077 // buy
						if( basis > 138.91 )
							ret := -0.477612
...
float op_operation = decision_tree_0_SOLUSDT_1Hour_26fd7ec2(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
