			...
			if( BBupper <= 37938.8 )
				...
				if( BBlower > 4934.55 )
					...
					if( BBlower > 5618.77 )
						ret := 0.509804
			if( BBupper > 37938.8 )
				if( dif_source_BBupper <= 5758.21 )
					if( BBlower <= 15255 )
						ret := -0.727273 // sell
					if( BBlower > 15255 )
						ret := -0.033333
				if( dif_source_BBupper > 5758.21 )
					if( dif_source_BBupper <= 7452.92 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > 7452.92 )
						ret := 0.000000
...
float op_operation = decision_tree_0_BTCUSDT_1Day_4166b2d5(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
