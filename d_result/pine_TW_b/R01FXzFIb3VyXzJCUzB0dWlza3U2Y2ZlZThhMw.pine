		...
		if( bbp <= -7.56819 )
			...
			if( d_k > -15.8533 )
				...
				if( smoothK_k > 28.5979 )
					ret := 0.543027
		if( bbp > -7.56819 )
			if( bearPower <= -2.83446 )
				if( smoothK_k <= 88.9323 )
					if( k <= 21.9383 )
						if( rsi1 <= 57.7245 )
							ret := -0.171429
						if( rsi1 > 57.7245 )
...
float op_operation = decision_tree_0_GME_1Hour_6cfee8a3(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
