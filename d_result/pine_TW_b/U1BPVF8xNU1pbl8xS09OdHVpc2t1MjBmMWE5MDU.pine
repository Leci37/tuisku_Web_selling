...
decision_tree_0_SPOT_15Min_20f1a905(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)=>
	...
	if( BollOsc > -32.4029 )
		...
		if( media_azul > 62.6296 )
			...
			if( media > 116.177 )
				if( pvimax <= 0.048817 )
					if( marron_mean <= 129.712 )
						if( verde_media <= 35.9895 )
							ret := -0.609756
						if( verde_media > 35.9895 )
							ret := 0.470588
					if( marron_mean > 129.712 )
...
float op_operation = decision_tree_0_SPOT_15Min_20f1a905(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
