				...
				if( upperKC > 52.3462 )
					...
					if( lowerBB > 46.4429 )
						...
						if( lowerBB > 47.8924 )
							ret := 0.480198
			if( basis > 57.5672 )
				if( avgHighLow <= 64.8479 )
					if( avgHighLow <= 63.0695 )
						if( upperKC <= 62.5767 )
							ret := -0.500000
						if( upperKC > 62.5767 )
							ret := 0.579710
...
float op_operation = decision_tree_0_RUN_1Hour_0c42a118(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
