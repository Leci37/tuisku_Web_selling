			...
			if( Negative_Money_Flow <= 3.05348e+08 )
				if( Short_Long_Diff <= 0.698134 )
					...
					if( Short_MA > 14.6117 )
						ret := -0.480363
				if( Short_Long_Diff > 0.698134 )
					if( Negative_Money_Flow_Sum <= 1.09234e+09 )
						ret := -0.009434
					if( Negative_Money_Flow_Sum > 1.09234e+09 )
						ret := -0.704545 // sell
			if( Negative_Money_Flow > 3.05348e+08 )
				if( Short_Long_Diff <= 5.3289 )
					ret := 1.000000 // buy
				if( Short_Long_Diff > 5.3289 )
					ret := 0.285714
		if( Positive_Money_Flow > 1.56792e+08 )
			if( MFI_High <= -18.503 )
				if( Positive_Money_Flow <= 2.48476e+08 )
					ret := 0.444444
				if( Positive_Money_Flow > 2.48476e+08 )
					if( Long_MA <= 107.509 )
						ret := -0.923077 // sell
					if( Long_MA > 107.509 )
						ret := -0.500000
			if( MFI_High > -18.503 )
				if( Positive_Money_Flow_Sum <= 2.97484e+09 )
					if( Positive_Money_Flow_Sum <= 2.35217e+09 )
						ret := 0.893617 // buy
					if( Positive_Money_Flow_Sum > 2.35217e+09 )
						ret := 0.545455
				if( Positive_Money_Flow_Sum > 2.97484e+09 )
...
float op_operation = decision_tree_0_ASAN_1Day_0f383003(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
