			...
			if( Typical_Price > 18.7494 )
				if( MFI_Low <= 43.3908 )
					...
					if( Positive_Money_Flow_Sum > 8.12557e+08 )
						ret := 0.500000
				if( MFI_Low > 43.3908 )
					if( Positive_Money_Flow_Sum <= 1.6223e+09 )
						ret := 0.051020
					if( Positive_Money_Flow_Sum > 1.6223e+09 )
						ret := -0.857143 // sell
		if( Typical_Price > 33.2693 )
			if( Negative_Money_Flow_Sum <= 8.30517e+08 )
				if( Positive_Money_Flow_Sum <= 7.65059e+08 )
					if( Positive_Money_Flow <= 4.04041e+07 )
						ret := -0.379310
					if( Positive_Money_Flow > 4.04041e+07 )
						ret := 0.285714
				if( Positive_Money_Flow_Sum > 7.65059e+08 )
					if( Positive_Money_Flow_Sum <= 3.17499e+09 )
						ret := 0.942529 // buy
					if( Positive_Money_Flow_Sum > 3.17499e+09 )
						ret := 0.363636
			if( Negative_Money_Flow_Sum > 8.30517e+08 )
				if( Negative_Money_Flow <= 2.87914e+08 )
					if( Negative_Money_Flow_Sum <= 2.21827e+09 )
						ret := -0.584416
					if( Negative_Money_Flow_Sum > 2.21827e+09 )
						ret := 0.500000
				if( Negative_Money_Flow > 2.87914e+08 )
...
float op_operation = decision_tree_0_ASAN_1Day_7cb3b6e0(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
