	...
	if( bullPower <= 0.277088 )
		...
		if( VIP_VIM > 0.303702 )
			...
			if( bearPower > 0.05546 )
				ret := 0.064103
	if( bullPower > 0.277088 )
		if( bearPower <= 0.125706 )
			if( VIM <= 1.29565 )
				if( bullPower <= 2.36011 )
					if( VIP <= 1.08129 )
						if( bearPower <= -0.870554 )
							ret := -0.027237
						if( bearPower > -0.870554 )
							ret := -0.287417
					if( VIP > 1.08129 )
						if( bearPower <= -0.59223 )
							ret := 0.531532
						if( bearPower > -0.59223 )
							ret := -0.139171
				if( bullPower > 2.36011 )
...
float op_operation = decision_tree_0_SNAP_1Hour_ab9e8323(bbm, bearPower, bbp, bullPower, BBPower_Color, VIP_VIM, VIM, VIP)
