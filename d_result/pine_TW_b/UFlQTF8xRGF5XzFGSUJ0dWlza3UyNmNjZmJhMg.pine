...
decision_tree_0_PYPL_1Day_26ccfba2(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( upper_3 > 289.684 )
		...
		if( basis_minus > 58.6431 )
			...
			if( upper_1 > 268.093 )
				if( lower_4 <= 206.991 )
					if( basis_minus <= 84.2464 )
						ret := 0.933333 // buy
					if( basis_minus > 84.2464 )
						ret := 0.000000
				if( lower_4 > 206.991 )
					if( basis_max <= -63.8269 )
						ret := -0.631579
					if( basis_max > -63.8269 )
						ret := 0.357143
...
float op_operation = decision_tree_0_PYPL_1Day_26ccfba2(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
