				...
				if( lowerBB > 26.5719 )
					if( rangema <= 0.126817 )
						...
						if( priceRange > 0.090116 )
							ret := 1.000000 // buy
					if( rangema > 0.126817 )
						if( avgHighLow <= 27.1467 )
							ret := -0.089286
						if( avgHighLow > 27.1467 )
							ret := 0.509615
			if( upperKC > 27.9648 )
				if( avgHighLow <= 27.6853 )
					if( rangema <= 0.457287 )
						if( basis <= 27.4262 )
							ret := 0.714286 // buy
						if( basis > 27.4262 )
				...
				if( basis <= 27.7424 )
					if( val <= -0.02779 )
						...
						if( dev > 0.526163 )
							ret := -0.875000 // sell
					if( val > -0.02779 )
						if( avgHighLow <= 27.8035 )
							ret := -0.006386
						if( avgHighLow > 27.8035 )
							ret := -0.921053 // sell
				if( basis > 27.7424 )
					if( ma <= 27.7962 )
						if( priceRange <= 0.123241 )
							ret := -0.176471
						if( priceRange > 0.123241 )
							ret := 0.708955 // buy
					if( ma > 27.7962 )
...
float op_operation = decision_tree_0_UBER_30Min_f48b9ec0(lowerBB, noSqzInt, avgHighLow, rangema, sqzOffInt, upperKC, ma, basis, val, sqzOnInt, dev, priceRange, lowerKC, upperBB)
