		...
		if( bearPower <= -2.4568 )
			if( bullPower <= 4.4768 )
				...
				if( bullPower > 4.3215 )
					ret := -1.000000 // sell
			if( bullPower > 4.4768 )
				if( bearPower <= -2.97751 )
					ret := -0.277778
				if( bearPower > -2.97751 )
					ret := 0.133333
		if( bearPower > -2.4568 )
			if( bearPower <= -1.39638 )
				if( bbp <= 2.45819 )
					if( bearPower <= -1.66308 )
						ret := -0.083333
					if( bearPower > -1.66308 )
						ret := 0.357143
				if( bbp > 2.45819 )
					if( bearPower <= -1.79545 )
						ret := 0.818182 // buy
					if( bearPower > -1.79545 )
						ret := 0.600000
			if( bearPower > -1.39638 )
				if( bullPower <= 1.70976 )
					if( bearPower <= -0.77713 )
						ret := -0.750000 // sell
					if( bearPower > -0.77713 )
						ret := 0.193878
				if( bullPower > 1.70976 )
...
float op_operation = decision_tree_0_MSFT_1Day_3dfa3e26(bearPower, bbm, bbp, bullPower, BBPower_Color)
