			...
			if( bullPower <= 3.94861 )
				...
				if( Upper_Band > 59.9295 )
					...
					if( bbp > 5.70843 )
						ret := 0.500000
			if( bullPower > 3.94861 )
				if( bullPower <= 7.52846 )
					ret := 0.690476
				if( bullPower > 7.52846 )
					ret := -1.000000 // sell
	if( Lower_Band > 52.5519 )
		if( bbp <= 6.53715 )
			if( bullPower <= -1.71652 )
				if( bbm <= 0.444175 )
					ret := 0.910714 // buy
				if( bbm > 0.444175 )
					ret := 0.220183
			if( bullPower > -1.71652 )
				if( basis <= 117.047 )
					...
					if( basis > 114.854 )
						ret := 0.795455 // buy
				if( basis > 117.047 )
					if( Upper_Band <= 129.781 )
						ret := -0.316092
					if( Upper_Band > 129.781 )
						ret := -0.677966
		if( bbp > 6.53715 )
			if( bullPower <= 5.86896 )
				if( Lower_Band <= 94.2119 )
					ret := -0.250000
				if( Lower_Band > 94.2119 )
					ret := 1.000000 // buy
			if( bullPower > 5.86896 )
...
float op_operation = decision_tree_0_GTLB_30Min_d9df0cf3(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
