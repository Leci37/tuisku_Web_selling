			...
			if( bearPower <= -0.061082 )
				...
				if( bbm > 2.63612 )
					...
					if( bbm > 2.85911 )
						ret := 0.166667
			if( bearPower > -0.061082 )
				if( bearPower <= -0.029727 )
					ret := 1.000000 // buy
				if( bearPower > -0.029727 )
					ret := 0.000000
		if( bbp > 0.256562 )
			if( bearPower <= -0.370363 )
				if( bearPower <= -0.682097 )
					if( bbm <= 2.995 )
						ret := -0.681818
					if( bbm > 2.995 )
						ret := 0.056604
			...
			if( bearPower > -0.370363 )
				if( bbm <= 0.4433 )
					if( bullPower <= 0.309761 )
						ret := 0.166667
					if( bullPower > 0.309761 )
						ret := -0.285714
				if( bbm > 0.4433 )
					if( bullPower <= 1.65178 )
						ret := 0.361345
					if( bullPower > 1.65178 )
						ret := 0.087302
...
float op_operation = decision_tree_0_ETSY_1Day_aed5f47d(bearPower, bbm, bbp, bullPower, BBPower_Color)
