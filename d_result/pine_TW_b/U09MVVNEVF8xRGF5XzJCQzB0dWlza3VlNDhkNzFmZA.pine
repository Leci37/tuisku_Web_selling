...
decision_tree_0_SOLUSDT_1Day_e48d71fd(bbm, bearPower, bbp, bullPower, BBPower_Color, mf, ad, ad_mf)=>
	...
	if( mf > -0.007568 )
		...
		if( bbm > 2.38926 )
			...
			if( ad > -3.49662e+06 )
				if( ad <= 3.57574e+06 )
					if( ad_mf <= -3.30614e+06 )
						ret := -0.952381 // sell
					if( ad_mf > -3.30614e+06 )
						ret := 0.003559
				if( ad > 3.57574e+06 )
					if( ad_mf <= 5.59614e+06 )
						ret := 0.529915
					if( ad_mf > 5.59614e+06 )
						ret := 0.151899
...
float op_operation = decision_tree_0_SOLUSDT_1Day_e48d71fd(bbm, bearPower, bbp, bullPower, BBPower_Color, mf, ad, ad_mf)
