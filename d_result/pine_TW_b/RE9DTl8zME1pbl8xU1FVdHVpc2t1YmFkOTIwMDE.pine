	...
	if( ma > 42.1594 )
		if( upperBB <= 45.8108 )
			if( ma <= 44.0486 )
				if( lowerKC <= 41.3541 )
					if( lowerBB <= 40.6127 )
						if( priceRange <= 0.846592 )
							ret := 0.444444
						if( priceRange > 0.846592 )
							ret := -0.541667
					if( lowerBB > 40.6127 )
						if( avgHighLow <= 43.0379 )
							ret := -0.972222 // sell
						if( avgHighLow > 43.0379 )
							ret := 0.000000
				if( lowerKC > 41.3541 )
...
float op_operation = decision_tree_0_DOCN_30Min_bad92001(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
