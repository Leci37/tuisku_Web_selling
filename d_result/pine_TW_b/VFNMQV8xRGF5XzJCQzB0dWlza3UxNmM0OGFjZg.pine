...
decision_tree_0_TSLA_1Day_16c48acf(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)=>
	...
	if( bearPower > -5.78499 )
		if( bullPower <= 145.192 )
			if( ad <= 539569 )
				if( ad <= -1.92354e+07 )
					if( ad_mf <= -3.79381e+07 )
						ret := 0.107143
					if( ad_mf > -3.79381e+07 )
						ret := 0.714286 // buy
				if( ad > -1.92354e+07 )
					if( bearPower <= 50.0208 )
						ret := -0.032468
					if( bearPower > 50.0208 )
						ret := -0.870968 // sell
			if( ad > 539569 )
...
float op_operation = decision_tree_0_TSLA_1Day_16c48acf(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)
