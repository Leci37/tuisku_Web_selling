			...
			if( Negative_Money_Flow_Sum <= 704029 )
				if( Money_Flow_Ratio <= 30.3404 )
					...
					if( MFI > 95.1994 )
						ret := -0.697917
				if( Money_Flow_Ratio > 30.3404 )
					if( bearPower <= -0.212801 )
						ret := 0.837209 // buy
					if( bearPower > -0.212801 )
						ret := 0.020588
			if( Negative_Money_Flow_Sum > 704029 )
				if( Typical_Price <= 33.5268 )
					if( bullPower <= -0.014519 )
						ret := 0.212329
					if( bullPower > -0.014519 )
						ret := 0.010010
				if( Typical_Price > 33.5268 )
					if( Raw_Money_Flow <= 3.86708e+07 )
						ret := -0.525714
					if( Raw_Money_Flow > 3.86708e+07 )
						ret := 0.400000
		if( bearPower > 0.189186 )
			if( bbm <= 0.049645 )
				if( Typical_Price <= 17.7731 )
					ret := 0.236842
				if( Typical_Price > 17.7731 )
					if( bearPower <= 0.238271 )
						ret := -0.360976
					if( bearPower > 0.238271 )
						ret := -0.678208
			if( bbm > 0.049645 )
				if( Positive_Money_Flow <= 5.10099e+06 )
					if( Raw_Money_Flow <= 95855 )
						ret := -0.585551
					if( Raw_Money_Flow > 95855 )
						ret := -0.105364
				if( Positive_Money_Flow > 5.10099e+06 )
...
float op_operation = decision_tree_0_DBX_15Min_e8d84cdd(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
