	...
	if( Positive_Money_Flow_Sum > 4.94523e+09 )
		if( Negative_Money_Flow <= 3.73161e+06 )
			if( Money_Flow_Ratio <= 2.08326 )
				ret := -0.764706 // sell
			if( Money_Flow_Ratio > 2.08326 )
				if( Negative_Money_Flow_Sum <= 2.17757e+09 )
					ret := -0.800000 // sell
				if( Negative_Money_Flow_Sum > 2.17757e+09 )
					ret := 0.538462
		if( Negative_Money_Flow > 3.73161e+06 )
			if( Negative_Money_Flow_Sum <= 2.61464e+09 )
				ret := -0.642857
			if( Negative_Money_Flow_Sum > 2.61464e+09 )
				if( Negative_Money_Flow_Sum <= 3.13846e+09 )
					ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 3.13846e+09 )
					if( Negative_Money_Flow_Sum <= 4.64009e+09 )
						ret := -0.666667
					if( Negative_Money_Flow_Sum > 4.64009e+09 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_DOTUSDT_1Day_5de52097(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
