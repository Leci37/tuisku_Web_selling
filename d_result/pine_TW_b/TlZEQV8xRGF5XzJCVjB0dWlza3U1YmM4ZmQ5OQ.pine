		...
		if( VIM <= 0.918273 )
			if( bearPower <= -2.5396 )
				...
				if( VIP > 1.31421 )
					ret := 1.000000 // buy
			if( bearPower > -2.5396 )
				if( bullPower <= 68.9791 )
					if( bearPower <= 10.1814 )
						ret := -0.071256
					if( bearPower > 10.1814 )
						ret := 0.265372
				if( bullPower > 68.9791 )
...
float op_operation = decision_tree_0_NVDA_1Day_5bc8fd99(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
