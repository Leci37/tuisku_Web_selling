		...
		if( chinkou_span > 108.299 )
			if( senkou_span_a_displaced <= 108.736 )
				if( senkou_span_a <= 106.79 )
					if( tenkan_sen <= 104.229 )
						ret := 0.808290 // buy
					if( tenkan_sen > 104.229 )
						ret := 0.538776
				if( senkou_span_a > 106.79 )
					if( senkou_span_b <= 104.736 )
						ret := -0.846154 // sell
					if( senkou_span_b > 104.736 )
						if( basis_max <= -1.11375 )
							ret := -0.013423
						if( basis_max > -1.11375 )
							ret := 0.442368
			if( senkou_span_a_displaced > 108.736 )
				if( chinkou_span <= 120.167 )
					if( senkou_span_a <= 113.469 )
						if( chinkou_span <= 114.307 )
							ret := 0.038835
						if( chinkou_span > 114.307 )
							ret := 0.571429
					if( senkou_span_a > 113.469 )
						if( tenkan_sen <= 121.763 )
							ret := -0.179198
						if( tenkan_sen > 121.763 )
							ret := -0.559259
				if( chinkou_span > 120.167 )
					if( senkou_span_a <= 119.526 )
						if( chinkou_span <= 121.476 )
							ret := 0.361702
						if( chinkou_span > 121.476 )
							ret := 0.691395
					if( senkou_span_a > 119.526 )
						if( senkou_span_b <= 117.842 )
							ret := 0.853659 // buy
						if( senkou_span_b > 117.842 )
							ret := 0.072299
	if( senkou_span_b > 160.841 )
...
float op_operation = decision_tree_0_PTON_30Min_622ea8ca(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
