		...
		if( bbp > 0.009278 )
			if( VIM <= 0.605209 )
				if( VIP_VIM <= 0.695537 )
					ret := 1.000000 // buy
				if( VIP_VIM > 0.695537 )
					if( bearPower <= 0.01548 )
						ret := -0.583333
					if( bearPower > 0.01548 )
						ret := 0.153846
			if( VIM > 0.605209 )
				if( VIP <= 1.18992 )
					if( bearPower <= 0.009233 )
						ret := -0.315315
					if( bearPower > 0.009233 )
						ret := 0.750000 // buy
				if( VIP > 1.18992 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_bb2d9a86(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
