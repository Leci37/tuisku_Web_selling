	...
	if( vrsi > 22.8116 )
		...
		if( BBupper > 92.8806 )
			if( BBupper <= 303.81 )
				if( BBupper <= 210.018 )
					if( BBupper <= 203.988 )
						if( dif_source_BBupper <= -20.7444 )
							ret := 0.645714
						if( dif_source_BBupper > -20.7444 )
							ret := 0.003512
					if( BBupper > 203.988 )
						if( dif_source_BBupper <= -8.66353 )
							ret := -0.294434
						if( dif_source_BBupper > -8.66353 )
							ret := -0.639118
				if( BBupper > 210.018 )
					if( dif_source_BBupper <= -5.56004 )
						if( dif_source_BBlower <= 6.93944 )
							ret := 0.022045
						if( dif_source_BBlower > 6.93944 )
							ret := 0.190788
					if( dif_source_BBupper > -5.56004 )
...
float op_operation = decision_tree_0_NFLX_30Min_5253b686(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
