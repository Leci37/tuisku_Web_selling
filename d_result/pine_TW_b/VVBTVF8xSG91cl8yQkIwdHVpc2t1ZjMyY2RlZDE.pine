				...
				if( Lower_Band > 15.5766 )
					...
					if( basis > 18.9244 )
						...
						if( Lower_Band > 64.3669 )
							ret := -0.542169
			if( basis > 69.3527 )
				if( Upper_Band <= 129.336 )
					if( Upper_Band <= 113.661 )
						if( basis <= 105.071 )
							ret := 0.294041
						if( basis > 105.071 )
							ret := 0.925234 // buy
					if( Upper_Band > 113.661 )
						if( Lower_Band <= 100.058 )
							ret := 0.601695
						if( Lower_Band > 100.058 )
							ret := -0.120527
				if( Upper_Band > 129.336 )
					ret := 0.790909 // buy
		if( basis > 122.814 )
			if( Upper_Band <= 134.587 )
				ret := -0.560209
			if( Upper_Band > 134.587 )
				if( Upper_Band <= 154.297 )
					if( Lower_Band <= 127.116 )
						if( bbp <= 5.276 )
							ret := -0.538462
						if( bbp > 5.276 )
							ret := 0.658228
					if( Lower_Band > 127.116 )
						ret := 0.731818 // buy
				if( Upper_Band > 154.297 )
					if( Lower_Band <= 157.123 )
						if( bbm <= 0.881188 )
							ret := 0.018868
						if( bbm > 0.881188 )
							ret := -0.684588
					if( Lower_Band > 157.123 )
						if( Upper_Band <= 207.902 )
							ret := 0.438596
						if( Upper_Band > 207.902 )
							ret := -0.114062
...
float op_operation = decision_tree_0_UPST_1Hour_f32cded1(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
