			...
			if( smoothD_d > 29.4835 )
				...
				if( d > 51.5887 )
					...
					if( MFI_Low > 29.0118 )
						ret := -0.458333
	if( MFI > 51.3109 )
		if( Typical_Price <= 214.128 )
			if( Negative_Money_Flow_Sum <= 3.70476e+10 )
				if( k <= 95.524 )
					if( MFI <= 63.4607 )
						ret := 0.082857
					if( MFI > 63.4607 )
						ret := -0.214844
				if( k > 95.524 )
					if( Positive_Money_Flow_Sum <= 3.38794e+10 )
						ret := 0.469880
					if( Positive_Money_Flow_Sum > 3.38794e+10 )
						ret := -0.200000
			if( Negative_Money_Flow_Sum > 3.70476e+10 )
				if( smoothD_d <= 43.8921 )
					if( Raw_Money_Flow <= 8.17933e+09 )
						ret := 0.608696
					if( Raw_Money_Flow > 8.17933e+09 )
						ret := -0.846154 // sell
				if( smoothD_d > 43.8921 )
					if( smoothK_k <= 87.5061 )
						ret := 0.571429
					if( smoothK_k > 87.5061 )
						ret := 1.000000 // buy
		if( Typical_Price > 214.128 )
			if( MFI <= 75.9065 )
				if( Raw_Money_Flow <= 1.02959e+10 )
					if( Positive_Money_Flow_Sum <= 6.67754e+10 )
						ret := 0.142857
					if( Positive_Money_Flow_Sum > 6.67754e+10 )
						ret := -0.282051
				if( Raw_Money_Flow > 1.02959e+10 )
			...
			if( MFI > 75.9065 )
				if( d_k <= 2.59769 )
					if( Money_Flow_Ratio <= 3.57305 )
						ret := 0.238095
					if( Money_Flow_Ratio > 3.57305 )
						ret := -0.095238
				if( d_k > 2.59769 )
					if( Positive_Money_Flow_Sum <= 8.41611e+10 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 8.41611e+10 )
						ret := 0.200000
...
float op_operation = decision_tree_0_MSFT_1Day_50b61580(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
