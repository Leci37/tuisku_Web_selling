		...
		if( senkou_span_a <= 53.7999 )
			if( basis_minus <= 0.115 )
				if( senkou_span_a_displaced <= 53.3099 )
					ret := 0.869159 // buy
				if( senkou_span_a_displaced > 53.3099 )
					if( basis_max <= -0.023715 )
						if( senkou_span_a_displaced <= 53.9532 )
							ret := 0.456522
						if( senkou_span_a_displaced > 53.9532 )
							ret := -0.800000 // sell
					if( basis_max > -0.023715 )
			...
			if( basis_minus > 0.115 )
				ret := 0.227848
		if( senkou_span_a > 53.7999 )
			if( tenkan_sen <= 101.376 )
				if( chinkou_span <= 93.5013 )
					if( tenkan_sen <= 94.4182 )
						if( basis_max <= 0.6252 )
							ret := -0.004981
						if( basis_max > 0.6252 )
							ret := 0.281059
					if( tenkan_sen > 94.4182 )
						ret := -0.775316 // sell
				if( chinkou_span > 93.5013 )
					if( senkou_span_a <= 94.6694 )
						if( kinjun_sen <= 92.6384 )
							ret := 0.802120 // buy
						if( kinjun_sen > 92.6384 )
							ret := 0.483032
					if( senkou_span_a > 94.6694 )
						if( chinkou_span <= 95.875 )
							ret := -0.314851
						if( chinkou_span > 95.875 )
							ret := 0.164673
			if( tenkan_sen > 101.376 )
				if( basis_max <= -0.001857 )
					ret := -0.738462 // sell
				if( basis_max > -0.001857 )
					if( chinkou_span <= 99.7579 )
						ret := -0.923077 // sell
					if( chinkou_span > 99.7579 )
						ret := 0.268293
...
float op_operation = decision_tree_0_ETSY_5Min_4e33a8ae(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
