			...
			if( Negative_Money_Flow_Sum <= 2.18111e+09 )
				if( rsi1 <= 63.2888 )
					...
					if( MFI_Low > 15.6931 )
						ret := -0.611888
				if( rsi1 > 63.2888 )
					if( Positive_Money_Flow_Sum <= 2.05503e+09 )
						ret := 0.287129
					if( Positive_Money_Flow_Sum > 2.05503e+09 )
						ret := -0.307229
			if( Negative_Money_Flow_Sum > 2.18111e+09 )
				if( Negative_Money_Flow <= 7.53131e+08 )
					if( Negative_Money_Flow_Sum <= 3.68667e+09 )
						ret := 0.682353
					if( Negative_Money_Flow_Sum > 3.68667e+09 )
						ret := 0.306818
				if( Negative_Money_Flow > 7.53131e+08 )
					...
					if( d_k > 11.0098 )
						ret := 0.000000
		if( Positive_Money_Flow_Sum > 4.39041e+09 )
			if( Negative_Money_Flow_Sum <= 2.3603e+09 )
				if( Positive_Money_Flow_Sum <= 7.7411e+09 )
					if( Typical_Price <= 1539.62 )
						ret := 0.623762
					if( Typical_Price > 1539.62 )
						ret := 0.000000
				if( Positive_Money_Flow_Sum > 7.7411e+09 )
...
float op_operation = decision_tree_0_MELI_1Day_7a80241b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
