...
decision_tree_0_SHOP_1Day_75ac5f4d(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)=>
	...
	if( adx > 28.0959 )
			...
			if( trueRange <= 6.59075 )
				if( diMinus <= 32.339 )
					...
					if( diMinus > 26.7919 )
						ret := -0.412500
				if( diMinus > 32.339 )
					if( directionalMovementPlus <= 0.008911 )
						ret := 0.362500
					if( directionalMovementPlus > 0.008911 )
						ret := 0.690722
			if( trueRange > 6.59075 )
				if( smoothedTrueRange <= 7.05104 )
					if( adx <= 54.2738 )
						ret := -0.848101 // sell
					if( adx > 54.2738 )
						ret := 0.142857
		...
		if( smoothedDirectionalMovementPlus > 1.32255 )
			if( dx <= 4.86299 )
				if( smoothedDirectionalMovementMinus <= 1.38764 )
					ret := -0.500000
				if( smoothedDirectionalMovementMinus > 1.38764 )
					if( smoothedDirectionalMovementMinus <= 11.7687 )
						ret := 0.809524 // buy
					if( smoothedDirectionalMovementMinus > 11.7687 )
						ret := 0.000000
			if( dx > 4.86299 )
				if( diMinus <= 21.6551 )
					...
					if( adx > 33.108 )
						ret := -0.223176
				if( diMinus > 21.6551 )
					if( smoothedDirectionalMovementPlus <= 14.0186 )
						ret := -0.324645
					if( smoothedDirectionalMovementPlus > 14.0186 )
						ret := -0.914286 // sell
...
float op_operation = decision_tree_0_SHOP_1Day_75ac5f4d(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)
