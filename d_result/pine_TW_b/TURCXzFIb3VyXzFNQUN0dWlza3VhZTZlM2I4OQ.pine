...
float op_operation = decision_tree_0_MDB_1Hour_ae6e3b89(macd, macd_IsBelowInt, signal, histB_IsUpInt, macd_IsAboveInt, histB_IsDownInt, histA_IsUpInt, hist, histA_IsDownInt)
