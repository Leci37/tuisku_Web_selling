...
decision_tree_0_DBX_5Min_f0966fec(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( bbp > -0.299692 )
				...
				if( Negative_Money_Flow_Sum > 352976 )
					...
					if( Positive_Money_Flow_Sum > 2.47831e+07 )
						...
						if( bullPower > 0.131034 )
							ret := 0.180952
			if( Positive_Money_Flow_Sum > 3.24832e+07 )
				if( Positive_Money_Flow_Sum <= 5.27297e+07 )
					if( bbm <= 0.044767 )
						if( bbp <= 0.090112 )
							ret := 0.706587 // buy
						if( bbp > 0.090112 )
		...
		if( bbp > 0.228511 )
			if( bbm <= 0.034856 )
				if( Typical_Price <= 22.2234 )
					ret := -0.064516
				if( Typical_Price > 22.2234 )
					ret := -0.703872 // sell
			if( bbm > 0.034856 )
				if( Positive_Money_Flow_Sum <= 1.18948e+07 )
					if( MFI <= 71.4811 )
						if( Positive_Money_Flow <= 170851 )
							ret := -0.815789 // sell
						if( Positive_Money_Flow > 170851 )
							ret := -0.390071
					if( MFI > 71.4811 )
						ret := -0.158576
				if( Positive_Money_Flow_Sum > 1.18948e+07 )
					if( Money_Flow_Ratio <= 4.38071 )
						if( Positive_Money_Flow_Sum <= 4.57272e+07 )
							ret := 0.214592
						if( Positive_Money_Flow_Sum > 4.57272e+07 )
							ret := -1.000000 // sell
					if( Money_Flow_Ratio > 4.38071 )
...
float op_operation = decision_tree_0_DBX_5Min_f0966fec(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
