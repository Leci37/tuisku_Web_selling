				...
				if( MFI > 18.1672 )
					if( MFI <= 52.7843 )
						...
						if( Positive_Money_Flow_Sum > 910598 )
							ret := 0.334850
					if( MFI > 52.7843 )
						if( Negative_Money_Flow_Sum <= 5.1031e+07 )
							ret := 0.394592
						if( Negative_Money_Flow_Sum > 5.1031e+07 )
							ret := -0.329545
			if( rsi1 > 58.3411 )
				if( d_k <= -2.74585 )
					ret := -0.409543
				if( d_k > -2.74585 )
					if( Positive_Money_Flow_Sum <= 1.11536e+08 )
						ret := 0.002863
					if( Positive_Money_Flow_Sum > 1.11536e+08 )
						ret := -0.677966
		if( Raw_Money_Flow > 282828 )
			if( MFI_Low <= -16.505 )
				if( MFI <= 0.540635 )
					ret := 0.417722
				if( MFI > 0.540635 )
					if( Raw_Money_Flow <= 6.87205e+06 )
						ret := -0.125541
					if( Raw_Money_Flow > 6.87205e+06 )
						if( Negative_Money_Flow_Sum <= 2.11672e+07 )
							ret := -0.115942
						if( Negative_Money_Flow_Sum > 2.11672e+07 )
							ret := -0.850340 // sell
			if( MFI_Low > -16.505 )
				if( Negative_Money_Flow_Sum <= 2.38154e+08 )
					if( Typical_Price <= 63.1692 )
						if( rsi1 <= 13.0033 )
							ret := -0.609756
						if( rsi1 > 13.0033 )
							ret := 0.343458
					if( Typical_Price > 63.1692 )
						if( Negative_Money_Flow_Sum <= 575791 )
							ret := 0.812500 // buy
						if( Negative_Money_Flow_Sum > 575791 )
							ret := -0.012239
				if( Negative_Money_Flow_Sum > 2.38154e+08 )
...
float op_operation = decision_tree_0_TTD_5Min_13f31b93(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, rsi1, d, k, smoothD_d, d_k, smoothK_k)
