	...
	if( MFI_Low > -15.057 )
		if( Short_Long_Diff <= 0.041808 )
			...
			if( Negative_Money_Flow_Sum > 3.66172e+08 )
				...
				if( MFI > 10.2608 )
					if( MFI <= 64.4325 )
						if( Positive_Money_Flow_Sum <= 4.2666e+08 )
							ret := 0.069030
						if( Positive_Money_Flow_Sum > 4.2666e+08 )
							ret := -0.189189
					if( MFI > 64.4325 )
						ret := 0.821429 // buy
		if( Short_Long_Diff > 0.041808 )
			if( Short_Long_Diff <= 13.0701 )
				if( Long_MA <= 44.6921 )
					if( Raw_Money_Flow <= 6.00076e+06 )
						ret := 0.647619
					if( Raw_Money_Flow > 6.00076e+06 )
						ret := 0.194444
				if( Long_MA > 44.6921 )
					if( Positive_Money_Flow_Sum <= 1.62121e+08 )
						if( MFI_High <= 1.81336 )
							ret := 0.103022
						if( MFI_High > 1.81336 )
							ret := 0.820000 // buy
					if( Positive_Money_Flow_Sum > 1.62121e+08 )
						if( Positive_Money_Flow_Sum <= 2.18769e+08 )
							ret := -0.085986
						if( Positive_Money_Flow_Sum > 2.18769e+08 )
							ret := 0.063912
			if( Short_Long_Diff > 13.0701 )
...
float op_operation = decision_tree_0_TTD_1Hour_691eba83(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
