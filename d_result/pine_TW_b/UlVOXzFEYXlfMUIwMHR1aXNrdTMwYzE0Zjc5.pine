			...
			if( bbp > 0.138807 )
				...
				if( bearPower > 0.740235 )
					...
					if( bearPower > 1.12221 )
						ret := -0.176471
	if( bbm > 0.890425 )
		if( bearPower <= -3.40083 )
			if( bullPower <= -4.53413 )
				if( bbp <= -14.2592 )
					ret := 0.000000
				if( bbp > -14.2592 )
					if( bullPower <= -4.86954 )
						ret := 0.500000
					if( bullPower > -4.86954 )
						ret := 1.000000 // buy
			if( bullPower > -4.53413 )
				if( bearPower <= -3.76699 )
					if( bbp <= -9.34232 )
						ret := -0.750000 // sell
					if( bbp > -9.34232 )
						ret := -0.164474
				if( bearPower > -3.76699 )
					...
					if( bbp > -4.1336 )
						ret := -0.111111
		if( bearPower > -3.40083 )
			if( bullPower <= -0.118424 )
				if( bbp <= -3.13175 )
					if( bullPower <= -1.64443 )
						ret := -0.129032
					if( bullPower > -1.64443 )
						ret := 0.729730 // buy
				if( bbp > -3.13175 )
					if( bullPower <= -0.865413 )
						ret := -0.760000 // sell
					if( bullPower > -0.865413 )
						ret := 0.292308
			if( bullPower > -0.118424 )
				if( bearPower <= -0.292759 )
					if( bullPower <= 2.1699 )
						ret := -0.363817
					if( bullPower > 2.1699 )
						ret := 0.136842
...
float op_operation = decision_tree_0_RUN_1Day_30c14f79(bbm, bearPower, bbp, bullPower, BBPower_Color)
