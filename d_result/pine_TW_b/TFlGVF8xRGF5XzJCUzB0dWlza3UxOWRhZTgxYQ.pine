...
decision_tree_0_LYFT_1Day_19dae81a(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( rsi1 > 46.3021 )
		if( k <= 97.8709 )
			if( smoothD_d <= 6.4913 )
				...
				if( bbm > 1.57534 )
					ret := 0.200000
			if( smoothD_d > 6.4913 )
				if( smoothK_k <= 76.3845 )
					if( smoothK_k <= 72.2498 )
						ret := -0.079137
					if( smoothK_k > 72.2498 )
						ret := 0.452830
				if( smoothK_k > 76.3845 )
		...
		if( k > 97.8709 )
			if( bbm <= 2.7521 )
				if( smoothK_k <= 95.0675 )
					if( smoothD_d <= 94.3704 )
						ret := 0.571429
					if( smoothD_d > 94.3704 )
						ret := 1.000000 // buy
				if( smoothK_k > 95.0675 )
...
float op_operation = decision_tree_0_LYFT_1Day_19dae81a(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
