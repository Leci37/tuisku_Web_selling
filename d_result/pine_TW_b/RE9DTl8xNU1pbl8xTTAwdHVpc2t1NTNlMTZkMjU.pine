			...
			if( Positive_Money_Flow_Sum > 415797 )
				...
				if( Negative_Money_Flow_Sum > 2.08028e+07 )
					...
					if( Negative_Money_Flow_Sum > 3.33934e+07 )
						ret := -0.002892
	if( Positive_Money_Flow > 87.2656 )
		if( Positive_Money_Flow <= 51646.1 )
			if( MFI <= 90.6818 )
				if( Typical_Price <= 24.1562 )
					if( MFI_Low <= 10.0664 )
						ret := -0.777778 // sell
					if( MFI_Low > 10.0664 )
						ret := 0.306931
				if( Typical_Price > 24.1562 )
					if( Typical_Price <= 82.8977 )
						ret := -0.276225
					if( Typical_Price > 82.8977 )
						ret := 0.056034
			if( MFI > 90.6818 )
				if( Negative_Money_Flow_Sum <= 435381 )
					if( Negative_Money_Flow <= 19772.3 )
						ret := -0.370000
					if( Negative_Money_Flow > 19772.3 )
						ret := 0.806452 // buy
				if( Negative_Money_Flow_Sum > 435381 )
					if( Typical_Price <= 55.3743 )
						ret := 0.754601 // buy
					if( Typical_Price > 55.3743 )
						ret := -0.046154
		if( Positive_Money_Flow > 51646.1 )
			if( Typical_Price <= 32.7822 )
				if( Negative_Money_Flow_Sum <= 239238 )
					ret := 0.881356 // buy
				if( Negative_Money_Flow_Sum > 239238 )
					if( Positive_Money_Flow <= 115730 )
						ret := -0.387097
					if( Positive_Money_Flow > 115730 )
						ret := 0.096852
			if( Typical_Price > 32.7822 )
				if( Negative_Money_Flow_Sum <= 1.78088e+08 )
					if( Positive_Money_Flow_Sum <= 9.63996e+06 )
						ret := 0.030864
					if( Positive_Money_Flow_Sum > 9.63996e+06 )
						ret := -0.063112
				if( Negative_Money_Flow_Sum > 1.78088e+08 )
...
float op_operation = decision_tree_0_DOCN_15Min_53e16d25(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
