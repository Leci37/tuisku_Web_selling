...
decision_tree_0_TTD_1Hour_8e914895(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)=>
	...
	if( d > 61.9941 )
		if( d_k <= 22.7363 )
			if( rsi1 <= 92.8171 )
				if( d <= 98.5488 )
					if( bullPower <= -1.52392 )
						if( bbm <= 27.5264 )
							ret := -0.260204
						if( bbm > 27.5264 )
							ret := 0.850000 // buy
					if( bullPower > -1.52392 )
						if( smoothK_k <= 47.2409 )
							ret := -0.275449
						if( smoothK_k > 47.2409 )
							ret := 0.049435
				if( d > 98.5488 )
...
float op_operation = decision_tree_0_TTD_1Hour_8e914895(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)
