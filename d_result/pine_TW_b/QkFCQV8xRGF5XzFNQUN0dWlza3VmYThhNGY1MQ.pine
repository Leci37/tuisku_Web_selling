...
float op_operation = decision_tree_0_BABA_1Day_fa8a4f51(macd_IsAboveInt, histB_IsDownInt, histA_IsDownInt, histB_IsUpInt, signal, histA_IsUpInt, hist, macd_IsBelowInt, macd)
