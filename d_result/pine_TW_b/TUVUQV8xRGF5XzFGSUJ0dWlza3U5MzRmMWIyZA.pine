			...
			if( upper_1 > 218.8 )
				...
				if( lower_1 > 179.742 )
					...
					if( upper_1 > 306.231 )
						ret := -0.664706
		if( lower_6 > 124.919 )
			if( basis_minus <= 120.238 )
				if( basis_max <= -111.909 )
					if( upper_2 <= 348.607 )
						ret := 0.142857
					if( upper_2 > 348.607 )
						ret := -0.797980 // sell
...
float op_operation = decision_tree_0_META_1Day_934f1b2d(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
