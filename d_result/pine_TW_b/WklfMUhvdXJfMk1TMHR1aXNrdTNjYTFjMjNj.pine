...
decision_tree_0_ZI_1Hour_3ca1c23c(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, smoothK_k, d_k, k, smoothD_d, rsi1, d)=>
	...
	if( Typical_Price > 42.477 )
		if( MFI <= 6.3921 )
			ret := -0.614035
		if( MFI > 6.3921 )
			if( Negative_Money_Flow_Sum <= 2.89092e+07 )
				if( d_k <= 3.64277 )
					if( Typical_Price <= 43.3927 )
						if( Raw_Money_Flow <= 1.61158e+07 )
							ret := -0.038462
						if( Raw_Money_Flow > 1.61158e+07 )
							ret := 1.000000 // buy
					if( Typical_Price > 43.3927 )
						ret := -0.388385
				if( d_k > 3.64277 )
					if( Positive_Money_Flow_Sum <= 3.16214e+08 )
						if( MFI <= 89.9281 )
							ret := -0.007194
						if( MFI > 89.9281 )
							ret := 0.781250 // buy
					if( Positive_Money_Flow_Sum > 3.16214e+08 )
						ret := -0.857143 // sell
			if( Negative_Money_Flow_Sum > 2.89092e+07 )
				if( Positive_Money_Flow_Sum <= 7.01629e+08 )
					if( Positive_Money_Flow_Sum <= 5.61586e+08 )
						if( rsi1 <= 21.2898 )
							ret := 0.500000
						if( rsi1 > 21.2898 )
							ret := -0.044448
...
float op_operation = decision_tree_0_ZI_1Hour_3ca1c23c(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, smoothK_k, d_k, k, smoothD_d, rsi1, d)
