			...
			if( val <= 0.031382 )
				if( lowerBB <= 16.6036 )
					...
					if( rangema > 0.454646 )
						ret := 0.250000
				if( lowerBB > 16.6036 )
					if( avgHighLow <= 116.413 )
						if( ma <= 114.842 )
							ret := -0.122022
						if( ma > 114.842 )
							ret := 0.926471 // buy
					if( avgHighLow > 116.413 )
						if( avgHighLow <= 172.63 )
							ret := -0.374502
						if( avgHighLow > 172.63 )
							ret := -0.073922
			if( val > 0.031382 )
...
float op_operation = decision_tree_0_UPST_1Hour_824105e6(lowerBB, noSqzInt, avgHighLow, rangema, sqzOffInt, upperKC, ma, basis, val, sqzOnInt, dev, priceRange, lowerKC, upperBB)
