			...
			if( senkou_span_a_displaced <= 229.118 )
				...
				if( chinkou_span > 109.687 )
					if( tenkan_sen <= 109.727 )
						if( basis_max <= -0.232582 )
							ret := 0.144578
						if( basis_max > -0.232582 )
							ret := 0.605598
					if( tenkan_sen > 109.727 )
						if( basis_minus <= -0.600817 )
							ret := 0.094670
						if( basis_minus > -0.600817 )
							ret := -0.002641
			if( senkou_span_a_displaced > 229.118 )
				ret := -0.890000 // sell
	if( basis_max > 1.01168 )
		if( senkou_span_b <= 171.483 )
			if( senkou_span_b_displaced <= 159.63 )
				if( kinjun_sen <= 124.457 )
					ret := 0.214286
				if( kinjun_sen > 124.457 )
					if( senkou_span_a <= 153.17 )
						ret := -0.416667
					if( senkou_span_a > 153.17 )
						ret := -0.942857 // sell
			if( senkou_span_b_displaced > 159.63 )
				ret := 0.738739 // buy
		if( senkou_span_b > 171.483 )
			if( basis_max <= 3.34594 )
				if( senkou_span_b_displaced <= 228.227 )
					if( basis_minus <= -3.32812 )
						if( basis_minus <= -4.58523 )
							ret := -0.774194 // sell
						if( basis_minus > -4.58523 )
							ret := 0.038462
					if( basis_minus > -3.32812 )
						if( senkou_span_b_displaced <= 206.195 )
							ret := -0.900901 // sell
						if( senkou_span_b_displaced > 206.195 )
							ret := -0.518519
				if( senkou_span_b_displaced > 228.227 )
...
float op_operation = decision_tree_0_QCOM_5Min_6764dfb9(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
