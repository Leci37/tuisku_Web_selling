			...
			if( Negative_Money_Flow_Sum <= 1.70075e+09 )
				if( Short_MA <= 87.3213 )
					...
					if( Negative_Money_Flow_Sum > 1.33151e+09 )
						ret := -0.965517 // sell
				if( Short_MA > 87.3213 )
					if( Positive_Money_Flow_Sum <= 3.42671e+09 )
						ret := 0.825688 // buy
					if( Positive_Money_Flow_Sum > 3.42671e+09 )
						ret := -0.245902
			if( Negative_Money_Flow_Sum > 1.70075e+09 )
				if( MFI_High <= -4.40703 )
					if( Short_Long_Diff <= 3.39293 )
						ret := -0.283925
					if( Short_Long_Diff > 3.39293 )
						ret := -0.686813
				if( MFI_High > -4.40703 )
					if( Typical_Price <= 315.112 )
						ret := 0.760000 // buy
					if( Typical_Price > 315.112 )
						ret := -0.125000
		if( Negative_Money_Flow_Sum > 3.87671e+09 )
			if( Negative_Money_Flow_Sum <= 4.74971e+09 )
				if( Raw_Money_Flow <= 9.32372e+08 )
					if( Positive_Money_Flow_Sum <= 3.39221e+09 )
						ret := 0.194444
					if( Positive_Money_Flow_Sum > 3.39221e+09 )
						ret := 0.737931 // buy
				if( Raw_Money_Flow > 9.32372e+08 )
					...
					if( Long_MA > 333.324 )
						ret := -0.700000 // sell
			if( Negative_Money_Flow_Sum > 4.74971e+09 )
				if( Positive_Money_Flow_Sum <= 5.29161e+09 )
					if( Positive_Money_Flow_Sum <= 2.54379e+09 )
						ret := -0.546392
					if( Positive_Money_Flow_Sum > 2.54379e+09 )
						ret := 0.474886
				if( Positive_Money_Flow_Sum > 5.29161e+09 )
					if( Short_Long_Diff <= -21.1255 )
						ret := 0.222222
					if( Short_Long_Diff > -21.1255 )
						ret := -0.600000
...
float op_operation = decision_tree_0_TWLO_1Day_6ed81c08(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
