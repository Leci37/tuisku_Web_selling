		...
		if( Money_Flow_Ratio <= 0.068541 )
			if( Long_MA <= 607.489 )
				...
				if( Positive_Money_Flow_Sum > 4.47019e+06 )
					ret := -0.666667
			if( Long_MA > 607.489 )
				if( Short_Long_Diff <= 0.826944 )
					ret := -0.047619
				if( Short_Long_Diff > 0.826944 )
					ret := 0.952381 // buy
		if( Money_Flow_Ratio > 0.068541 )
			if( Raw_Money_Flow <= 1.66619e+07 )
				if( MFI_Low <= 25.4421 )
					if( Positive_Money_Flow <= 37115.6 )
						if( Raw_Money_Flow <= 657182 )
							ret := 0.068246
						if( Raw_Money_Flow > 657182 )
							ret := -0.114635
					if( Positive_Money_Flow > 37115.6 )
						if( Positive_Money_Flow <= 764971 )
							ret := -0.201489
						if( Positive_Money_Flow > 764971 )
							ret := 0.017273
				if( MFI_Low > 25.4421 )
					if( Positive_Money_Flow_Sum <= 9.62849e+07 )
						if( Negative_Money_Flow_Sum <= 4.29871e+07 )
							ret := 0.001353
						if( Negative_Money_Flow_Sum > 4.29871e+07 )
							ret := 0.619266
					if( Positive_Money_Flow_Sum > 9.62849e+07 )
						...
						if( MFI_High > 1.81039 )
							ret := -0.752000 // sell
			if( Raw_Money_Flow > 1.66619e+07 )
				if( Money_Flow_Ratio <= 0.714603 )
					ret := 0.795455 // buy
				if( Money_Flow_Ratio > 0.714603 )
					if( Negative_Money_Flow_Sum <= 3.93791e+07 )
						if( Typical_Price <= 597.862 )
							ret := 0.493671
						if( Typical_Price > 597.862 )
							ret := -0.409091
					if( Negative_Money_Flow_Sum > 3.93791e+07 )
...
float op_operation = decision_tree_0_HUBS_1Min_0efd13c5(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
