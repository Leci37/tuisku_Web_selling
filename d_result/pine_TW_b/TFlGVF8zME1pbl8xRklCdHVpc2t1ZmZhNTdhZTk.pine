...
decision_tree_0_LYFT_30Min_ffa57ae9(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( lower_6 > 7.80143 )
		...
		if( upper_5 > 15.7382 )
			if( upper_6 <= 27.4405 )
				if( lower_6 <= 17.0054 )
					if( basis_minus <= 6.8153 )
						ret := -0.067770
					if( basis_minus > 6.8153 )
						ret := -0.656716
				if( lower_6 > 17.0054 )
					if( basis_max <= -1.47088 )
						ret := -0.443878
					if( basis_max > -1.47088 )
						ret := -0.737089 // sell
			if( upper_6 > 27.4405 )
...
float op_operation = decision_tree_0_LYFT_30Min_ffa57ae9(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
