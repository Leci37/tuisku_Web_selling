...
decision_tree_0_SNAP_1Day_c9b3a5a0(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( ema3 > 14.4042 )
		if( ema12 <= -2.22438 )
			if( Positive_Money_Flow_Sum <= 3.15463e+09 )
				ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 3.15463e+09 )
				if( ema3 <= 64.3626 )
					if( Negative_Money_Flow <= 1.11929e+08 )
						ret := 0.500000
					if( Negative_Money_Flow > 1.11929e+08 )
						ret := 0.958333 // buy
				if( ema3 > 64.3626 )
					ret := 0.000000
		if( ema12 > -2.22438 )
			if( Money_Flow_Ratio <= 0.704487 )
				if( Positive_Money_Flow_Sum <= 5.86336e+09 )
					if( Typical_Price <= 48.1986 )
						ret := -0.413655
					if( Typical_Price > 48.1986 )
						ret := 0.666667
				if( Positive_Money_Flow_Sum > 5.86336e+09 )
...
float op_operation = decision_tree_0_SNAP_1Day_c9b3a5a0(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
