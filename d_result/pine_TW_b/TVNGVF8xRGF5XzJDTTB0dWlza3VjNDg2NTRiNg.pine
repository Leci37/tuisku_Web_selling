...
decision_tree_0_MSFT_1Day_c48654b6(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( ad_mf > -1.85685e+07 )
		if( Raw_Money_Flow <= 9.65865e+09 )
			...
			if( Positive_Money_Flow_Sum > 6.65429e+10 )
				if( mf <= 0.045761 )
					if( Positive_Money_Flow_Sum <= 9.41548e+10 )
						ret := -0.170455
					if( Positive_Money_Flow_Sum > 9.41548e+10 )
						ret := 0.805556 // buy
				if( mf > 0.045761 )
					if( Typical_Price <= 270.572 )
						ret := -0.703125 // sell
					if( Typical_Price > 270.572 )
						ret := -0.269076
		if( Raw_Money_Flow > 9.65865e+09 )
			if( Positive_Money_Flow_Sum <= 7.06018e+10 )
				if( mf <= -0.021649 )
					if( Typical_Price <= 164.163 )
						ret := -1.000000 // sell
					if( Typical_Price > 164.163 )
						ret := 0.595238
				if( mf > -0.021649 )
					...
					if( MFI_Low > 17.9103 )
						ret := -0.134831
			if( Positive_Money_Flow_Sum > 7.06018e+10 )
				if( Negative_Money_Flow_Sum <= 3.18432e+10 )
					if( Typical_Price <= 298.561 )
						ret := 0.750000 // buy
					if( Typical_Price > 298.561 )
						ret := 0.000000
				if( Negative_Money_Flow_Sum > 3.18432e+10 )
...
float op_operation = decision_tree_0_MSFT_1Day_c48654b6(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
