	...
	if( upperKC > 78.3896 )
		...
		if( basis > 81.355 )
			...
			if( lowerBB > 323.16 )
				...
				if( lowerKC > 327.264 )
					if( upperKC <= 341.215 )
						if( avgHighLow <= 332.622 )
							ret := -0.428571
						if( avgHighLow > 332.622 )
							ret := 0.483871
					if( upperKC > 341.215 )
						if( avgHighLow <= 340.045 )
							ret := -0.611354
						if( avgHighLow > 340.045 )
							ret := -0.093750
...
float op_operation = decision_tree_0_SPOT_1Hour_77241fcb(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
