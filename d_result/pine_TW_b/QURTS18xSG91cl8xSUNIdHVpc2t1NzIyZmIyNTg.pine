		...
		if( chinkou_span > 289.864 )
			if( kinjun_sen <= 293.134 )
				...
				if( basis_max > -1.22924 )
					ret := 0.648903
			if( kinjun_sen > 293.134 )
				if( senkou_span_a_displaced <= 288.615 )
					ret := 0.526316
				if( senkou_span_a_displaced > 288.615 )
					if( basis_minus <= -1.89625 )
						ret := 0.945946 // buy
					if( basis_minus > -1.89625 )
						if( chinkou_span <= 307.824 )
							ret := -0.301255
						if( chinkou_span > 307.824 )
							ret := 0.231183
	if( senkou_span_b_displaced > 303.518 )
		if( chinkou_span <= 316.49 )
			if( basis_max <= 0.128698 )
				ret := -0.846154 // sell
			if( basis_max > 0.128698 )
				if( basis_minus <= -1.62574 )
					if( chinkou_span <= 286.731 )
						ret := -0.755435 // sell
					if( chinkou_span > 286.731 )
						if( basis_minus <= -3.76342 )
							ret := -0.037037
						if( basis_minus > -3.76342 )
							ret := -0.682927
				if( basis_minus > -1.62574 )
					ret := -0.031250
		if( chinkou_span > 316.49 )
			if( senkou_span_b_displaced <= 311.38 )
				if( senkou_span_a <= 315.983 )
					ret := -0.923077 // sell
				if( senkou_span_a > 315.983 )
					ret := -0.138889
			if( senkou_span_b_displaced > 311.38 )
				if( tenkan_sen <= 327.495 )
					ret := 0.643478
				if( tenkan_sen > 327.495 )
					ret := 0.025210
...
float op_operation = decision_tree_0_ADSK_1Hour_722fb258(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
