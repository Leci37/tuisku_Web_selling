...
decision_tree_0_TRXUSDT_1Day_062cd8ae(mf, ad, ad_mf, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( ema2 > 0.014606 )
		...
		if( ema13 > 0.006146 )
			if( mf <= 0.191304 )
				if( ema2 <= 0.053209 )
					if( ad_mf <= 1.18633e+09 )
						ret := 0.888889 // buy
					if( ad_mf > 1.18633e+09 )
						ret := -0.285714
				if( ema2 > 0.053209 )
					if( ad_mf <= 2.68517e+09 )
						ret := -0.785714 // sell
					if( ad_mf > 2.68517e+09 )
						ret := 0.500000
			if( mf > 0.191304 )
				if( ad_mf <= 1.21069e+09 )
					if( ad_mf <= -4.58193e+08 )
						ret := 1.000000 // buy
					if( ad_mf > -4.58193e+08 )
						ret := 0.055556
				if( ad_mf > 1.21069e+09 )
...
float op_operation = decision_tree_0_TRXUSDT_1Day_062cd8ae(mf, ad, ad_mf, ema1, tema, ema12, ema2, ema3, ema13)
