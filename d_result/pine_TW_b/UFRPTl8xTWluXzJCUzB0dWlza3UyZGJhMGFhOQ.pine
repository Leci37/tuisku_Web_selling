			...
			if( bullPower <= 0.016515 )
				if( bullPower <= 0.009802 )
					...
					if( d > 31.7164 )
						ret := -0.077713
				if( bullPower > 0.009802 )
					if( smoothD_d <= 60.6203 )
						ret := -0.413098
					if( smoothD_d > 60.6203 )
						ret := -0.137068
			if( bullPower > 0.016515 )
				if( bullPower <= 0.048503 )
					if( smoothK_k <= 21.1448 )
						ret := -0.845455 // sell
					if( smoothK_k > 21.1448 )
						ret := -0.501221
				if( bullPower > 0.048503 )
			...
			if( d_k <= 0.406667 )
				...
				if( bullPower > 0.016663 )
					...
					if( bbm > 0.00988 )
						ret := -0.109355
			if( d_k > 0.406667 )
				if( smoothD_d <= 78.3671 )
					if( bullPower <= 0.018767 )
						ret := 0.008547
					if( bullPower > 0.018767 )
						ret := -0.170912
				if( smoothD_d > 78.3671 )
					if( bullPower <= 0.096716 )
						ret := 0.022366
					if( bullPower > 0.096716 )
						ret := 0.628205
...
float op_operation = decision_tree_0_PTON_1Min_2dba0aa9(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
