...
decision_tree_0_ETHUSDT_1Day_ffec49ab(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( lowerBand > 4.4347 )
		...
		if( lowerBand > 29.3496 )
			if( wvf <= 36.8206 )
				if( lowerBand <= 35.1564 )
					ret := 1.000000 // buy
				if( lowerBand > 35.1564 )
					ret := 0.000000
			if( wvf > 36.8206 )
				if( Color_con2 <= -14.5379 )
					ret := 1.000000 // buy
				if( Color_con2 > -14.5379 )
					ret := 0.000000
...
float op_operation = decision_tree_0_ETHUSDT_1Day_ffec49ab(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
