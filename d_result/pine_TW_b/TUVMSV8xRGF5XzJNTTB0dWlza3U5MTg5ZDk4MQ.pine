		...
		if( Negative_Money_Flow_Sum <= 4.43015e+08 )
			if( Short_Long_Diff <= 2.32411 )
				...
				if( Typical_Price > 129.787 )
					ret := 0.266667
			if( Short_Long_Diff > 2.32411 )
				if( Positive_Money_Flow <= 1.10329e+08 )
					if( Short_Long_Diff <= 3.01049 )
						ret := -0.416667
					if( Short_Long_Diff > 3.01049 )
						ret := 0.000000
				if( Positive_Money_Flow > 1.10329e+08 )
					ret := 0.500000
		if( Negative_Money_Flow_Sum > 4.43015e+08 )
			if( Raw_Money_Flow <= 3.11825e+08 )
				if( Positive_Money_Flow_Sum <= 1.90546e+09 )
					if( Long_MA <= 296.399 )
						ret := -0.552632
					if( Long_MA > 296.399 )
						ret := 0.461538
				if( Positive_Money_Flow_Sum > 1.90546e+09 )
					if( Short_Long_Diff <= 31.1842 )
						ret := -0.836879 // sell
					if( Short_Long_Diff > 31.1842 )
						ret := -0.090909
			if( Raw_Money_Flow > 3.11825e+08 )
				if( Negative_Money_Flow_Sum <= 1.99569e+09 )
					if( Positive_Money_Flow_Sum <= 3.15365e+09 )
						ret := -0.470588
					if( Positive_Money_Flow_Sum > 3.15365e+09 )
						ret := 0.278788
				if( Negative_Money_Flow_Sum > 1.99569e+09 )
					if( Typical_Price <= 1396.4 )
						ret := -0.590062
					if( Typical_Price > 1396.4 )
						ret := 0.088235
...
float op_operation = decision_tree_0_MELI_1Day_9189d981(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
