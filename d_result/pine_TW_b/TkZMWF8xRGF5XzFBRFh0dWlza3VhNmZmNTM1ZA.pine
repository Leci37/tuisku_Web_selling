...
decision_tree_0_NFLX_1Day_a6ff535d(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)=>
	...
	if( smoothedTrueRange > 18.0142 )
		if( diPlus <= 14.6136 )
			...
			if( smoothedTrueRange > 18.2125 )
				if( diMinus <= 47.1181 )
					if( directionalMovementMinus <= 0.408956 )
						ret := 0.105263
					if( directionalMovementMinus > 0.408956 )
						ret := 0.722222 // buy
				if( diMinus > 47.1181 )
					if( smoothedTrueRange <= 28.827 )
						ret := -0.793103 // sell
					if( smoothedTrueRange > 28.827 )
						ret := 1.000000 // buy
		if( diPlus > 14.6136 )
			if( smoothedDirectionalMovementPlus <= 3.63399 )
				if( trueRange <= 26.5612 )
					if( trueRange <= 13.5679 )
						ret := -0.714286 // sell
					if( trueRange > 13.5679 )
						ret := -1.000000 // sell
				if( trueRange > 26.5612 )
					ret := -0.428571
			if( smoothedDirectionalMovementPlus > 3.63399 )
				if( smoothedDirectionalMovementPlus <= 4.60248 )
					if( trueRange <= 22.0612 )
						ret := -0.227273
					if( trueRange > 22.0612 )
						ret := 0.722222 // buy
				if( smoothedDirectionalMovementPlus > 4.60248 )
...
float op_operation = decision_tree_0_NFLX_1Day_a6ff535d(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
