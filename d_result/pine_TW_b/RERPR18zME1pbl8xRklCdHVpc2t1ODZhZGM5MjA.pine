...
decision_tree_0_DDOG_30Min_86adc920(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( lower_6 > 67.4539 )
		...
		if( upper_4 > 80.2745 )
			if( basis <= 81.7763 )
				if( upper_5 <= 88.5899 )
					if( basis_max <= -8.26857 )
						if( basis_max <= -10.8333 )
							ret := 0.606061
						if( basis_max > -10.8333 )
							ret := -0.266667
					if( basis_max > -8.26857 )
...
float op_operation = decision_tree_0_DDOG_30Min_86adc920(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
