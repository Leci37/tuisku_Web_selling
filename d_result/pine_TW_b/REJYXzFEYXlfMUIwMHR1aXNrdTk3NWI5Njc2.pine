			...
			if( bbp <= 2.72155 )
				if( bbp <= 2.21646 )
					...
					if( bbp > 0.828693 )
						ret := -0.063063
				if( bbp > 2.21646 )
					if( bullPower <= 1.57415 )
						ret := 0.000000
					if( bullPower > 1.57415 )
						ret := 0.727273 // buy
			if( bbp > 2.72155 )
				if( bbm <= 1.2976 )
					if( bullPower <= 2.17476 )
						ret := -0.900000 // sell
					if( bullPower > 2.17476 )
						ret := 0.090909
				if( bbm > 1.2976 )
					if( bearPower <= 0.765542 )
						ret := -0.692308
					if( bearPower > 0.765542 )
						ret := -0.964286 // sell
...
float op_operation = decision_tree_0_DBX_1Day_975b9676(bearPower, bbm, bbp, bullPower, BBPower_Color)
