...
decision_tree_0_PYPL_1Day_7861c396(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( lowerBand > 9.07543 )
		if( wvf <= 30.0715 )
			if( sDev <= 10.3814 )
				if( upperBand <= 27.0246 )
					if( Color_con2 <= -3.78946 )
						ret := 0.931034 // buy
					if( Color_con2 > -3.78946 )
						ret := 0.200000
				if( upperBand > 27.0246 )
					if( upperBand <= 27.7992 )
						ret := -0.300000
					if( upperBand > 27.7992 )
						ret := 0.500000
			if( sDev > 10.3814 )
...
float op_operation = decision_tree_0_PYPL_1Day_7861c396(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
