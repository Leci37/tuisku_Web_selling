			...
			if( sDev <= 9.85913 )
				if( sDev <= 3.53444 )
					...
					if( midLine > 4.54436 )
						ret := 0.000000
				if( sDev > 3.53444 )
					if( Color_con2 <= -38.9003 )
						ret := -0.947368 // sell
					if( Color_con2 > -38.9003 )
						ret := 0.164265
			if( sDev > 9.85913 )
				if( wvf <= 4.23579 )
					if( Color_con1 <= -17.7493 )
						ret := 0.904762 // buy
					if( Color_con1 > -17.7493 )
						ret := -0.166667
				if( wvf > 4.23579 )
					...
					if( midLine > 12.3533 )
						ret := 0.109091
		if( upperBand > 25.6585 )
			if( upperBand <= 41.3626 )
				if( lowerBand <= 4.50958 )
					if( midLine <= 14.2111 )
						ret := 0.193548
					if( midLine > 14.2111 )
						ret := 0.768707 // buy
...
float op_operation = decision_tree_0_LYFT_1Day_3a9912ee(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
