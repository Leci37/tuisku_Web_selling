				...
				if( azul <= 120.832 )
					...
					if( verde_azul > -49.2455 )
						...
						if( azul > -16.436 )
							ret := -0.031638
				if( azul > 120.832 )
					if( media_azul <= -52.5143 )
						if( BollOsc <= 49.83 )
							ret := -0.410526
						if( BollOsc > 49.83 )
							ret := -1.000000 // sell
					if( media_azul > -52.5143 )
						if( marron_mean <= 104.239 )
							ret := 0.777778 // buy
						if( marron_mean > 104.239 )
							ret := -0.111111
			if( verde > 149.631 )
				if( media_azul <= 44.8234 )
					if( nvimax <= 0.028473 )
						ret := 0.846154 // buy
					if( nvimax > 0.028473 )
						if( verde_mean <= 216.653 )
							ret := -0.707395 // sell
						if( verde_mean > 216.653 )
							ret := -0.102041
				if( media_azul > 44.8234 )
...
float op_operation = decision_tree_0_TWLO_1Min_453df453(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
