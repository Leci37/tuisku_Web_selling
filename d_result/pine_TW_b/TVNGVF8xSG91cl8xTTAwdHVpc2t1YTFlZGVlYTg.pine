			...
			if( Money_Flow_Ratio > 1.066 )
				if( Money_Flow_Ratio <= 1.22706 )
					...
					if( MFI > 52.8615 )
						ret := -0.659026
				if( Money_Flow_Ratio > 1.22706 )
					if( Typical_Price <= 304.566 )
						if( MFI_Low <= 50.3226 )
							ret := 0.287879
						if( MFI_Low > 50.3226 )
							ret := -0.600000
					if( Typical_Price > 304.566 )
						if( Negative_Money_Flow_Sum <= 6.11512e+09 )
							ret := -0.522088
						if( Negative_Money_Flow_Sum > 6.11512e+09 )
							ret := 0.000000
	if( Negative_Money_Flow_Sum > 9.1067e+09 )
		if( MFI <= 39.441 )
			if( Raw_Money_Flow <= 1.61694e+07 )
				if( Negative_Money_Flow_Sum <= 1.23686e+10 )
					if( Money_Flow_Ratio <= 0.334822 )
						if( Positive_Money_Flow_Sum <= 2.46024e+09 )
							ret := 0.208738
						if( Positive_Money_Flow_Sum > 2.46024e+09 )
							ret := -0.618182
					if( Money_Flow_Ratio > 0.334822 )
			...
			if( Raw_Money_Flow > 1.61694e+07 )
				if( MFI_High <= -47.0263 )
					if( Typical_Price <= 193.955 )
						if( Money_Flow_Ratio <= 0.361986 )
							ret := -0.287671
						if( Money_Flow_Ratio > 0.361986 )
							ret := 0.950000 // buy
					if( Typical_Price > 193.955 )
						if( Positive_Money_Flow <= 1.14782e+09 )
							ret := 0.615538
						if( Positive_Money_Flow > 1.14782e+09 )
							ret := -0.096774
				if( MFI_High > -47.0263 )
...
float op_operation = decision_tree_0_MSFT_1Hour_a1edeea8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
