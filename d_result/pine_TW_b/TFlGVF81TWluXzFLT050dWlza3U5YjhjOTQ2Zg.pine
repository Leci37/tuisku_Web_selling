	...
	if( source > 11.3199 )
				...
				if( azul > -90.9638 )
					if( nvi_ema <= 0.819413 )
						...
						if( verde > -36.1676 )
							ret := -0.178876
					if( nvi_ema > 0.819413 )
						if( azul_mean <= -35.7216 )
							ret := -0.601399
						if( azul_mean > -35.7216 )
							ret := -0.107527
			if( azul_mean > -28.6039 )
				if( verde_mean <= -26.7114 )
					if( oscp <= -78.1501 )
						if( media <= 7.32923 )
							ret := -0.920000 // sell
						if( media > 7.32923 )
		...
		if( BollOsc > -33.238 )
			if( oscp <= 19.3415 )
				if( media <= 103.401 )
					if( xrsi <= 69.1212 )
						if( marron_mean <= 99.4479 )
							ret := -0.039133
						if( marron_mean > 99.4479 )
							ret := 0.101499
					if( xrsi > 69.1212 )
						if( media_azul <= 90.5569 )
							ret := -0.353073
						if( media_azul > 90.5569 )
							ret := 0.003817
				if( media > 103.401 )
					if( stoc <= 90.2136 )
						if( verde_azul <= 144.815 )
							ret := 0.407631
						if( verde_azul > 144.815 )
							ret := -0.631579
					if( stoc > 90.2136 )
						...
						if( azul > 15.8454 )
							ret := -0.637931
			if( oscp > 19.3415 )
				if( marron_mean <= 129.547 )
					if( xmf <= 96.6889 )
						if( media_azul <= 93.9241 )
							ret := -0.300394
						if( media_azul > 93.9241 )
							ret := -0.066338
					if( xmf > 96.6889 )
...
float op_operation = decision_tree_0_LYFT_5Min_9b8c946f(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
