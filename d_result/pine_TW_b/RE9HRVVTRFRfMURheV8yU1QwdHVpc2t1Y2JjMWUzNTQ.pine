			...
			if( ema12 <= 0.013593 )
				if( ema12 <= -0.014536 )
					...
					if( rsi1 > 42.3537 )
						ret := -1.000000 // sell
				if( ema12 > -0.014536 )
					if( smoothK_k <= 9.23836 )
						ret := -0.433447
					if( smoothK_k > 9.23836 )
						ret := -0.141304
			if( ema12 > 0.013593 )
				if( smoothK_k <= 52.8115 )
					if( ema13 <= 0.126907 )
						ret := 0.777778 // buy
					if( ema13 > 0.126907 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_cbc1e354(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)
