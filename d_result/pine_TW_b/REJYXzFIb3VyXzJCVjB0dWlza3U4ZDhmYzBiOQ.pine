...
decision_tree_0_DBX_1Hour_8d8fc0b9(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)=>
	...
	if( bullPower > 0.105402 )
		if( VIP_VIM <= -0.416026 )
			...
			if( VIM > 1.37617 )
				if( VIM <= 1.71737 )
					if( bullPower <= 0.468392 )
						if( bullPower <= 0.126327 )
							ret := -0.600000
						if( bullPower > 0.126327 )
							ret := -0.913793 // sell
					if( bullPower > 0.468392 )
...
float op_operation = decision_tree_0_DBX_1Hour_8d8fc0b9(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
