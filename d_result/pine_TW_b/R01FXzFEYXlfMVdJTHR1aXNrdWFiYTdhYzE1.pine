			...
			if( sDev > 10.0141 )
				if( midLine <= 28.028 )
					...
					if( midLine > 20.6637 )
						ret := -0.406780
				if( midLine > 28.028 )
					if( Color_con2 <= -48.2574 )
						ret := -0.875000 // sell
					if( Color_con2 > -48.2574 )
						ret := 0.695833
		if( Color_con2 > 43.64 )
			if( upperBand <= 78.2862 )
				ret := -1.000000 // sell
			if( upperBand > 78.2862 )
				ret := -0.750000 // sell
...
float op_operation = decision_tree_0_GME_1Day_aba7ac15(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
