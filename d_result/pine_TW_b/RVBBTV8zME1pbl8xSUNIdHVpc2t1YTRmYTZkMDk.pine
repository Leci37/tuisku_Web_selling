				...
				if( senkou_span_a > 319.612 )
					...
					if( senkou_span_b > 333.211 )
						...
						if( chinkou_span > 328.053 )
							ret := -0.307865
			if( chinkou_span > 341.588 )
				if( basis_minus <= 11.3203 )
					if( kinjun_sen <= 354.574 )
						if( chinkou_span <= 367.644 )
							ret := 0.422092
						if( chinkou_span > 367.644 )
							ret := 0.871921 // buy
					if( kinjun_sen > 354.574 )
						if( chinkou_span <= 359.89 )
							ret := -0.389706
						if( chinkou_span > 359.89 )
							ret := 0.069755
				if( basis_minus > 11.3203 )
					if( kinjun_sen <= 606.905 )
						if( kinjun_sen <= 360.279 )
							ret := -0.036765
						if( kinjun_sen > 360.279 )
							ret := -0.409396
					if( kinjun_sen > 606.905 )
						if( tenkan_sen <= 689.785 )
							ret := 0.590062
						if( tenkan_sen > 689.785 )
							ret := -0.277778
		if( senkou_span_b_displaced > 664 )
			if( basis_max <= 11.6437 )
				if( basis_minus <= -20.7751 )
					ret := 0.888889 // buy
				if( basis_minus > -20.7751 )
					if( senkou_span_a <= 637.259 )
						if( senkou_span_b <= 644.598 )
							ret := -0.818182 // sell
						if( senkou_span_b > 644.598 )
							ret := 0.705882 // buy
					if( senkou_span_a > 637.259 )
						if( basis_minus <= 17.4297 )
							ret := -0.594787
						if( basis_minus > 17.4297 )
							ret := 0.500000
			if( basis_max > 11.6437 )
...
float op_operation = decision_tree_0_EPAM_30Min_a4fa6d09(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
