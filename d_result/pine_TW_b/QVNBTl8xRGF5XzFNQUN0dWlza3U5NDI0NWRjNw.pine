...
float op_operation = decision_tree_0_ASAN_1Day_94245dc7(macd_IsAboveInt, histB_IsDownInt, histA_IsDownInt, histB_IsUpInt, signal, histA_IsUpInt, hist, macd_IsBelowInt, macd)
