...
decision_tree_0_ETHUSDT_1Day_c5f5fabd(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( smoothD_d > 82.3487 )
		if( bbp <= 25.5283 )
			if( rsi1 <= 55.4571 )
				if( bullPower <= 13.8224 )
					if( d_k <= 4.09302 )
						ret := -0.472222
					if( d_k > 4.09302 )
						ret := 0.066667
				if( bullPower > 13.8224 )
					if( smoothD_d <= 84.0633 )
						ret := 0.857143 // buy
					if( smoothD_d > 84.0633 )
						ret := 0.162162
			if( rsi1 > 55.4571 )
		...
		if( bbp > 25.5283 )
			if( bbp <= 43.4947 )
				if( d <= 86.398 )
					ret := 0.444444
				if( d > 86.398 )
					if( bearPower <= 12.7069 )
						ret := -0.333333
					if( bearPower > 12.7069 )
						ret := -0.909091 // sell
			if( bbp > 43.4947 )
				if( smoothD_d <= 82.9676 )
					ret := -0.642857
				if( smoothD_d > 82.9676 )
					if( bullPower <= 52.4843 )
						ret := 0.705882 // buy
					if( bullPower > 52.4843 )
						ret := 0.213166
...
float op_operation = decision_tree_0_ETHUSDT_1Day_c5f5fabd(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
