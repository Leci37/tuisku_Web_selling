...
decision_tree_0_FFIV_1Day_21e047a4(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Short_MA > 144.243 )
			...
			if( Short_Long_Diff <= -4.39261 )
				if( Negative_Money_Flow_Sum <= 5.95344e+08 )
					...
					if( Negative_Money_Flow > 7.81737e+07 )
						ret := 0.000000
				if( Negative_Money_Flow_Sum > 5.95344e+08 )
					if( Negative_Money_Flow <= 1.34753e+08 )
						ret := -0.251534
					if( Negative_Money_Flow > 1.34753e+08 )
						ret := 0.465116
			if( Short_Long_Diff > -4.39261 )
				if( Negative_Money_Flow_Sum <= 1.03144e+09 )
					if( Positive_Money_Flow_Sum <= 3.68193e+08 )
						ret := 0.666667
					if( Positive_Money_Flow_Sum > 3.68193e+08 )
						ret := 0.166667
				if( Negative_Money_Flow_Sum > 1.03144e+09 )
		...
		if( Short_Long_Diff > -0.549896 )
			...
			if( MFI_High > -40.0961 )
				if( MFI_High <= -31.5925 )
					if( Positive_Money_Flow_Sum <= 7.08735e+08 )
						ret := -0.412281
					if( Positive_Money_Flow_Sum > 7.08735e+08 )
						ret := -0.714286 // sell
				if( MFI_High > -31.5925 )
					if( Short_Long_Diff <= 0.985328 )
						ret := -0.358974
					if( Short_Long_Diff > 0.985328 )
						ret := -0.033121
...
float op_operation = decision_tree_0_FFIV_1Day_21e047a4(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
