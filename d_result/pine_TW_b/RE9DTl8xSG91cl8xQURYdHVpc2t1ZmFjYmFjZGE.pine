	...
	if( smoothedDirectionalMovementMinus <= 0.506662 )
		...
		if( directionalMovementPlus > 0.433121 )
			if( diPlus <= 39.3909 )
				if( adx <= 53.0249 )
					if( diPlus <= 22.7661 )
						if( smoothedDirectionalMovementMinus <= 0.283431 )
							ret := 0.309524
						if( smoothedDirectionalMovementMinus > 0.283431 )
							ret := -0.113122
					if( diPlus > 22.7661 )
						...
						if( dx > 14.3739 )
							ret := -0.315049
				if( adx > 53.0249 )
					if( smoothedDirectionalMovementMinus <= 0.312241 )
						if( dx <= 63.0349 )
							ret := -0.773723 // sell
						if( dx > 63.0349 )
							ret := 0.181818
			...
			if( diPlus > 39.3909 )
				if( diMinus <= 23.1347 )
					if( smoothedDirectionalMovementMinus <= 0.053177 )
						if( diMinus <= 6.94943 )
							ret := 0.029412
						if( diMinus > 6.94943 )
							ret := -0.621622
				...
				if( diMinus > 23.1347 )
					if( dx <= 18.3268 )
						if( smoothedDirectionalMovementPlus <= 0.193846 )
							ret := 0.000000
						if( smoothedDirectionalMovementPlus > 0.193846 )
							ret := 0.785714 // buy
					if( dx > 18.3268 )
		...
		if( dx <= 42.1302 )
			if( adx <= 24.8198 )
				if( adx <= 10.7342 )
					ret := 0.666667
				if( adx > 10.7342 )
					if( trueRange <= 2.90799 )
						if( trueRange <= 2.05952 )
							ret := -0.245614
						if( trueRange > 2.05952 )
							ret := 0.500000
					if( trueRange > 2.90799 )
			...
			if( adx > 24.8198 )
				if( adx <= 28.9566 )
					if( smoothedTrueRange <= 4.52678 )
						if( smoothedTrueRange <= 1.62403 )
							ret := 0.666667
						if( smoothedTrueRange > 1.62403 )
							ret := 1.000000 // buy
					if( smoothedTrueRange > 4.52678 )
						ret := 0.000000
				if( adx > 28.9566 )
					if( smoothedDirectionalMovementPlus <= 0.36544 )
						if( dx <= 32.4247 )
							ret := -0.454545
						if( dx > 32.4247 )
							ret := 0.183673
					if( smoothedDirectionalMovementPlus > 0.36544 )
						if( trueRange <= 0.901684 )
							ret := -0.200000
						if( trueRange > 0.901684 )
							ret := 0.666667
		if( dx > 42.1302 )
			if( smoothedDirectionalMovementPlus <= 0.046457 )
				if( adx <= 54.9565 )
					if( diPlus <= 1.70745 )
						ret := 0.666667
					if( diPlus > 1.70745 )
...
float op_operation = decision_tree_0_DOCN_1Hour_facbacda(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
