		...
		if( Negative_Money_Flow > 6.46851e+07 )
			if( Positive_Money_Flow_Sum <= 2.76484e+09 )
				if( Negative_Money_Flow_Sum <= 5.78085e+09 )
					if( ema3 <= 2579.76 )
						if( Positive_Money_Flow_Sum <= 2.00002e+09 )
							ret := 0.003905
						if( Positive_Money_Flow_Sum > 2.00002e+09 )
							ret := 0.693878
					if( ema3 > 2579.76 )
				...
				if( Negative_Money_Flow_Sum > 5.78085e+09 )
					ret := 0.543478
			if( Positive_Money_Flow_Sum > 2.76484e+09 )
				if( Positive_Money_Flow_Sum <= 4.0442e+09 )
					ret := -0.777778 // sell
				if( Positive_Money_Flow_Sum > 4.0442e+09 )
					ret := 1.000000 // buy
	if( MFI > 41.8665 )
		...
		if( ema12 > -62.1972 )
			...
			if( Positive_Money_Flow_Sum > 6.5899e+08 )
				if( ema13 <= -39.1595 )
					ret := 0.726027 // buy
				if( ema13 > -39.1595 )
					if( Negative_Money_Flow_Sum <= 3.88172e+09 )
						if( Negative_Money_Flow_Sum <= 1.56296e+09 )
							ret := -0.062664
						if( Negative_Money_Flow_Sum > 1.56296e+09 )
							ret := 0.033999
					if( Negative_Money_Flow_Sum > 3.88172e+09 )
...
float op_operation = decision_tree_0_GOOG_1Hour_ce092375(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
