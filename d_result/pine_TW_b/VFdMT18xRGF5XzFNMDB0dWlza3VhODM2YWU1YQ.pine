			...
			if( MFI <= 62.3301 )
				...
				if( Negative_Money_Flow_Sum > 8.00765e+09 )
					...
					if( MFI_Low > -13.6118 )
						ret := 1.000000 // buy
			if( MFI > 62.3301 )
				if( Positive_Money_Flow <= 1.61788e+08 )
					ret := -1.000000 // sell
				if( Positive_Money_Flow > 1.61788e+08 )
					if( Positive_Money_Flow_Sum <= 1.25302e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 1.25302e+09 )
						ret := 0.500000
		if( Positive_Money_Flow_Sum > 1.90342e+09 )
			if( Negative_Money_Flow_Sum <= 2.76412e+09 )
				if( Negative_Money_Flow_Sum <= 1.27266e+09 )
					if( Negative_Money_Flow <= 3.12092e+06 )
						ret := 0.428571
					if( Negative_Money_Flow > 3.12092e+06 )
						ret := -0.846154 // sell
				if( Negative_Money_Flow_Sum > 1.27266e+09 )
					if( Negative_Money_Flow <= 3.87412e+08 )
						ret := -0.350254
					if( Negative_Money_Flow > 3.87412e+08 )
						ret := -0.788889 // sell
			if( Negative_Money_Flow_Sum > 2.76412e+09 )
				if( Money_Flow_Ratio <= 1.84898 )
					if( Positive_Money_Flow_Sum <= 7.24358e+09 )
						ret := 0.232897
					if( Positive_Money_Flow_Sum > 7.24358e+09 )
						ret := -0.403846
				if( Money_Flow_Ratio > 1.84898 )
					if( Raw_Money_Flow <= 7.66336e+08 )
						ret := -0.661290
					if( Raw_Money_Flow > 7.66336e+08 )
						ret := 0.068966
...
float op_operation = decision_tree_0_TWLO_1Day_a836ae5a(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
