				...
				if( basis_max <= -29.7494 )
					if( lower_5 <= 255.809 )
						...
						if( lower_2 > 265.42 )
							ret := -0.767932 // sell
					if( lower_5 > 255.809 )
						if( basis_max <= -31.3019 )
							ret := 0.059401
						if( basis_max > -31.3019 )
							ret := -0.301184
				if( basis_max > -29.7494 )
					if( basis_max <= -21.8401 )
						if( basis_max <= -22.5079 )
							ret := 0.062227
						if( basis_max > -22.5079 )
							ret := 0.334454
					if( basis_max > -21.8401 )
...
float op_operation = decision_tree_0_META_1Hour_77e79e1a(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
