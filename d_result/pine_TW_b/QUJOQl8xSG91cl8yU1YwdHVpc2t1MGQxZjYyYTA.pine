...
decision_tree_0_ABNB_1Hour_0d1f62a0(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)=>
	...
	if( VIP_VIM > -0.324325 )
		if( d <= 82.4552 )
			if( smoothK_k <= 1.01105 )
				if( rsi1 <= 35.2652 )
					if( smoothD_d <= -1.47377 )
						if( VIM <= 1.17971 )
							ret := 0.750000 // buy
						if( VIM > 1.17971 )
							ret := -0.250000
				...
				if( rsi1 <= 33.2698 )
					if( VIM <= 1.1048 )
						...
						if( VIM > 1.04928 )
							ret := 0.940000 // buy
					if( VIM > 1.1048 )
						if( smoothD_d <= 56.1051 )
							ret := 0.334426
						if( smoothD_d > 56.1051 )
							ret := -0.250000
				if( rsi1 > 33.2698 )
					if( smoothD_d <= 13.1525 )
						if( rsi1 <= 64.3427 )
							ret := 0.125936
						if( rsi1 > 64.3427 )
							ret := 0.818182 // buy
...
float op_operation = decision_tree_0_ABNB_1Hour_0d1f62a0(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)
