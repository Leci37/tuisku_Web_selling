...
decision_tree_0_DBX_1Min_7a6ed9d6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema12 > -0.035816 )
			...
			if( ema1 <= 23.5447 )
				...
				if( Positive_Money_Flow_Sum > 61827.6 )
					...
					if( Positive_Money_Flow_Sum > 1.11714e+06 )
						ret := 0.066005
			if( ema1 > 23.5447 )
				if( Money_Flow_Ratio <= 3.17895 )
					if( Positive_Money_Flow_Sum <= 255885 )
						ret := 0.163176
					if( Positive_Money_Flow_Sum > 255885 )
						ret := -0.043426
				if( Money_Flow_Ratio > 3.17895 )
		...
		if( ema13 > 0.169383 )
			if( tema <= 22.8986 )
				if( Negative_Money_Flow_Sum <= 1.13901e+06 )
					if( ema12 <= 0.142752 )
						ret := 0.333333
					if( ema12 > 0.142752 )
						ret := -0.692308
				if( Negative_Money_Flow_Sum > 1.13901e+06 )
					...
					if( MFI > 35.6502 )
						ret := -1.000000 // sell
			if( tema > 22.8986 )
				if( Negative_Money_Flow_Sum <= 794222 )
					if( Money_Flow_Ratio <= 4.39186 )
						ret := -0.400000
					if( Money_Flow_Ratio > 4.39186 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 794222 )
...
float op_operation = decision_tree_0_DBX_1Min_7a6ed9d6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
