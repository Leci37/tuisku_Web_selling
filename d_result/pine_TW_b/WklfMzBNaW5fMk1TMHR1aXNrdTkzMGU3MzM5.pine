		...
		if( d_k <= -2.81341 )
			if( Positive_Money_Flow <= 1.29388e+06 )
				if( Positive_Money_Flow <= 1225.39 )
					if( Positive_Money_Flow_Sum <= 2.83631e+07 )
						ret := -0.476471
					if( Positive_Money_Flow_Sum > 2.83631e+07 )
						ret := -0.035363
				if( Positive_Money_Flow > 1225.39 )
			...
			if( Positive_Money_Flow > 1.29388e+06 )
				ret := -0.072046
		if( d_k > -2.81341 )
			if( Raw_Money_Flow <= 1.06347e+06 )
				if( Money_Flow_Ratio <= 4.10363 )
					if( Negative_Money_Flow_Sum <= 3.32743e+07 )
						if( Positive_Money_Flow_Sum <= 390610 )
							ret := 0.882353 // buy
						if( Positive_Money_Flow_Sum > 390610 )
							ret := -0.411504
					if( Negative_Money_Flow_Sum > 3.32743e+07 )
						if( Typical_Price <= 55.4533 )
							ret := 0.031513
						if( Typical_Price > 55.4533 )
							ret := -0.400000
				if( Money_Flow_Ratio > 4.10363 )
					if( Negative_Money_Flow <= 127662 )
						if( MFI <= 89.0779 )
							ret := 0.432787
						if( MFI > 89.0779 )
							ret := -0.013423
					if( Negative_Money_Flow > 127662 )
						ret := -0.566038
			if( Raw_Money_Flow > 1.06347e+06 )
				if( Negative_Money_Flow_Sum <= 3.42511e+07 )
					if( smoothD_d <= 40.0468 )
						ret := -0.379808
					if( smoothD_d > 40.0468 )
						if( MFI <= 74.7609 )
							ret := -0.095238
...
float op_operation = decision_tree_0_ZI_30Min_930e7339(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, smoothK_k, d_k, k, smoothD_d, rsi1, d)
