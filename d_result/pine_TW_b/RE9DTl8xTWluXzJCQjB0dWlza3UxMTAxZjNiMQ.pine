...
decision_tree_0_DOCN_1Min_1101f3b1(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bbp > -0.362477 )
		if( bbp <= 0.356368 )
			...
			if( Lower_Band > 36.2071 )
				if( basis <= 43.9349 )
					if( Upper_Band <= 38.1825 )
						if( basis <= 38.0395 )
							ret := -0.075194
						if( basis > 38.0395 )
							ret := -0.960000 // sell
					if( Upper_Band > 38.1825 )
						if( Lower_Band <= 38.0336 )
							ret := 0.388170
						if( Lower_Band > 38.0336 )
							ret := -0.013961
				if( basis > 43.9349 )
		...
		if( bbp > 0.356368 )
			if( bbm <= 0.069888 )
				if( Lower_Band <= 28.3428 )
					ret := 0.717391 // buy
				if( Lower_Band > 28.3428 )
					if( bullPower <= 0.419404 )
						ret := -0.351852
					if( bullPower > 0.419404 )
						ret := -0.758824 // sell
			if( bbm > 0.069888 )
				if( bullPower <= 0.432835 )
					ret := -0.206019
				if( bullPower > 0.432835 )
					if( bbm <= 0.436618 )
						if( basis <= 40.8732 )
...
float op_operation = decision_tree_0_DOCN_1Min_1101f3b1(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
