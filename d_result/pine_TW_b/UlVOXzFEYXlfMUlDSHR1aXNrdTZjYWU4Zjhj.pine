			...
			if( senkou_span_b_displaced <= 26.435 )
				if( kinjun_sen <= 29.9582 )
					...
					if( kinjun_sen > 27.39 )
						ret := -0.846154 // sell
				if( kinjun_sen > 29.9582 )
					if( senkou_span_a_displaced <= 24.67 )
						ret := 0.333333
					if( senkou_span_a_displaced > 24.67 )
						ret := 1.000000 // buy
			if( senkou_span_b_displaced > 26.435 )
				if( basis_minus <= -12.2664 )
					ret := 0.714286 // buy
				if( basis_minus > -12.2664 )
					if( senkou_span_a <= 24.9387 )
						ret := 0.571429
					if( senkou_span_a > 24.9387 )
						ret := -0.779376 // sell
		if( chinkou_span > 43.7408 )
			if( senkou_span_a <= 62.3836 )
				if( chinkou_span <= 45.7336 )
					if( basis_minus <= -11.6231 )
						ret := 0.875000 // buy
					if( basis_minus > -11.6231 )
						ret := -0.214286
				if( chinkou_span > 45.7336 )
					if( senkou_span_b <= 65.8142 )
						ret := 0.709434 // buy
					if( senkou_span_b > 65.8142 )
						ret := 0.045455
			if( senkou_span_a > 62.3836 )
				if( chinkou_span <= 75.0836 )
					if( basis_max <= 0.497431 )
						ret := -0.909091 // sell
					if( basis_max > 0.497431 )
						ret := -0.629630
				if( chinkou_span > 75.0836 )
...
float op_operation = decision_tree_0_RUN_1Day_6cae8f8c(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
