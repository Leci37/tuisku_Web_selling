		...
		if( BBupper <= 563.543 )
			...
			if( BBlower > 411.011 )
				if( BBlower <= 427.918 )
					ret := 0.612536
				if( BBlower > 427.918 )
					if( dif_source_BBupper <= 2.94369 )
						ret := -0.152778
					if( dif_source_BBupper > 2.94369 )
						ret := 0.319328
		if( BBupper > 563.543 )
			if( BBlower <= 362.244 )
				if( dif_source_BBupper <= -69.2922 )
					if( BBupper <= 696.207 )
						ret := 0.861111 // buy
					if( BBupper > 696.207 )
						if( vrsi <= 41.3254 )
...
float op_operation = decision_tree_0_HUBS_1Hour_7672b4bc(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
