			...
			if( Positive_Money_Flow_Sum <= 6.43768e+10 )
				...
				if( Positive_Money_Flow_Sum > 3.96638e+10 )
					...
					if( k > 80.754 )
						ret := -0.547368
			if( Positive_Money_Flow_Sum > 6.43768e+10 )
				if( Negative_Money_Flow_Sum <= 4.32543e+10 )
					if( smoothK_k <= 66.5871 )
						ret := -0.564103
					if( smoothK_k > 66.5871 )
						ret := 0.666667
				if( Negative_Money_Flow_Sum > 4.32543e+10 )
					if( Typical_Price <= 321.099 )
						ret := 0.227273
					if( Typical_Price > 321.099 )
						ret := 0.773585 // buy
		if( MFI_Low > 48.1726 )
			if( Positive_Money_Flow <= 5.5127e+09 )
				if( Positive_Money_Flow_Sum <= 7.50977e+10 )
					if( smoothK_k <= 88.2815 )
						ret := 0.609091
					if( smoothK_k > 88.2815 )
						ret := 0.064103
				if( Positive_Money_Flow_Sum > 7.50977e+10 )
					if( Positive_Money_Flow_Sum <= 9.53664e+10 )
						ret := -0.631579
					if( Positive_Money_Flow_Sum > 9.53664e+10 )
						ret := 0.750000 // buy
			if( Positive_Money_Flow > 5.5127e+09 )
				if( d_k <= 4.27505 )
					if( smoothD_d <= 71.4995 )
						ret := -0.100000
					if( smoothD_d > 71.4995 )
						ret := -0.605263
				if( d_k > 4.27505 )
					if( Typical_Price <= 349.132 )
						ret := 0.818182 // buy
					if( Typical_Price > 349.132 )
						ret := 0.125000
...
float op_operation = decision_tree_0_META_1Day_41d647a1(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
