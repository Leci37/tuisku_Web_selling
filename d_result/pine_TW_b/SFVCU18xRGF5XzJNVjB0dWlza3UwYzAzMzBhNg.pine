...
decision_tree_0_HUBS_1Day_0c0330a6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Positive_Money_Flow_Sum > 2.54559e+09 )
		if( VIM <= 0.985437 )
			if( VIP <= 1.18456 )
				if( Negative_Money_Flow <= 1.13859e+08 )
					if( MFI_Low <= 41.365 )
						ret := 0.318182
					if( MFI_Low > 41.365 )
						ret := -0.736111 // sell
		...
		if( VIM > 0.985437 )
			if( MFI_High <= -15.5773 )
				if( Typical_Price <= 713.767 )
					if( Typical_Price <= 477.678 )
						ret := 0.782609 // buy
					if( Typical_Price > 477.678 )
						ret := 0.137931
				if( Typical_Price > 713.767 )
...
float op_operation = decision_tree_0_HUBS_1Day_0c0330a6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
