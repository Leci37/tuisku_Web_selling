...
decision_tree_0_TTD_5Min_651d7cab(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)=>
	...
	if( verde_media > 8.64191 )
		if( oscp <= 64.9419 )
			if( verde_mean <= 5.57951 )
				if( verde <= 23.264 )
					if( pvi <= 0.300515 )
						if( marron_mean <= 12.6642 )
							ret := 0.823529 // buy
						if( marron_mean > 12.6642 )
							ret := -0.500000
					if( pvi > 0.300515 )
						if( verde_azul <= 23.0545 )
							ret := 0.142857
						if( verde_azul > 23.0545 )
							ret := -0.571429
				if( verde > 23.264 )
					if( xmf <= 83.7618 )
						if( marron_mean <= 27.9588 )
							ret := -0.670139
						if( marron_mean > 27.9588 )
							ret := 0.333333
					if( xmf > 83.7618 )
				...
				if( azul <= -35.0664 )
					if( tprice <= 75.886 )
						...
						if( nvimax > 0.122398 )
							ret := 0.284091
					if( tprice > 75.886 )
						if( marron_mean <= 52.3189 )
							ret := -0.268382
						if( marron_mean > 52.3189 )
							ret := 0.181818
				if( azul > -35.0664 )
					if( media_azul <= 4.63305 )
						if( xrsi <= 55.2606 )
							ret := -0.050000
						if( xrsi > 55.2606 )
							ret := -0.494737
					if( media_azul > 4.63305 )
						if( marron_mean <= 14.9637 )
							ret := -0.586207
						if( marron_mean > 14.9637 )
							ret := -0.039047
		if( oscp > 64.9419 )
			if( tprice <= 80.7429 )
				if( media_azul <= 111.129 )
					if( BollOsc <= 42.8345 )
						if( verde_media <= 57.5172 )
							ret := 1.000000 // buy
						if( verde_media > 57.5172 )
							ret := -0.864583 // sell
					if( BollOsc > 42.8345 )
						...
						if( xmf > 71.4696 )
							ret := 0.122093
				if( media_azul > 111.129 )
					if( verde_azul <= 242.802 )
						if( oscp <= 68.0228 )
							ret := 0.500000
						if( oscp > 68.0228 )
							ret := 0.974359 // buy
					if( verde_azul > 242.802 )
						if( azul_mean <= -10.8505 )
							ret := 0.370370
						if( azul_mean > -10.8505 )
							ret := -0.750000 // sell
			if( tprice > 80.7429 )
...
float op_operation = decision_tree_0_TTD_5Min_651d7cab(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
