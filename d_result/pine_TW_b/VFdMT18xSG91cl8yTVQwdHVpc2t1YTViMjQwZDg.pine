		...
		if( Positive_Money_Flow_Sum > 1.0625e+09 )
			if( Money_Flow_Ratio <= 6.2105 )
				...
				if( tema > 190.087 )
					ret := -0.750000 // sell
			if( Money_Flow_Ratio > 6.2105 )
				if( Money_Flow_Ratio <= 47.9492 )
					ret := 0.400000
				if( Money_Flow_Ratio > 47.9492 )
					ret := -0.928571 // sell
	if( Negative_Money_Flow > 1852.24 )
		if( Positive_Money_Flow_Sum <= 2.20859e+09 )
			if( Raw_Money_Flow <= 2.68141e+06 )
				if( tema <= 380.765 )
					if( Positive_Money_Flow_Sum <= 5.85673e+08 )
						if( MFI_Low <= 79.7158 )
							ret := 0.087518
						if( MFI_Low > 79.7158 )
							ret := -0.880952 // sell
					if( Positive_Money_Flow_Sum > 5.85673e+08 )
						if( Positive_Money_Flow_Sum <= 7.94606e+08 )
							ret := 0.622222
						if( Positive_Money_Flow_Sum > 7.94606e+08 )
							ret := 0.006667
				if( tema > 380.765 )
					ret := -0.578313
			if( Raw_Money_Flow > 2.68141e+06 )
				if( Negative_Money_Flow <= 3.73446e+08 )
					if( Negative_Money_Flow_Sum <= 1.14974e+09 )
						if( ema13 <= 7.051 )
							ret := -0.010820
						if( ema13 > 7.051 )
							ret := 0.480620
					if( Negative_Money_Flow_Sum > 1.14974e+09 )
						if( Negative_Money_Flow_Sum <= 1.97965e+09 )
							ret := 0.481928
						if( Negative_Money_Flow_Sum > 1.97965e+09 )
							ret := -1.000000 // sell
				if( Negative_Money_Flow > 3.73446e+08 )
...
float op_operation = decision_tree_0_TWLO_1Hour_a5b240d8(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
