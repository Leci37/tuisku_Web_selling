...
decision_tree_0_SHOP_1Hour_4e935ff9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)=>
	...
	if( BBlower > 886.621 )
		if( dif_source_BBlower <= 180.936 )
			...
			if( BBupper > 1630.37 )
				if( BBupper <= 1764.21 )
					if( dif_source_BBupper <= -343.408 )
						if( vrsi <= 20.3951 )
							ret := 0.950000 // buy
						if( vrsi > 20.3951 )
							ret := -0.153846
					if( dif_source_BBupper > -343.408 )
						if( dif_source_BBlower <= 143.278 )
							ret := -0.647303
						if( dif_source_BBlower > 143.278 )
							ret := 0.320000
				if( BBupper > 1764.21 )
		...
		if( dif_source_BBlower > 180.936 )
			if( BBlower <= 1356.02 )
				if( BBlower <= 993.12 )
					ret := -0.655319
				if( BBlower > 993.12 )
					if( dif_source_BBupper <= 15.8151 )
						if( BBlower <= 1328.22 )
							ret := -0.306647
						if( BBlower > 1328.22 )
							ret := 0.246914
					if( dif_source_BBupper > 15.8151 )
						if( dif_source_BBlower <= 398.854 )
							ret := 0.532051
						if( dif_source_BBlower > 398.854 )
							ret := -0.735294 // sell
			if( BBlower > 1356.02 )
...
float op_operation = decision_tree_0_SHOP_1Hour_4e935ff9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
