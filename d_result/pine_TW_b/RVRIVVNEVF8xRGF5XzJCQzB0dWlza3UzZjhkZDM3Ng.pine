...
decision_tree_0_ETHUSDT_1Day_3f8dd376(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)=>
	...
	if( BBPower_Color > 0.5 )
		...
		if( ad > -53449.7 )
			if( bbp <= 44.1169 )
				if( bullPower <= 55.4472 )
					if( bearPower <= 9.94926 )
						ret := 0.168831
					if( bearPower > 9.94926 )
						ret := -0.526316
				if( bullPower > 55.4472 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_3f8dd376(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
