			...
			if( bearPower <= -47.1316 )
				...
				if( bullPower > -47.2941 )
					if( Upper_Band <= 1362.91 )
						if( Lower_Band <= 1134.8 )
							ret := 0.647059
						if( Lower_Band > 1134.8 )
							ret := -0.666667
					if( Upper_Band > 1362.91 )
						if( Upper_Band <= 1417.93 )
							ret := 1.000000 // buy
						if( Upper_Band > 1417.93 )
							ret := 0.455882
			if( bearPower > -47.1316 )
				if( bearPower <= -24.9115 )
					if( bbp <= -62.7682 )
						if( bbm <= 2.9 )
							ret := -0.375000
						if( bbm > 2.9 )
				...
				if( bearPower > -24.9115 )
					if( basis <= 1536.51 )
						if( bullPower <= 0.40093 )
							ret := -0.261468
						if( bullPower > 0.40093 )
							ret := 0.124060
					if( basis > 1536.51 )
						if( Upper_Band <= 1613.97 )
							ret := -0.682243
						if( Upper_Band > 1613.97 )
							ret := -0.076923
	if( bearPower > -7.20014 )
		if( Upper_Band <= 29.4929 )
			if( basis <= 27.153 )
				if( Upper_Band <= 27.1195 )
					if( Upper_Band <= 26.5863 )
						ret := -0.437500
					if( Upper_Band > 26.5863 )
						if( bbm <= 0.841584 )
							ret := 0.527473
			...
			if( basis > 27.153 )
				if( basis <= 28.6078 )
					if( bullPower <= 0.843312 )
						if( Lower_Band <= 27.5356 )
							ret := 0.972222 // buy
						if( Lower_Band > 27.5356 )
							ret := 0.703704 // buy
					if( bullPower > 0.843312 )
						if( bearPower <= 0.251864 )
							ret := -0.285714
						if( bearPower > 0.251864 )
							ret := 0.760000 // buy
				if( basis > 28.6078 )
		...
		if( Upper_Band > 29.4929 )
			if( basis <= 28.9848 )
				if( bbm <= 0.7675 )
					if( bullPower <= -0.075327 )
						if( Lower_Band <= 26.116 )
							ret := -0.714286 // sell
						if( Lower_Band > 26.116 )
							ret := 0.125000
					if( bullPower > -0.075327 )
				...
				if( bbm > 0.7675 )
					ret := 0.466667
			if( basis > 28.9848 )
				if( Upper_Band <= 30.8414 )
					if( bearPower <= 0.134611 )
						if( bbm <= 0.835475 )
							ret := 0.905172 // buy
						if( bbm > 0.835475 )
							ret := 0.380952
					if( bearPower > 0.134611 )
						ret := -0.888889 // sell
				if( Upper_Band > 30.8414 )
					if( Lower_Band <= 115.391 )
						if( bbp <= 1.00029 )
							ret := -0.054144
						if( bbp > 1.00029 )
							ret := 0.112163
					if( Lower_Band > 115.391 )
						if( Upper_Band <= 1053.67 )
							ret := 0.104347
						if( Upper_Band > 1053.67 )
							ret := -0.056446
...
float op_operation = decision_tree_0_SHOP_1Hour_5085f1ae(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
