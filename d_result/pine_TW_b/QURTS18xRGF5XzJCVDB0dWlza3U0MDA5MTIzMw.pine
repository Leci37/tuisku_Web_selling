...
decision_tree_0_ADSK_1Day_40091233(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)=>
	...
	if( tema > 202.791 )
		if( tema <= 222.175 )
			if( bullPower <= -3.00742 )
				if( ema3 <= 209.12 )
					ret := 1.000000 // buy
				if( ema3 > 209.12 )
					if( bearPower <= -12.9728 )
						ret := 0.500000
					if( bearPower > -12.9728 )
						ret := -0.440000
			if( bullPower > -3.00742 )
...
float op_operation = decision_tree_0_ADSK_1Day_40091233(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)
