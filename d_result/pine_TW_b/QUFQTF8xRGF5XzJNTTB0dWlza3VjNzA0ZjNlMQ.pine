			...
			if( Typical_Price <= 236.478 )
				if( Negative_Money_Flow <= 6.23364e+09 )
					...
					if( MFI > 67.5569 )
						ret := -0.393750
				if( Negative_Money_Flow > 6.23364e+09 )
					if( Positive_Money_Flow_Sum <= 8.10837e+10 )
						ret := -0.206294
					if( Positive_Money_Flow_Sum > 8.10837e+10 )
						ret := -0.528662
			if( Typical_Price > 236.478 )
				...
				if( MFI_High > -14.0396 )
					...
					if( Long_MA > 290.379 )
						ret := -0.671053
		if( Negative_Money_Flow_Sum > 1.38515e+11 )
			if( Negative_Money_Flow <= 2.03605e+10 )
				if( MFI <= 46.9457 )
					if( Negative_Money_Flow <= 1.79941e+10 )
						ret := -0.852459 // sell
					if( Negative_Money_Flow > 1.79941e+10 )
						ret := -1.000000 // sell
				if( MFI > 46.9457 )
...
float op_operation = decision_tree_0_AAPL_1Day_c704f3e1(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
