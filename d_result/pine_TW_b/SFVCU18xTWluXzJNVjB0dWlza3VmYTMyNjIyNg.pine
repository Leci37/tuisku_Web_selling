		...
		if( Typical_Price > 496.091 )
			if( Positive_Money_Flow_Sum <= 1.15717e+08 )
				if( Money_Flow_Ratio <= 35.8447 )
					if( Positive_Money_Flow_Sum <= 6.40182e+07 )
						if( Positive_Money_Flow_Sum <= 2.84007e+07 )
							ret := -0.009371
						if( Positive_Money_Flow_Sum > 2.84007e+07 )
							ret := -0.151026
					if( Positive_Money_Flow_Sum > 6.40182e+07 )
						...
						if( VIP_VIM > 0.782452 )
							ret := -0.677966
				if( Money_Flow_Ratio > 35.8447 )
					if( Negative_Money_Flow_Sum <= 987217 )
						if( Money_Flow_Ratio <= 49.8345 )
							ret := -0.100000
						if( Money_Flow_Ratio > 49.8345 )
							ret := -0.769231 // sell
					if( Negative_Money_Flow_Sum > 987217 )
						if( Positive_Money_Flow_Sum <= 6.9522e+07 )
							ret := -1.000000 // sell
						if( Positive_Money_Flow_Sum > 6.9522e+07 )
							ret := -0.200000
			if( Positive_Money_Flow_Sum > 1.15717e+08 )
			...
			if( MFI_Low > -16.5584 )
				...
				if( MFI_High > -74.7473 )
					...
					if( MFI_High > -68.2933 )
						ret := 0.888889 // buy
		if( MFI > 14.8294 )
			if( Negative_Money_Flow_Sum <= 2.1018e+07 )
				if( Typical_Price <= 599.197 )
					if( MFI <= 78.0427 )
						ret := 0.533333
					if( MFI > 78.0427 )
						if( Typical_Price <= 572.409 )
							ret := 0.981818 // buy
						if( Typical_Price > 572.409 )
							ret := 0.785714 // buy
				if( Typical_Price > 599.197 )
					ret := -0.375000
			if( Negative_Money_Flow_Sum > 2.1018e+07 )
				if( Negative_Money_Flow_Sum <= 4.57886e+07 )
					if( Negative_Money_Flow_Sum <= 3.94195e+07 )
						if( Money_Flow_Ratio <= 1.52654 )
							ret := 0.711111 // buy
						if( Money_Flow_Ratio > 1.52654 )
							ret := -0.125000
					if( Negative_Money_Flow_Sum > 3.94195e+07 )
						if( Negative_Money_Flow <= 2.81451e+07 )
							ret := -0.580000
						if( Negative_Money_Flow > 2.81451e+07 )
							ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 4.57886e+07 )
					if( Raw_Money_Flow <= 5.76822e+07 )
						if( Money_Flow_Ratio <= 1.85662 )
							ret := 0.635762
						if( Money_Flow_Ratio > 1.85662 )
							ret := -1.000000 // sell
					if( Raw_Money_Flow > 5.76822e+07 )
...
float op_operation = decision_tree_0_HUBS_1Min_fa326226(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
