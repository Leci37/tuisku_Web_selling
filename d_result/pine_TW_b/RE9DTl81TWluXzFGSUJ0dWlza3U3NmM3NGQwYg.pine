	...
	if( lower_4 > 46.9295 )
		if( upper_6 <= 51.8478 )
			...
			if( lower_3 > 48.2373 )
				ret := -0.913043 // sell
		if( upper_6 > 51.8478 )
			if( basis_max <= -2.67958 )
				ret := -0.810811 // sell
			if( basis_max > -2.67958 )
				if( basis_minus <= 2.65497 )
					if( basis_minus <= 2.48487 )
						ret := 0.068702
					if( basis_minus > 2.48487 )
						if( upper_2 <= 50.5849 )
							ret := 0.086957
...
float op_operation = decision_tree_0_DOCN_5Min_76c74d0b(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
