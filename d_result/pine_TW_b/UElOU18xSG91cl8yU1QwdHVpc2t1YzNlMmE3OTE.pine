				...
				if( ema13 > -0.072122 )
					...
					if( ema13 > 0.578892 )
						...
						if( smoothK_k > 67.5022 )
							ret := -0.000682
		if( ema3 > 63.9676 )
			if( smoothK_k <= 81.6493 )
				if( smoothK_k <= 76.2292 )
					if( d <= 0.568552 )
						ret := 1.000000 // buy
					if( d > 0.568552 )
						if( rsi1 <= 26.4494 )
...
float op_operation = decision_tree_0_PINS_1Hour_c3e2a791(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)
