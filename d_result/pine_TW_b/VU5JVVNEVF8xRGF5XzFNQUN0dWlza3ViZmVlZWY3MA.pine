...
float op_operation = decision_tree_0_UNIUSDT_1Day_bfeeef70(histB_IsUpInt, macd_IsBelowInt, macd, histB_IsDownInt, macd_IsAboveInt, histA_IsDownInt, histA_IsUpInt, hist, signal)
