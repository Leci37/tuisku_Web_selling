			...
			if( Raw_Money_Flow > 9.51723e+07 )
				...
				if( Positive_Money_Flow_Sum > 6.08298e+09 )
					...
					if( Positive_Money_Flow_Sum > 1.681e+10 )
						ret := -0.888889 // sell
		if( Raw_Money_Flow > 1.30345e+09 )
			if( Positive_Money_Flow_Sum <= 1.78748e+10 )
				ret := 1.000000 // buy
			if( Positive_Money_Flow_Sum > 1.78748e+10 )
				if( Positive_Money_Flow_Sum <= 2.77536e+10 )
					ret := 0.125000
				if( Positive_Money_Flow_Sum > 2.77536e+10 )
					ret := -0.250000
...
float op_operation = decision_tree_0_PTON_1Day_8d935776(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
