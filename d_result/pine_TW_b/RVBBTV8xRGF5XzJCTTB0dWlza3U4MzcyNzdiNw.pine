			...
			if( Negative_Money_Flow_Sum <= 1.72151e+09 )
				...
				if( Negative_Money_Flow_Sum > 1.42965e+09 )
					...
					if( Positive_Money_Flow_Sum > 1.65948e+09 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 1.72151e+09 )
				if( bearPower <= -101.422 )
					ret := -0.200000
				if( bearPower > -101.422 )
					if( Typical_Price <= 286.775 )
						ret := 0.966667 // buy
					if( Typical_Price > 286.775 )
						ret := 0.454545
		if( Typical_Price > 290.629 )
			if( Negative_Money_Flow_Sum <= 4.31322e+08 )
				if( bullPower <= 34.6385 )
					if( Raw_Money_Flow <= 1.49551e+08 )
						ret := 0.060606
					if( Raw_Money_Flow > 1.49551e+08 )
						ret := 0.608696
				if( bullPower > 34.6385 )
			...
			if( Negative_Money_Flow_Sum > 4.31322e+08 )
				if( bbp <= -21.1387 )
					if( Positive_Money_Flow_Sum <= 1.22853e+09 )
						ret := -0.857143 // sell
					if( Positive_Money_Flow_Sum > 1.22853e+09 )
						ret := 0.435484
				if( bbp > -21.1387 )
					if( Positive_Money_Flow <= 466925 )
						ret := -0.328571
					if( Positive_Money_Flow > 466925 )
						ret := -0.717314 // sell
...
float op_operation = decision_tree_0_EPAM_1Day_837277b7(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
