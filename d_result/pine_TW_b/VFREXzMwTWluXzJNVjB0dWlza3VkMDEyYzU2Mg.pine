		...
		if( Typical_Price <= 27.9117 )
			...
			if( VIM > 1.39656 )
				...
				if( Raw_Money_Flow > 25498 )
					ret := -0.626866
		if( Typical_Price > 27.9117 )
			if( Positive_Money_Flow_Sum <= 7.42281e+08 )
				if( Money_Flow_Ratio <= 470.644 )
					if( VIP_VIM <= -0.860925 )
						if( Typical_Price <= 220.745 )
							ret := -0.108974
						if( Typical_Price > 220.745 )
							ret := -0.675676
					if( VIP_VIM > -0.860925 )
						if( Negative_Money_Flow_Sum <= 1.78294e+06 )
							ret := -0.125255
						if( Negative_Money_Flow_Sum > 1.78294e+06 )
							ret := -0.003111
				if( Money_Flow_Ratio > 470.644 )
					if( VIP_VIM <= 1.02079 )
						if( Typical_Price <= 50.3433 )
							ret := 0.428571
						if( Typical_Price > 50.3433 )
							ret := -0.644809
					if( VIP_VIM > 1.02079 )
						if( Typical_Price <= 219.872 )
							ret := -0.666667
						if( Typical_Price > 219.872 )
							ret := 0.777778 // buy
			if( Positive_Money_Flow_Sum > 7.42281e+08 )
				if( Negative_Money_Flow_Sum <= 5.06475e+08 )
					if( Negative_Money_Flow_Sum <= 2.2e+08 )
						if( Typical_Price <= 263.537 )
							ret := 0.775862 // buy
						if( Typical_Price > 263.537 )
							ret := -0.360000
					if( Negative_Money_Flow_Sum > 2.2e+08 )
						if( Positive_Money_Flow_Sum <= 1.38958e+09 )
							ret := 0.872727 // buy
						if( Positive_Money_Flow_Sum > 1.38958e+09 )
							ret := -0.333333
				if( Negative_Money_Flow_Sum > 5.06475e+08 )
					if( Raw_Money_Flow <= 6.92891e+07 )
						ret := 0.581395
					if( Raw_Money_Flow > 6.92891e+07 )
						ret := -0.464286
...
float op_operation = decision_tree_0_TTD_30Min_d012c562(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
