...
decision_tree_0_META_1Day_299b6971(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Money_Flow_Ratio > 0.763358 )
		if( MFI <= 68.9514 )
			...
			if( MFI_Low > 34.4267 )
				if( MFI_Low <= 42.1538 )
					if( Raw_Money_Flow <= 2.88381e+09 )
						ret := -0.092593
					if( Raw_Money_Flow > 2.88381e+09 )
						ret := -0.483622
				if( MFI_Low > 42.1538 )
					if( Money_Flow_Ratio <= 1.93712 )
						ret := 0.173077
					if( Money_Flow_Ratio > 1.93712 )
						ret := -0.288889
		if( MFI > 68.9514 )
			if( Positive_Money_Flow_Sum <= 7.30299e+10 )
				if( bbm <= 2.84821 )
					if( bearPower <= 1.09126 )
						ret := 0.826087 // buy
					if( bearPower > 1.09126 )
						ret := -0.130435
				if( bbm > 2.84821 )
					...
					if( Typical_Price > 190.235 )
						ret := 0.405797
			if( Positive_Money_Flow_Sum > 7.30299e+10 )
				if( Raw_Money_Flow <= 1.00524e+10 )
					if( bullPower <= 26.8951 )
						ret := -0.640625
					if( bullPower > 26.8951 )
						ret := 0.000000
				if( Raw_Money_Flow > 1.00524e+10 )
					if( Positive_Money_Flow_Sum <= 8.9625e+10 )
						ret := 0.857143 // buy
					if( Positive_Money_Flow_Sum > 8.9625e+10 )
						ret := -0.500000
...
float op_operation = decision_tree_0_META_1Day_299b6971(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
