		...
		if( bearPower <= -1.0292 )
			if( Negative_Money_Flow <= 1.82934e+08 )
				if( Negative_Money_Flow_Sum <= 3.09982e+09 )
					if( Positive_Money_Flow_Sum <= 1.80116e+09 )
						if( bearPower <= -3.32721 )
							ret := 0.412281
						if( bearPower > -3.32721 )
							ret := 0.058972
					if( Positive_Money_Flow_Sum > 1.80116e+09 )
				...
				if( Negative_Money_Flow_Sum > 3.09982e+09 )
					ret := 0.538462
			if( Negative_Money_Flow > 1.82934e+08 )
				if( Money_Flow_Ratio <= 0.614793 )
					ret := -0.068841
				if( Money_Flow_Ratio > 0.614793 )
					ret := -0.684564
		if( bearPower > -1.0292 )
			if( Money_Flow_Ratio <= 0.232415 )
				if( Positive_Money_Flow <= 3.1607e+06 )
					ret := -0.429104
				if( Positive_Money_Flow > 3.1607e+06 )
					ret := 0.227273
			if( Money_Flow_Ratio > 0.232415 )
				if( Positive_Money_Flow_Sum <= 7.65703e+08 )
					if( Negative_Money_Flow_Sum <= 7.72067e+08 )
						if( bullPower <= 0.253692 )
							ret := -0.026448
						if( bullPower > 0.253692 )
							ret := -0.168079
					if( Negative_Money_Flow_Sum > 7.72067e+08 )
						if( Negative_Money_Flow <= 1.1562e+06 )
							ret := -0.638095
						if( Negative_Money_Flow > 1.1562e+06 )
							ret := 0.340000
				if( Positive_Money_Flow_Sum > 7.65703e+08 )
					if( Positive_Money_Flow_Sum <= 8.49148e+08 )
						ret := 0.521127
					if( Positive_Money_Flow_Sum > 8.49148e+08 )
						if( bbm <= 0.459631 )
							ret := 0.228228
...
float op_operation = decision_tree_0_RBLX_1Hour_f36f9fea(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
