			...
			if( bearPower <= 0.135015 )
				...
				if( Lower_Band > 2.54459 )
					if( Lower_Band <= 2.73968 )
						if( Lower_Band <= 2.63482 )
							ret := 0.010490
						if( Lower_Band > 2.63482 )
							ret := -0.712389 // sell
					if( Lower_Band > 2.73968 )
						if( Upper_Band <= 2.95303 )
							ret := -0.659091
						if( Upper_Band > 2.95303 )
							ret := -0.026147
			if( bearPower > 0.135015 )
				if( bbm <= 0.079995 )
					if( Lower_Band <= 15.3976 )
						if( Upper_Band <= 6.9795 )
							ret := 0.723077 // buy
						if( Upper_Band > 6.9795 )
							ret := 0.101796
					if( Lower_Band > 15.3976 )
						if( Lower_Band <= 20.5108 )
							ret := 0.890625 // buy
						if( Lower_Band > 20.5108 )
							ret := 0.243243
				if( bbm > 0.079995 )
...
float op_operation = decision_tree_0_NIO_1Hour_65bd1827(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
