...
decision_tree_0_MELI_30Min_e5501a27(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Short_MA > 335.834 )
				...
				if( Raw_Money_Flow <= 2.03701e+06 )
					...
					if( Short_Long_Diff > 1.75372 )
						...
						if( MFI_High > -29.8356 )
							ret := 0.086957
				if( Raw_Money_Flow > 2.03701e+06 )
					if( Negative_Money_Flow_Sum <= 2.25773e+08 )
						if( Short_Long_Diff <= 5.32904 )
							ret := -0.040561
						if( Short_Long_Diff > 5.32904 )
							ret := 0.131765
					if( Negative_Money_Flow_Sum > 2.25773e+08 )
						ret := 0.178998
			if( MFI_High > -19.441 )
				if( Short_Long_Diff <= 39.0283 )
					if( Positive_Money_Flow_Sum <= 1.84952e+08 )
						if( Raw_Money_Flow <= 1.40296e+06 )
							ret := -0.406940
						if( Raw_Money_Flow > 1.40296e+06 )
							ret := -0.112878
					if( Positive_Money_Flow_Sum > 1.84952e+08 )
						if( Typical_Price <= 1194.38 )
							ret := 0.028024
						if( Typical_Price > 1194.38 )
							ret := -0.107602
				if( Short_Long_Diff > 39.0283 )
		...
		if( Negative_Money_Flow_Sum > 2.66236e+08 )
			if( MFI_Low <= 29.6268 )
				if( Short_Long_Diff <= -36.5611 )
					if( Short_MA <= 1460.99 )
						ret := -0.531100
					if( Short_MA > 1460.99 )
						if( Negative_Money_Flow_Sum <= 9.84891e+08 )
							ret := -0.172043
						if( Negative_Money_Flow_Sum > 9.84891e+08 )
							ret := 1.000000 // buy
				if( Short_Long_Diff > -36.5611 )
...
float op_operation = decision_tree_0_MELI_30Min_e5501a27(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
