		...
		if( ema12 <= 0.005556 )
			...
			if( d_k > 11.8627 )
				...
				if( ema12 > -0.146328 )
					ret := -0.666667
		if( ema12 > 0.005556 )
			if( smoothD_d <= 96.4403 )
				if( smoothD_d <= 1.81847 )
					ret := -1.000000 // sell
				if( smoothD_d > 1.81847 )
					if( smoothD_d <= 9.23596 )
						if( tema <= 235.687 )
							ret := -0.250000
						if( tema > 235.687 )
							ret := 0.071429
...
float op_operation = decision_tree_0_SNOW_5Min_5fb56408(d_k, d, rsi1, k, smoothD_d, smoothK_k, ema1, tema, ema12, ema2, ema3, ema13)
