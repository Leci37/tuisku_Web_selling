...
decision_tree_0_RBLX_15Min_67fbbac6(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)=>
	...
	if( basis > 39.7151 )
		if( upper_3 <= 40.4836 )
			if( basis_minus <= 1.19721 )
				ret := 0.000000
			if( basis_minus > 1.19721 )
				ret := -1.000000 // sell
		if( upper_3 > 40.4836 )
			if( basis_max <= -36.2301 )
				if( upper_1 <= 108.518 )
					if( upper_1 <= 108.382 )
						if( lower_3 <= 81.302 )
							ret := -0.900000 // sell
...
float op_operation = decision_tree_0_RBLX_15Min_67fbbac6(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)
