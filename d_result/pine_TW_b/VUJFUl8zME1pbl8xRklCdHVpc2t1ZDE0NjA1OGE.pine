	...
	if( basis_max <= -1.28023 )
		...
		if( lower_5 > 21.936 )
			...
			if( basis_max > -6.19076 )
				...
				if( upper_5 > 24.4233 )
					if( upper_5 <= 25.0386 )
						if( basis_minus <= 1.68609 )
							ret := -0.052632
						if( basis_minus > 1.68609 )
							ret := -0.800000 // sell
					if( upper_5 > 25.0386 )
						if( basis_max <= -3.76646 )
							ret := -0.070174
						if( basis_max > -3.76646 )
							ret := -0.008252
	if( basis_max > -1.28023 )
		if( basis_max <= -0.832692 )
			if( lower_5 <= 23.9277 )
				ret := 0.746269 // buy
			if( lower_5 > 23.9277 )
				if( basis <= 27.8684 )
...
float op_operation = decision_tree_0_UBER_30Min_d146058a(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)
