...
float op_operation = decision_tree_0_CRSR_1Day_af0b2b1e(val, sqzOnInt, lowerBB, lowerKC, upperKC, dev, rangema, sqzOffInt, upperBB, priceRange, noSqzInt, ma, basis, avgHighLow)
