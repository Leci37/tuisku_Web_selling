				...
				if( ema13 <= -1.15023 )
					...
					if( ema1 > 54.6044 )
						...
						if( k > 71.8926 )
							ret := -0.210256
				if( ema13 > -1.15023 )
					if( smoothK_k <= 86.5936 )
						if( smoothD_d <= 83.6006 )
							ret := -0.022080
						if( smoothD_d > 83.6006 )
							ret := -0.581395
					if( smoothK_k > 86.5936 )
						if( smoothD_d <= 82.3991 )
							ret := 0.346067
						if( smoothD_d > 82.3991 )
							ret := 0.102605
		if( d_k > 1.43249 )
...
float op_operation = decision_tree_0_UPST_1Hour_a7a8b702(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)
