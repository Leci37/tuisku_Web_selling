				...
				if( dx > 82.1555 )
					if( diMinus <= 2.66728 )
						...
						if( trueRange > 0.1675 )
							ret := 0.687500
					if( diMinus > 2.66728 )
						if( directionalMovementMinus <= 0.010539 )
							ret := -0.979592 // sell
						if( directionalMovementMinus > 0.010539 )
							ret := 1.000000 // buy
	if( directionalMovementMinus > 0.180661 )
		if( directionalMovementMinus <= 0.320515 )
			if( smoothedTrueRange <= 0.08549 )
				ret := 0.694444
			if( smoothedTrueRange > 0.08549 )
				if( diMinus <= 72.9404 )
					ret := 0.237467
...
float op_operation = decision_tree_0_DOCN_1Min_40f9971f(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
