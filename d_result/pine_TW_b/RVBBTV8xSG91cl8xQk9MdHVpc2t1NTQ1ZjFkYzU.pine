			...
			if( BBlower <= 539.155 )
				if( dif_source_BBlower <= -32.5558 )
					if( vrsi <= 9.4132 )
						ret := -0.600000
					if( vrsi > 9.4132 )
						if( dif_source_BBlower <= -96.5682 )
							ret := 0.333333
						if( dif_source_BBlower > -96.5682 )
							ret := 0.883333 // buy
				if( dif_source_BBlower > -32.5558 )
					if( dif_source_BBupper <= -99.9196 )
						if( BBlower <= 401.297 )
							ret := -0.115702
						if( BBlower > 401.297 )
							ret := -0.512500
					if( dif_source_BBupper > -99.9196 )
						if( dif_source_BBlower <= 41.8913 )
							ret := 0.010901
						if( dif_source_BBlower > 41.8913 )
							ret := -0.096765
			if( BBlower > 539.155 )
				if( dif_source_BBlower <= 125.607 )
					if( dif_source_BBupper <= -7.79646 )
						if( BBlower <= 569.349 )
							ret := 0.606280
						if( BBlower > 569.349 )
							ret := 0.103448
...
float op_operation = decision_tree_0_EPAM_1Hour_545f1dc5(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
