	...
	if( Negative_Money_Flow_Sum > 7.89524e+08 )
		if( d <= 8.30142 )
			...
			if( Typical_Price > 488.842 )
				ret := -0.888060 // sell
		if( d > 8.30142 )
			if( Positive_Money_Flow_Sum <= 4.95538e+08 )
				if( MFI <= 26.6698 )
					if( Negative_Money_Flow_Sum <= 1.10167e+09 )
						if( Negative_Money_Flow_Sum <= 8.70067e+08 )
							ret := -0.434783
						if( Negative_Money_Flow_Sum > 8.70067e+08 )
							ret := 0.671429
					if( Negative_Money_Flow_Sum > 1.10167e+09 )
						if( Negative_Money_Flow_Sum <= 1.82891e+09 )
							ret := -0.552632
						if( Negative_Money_Flow_Sum > 1.82891e+09 )
							ret := 0.400000
				if( MFI > 26.6698 )
					if( Raw_Money_Flow <= 1.26523e+08 )
						ret := -0.816327 // sell
					if( Raw_Money_Flow > 1.26523e+08 )
						ret := 0.307692
			if( Positive_Money_Flow_Sum > 4.95538e+08 )
				if( k <= 6.59697 )
					ret := -1.000000 // sell
				if( k > 6.59697 )
					if( Typical_Price <= 704.634 )
						if( Raw_Money_Flow <= 9.04204e+07 )
							ret := 1.000000 // buy
						if( Raw_Money_Flow > 9.04204e+07 )
							ret := 0.181818
					if( Typical_Price > 704.634 )
...
float op_operation = decision_tree_0_TTD_1Hour_5544b692(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, rsi1, d, k, smoothD_d, d_k, smoothK_k)
