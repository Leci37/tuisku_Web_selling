			...
			if( Lower_Band <= 6.93859 )
				if( bearPower <= -0.110896 )
					if( Upper_Band <= 4.93115 )
						if( bullPower <= -0.060168 )
							ret := -0.666667
						if( bullPower > -0.060168 )
							ret := 0.023392
					if( Upper_Band > 4.93115 )
						if( Upper_Band <= 5.00705 )
							ret := 0.863636 // buy
						if( Upper_Band > 5.00705 )
							ret := 0.219929
				if( bearPower > -0.110896 )
					if( bullPower <= 0.026535 )
						if( Lower_Band <= 4.41827 )
							ret := 0.049338
						if( Lower_Band > 4.41827 )
							ret := -0.089061
					if( bullPower > 0.026535 )
						if( Lower_Band <= 6.59737 )
							ret := 0.034321
						if( Lower_Band > 6.59737 )
							ret := 0.213652
			if( Lower_Band > 6.93859 )
				if( Lower_Band <= 7.41562 )
					if( Upper_Band <= 8.88268 )
						if( Lower_Band <= 7.26889 )
							ret := -0.141210
						if( Lower_Band > 7.26889 )
							ret := -0.480072
					if( Upper_Band > 8.88268 )
						ret := 0.926829 // buy
				if( Lower_Band > 7.41562 )
					if( Upper_Band <= 44.9184 )
						if( Lower_Band <= 38.5786 )
							ret := -0.022168
						if( Lower_Band > 38.5786 )
							ret := 0.174809
					if( Upper_Band > 44.9184 )
						if( Lower_Band <= 38.6037 )
							ret := 0.718750 // buy
						if( Lower_Band > 38.6037 )
							ret := -0.264392
...
float op_operation = decision_tree_0_DOTUSDT_1Hour_36d25912(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
