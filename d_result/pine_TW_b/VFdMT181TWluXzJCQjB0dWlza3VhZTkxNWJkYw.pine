...
decision_tree_0_TWLO_5Min_ae915bdc(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)=>
	...
	if( bbp > 0.125936 )
			...
			if( Lower_Band <= 56.675 )
				if( basis <= 57.4926 )
					...
					if( bbp > 0.838314 )
						ret := -0.714286 // sell
				if( basis > 57.4926 )
					if( bearPower <= 0.157473 )
						ret := 0.950000 // buy
					if( bearPower > 0.157473 )
						ret := -0.153846
			if( Lower_Band > 56.675 )
				if( bbm <= 0.25068 )
					if( bearPower <= 0.106479 )
						ret := -0.111202
					if( bearPower > 0.106479 )
						ret := 0.001337
				if( bbm > 0.25068 )
		...
		if( bearPower > 0.239123 )
			if( basis <= 64.1619 )
				if( bbm <= 0.09757 )
					if( bullPower <= 0.458506 )
						ret := -0.143689
					if( bullPower > 0.458506 )
						ret := -0.616438
				if( bbm > 0.09757 )
					if( Upper_Band <= 53.0483 )
						ret := -0.553571
					if( Upper_Band > 53.0483 )
						ret := 0.056917
			if( basis > 64.1619 )
...
float op_operation = decision_tree_0_TWLO_5Min_ae915bdc(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
