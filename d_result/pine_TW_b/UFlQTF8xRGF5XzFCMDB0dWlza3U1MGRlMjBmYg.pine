...
decision_tree_0_PYPL_1Day_50de20fb(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bearPower > -7.07577 )
		if( bullPower <= 1.61106 )
			...
			if( bbm > 2.28268 )
				if( bbp <= -3.51472 )
					if( bearPower <= -5.60765 )
						ret := 0.490566
					if( bearPower > -5.60765 )
						ret := 0.017751
				if( bbp > -3.51472 )
					if( bullPower <= -0.258126 )
						ret := 0.625000
					if( bullPower > -0.258126 )
						ret := -0.409722
		if( bullPower > 1.61106 )
			if( bbm <= 2.65972 )
				if( bbm <= 1.17696 )
					...
					if( bbp > 2.54324 )
						ret := -0.158537
				if( bbm > 1.17696 )
					if( bearPower <= -0.457098 )
						ret := 0.125000
					if( bearPower > -0.457098 )
						ret := -0.412451
			if( bbm > 2.65972 )
				if( bearPower <= -5.24295 )
					if( bbm <= 9.51296 )
						ret := -0.714286 // sell
					if( bbm > 9.51296 )
						ret := -1.000000 // sell
				if( bearPower > -5.24295 )
					if( bullPower <= 2.04828 )
						ret := -0.652174
					if( bullPower > 2.04828 )
						ret := 0.097668
...
float op_operation = decision_tree_0_PYPL_1Day_50de20fb(bearPower, bbm, bbp, bullPower, BBPower_Color)
