				...
				if( lowerBand > -9.66292 )
					if( lowerBand <= 0.681783 )
						...
						if( wvf > 10.2875 )
							ret := 0.371542
					if( lowerBand > 0.681783 )
						if( upperBand <= 21.7337 )
							ret := -0.158076
						if( upperBand > 21.7337 )
							ret := 0.404110
	if( lowerBand > 6.08695 )
		if( colInt <= 0.5 )
			if( upperBand <= 21.1409 )
				if( sDev <= 3.01631 )
					if( sDev <= 1.7577 )
						ret := 0.185185
					if( sDev > 1.7577 )
						ret := -0.638393
				if( sDev > 3.01631 )
					if( Color_con2 <= -9.81959 )
						if( Color_con1 <= -12.5134 )
							ret := -1.000000 // sell
						if( Color_con1 > -12.5134 )
							ret := 0.769231 // buy
					if( Color_con2 > -9.81959 )
						if( Color_con1 <= -3.30039 )
							ret := -0.244048
						if( Color_con1 > -3.30039 )
							ret := 0.833333 // buy
			if( upperBand > 21.1409 )
				...
				if( wvf > 8.87417 )
					ret := -0.852761 // sell
		if( colInt > 0.5 )
			if( lowerBand <= 10.4481 )
				if( upperBand <= 16.3441 )
					ret := 0.000000
				if( upperBand > 16.3441 )
					ret := 1.000000 // buy
			if( lowerBand > 10.4481 )
...
float op_operation = decision_tree_0_AFRM_30Min_6a04edcb(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
