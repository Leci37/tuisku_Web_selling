				...
				if( tema <= 199.38 )
					if( ema12 <= 0.927292 )
						...
						if( bbm > 0.686969 )
							ret := -0.512000
					if( ema12 > 0.927292 )
						if( bearPower <= 1.91587 )
							ret := 0.714286 // buy
						if( bearPower > 1.91587 )
							ret := -0.575000
				if( tema > 199.38 )
					if( bullPower <= 0.628513 )
						ret := -0.326531
					if( bullPower > 0.628513 )
						if( bbm <= 0.332015 )
							ret := -0.013514
...
float op_operation = decision_tree_0_FFIV_5Min_898a9953(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
