			...
			if( smoothedTrueRange > 0.603554 )
				...
				if( adx > 47.557 )
					...
					if( adx > 60.8766 )
						ret := 0.312500
	if( smoothedDirectionalMovementPlus > 0.398393 )
		if( trueRange <= 5.48498 )
			if( adx <= 70.5281 )
				if( diMinus <= 29.0561 )
					if( smoothedTrueRange <= 2.2276 )
						ret := -0.880435 // sell
					if( smoothedTrueRange > 2.2276 )
						ret := -0.571429
				if( diMinus > 29.0561 )
					ret := 0.000000
			if( adx > 70.5281 )
				if( smoothedDirectionalMovementPlus <= 0.679562 )
					ret := 1.000000 // buy
				if( smoothedDirectionalMovementPlus > 0.679562 )
					ret := 0.000000
		if( trueRange > 5.48498 )
...
float op_operation = decision_tree_0_DBX_1Day_bed37710(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
