			...
			if( basis <= 25.8614 )
				...
				if( bbp > -3.56188 )
					...
					if( bbm > 1.93537 )
						ret := 0.275862
			if( basis > 25.8614 )
				if( bullPower <= 7.07893 )
					if( Upper_Band <= 49.3942 )
						ret := -0.280156
					if( Upper_Band > 49.3942 )
						ret := 0.000000
				if( bullPower > 7.07893 )
					if( Upper_Band <= 123.369 )
						ret := 0.529412
					if( Upper_Band > 123.369 )
						ret := -0.135135
...
float op_operation = decision_tree_0_PTON_1Day_a93b5de6(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
