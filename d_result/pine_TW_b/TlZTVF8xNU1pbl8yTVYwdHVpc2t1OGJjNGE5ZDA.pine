	...
	if( VIP > 1.0153 )
		if( Typical_Price <= 19.1826 )
			...
			if( Positive_Money_Flow_Sum > 2.88656e+07 )
				ret := 0.452308
		if( Typical_Price > 19.1826 )
			if( Positive_Money_Flow <= 1.12332e+07 )
				if( Negative_Money_Flow_Sum <= 5.59289e+07 )
					if( Positive_Money_Flow_Sum <= 3.62843e+07 )
						if( Typical_Price <= 43.6328 )
							ret := -0.037646
						if( Typical_Price > 43.6328 )
							ret := -0.207009
					if( Positive_Money_Flow_Sum > 3.62843e+07 )
						if( Typical_Price <= 33.5817 )
							ret := 0.204501
						if( Typical_Price > 33.5817 )
							ret := -0.006623
				if( Negative_Money_Flow_Sum > 5.59289e+07 )
					if( VIP <= 1.35707 )
						if( Raw_Money_Flow <= 6.65793e+06 )
							ret := -0.490798
						if( Raw_Money_Flow > 6.65793e+06 )
							ret := -0.024590
					if( VIP > 1.35707 )
						ret := 0.301587
			if( Positive_Money_Flow > 1.12332e+07 )
				if( Raw_Money_Flow <= 1.61281e+07 )
					if( MFI_High <= -25.845 )
						ret := 0.242424
					if( MFI_High > -25.845 )
						ret := -0.513158
				if( Raw_Money_Flow > 1.61281e+07 )
					if( Positive_Money_Flow_Sum <= 3.62658e+07 )
						ret := 0.465116
					if( Positive_Money_Flow_Sum > 3.62658e+07 )
						ret := -0.193878
...
float op_operation = decision_tree_0_NVST_15Min_8bc4a9d0(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
