				...
				if( Typical_Price > 29.0511 )
					if( Negative_Money_Flow_Sum <= 5.58356e+07 )
						...
						if( bullPower > -0.035311 )
							ret := 0.005497
					if( Negative_Money_Flow_Sum > 5.58356e+07 )
						if( Positive_Money_Flow <= 6.45018e+06 )
							ret := 0.605691
						if( Positive_Money_Flow > 6.45018e+06 )
							ret := -0.454545
	if( bbp > 0.023625 )
		if( Raw_Money_Flow <= 9195.35 )
			if( bbp <= 0.139549 )
				if( Positive_Money_Flow_Sum <= 2.52238e+07 )
					if( Negative_Money_Flow_Sum <= 45301.7 )
						ret := 0.422222
					if( Negative_Money_Flow_Sum > 45301.7 )
						ret := -0.309609
				if( Positive_Money_Flow_Sum > 2.52238e+07 )
			...
			if( bbp > 0.139549 )
				ret := -0.607955
		if( Raw_Money_Flow > 9195.35 )
			if( Raw_Money_Flow <= 1.06032e+07 )
				if( bearPower <= 0.049332 )
					if( Raw_Money_Flow <= 697573 )
						if( Raw_Money_Flow <= 520159 )
							ret := -0.044919
						if( Raw_Money_Flow > 520159 )
							ret := -0.195456
					if( Raw_Money_Flow > 697573 )
						if( Positive_Money_Flow_Sum <= 1.85037e+07 )
							ret := -0.013648
						if( Positive_Money_Flow_Sum > 1.85037e+07 )
							ret := 0.193651
				if( bearPower > 0.049332 )
...
float op_operation = decision_tree_0_PINS_1Min_42e1d927(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
