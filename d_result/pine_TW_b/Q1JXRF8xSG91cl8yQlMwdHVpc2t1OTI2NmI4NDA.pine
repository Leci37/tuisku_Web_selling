			...
			if( bbm <= 0.299706 )
				...
				if( bbp > 2.19681 )
					if( d <= 14.8443 )
						ret := -0.628571
					if( d > 14.8443 )
						if( smoothD_d <= 96.0055 )
							ret := 0.001631
						if( smoothD_d > 96.0055 )
							ret := -0.505376
			if( bbm > 0.299706 )
				if( bullPower <= 17.8482 )
					if( d <= 45.4187 )
						if( k <= 4.55245 )
							ret := 0.112650
						if( k > 4.55245 )
...
float op_operation = decision_tree_0_CRWD_1Hour_9266b840(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
