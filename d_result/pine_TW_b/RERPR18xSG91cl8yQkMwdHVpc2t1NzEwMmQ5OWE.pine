				...
				if( mf > -0.227675 )
					if( mf <= -0.10105 )
						...
						if( ad > -1045.69 )
							ret := -0.602941
					if( mf > -0.10105 )
						if( bullPower <= 0.521842 )
							ret := -1.000000 // sell
						if( bullPower > 0.521842 )
							ret := -0.119681
			if( bbm > 0.457013 )
				if( bullPower <= 1.62861 )
					if( ad <= 33008.4 )
						if( ad_mf <= 798.446 )
							ret := 0.067857
						if( ad_mf > 798.446 )
					...
					if( ad > 33008.4 )
						...
						if( bbp > 1.60108 )
							ret := 0.328302
				if( bullPower > 1.62861 )
					if( bullPower <= 11.2013 )
						if( bullPower <= 1.63234 )
							ret := -0.800000 // sell
						if( bullPower > 1.63234 )
							ret := -0.075650
					if( bullPower > 11.2013 )
...
float op_operation = decision_tree_0_DDOG_1Hour_7102d99a(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
