...
decision_tree_0_ASAN_1Day_a837c519(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)=>
	...
	if( smoothedDirectionalMovementPlus > 0.469726 )
		if( diPlus <= 44.242 )
			...
			if( smoothedDirectionalMovementPlus > 1.68478 )
				if( diMinus <= 18.0526 )
					if( directionalMovementMinus <= 0.276144 )
						ret := -0.647059
					if( directionalMovementMinus > 0.276144 )
						ret := -1.000000 // sell
				if( diMinus > 18.0526 )
...
float op_operation = decision_tree_0_ASAN_1Day_a837c519(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)
