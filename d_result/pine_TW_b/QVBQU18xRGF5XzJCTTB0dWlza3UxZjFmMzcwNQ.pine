			...
			if( Positive_Money_Flow <= 522079 )
				if( bbp <= 1.30415 )
					...
					if( bbm > 0.07061 )
						ret := -0.650794
				if( bbp > 1.30415 )
					if( Typical_Price <= 43.4643 )
						ret := 0.720000 // buy
					if( Typical_Price > 43.4643 )
						ret := -0.187500
			if( Positive_Money_Flow > 522079 )
				if( bullPower <= 0.176804 )
					if( bullPower <= 0.162439 )
						ret := 0.400000
					if( bullPower > 0.162439 )
						ret := 1.000000 // buy
				if( bullPower > 0.176804 )
					if( Money_Flow_Ratio <= 9.711 )
						ret := 0.043189
					if( Money_Flow_Ratio > 9.711 )
						ret := -0.928571 // sell
...
float op_operation = decision_tree_0_APPS_1Day_1f1f3705(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
