				...
				if( priceRange <= 1.26204 )
					...
					if( rangema > 0.653217 )
						...
						if( dev > 0.928865 )
							ret := -0.227848
				if( priceRange > 1.26204 )
					if( avgHighLow <= 127.283 )
						if( upperBB <= 125.755 )
							ret := 0.535714
						if( upperBB > 125.755 )
							ret := 0.894737 // buy
					if( avgHighLow > 127.283 )
						if( avgHighLow <= 128.375 )
							ret := -0.750000 // sell
						if( avgHighLow > 128.375 )
							ret := 0.571429
			if( rangema > 1.08945 )
				...
				if( lowerBB > 126.907 )
					ret := -1.000000 // sell
	if( upperKC > 130.846 )
		if( avgHighLow <= 131.046 )
			if( avgHighLow <= 130.202 )
				if( upperBB <= 132.707 )
					if( rangema <= 1.83195 )
						if( lowerBB <= 127.581 )
							ret := -0.514706
						if( lowerBB > 127.581 )
							ret := 0.000000
					if( rangema > 1.83195 )
						if( priceRange <= 1.43413 )
							ret := 0.000000
						if( priceRange > 1.43413 )
							ret := 0.933333 // buy
				if( upperBB > 132.707 )
					if( avgHighLow <= 129.83 )
						if( val <= -0.205329 )
							ret := -0.571429
						if( val > -0.205329 )
							ret := -1.000000 // sell
...
float op_operation = decision_tree_0_SNOW_30Min_b38077bc(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
