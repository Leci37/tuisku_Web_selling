		...
		if( MFI <= 29.078 )
			if( Typical_Price <= 157.584 )
				...
				if( Short_Long_Diff > -26.2687 )
					ret := 1.000000 // buy
			if( Typical_Price > 157.584 )
				if( Short_Long_Diff <= -14.5673 )
					ret := 1.000000 // buy
				if( Short_Long_Diff > -14.5673 )
					ret := 0.000000
		if( MFI > 29.078 )
			if( Short_Long_Diff <= 27.6305 )
				if( Positive_Money_Flow_Sum <= 5.88732e+09 )
					if( Positive_Money_Flow_Sum <= 2.38646e+09 )
						ret := -0.280000
					if( Positive_Money_Flow_Sum > 2.38646e+09 )
						ret := -0.818182 // sell
				if( Positive_Money_Flow_Sum > 5.88732e+09 )
...
float op_operation = decision_tree_0_GME_1Day_d0d71fde(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
