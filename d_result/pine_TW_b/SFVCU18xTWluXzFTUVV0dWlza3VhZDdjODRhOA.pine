...
decision_tree_0_HUBS_1Min_ad7c84a8(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)=>
	...
	if( upperKC > 495.821 )
		...
		if( upperBB > 511.324 )
				...
				if( upperBB <= 515.345 )
					...
					if( priceRange > 1.50329 )
						...
						if( sqzOffInt > 0.5 )
							ret := 0.809524 // buy
				if( upperBB > 515.345 )
					if( avgHighLow <= 529.428 )
						if( avgHighLow <= 529.178 )
							ret := 0.091877
						if( avgHighLow > 529.178 )
							ret := -0.727273 // sell
					if( avgHighLow > 529.428 )
			...
			if( upperBB > 534.228 )
				if( lowerBB <= 539.825 )
					if( avgHighLow <= 538.577 )
						if( avgHighLow <= 532.799 )
							ret := -0.531646
						if( avgHighLow > 532.799 )
							ret := -0.096142
					if( avgHighLow > 538.577 )
...
float op_operation = decision_tree_0_HUBS_1Min_ad7c84a8(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
