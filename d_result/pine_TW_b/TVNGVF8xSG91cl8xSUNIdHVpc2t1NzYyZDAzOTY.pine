			...
			if( senkou_span_a > 259.909 )
				if( chinkou_span <= 260.512 )
					...
					if( senkou_span_b_displaced > 278.623 )
						ret := 0.515152
				if( chinkou_span > 260.512 )
					if( senkou_span_a <= 270.086 )
						ret := 0.184669
					if( senkou_span_a > 270.086 )
						ret := -0.465776
		if( chinkou_span > 277.159 )
			if( senkou_span_a <= 284.827 )
				if( senkou_span_b_displaced <= 280.469 )
					if( senkou_span_a <= 276.162 )
						ret := 0.669565
					if( senkou_span_a > 276.162 )
						if( chinkou_span <= 283.983 )
							ret := -0.300654
						if( chinkou_span > 283.983 )
							ret := 0.261438
				if( senkou_span_b_displaced > 280.469 )
					if( basis_max <= 2.46513 )
						if( basis_max <= -1.17 )
							ret := -0.147541
						if( basis_max > -1.17 )
							ret := 0.597582
					if( basis_max > 2.46513 )
						ret := -0.782609 // sell
			if( senkou_span_a > 284.827 )
				if( basis_minus <= -5.9179 )
					ret := 0.394737
				if( basis_minus > -5.9179 )
					if( chinkou_span <= 299.509 )
						if( senkou_span_b_displaced <= 289.282 )
							ret := -0.003311
						if( senkou_span_b_displaced > 289.282 )
							ret := -0.469231
					if( chinkou_span > 299.509 )
						if( senkou_span_b_displaced <= 330.231 )
							ret := 0.112925
						if( senkou_span_b_displaced > 330.231 )
							ret := -0.077201
...
float op_operation = decision_tree_0_MSFT_1Hour_762d0396(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
