...
decision_tree_0_TWLO_1Day_98c9ebc6(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)=>
	...
	if( smoothedTrueRange > 3.19298 )
		...
		if( diMinus > 5.49463 )
			...
			if( trueRange > 3.35995 )
				if( diMinus <= 10.8729 )
					if( smoothedDirectionalMovementPlus <= 2.045 )
						ret := -0.062500
					if( smoothedDirectionalMovementPlus > 2.045 )
						ret := -0.652174
				if( diMinus > 10.8729 )
...
float op_operation = decision_tree_0_TWLO_1Day_98c9ebc6(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
