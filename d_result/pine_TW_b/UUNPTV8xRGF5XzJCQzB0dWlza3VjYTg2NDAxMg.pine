			...
			if( mf <= 0.245852 )
				...
				if( mf > -0.025705 )
					...
					if( ad > -2.30145e+06 )
						ret := 0.135371
			if( mf > 0.245852 )
				if( bullPower <= 1.78186 )
					ret := -0.080000
				if( bullPower > 1.78186 )
					if( bearPower <= 2.65039 )
						ret := -0.788462 // sell
					if( bearPower > 2.65039 )
						ret := -0.282051
		if( bbm > 4.81182 )
			if( bullPower <= -0.583072 )
				if( ad_mf <= 1.26189e+07 )
					if( mf <= -0.01033 )
						ret := 0.714286 // buy
					if( mf > -0.01033 )
						ret := 0.000000
				if( ad_mf > 1.26189e+07 )
					if( ad_mf <= 1.43296e+07 )
						ret := -1.000000 // sell
					if( ad_mf > 1.43296e+07 )
						ret := 0.500000
			if( bullPower > -0.583072 )
...
float op_operation = decision_tree_0_QCOM_1Day_ca864012(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)
