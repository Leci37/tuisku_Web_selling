	...
	if( senkou_span_a > 366.827 )
		if( chinkou_span <= 378.425 )
			...
			if( tenkan_sen > 375.838 )
				ret := -0.604608
		if( chinkou_span > 378.425 )
			if( senkou_span_a_displaced <= 412.651 )
				if( basis_minus <= 2.39008 )
					if( chinkou_span <= 401.186 )
						if( tenkan_sen <= 376.887 )
							ret := 0.572614
						if( tenkan_sen > 376.887 )
							ret := 0.015152
					if( chinkou_span > 401.186 )
						if( senkou_span_b <= 409.336 )
							ret := 0.575042
						if( senkou_span_b > 409.336 )
							ret := -0.277228
				if( basis_minus > 2.39008 )
					if( senkou_span_b <= 378.108 )
						ret := 0.269565
					if( senkou_span_b > 378.108 )
						if( chinkou_span <= 421.01 )
							ret := -0.216636
						if( chinkou_span > 421.01 )
							ret := 0.544402
			if( senkou_span_a_displaced > 412.651 )
				if( chinkou_span <= 498.667 )
					if( kinjun_sen <= 493.595 )
						if( chinkou_span <= 450.101 )
							ret := -0.288202
						if( chinkou_span > 450.101 )
							ret := 0.187402
					if( kinjun_sen > 493.595 )
						ret := -0.667453
				if( chinkou_span > 498.667 )
					if( tenkan_sen <= 508.575 )
						if( basis_max <= 5.13745 )
							ret := 0.562610
						if( basis_max > 5.13745 )
							ret := -0.500000
					if( tenkan_sen > 508.575 )
						if( chinkou_span <= 569.91 )
							ret := -0.221687
						if( chinkou_span > 569.91 )
							ret := 0.611940
...
float op_operation = decision_tree_0_MDB_30Min_1371a89c(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
