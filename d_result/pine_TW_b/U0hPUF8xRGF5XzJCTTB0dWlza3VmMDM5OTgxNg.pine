			...
			if( Negative_Money_Flow_Sum <= 6.49361e+09 )
				...
				if( Typical_Price > 174.435 )
					...
					if( MFI_Low > 54.3428 )
						ret := -0.482353
			if( Negative_Money_Flow_Sum > 6.49361e+09 )
				if( Typical_Price <= 600.666 )
					if( Positive_Money_Flow_Sum <= 8.60051e+09 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 8.60051e+09 )
						ret := -0.943262 // sell
				if( Typical_Price > 600.666 )
					if( bearPower <= -18.3081 )
						ret := 0.020134
					if( bearPower > -18.3081 )
						ret := -0.364929
		if( Positive_Money_Flow_Sum > 2.40223e+10 )
			if( bearPower <= 50.1338 )
				if( Positive_Money_Flow_Sum <= 2.87539e+10 )
					if( MFI_Low <= 41.8404 )
						ret := 0.000000
					if( MFI_Low > 41.8404 )
						ret := 0.951220 // buy
				if( Positive_Money_Flow_Sum > 2.87539e+10 )
					ret := 0.000000
			if( bearPower > 50.1338 )
				if( Positive_Money_Flow_Sum <= 2.53593e+10 )
					ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 2.53593e+10 )
					ret := 0.000000
...
float op_operation = decision_tree_0_SHOP_1Day_f0399816(bbm, bearPower, bbp, bullPower, BBPower_Color, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
