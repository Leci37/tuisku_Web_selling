			...
			if( MFI_High > -34.8172 )
				...
				if( Negative_Money_Flow > 468665 )
					...
					if( tema > 14.7129 )
						ret := -0.619048
		if( ema13 > 0.430361 )
			if( Negative_Money_Flow_Sum <= 2.56888e+09 )
				if( Positive_Money_Flow_Sum <= 3.91829e+09 )
					if( tema <= 8.41608 )
						ret := 0.000000
					if( tema > 8.41608 )
						ret := -0.916667 // sell
				if( Positive_Money_Flow_Sum > 3.91829e+09 )
					if( Positive_Money_Flow <= 6.03599e+08 )
						ret := 0.868132 // buy
					if( Positive_Money_Flow > 6.03599e+08 )
						ret := 0.306122
			if( Negative_Money_Flow_Sum > 2.56888e+09 )
				if( Negative_Money_Flow_Sum <= 6.03701e+09 )
					if( MFI <= 69.374 )
						ret := -0.761905 // sell
					if( MFI > 69.374 )
						ret := -0.275000
				if( Negative_Money_Flow_Sum > 6.03701e+09 )
					if( Positive_Money_Flow_Sum <= 3.10466e+10 )
						ret := 0.032086
					if( Positive_Money_Flow_Sum > 3.10466e+10 )
						ret := 0.466667
...
float op_operation = decision_tree_0_NIO_1Day_84a9fda7(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
