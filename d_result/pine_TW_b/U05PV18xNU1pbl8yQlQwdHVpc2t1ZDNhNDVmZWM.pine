			...
			if( ema3 > 352.274 )
				...
				if( bbm > 6.97452 )
					...
					if( ema3 > 400.208 )
						ret := -1.000000 // sell
		if( bearPower > -10.8494 )
			if( bearPower <= 1.70465 )
				if( bullPower <= -6.20138 )
					if( ema12 <= -4.36171 )
						if( bearPower <= -10.5949 )
							ret := -1.000000 // sell
						if( bearPower > -10.5949 )
							ret := 0.222222
					if( ema12 > -4.36171 )
						if( bullPower <= -6.56471 )
							ret := 1.000000 // buy
						if( bullPower > -6.56471 )
							ret := 0.500000
				if( bullPower > -6.20138 )
					if( ema13 <= -2.08173 )
						if( bearPower <= -3.62471 )
							ret := -0.016480
						if( bearPower > -3.62471 )
							ret := -0.149478
					if( ema13 > -2.08173 )
						if( bearPower <= -1.33699 )
							ret := 0.060783
						if( bearPower > -1.33699 )
							ret := -0.015825
			if( bearPower > 1.70465 )
...
float op_operation = decision_tree_0_SNOW_15Min_d3a45fec(bbm, bearPower, bbp, bullPower, BBPower_Color, ema1, tema, ema12, ema2, ema3, ema13)
