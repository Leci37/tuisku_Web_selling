				...
				if( Typical_Price <= 87.2882 )
					...
					if( Negative_Money_Flow_Sum > 3.26364e+07 )
						...
						if( MFI_Low > 2.89224 )
							ret := 0.091929
				if( Typical_Price > 87.2882 )
					if( Positive_Money_Flow_Sum <= 6.43236e+08 )
						if( MFI_High <= -76.0568 )
							ret := 0.442748
						if( MFI_High > -76.0568 )
							ret := 0.001631
					if( Positive_Money_Flow_Sum > 6.43236e+08 )
						ret := 0.478261
	if( Money_Flow_Ratio > 3.32874 )
		if( Positive_Money_Flow <= 10.196 )
			if( Typical_Price <= 126.55 )
				ret := 0.067729
			if( Typical_Price > 126.55 )
				if( Positive_Money_Flow_Sum <= 4.22991e+08 )
					ret := -0.816327 // sell
				if( Positive_Money_Flow_Sum > 4.22991e+08 )
					ret := -0.130137
		if( Positive_Money_Flow > 10.196 )
			if( Negative_Money_Flow_Sum <= 7.5512e+07 )
				if( Negative_Money_Flow_Sum <= 4.42648e+07 )
					if( Typical_Price <= 32.7879 )
						ret := 0.916667 // buy
					if( Typical_Price > 32.7879 )
						if( Negative_Money_Flow_Sum <= 3.47316e+07 )
							ret := -0.349206
						if( Negative_Money_Flow_Sum > 3.47316e+07 )
							ret := 0.036649
				if( Negative_Money_Flow_Sum > 4.42648e+07 )
...
float op_operation = decision_tree_0_DDOG_1Hour_25de0c8b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
