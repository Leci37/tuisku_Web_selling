			...
			if( bullPower > 1.73522 )
				...
				if( basis > 19.0347 )
					...
					if( basis > 23.9737 )
						ret := 0.197674
	if( bbp > 10.1338 )
		if( Upper_Band <= 125.504 )
			if( Lower_Band <= 63.3148 )
				if( Upper_Band <= 64.7818 )
					if( bullPower <= 7.50803 )
						ret := 0.571429
					if( bullPower > 7.50803 )
						ret := 0.909091 // buy
				if( Upper_Band > 64.7818 )
					if( Lower_Band <= 39.2153 )
						ret := -0.700000 // sell
					if( Lower_Band > 39.2153 )
						ret := 0.250000
			if( Lower_Band > 63.3148 )
				if( Upper_Band <= 92.101 )
					ret := 0.714286 // buy
				if( Upper_Band > 92.101 )
					ret := 1.000000 // buy
		if( Upper_Band > 125.504 )
...
float op_operation = decision_tree_0_ASAN_1Day_69ffb6f0(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
