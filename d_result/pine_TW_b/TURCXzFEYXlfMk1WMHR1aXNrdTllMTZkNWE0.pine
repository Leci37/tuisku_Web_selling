...
decision_tree_0_MDB_1Day_9e16d5a4(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( VIM > 0.947012 )
		if( Negative_Money_Flow <= 4.38471e+08 )
			if( MFI <= 51.6144 )
				if( VIM <= 1.13809 )
					if( Positive_Money_Flow_Sum <= 7.01318e+08 )
						ret := 0.353448
					if( Positive_Money_Flow_Sum > 7.01318e+08 )
						ret := -0.144414
				if( VIM > 1.13809 )
					if( Money_Flow_Ratio <= 0.776721 )
						ret := 0.078759
					if( Money_Flow_Ratio > 0.776721 )
						ret := 0.639175
			if( MFI > 51.6144 )
				if( Positive_Money_Flow_Sum <= 4.05946e+09 )
					if( Typical_Price <= 465.777 )
						ret := 0.464497
					if( Typical_Price > 465.777 )
						ret := -0.714286 // sell
				if( Positive_Money_Flow_Sum > 4.05946e+09 )
					if( Raw_Money_Flow <= 3.35931e+08 )
						ret := -0.447368
					if( Raw_Money_Flow > 3.35931e+08 )
						ret := 0.289474
		if( Negative_Money_Flow > 4.38471e+08 )
			if( MFI <= 42.4558 )
				if( Typical_Price <= 312.501 )
					if( VIP <= 0.990233 )
						ret := 0.250000
					if( VIP > 0.990233 )
						ret := -0.823529 // sell
				if( Typical_Price > 312.501 )
					if( Negative_Money_Flow_Sum <= 5.2957e+09 )
						ret := -0.848485 // sell
					if( Negative_Money_Flow_Sum > 5.2957e+09 )
						ret := -0.090909
			if( MFI > 42.4558 )
				if( Typical_Price <= 276.464 )
					if( Negative_Money_Flow_Sum <= 3.08601e+09 )
						ret := 0.285714
					if( Negative_Money_Flow_Sum > 3.08601e+09 )
						ret := 0.857143 // buy
				if( Typical_Price > 276.464 )
...
float op_operation = decision_tree_0_MDB_1Day_9e16d5a4(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
