...
decision_tree_0_ETHUSDT_1Hour_09b52e7b(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower <= 3065.17 )
		...
		if( dif_source_BBupper > -5.89224 )
			if( BBlower <= 119.31 )
				if( dif_source_BBlower <= 35.1586 )
					ret := -0.888889 // sell
				if( dif_source_BBlower > 35.1586 )
					ret := -1.000000 // sell
			if( BBlower > 119.31 )
				if( BBupper <= 3835.74 )
					if( dif_source_BBlower <= 3.04639 )
						if( BBlower <= 144.276 )
							ret := -0.823529 // sell
						if( BBlower > 144.276 )
							ret := -0.411765
					if( dif_source_BBlower > 3.04639 )
						if( dif_source_BBlower <= 18.8206 )
							ret := 0.232520
						if( dif_source_BBlower > 18.8206 )
							ret := 0.104719
				if( BBupper > 3835.74 )
					...
					if( vrsi > 76.4563 )
						ret := 0.315789
	if( BBlower > 3065.17 )
		if( dif_source_BBlower <= 662.873 )
			if( vrsi <= 64.2742 )
				if( dif_source_BBupper <= -910.903 )
					if( dif_source_BBlower <= -15.7004 )
						if( dif_source_BBupper <= -1205.71 )
							ret := -1.000000 // sell
						if( dif_source_BBupper > -1205.71 )
							ret := 0.930693 // buy
					if( dif_source_BBlower > -15.7004 )
		...
		if( dif_source_BBlower > 662.873 )
			if( BBlower <= 3087.4 )
				...
				if( BBupper > 4217.79 )
					ret := 0.230769
			if( BBlower > 3087.4 )
				if( dif_source_BBlower <= 735.11 )
					if( dif_source_BBupper <= -328.677 )
						ret := 0.733333 // buy
					if( dif_source_BBupper > -328.677 )
						if( BBupper <= 4686.34 )
							ret := -0.352381
...
float op_operation = decision_tree_0_ETHUSDT_1Hour_09b52e7b(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
