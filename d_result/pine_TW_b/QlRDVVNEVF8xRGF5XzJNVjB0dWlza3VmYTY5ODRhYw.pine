...
decision_tree_0_BTCUSDT_1Day_fa6984ac(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)=>
	...
	if( Negative_Money_Flow > 6.08422e+07 )
		...
		if( Positive_Money_Flow_Sum > 2.51724e+09 )
			if( VIP_VIM <= -0.367779 )
				if( MFI_Low <= 7.8341 )
					if( Positive_Money_Flow_Sum <= 9.14113e+09 )
						ret := 0.457627
					if( Positive_Money_Flow_Sum > 9.14113e+09 )
						ret := 0.916667 // buy
				if( MFI_Low > 7.8341 )
					if( Negative_Money_Flow <= 5.30633e+09 )
						ret := 0.296296
					if( Negative_Money_Flow > 5.30633e+09 )
						ret := -0.444444
			if( VIP_VIM > -0.367779 )
				if( Typical_Price <= 41243.4 )
					if( VIP_VIM <= 0.158515 )
						ret := -0.105590
					if( VIP_VIM > 0.158515 )
						ret := 0.291803
				if( Typical_Price > 41243.4 )
					if( Negative_Money_Flow_Sum <= 2.31746e+10 )
						ret := -0.432990
					if( Negative_Money_Flow_Sum > 2.31746e+10 )
						ret := 0.125000
...
float op_operation = decision_tree_0_BTCUSDT_1Day_fa6984ac(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
