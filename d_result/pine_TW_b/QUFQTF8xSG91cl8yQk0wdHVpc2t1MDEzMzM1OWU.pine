...
decision_tree_0_AAPL_1Hour_0133359e(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)=>
				...
				if( bearPower <= -1.43771 )
					...
					if( Negative_Money_Flow_Sum > 1.23178e+10 )
						...
						if( Raw_Money_Flow > 2.65987e+09 )
							ret := -0.170139
				if( bearPower > -1.43771 )
					if( bullPower <= 1.90987 )
						if( Typical_Price <= 156.171 )
							ret := 0.093407
						if( Typical_Price > 156.171 )
							ret := -0.101286
					if( bullPower > 1.90987 )
	...
	if( Positive_Money_Flow_Sum > 1.98498e+10 )
		if( Typical_Price <= 156.182 )
			if( Positive_Money_Flow_Sum <= 2.20004e+10 )
				ret := -0.558824
			if( Positive_Money_Flow_Sum > 2.20004e+10 )
				if( Positive_Money_Flow <= 3.20376e+07 )
					ret := 0.603774
				if( Positive_Money_Flow > 3.20376e+07 )
					if( bbm <= 1.00513 )
						ret := 1.000000 // buy
					if( bbm > 1.00513 )
						ret := -0.368421
		if( Typical_Price > 156.182 )
			if( bearPower <= -5.67712 )
				ret := -1.000000 // sell
			if( bearPower > -5.67712 )
				if( Money_Flow_Ratio <= 810.354 )
					if( bullPower <= 14.5948 )
						ret := 0.636364
					if( bullPower > 14.5948 )
						ret := -0.750000 // sell
				if( Money_Flow_Ratio > 810.354 )
...
float op_operation = decision_tree_0_AAPL_1Hour_0133359e(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
