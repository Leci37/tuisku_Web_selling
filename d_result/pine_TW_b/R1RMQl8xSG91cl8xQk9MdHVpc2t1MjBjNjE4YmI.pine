...
decision_tree_0_GTLB_1Hour_20c618bb(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower <= 41.4193 )
		...
		if( dif_source_BBlower > 6.37228 )
			...
			if( BBlower > 26.1209 )
				if( BBlower <= 40.2977 )
					if( dif_source_BBupper <= -2.11201 )
						if( dif_source_BBlower <= 17.8399 )
							ret := -0.035691
						if( dif_source_BBlower > 17.8399 )
							ret := 0.305136
					if( dif_source_BBupper > -2.11201 )
			...
			if( BBupper > 102.68 )
				if( BBupper <= 128.501 )
					...
					if( dif_source_BBlower > 18.0833 )
						ret := 0.333333
				if( BBupper > 128.501 )
					if( dif_source_BBlower <= 8.53277 )
						ret := 0.153846
					if( dif_source_BBlower > 8.53277 )
						ret := -0.666667
		if( BBlower > 68.4934 )
			if( dif_source_BBlower <= -0.010764 )
				if( dif_source_BBupper <= -39.0172 )
					ret := 1.000000 // buy
				if( dif_source_BBupper > -39.0172 )
					ret := -0.272727
			if( dif_source_BBlower > -0.010764 )
				if( dif_source_BBupper <= -58.8025 )
					if( BBupper <= 140.149 )
						ret := 0.846154 // buy
					if( BBupper > 140.149 )
						ret := 0.500000
...
float op_operation = decision_tree_0_GTLB_1Hour_20c618bb(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
