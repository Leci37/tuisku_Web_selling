...
decision_tree_0_AAPL_1Day_7890b971(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)=>
	...
	if( smoothedDirectionalMovementPlus > 0.96742 )
		if( diPlus <= 19.878 )
			...
			if( smoothedTrueRange > 5.0535 )
				if( dx <= 21.8462 )
					if( smoothedTrueRange <= 6.10586 )
						ret := -0.928571 // sell
					if( smoothedTrueRange > 6.10586 )
						ret := 0.625000
				if( dx > 21.8462 )
					if( directionalMovementMinus <= 6.25179 )
						ret := -0.933884 // sell
					if( directionalMovementMinus > 6.25179 )
						ret := -0.680000
		if( diPlus > 19.878 )
			if( smoothedDirectionalMovementMinus <= 1.26744 )
				if( directionalMovementPlus <= 2.85048 )
					if( adx <= 67.2034 )
						ret := -0.032459
					if( adx > 67.2034 )
						ret := -0.710526 // sell
				if( directionalMovementPlus > 2.85048 )
					...
					if( diPlus > 30.3841 )
						ret := -0.321918
			if( smoothedDirectionalMovementMinus > 1.26744 )
				if( smoothedTrueRange <= 8.01383 )
					if( smoothedDirectionalMovementPlus <= 1.26589 )
						ret := 0.378049
					if( smoothedDirectionalMovementPlus > 1.26589 )
						ret := -0.431818
				if( smoothedTrueRange > 8.01383 )
...
float op_operation = decision_tree_0_AAPL_1Day_7890b971(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)
