			...
			if( tema <= 62013.4 )
				...
				if( ema2 > 58685.8 )
					...
					if( bbp > -7311.79 )
						ret := 0.345455
			if( tema > 62013.4 )
				if( bearPower <= -1714.83 )
					if( bbm <= 3478.62 )
						ret := -0.156250
					if( bbm > 3478.62 )
						ret := 0.593750
				if( bearPower > -1714.83 )
					if( bullPower <= 6698.82 )
						ret := -0.653631
					if( bullPower > 6698.82 )
						ret := 0.333333
...
float op_operation = decision_tree_0_BTCUSDT_1Day_e3c3b32a(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)
