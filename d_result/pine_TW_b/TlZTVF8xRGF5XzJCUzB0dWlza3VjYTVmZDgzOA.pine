			...
			if( smoothD_d <= 70.6758 )
				...
				if( smoothK_k > 73.5537 )
					...
					if( d > 67.6972 )
						ret := 0.080000
			if( smoothD_d > 70.6758 )
				if( smoothK_k <= 70.6481 )
					if( rsi1 <= 62.0137 )
						ret := 0.851852 // buy
					if( rsi1 > 62.0137 )
						ret := 0.071429
				if( smoothK_k > 70.6481 )
					if( smoothK_k <= 84.6405 )
						ret := 0.014286
					if( smoothK_k > 84.6405 )
						ret := 0.500000
		if( rsi1 > 66.155 )
			if( smoothK_k <= 67.9039 )
				if( smoothD_d <= 50.7315 )
					ret := 0.000000
				if( smoothD_d > 50.7315 )
					if( bearPower <= 0.076251 )
						ret := -0.500000
					if( bearPower > 0.076251 )
						ret := -0.961538 // sell
			if( smoothK_k > 67.9039 )
				if( bullPower <= 1.45669 )
					if( smoothD_d <= 86.6675 )
						ret := 0.200000
					if( smoothD_d > 86.6675 )
						ret := -0.727273 // sell
				if( bullPower > 1.45669 )
					if( smoothD_d <= 66.8664 )
						ret := -0.857143 // sell
					if( smoothD_d > 66.8664 )
						ret := 0.245283
...
float op_operation = decision_tree_0_NVST_1Day_ca5fd838(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
