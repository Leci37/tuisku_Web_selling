			...
			if( Positive_Money_Flow_Sum <= 5.19581e+09 )
				...
				if( Money_Flow_Ratio > 8.37636 )
					...
					if( Positive_Money_Flow > 1.491e+08 )
						ret := 0.000000
			if( Positive_Money_Flow_Sum > 5.19581e+09 )
				if( Typical_Price <= 174.796 )
					if( Positive_Money_Flow <= 5.01962e+08 )
						ret := 0.710526 // buy
					if( Positive_Money_Flow > 5.01962e+08 )
						ret := 0.261682
				if( Typical_Price > 174.796 )
					if( Raw_Money_Flow <= 3.5281e+08 )
						ret := 0.642857
					if( Raw_Money_Flow > 3.5281e+08 )
						ret := -0.304878
		if( Positive_Money_Flow_Sum > 6.34755e+10 )
...
float op_operation = decision_tree_0_GME_1Day_08983c57(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
