	...
	if( Positive_Money_Flow_Sum > 1.16464e+09 )
		if( Positive_Money_Flow_Sum <= 4.6678e+09 )
			if( Negative_Money_Flow_Sum <= 2.7535e+09 )
				if( MFI_High <= -20.7306 )
					if( Negative_Money_Flow_Sum <= 1.34664e+09 )
						ret := -0.351852
					if( Negative_Money_Flow_Sum > 1.34664e+09 )
						ret := 0.195960
				if( MFI_High > -20.7306 )
					if( Negative_Money_Flow_Sum <= 7.61546e+08 )
						ret := 0.203704
					if( Negative_Money_Flow_Sum > 7.61546e+08 )
						ret := -0.318182
			if( Negative_Money_Flow_Sum > 2.7535e+09 )
				if( MFI_High <= -63.3545 )
					ret := 1.000000 // buy
				if( MFI_High > -63.3545 )
					if( Money_Flow_Ratio <= 0.985114 )
						ret := -0.529221
					if( Money_Flow_Ratio > 0.985114 )
						ret := 0.461538
		if( Positive_Money_Flow_Sum > 4.6678e+09 )
			if( MFI <= 74.2054 )
				if( Negative_Money_Flow <= 7.9881e+06 )
					if( MFI_Low <= 51.182 )
						ret := 0.111111
					if( MFI_Low > 51.182 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow > 7.9881e+06 )
					if( Money_Flow_Ratio <= 2.27717 )
						ret := 0.950000 // buy
					if( Money_Flow_Ratio > 2.27717 )
						ret := 0.500000
			if( MFI > 74.2054 )
...
float op_operation = decision_tree_0_LYFT_1Day_d7a39b8d(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
