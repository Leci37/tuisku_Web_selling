	...
	if( upperBB > 39.9428 )
		...
		if( dev > 1.39452 )
			...
			if( avgHighLow > 40.0875 )
				if( upperKC <= 84.5798 )
					if( lowerKC <= 67.5542 )
						if( avgHighLow <= 41.8989 )
							ret := 0.552381
						if( avgHighLow > 41.8989 )
							ret := -0.058824
					if( lowerKC > 67.5542 )
						if( priceRange <= 0.410059 )
							ret := 0.041237
						if( priceRange > 0.410059 )
							ret := 0.633124
				if( upperKC > 84.5798 )
					if( avgHighLow <= 199.419 )
						if( priceRange <= 1.6619 )
							ret := 0.050014
						if( priceRange > 1.6619 )
							ret := -0.086945
					if( avgHighLow > 199.419 )
...
float op_operation = decision_tree_0_U_30Min_1b6d0107(lowerBB, noSqzInt, avgHighLow, rangema, sqzOffInt, upperKC, ma, basis, val, sqzOnInt, dev, priceRange, lowerKC, upperBB)
