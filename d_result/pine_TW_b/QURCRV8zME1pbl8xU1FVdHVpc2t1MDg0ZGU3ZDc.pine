		...
		if( rangema > 4.19745 )
			...
			if( ma > 295.723 )
				if( lowerBB <= 285.973 )
					ret := -0.833333 // sell
				if( lowerBB > 285.973 )
					if( avgHighLow <= 304.645 )
						if( ma <= 300.61 )
							ret := -0.269231
						if( ma > 300.61 )
							ret := 0.842697 // buy
					if( avgHighLow > 304.645 )
						if( avgHighLow <= 670.202 )
							ret := -0.205474
						if( avgHighLow > 670.202 )
							ret := -0.917808 // sell
...
float op_operation = decision_tree_0_ADBE_30Min_084de7d7(val, sqzOnInt, lowerBB, lowerKC, upperKC, dev, rangema, sqzOffInt, upperBB, priceRange, noSqzInt, ma, basis, avgHighLow)
