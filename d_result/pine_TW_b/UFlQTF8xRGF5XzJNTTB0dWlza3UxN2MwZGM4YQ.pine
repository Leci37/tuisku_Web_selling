			...
			if( Positive_Money_Flow_Sum <= 8.66886e+09 )
				...
				if( Short_MA > 80.3678 )
					...
					if( Short_MA > 90.6944 )
						ret := -0.153005
			if( Positive_Money_Flow_Sum > 8.66886e+09 )
				if( Negative_Money_Flow_Sum <= 1.05381e+10 )
					if( Short_MA <= 102.154 )
						ret := 0.362637
					if( Short_MA > 102.154 )
						ret := 0.837209 // buy
				if( Negative_Money_Flow_Sum > 1.05381e+10 )
					if( Positive_Money_Flow_Sum <= 9.71716e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 9.71716e+09 )
						ret := -0.909091 // sell
		if( Raw_Money_Flow > 1.21346e+09 )
			if( Short_MA <= 96.2952 )
				if( Typical_Price <= 64.6134 )
					if( Long_MA <= 59.6946 )
						ret := 0.000000
					if( Long_MA > 59.6946 )
						ret := 0.666667
				if( Typical_Price > 64.6134 )
					...
					if( MFI > 31.3189 )
						ret := -0.751111 // sell
			if( Short_MA > 96.2952 )
				if( Negative_Money_Flow_Sum <= 4.62291e+10 )
					if( MA_Cross <= 1.9598 )
						ret := -0.086037
					if( MA_Cross > 1.9598 )
						ret := 0.885714 // buy
				if( Negative_Money_Flow_Sum > 4.62291e+10 )
					if( Negative_Money_Flow_Sum <= 5.59145e+10 )
						ret := -0.920000 // sell
					if( Negative_Money_Flow_Sum > 5.59145e+10 )
						ret := 0.181818
...
float op_operation = decision_tree_0_PYPL_1Day_17c0dc8a(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
