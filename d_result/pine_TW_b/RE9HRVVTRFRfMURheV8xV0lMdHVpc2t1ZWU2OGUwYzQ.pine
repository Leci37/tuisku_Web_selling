			...
			if( upperBand <= 35.1776 )
				...
				if( midLine > 22.8296 )
					...
					if( Color_con1 > -7.05665 )
						ret := 0.142857
			if( upperBand > 35.1776 )
				if( upperBand <= 57.0149 )
					if( lowerBand <= 21.38 )
						ret := 0.024631
					if( lowerBand > 21.38 )
						ret := 0.844444 // buy
				if( upperBand > 57.0149 )
					if( Color_con2 <= -19.6604 )
						ret := -0.727273 // sell
					if( Color_con2 > -19.6604 )
						ret := 0.661417
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_ee68e0c4(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
