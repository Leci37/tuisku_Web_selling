...
decision_tree_0_APPS_1Hour_7052545d(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)=>
	...
	if( Money_Flow_Ratio > 0.417034 )
		...
		if( Typical_Price > 1.68836 )
			if( ema3 <= 82.1586 )
				if( Negative_Money_Flow_Sum <= 1.76903e+08 )
				...
				if( Negative_Money_Flow_Sum > 1.76903e+08 )
					...
					if( MFI_High > -28.9251 )
						ret := 0.828358 // buy
			if( ema3 > 82.1586 )
				if( Positive_Money_Flow_Sum <= 3.38484e+08 )
					if( Positive_Money_Flow_Sum <= 1.35966e+08 )
						if( Positive_Money_Flow_Sum <= 1.01916e+08 )
							ret := -0.457831
						if( Positive_Money_Flow_Sum > 1.01916e+08 )
							ret := 0.270270
					if( Positive_Money_Flow_Sum > 1.35966e+08 )
						if( Money_Flow_Ratio <= 1.12546 )
							ret := -0.831776 // sell
						if( Money_Flow_Ratio > 1.12546 )
							ret := -0.337278
				if( Positive_Money_Flow_Sum > 3.38484e+08 )
...
float op_operation = decision_tree_0_APPS_1Hour_7052545d(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
