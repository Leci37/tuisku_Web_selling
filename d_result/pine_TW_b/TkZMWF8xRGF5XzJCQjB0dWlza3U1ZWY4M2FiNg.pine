...
decision_tree_0_NFLX_1Day_5ef83ab6(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( Lower_Band > 321.301 )
			...
			if( Upper_Band <= 380.621 )
				...
				if( bearPower > 0.191874 )
					...
					if( basis > 360.107 )
						ret := -0.800000 // sell
			if( Upper_Band > 380.621 )
				if( bearPower <= 6.42924 )
					if( bearPower <= -24.2634 )
						ret := -0.235294
					if( bearPower > -24.2634 )
						ret := -0.651982
				if( bearPower > 6.42924 )
		...
		if( basis > 407.106 )
			if( basis <= 660.07 )
				if( bearPower <= 0.279752 )
					if( Upper_Band <= 547.461 )
						ret := 0.447699
					if( Upper_Band > 547.461 )
						ret := 0.024590
				if( bearPower > 0.279752 )
...
float op_operation = decision_tree_0_NFLX_1Day_5ef83ab6(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
