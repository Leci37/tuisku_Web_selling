			...
			if( Negative_Money_Flow_Sum > 3.011e+09 )
				...
				if( rsi1 > 26.0388 )
					...
					if( smoothD_d > 17.8273 )
						ret := -0.238509
	if( rsi1 > 63.9133 )
		if( Positive_Money_Flow_Sum <= 4.16914e+10 )
			if( rsi1 <= 82.4711 )
				if( smoothD_d <= 49.9815 )
					if( smoothD_d <= 4.86019 )
						ret := -0.148148
					if( smoothD_d > 4.86019 )
						ret := 0.607143
				if( smoothD_d > 49.9815 )
					if( Typical_Price <= 44667.2 )
						ret := 0.236059
					if( Typical_Price > 44667.2 )
						ret := -0.252174
			if( rsi1 > 82.4711 )
				if( Positive_Money_Flow_Sum <= 2.5972e+10 )
					if( Negative_Money_Flow_Sum <= 5.42905e+08 )
						ret := 0.803030 // buy
					if( Negative_Money_Flow_Sum > 5.42905e+08 )
						ret := -0.013699
				if( Positive_Money_Flow_Sum > 2.5972e+10 )
					...
					if( MFI > 93.9626 )
						ret := 0.000000
		if( Positive_Money_Flow_Sum > 4.16914e+10 )
			if( Positive_Money_Flow_Sum <= 4.78704e+10 )
				if( Typical_Price <= 32000.3 )
					ret := 0.000000
				if( Typical_Price > 32000.3 )
					if( d <= 98.6323 )
						ret := -0.951220 // sell
...
float op_operation = decision_tree_0_BTCUSDT_1Day_2665cadd(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
