			...
			if( MFI_High <= -62.7659 )
				if( Negative_Money_Flow <= 1.57952e+08 )
					...
					if( Positive_Money_Flow > 3.52922e+07 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow > 1.57952e+08 )
					if( Negative_Money_Flow_Sum <= 2.1478e+09 )
						ret := 0.333333
					if( Negative_Money_Flow_Sum > 2.1478e+09 )
						ret := 0.923077 // buy
			if( MFI_High > -62.7659 )
				if( Negative_Money_Flow_Sum <= 8.42079e+08 )
					if( Typical_Price <= 8.98583 )
						ret := -0.401042
					if( Typical_Price > 8.98583 )
						ret := 0.354430
				if( Negative_Money_Flow_Sum > 8.42079e+08 )
					...
					if( MFI > 21.1255 )
						ret := -0.603896
		if( MFI > 34.685 )
			if( Positive_Money_Flow_Sum <= 7.76316e+08 )
				if( Typical_Price <= 16.6392 )
					if( Negative_Money_Flow_Sum <= 1.38902e+08 )
						ret := -0.062147
					if( Negative_Money_Flow_Sum > 1.38902e+08 )
						ret := 0.496454
				if( Typical_Price > 16.6392 )
					if( Money_Flow_Ratio <= 1.13216 )
						ret := -0.822917 // sell
					if( Money_Flow_Ratio > 1.13216 )
						ret := -0.413793
			if( Positive_Money_Flow_Sum > 7.76316e+08 )
				if( Positive_Money_Flow_Sum <= 1.18801e+09 )
					if( Negative_Money_Flow_Sum <= 1.85316e+09 )
						ret := 0.815385 // buy
					if( Negative_Money_Flow_Sum > 1.85316e+09 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 1.18801e+09 )
					if( Typical_Price <= 77.3154 )
						ret := 0.166667
					if( Typical_Price > 77.3154 )
						ret := -0.609756
...
float op_operation = decision_tree_0_APPS_1Day_ca1ff3c6(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
