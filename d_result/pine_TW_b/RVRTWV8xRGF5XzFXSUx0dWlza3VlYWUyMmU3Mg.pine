...
decision_tree_0_ETSY_1Day_eae22e72(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( lowerBand > 12.7309 )
		if( wvf <= 34.2529 )
			if( upperBand <= 47.7126 )
				if( midLine <= 23.0497 )
					if( Color_con2 <= 2.55497 )
						ret := 0.200000
					if( Color_con2 > 2.55497 )
						ret := -1.000000 // sell
				if( midLine > 23.0497 )
			...
			if( midLine <= 29.449 )
				...
				if( Color_con1 > -0.791672 )
					...
					if( midLine > 25.1957 )
						ret := -1.000000 // sell
			if( midLine > 29.449 )
				if( lowerBand <= 25.4063 )
					if( lowerBand <= 20.3036 )
						ret := 0.500000
					if( lowerBand > 20.3036 )
						ret := 1.000000 // buy
				if( lowerBand > 25.4063 )
...
float op_operation = decision_tree_0_ETSY_1Day_eae22e72(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
