...
decision_tree_0_XRPUSDT_1Day_0dfa708c(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, ema2, tema, ema12, ema3, ema1, ema13)=>
	...
	if( ema2 > 0.376228 )
			...
			if( tema <= 0.370058 )
				...
				if( ema1 > 0.341229 )
					...
					if( Money_Flow_Ratio > 0.871398 )
						ret := 0.111111
			if( tema > 0.370058 )
				if( Positive_Money_Flow_Sum <= 9.02285e+08 )
					if( Negative_Money_Flow_Sum <= 8.81385e+07 )
						ret := 0.562500
					if( Negative_Money_Flow_Sum > 8.81385e+07 )
						ret := -0.284229
				if( Positive_Money_Flow_Sum > 9.02285e+08 )
		...
		if( tema > 1.34502 )
			...
			if( ema3 > 0.742446 )
				if( ema12 <= -0.02649 )
					if( Money_Flow_Ratio <= 0.963614 )
						ret := 0.500000
					if( Money_Flow_Ratio > 0.963614 )
						ret := -1.000000 // sell
				if( ema12 > -0.02649 )
					if( Negative_Money_Flow_Sum <= 1.27501e+10 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 1.27501e+10 )
						ret := -0.666667
...
float op_operation = decision_tree_0_XRPUSDT_1Day_0dfa708c(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, ema2, tema, ema12, ema3, ema1, ema13)
