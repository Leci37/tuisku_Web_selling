		...
		if( MFI <= 40.2202 )
			if( MFI_Low <= -12.0049 )
				...
				if( Typical_Price > 100.116 )
					ret := -0.967742 // sell
			if( MFI_Low > -12.0049 )
				if( Negative_Money_Flow_Sum <= 5.01062e+06 )
					ret := -0.721154 // sell
				if( Negative_Money_Flow_Sum > 5.01062e+06 )
					if( Negative_Money_Flow_Sum <= 2.17048e+08 )
						if( bearPower <= 0.30178 )
							ret := -0.017776
						if( bearPower > 0.30178 )
							ret := -0.465409
					if( Negative_Money_Flow_Sum > 2.17048e+08 )
						ret := -0.787879 // sell
		if( MFI > 40.2202 )
			if( bullPower <= -0.249811 )
				if( Negative_Money_Flow <= 143384 )
					if( Typical_Price <= 41.8978 )
						ret := 0.649682
					if( Typical_Price > 41.8978 )
						ret := 0.221843
				if( Negative_Money_Flow > 143384 )
					...
					if( bbm > 0.601948 )
						ret := 0.403279
			if( bullPower > -0.249811 )
				if( Money_Flow_Ratio <= 9.556 )
					if( Negative_Money_Flow_Sum <= 7.20249e+07 )
						if( Positive_Money_Flow_Sum <= 2.00974e+06 )
							ret := -0.640000
						if( Positive_Money_Flow_Sum > 2.00974e+06 )
							ret := 0.081803
					if( Negative_Money_Flow_Sum > 7.20249e+07 )
						ret := 0.496183
				if( Money_Flow_Ratio > 9.556 )
					if( Typical_Price <= 80.228 )
						if( Typical_Price <= 30.2502 )
							ret := -0.189189
						if( Typical_Price > 30.2502 )
							ret := 0.630631
					if( Typical_Price > 80.228 )
...
float op_operation = decision_tree_0_DOCN_30Min_7f044dc4(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
