			...
			if( senkou_span_b_displaced <= 185.674 )
				...
				if( senkou_span_b_displaced > 180.509 )
					...
					if( basis_minus > 0.986243 )
						ret := -0.426357
			if( senkou_span_b_displaced > 185.674 )
				if( kinjun_sen <= 196.24 )
					ret := 0.768707 // buy
				if( kinjun_sen > 196.24 )
					if( tenkan_sen <= 206.916 )
						ret := 0.436869
					if( tenkan_sen > 206.916 )
						ret := -0.541667
	if( senkou_span_b > 200.157 )
		if( chinkou_span <= 200.586 )
			if( basis_minus <= -4.76973 )
				if( senkou_span_b <= 205.494 )
					ret := 0.740741 // buy
				if( senkou_span_b > 205.494 )
					ret := -0.923077 // sell
			if( basis_minus > -4.76973 )
				ret := -0.605442
		if( chinkou_span > 200.586 )
			if( senkou_span_a_displaced <= 212.434 )
				if( senkou_span_a <= 202.535 )
					if( chinkou_span <= 202.758 )
						ret := -0.138889
					if( chinkou_span > 202.758 )
						ret := 0.682353
				if( senkou_span_a > 202.535 )
					if( senkou_span_b <= 205.345 )
						if( senkou_span_a_displaced <= 199.224 )
							ret := 0.777778 // buy
						if( senkou_span_a_displaced > 199.224 )
							ret := -0.616667
					if( senkou_span_b > 205.345 )
						if( senkou_span_b <= 206.113 )
							ret := 0.658537
						if( senkou_span_b > 206.113 )
							ret := -0.026667
			if( senkou_span_a_displaced > 212.434 )
...
float op_operation = decision_tree_0_ABNB_15Min_5a176bdf(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
