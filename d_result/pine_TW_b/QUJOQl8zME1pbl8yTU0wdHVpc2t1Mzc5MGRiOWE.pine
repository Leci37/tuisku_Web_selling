				...
				if( Positive_Money_Flow_Sum > 4.81038e+07 )
					...
					if( Money_Flow_Ratio > 0.564707 )
						...
						if( MA_Cross > 0.159339 )
							ret := 0.407240
			if( Raw_Money_Flow > 6.89866e+07 )
				if( Money_Flow_Ratio <= 0.68059 )
					if( Negative_Money_Flow_Sum <= 1.06199e+09 )
						if( Typical_Price <= 106.827 )
							ret := 0.659574
						if( Typical_Price > 106.827 )
							ret := 0.032258
					if( Negative_Money_Flow_Sum > 1.06199e+09 )
				...
				if( Money_Flow_Ratio > 0.68059 )
					if( Short_MA <= 116.606 )
						if( Raw_Money_Flow <= 8.07455e+07 )
							ret := -0.392857
						if( Raw_Money_Flow > 8.07455e+07 )
							ret := -0.091304
					if( Short_MA > 116.606 )
						if( Positive_Money_Flow_Sum <= 1.41632e+08 )
							ret := 0.900000 // buy
						if( Positive_Money_Flow_Sum > 1.41632e+08 )
							ret := 0.088235
	if( Typical_Price > 118.182 )
		if( Typical_Price <= 182.776 )
			if( Raw_Money_Flow <= 1.01285e+08 )
				if( MFI <= 7.60804 )
					if( Positive_Money_Flow <= 48651.3 )
						if( Negative_Money_Flow_Sum <= 1.11831e+08 )
							ret := -0.422594
						if( Negative_Money_Flow_Sum > 1.11831e+08 )
							ret := -0.031215
					if( Positive_Money_Flow > 48651.3 )
						if( Short_Long_Diff <= -5.46181 )
							ret := 1.000000 // buy
						if( Short_Long_Diff > -5.46181 )
							ret := -0.413732
				if( MFI > 7.60804 )
					if( Negative_Money_Flow_Sum <= 1.17552e+08 )
						if( Short_MA <= 157.032 )
							ret := 0.096010
						if( Short_MA > 157.032 )
							ret := -0.075630
					if( Negative_Money_Flow_Sum > 1.17552e+08 )
						if( Raw_Money_Flow <= 1.45811e+06 )
							ret := 0.028022
						if( Raw_Money_Flow > 1.45811e+06 )
							ret := -0.120116
			if( Raw_Money_Flow > 1.01285e+08 )
				if( Short_Long_Diff <= 1.22857 )
					if( Positive_Money_Flow_Sum <= 7.34314e+06 )
						if( Money_Flow_Ratio <= 0.003336 )
							ret := 0.526316
						if( Money_Flow_Ratio > 0.003336 )
							ret := -0.144737
					if( Positive_Money_Flow_Sum > 7.34314e+06 )
						if( Short_Long_Diff <= -0.747689 )
							ret := 0.438202
						if( Short_Long_Diff > -0.747689 )
							ret := 0.178207
				if( Short_Long_Diff > 1.22857 )
					if( MFI_High <= 17.2064 )
						if( Positive_Money_Flow <= 1.57311e+08 )
							ret := -0.137195
						if( Positive_Money_Flow > 1.57311e+08 )
							ret := -0.688000
					if( MFI_High > 17.2064 )
						...
						if( MFI > 99.66 )
							ret := -0.150000
		if( Typical_Price > 182.776 )
			if( Positive_Money_Flow_Sum <= 2.83251e+06 )
				if( MFI_High <= -58.911 )
					if( Positive_Money_Flow_Sum <= 1.64034e+06 )
						if( MFI_High <= -72.876 )
							ret := 0.071429
						if( MFI_High > -72.876 )
							ret := 0.900000 // buy
				...
				if( MFI_High > -58.911 )
					...
					if( MFI > 60.6829 )
						ret := 0.000000
			if( Positive_Money_Flow_Sum > 2.83251e+06 )
				if( Negative_Money_Flow_Sum <= 4.02047e+07 )
					if( Positive_Money_Flow_Sum <= 3.83949e+06 )
						if( Long_MA <= 188.642 )
							ret := 0.444444
						if( Long_MA > 188.642 )
							ret := 1.000000 // buy
				...
				if( Negative_Money_Flow_Sum > 4.02047e+07 )
					if( MFI_Low <= 45.9406 )
						if( Short_Long_Diff <= 4.50032 )
							ret := -0.179529
						if( Short_Long_Diff > 4.50032 )
							ret := 0.850000 // buy
					if( MFI_Low > 45.9406 )
						if( Negative_Money_Flow_Sum <= 2.91828e+08 )
							ret := 0.173780
						if( Negative_Money_Flow_Sum > 2.91828e+08 )
							ret := -0.409091
...
float op_operation = decision_tree_0_ABNB_30Min_3790db9a(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
