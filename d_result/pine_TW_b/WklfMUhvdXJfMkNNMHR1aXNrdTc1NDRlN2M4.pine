...
decision_tree_0_ZI_1Hour_7544e7c8(ad, ad_mf, mf, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)=>
	...
	if( Typical_Price > 48.0147 )
		if( mf <= 0.033462 )
			if( Positive_Money_Flow_Sum <= 4.23807e+08 )
				if( Positive_Money_Flow_Sum <= 4.01106e+07 )
					if( Raw_Money_Flow <= 3.96143e+07 )
						ret := -0.425856
					if( Raw_Money_Flow > 3.96143e+07 )
						ret := 0.562500
				if( Positive_Money_Flow_Sum > 4.01106e+07 )
					if( Negative_Money_Flow_Sum <= 1.12948e+08 )
						ret := 0.087097
					if( Negative_Money_Flow_Sum > 1.12948e+08 )
						ret := -0.187726
			if( Positive_Money_Flow_Sum > 4.23807e+08 )
				if( Raw_Money_Flow <= 5.12326e+07 )
					if( Negative_Money_Flow_Sum <= 1.06109e+08 )
						ret := -0.375000
					if( Negative_Money_Flow_Sum > 1.06109e+08 )
						ret := -0.912281 // sell
				if( Raw_Money_Flow > 5.12326e+07 )
					ret := -0.263158
		if( mf > 0.033462 )
			if( Positive_Money_Flow_Sum <= 2.5955e+08 )
				if( mf <= 0.332462 )
					if( Negative_Money_Flow_Sum <= 5.28694e+07 )
						ret := -0.110169
					if( Negative_Money_Flow_Sum > 5.28694e+07 )
						ret := 0.093541
				if( mf > 0.332462 )
					if( Positive_Money_Flow_Sum <= 2.52839e+08 )
						ret := -0.375610
					if( Positive_Money_Flow_Sum > 2.52839e+08 )
						ret := 0.714286 // buy
			if( Positive_Money_Flow_Sum > 2.5955e+08 )
				if( Negative_Money_Flow_Sum <= 1.28754e+08 )
					if( Positive_Money_Flow_Sum <= 3.40507e+08 )
						ret := 0.284024
					if( Positive_Money_Flow_Sum > 3.40507e+08 )
						ret := -0.286957
				if( Negative_Money_Flow_Sum > 1.28754e+08 )
					if( Typical_Price <= 65.8875 )
						ret := 0.715789 // buy
					if( Typical_Price > 65.8875 )
						ret := 0.060606
...
float op_operation = decision_tree_0_ZI_1Hour_7544e7c8(ad, ad_mf, mf, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
