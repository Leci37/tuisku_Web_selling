			...
			if( Color_con1 > -55.3298 )
				...
				if( sDev > 21.9671 )
					...
					if( wvf > 0.918668 )
						ret := 0.966667 // buy
		if( Color_con1 > -38.22 )
			if( Color_con2 <= -14.161 )
				if( lowerBand <= -1.15854 )
					if( Color_con2 <= -27.5219 )
						ret := 0.500000
					if( Color_con2 > -27.5219 )
						ret := 0.000000
				if( lowerBand > -1.15854 )
					if( upperBand <= 49.7046 )
						ret := -0.400000
					if( upperBand > 49.7046 )
						ret := -1.000000 // sell
			if( Color_con2 > -14.161 )
				if( lowerBand <= -0.566841 )
					if( sDev <= 20.6464 )
						ret := 0.714286 // buy
					if( sDev > 20.6464 )
						ret := 0.235294
				if( lowerBand > -0.566841 )
					if( Color_con2 <= 26.8008 )
						ret := 0.878788 // buy
					if( Color_con2 > 26.8008 )
						ret := 0.000000
...
float op_operation = decision_tree_0_PINS_1Day_4bc66688(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
