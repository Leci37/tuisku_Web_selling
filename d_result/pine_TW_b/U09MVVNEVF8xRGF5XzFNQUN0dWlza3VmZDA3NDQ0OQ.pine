...
float op_operation = decision_tree_0_SOLUSDT_1Day_fd074449(signal, histA_IsDownInt, macd, hist, histA_IsUpInt, histB_IsDownInt, histB_IsUpInt, macd_IsBelowInt, macd_IsAboveInt)
