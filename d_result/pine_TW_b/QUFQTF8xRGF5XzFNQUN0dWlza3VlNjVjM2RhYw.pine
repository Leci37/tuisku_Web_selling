...
float op_operation = decision_tree_0_AAPL_1Day_e65c3dac(macd_IsAboveInt, histB_IsDownInt, histA_IsDownInt, histB_IsUpInt, signal, histA_IsUpInt, hist, macd_IsBelowInt, macd)
