...
decision_tree_0_ETHUSDT_1Day_89642706(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bearPower > -5.54695 )
		if( bullPower <= 12.731 )
			...
			if( bbp > 4.70833 )
				if( bbm <= 5.41799 )
					if( bearPower <= 2.44002 )
						ret := 0.636364
					if( bearPower > 2.44002 )
						ret := 0.880000 // buy
				if( bbm > 5.41799 )
					if( bearPower <= 2.43093 )
						ret := 0.631068
					if( bearPower > 2.43093 )
						ret := 0.131579
		if( bullPower > 12.731 )
			if( bbp <= 22.8587 )
				...
				if( bbp > 17.1913 )
					...
					if( bbm > 15.8446 )
						ret := 0.111111
			if( bbp > 22.8587 )
				if( bullPower <= 19.5139 )
					if( bbm <= 8.36795 )
						ret := 0.545455
					if( bbm > 8.36795 )
						ret := 0.955556 // buy
				if( bullPower > 19.5139 )
					if( bullPower <= 24.7108 )
						ret := -0.506024
					if( bullPower > 24.7108 )
						ret := 0.096774
...
float op_operation = decision_tree_0_ETHUSDT_1Day_89642706(bearPower, bbm, bbp, bullPower, BBPower_Color)
