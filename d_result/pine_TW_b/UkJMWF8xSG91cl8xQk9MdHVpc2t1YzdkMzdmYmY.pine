...
decision_tree_0_RBLX_1Hour_c7d37fbf(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)=>
	...
	if( BBupper > 45.6895 )
		if( vrsi <= 47.7985 )
			...
			if( dif_source_BBlower > 0.601438 )
				if( BBupper <= 99.9248 )
					if( dif_source_BBupper <= -27.8751 )
						ret := -0.689189
					if( dif_source_BBupper > -27.8751 )
						if( dif_source_BBlower <= 31.693 )
							ret := -0.072212
						if( dif_source_BBlower > 31.693 )
							ret := -1.000000 // sell
				if( BBupper > 99.9248 )
					if( BBlower <= 68.2407 )
						ret := 0.803571 // buy
					if( BBlower > 68.2407 )
						if( dif_source_BBupper <= -25.4106 )
							ret := 0.622047
						if( dif_source_BBupper > -25.4106 )
							ret := -0.099730
		if( vrsi > 47.7985 )
			if( BBlower <= 93.9763 )
				if( dif_source_BBupper <= -28.1486 )
					if( BBlower <= 56.4243 )
						ret := 0.966667 // buy
					if( BBlower > 56.4243 )
						ret := -0.434783
				if( dif_source_BBupper > -28.1486 )
					if( dif_source_BBupper <= -17.9349 )
						if( BBupper <= 110.247 )
							ret := -0.595506
						if( BBupper > 110.247 )
							ret := 0.237288
...
float op_operation = decision_tree_0_RBLX_1Hour_c7d37fbf(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
