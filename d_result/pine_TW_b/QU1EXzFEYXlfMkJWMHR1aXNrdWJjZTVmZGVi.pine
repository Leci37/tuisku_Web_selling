			...
			if( VIP <= 1.03516 )
				...
				if( VIP_VIM > -0.601608 )
					...
					if( bbp > 2.74021 )
						ret := -0.428571
			if( VIP > 1.03516 )
				if( bearPower <= 1.69395 )
					if( VIM <= 0.91971 )
						ret := -0.115942
					if( VIM > 0.91971 )
						ret := -0.750000 // sell
				if( bearPower > 1.69395 )
					if( bearPower <= 6.35452 )
						ret := -0.942308 // sell
					if( bearPower > 6.35452 )
						ret := -0.416667
...
float op_operation = decision_tree_0_AMD_1Day_bce5fdeb(bullPower, bbp, bearPower, bbm, BBPower_Color, VIP, VIM, VIP_VIM)
