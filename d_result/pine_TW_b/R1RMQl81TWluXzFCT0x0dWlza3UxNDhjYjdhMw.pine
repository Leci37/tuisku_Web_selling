			...
			if( BBlower > 70.865 )
				...
				if( dif_source_BBupper > -5.09199 )
					...
					if( BBupper > 78.9179 )
						ret := 0.565217
	if( vrsi > 43.7439 )
		if( dif_source_BBupper <= 2.77177 )
			if( BBlower <= 43.4973 )
				if( dif_source_BBupper <= -5.39243 )
					ret := 0.816327 // buy
				if( dif_source_BBupper > -5.39243 )
					if( BBlower <= 39.6858 )
						if( dif_source_BBlower <= 0.200403 )
							ret := -0.624242
						if( dif_source_BBlower > 0.200403 )
							ret := -0.062789
					if( BBlower > 39.6858 )
						if( dif_source_BBlower <= 1.75808 )
							ret := 0.159206
						if( dif_source_BBlower > 1.75808 )
							ret := -0.020928
			if( BBlower > 43.4973 )
				if( BBupper <= 47.2314 )
					if( dif_source_BBlower <= 1.59949 )
						if( vrsi <= 56.5929 )
							ret := -0.222222
						if( vrsi > 56.5929 )
							ret := -0.528796
...
float op_operation = decision_tree_0_GTLB_5Min_148cb7a3(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
