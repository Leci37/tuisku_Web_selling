...
float op_operation = decision_tree_0_DOTUSDT_1Day_ce6b123f(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
