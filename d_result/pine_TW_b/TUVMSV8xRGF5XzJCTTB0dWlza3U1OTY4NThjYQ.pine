		...
		if( Negative_Money_Flow_Sum <= 1.55821e+09 )
			if( bearPower <= -2.98977 )
				if( Typical_Price <= 329.633 )
					if( Positive_Money_Flow_Sum <= 1.55446e+09 )
						ret := 0.193548
					if( Positive_Money_Flow_Sum > 1.55446e+09 )
						ret := -0.774194 // sell
				if( Typical_Price > 329.633 )
					if( Typical_Price <= 547.738 )
						ret := -0.762887 // sell
					if( Typical_Price > 547.738 )
						ret := 0.000000
			if( bearPower > -2.98977 )
				if( Positive_Money_Flow_Sum <= 2.03263e+09 )
					if( Negative_Money_Flow_Sum <= 1.28756e+09 )
						ret := 0.344156
					if( Negative_Money_Flow_Sum > 1.28756e+09 )
						ret := -0.388889
				if( Positive_Money_Flow_Sum > 2.03263e+09 )
					if( Typical_Price <= 388.524 )
						ret := -0.703297 // sell
					if( Typical_Price > 388.524 )
						ret := 0.183099
		if( Negative_Money_Flow_Sum > 1.55821e+09 )
			if( bbm <= 43.6761 )
				if( Money_Flow_Ratio <= 0.494824 )
					if( Typical_Price <= 608.819 )
						ret := -0.166667
					if( Typical_Price > 608.819 )
						ret := 0.684211
				if( Money_Flow_Ratio > 0.494824 )
					if( Positive_Money_Flow_Sum <= 3.80405e+09 )
						ret := 0.183217
					if( Positive_Money_Flow_Sum > 3.80405e+09 )
						ret := -0.120075
			if( bbm > 43.6761 )
				if( Negative_Money_Flow_Sum <= 1.39767e+10 )
					if( Negative_Money_Flow_Sum <= 8.74019e+09 )
						ret := -0.098517
					if( Negative_Money_Flow_Sum > 8.74019e+09 )
						ret := -0.635135
				if( Negative_Money_Flow_Sum > 1.39767e+10 )
					if( bearPower <= -109.464 )
						ret := 0.937500 // buy
					if( bearPower > -109.464 )
						ret := 0.000000
...
float op_operation = decision_tree_0_MELI_1Day_596858ca(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
