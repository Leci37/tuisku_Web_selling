	...
	if( Typical_Price > 10.659 )
		...
		if( Negative_Money_Flow_Sum > 4.41198e+10 )
			if( Raw_Money_Flow <= 5.80573e+09 )
				if( Typical_Price <= 91.0634 )
					if( Typical_Price <= 75.0235 )
						ret := 0.000000
					if( Typical_Price > 75.0235 )
						ret := -0.857143 // sell
				if( Typical_Price > 91.0634 )
...
float op_operation = decision_tree_0_AMD_1Day_f1c70b1e(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
