			...
			if( Positive_Money_Flow_Sum <= 2.57451e+08 )
				...
				if( ema12 > -5.98659 )
					...
					if( Raw_Money_Flow > 6.94632e+06 )
						ret := -0.168303
			if( Positive_Money_Flow_Sum > 2.57451e+08 )
				if( Money_Flow_Ratio <= 2.88416 )
					if( ema13 <= 26.8274 )
						ret := 0.145889
					if( ema13 > 26.8274 )
						ret := -0.703704 // sell
				if( Money_Flow_Ratio > 2.88416 )
					if( Raw_Money_Flow <= 3.43492e+08 )
						ret := -0.321429
					if( Raw_Money_Flow > 3.43492e+08 )
						ret := 0.583333
		if( Positive_Money_Flow_Sum > 4.08868e+09 )
			if( Positive_Money_Flow_Sum <= 4.499e+09 )
				ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 4.499e+09 )
				if( ema2 <= 294.35 )
					ret := -0.545455
				if( ema2 > 294.35 )
					if( Typical_Price <= 318.21 )
						ret := -1.000000 // sell
					if( Typical_Price > 318.21 )
						ret := -0.857143 // sell
...
float op_operation = decision_tree_0_LTCUSDT_1Day_37ea79d1(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
