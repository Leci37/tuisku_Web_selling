				...
				if( senkou_span_a <= 77.6982 )
					...
					if( basis_minus > -0.184674 )
						...
						if( basis_minus > 1.7712 )
							ret := 0.598639
				if( senkou_span_a > 77.6982 )
					if( chinkou_span <= 83.4093 )
						if( tenkan_sen <= 80.1681 )
							ret := -0.024357
						if( tenkan_sen > 80.1681 )
							ret := -0.517442
					if( chinkou_span > 83.4093 )
						if( tenkan_sen <= 85.0875 )
							ret := 0.472277
						if( tenkan_sen > 85.0875 )
							ret := 0.011928
	if( basis_max > 1.14938 )
		if( chinkou_span <= 92.3201 )
			if( senkou_span_a <= 59.6535 )
				ret := 1.000000 // buy
			if( senkou_span_a > 59.6535 )
				ret := -0.663185
		if( chinkou_span > 92.3201 )
			if( senkou_span_a_displaced <= 104.964 )
				ret := 0.797980 // buy
			if( senkou_span_a_displaced > 104.964 )
				if( kinjun_sen <= 258.884 )
					if( chinkou_span <= 202.115 )
						if( kinjun_sen <= 197.521 )
							ret := -0.104798
						if( kinjun_sen > 197.521 )
							ret := -0.621622
					if( chinkou_span > 202.115 )
						if( senkou_span_a <= 235.436 )
							ret := 0.696970
						if( senkou_span_a > 235.436 )
							ret := 0.131661
				if( kinjun_sen > 258.884 )
					if( senkou_span_b <= 265.055 )
						ret := -0.865672 // sell
					if( senkou_span_b > 265.055 )
						if( senkou_span_b_displaced <= 272.998 )
							ret := 0.555556
						if( senkou_span_b_displaced > 272.998 )
							ret := -0.454839
...
float op_operation = decision_tree_0_PYPL_1Hour_581428a2(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
