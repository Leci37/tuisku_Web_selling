			...
			if( bbm <= 0.053301 )
				...
				if( ema1 > 79.1937 )
					...
					if( ema12 > 0.045479 )
						ret := -0.550562
			if( bbm > 0.053301 )
				if( bearPower <= 0.723648 )
					if( ema1 <= 64.3019 )
						if( bearPower <= -0.434742 )
							ret := 0.701299 // buy
						if( bearPower > -0.434742 )
							ret := 0.024572
					if( ema1 > 64.3019 )
						if( bullPower <= 0.104077 )
							ret := 0.040098
						if( bullPower > 0.104077 )
							ret := -0.078864
				if( bearPower > 0.723648 )
...
float op_operation = decision_tree_0_UBER_5Min_ad5761e5(bbp, bullPower, BBPower_Color, bearPower, bbm, ema2, ema1, ema12, ema3, ema13, tema)
