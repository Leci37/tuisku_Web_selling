...
decision_tree_0_FFIV_1Hour_d6e407d6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Typical_Price <= 127.332 )
		...
		if( MFI > 31.215 )
			...
			if( MFI_Low > 57.5075 )
				if( VIP_VIM <= 0.433937 )
					if( Negative_Money_Flow <= 8.90139e+06 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow > 8.90139e+06 )
						ret := 0.000000
				if( VIP_VIM > 0.433937 )
					...
					if( VIP_VIM > 0.536558 )
						ret := -0.100000
	if( Typical_Price > 127.332 )
		if( Negative_Money_Flow <= 6.745e+07 )
			if( Negative_Money_Flow_Sum <= 2.54037e+08 )
				if( Raw_Money_Flow <= 3.7259e+06 )
					if( VIP_VIM <= -0.777888 )
						if( Positive_Money_Flow_Sum <= 5.29951e+07 )
							ret := 0.000000
						if( Positive_Money_Flow_Sum > 5.29951e+07 )
							ret := 0.961538 // buy
					if( VIP_VIM > -0.777888 )
						...
						if( VIP_VIM > 0.449359 )
							ret := -0.363036
				if( Raw_Money_Flow > 3.7259e+06 )
					if( Negative_Money_Flow_Sum <= 1.47269e+08 )
						if( VIP <= 0.759227 )
							ret := 0.326087
						if( VIP > 0.759227 )
							ret := 0.013026
			...
			if( Negative_Money_Flow_Sum > 2.54037e+08 )
				if( VIM <= 1.38311 )
					if( MFI_High <= -49.0042 )
						if( Raw_Money_Flow <= 1.4579e+07 )
							ret := 0.166667
						if( Raw_Money_Flow > 1.4579e+07 )
							ret := -0.416667
					if( MFI_High > -49.0042 )
						if( Typical_Price <= 200.283 )
							ret := 0.756098 // buy
						if( Typical_Price > 200.283 )
							ret := -0.409091
				if( VIM > 1.38311 )
		...
		if( Negative_Money_Flow > 6.745e+07 )
			if( MFI <= 29.0894 )
				if( Positive_Money_Flow_Sum <= 2.13946e+07 )
					ret := 0.875000 // buy
				if( Positive_Money_Flow_Sum > 2.13946e+07 )
					if( VIP_VIM <= -1.02619 )
						ret := 1.000000 // buy
					if( VIP_VIM > -1.02619 )
						...
						if( VIP_VIM > 0.404954 )
							ret := 0.750000 // buy
			if( MFI > 29.0894 )
				if( Money_Flow_Ratio <= 0.908319 )
					if( Negative_Money_Flow_Sum <= 2.38975e+08 )
						if( Money_Flow_Ratio <= 0.517208 )
							ret := -0.600000
						if( Money_Flow_Ratio > 0.517208 )
							ret := 0.500000
					if( Negative_Money_Flow_Sum > 2.38975e+08 )
						ret := 1.000000 // buy
				if( Money_Flow_Ratio > 0.908319 )
					if( Positive_Money_Flow_Sum <= 2.05777e+08 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 2.05777e+08 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_FFIV_1Hour_d6e407d6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
