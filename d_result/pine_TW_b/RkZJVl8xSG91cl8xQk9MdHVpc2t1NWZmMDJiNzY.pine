				...
				if( BBlower <= 157.807 )
					if( BBlower <= 122.888 )
						...
						if( vrsi > 26.911 )
							ret := 0.734694 // buy
					if( BBlower > 122.888 )
						if( dif_source_BBlower <= -2.26076 )
							ret := 0.583333
						if( dif_source_BBlower > -2.26076 )
							ret := 0.212903
				if( BBlower > 157.807 )
					if( dif_source_BBupper <= -58.4618 )
						if( dif_source_BBlower <= -2.49822 )
							ret := 0.891892 // buy
						if( dif_source_BBlower > -2.49822 )
							ret := 0.250000
					if( dif_source_BBupper > -58.4618 )
				...
				if( dif_source_BBupper <= 7.87512 )
					if( vrsi <= 91.6692 )
						...
						if( BBupper > 177.648 )
							ret := 0.083401
					if( vrsi > 91.6692 )
						if( dif_source_BBlower <= 9.20763 )
							ret := -0.445565
						if( dif_source_BBlower > 9.20763 )
							ret := -0.044313
				if( dif_source_BBupper > 7.87512 )
					if( dif_source_BBlower <= 24.1117 )
						ret := 0.200000
					if( dif_source_BBlower > 24.1117 )
						if( BBupper <= 134.743 )
							ret := 1.000000 // buy
				...
				if( BBupper <= 248.784 )
					...
					if( BBlower > 221.686 )
						...
						if( vrsi > 64.4238 )
							ret := 0.681034
				if( BBupper > 248.784 )
					if( dif_source_BBlower <= 0.303261 )
						ret := 0.571429
					if( dif_source_BBlower > 0.303261 )
						if( BBupper <= 250.923 )
							ret := -0.656250
...
float op_operation = decision_tree_0_FFIV_1Hour_5ff02b76(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
