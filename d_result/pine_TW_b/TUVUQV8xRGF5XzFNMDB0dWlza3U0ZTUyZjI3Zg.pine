			...
			if( Negative_Money_Flow_Sum > 2.70144e+10 )
				if( Money_Flow_Ratio <= 0.493183 )
					...
					if( MFI_High > -52.4506 )
						ret := -0.779661 // sell
				if( Money_Flow_Ratio > 0.493183 )
					if( Positive_Money_Flow_Sum <= 7.05101e+10 )
						ret := -0.091593
					if( Positive_Money_Flow_Sum > 7.05101e+10 )
						ret := 0.500000
		if( Money_Flow_Ratio > 2.11398 )
			if( Positive_Money_Flow_Sum <= 7.68e+10 )
				if( Raw_Money_Flow <= 3.86942e+09 )
					if( Negative_Money_Flow <= 6.00245e+06 )
						ret := 0.054545
					if( Negative_Money_Flow > 6.00245e+06 )
						ret := -1.000000 // sell
				if( Raw_Money_Flow > 3.86942e+09 )
					if( Typical_Price <= 213.008 )
						ret := 0.724638 // buy
					if( Typical_Price > 213.008 )
						ret := 0.185185
			if( Positive_Money_Flow_Sum > 7.68e+10 )
				if( Positive_Money_Flow <= 5.99727e+09 )
					ret := -1.000000 // sell
				if( Positive_Money_Flow > 5.99727e+09 )
					if( Typical_Price <= 276.751 )
						ret := -0.714286 // sell
					if( Typical_Price > 276.751 )
						ret := -0.066667
...
float op_operation = decision_tree_0_META_1Day_4e52f27f(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
