		...
		if( Color_con1 <= -28.8009 )
			...
			if( Color_con2 > -24.363 )
				...
				if( sDev > 18.6609 )
					ret := -0.750000 // sell
		if( Color_con1 > -28.8009 )
			if( Color_con2 <= -9.47627 )
				if( wvf <= 10.0621 )
					if( lowerBand <= -2.84089 )
						ret := -0.571429
					if( lowerBand > -2.84089 )
						ret := 0.500000
				if( wvf > 10.0621 )
					if( Color_con1 <= -7.53809 )
						ret := 0.954545 // buy
					if( Color_con1 > -7.53809 )
						ret := 0.166667
			if( Color_con2 > -9.47627 )
				if( Color_con2 <= 1.02368 )
					if( lowerBand <= 7.06835 )
						ret := -0.797101 // sell
					if( lowerBand > 7.06835 )
						ret := 0.281553
				if( Color_con2 > 1.02368 )
...
float op_operation = decision_tree_0_CRSR_1Day_fbc47a61(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
