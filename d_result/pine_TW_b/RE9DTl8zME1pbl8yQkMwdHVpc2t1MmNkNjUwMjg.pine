				...
				if( ad <= 168177 )
					...
					if( bullPower > -0.15235 )
						...
						if( ad_mf > 3404.15 )
							ret := 0.041645
				if( ad > 168177 )
					if( bullPower <= 0.44243 )
						ret := -0.497992
					if( bullPower > 0.44243 )
						ret := -0.021739
			if( bbp > 1.04232 )
				if( mf <= 0.006611 )
					if( bullPower <= 0.785644 )
						ret := -0.792857 // sell
					if( bullPower > 0.785644 )
						ret := -0.375328
				if( mf > 0.006611 )
...
float op_operation = decision_tree_0_DOCN_30Min_2cd65028(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
