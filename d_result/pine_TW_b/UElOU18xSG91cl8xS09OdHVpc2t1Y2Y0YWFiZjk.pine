			...
			if( verde_mean <= -65.3185 )
				...
				if( media > 6.64875 )
					if( source <= 20.1863 )
						ret := 0.500000
					if( source > 20.1863 )
						if( media_azul <= 33.7982 )
							ret := -0.881188 // sell
						if( media_azul > 33.7982 )
							ret := 1.000000 // buy
			if( verde_mean > -65.3185 )
				if( verde_media <= -21.405 )
					if( xrsi <= 22.5661 )
						if( source <= 68.0758 )
							ret := 0.601173
						if( source > 68.0758 )
				...
				if( verde_media > -21.405 )
					if( source <= 83.9395 )
						...
						if( tprice > 55.3457 )
							ret := 0.106403
					if( source > 83.9395 )
						if( verde_media <= 64.1778 )
							ret := -0.645570
						if( verde_media > 64.1778 )
							ret := 0.133333
		if( nvi_ema > 1.61121 )
			if( pvim <= -0.992974 )
				if( azul_mean <= 7.52447 )
					if( stoc <= 42.6615 )
						if( pvi_ema <= -0.997218 )
							ret := -0.167401
						if( pvi_ema > -0.997218 )
				...
				if( xrsi <= 24.3738 )
					if( media <= 22.5139 )
						...
						if( media > 2.33616 )
							ret := 0.500000
					if( media > 22.5139 )
						if( marron_mean <= 3.72547 )
							ret := -0.882353 // sell
						if( marron_mean > 3.72547 )
							ret := 0.216216
				if( xrsi > 24.3738 )
					if( media <= 108.58 )
						if( verde_azul <= 128.842 )
							ret := -0.186714
						if( verde_azul > 128.842 )
							ret := 0.167969
					if( media > 108.58 )
...
float op_operation = decision_tree_0_PINS_1Hour_cf4aabf9(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
