				...
				if( source > 63.0543 )
					if( xrsi <= 31.501 )
						...
						if( BollOsc > -37.1471 )
							ret := 0.000000
					if( xrsi > 31.501 )
						if( media_azul <= 69.6748 )
							ret := 0.487500
						if( media_azul > 69.6748 )
							ret := -1.000000 // sell
			if( oscp > -39.5498 )
				if( media_azul <= 76.2229 )
					if( marron_mean <= -6.13307 )
						if( pvimax <= 0.079232 )
							ret := 0.000000
						if( pvimax > 0.079232 )
							ret := 1.000000 // buy
...
float op_operation = decision_tree_0_TWLO_5Min_eb1804e5(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
