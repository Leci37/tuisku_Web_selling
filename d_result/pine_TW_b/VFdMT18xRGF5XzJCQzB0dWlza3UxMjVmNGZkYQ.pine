			...
			if( bbm > 2.23114 )
				...
				if( ad_mf > 307257 )
					...
					if( ad > 1.08794e+06 )
						ret := -0.156250
		if( ad_mf > 2.05275e+06 )
			if( ad_mf <= 1.09778e+07 )
				if( bbp <= 6.81116 )
					if( ad_mf <= 4.78835e+06 )
						ret := 0.662500
					if( ad_mf > 4.78835e+06 )
						ret := 0.000000
				if( bbp > 6.81116 )
					if( bearPower <= 4.86917 )
						ret := 0.000000
					if( bearPower > 4.86917 )
						ret := 0.687500
			if( ad_mf > 1.09778e+07 )
...
float op_operation = decision_tree_0_TWLO_1Day_125f4fda(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)
