...
decision_tree_0_ADSK_1Day_3f3f7235(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)=>
	...
	if( Typical_Price > 202.613 )
		if( Long_MA <= 243.559 )
			if( Short_Long_Diff <= 15.3175 )
				if( Positive_Money_Flow <= 5.08765e+08 )
					if( Positive_Money_Flow_Sum <= 2.44996e+09 )
						ret := -0.206667
					if( Positive_Money_Flow_Sum > 2.44996e+09 )
						ret := -0.500000
				if( Positive_Money_Flow > 5.08765e+08 )
					...
					if( Long_MA > 208.234 )
						ret := -0.074074
			if( Short_Long_Diff > 15.3175 )
				if( Negative_Money_Flow_Sum <= 1.46729e+09 )
					ret := 0.000000
				if( Negative_Money_Flow_Sum > 1.46729e+09 )
					if( MFI_Low <= 45.4546 )
						ret := 0.000000
					if( MFI_Low > 45.4546 )
						ret := 0.928571 // buy
		if( Long_MA > 243.559 )
			if( Negative_Money_Flow_Sum <= 4.96055e+09 )
				if( Negative_Money_Flow_Sum <= 3.19698e+09 )
					if( Short_Long_Diff <= 3.07227 )
						ret := 0.236559
					if( Short_Long_Diff > 3.07227 )
						ret := -0.145631
				if( Negative_Money_Flow_Sum > 3.19698e+09 )
					if( Short_Long_Diff <= -14.1863 )
						ret := 0.571429
					if( Short_Long_Diff > -14.1863 )
						ret := -0.632479
			if( Negative_Money_Flow_Sum > 4.96055e+09 )
...
float op_operation = decision_tree_0_ADSK_1Day_3f3f7235(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
