				...
				if( Negative_Money_Flow <= 4.99518e+06 )
					...
					if( Negative_Money_Flow_Sum > 3.03869e+07 )
						...
						if( MFI_High > -67.0612 )
							ret := -0.596330
				if( Negative_Money_Flow > 4.99518e+06 )
					if( Positive_Money_Flow_Sum <= 3.07933e+07 )
						if( Negative_Money_Flow_Sum <= 1.5301e+07 )
							ret := -0.085470
						if( Negative_Money_Flow_Sum > 1.5301e+07 )
							ret := 0.452539
					if( Positive_Money_Flow_Sum > 3.07933e+07 )
						if( Short_Long_Diff <= 1.19524 )
							ret := -0.561644
						if( Short_Long_Diff > 1.19524 )
							ret := 0.625000
			if( Negative_Money_Flow_Sum > 3.37949e+07 )
				if( Negative_Money_Flow_Sum <= 5.65982e+07 )
					if( Money_Flow_Ratio <= 0.577615 )
						if( Raw_Money_Flow <= 2.63548e+07 )
							ret := 0.665468
						if( Raw_Money_Flow > 2.63548e+07 )
							ret := -0.230769
					if( Money_Flow_Ratio > 0.577615 )
						if( Positive_Money_Flow_Sum <= 5.31557e+07 )
							ret := -0.209877
						if( Positive_Money_Flow_Sum > 5.31557e+07 )
							ret := 0.434211
				if( Negative_Money_Flow_Sum > 5.65982e+07 )
					if( Typical_Price <= 62.1399 )
						if( Negative_Money_Flow_Sum <= 6.25205e+07 )
							ret := -0.475000
						if( Negative_Money_Flow_Sum > 6.25205e+07 )
							ret := 0.248120
					if( Typical_Price > 62.1399 )
						if( Negative_Money_Flow_Sum <= 9.73121e+07 )
							ret := -0.222222
						if( Negative_Money_Flow_Sum > 9.73121e+07 )
							ret := -1.000000 // sell
	if( Positive_Money_Flow > 14.7987 )
		if( Negative_Money_Flow_Sum <= 1.91448e+08 )
			if( Short_Long_Diff <= 2.93107 )
				if( Positive_Money_Flow_Sum <= 2.77078e+07 )
					if( Money_Flow_Ratio <= 62.5936 )
						if( Positive_Money_Flow_Sum <= 284463 )
							ret := -0.223152
						if( Positive_Money_Flow_Sum > 284463 )
							ret := -0.007800
					if( Money_Flow_Ratio > 62.5936 )
						if( Positive_Money_Flow_Sum <= 6.85939e+06 )
							ret := 0.289474
						if( Positive_Money_Flow_Sum > 6.85939e+06 )
							ret := -0.544554
				if( Positive_Money_Flow_Sum > 2.77078e+07 )
					if( Typical_Price <= 58.0156 )
						if( Raw_Money_Flow <= 1.0383e+07 )
							ret := -0.160952
						if( Raw_Money_Flow > 1.0383e+07 )
							ret := 0.480315
					if( Typical_Price > 58.0156 )
						if( Positive_Money_Flow_Sum <= 1.00636e+08 )
							ret := -0.284625
						if( Positive_Money_Flow_Sum > 1.00636e+08 )
							ret := -0.988506 // sell
			if( Short_Long_Diff > 2.93107 )
				if( Positive_Money_Flow <= 2.50569e+06 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow > 2.50569e+06 )
					ret := 0.800000 // buy
		if( Negative_Money_Flow_Sum > 1.91448e+08 )
			if( Short_Long_Diff <= -0.427242 )
				ret := 1.000000 // buy
			if( Short_Long_Diff > -0.427242 )
				ret := 0.333333
...
float op_operation = decision_tree_0_GTLB_5Min_4f245234(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
