...
decision_tree_0_QCOM_1Day_84484cfc(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)=>
	...
	if( Lower_Band > 51.2723 )
		if( basis <= 66.6396 )
			...
			if( Upper_Band > 66.6217 )
				if( bbm <= 0.705 )
					if( Lower_Band <= 63.5762 )
						ret := 0.000000
					if( Lower_Band > 63.5762 )
						ret := 0.916667 // buy
				if( bbm > 0.705 )
					if( Upper_Band <= 67.9792 )
						ret := -0.894737 // sell
					if( Upper_Band > 67.9792 )
						ret := -0.362832
		if( basis > 66.6396 )
			if( Lower_Band <= 106.105 )
				if( Lower_Band <= 102.335 )
					if( bbp <= -7.94601 )
						ret := -0.638298
					if( bbp > -7.94601 )
						ret := 0.101920
...
float op_operation = decision_tree_0_QCOM_1Day_84484cfc(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
