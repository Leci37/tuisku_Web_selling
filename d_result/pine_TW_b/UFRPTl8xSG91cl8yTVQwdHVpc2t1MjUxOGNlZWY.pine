...
decision_tree_0_PTON_1Hour_2518ceef(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( tema > 3.07683 )
		...
		if( Raw_Money_Flow > 2.20203e+06 )
			if( ema13 <= 2.37452 )
				if( Raw_Money_Flow <= 2.13288e+08 )
					if( ema1 <= 116.604 )
						if( Money_Flow_Ratio <= 0.109016 )
							ret := 0.221691
						if( Money_Flow_Ratio > 0.109016 )
							ret := 0.047045
					if( ema1 > 116.604 )
						if( Negative_Money_Flow <= 862614 )
							ret := 0.009901
						if( Negative_Money_Flow > 862614 )
							ret := -0.275488
				if( Raw_Money_Flow > 2.13288e+08 )
					if( ema13 <= -7.45678 )
						ret := -0.894737 // sell
					if( ema13 > -7.45678 )
						if( Typical_Price <= 108.134 )
							ret := 0.537118
						if( Typical_Price > 108.134 )
							ret := 0.100962
			if( ema13 > 2.37452 )
				if( Raw_Money_Flow <= 3.57766e+07 )
					if( MFI_Low <= 68.8543 )
						if( ema2 <= 35.2827 )
							ret := 1.000000 // buy
						if( ema2 > 35.2827 )
				...
				if( Raw_Money_Flow > 3.57766e+07 )
					if( MFI_Low <= 71.3945 )
						if( Positive_Money_Flow_Sum <= 5.42395e+09 )
							ret := -0.095785
						if( Positive_Money_Flow_Sum > 5.42395e+09 )
							ret := 1.000000 // buy
					if( MFI_Low > 71.3945 )
						if( Raw_Money_Flow <= 1.66558e+08 )
							ret := 0.230769
						if( Raw_Money_Flow > 1.66558e+08 )
							ret := -0.777778 // sell
...
float op_operation = decision_tree_0_PTON_1Hour_2518ceef(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
