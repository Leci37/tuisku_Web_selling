			...
			if( ema3 <= 55.1414 )
				...
				if( MFI_Low > 53.9383 )
					...
					if( ema2 > 44.7594 )
						ret := -0.363636
			if( ema3 > 55.1414 )
				if( Negative_Money_Flow_Sum <= 3.75996e+09 )
					if( Raw_Money_Flow <= 3.07288e+08 )
						ret := 0.020619
					if( Raw_Money_Flow > 3.07288e+08 )
						ret := -0.259045
				if( Negative_Money_Flow_Sum > 3.75996e+09 )
...
float op_operation = decision_tree_0_TWLO_1Day_a1a41440(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
