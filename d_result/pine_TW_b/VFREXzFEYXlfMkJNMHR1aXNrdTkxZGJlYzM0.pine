			...
			if( Negative_Money_Flow <= 2.93513e+08 )
				...
				if( Money_Flow_Ratio > 0.753635 )
					...
					if( Negative_Money_Flow_Sum > 1.91894e+09 )
						ret := -0.615385
			if( Negative_Money_Flow > 2.93513e+08 )
				if( Raw_Money_Flow <= 5.61738e+08 )
					if( Raw_Money_Flow <= 4.17352e+08 )
						ret := -0.941176 // sell
					if( Raw_Money_Flow > 4.17352e+08 )
						ret := -0.533333
				if( Raw_Money_Flow > 5.61738e+08 )
					if( bullPower <= 26.1561 )
						ret := 0.272727
					if( bullPower > 26.1561 )
						ret := -0.875000 // sell
		if( bearPower > -2.65193 )
			if( Positive_Money_Flow <= 9.24964e+08 )
				if( bbp <= 63.0153 )
					if( Money_Flow_Ratio <= 4.80305 )
						ret := -0.047163
					if( Money_Flow_Ratio > 4.80305 )
						ret := 0.380952
				if( bbp > 63.0153 )
			...
			if( Positive_Money_Flow > 9.24964e+08 )
				if( Negative_Money_Flow_Sum <= 1.49211e+09 )
					ret := 0.000000
				if( Negative_Money_Flow_Sum > 1.49211e+09 )
					if( Positive_Money_Flow <= 1.7854e+09 )
						ret := -0.636364
					if( Positive_Money_Flow > 1.7854e+09 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_TTD_1Day_91dbec34(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
