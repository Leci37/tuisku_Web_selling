...
decision_tree_0_ETHUSDT_30Min_2080116b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( rsi1 > 50.517 )
		if( d_k <= 2.93029 )
			if( rsi1 <= 65.2875 )
				if( Negative_Money_Flow <= 1.23422e+07 )
					if( MFI <= 54.9838 )
						if( Negative_Money_Flow_Sum <= 1.09775e+08 )
							ret := 0.175543
						if( Negative_Money_Flow_Sum > 1.09775e+08 )
							if( d_k <= -3.84464 )
								ret := 0.585814
				...
				if( Negative_Money_Flow > 1.23422e+07 )
					ret := 0.587688
			if( rsi1 > 65.2875 )
				if( Typical_Price <= 657.598 )
					ret := 0.037383
				if( Typical_Price > 657.598 )
					ret := 0.642970
		if( d_k > 2.93029 )
			if( rsi1 <= 67.1056 )
				if( Positive_Money_Flow <= 1.9646e+07 )
					if( MFI_High <= -19.6559 )
						if( rsi1 <= 56.3965 )
							ret := 0.007878
						if( rsi1 > 56.3965 )
				...
				if( Positive_Money_Flow > 1.9646e+07 )
					...
					if( MFI > 73.6178 )
						ret := -0.714640 // sell
			if( rsi1 > 67.1056 )
				if( Positive_Money_Flow <= 9.24168e+07 )
					ret := 0.313601
				if( Positive_Money_Flow > 9.24168e+07 )
					ret := -0.372000
...
float op_operation = decision_tree_0_ETHUSDT_30Min_2080116b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
