				...
				if( VIM > 1.19392 )
					...
					if( VIP > 0.729706 )
						...
						if( VIP > 0.837021 )
							ret := -0.125000
		if( bearPower > -1.09758 )
			if( bullPower <= -0.002552 )
				if( bearPower <= -0.060446 )
					if( bbm <= 0.024816 )
						if( VIP <= 0.86198 )
							ret := -0.378788
						if( VIP > 0.86198 )
				...
				if( VIP_VIM > -0.364968 )
					if( bbm <= 1.05977 )
						...
						if( bbp > -0.3613 )
							ret := -0.090431
					if( bbm > 1.05977 )
						if( bullPower <= 0.954095 )
							ret := -0.627907
						if( bullPower > 0.954095 )
							ret := 0.875000 // buy
	if( VIP > 0.889062 )
		if( bearPower <= -0.664654 )
			if( bbm <= 4.08165 )
				if( VIM <= 1.06732 )
					if( VIM <= 0.973341 )
						if( VIM <= 0.767737 )
		...
		if( bearPower > -0.664654 )
				...
				if( VIM <= 0.784781 )
					if( VIM <= 0.547029 )
						...
						if( VIP > 1.2761 )
							ret := 0.000000
					if( VIM > 0.547029 )
						if( bearPower <= 1.97022 )
							ret := 0.108190
						if( bearPower > 1.97022 )
							ret := -0.600000
				if( VIM > 0.784781 )
					if( bullPower <= 0.03232 )
						if( VIP_VIM <= 0.40346 )
							ret := 0.036671
						if( VIP_VIM > 0.40346 )
							ret := 0.813953 // buy
			...
			if( VIP_VIM > 0.838158 )
				...
				if( bearPower > 0.578481 )
					if( VIP <= 1.42738 )
						if( bullPower <= 1.60847 )
							ret := 1.000000 // buy
						if( bullPower > 1.60847 )
							ret := 0.000000
					if( VIP > 1.42738 )
						if( bearPower <= 0.895116 )
							ret := -0.600000
						if( bearPower > 0.895116 )
							ret := 0.187500
...
float op_operation = decision_tree_0_NIO_1Hour_16b5ed96(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
