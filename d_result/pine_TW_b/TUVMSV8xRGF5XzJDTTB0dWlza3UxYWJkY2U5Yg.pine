			...
			if( Negative_Money_Flow_Sum <= 2.62074e+09 )
				if( Positive_Money_Flow_Sum <= 1.73987e+09 )
					...
					if( MFI_Low > 35.7505 )
						ret := 0.337386
				if( Positive_Money_Flow_Sum > 1.73987e+09 )
					if( Typical_Price <= 443.818 )
						ret := -0.540230
					if( Typical_Price > 443.818 )
						ret := 0.088167
			if( Negative_Money_Flow_Sum > 2.62074e+09 )
				if( MFI <= 57.5086 )
					if( Typical_Price <= 1601.37 )
						ret := 0.814815 // buy
					if( Typical_Price > 1601.37 )
						ret := -0.125000
				if( MFI > 57.5086 )
					if( Typical_Price <= 1306.98 )
						ret := -0.309524
					if( Typical_Price > 1306.98 )
						ret := 0.186441
		if( Negative_Money_Flow_Sum > 3.39233e+09 )
			if( ad <= -67336.5 )
				if( MFI_Low <= 38.1467 )
					if( Typical_Price <= 1399.47 )
						ret := 0.250000
					if( Typical_Price > 1399.47 )
						ret := -0.213333
				if( MFI_Low > 38.1467 )
					if( Typical_Price <= 1385.4 )
						ret := -0.571429
					if( Typical_Price > 1385.4 )
						ret := 0.333333
			if( ad > -67336.5 )
				if( Negative_Money_Flow_Sum <= 4.42764e+09 )
					if( Typical_Price <= 1835.25 )
						ret := -0.704280 // sell
					if( Typical_Price > 1835.25 )
						ret := -0.107143
				if( Negative_Money_Flow_Sum > 4.42764e+09 )
					if( Negative_Money_Flow_Sum <= 5.80357e+09 )
						ret := 0.099338
					if( Negative_Money_Flow_Sum > 5.80357e+09 )
						ret := -0.690909
...
float op_operation = decision_tree_0_MELI_1Day_1abdce9b(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
