			...
			if( diPlus <= 42.7896 )
				if( diPlus <= 33.8976 )
					...
					if( diMinus > 21.6249 )
						ret := 0.428016
				if( diPlus > 33.8976 )
					if( smoothedDirectionalMovementPlus <= 0.389254 )
						ret := 0.082569
					if( smoothedDirectionalMovementPlus > 0.389254 )
						ret := -0.511737
			if( diPlus > 42.7896 )
				if( smoothedTrueRange <= 2.75555 )
					if( adx <= 60.4341 )
						ret := 0.934211 // buy
					if( adx > 60.4341 )
						ret := -0.333333
				if( smoothedTrueRange > 2.75555 )
					if( directionalMovementPlus <= 2.18992 )
						ret := -0.526316
					if( directionalMovementPlus > 2.18992 )
						ret := 0.727273 // buy
		if( diMinus > 25.5743 )
			if( adx <= 18.1484 )
				if( smoothedDirectionalMovementPlus <= 0.427523 )
					if( smoothedDirectionalMovementPlus <= 0.17681 )
						ret := -1.000000 // sell
					if( smoothedDirectionalMovementPlus > 0.17681 )
						ret := 0.689189
				if( smoothedDirectionalMovementPlus > 0.427523 )
					...
					if( dx > 9.08053 )
						ret := -0.766667 // sell
			if( adx > 18.1484 )
				if( smoothedTrueRange <= 2.68306 )
					if( trueRange <= 1.61848 )
						ret := -0.241270
					if( trueRange > 1.61848 )
						ret := -0.734884 // sell
				if( smoothedTrueRange > 2.68306 )
...
float op_operation = decision_tree_0_RUN_1Day_4fbcfe5a(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)
