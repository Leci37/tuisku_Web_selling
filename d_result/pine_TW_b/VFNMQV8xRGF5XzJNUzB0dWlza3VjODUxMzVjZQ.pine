			...
			if( Money_Flow_Ratio > 0.708084 )
				...
				if( Raw_Money_Flow > 1.90301e+10 )
					...
					if( k > 94.6212 )
						ret := 0.467890
	if( Negative_Money_Flow_Sum > 9.52721e+10 )
		if( Positive_Money_Flow_Sum <= 4.2668e+11 )
			if( MFI_Low <= 51.0536 )
				if( smoothK_k <= 88.3589 )
					if( rsi1 <= 29.7049 )
						ret := 0.090551
					if( rsi1 > 29.7049 )
						ret := -0.291489
				if( smoothK_k > 88.3589 )
					if( Typical_Price <= 172.202 )
						ret := 0.900000 // buy
					if( Typical_Price > 172.202 )
						ret := 0.142857
			if( MFI_Low > 51.0536 )
				if( Typical_Price <= 275.424 )
					if( d <= 70.5756 )
						ret := -0.750000 // sell
					if( d > 70.5756 )
						ret := 0.090909
				if( Typical_Price > 275.424 )
					if( smoothD_d <= 50.6124 )
						ret := -0.250000
					if( smoothD_d > 50.6124 )
						ret := -0.870968 // sell
		if( Positive_Money_Flow_Sum > 4.2668e+11 )
			if( Typical_Price <= 790.804 )
				if( smoothD_d <= 7.69203 )
					if( smoothK_k <= 6.26394 )
						ret := 1.000000 // buy
					if( smoothK_k > 6.26394 )
						ret := 0.000000
				if( smoothD_d > 7.69203 )
					if( Typical_Price <= 637.417 )
						ret := 0.000000
					if( Typical_Price > 637.417 )
						ret := 1.000000 // buy
			if( Typical_Price > 790.804 )
...
float op_operation = decision_tree_0_TSLA_1Day_c85135ce(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, rsi1, d, k, smoothD_d, d_k, smoothK_k)
