			...
			if( rsi1 > 61.2636 )
				if( d_k <= -8.14245 )
					if( rsi1 <= 68.8698 )
						ret := 0.111111
					if( rsi1 > 68.8698 )
						if( smoothD_d <= 41.6449 )
							ret := -0.846154 // sell
						if( smoothD_d > 41.6449 )
							ret := -1.000000 // sell
				if( d_k > -8.14245 )
					if( ad_mf <= 1.21049e+06 )
						ret := 0.000000
					if( ad_mf > 1.21049e+06 )
						ret := 1.000000 // buy
	if( d_k > -5.50194 )
				...
				if( rsi1 <= 42.9497 )
					if( ad_mf <= -167934 )
						...
						if( d_k > 9.00751 )
							ret := -0.028571
					if( ad_mf > -167934 )
						if( smoothD_d <= 57.9994 )
							ret := -0.058824
						if( smoothD_d > 57.9994 )
							ret := 0.340909
				if( rsi1 > 42.9497 )
					if( mf <= -0.169416 )
						if( smoothD_d <= 50.3575 )
							ret := 0.327586
						if( smoothD_d > 50.3575 )
							ret := 0.715909 // buy
					if( mf > -0.169416 )
...
float op_operation = decision_tree_0_GTLB_30Min_f2f3e6a3(mf, ad_mf, ad, d, d_k, smoothK_k, k, rsi1, smoothD_d)
