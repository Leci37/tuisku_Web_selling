				...
				if( tema <= 46.8268 )
					if( rsi1 <= 61.3073 )
						...
						if( tema > 44.0652 )
							ret := 0.016758
					if( rsi1 > 61.3073 )
						if( smoothK_k <= 32.3327 )
							ret := -0.545455
						if( smoothK_k > 32.3327 )
							ret := -0.015134
				if( tema > 46.8268 )
					if( k <= 39.1216 )
						if( smoothK_k <= 27.3074 )
							ret := 0.257143
						if( smoothK_k > 27.3074 )
							ret := -0.700000 // sell
					if( k > 39.1216 )
...
float op_operation = decision_tree_0_GTLB_15Min_4006d38b(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)
