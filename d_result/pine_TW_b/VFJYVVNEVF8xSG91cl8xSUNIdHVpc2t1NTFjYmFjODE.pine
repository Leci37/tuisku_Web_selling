			...
			if( chinkou_span <= 0.074313 )
				if( senkou_span_b_displaced <= 0.083804 )
					...
					if( basis_max > 0.001282 )
						ret := 0.021978
				if( senkou_span_b_displaced > 0.083804 )
					if( kinjun_sen <= 0.08151 )
						ret := 0.974359 // buy
					if( kinjun_sen > 0.08151 )
						ret := -0.789474 // sell
			if( chinkou_span > 0.074313 )
				if( basis_minus <= 0.004009 )
					if( tenkan_sen <= 0.076722 )
						if( kinjun_sen <= 0.080877 )
							ret := 0.300592
						if( kinjun_sen > 0.080877 )
							ret := -1.000000 // sell
					if( tenkan_sen > 0.076722 )
						if( chinkou_span <= 0.088313 )
							ret := -0.143477
						if( chinkou_span > 0.088313 )
							ret := 0.015305
				if( basis_minus > 0.004009 )
					if( basis_minus <= 0.009165 )
						if( senkou_span_a_displaced <= 0.141193 )
							ret := -0.354086
						if( senkou_span_a_displaced > 0.141193 )
							ret := -0.800000 // sell
					if( basis_minus > 0.009165 )
						if( basis_minus <= 0.011553 )
							ret := 0.645390
						if( basis_minus > 0.011553 )
							ret := -0.327273
	if( basis_max > 0.003128 )
		if( tenkan_sen <= 0.151601 )
			if( chinkou_span <= 0.088265 )
				ret := 0.125000
			if( chinkou_span > 0.088265 )
				ret := 0.747036 // buy
		if( tenkan_sen > 0.151601 )
...
float op_operation = decision_tree_0_TRXUSDT_1Hour_51cbac81(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
