...
float op_operation = decision_tree_0_ADSK_5Min_2afc69fb(macd_IsAboveInt, histB_IsDownInt, histA_IsDownInt, histB_IsUpInt, signal, histA_IsUpInt, hist, macd_IsBelowInt, macd)
