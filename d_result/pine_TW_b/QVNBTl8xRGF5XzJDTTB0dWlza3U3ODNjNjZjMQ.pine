			...
			if( Typical_Price > 99.1649 )
				...
				if( mf > -0.048572 )
					...
					if( mf > 0.173263 )
						ret := -1.000000 // sell
		if( MFI > 74.3775 )
			if( Negative_Money_Flow_Sum <= 8.54684e+08 )
				if( MFI <= 86.4353 )
					if( MFI_Low <= 59.4274 )
						ret := 1.000000 // buy
					if( MFI_Low > 59.4274 )
...
float op_operation = decision_tree_0_ASAN_1Day_783c66c1(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
