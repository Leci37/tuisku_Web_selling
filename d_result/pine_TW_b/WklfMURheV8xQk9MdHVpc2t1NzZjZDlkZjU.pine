...
decision_tree_0_ZI_1Day_76cd9df5(BBupper, BBlower, crossover_rsi_bblowerInt, vrsi, dif_source_BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower)=>
	...
	if( dif_source_BBupper > -26.0804 )
		if( BBlower <= 34.0615 )
			if( BBlower <= 14.1879 )
				if( dif_source_BBupper <= -8.89511 )
					if( dif_source_BBlower <= 12.4525 )
						ret := 0.326203
					if( dif_source_BBlower > 12.4525 )
						ret := -0.700000 // sell
				if( dif_source_BBupper > -8.89511 )
					if( dif_source_BBlower <= 0.381816 )
						ret := 0.032258
					if( dif_source_BBlower > 0.381816 )
						ret := -0.836364 // sell
			if( BBlower > 14.1879 )
		...
		if( BBlower > 34.0615 )
			if( BBlower <= 39.5041 )
				if( BBupper <= 76.7637 )
					if( dif_source_BBupper <= -21.6292 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > -21.6292 )
						ret := 0.187097
				if( BBupper > 76.7637 )
					if( dif_source_BBupper <= -23.446 )
						ret := 0.000000
					if( dif_source_BBupper > -23.446 )
						ret := -1.000000 // sell
			if( BBlower > 39.5041 )
				if( dif_source_BBupper <= -25.462 )
					ret := 1.000000 // buy
				if( dif_source_BBupper > -25.462 )
					if( dif_source_BBupper <= -20.466 )
						ret := -0.750000 // sell
					if( dif_source_BBupper > -20.466 )
						ret := 0.000000
...
float op_operation = decision_tree_0_ZI_1Day_76cd9df5(BBupper, BBlower, crossover_rsi_bblowerInt, vrsi, dif_source_BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower)
