				...
				if( VIP <= 1.39305 )
					if( d_k <= -0.248896 )
						...
						if( VIM > 0.692863 )
							ret := 0.396226
					if( d_k > -0.248896 )
						if( smoothK_k <= 96.9976 )
							ret := -0.467456
						if( smoothK_k > 96.9976 )
							ret := -0.010989
				if( VIP > 1.39305 )
					if( smoothD_d <= 96.7208 )
						if( rsi1 <= 78.9222 )
							ret := 0.923077 // buy
						if( rsi1 > 78.9222 )
							ret := -0.171429
...
float op_operation = decision_tree_0_TTD_1Hour_feeb4a81(rsi1, d, k, smoothD_d, d_k, smoothK_k, VIP, VIP_VIM, VIM)
