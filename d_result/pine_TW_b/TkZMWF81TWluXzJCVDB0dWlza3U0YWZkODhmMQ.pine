		...
		if( bbm > 0.609199 )
			...
			if( ema3 > 715.455 )
				...
				if( ema13 > -2.08034 )
					ret := -0.056338
	if( bullPower > -0.24758 )
		if( bearPower <= 9.55439 )
			if( bullPower <= 5.88007 )
				if( bearPower <= 2.51019 )
					if( bbp <= -0.592699 )
						if( ema2 <= 700.804 )
							ret := -0.092010
						if( ema2 > 700.804 )
...
float op_operation = decision_tree_0_NFLX_5Min_4afd88f1(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
