				...
				if( val > -0.077325 )
					if( lowerKC <= 260.136 )
						...
						if( lowerKC > 228.52 )
							ret := 0.595506
					if( lowerKC > 260.136 )
						if( priceRange <= 1.78106 )
							ret := -0.903226 // sell
						if( priceRange > 1.78106 )
							ret := -0.222222
			if( upperKC > 273.93 )
				if( rangema <= 3.23454 )
					if( priceRange <= 1.99375 )
						if( avgHighLow <= 271.618 )
							ret := -0.833333 // sell
						if( avgHighLow > 271.618 )
							ret := -1.000000 // sell
					if( priceRange > 1.99375 )
...
float op_operation = decision_tree_0_ADSK_5Min_019236fe(val, sqzOnInt, lowerBB, lowerKC, upperKC, dev, rangema, sqzOffInt, upperBB, priceRange, noSqzInt, ma, basis, avgHighLow)
