			...
			if( Typical_Price <= 2.78119 )
				if( Raw_Money_Flow <= 8.13851e+07 )
					...
					if( Negative_Money_Flow > 4.00574e+07 )
						ret := 0.363636
				if( Raw_Money_Flow > 8.13851e+07 )
					if( Positive_Money_Flow_Sum <= 4.91618e+08 )
						ret := -0.900000 // sell
					if( Positive_Money_Flow_Sum > 4.91618e+08 )
						ret := 0.350000
			if( Typical_Price > 2.78119 )
				if( Money_Flow_Ratio <= 0.502324 )
					if( Typical_Price <= 41.1474 )
						ret := 0.127358
					if( Typical_Price > 41.1474 )
						ret := -0.857143 // sell
				if( Money_Flow_Ratio > 0.502324 )
					if( Positive_Money_Flow_Sum <= 5.74282e+08 )
						ret := -0.610390
					if( Positive_Money_Flow_Sum > 5.74282e+08 )
						ret := -0.269821
		if( MFI > 66.0691 )
			if( Positive_Money_Flow_Sum <= 3.12977e+10 )
				if( Negative_Money_Flow_Sum <= 5.14758e+08 )
					if( Positive_Money_Flow <= 1.46063e+06 )
						ret := 0.476190
					if( Positive_Money_Flow > 1.46063e+06 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 5.14758e+08 )
					if( Raw_Money_Flow <= 2.00091e+08 )
						ret := -0.682927
					if( Raw_Money_Flow > 2.00091e+08 )
						ret := 0.102410
			if( Positive_Money_Flow_Sum > 3.12977e+10 )
				if( Negative_Money_Flow_Sum <= 1.10965e+10 )
					if( Money_Flow_Ratio <= 3.39288 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 3.39288 )
						ret := 0.333333
				if( Negative_Money_Flow_Sum > 1.10965e+10 )
					if( Raw_Money_Flow <= 2.20881e+09 )
						ret := 0.500000
					if( Raw_Money_Flow > 2.20881e+09 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_NIO_1Day_192e4e92(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
