			...
			if( chinkou_span <= 98.6043 )
				...
				if( chinkou_span > 38.8233 )
					...
					if( chinkou_span > 39.3384 )
						ret := -0.765625 // sell
			if( chinkou_span > 98.6043 )
				if( senkou_span_b_displaced <= 201.363 )
					if( basis_max <= 5.38998 )
						ret := -0.333333
					if( basis_max > 5.38998 )
						ret := 0.500000
				if( senkou_span_b_displaced > 201.363 )
					if( senkou_span_a <= 156.646 )
						ret := -1.000000 // sell
					if( senkou_span_a > 156.646 )
						ret := 0.000000
		if( basis_minus > -19.2311 )
			if( chinkou_span <= 174.52 )
				if( tenkan_sen <= 150.799 )
					if( senkou_span_b_displaced <= 38.7178 )
						ret := -0.424242
					if( senkou_span_b_displaced > 38.7178 )
						ret := 0.129870
				if( tenkan_sen > 150.799 )
					if( basis_max <= 7.59587 )
						ret := -0.603175
					if( basis_max > 7.59587 )
						ret := 1.000000 // buy
			if( chinkou_span > 174.52 )
				if( senkou_span_b_displaced <= 150.367 )
					if( tenkan_sen <= 210.316 )
						ret := 0.705882 // buy
					if( tenkan_sen > 210.316 )
						ret := 0.000000
				if( senkou_span_b_displaced > 150.367 )
					if( chinkou_span <= 177.69 )
						ret := -0.800000 // sell
					if( chinkou_span > 177.69 )
						ret := -0.125000
...
float op_operation = decision_tree_0_SOLUSDT_1Day_5c7476e4(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
