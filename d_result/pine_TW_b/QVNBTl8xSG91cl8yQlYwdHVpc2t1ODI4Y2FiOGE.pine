...
decision_tree_0_ASAN_1Hour_828cab8a(bullPower, bbp, bearPower, bbm, BBPower_Color, VIP, VIM, VIP_VIM)=>
	...
	if( VIP <= 1.17924 )
		...
		if( bullPower > -0.075795 )
			...
			if( VIP_VIM > -0.028231 )
				if( bbm <= 0.003174 )
					if( bearPower <= 0.105496 )
						if( bullPower <= 0.020251 )
							ret := -0.297297
						if( bullPower > 0.020251 )
							ret := 0.375000
					if( bearPower > 0.105496 )
				...
				if( bbm > 0.003174 )
					...
					if( bbm > 0.304742 )
						...
						if( VIM > 1.10889 )
							ret := 0.569231
	if( VIP > 1.17924 )
		if( bearPower <= -0.926069 )
			if( bullPower <= 3.21152 )
				if( VIP <= 1.22134 )
					if( VIP <= 1.19591 )
						ret := 0.454545
					if( VIP > 1.19591 )
				...
				if( bearPower <= 0.048363 )
					...
					if( bbp > -0.720642 )
						...
						if( VIP_VIM > 0.01437 )
							ret := -0.204545
				if( bearPower > 0.048363 )
					if( bearPower <= 0.462525 )
						if( bullPower <= 0.366342 )
							ret := -0.488506
						if( bullPower > 0.366342 )
							ret := 0.266667
					if( bearPower > 0.462525 )
...
float op_operation = decision_tree_0_ASAN_1Hour_828cab8a(bullPower, bbp, bearPower, bbm, BBPower_Color, VIP, VIM, VIP_VIM)
