...
decision_tree_0_SHOP_1Hour_e9485bb3(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)=>
	...
	if( diPlus > 22.7292 )
		if( adx <= 14.3969 )
			if( smoothedDirectionalMovementMinus <= 0.521796 )
				if( smoothedDirectionalMovementPlus <= 0.127343 )
					ret := 0.083333
				if( smoothedDirectionalMovementPlus > 0.127343 )
					ret := 0.637838
			if( smoothedDirectionalMovementMinus > 0.521796 )
				...
				if( dx > 12.2467 )
					ret := -0.292929
		if( adx > 14.3969 )
			if( trueRange <= 38.7525 )
				if( smoothedTrueRange <= 0.759069 )
					if( adx <= 85.5434 )
						ret := 0.015059
					if( adx > 85.5434 )
						ret := 0.676471
				if( smoothedTrueRange > 0.759069 )
					if( adx <= 17.4754 )
						if( smoothedDirectionalMovementMinus <= 0.466004 )
							ret := 0.370370
						if( smoothedDirectionalMovementMinus > 0.466004 )
							ret := -0.202532
					if( adx > 17.4754 )
			...
			if( trueRange > 38.7525 )
				if( adx <= 42.9594 )
					if( directionalMovementPlus <= 39.6545 )
						if( smoothedTrueRange <= 18.7309 )
							ret := 0.155556
						if( smoothedTrueRange > 18.7309 )
							ret := -0.694915
					if( directionalMovementPlus > 39.6545 )
...
float op_operation = decision_tree_0_SHOP_1Hour_e9485bb3(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)
