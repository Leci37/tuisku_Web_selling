			...
			if( BBupper > 421.796 )
				...
				if( BBupper > 537.874 )
					...
					if( vrsi > 33.8956 )
						ret := -1.000000 // sell
		if( BBlower > 275.962 )
			if( dif_source_BBupper <= -125.395 )
				if( dif_source_BBlower <= -12.306 )
					if( dif_source_BBupper <= -463.072 )
						ret := -1.000000 // sell
					if( dif_source_BBupper > -463.072 )
						ret := 0.717949 // buy
				if( dif_source_BBlower > -12.306 )
			...
			if( dif_source_BBupper > -125.395 )
				if( BBupper <= 555.179 )
					if( dif_source_BBupper <= -20.019 )
						ret := 0.770492 // buy
					if( dif_source_BBupper > -20.019 )
						ret := 0.232558
				if( BBupper > 555.179 )
					if( dif_source_BBlower <= 154.952 )
						ret := 0.207627
					if( dif_source_BBlower > 154.952 )
						ret := -0.149502
...
float op_operation = decision_tree_0_NFLX_1Day_7a0fcfb6(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
