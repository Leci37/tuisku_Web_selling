...
decision_tree_0_AVAXUSDT_1Day_e6a3a42d(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( Typical_Price > 24.355 )
		if( MFI_High <= -46.4561 )
			if( rsi1 <= 27.8468 )
				if( Negative_Money_Flow <= 1.72257e+08 )
					if( Typical_Price <= 26.0036 )
						ret := 0.894737 // buy
					if( Typical_Price > 26.0036 )
						ret := 0.325000
				if( Negative_Money_Flow > 1.72257e+08 )
			...
			if( rsi1 > 27.8468 )
				...
				if( smoothK_k > 7.2784 )
					...
					if( d_k > 9.69401 )
						ret := -0.375000
		if( MFI_High > -46.4561 )
			if( Negative_Money_Flow <= 3.65171e+08 )
				if( d_k <= -8.50182 )
					if( MFI <= 70.4274 )
						ret := 0.181818
					if( MFI > 70.4274 )
				...
				if( d_k > -8.50182 )
					...
					if( rsi1 > 87.4561 )
						ret := 0.625000
			if( Negative_Money_Flow > 3.65171e+08 )
				if( Positive_Money_Flow_Sum <= 5.45253e+09 )
					if( Money_Flow_Ratio <= 1.49579 )
						ret := 0.571429
					if( Money_Flow_Ratio > 1.49579 )
						ret := 0.923077 // buy
				if( Positive_Money_Flow_Sum > 5.45253e+09 )
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_e6a3a42d(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
