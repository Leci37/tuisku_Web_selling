...
decision_tree_0_ABNB_1Min_bb661bec(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)=>
	...
	if( rsi1 > 44.4674 )
		if( smoothK_k <= 96.4993 )
			if( d <= 75.3819 )
				if( d_k <= -29.6236 )
					if( smoothK_k <= 82.8422 )
						if( smoothK_k <= 63.6719 )
							ret := 0.166667
						if( smoothK_k > 63.6719 )
							ret := -0.661417
					if( smoothK_k > 82.8422 )
...
float op_operation = decision_tree_0_ABNB_1Min_bb661bec(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)
