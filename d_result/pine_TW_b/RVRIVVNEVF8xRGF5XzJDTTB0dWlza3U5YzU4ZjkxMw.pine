			...
			if( Positive_Money_Flow_Sum > 2.00749e+10 )
				...
				if( Money_Flow_Ratio > 1.07332 )
					...
					if( mf > 0.34839 )
						ret := -0.454545
		if( Typical_Price > 3165.86 )
			if( Money_Flow_Ratio <= 4.02593 )
				if( ad_mf <= 74356.8 )
					if( Positive_Money_Flow <= 9.32832e+06 )
						ret := -0.269841
					if( Positive_Money_Flow > 9.32832e+06 )
						ret := -0.701299 // sell
				if( ad_mf > 74356.8 )
					if( Positive_Money_Flow_Sum <= 1.84925e+10 )
						ret := -0.058824
					if( Positive_Money_Flow_Sum > 1.84925e+10 )
						ret := -0.611111
			if( Money_Flow_Ratio > 4.02593 )
				if( Typical_Price <= 3494.32 )
					if( Positive_Money_Flow_Sum <= 1.92842e+10 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 1.92842e+10 )
						ret := 0.888889 // buy
				if( Typical_Price > 3494.32 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_9c58f913(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
