				...
				if( bbm <= 0.194963 )
					...
					if( bbm > 0.101327 )
						...
						if( bbp > 0.610853 )
							ret := 0.252441
				if( bbm > 0.194963 )
					if( bullPower <= 0.982071 )
						if( bearPower <= 0.554494 )
							ret := -0.118354
						if( bearPower > 0.554494 )
							ret := -0.847826 // sell
					if( bullPower > 0.982071 )
						if( bearPower <= 0.541328 )
							ret := 0.720721 // buy
						if( bearPower > 0.541328 )
							ret := -0.083333
		if( bearPower > 0.924608 )
			if( bbm <= 0.015111 )
				if( bullPower <= 1.62273 )
					if( bullPower <= 1.31322 )
						if( bullPower <= 1.1822 )
							ret := -0.523810
						if( bullPower > 1.1822 )
							ret := -1.000000 // sell
			...
			if( bbm > 0.015111 )
				if( bbp <= 2.78774 )
					if( bearPower <= 1.14678 )
						if( bearPower <= 1.01283 )
							ret := -0.241379
						if( bearPower > 1.01283 )
							ret := -0.896552 // sell
					if( bearPower > 1.14678 )
						...
						if( bbp > 2.73684 )
							ret := 0.555556
				if( bbp > 2.78774 )
					if( bearPower <= 1.37892 )
						if( bbm <= 0.994817 )
							ret := -1.000000 // sell
						if( bbm > 0.994817 )
							ret := -0.857143 // sell
					if( bearPower > 1.37892 )
						if( bearPower <= 1.58271 )
							ret := 0.619048
						if( bearPower > 1.58271 )
							ret := -0.686747
...
float op_operation = decision_tree_0_FFIV_1Min_ce27672c(bearPower, bbm, bbp, bullPower, BBPower_Color)
