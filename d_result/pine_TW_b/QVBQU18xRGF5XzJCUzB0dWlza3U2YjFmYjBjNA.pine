...
decision_tree_0_APPS_1Day_6b1fb0c4(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( bbm > 0.587231 )
		...
		if( smoothD_d > 65.1826 )
			if( rsi1 <= 39.789 )
				if( smoothK_k <= 63.6947 )
					ret := 0.222222
				if( smoothK_k > 63.6947 )
					if( smoothK_k <= 89.9101 )
						ret := -0.886364 // sell
					if( smoothK_k > 89.9101 )
						ret := 0.285714
			if( rsi1 > 39.789 )
				if( smoothK_k <= 74.9714 )
					if( rsi1 <= 65.1013 )
						ret := 0.712500 // buy
					if( rsi1 > 65.1013 )
						ret := 0.032258
...
float op_operation = decision_tree_0_APPS_1Day_6b1fb0c4(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
