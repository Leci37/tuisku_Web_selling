				...
				if( nvi_ema <= 1.99094 )
					...
					if( marron > 14.5639 )
						...
						if( stoc > 32.7341 )
							ret := -0.249044
				if( nvi_ema > 1.99094 )
					if( verde_media <= 3.097 )
						if( azul <= 15.9525 )
							ret := 0.001804
						if( azul > 15.9525 )
							ret := 0.175922
					if( verde_media > 3.097 )
						if( media_azul <= 68.2849 )
							ret := -0.109469
						if( media_azul > 68.2849 )
							ret := 0.033102
	if( stoc > 79.1367 )
		if( marron_mean <= 123.42 )
			if( source <= 33.4622 )
				if( xrsi <= 52.2825 )
					ret := -1.000000 // sell
				if( xrsi > 52.2825 )
				...
				if( pvi <= -0.229982 )
					...
					if( verde > 148.478 )
						...
						if( source > 44.6711 )
							ret := -0.296252
				if( pvi > -0.229982 )
					if( azul_mean <= -32.2605 )
						if( azul <= -121.568 )
							ret := 1.000000 // buy
						if( azul > -121.568 )
							ret := -0.843750 // sell
					if( azul_mean > -32.2605 )
						if( azul_mean <= 12.7662 )
							ret := 0.043619
						if( azul_mean > 12.7662 )
							ret := -0.155111
		if( marron_mean > 123.42 )
...
float op_operation = decision_tree_0_DDOG_15Min_9cdf3b86(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
