			...
			if( Positive_Money_Flow > 9.73693e+08 )
				if( Negative_Money_Flow_Sum <= 1.34449e+10 )
					...
					if( ad > -1.70016e+07 )
						ret := -0.337838
				if( Negative_Money_Flow_Sum > 1.34449e+10 )
					if( Positive_Money_Flow_Sum <= 1.02469e+10 )
						ret := 0.636364
					if( Positive_Money_Flow_Sum > 1.02469e+10 )
						ret := -0.166667
		if( Typical_Price > 90.5156 )
			if( Negative_Money_Flow_Sum <= 8.77897e+10 )
				if( MFI_High <= -27.6725 )
					if( Typical_Price <= 111.336 )
						ret := -0.600858
					if( Typical_Price > 111.336 )
						ret := -0.111258
				if( MFI_High > -27.6725 )
					if( Positive_Money_Flow_Sum <= 2.54463e+10 )
						ret := 0.168498
					if( Positive_Money_Flow_Sum > 2.54463e+10 )
						ret := -0.113737
			if( Negative_Money_Flow_Sum > 8.77897e+10 )
				if( mf <= -0.09403 )
					ret := 0.000000
				if( mf > -0.09403 )
					if( Negative_Money_Flow <= 9.44293e+09 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow > 9.44293e+09 )
						ret := 0.000000
...
float op_operation = decision_tree_0_BABA_1Day_73d7ceee(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
