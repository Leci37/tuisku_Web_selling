				...
				if( MFI_Low <= 15.5255 )
					...
					if( Negative_Money_Flow_Sum > 2.20101e+08 )
						...
						if( VIM > 1.08465 )
							ret := -0.635135
				if( MFI_Low > 15.5255 )
					if( Negative_Money_Flow_Sum <= 1.44294e+08 )
						if( Positive_Money_Flow_Sum <= 2.4255e+08 )
							ret := 0.128931
						if( Positive_Money_Flow_Sum > 2.4255e+08 )
							ret := -0.137002
					if( Negative_Money_Flow_Sum > 1.44294e+08 )
						if( Money_Flow_Ratio <= 0.64683 )
							ret := -0.343434
						if( Money_Flow_Ratio > 0.64683 )
							ret := 0.327915
			if( Typical_Price > 325.096 )
				ret := -0.412371
		if( Raw_Money_Flow > 8.00594e+06 )
			if( Positive_Money_Flow_Sum <= 4.42168e+07 )
				if( MFI <= 62.5693 )
					ret := 0.444079
				if( MFI > 62.5693 )
					ret := -0.358974
			if( Positive_Money_Flow_Sum > 4.42168e+07 )
				if( Money_Flow_Ratio <= 1.92196 )
					if( Positive_Money_Flow <= 5.7917e+07 )
						ret := -0.196544
					if( Positive_Money_Flow > 5.7917e+07 )
						if( Money_Flow_Ratio <= 1.59954 )
							ret := 0.321285
						if( Money_Flow_Ratio > 1.59954 )
							ret := -0.354430
				if( Money_Flow_Ratio > 1.92196 )
					if( Money_Flow_Ratio <= 5.4028 )
						ret := 0.081694
					if( Money_Flow_Ratio > 5.4028 )
						ret := -0.126253
...
float op_operation = decision_tree_0_UPST_1Hour_f0cc0f4b(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
