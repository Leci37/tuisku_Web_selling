...
decision_tree_0_DOTUSDT_1Day_188e39c9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( Lower_Band > 32.0384 )
		if( basis <= 40.6081 )
			if( Upper_Band <= 47.149 )
				if( bullPower <= 1.71409 )
					ret := -0.857143 // sell
				if( bullPower > 1.71409 )
					ret := -1.000000 // sell
			if( Upper_Band > 47.149 )
...
float op_operation = decision_tree_0_DOTUSDT_1Day_188e39c9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
