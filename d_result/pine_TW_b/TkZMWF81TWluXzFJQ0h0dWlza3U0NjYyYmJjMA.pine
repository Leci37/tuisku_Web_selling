			...
			if( chinkou_span > 317.442 )
				...
				if( senkou_span_a > 322.711 )
					...
					if( senkou_span_b_displaced > 322.042 )
						ret := -0.829897 // sell
		if( chinkou_span > 323.005 )
			if( basis_minus <= 0.637046 )
				if( tenkan_sen <= 732.565 )
					if( chinkou_span <= 691.432 )
						if( senkou_span_a_displaced <= 695.913 )
							ret := 0.021831
						if( senkou_span_a_displaced > 695.913 )
							ret := -0.703518 // sell
					if( chinkou_span > 691.432 )
						if( senkou_span_a <= 692.307 )
							ret := 0.671827
						if( senkou_span_a > 692.307 )
							ret := 0.148280
				if( tenkan_sen > 732.565 )
					ret := -0.897436 // sell
			if( basis_minus > 0.637046 )
				if( kinjun_sen <= 695.351 )
					if( chinkou_span <= 694.55 )
						if( senkou_span_b <= 684.92 )
							ret := -0.033791
						if( senkou_span_b > 684.92 )
							ret := -0.527716
					if( chinkou_span > 694.55 )
						if( senkou_span_b_displaced <= 695.61 )
							ret := 0.660194
						if( senkou_span_b_displaced > 695.61 )
							ret := -0.033333
				if( kinjun_sen > 695.351 )
					if( chinkou_span <= 711.862 )
						if( kinjun_sen <= 698.371 )
							ret := -0.603704
						if( kinjun_sen > 698.371 )
							ret := -0.322137
					if( chinkou_span > 711.862 )
						if( senkou_span_a <= 713.624 )
							ret := 0.583333
						if( senkou_span_a > 713.624 )
							ret := -0.126984
...
float op_operation = decision_tree_0_NFLX_5Min_4662bbc0(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
