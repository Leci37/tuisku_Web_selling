			...
			if( bbm > 10.7032 )
				...
				if( Upper_Band > 1292.64 )
					...
					if( basis > 1479.39 )
						ret := -0.368421
		if( bbm > 26.6134 )
			if( Lower_Band <= 2020.39 )
				if( Upper_Band <= 1219.81 )
					if( bullPower <= 45.0042 )
						ret := -0.133333
					if( bullPower > 45.0042 )
						ret := -0.785714 // sell
				if( Upper_Band > 1219.81 )
					if( Lower_Band <= 1063.24 )
						ret := 0.965517 // buy
					if( Lower_Band > 1063.24 )
						ret := 0.187500
			if( Lower_Band > 2020.39 )
...
float op_operation = decision_tree_0_GOOG_1Day_bf93cf02(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
