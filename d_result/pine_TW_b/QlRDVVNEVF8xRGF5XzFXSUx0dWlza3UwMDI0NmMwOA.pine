			...
			if( midLine <= 8.25028 )
				if( Color_con2 <= -26.8999 )
					...
					if( midLine > 5.5433 )
						ret := 0.851852 // buy
				if( Color_con2 > -26.8999 )
					if( Color_con2 <= -10.8031 )
						ret := -0.391144
					if( Color_con2 > -10.8031 )
						ret := -0.049288
			if( midLine > 8.25028 )
				if( lowerBand <= -6.67477 )
					if( sDev <= 15.9405 )
						ret := 0.000000
					if( sDev > 15.9405 )
						ret := -0.941176 // sell
				if( lowerBand > -6.67477 )
					if( lowerBand <= -3.88888 )
						ret := 0.893130 // buy
					if( lowerBand > -3.88888 )
						ret := 0.257908
		if( midLine > 10.9291 )
			if( midLine <= 16.606 )
				if( upperBand <= 22.5412 )
					if( Color_con2 <= -5.26075 )
						ret := 0.423913
					if( Color_con2 > -5.26075 )
						ret := -0.153846
				if( upperBand > 22.5412 )
					if( Color_con2 <= -16.9788 )
						ret := -0.821429 // sell
					if( Color_con2 > -16.9788 )
						ret := -0.347826
			if( midLine > 16.606 )
				if( midLine <= 24.555 )
					if( Color_con1 <= -43.5123 )
						ret := -0.937500 // sell
					if( Color_con1 > -43.5123 )
						ret := 0.349633
				if( midLine > 24.555 )
					if( lowerBand <= 20.7787 )
						ret := -0.459064
					if( lowerBand > 20.7787 )
						ret := 0.575472
...
float op_operation = decision_tree_0_BTCUSDT_1Day_00246c08(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
