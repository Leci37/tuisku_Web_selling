			...
			if( Negative_Money_Flow_Sum <= 1.49641e+11 )
				...
				if( Money_Flow_Ratio > 0.500767 )
					...
					if( ema12 > -190.426 )
						ret := -0.028097
			if( Negative_Money_Flow_Sum > 1.49641e+11 )
				if( Negative_Money_Flow <= 7.58046e+09 )
					if( Positive_Money_Flow <= 1.35578e+10 )
						ret := -0.666667
					if( Positive_Money_Flow > 1.35578e+10 )
						ret := 0.600000
				if( Negative_Money_Flow > 7.58046e+09 )
...
float op_operation = decision_tree_0_AMZN_1Day_5230845c(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
