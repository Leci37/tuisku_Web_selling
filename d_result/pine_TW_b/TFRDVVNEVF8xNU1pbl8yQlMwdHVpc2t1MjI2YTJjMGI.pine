			...
			if( bbp > -0.219212 )
				if( bbp <= 0.385683 )
					...
					if( rsi1 > 48.1239 )
						ret := 0.157880
				if( bbp > 0.385683 )
					if( bearPower <= 0.211428 )
						ret := -0.144404
					if( bearPower > 0.211428 )
						ret := -0.362628
		if( rsi1 > 66.0111 )
			if( bearPower <= 0.008711 )
...
float op_operation = decision_tree_0_LTCUSDT_15Min_226a2c0b(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
