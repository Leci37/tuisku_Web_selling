...
decision_tree_0_QCOM_1Day_dba031ce(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)=>
	...
	if( Positive_Money_Flow_Sum > 1.0181e+10 )
		...
		if( Positive_Money_Flow_Sum > 1.14483e+10 )
			if( ad <= -4.93312e+06 )
				if( mf <= 0.036736 )
					if( Typical_Price <= 144.04 )
						ret := -0.800000 // sell
					if( Typical_Price > 144.04 )
						ret := -0.047619
				if( mf > 0.036736 )
					if( Negative_Money_Flow <= 1.58055e+09 )
						ret := 0.629032
					if( Negative_Money_Flow > 1.58055e+09 )
						ret := -0.307692
			if( ad > -4.93312e+06 )
				if( Typical_Price <= 193.643 )
					if( mf <= 0.062888 )
						ret := -0.661871
					if( mf > 0.062888 )
						ret := -0.125806
				if( Typical_Price > 193.643 )
					if( Raw_Money_Flow <= 2.17459e+09 )
						ret := 0.885714 // buy
					if( Raw_Money_Flow > 2.17459e+09 )
						ret := -0.545455
...
float op_operation = decision_tree_0_QCOM_1Day_dba031ce(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
