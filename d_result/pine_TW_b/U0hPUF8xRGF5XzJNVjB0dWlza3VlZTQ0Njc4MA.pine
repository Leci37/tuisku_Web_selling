	...
	if( Positive_Money_Flow_Sum > 4.62695e+09 )
		if( Typical_Price <= 678.548 )
			...
			if( VIM > 1.93986 )
				ret := 1.000000 // buy
		if( Typical_Price > 678.548 )
			if( Positive_Money_Flow_Sum <= 1.65163e+10 )
				if( MFI_High <= -32.6612 )
					if( Negative_Money_Flow_Sum <= 2.23257e+10 )
						ret := -0.145161
					if( Negative_Money_Flow_Sum > 2.23257e+10 )
						ret := 0.652174
				if( MFI_High > -32.6612 )
					...
					if( VIM > 0.85772 )
						ret := 0.519608
			if( Positive_Money_Flow_Sum > 1.65163e+10 )
				if( Typical_Price <= 978.391 )
					if( Money_Flow_Ratio <= 1.67402 )
						ret := -0.375000
					if( Money_Flow_Ratio > 1.67402 )
						ret := 0.638889
				if( Typical_Price > 978.391 )
					if( Positive_Money_Flow <= 1.79786e+08 )
						ret := 0.000000
					if( Positive_Money_Flow > 1.79786e+08 )
						ret := -0.588235
...
float op_operation = decision_tree_0_SHOP_1Day_ee446780(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)
