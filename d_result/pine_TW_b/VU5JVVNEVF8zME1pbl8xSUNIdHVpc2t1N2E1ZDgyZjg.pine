				...
				if( senkou_span_b_displaced <= 7.2306 )
					if( basis_max <= 0.03987 )
						...
						if( chinkou_span > 6.05238 )
							ret := -0.440200
					if( basis_max > 0.03987 )
						if( senkou_span_b_displaced <= 5.9775 )
							ret := 0.543478
						if( senkou_span_b_displaced > 5.9775 )
							ret := -0.273585
				if( senkou_span_b_displaced > 7.2306 )
					ret := 0.672727
		if( chinkou_span > 6.36543 )
			if( kinjun_sen <= 6.51497 )
				if( tenkan_sen <= 6.299 )
					ret := 0.549898
				if( tenkan_sen > 6.299 )
					if( chinkou_span <= 6.50807 )
						ret := -0.012380
					if( chinkou_span > 6.50807 )
						if( senkou_span_b_displaced <= 6.21577 )
							ret := -0.118919
						if( senkou_span_b_displaced > 6.21577 )
							ret := 0.460335
			if( kinjun_sen > 6.51497 )
				if( chinkou_span <= 6.66166 )
					if( tenkan_sen <= 6.80685 )
						if( tenkan_sen <= 6.58278 )
							ret := 0.054859
						if( tenkan_sen > 6.58278 )
							ret := -0.250743
					if( tenkan_sen > 6.80685 )
						ret := -0.603139
				if( chinkou_span > 6.66166 )
					if( tenkan_sen <= 7.08851 )
						if( chinkou_span <= 7.12027 )
							ret := 0.100811
						if( chinkou_span > 7.12027 )
							ret := 0.592262
					if( tenkan_sen > 7.08851 )
						if( chinkou_span <= 7.18835 )
							ret := -0.452196
						if( chinkou_span > 7.18835 )
							ret := -0.010396
...
float op_operation = decision_tree_0_UNIUSDT_30Min_7a5d82f8(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
