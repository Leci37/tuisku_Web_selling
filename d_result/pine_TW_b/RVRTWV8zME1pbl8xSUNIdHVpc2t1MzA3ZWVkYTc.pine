				...
				if( chinkou_span <= 210.456 )
					...
					if( senkou_span_a > 203.433 )
						...
						if( tenkan_sen > 208.947 )
							ret := -0.484787
				if( chinkou_span > 210.456 )
					if( kinjun_sen <= 207.464 )
						if( kinjun_sen <= 200.085 )
							ret := 0.142857
						if( kinjun_sen > 200.085 )
							ret := 0.787375 // buy
					if( kinjun_sen > 207.464 )
						if( senkou_span_b_displaced <= 198.488 )
							ret := -1.000000 // sell
						if( senkou_span_b_displaced > 198.488 )
							ret := 0.235945
	if( senkou_span_b > 218.89 )
		if( chinkou_span <= 210.979 )
			if( senkou_span_b_displaced <= 235.126 )
				ret := -0.848837 // sell
			if( senkou_span_b_displaced > 235.126 )
				ret := 0.200000
		if( chinkou_span > 210.979 )
			if( kinjun_sen <= 294.373 )
				if( senkou_span_b_displaced <= 218.46 )
					if( senkou_span_a_displaced <= 218.127 )
						if( senkou_span_b_displaced <= 217.68 )
							ret := 0.147059
						if( senkou_span_b_displaced > 217.68 )
							ret := -1.000000 // sell
					if( senkou_span_a_displaced > 218.127 )
						ret := -0.609890
				if( senkou_span_b_displaced > 218.46 )
					if( chinkou_span <= 269.71 )
						if( senkou_span_a_displaced <= 236.522 )
							ret := 0.030457
						if( senkou_span_a_displaced > 236.522 )
							ret := -0.445926
					if( chinkou_span > 269.71 )
...
float op_operation = decision_tree_0_ETSY_30Min_307eeda7(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
