...
decision_tree_0_ADBE_1Hour_87184ab4(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)=>
	...
	if( bearPower > -3.41016 )
		...
		if( Lower_Band > 234.599 )
			if( basis <= 620.444 )
				if( Lower_Band <= 245.526 )
					if( bearPower <= -2.48901 )
						if( bullPower <= 2.48001 )
							ret := 0.723077 // buy
						if( bullPower > 2.48001 )
							ret := -0.750000 // sell
					if( bearPower > -2.48901 )
						if( Upper_Band <= 246.948 )
							ret := 0.170886
						if( Upper_Band > 246.948 )
							ret := -0.535326
				if( Lower_Band > 245.526 )
					if( bullPower <= 6.64895 )
						if( Upper_Band <= 611.713 )
							ret := 0.044655
						if( Upper_Band > 611.713 )
							ret := 0.335312
					if( bullPower > 6.64895 )
						if( Upper_Band <= 327.583 )
							ret := 0.311111
						if( Upper_Band > 327.583 )
							ret := -0.109460
			if( basis > 620.444 )
				if( Upper_Band <= 656.533 )
					if( Upper_Band <= 651.858 )
						if( Upper_Band <= 638.609 )
							ret := -0.423729
						if( Upper_Band > 638.609 )
							ret := 0.212766
					if( Upper_Band > 651.858 )
...
float op_operation = decision_tree_0_ADBE_1Hour_87184ab4(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
