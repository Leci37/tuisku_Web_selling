	...
	if( basis_max > 0.663689 )
		if( basis_max <= 1.44875 )
			if( chinkou_span <= 34.5408 )
				if( basis_minus <= -3.30625 )
					if( basis_max <= 0.812786 )
						ret := 1.000000 // buy
					if( basis_max > 0.812786 )
						ret := 0.090909
				if( basis_minus > -3.30625 )
					if( basis_max <= 0.810591 )
						ret := -0.653846
					if( basis_max > 0.810591 )
						ret := -0.966942 // sell
			if( chinkou_span > 34.5408 )
				if( senkou_span_b <= 46.0522 )
					if( senkou_span_a_displaced <= 35.7437 )
						ret := -0.526316
					if( senkou_span_a_displaced > 35.7437 )
						ret := 0.241379
				if( senkou_span_b > 46.0522 )
		...
		if( basis_max > 1.44875 )
			if( basis_max <= 2.392 )
				ret := 1.000000 // buy
			if( basis_max > 2.392 )
				if( chinkou_span <= 17.7768 )
					if( tenkan_sen <= 13.4512 )
						ret := 0.000000
					if( tenkan_sen > 13.4512 )
						ret := 1.000000 // buy
				if( chinkou_span > 17.7768 )
					if( senkou_span_b_displaced <= 30.2925 )
						ret := -1.000000 // sell
					if( senkou_span_b_displaced > 30.2925 )
						ret := -0.333333
...
float op_operation = decision_tree_0_NVST_1Day_be0c0b15(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
