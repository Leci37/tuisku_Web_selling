			...
			if( VIP_VIM <= -0.016095 )
				...
				if( k > 91.3221 )
					...
					if( VIP_VIM > -0.028222 )
						ret := 0.142857
			if( VIP_VIM > -0.016095 )
				if( smoothD_d <= 78.1171 )
					if( smoothD_d <= 70.7732 )
						ret := 0.168142
					if( smoothD_d > 70.7732 )
						ret := 0.690323
				if( smoothD_d > 78.1171 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_a7dd65af(smoothK_k, d_k, k, smoothD_d, rsi1, d, VIP_VIM, VIP, VIM)
