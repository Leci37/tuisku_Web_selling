			...
			if( ad <= -2.57251e+06 )
				...
				if( ad > -2.98509e+06 )
					...
					if( ad > -2.65273e+06 )
						ret := 0.000000
			if( ad > -2.57251e+06 )
				if( bullPower <= 0.612681 )
					if( bearPower <= 0.053958 )
						ret := -0.625000
					if( bearPower > 0.053958 )
						ret := 0.196721
				if( bullPower > 0.612681 )
...
float op_operation = decision_tree_0_DBX_1Day_ea2f03de(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
