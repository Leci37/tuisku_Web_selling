			...
			if( bbm > 5.03022 )
				if( rsi1 <= 38.8008 )
					...
					if( rsi1 > 33.0071 )
						ret := -0.777778 // sell
				if( rsi1 > 38.8008 )
					if( smoothK_k <= 18.4229 )
						ret := -0.238636
					if( smoothK_k > 18.4229 )
						ret := 0.150990
		if( smoothK_k > 80.2185 )
			if( bearPower <= 0.387295 )
				if( d <= 91.2801 )
					if( bearPower <= -0.89469 )
						ret := 0.514706
					if( bearPower > -0.89469 )
						ret := -0.255319
				if( d > 91.2801 )
...
float op_operation = decision_tree_0_ADSK_1Day_908bf5af(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
