...
decision_tree_0_UPST_30Min_24885cd9(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)=>
	...
	if( media > 47.4942 )
		if( pvi <= 1.11153 )
			if( nvim <= 0.168209 )
				if( azul_mean <= 30.6977 )
					if( stoc <= 91.8296 )
						if( verde_azul <= 28.606 )
							ret := -0.520000
						if( verde_azul > 28.606 )
							ret := 0.668845
					if( stoc > 91.8296 )
...
float op_operation = decision_tree_0_UPST_30Min_24885cd9(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
