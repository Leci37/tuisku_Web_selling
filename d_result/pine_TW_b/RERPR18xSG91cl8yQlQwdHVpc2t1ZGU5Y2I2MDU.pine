	...
	if( bbp > 1.26706 )
		...
		if( ema2 > 162.217 )
			if( ema13 <= 1.29694 )
				if( bbm <= 1.38407 )
					if( ema13 <= 0.136247 )
						if( bullPower <= 1.18467 )
							ret := -0.461538
						if( bullPower > 1.18467 )
							ret := -0.700000 // sell
					if( ema13 > 0.136247 )
						if( bullPower <= 0.878569 )
							ret := -0.714286 // sell
						if( bullPower > 0.878569 )
							ret := -0.950820 // sell
				if( bbm > 1.38407 )
...
float op_operation = decision_tree_0_DDOG_1Hour_de9cb605(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
