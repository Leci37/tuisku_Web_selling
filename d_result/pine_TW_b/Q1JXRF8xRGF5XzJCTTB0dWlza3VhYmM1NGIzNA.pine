			...
			if( Positive_Money_Flow_Sum > 2.12873e+09 )
				if( bbm <= 5.67472 )
					...
					if( Positive_Money_Flow_Sum > 4.05206e+09 )
						ret := -0.053279
				if( bbm > 5.67472 )
					if( Negative_Money_Flow_Sum <= 4.24909e+09 )
						ret := -0.334152
					if( Negative_Money_Flow_Sum > 4.24909e+09 )
						ret := 0.032000
...
float op_operation = decision_tree_0_CRWD_1Day_abc54b34(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
