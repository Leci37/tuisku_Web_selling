...
decision_tree_0_BABA_1Day_3f4b4a6b(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)=>
	...
	if( midLine > 13.4652 )
		if( wvf <= 17.9911 )
			...
			if( sDev > 8.86586 )
				if( sDev <= 10.3258 )
					if( Color_con1 <= -16.8762 )
						ret := 0.407407
					if( Color_con1 > -16.8762 )
						ret := 0.833333 // buy
				if( sDev > 10.3258 )
					if( Color_con2 <= -19.6746 )
						ret := 0.741935 // buy
					if( Color_con2 > -19.6746 )
						ret := -0.207921
		if( wvf > 17.9911 )
			if( midLine <= 22.8166 )
				if( lowerBand <= 7.19791 )
					if( Color_con2 <= 2.40359 )
						ret := 0.966667 // buy
					if( Color_con2 > 2.40359 )
						ret := 0.720588 // buy
				if( lowerBand > 7.19791 )
...
float op_operation = decision_tree_0_BABA_1Day_3f4b4a6b(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
