			...
			if( adx <= 17.0521 )
				if( directionalMovementMinus <= 0.007652 )
					...
					if( diMinus > 19.091 )
						ret := 1.000000 // buy
				if( directionalMovementMinus > 0.007652 )
					if( directionalMovementPlus <= 0.000377 )
						ret := 0.185124
					if( directionalMovementPlus > 0.000377 )
						ret := 0.584158
			if( adx > 17.0521 )
				if( directionalMovementPlus <= 0.17168 )
					if( smoothedDirectionalMovementMinus <= 0.079566 )
						ret := 0.066728
					if( smoothedDirectionalMovementMinus > 0.079566 )
						ret := 0.222333
				if( directionalMovementPlus > 0.17168 )
					if( smoothedDirectionalMovementPlus <= 0.071922 )
						ret := -0.730769 // sell
					if( smoothedDirectionalMovementPlus > 0.071922 )
						ret := 0.026022
		if( dx > 38.6344 )
			if( smoothedDirectionalMovementPlus <= 0.25 )
				if( diPlus <= 41.0543 )
					if( diMinus <= 45.8969 )
						ret := -0.018467
					if( diMinus > 45.8969 )
...
float op_operation = decision_tree_0_ASAN_1Hour_0f41e5ac(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)
