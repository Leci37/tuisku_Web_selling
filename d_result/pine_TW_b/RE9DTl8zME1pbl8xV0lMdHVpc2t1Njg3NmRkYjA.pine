				...
				if( midLine <= 4.13992 )
					...
					if( sDev > 2.8808 )
						...
						if( midLine > 3.86877 )
							ret := -0.167910
				if( midLine > 4.13992 )
					if( lowerBand <= -0.520059 )
						if( Color_con2 <= 10.9095 )
							ret := -0.120898
						if( Color_con2 > 10.9095 )
							ret := -1.000000 // sell
					if( lowerBand > -0.520059 )
						if( Color_con2 <= 3.79721 )
							ret := 0.139938
						if( Color_con2 > 3.79721 )
							ret := 0.746154 // buy
		if( lowerBand > 4.03029 )
			if( Color_con2 <= 1.7706 )
				if( sDev <= 2.25452 )
					if( sDev <= 1.50991 )
						ret := 0.119048
					if( sDev > 1.50991 )
						ret := -0.752632 // sell
				if( sDev > 2.25452 )
					if( upperBand <= 10.7989 )
						if( lowerBand <= 5.29213 )
							ret := 0.363057
						if( lowerBand > 5.29213 )
							ret := -0.571429
					if( upperBand > 10.7989 )
...
float op_operation = decision_tree_0_DOCN_30Min_6876ddb0(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
