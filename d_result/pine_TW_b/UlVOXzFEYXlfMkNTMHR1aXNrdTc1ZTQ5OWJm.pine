			...
			if( rsi1 > 23.3227 )
				...
				if( d > 91.955 )
					...
					if( k > 93.1 )
						ret := 0.190476
	if( rsi1 > 55.9799 )
		if( ad_mf <= -4.00391e+06 )
			if( mf <= 0.045141 )
				if( smoothK_k <= 72.5914 )
					if( d_k <= 13.0221 )
						ret := -0.805556 // sell
					if( d_k > 13.0221 )
						ret := 0.333333
...
float op_operation = decision_tree_0_RUN_1Day_75e499bf(mf, ad, ad_mf, d_k, d, rsi1, k, smoothD_d, smoothK_k)
