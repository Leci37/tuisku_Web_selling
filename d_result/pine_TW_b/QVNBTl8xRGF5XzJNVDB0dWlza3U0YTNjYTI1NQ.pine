...
decision_tree_0_ASAN_1Day_4a3ca255(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)=>
	...
	if( Money_Flow_Ratio > 1.02217 )
			...
			if( ema3 <= 18.6133 )
				...
				if( Positive_Money_Flow_Sum > 2.80835e+08 )
					...
					if( ema12 > -0.031434 )
						ret := 0.381818
			if( ema3 > 18.6133 )
				if( Negative_Money_Flow <= 2.4942e+08 )
					if( Typical_Price <= 75.5483 )
						ret := -0.556818
					if( Typical_Price > 75.5483 )
						ret := 0.523810
				if( Negative_Money_Flow > 2.4942e+08 )
		...
		if( Money_Flow_Ratio > 1.98887 )
			if( tema <= 41.6735 )
				if( ema3 <= 19.4339 )
					if( Negative_Money_Flow_Sum <= 1.5747e+08 )
						ret := 0.045455
					if( Negative_Money_Flow_Sum > 1.5747e+08 )
						ret := 0.577778
				if( ema3 > 19.4339 )
					...
					if( ema1 > 24.0857 )
						ret := -0.012987
			if( tema > 41.6735 )
				if( Positive_Money_Flow_Sum <= 2.6326e+09 )
					if( Raw_Money_Flow <= 1.10054e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 1.10054e+08 )
						ret := 0.973684 // buy
				if( Positive_Money_Flow_Sum > 2.6326e+09 )
					if( Negative_Money_Flow_Sum <= 1.22936e+09 )
						ret := 0.416667
					if( Negative_Money_Flow_Sum > 1.22936e+09 )
						ret := -0.750000 // sell
...
float op_operation = decision_tree_0_ASAN_1Day_4a3ca255(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
