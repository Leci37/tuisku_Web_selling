			...
			if( VIM > 1.12847 )
				...
				if( Typical_Price > 3.58167 )
					...
					if( Raw_Money_Flow > 1.05169e+08 )
						ret := 0.000000
		if( Negative_Money_Flow_Sum > 6.32368e+08 )
			if( Typical_Price <= 9.8129 )
				if( Raw_Money_Flow <= 6.57491e+07 )
					if( Positive_Money_Flow_Sum <= 4.0201e+08 )
						ret := -0.714286 // sell
					if( Positive_Money_Flow_Sum > 4.0201e+08 )
						ret := 0.222222
				if( Raw_Money_Flow > 6.57491e+07 )
					if( Positive_Money_Flow_Sum <= 1.04588e+09 )
						ret := 0.658163
					if( Positive_Money_Flow_Sum > 1.04588e+09 )
						ret := -0.272727
			if( Typical_Price > 9.8129 )
				if( Typical_Price <= 18.282 )
					if( Negative_Money_Flow_Sum <= 2.51256e+09 )
						ret := -0.563830
					if( Negative_Money_Flow_Sum > 2.51256e+09 )
						ret := 0.538462
				if( Typical_Price > 18.282 )
					if( Negative_Money_Flow_Sum <= 1.56783e+10 )
						ret := -0.027375
					if( Negative_Money_Flow_Sum > 1.56783e+10 )
						ret := 0.660714
...
float op_operation = decision_tree_0_PTON_1Day_598c5210(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
