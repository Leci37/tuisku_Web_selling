		...
		if( bbp <= 1.18156 )
			if( Upper_Band <= 77.1578 )
				if( Lower_Band <= 60.4081 )
					if( Upper_Band <= 38.9109 )
						ret := 0.910714 // buy
					if( Upper_Band > 38.9109 )
						ret := 0.246548
				if( Lower_Band > 60.4081 )
					if( bearPower <= -0.373608 )
						ret := 0.655172
					if( bearPower > -0.373608 )
						ret := 0.971429 // buy
			if( Upper_Band > 77.1578 )
				...
				if( basis > 280.588 )
					...
					if( bbp > -5.62042 )
						ret := -0.950000 // sell
		if( bbp > 1.18156 )
			if( Lower_Band <= 83.2886 )
				if( basis <= 79.45 )
					if( Upper_Band <= 81.2802 )
						ret := -0.216535
					if( Upper_Band > 81.2802 )
						ret := 0.483333
				if( basis > 79.45 )
...
float op_operation = decision_tree_0_PYPL_1Day_6ec43255(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
