			...
			if( VIM <= 1.20679 )
				if( bearPower <= -3.04142 )
					...
					if( bbp > -7.20554 )
						ret := 0.350515
				if( bearPower > -3.04142 )
					if( bearPower <= 1.10179 )
						ret := -0.259912
					if( bearPower > 1.10179 )
						ret := 0.014634
			if( VIM > 1.20679 )
				if( VIP_VIM <= -0.63252 )
					if( bullPower <= -6.15612 )
						ret := 0.000000
					if( bullPower > -6.15612 )
						ret := 1.000000 // buy
				if( VIP_VIM > -0.63252 )
					if( bullPower <= -1.34068 )
						ret := -0.745614 // sell
					if( bullPower > -1.34068 )
						ret := -0.028571
...
float op_operation = decision_tree_0_LYFT_1Day_edd3feea(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
