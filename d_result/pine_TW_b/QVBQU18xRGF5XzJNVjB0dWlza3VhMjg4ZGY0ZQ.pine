			...
			if( Negative_Money_Flow <= 8.12324e+06 )
				if( Positive_Money_Flow <= 2.79918e+07 )
					...
					if( VIP > 0.884089 )
						ret := 0.103448
				if( Positive_Money_Flow > 2.79918e+07 )
					if( Money_Flow_Ratio <= 3.04298 )
						ret := -0.500000
					if( Money_Flow_Ratio > 3.04298 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow > 8.12324e+06 )
				if( Negative_Money_Flow_Sum <= 8.32722e+07 )
					if( Raw_Money_Flow <= 1.98776e+07 )
						ret := -0.724638 // sell
					if( Raw_Money_Flow > 1.98776e+07 )
						ret := 0.083333
				if( Negative_Money_Flow_Sum > 8.32722e+07 )
					ret := -0.942308 // sell
		if( Negative_Money_Flow_Sum > 9.93079e+07 )
			if( Typical_Price <= 63.0993 )
				if( Raw_Money_Flow <= 1.22322e+08 )
					if( Typical_Price <= 16.6362 )
						ret := 0.159923
					if( Typical_Price > 16.6362 )
						ret := -0.337264
				if( Raw_Money_Flow > 1.22322e+08 )
					if( Negative_Money_Flow_Sum <= 8.84974e+08 )
						ret := -0.182796
					if( Negative_Money_Flow_Sum > 8.84974e+08 )
						ret := 0.500000
			if( Typical_Price > 63.0993 )
				if( Positive_Money_Flow_Sum <= 2.5428e+09 )
					if( Negative_Money_Flow <= 2.8937e+08 )
						ret := -0.621951
					if( Negative_Money_Flow > 2.8937e+08 )
						ret := 0.428571
				if( Positive_Money_Flow_Sum > 2.5428e+09 )
					if( Negative_Money_Flow_Sum <= 1.10101e+09 )
						ret := -0.578947
					if( Negative_Money_Flow_Sum > 1.10101e+09 )
						ret := 0.581395
...
float op_operation = decision_tree_0_APPS_1Day_a288df4e(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
