		...
		if( basis_minus > -1.35539 )
			...
			if( chinkou_span > 39.9923 )
				...
				if( tenkan_sen > 39.3915 )
					ret := 0.288673
	if( kinjun_sen > 40.6107 )
		if( chinkou_span <= 41.8883 )
			if( chinkou_span <= 39.215 )
				ret := -0.606061
			if( chinkou_span > 39.215 )
				if( tenkan_sen <= 40.6966 )
					ret := 0.182857
				if( tenkan_sen > 40.6966 )
					if( tenkan_sen <= 42.0326 )
						if( basis_max <= 0.316262 )
							ret := -0.281292
						if( basis_max > 0.316262 )
							ret := 0.237037
					if( tenkan_sen > 42.0326 )
						ret := -0.513419
		if( chinkou_span > 41.8883 )
			if( tenkan_sen <= 43.8937 )
				if( chinkou_span <= 43.1604 )
					if( tenkan_sen <= 42.2561 )
						ret := 0.330049
					if( tenkan_sen > 42.2561 )
						ret := -0.259446
				if( chinkou_span > 43.1604 )
					if( kinjun_sen <= 42.7499 )
						ret := 0.673563
					if( kinjun_sen > 42.7499 )
						if( chinkou_span <= 44.998 )
							ret := 0.209226
						if( chinkou_span > 44.998 )
							ret := 0.728324 // buy
			if( tenkan_sen > 43.8937 )
				if( chinkou_span <= 43.9189 )
					ret := -0.431498
				if( chinkou_span > 43.9189 )
					if( chinkou_span <= 129.163 )
						if( tenkan_sen <= 117.224 )
							ret := -0.020107
						if( tenkan_sen > 117.224 )
							ret := -0.371941
					if( chinkou_span > 129.163 )
...
float op_operation = decision_tree_0_RBLX_30Min_473ea652(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
