				...
				if( lower_5 <= 23.067 )
					...
					if( lower_5 > 22.1506 )
						...
						if( lower_2 > 24.0135 )
							ret := 0.299331
				if( lower_5 > 23.067 )
					if( basis_max <= -25.4116 )
						if( lower_3 <= 49.6432 )
							ret := 0.000000
						if( lower_3 > 49.6432 )
							ret := 0.975610 // buy
					if( basis_max > -25.4116 )
						if( basis_minus <= 1.03139 )
							ret := 0.274232
						if( basis_minus > 1.03139 )
							ret := 0.021450
...
float op_operation = decision_tree_0_PINS_30Min_423f50c9(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
