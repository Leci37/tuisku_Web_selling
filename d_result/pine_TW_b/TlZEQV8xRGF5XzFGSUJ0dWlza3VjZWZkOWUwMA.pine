...
decision_tree_0_NVDA_1Day_cefd9e00(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( lower_1 > 147.933 )
		...
		if( lower_3 > 28.774 )
			...
			if( upper_4 > 325.979 )
				if( lower_3 <= 337.955 )
					if( basis_minus <= 299.842 )
						ret := 0.490323
					if( basis_minus > 299.842 )
						ret := 0.039578
				if( lower_3 > 337.955 )
					if( basis_max <= -183.875 )
						ret := -0.666667
					if( basis_max > -183.875 )
						ret := 0.365854
...
float op_operation = decision_tree_0_NVDA_1Day_cefd9e00(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
