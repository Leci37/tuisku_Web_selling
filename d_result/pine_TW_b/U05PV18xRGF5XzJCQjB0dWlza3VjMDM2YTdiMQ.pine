			...
			if( basis > 218.718 )
				if( basis <= 225.585 )
					...
					if( basis > 220.36 )
						ret := -1.000000 // sell
				if( basis > 225.585 )
					if( Lower_Band <= 215.659 )
						ret := -0.100000
					if( Lower_Band > 215.659 )
						ret := -0.909091 // sell
		if( Upper_Band > 250.466 )
			if( Upper_Band <= 316.241 )
				if( Lower_Band <= 219.042 )
					if( basis <= 249.106 )
						ret := 0.368421
					if( basis > 249.106 )
						ret := -0.923077 // sell
				if( Lower_Band > 219.042 )
					if( bearPower <= -7.14856 )
						ret := 0.882353 // buy
					if( bearPower > -7.14856 )
						ret := 0.427184
			if( Upper_Band > 316.241 )
				if( bearPower <= -28.948 )
					if( Upper_Band <= 384.334 )
						ret := 0.057692
					if( Upper_Band > 384.334 )
						ret := 0.800000 // buy
				if( bearPower > -28.948 )
...
float op_operation = decision_tree_0_SNOW_1Day_c036a7b1(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
