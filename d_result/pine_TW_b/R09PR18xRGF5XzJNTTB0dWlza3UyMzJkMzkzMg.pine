	...
	if( MFI_High > -17.6975 )
		if( Typical_Price <= 103.359 )
			...
			if( Positive_Money_Flow_Sum > 3.72668e+10 )
				ret := 0.500000
		if( Typical_Price > 103.359 )
			if( Raw_Money_Flow <= 1.54936e+09 )
				if( Positive_Money_Flow_Sum <= 1.0632e+10 )
					if( Money_Flow_Ratio <= 1.96561 )
						ret := 0.230769
					if( Money_Flow_Ratio > 1.96561 )
						ret := 0.916667 // buy
				if( Positive_Money_Flow_Sum > 1.0632e+10 )
					if( Short_Long_Diff <= 12.1038 )
						ret := -0.243243
					if( Short_Long_Diff > 12.1038 )
						ret := 0.070175
			if( Raw_Money_Flow > 1.54936e+09 )
				if( Positive_Money_Flow_Sum <= 2.45877e+10 )
					if( Positive_Money_Flow_Sum <= 1.35576e+10 )
						ret := 0.210526
					if( Positive_Money_Flow_Sum > 1.35576e+10 )
						ret := -0.615741
				if( Positive_Money_Flow_Sum > 2.45877e+10 )
					if( Positive_Money_Flow_Sum <= 3.01819e+10 )
						ret := 0.150000
					if( Positive_Money_Flow_Sum > 3.01819e+10 )
						ret := -0.365759
...
float op_operation = decision_tree_0_GOOG_1Day_232d3932(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
