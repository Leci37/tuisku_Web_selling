	...
	if( ad_mf > -8.85485e+06 )
		if( MFI <= 30.9484 )
			if( mf <= -0.234355 )
				ret := 1.000000 // buy
			if( mf > -0.234355 )
				if( ad_mf <= -2.31269e+06 )
					if( MFI_Low <= 7.69194 )
						ret := -0.769231 // sell
					if( MFI_Low > 7.69194 )
						ret := 0.545455
				if( ad_mf > -2.31269e+06 )
					if( Typical_Price <= 159.238 )
						ret := -0.448276
					if( Typical_Price > 159.238 )
						ret := -0.859155 // sell
		if( MFI > 30.9484 )
			if( Money_Flow_Ratio <= 0.797097 )
				if( mf <= 0.005625 )
					if( Typical_Price <= 362.068 )
						ret := -0.106227
					if( Typical_Price > 362.068 )
						ret := 0.687500
				if( mf > 0.005625 )
			...
			if( Money_Flow_Ratio > 0.797097 )
				if( MFI_Low <= 48.2024 )
					if( Money_Flow_Ratio <= 0.992243 )
						ret := -0.002740
					if( Money_Flow_Ratio > 0.992243 )
						ret := -0.205617
				if( MFI_Low > 48.2024 )
					if( Positive_Money_Flow_Sum <= 7.86389e+10 )
						ret := 0.323899
					if( Positive_Money_Flow_Sum > 7.86389e+10 )
						ret := -0.597015
...
float op_operation = decision_tree_0_META_1Day_751ead36(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
