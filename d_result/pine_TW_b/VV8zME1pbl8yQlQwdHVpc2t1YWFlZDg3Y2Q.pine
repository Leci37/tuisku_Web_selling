				...
				if( bbp > 1.70362 )
					if( ema1 <= 155.078 )
						...
						if( ema3 > 152.467 )
							ret := -0.875000 // sell
					if( ema1 > 155.078 )
						if( bullPower <= 1.43334 )
							ret := -0.444444
						if( bullPower > 1.43334 )
							ret := 0.857143 // buy
			if( ema2 > 167.201 )
				if( ema1 <= 194.742 )
					if( bearPower <= 0.837753 )
						if( tema <= 182.754 )
							ret := -0.075710
						if( tema > 182.754 )
							ret := 0.425000
...
float op_operation = decision_tree_0_U_30Min_aaed87cd(bbp, bullPower, BBPower_Color, bearPower, bbm, ema2, ema1, ema12, ema3, ema13, tema)
