			...
			if( upperKC <= 1222.69 )
				if( dev <= 36.6716 )
					...
					if( dev > 33.5328 )
						ret := 0.636364
				if( dev > 36.6716 )
					if( priceRange <= 8.45694 )
						if( val <= 1.55391 )
							ret := -0.428571
						if( val > 1.55391 )
							ret := -0.884615 // sell
					if( priceRange > 8.45694 )
						if( priceRange <= 20.4283 )
							ret := -0.984375 // sell
						if( priceRange > 20.4283 )
							ret := -0.812500 // sell
			if( upperKC > 1222.69 )
				if( lowerKC <= 1174.01 )
					...
					if( upperKC > 1227.11 )
						ret := 1.000000 // buy
				if( lowerKC > 1174.01 )
					if( priceRange <= 53.901 )
						if( ma <= 1599.07 )
							ret := -0.000319
						if( ma > 1599.07 )
							ret := -0.157107
					if( priceRange > 53.901 )
						if( avgHighLow <= 1456.51 )
							ret := -0.315789
						if( avgHighLow > 1456.51 )
							ret := 0.650000
...
float op_operation = decision_tree_0_MELI_1Hour_89c97621(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
