			...
			if( lower_4 > 339.125 )
				if( upper_3 <= 923.176 )
					...
					if( upper_6 > 962.726 )
						ret := 0.618123
				if( upper_3 > 923.176 )
					if( basis_max <= -366.227 )
						ret := 0.456731
					if( basis_max > -366.227 )
						ret := -0.036359
		if( basis_minus > 376.604 )
			if( upper_1 <= 1384.52 )
				if( basis_max <= -376.838 )
					ret := -0.923077 // sell
				if( basis_max > -376.838 )
					ret := 0.000000
			if( upper_1 > 1384.52 )
				if( upper_5 <= 1633.64 )
					if( basis_minus <= 391.463 )
						ret := 0.653846
					if( basis_minus > 391.463 )
						ret := -1.000000 // sell
				if( upper_5 > 1633.64 )
...
float op_operation = decision_tree_0_MELI_30Min_6b5ee418(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
