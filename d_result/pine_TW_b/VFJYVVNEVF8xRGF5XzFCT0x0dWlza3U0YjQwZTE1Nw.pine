			...
			if( BBupper <= 0.134894 )
				...
				if( BBupper > 0.113713 )
					...
					if( BBupper > 0.115836 )
						ret := -0.069930
			if( BBupper > 0.134894 )
				if( dif_source_BBlower <= 0.055632 )
					ret := 1.000000 // buy
				if( dif_source_BBlower > 0.055632 )
					if( dif_source_BBlower <= 0.061633 )
						ret := 0.160000
					if( dif_source_BBlower > 0.061633 )
						ret := 0.636364
		if( dif_source_BBupper > -0.034982 )
			if( dif_source_BBlower <= 0.050662 )
				if( BBlower <= 0.05382 )
					if( vrsi <= 10.9628 )
						ret := 0.469388
					if( vrsi > 10.9628 )
						ret := -0.197026
				if( BBlower > 0.05382 )
					if( dif_source_BBlower <= 0.031918 )
						ret := 0.080972
					if( dif_source_BBlower > 0.031918 )
						ret := -0.063291
			if( dif_source_BBlower > 0.050662 )
				if( vrsi <= 53.5832 )
					if( dif_source_BBupper <= -0.015158 )
						ret := -0.926829 // sell
					if( dif_source_BBupper > -0.015158 )
						ret := -0.432432
				if( vrsi > 53.5832 )
...
float op_operation = decision_tree_0_TRXUSDT_1Day_4b40e157(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
