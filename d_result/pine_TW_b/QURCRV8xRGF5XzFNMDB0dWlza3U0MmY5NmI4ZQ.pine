		...
		if( Positive_Money_Flow_Sum <= 1.11544e+10 )
			if( Typical_Price <= 606.159 )
				if( Typical_Price <= 561.766 )
					if( Positive_Money_Flow_Sum <= 9.43191e+09 )
						ret := -0.198238
					if( Positive_Money_Flow_Sum > 9.43191e+09 )
						ret := 0.447368
				if( Typical_Price > 561.766 )
					if( Negative_Money_Flow <= 1.51915e+09 )
						ret := 0.944444 // buy
					if( Negative_Money_Flow > 1.51915e+09 )
						ret := 0.307692
			if( Typical_Price > 606.159 )
				ret := -1.000000 // sell
		if( Positive_Money_Flow_Sum > 1.11544e+10 )
			if( Negative_Money_Flow <= 1.71078e+09 )
				if( MFI_High <= -26.2238 )
					if( Raw_Money_Flow <= 9.84995e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 9.84995e+08 )
						ret := -0.881579 // sell
				if( MFI_High > -26.2238 )
					if( Negative_Money_Flow_Sum <= 1.37828e+10 )
						ret := -0.833333 // sell
					if( Negative_Money_Flow_Sum > 1.37828e+10 )
						ret := 0.300000
			if( Negative_Money_Flow > 1.71078e+09 )
				if( Positive_Money_Flow_Sum <= 1.49352e+10 )
					if( Negative_Money_Flow_Sum <= 2.22392e+10 )
						ret := 0.733333 // buy
					if( Negative_Money_Flow_Sum > 2.22392e+10 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 1.49352e+10 )
					if( Raw_Money_Flow <= 2.36396e+09 )
						ret := 0.000000
					if( Raw_Money_Flow > 2.36396e+09 )
						ret := -0.947368 // sell
...
float op_operation = decision_tree_0_ADBE_1Day_42f96b8e(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
