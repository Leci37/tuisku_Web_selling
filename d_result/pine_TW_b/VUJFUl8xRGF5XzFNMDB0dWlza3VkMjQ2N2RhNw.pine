			...
			if( Positive_Money_Flow_Sum > 5.09853e+09 )
				...
				if( MFI_Low > 35.9274 )
					...
					if( Negative_Money_Flow_Sum > 5.0451e+09 )
						ret := 0.684211
	if( Typical_Price > 30.9208 )
		if( Positive_Money_Flow_Sum <= 4.08485e+09 )
			if( Money_Flow_Ratio <= 0.227277 )
				ret := 1.000000 // buy
			if( Money_Flow_Ratio > 0.227277 )
				if( Positive_Money_Flow_Sum <= 1.80716e+09 )
					if( Negative_Money_Flow <= 2.13819e+08 )
						ret := 0.333333
					if( Negative_Money_Flow > 2.13819e+08 )
						ret := -0.500000
				if( Positive_Money_Flow_Sum > 1.80716e+09 )
					if( Money_Flow_Ratio <= 1.19049 )
						ret := -0.420382
					if( Money_Flow_Ratio > 1.19049 )
						ret := -0.763158 // sell
		if( Positive_Money_Flow_Sum > 4.08485e+09 )
			if( Positive_Money_Flow_Sum <= 6.72912e+09 )
				if( Money_Flow_Ratio <= 3.31024 )
					if( MFI <= 61.0507 )
						ret := 0.249169
					if( MFI > 61.0507 )
						ret := -0.727273 // sell
...
float op_operation = decision_tree_0_UBER_1Day_d2467da7(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
