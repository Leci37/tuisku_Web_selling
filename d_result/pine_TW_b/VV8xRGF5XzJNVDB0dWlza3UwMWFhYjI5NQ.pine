			...
			if( Negative_Money_Flow > 3.92474e+08 )
				...
				if( Positive_Money_Flow_Sum > 2.58511e+09 )
					...
					if( Negative_Money_Flow > 4.2298e+08 )
						ret := -0.189189
		if( ema13 > 2.59165 )
			if( Positive_Money_Flow_Sum <= 4.24939e+09 )
				if( Negative_Money_Flow_Sum <= 1.38775e+09 )
					if( Positive_Money_Flow_Sum <= 3.16386e+09 )
						ret := -0.380952
					if( Positive_Money_Flow_Sum > 3.16386e+09 )
						ret := 0.333333
				if( Negative_Money_Flow_Sum > 1.38775e+09 )
					if( Raw_Money_Flow <= 3.21078e+08 )
						ret := 0.818182 // buy
					if( Raw_Money_Flow > 3.21078e+08 )
						ret := 0.254545
			if( Positive_Money_Flow_Sum > 4.24939e+09 )
				if( Positive_Money_Flow_Sum <= 9.44377e+09 )
					if( Raw_Money_Flow <= 9.20019e+08 )
						ret := -0.306818
					if( Raw_Money_Flow > 9.20019e+08 )
						ret := 0.583333
				if( Positive_Money_Flow_Sum > 9.44377e+09 )
...
float op_operation = decision_tree_0_U_1Day_01aab295(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
