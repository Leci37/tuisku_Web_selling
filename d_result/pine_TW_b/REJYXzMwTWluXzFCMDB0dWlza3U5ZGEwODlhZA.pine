			...
			if( bearPower <= 0.097065 )
				...
				if( bbp > -0.33711 )
					...
					if( bearPower > -0.1848 )
						ret := -0.036626
			if( bearPower > 0.097065 )
				if( bullPower <= 0.104222 )
					if( bullPower <= 0.101241 )
						ret := 0.358974
					if( bullPower > 0.101241 )
						ret := 0.710145 // buy
				if( bullPower > 0.104222 )
					if( bullPower <= 0.108029 )
						ret := -0.589744
					if( bullPower > 0.108029 )
						ret := 0.317164
		if( bbp > 0.242369 )
			if( bbm <= 0.007946 )
				if( bearPower <= 0.303194 )
					if( bullPower <= 0.199541 )
						ret := -0.374142
					if( bullPower > 0.199541 )
						ret := -0.086614
				if( bearPower > 0.303194 )
					if( bullPower <= 0.372551 )
						ret := -0.618705
					if( bullPower > 0.372551 )
						ret := -0.894737 // sell
			if( bbm > 0.007946 )
				if( bullPower <= 0.375537 )
					if( bullPower <= 0.321119 )
						ret := -0.094979
					if( bullPower > 0.321119 )
						ret := 0.071588
				if( bullPower > 0.375537 )
					if( bullPower <= 0.379115 )
						ret := -0.821918 // sell
					if( bullPower > 0.379115 )
						ret := -0.149748
...
float op_operation = decision_tree_0_DBX_30Min_9da089ad(bearPower, bbm, bbp, bullPower, BBPower_Color)
