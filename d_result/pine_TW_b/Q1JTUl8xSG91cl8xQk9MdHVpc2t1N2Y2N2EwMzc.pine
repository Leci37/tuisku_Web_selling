...
decision_tree_0_CRSR_1Hour_7f67a037(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)=>
	...
	if( vrsi > 58.7074 )
		if( BBlower <= 5.62033 )
			if( dif_source_BBlower <= 1.28286 )
				if( dif_source_BBlower <= 0.972939 )
					if( vrsi <= 87.4409 )
						if( BBlower <= 5.59469 )
							ret := 0.850000 // buy
						if( BBlower > 5.59469 )
			...
			if( dif_source_BBlower > 1.28286 )
				if( BBlower <= 5.60146 )
					...
					if( BBlower > 5.4117 )
						ret := -0.733333 // sell
				if( BBlower > 5.60146 )
					if( dif_source_BBupper <= -0.234912 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > -0.234912 )
						ret := 0.000000
		if( BBlower > 5.62033 )
			if( BBupper <= 49.5878 )
				if( dif_source_BBupper <= 2.16011 )
					if( dif_source_BBupper <= -11.5127 )
						if( BBupper <= 48.315 )
							ret := 0.363636
						if( BBupper > 48.315 )
							ret := 0.945946 // buy
					if( dif_source_BBupper > -11.5127 )
						if( dif_source_BBlower <= 4.4785 )
							ret := -0.180361
						if( dif_source_BBlower > 4.4785 )
							ret := 0.028504
				if( dif_source_BBupper > 2.16011 )
...
float op_operation = decision_tree_0_CRSR_1Hour_7f67a037(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
