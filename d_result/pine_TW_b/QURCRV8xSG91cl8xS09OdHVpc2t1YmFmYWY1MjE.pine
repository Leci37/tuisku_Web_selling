...
decision_tree_0_ADBE_1Hour_bafaf521(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)=>
				...
				if( tprice > 239.34 )
					if( xmf <= 74.3331 )
						...
						if( marron > 103.514 )
							ret := 0.470968
					if( xmf > 74.3331 )
						if( verde_media <= 95.4847 )
							ret := 0.698962
						if( verde_media > 95.4847 )
							ret := 0.057143
			if( media > 94.6773 )
				if( azul_mean <= 12.1974 )
					if( pvimin <= -0.084453 )
						ret := 0.800000 // buy
					if( pvimin > -0.084453 )
						if( oscp <= 25.4358 )
	...
	if( nvim > 0.509083 )
		...
		if( pvi_ema > 0.186533 )
			if( pvi_ema <= 0.48764 )
				if( azul_mean <= -14.3563 )
					if( nvimin <= 0.512847 )
						if( azul_mean <= -39.3389 )
							ret := 1.000000 // buy
						if( azul_mean > -39.3389 )
							ret := -0.055556
					if( nvimin > 0.512847 )
				...
				if( azul_mean > -14.3563 )
					if( media <= 111.303 )
						...
						if( verde > -25.1803 )
							ret := -0.267598
					if( media > 111.303 )
						if( azul_mean <= 14.8365 )
							ret := 1.000000 // buy
						if( azul_mean > 14.8365 )
							ret := -0.200000
			if( pvi_ema > 0.48764 )
				if( media <= 23.2273 )
					if( verde_mean <= -33.533 )
						if( source <= 620.325 )
							ret := -0.906250 // sell
						if( source > 620.325 )
							ret := 0.000000
...
float op_operation = decision_tree_0_ADBE_1Hour_bafaf521(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
