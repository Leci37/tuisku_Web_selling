...
float op_operation = decision_tree_0_SNOW_1Hour_9ce9f227(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
