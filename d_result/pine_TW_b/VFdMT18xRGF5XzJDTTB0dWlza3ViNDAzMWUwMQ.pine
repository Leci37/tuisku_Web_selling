			...
			if( Negative_Money_Flow_Sum <= 1.26768e+09 )
				if( Positive_Money_Flow_Sum <= 1.84544e+09 )
					...
					if( Positive_Money_Flow > 5.36213e+07 )
						ret := -0.127907
				if( Positive_Money_Flow_Sum > 1.84544e+09 )
					if( Positive_Money_Flow_Sum <= 3.15564e+09 )
						ret := 0.653179
					if( Positive_Money_Flow_Sum > 3.15564e+09 )
						ret := -0.446809
			if( Negative_Money_Flow_Sum > 1.26768e+09 )
				if( Money_Flow_Ratio <= 3.69226 )
					if( MFI_Low <= 48.0038 )
						ret := -0.078401
					if( MFI_Low > 48.0038 )
						ret := -0.535211
				if( Money_Flow_Ratio > 3.69226 )
					if( Negative_Money_Flow_Sum <= 1.58461e+09 )
						ret := -0.625000
					if( Negative_Money_Flow_Sum > 1.58461e+09 )
						ret := 0.864865 // buy
...
float op_operation = decision_tree_0_TWLO_1Day_b4031e01(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
