				...
				if( azul > 21.9152 )
					if( marron <= 39.0436 )
						...
						if( oscp > -16.5311 )
							ret := 0.000000
					if( marron > 39.0436 )
						if( verde_mean <= -15.3281 )
							ret := -1.000000 // sell
						if( verde_mean > -15.3281 )
							ret := 0.102273
	if( verde_media > 6.50666 )
		if( verde_azul <= 40.5884 )
			if( nvi <= -0.766013 )
				if( verde <= 85.157 )
					if( azul_mean <= 6.47807 )
						if( source <= 10.9573 )
							ret := 0.144330
						if( source > 10.9573 )
							ret := 0.552632
			...
			if( nvi > -0.766013 )
				if( xrsi <= 79.9344 )
					if( verde_media <= 17.1346 )
						if( marron_mean <= 46.0158 )
							ret := -0.317155
						if( marron_mean > 46.0158 )
							ret := 0.128000
					if( verde_media > 17.1346 )
						if( media_azul <= -3.03558 )
							ret := -0.673529
						if( media_azul > -3.03558 )
							ret := -0.383028
				if( xrsi > 79.9344 )
		...
		if( verde_azul > 40.5884 )
			if( source <= 10.7566 )
				if( verde_mean <= 107.489 )
					if( azul_mean <= -1.06283 )
						if( xmf <= 65.571 )
							ret := 0.316317
						if( xmf > 65.571 )
							ret := 0.076297
					if( azul_mean > -1.06283 )
						if( marron_mean <= 87.1883 )
							ret := -0.049577
						if( marron_mean > 87.1883 )
							ret := 0.271248
				if( verde_mean > 107.489 )
...
float op_operation = decision_tree_0_SNAP_30Min_f68f2b25(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
