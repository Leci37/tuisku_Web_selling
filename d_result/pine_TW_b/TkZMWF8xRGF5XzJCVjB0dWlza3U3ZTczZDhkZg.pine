			...
			if( bbm > 12.7529 )
				...
				if( bearPower > -70.0173 )
					...
					if( bearPower > -40.6879 )
						ret := -0.447368
	if( bbp > 68.9911 )
		if( bearPower <= 25.4595 )
			ret := 0.000000
		if( bearPower > 25.4595 )
			if( bearPower <= 44.3084 )
				if( bbm <= 21.5031 )
					ret := -1.000000 // sell
				if( bbm > 21.5031 )
					if( bbm <= 27.8392 )
...
float op_operation = decision_tree_0_NFLX_1Day_7e73d8df(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
