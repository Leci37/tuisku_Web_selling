...
decision_tree_0_MELI_1Day_505ef9b9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( Lower_Band > 1623.44 )
		if( basis <= 1896.1 )
			if( bbm <= 43.5271 )
				if( Upper_Band <= 1797.32 )
					ret := -1.000000 // sell
				if( Upper_Band > 1797.32 )
					if( bullPower <= 22.8121 )
						ret := -0.333333
					if( bullPower > 22.8121 )
						ret := 0.000000
			if( bbm > 43.5271 )
				if( Upper_Band <= 1784.36 )
					ret := 0.000000
				if( Upper_Band > 1784.36 )
					if( basis <= 1890 )
						ret := -0.935185 // sell
...
float op_operation = decision_tree_0_MELI_1Day_505ef9b9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
