				...
				if( xrsi <= 31.7715 )
					...
					if( media > 2.35601 )
						...
						if( verde > -96.6472 )
							ret := 0.113122
				if( xrsi > 31.7715 )
					if( media_azul <= -46.3283 )
						if( marron_mean <= 25.742 )
							ret := 0.900000 // buy
						if( marron_mean > 25.742 )
							ret := 0.365854
					if( media_azul > -46.3283 )
...
float op_operation = decision_tree_0_LYFT_1Hour_b5b16f49(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
