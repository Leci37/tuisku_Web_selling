...
decision_tree_0_MELI_1Hour_e35234ad(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( wvf > 8.11331 )
		if( midLine <= 17.0619 )
			if( midLine <= 13.1682 )
				if( lowerBand <= 8.67821 )
					if( lowerBand <= -3.6083 )
						if( Color_con2 <= 5.54443 )
							ret := 0.181818
						if( Color_con2 > 5.54443 )
							ret := 0.851852 // buy
					if( lowerBand > -3.6083 )
						if( Color_con2 <= 4.10765 )
							ret := -0.175285
						if( Color_con2 > 4.10765 )
							ret := -0.512605
				if( lowerBand > 8.67821 )
			...
			if( midLine > 13.1682 )
				...
				if( upperBand > 25.2925 )
					ret := -0.181818
		if( midLine > 17.0619 )
			if( Color_con2 <= -2.19784 )
				if( Color_con1 <= -8.1781 )
					if( lowerBand <= 11.102 )
						ret := -1.000000 // sell
					if( lowerBand > 11.102 )
						ret := -0.800000 // sell
...
float op_operation = decision_tree_0_MELI_1Hour_e35234ad(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
