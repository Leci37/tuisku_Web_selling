			...
			if( basis_minus > 0.40462 )
				...
				if( chinkou_span > 26.4767 )
					...
					if( basis_max > -0.311862 )
						ret := 0.867925 // buy
	if( kinjun_sen > 23.9149 )
		if( chinkou_span <= 24.7491 )
			if( tenkan_sen <= 24.8205 )
				if( senkou_span_b_displaced <= 23.8623 )
					if( basis_max <= -0.287181 )
						ret := 0.312500
					if( basis_max > -0.287181 )
						ret := -0.582645
				if( senkou_span_b_displaced > 23.8623 )
					if( chinkou_span <= 22.3 )
						ret := -0.701245 // sell
					if( chinkou_span > 22.3 )
						ret := -0.102459
			if( tenkan_sen > 24.8205 )
				if( tenkan_sen <= 26.4807 )
					if( senkou_span_a <= 25.8722 )
						ret := -0.675591
					if( senkou_span_a > 25.8722 )
						ret := -0.175758
				if( tenkan_sen > 26.4807 )
					if( kinjun_sen <= 28.9237 )
						ret := -0.973913 // sell
					if( kinjun_sen > 28.9237 )
						ret := 0.000000
		if( chinkou_span > 24.7491 )
			if( senkou_span_a <= 26.0391 )
				if( tenkan_sen <= 24.6749 )
					if( tenkan_sen <= 24.5095 )
						ret := 0.554054
					if( tenkan_sen > 24.5095 )
						ret := 0.910714 // buy
				if( tenkan_sen > 24.6749 )
					if( chinkou_span <= 28.126 )
						ret := 0.265211
					if( chinkou_span > 28.126 )
						ret := 0.765217 // buy
			if( senkou_span_a > 26.0391 )
				if( chinkou_span <= 28.1262 )
					if( senkou_span_a <= 28.4837 )
						ret := -0.278932
					if( senkou_span_a > 28.4837 )
						ret := -0.725995 // sell
				if( chinkou_span > 28.1262 )
					if( kinjun_sen <= 29.4075 )
						ret := 0.417596
					if( kinjun_sen > 29.4075 )
						ret := -0.016309
...
float op_operation = decision_tree_0_RUN_30Min_0a849cec(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
