			...
			if( smoothD_d > 93.2768 )
				...
				if( Positive_Money_Flow_Sum > 4.39826e+10 )
					...
					if( Positive_Money_Flow_Sum > 8.77859e+10 )
						ret := -0.100000
	if( Negative_Money_Flow_Sum > 5.51625e+10 )
		if( Negative_Money_Flow_Sum <= 3.53964e+11 )
			if( Typical_Price <= 380.21 )
				if( Positive_Money_Flow_Sum <= 3.42793e+10 )
					if( Positive_Money_Flow <= 4.97883e+09 )
						ret := 0.437500
					if( Positive_Money_Flow > 4.97883e+09 )
						ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 3.42793e+10 )
					if( smoothK_k <= 27.8755 )
						ret := -0.610272
					if( smoothK_k > 27.8755 )
						ret := -0.263427
			if( Typical_Price > 380.21 )
				if( Positive_Money_Flow_Sum <= 3.82495e+11 )
					if( rsi1 <= 36.3608 )
						ret := 0.813953 // buy
					if( rsi1 > 36.3608 )
						ret := 0.248148
				if( Positive_Money_Flow_Sum > 3.82495e+11 )
					...
					if( k > 49.94 )
						ret := -1.000000 // sell
		if( Negative_Money_Flow_Sum > 3.53964e+11 )
			if( Raw_Money_Flow <= 4.72823e+10 )
				if( Money_Flow_Ratio <= 0.463406 )
					ret := 1.000000 // buy
				if( Money_Flow_Ratio > 0.463406 )
					ret := 0.615385
			if( Raw_Money_Flow > 4.72823e+10 )
...
float op_operation = decision_tree_0_NVDA_1Day_0ce15d20(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
