			...
			if( Positive_Money_Flow > 1.09551e+08 )
				...
				if( Positive_Money_Flow > 2.73232e+08 )
					...
					if( MFI_Low > 68.9005 )
						ret := -0.166667
	if( Negative_Money_Flow_Sum > 8.88297e+08 )
		if( Typical_Price <= 290.203 )
			if( Negative_Money_Flow_Sum <= 2.02032e+09 )
				if( Negative_Money_Flow_Sum <= 1.43629e+09 )
					if( MFI <= 55.3795 )
						ret := 0.478261
					if( MFI > 55.3795 )
						ret := -0.274854
			...
			if( Negative_Money_Flow_Sum > 2.02032e+09 )
				if( Long_MA <= 190.633 )
					...
					if( Long_MA > 177.818 )
						ret := -0.746479 // sell
				if( Long_MA > 190.633 )
					if( Money_Flow_Ratio <= 0.418971 )
						ret := 0.138889
					if( Money_Flow_Ratio > 0.418971 )
						ret := 0.510345
		if( Typical_Price > 290.203 )
			if( Negative_Money_Flow_Sum <= 3.92313e+09 )
				if( Positive_Money_Flow_Sum <= 2.24184e+09 )
					if( MFI_Low <= 31.8476 )
						ret := -0.866667 // sell
					if( MFI_Low > 31.8476 )
						ret := -0.277778
				if( Positive_Money_Flow_Sum > 2.24184e+09 )
					...
					if( Long_MA > 396.285 )
						ret := -0.611111
			if( Negative_Money_Flow_Sum > 3.92313e+09 )
				if( Positive_Money_Flow_Sum <= 3.4175e+09 )
					if( Long_MA <= 406.269 )
						ret := 0.017544
					if( Long_MA > 406.269 )
						ret := -0.706667 // sell
...
float op_operation = decision_tree_0_MDB_1Day_7eb2cbbf(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
