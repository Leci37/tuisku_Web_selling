			...
			if( bbp <= 8.12689 )
				if( bbm <= 6.25705 )
					...
					if( bbm > 1.482 )
						ret := -0.524324
				if( bbm > 6.25705 )
					if( smoothK_k <= 95.6686 )
						ret := 0.483871
					if( smoothK_k > 95.6686 )
						ret := -0.916667 // sell
			if( bbp > 8.12689 )
				if( bullPower <= 36.9978 )
					if( bullPower <= 33.8529 )
						ret := 0.002632
					if( bullPower > 33.8529 )
						ret := 1.000000 // buy
				if( bullPower > 36.9978 )
...
float op_operation = decision_tree_0_EPAM_1Day_a1a81875(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
