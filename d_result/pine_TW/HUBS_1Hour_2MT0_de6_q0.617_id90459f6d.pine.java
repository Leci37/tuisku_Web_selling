...
decision_tree_0_HUBS_1Hour_90459f6d(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
			...
			if( Positive_Money_Flow_Sum <= 1.00304e+08 )
				...
				if( ema12 > -0.900036 )
					if( Raw_Money_Flow <= 4.72743e+06 )
						if( Typical_Price <= 127.492 )
							ret := 0.200000
						if( Typical_Price > 127.492 )
							ret := -0.901961 // sell
					if( Raw_Money_Flow > 4.72743e+06 )
						if( Positive_Money_Flow_Sum <= 7.59375e+07 )
							ret := 0.154930
						if( Positive_Money_Flow_Sum > 7.59375e+07 )
							ret := -0.543689
			if( Positive_Money_Flow_Sum > 1.00304e+08 )
				if( Raw_Money_Flow <= 5.13995e+06 )
					if( Negative_Money_Flow_Sum <= 4.28863e+07 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 4.28863e+07 )
						if( ema12 <= 1.07533 )
							ret := 0.500000
	...
	if( ema1 > 152.813 )
		if( Positive_Money_Flow_Sum <= 3.69186e+08 )
			if( ema3 <= 203.591 )
				if( Positive_Money_Flow_Sum <= 3.97627e+07 )
					if( ema13 <= -1.64988 )
						if( ema12 <= -1.57612 )
							ret := 0.826923 // buy
						if( ema12 > -1.57612 )
							ret := 0.347826
					if( ema13 > -1.64988 )
						if( Negative_Money_Flow_Sum <= 3.92199e+07 )
							ret := 0.800000 // buy
						if( Negative_Money_Flow_Sum > 3.92199e+07 )
							ret := -0.073529
				if( Positive_Money_Flow_Sum > 3.97627e+07 )
					if( ema1 <= 154.46 )
						if( Negative_Money_Flow_Sum <= 6.12235e+07 )
							ret := -0.861111 // sell
						if( Negative_Money_Flow_Sum > 6.12235e+07 )
							ret := -0.303571
					if( ema1 > 154.46 )
						if( Raw_Money_Flow <= 1.13072e+06 )
							ret := 0.263736
						if( Raw_Money_Flow > 1.13072e+06 )
							ret := -0.133935
			if( ema3 > 203.591 )
				if( Negative_Money_Flow_Sum <= 8.35956e+07 )
					if( Raw_Money_Flow <= 1.74469e+06 )
						if( ema12 <= 3.38149 )
							ret := 0.727273 // buy
						if( ema12 > 3.38149 )
							ret := 0.155556
				...
				if( Negative_Money_Flow_Sum > 8.35956e+07 )
					if( ema3 <= 294.827 )
						if( Positive_Money_Flow_Sum <= 2.15798e+08 )
							ret := 0.095126
						if( Positive_Money_Flow_Sum > 2.15798e+08 )
							ret := 0.592105
					if( ema3 > 294.827 )
						if( Negative_Money_Flow_Sum <= 3.01796e+08 )
							ret := -0.052965
						if( Negative_Money_Flow_Sum > 3.01796e+08 )
							ret := 0.077606
		if( Positive_Money_Flow_Sum > 3.69186e+08 )
			if( tema <= 416.8 )
				if( Money_Flow_Ratio <= 2.67268 )
					if( ema12 <= -0.623489 )
						if( Negative_Money_Flow_Sum <= 3.06326e+08 )
							ret := 0.769231 // buy
						if( Negative_Money_Flow_Sum > 3.06326e+08 )
							ret := -0.782609 // sell
					if( ema12 > -0.623489 )
				...
				if( Positive_Money_Flow <= 7.7141e+06 )
					...
					if( Positive_Money_Flow_Sum > 6.01716e+08 )
						...
						if( MFI_Low > 24.9907 )
							ret := 0.539568
				if( Positive_Money_Flow > 7.7141e+06 )
					if( Negative_Money_Flow_Sum <= 1.47052e+08 )
						if( ema3 <= 438.988 )
							ret := 0.631579
						if( ema3 > 438.988 )
							ret := -0.163636
...
float op_operation = decision_tree_0_HUBS_1Hour_90459f6d(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
