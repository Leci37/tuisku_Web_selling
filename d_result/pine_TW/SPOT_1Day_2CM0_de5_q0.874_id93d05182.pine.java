...
decision_tree_0_SPOT_1Day_93d05182(mf, ad, ad_mf, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)=>
	...
	if( Positive_Money_Flow > 4.77661e+08 )
		if( MFI_High <= -6.59008 )
			if( Money_Flow_Ratio <= 0.623408 )
				if( Negative_Money_Flow_Sum <= 3.99966e+09 )
					ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 3.99966e+09 )
					if( Typical_Price <= 264.523 )
						ret := 0.125000
					if( Typical_Price > 264.523 )
						ret := 0.875000 // buy
			if( Money_Flow_Ratio > 0.623408 )
				if( Positive_Money_Flow <= 1.21426e+09 )
					if( Positive_Money_Flow_Sum <= 2.82939e+09 )
						ret := -0.150000
					if( Positive_Money_Flow_Sum > 2.82939e+09 )
						ret := -0.692308
				if( Positive_Money_Flow > 1.21426e+09 )
					...
					if( mf > 0.12486 )
						ret := -1.000000 // sell
		if( MFI_High > -6.59008 )
			if( Positive_Money_Flow <= 1.01307e+09 )
				if( Positive_Money_Flow_Sum <= 2.77763e+09 )
					ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 2.77763e+09 )
					if( ad <= 2.4563e+06 )
						ret := -0.258065
					if( ad > 2.4563e+06 )
						ret := 0.666667
			if( Positive_Money_Flow > 1.01307e+09 )
				if( Positive_Money_Flow <= 1.12725e+09 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow > 1.12725e+09 )
					if( Raw_Money_Flow <= 1.92115e+09 )
						ret := 0.100000
					if( Raw_Money_Flow > 1.92115e+09 )
						ret := 0.800000 // buy
...
float op_operation = decision_tree_0_SPOT_1Day_93d05182(mf, ad, ad_mf, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
