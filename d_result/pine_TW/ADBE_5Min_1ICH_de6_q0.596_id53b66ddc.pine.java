				...
				if( chinkou_span > 519.539 )
					...
					if( senkou_span_a > 522.268 )
						...
						if( senkou_span_b_displaced > 517.742 )
							ret := -0.362319
		if( chinkou_span > 523.446 )
			if( tenkan_sen <= 524.289 )
				if( senkou_span_a_displaced <= 457.823 )
					ret := -0.769231 // sell
				if( senkou_span_a_displaced > 457.823 )
					if( chinkou_span <= 524.528 )
						if( senkou_span_a <= 522.876 )
							ret := 0.364807
						if( senkou_span_a > 522.876 )
							ret := -0.142857
					if( chinkou_span > 524.528 )
						if( senkou_span_b_displaced <= 526.734 )
							ret := 0.616359
						if( senkou_span_b_displaced > 526.734 )
							ret := 0.319588
			if( tenkan_sen > 524.289 )
				if( chinkou_span <= 527.2 )
					if( kinjun_sen <= 527.13 )
						if( basis_max <= -0.311632 )
							ret := -0.393162
						if( basis_max > -0.311632 )
							ret := 0.176211
					if( kinjun_sen > 527.13 )
						if( basis_max <= 0.040424 )
							ret := -0.687500
						if( basis_max > 0.040424 )
							ret := -0.220513
				if( chinkou_span > 527.2 )
					if( senkou_span_a <= 536.296 )
						if( kinjun_sen <= 523.485 )
							ret := 0.721649 // buy
						if( kinjun_sen > 523.485 )
							ret := 0.215339
					if( senkou_span_a > 536.296 )
						if( chinkou_span <= 544.106 )
							ret := -0.330319
						if( chinkou_span > 544.106 )
							ret := 0.033071
...
float op_operation = decision_tree_0_ADBE_5Min_53b66ddc(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
