			...
			if( MFI_High <= -44.8427 )
				...
				if( Negative_Money_Flow > 3.02751e+09 )
					...
					if( Typical_Price > 29.4853 )
						ret := 0.218750
			if( MFI_High > -44.8427 )
				if( Money_Flow_Ratio <= 2.05313 )
					if( Negative_Money_Flow_Sum <= 4.52892e+09 )
						ret := -0.484127
					if( Negative_Money_Flow_Sum > 4.52892e+09 )
						ret := 0.171753
				if( Money_Flow_Ratio > 2.05313 )
					if( Positive_Money_Flow_Sum <= 5.85756e+10 )
						ret := -0.267898
					if( Positive_Money_Flow_Sum > 5.85756e+10 )
						ret := 0.289474
		if( Raw_Money_Flow > 8.38626e+09 )
			if( Negative_Money_Flow_Sum <= 3.69709e+10 )
				if( MFI_Low <= 57.8229 )
					if( VIP <= 1.47077 )
						ret := 0.696970
					if( VIP > 1.47077 )
						ret := -0.750000 // sell
				if( MFI_Low > 57.8229 )
					if( Money_Flow_Ratio <= 6.27107 )
						ret := -0.148148
					if( Money_Flow_Ratio > 6.27107 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 3.69709e+10 )
				if( VIP <= 1.01268 )
					if( Negative_Money_Flow_Sum <= 8.21064e+10 )
						ret := 0.282051
					if( Negative_Money_Flow_Sum > 8.21064e+10 )
						ret := -0.440559
				if( VIP > 1.01268 )
					if( Negative_Money_Flow_Sum <= 8.56395e+10 )
						ret := -0.805556 // sell
					if( Negative_Money_Flow_Sum > 8.56395e+10 )
						ret := 0.000000
...
float op_operation = decision_tree_0_AMD_1Day_77af60e6(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
