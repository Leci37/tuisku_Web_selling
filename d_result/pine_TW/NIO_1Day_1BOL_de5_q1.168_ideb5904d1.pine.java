			...
			if( vrsi > 51.1502 )
				if( BBlower <= -11.417 )
					...
					if( BBlower > -12.0655 )
						ret := -1.000000 // sell
				if( BBlower > -11.417 )
					if( dif_source_BBlower <= 33.1528 )
						ret := 0.250000
					if( dif_source_BBlower > 33.1528 )
						ret := 0.815789 // buy
		if( BBlower > 0.944078 )
			if( vrsi <= 30.9195 )
				if( dif_source_BBlower <= 1.2583 )
					ret := 1.000000 // buy
				if( dif_source_BBlower > 1.2583 )
					if( dif_source_BBlower <= 1.67809 )
						ret := 0.000000
					if( dif_source_BBlower > 1.67809 )
						ret := -0.614035
			if( vrsi > 30.9195 )
				if( vrsi <= 50.9938 )
					if( dif_source_BBlower <= 5.4125 )
						ret := 0.621951
					if( dif_source_BBlower > 5.4125 )
						ret := -1.000000 // sell
				if( vrsi > 50.9938 )
...
float op_operation = decision_tree_0_NIO_1Day_eb5904d1(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
