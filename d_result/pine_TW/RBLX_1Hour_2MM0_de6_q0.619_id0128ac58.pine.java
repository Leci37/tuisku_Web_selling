...
decision_tree_0_RBLX_1Hour_0128ac58(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)=>
	...
	if( Typical_Price > 40.1945 )
		...
		if( Short_Long_Diff > -3.2548 )
			if( Long_MA <= 116.649 )
				if( Negative_Money_Flow_Sum <= 7.48762e+08 )
					if( MFI_Low <= -12.2478 )
						if( Raw_Money_Flow <= 2.40966e+06 )
							ret := -0.617886
						if( Raw_Money_Flow > 2.40966e+06 )
							ret := -0.093863
					if( MFI_Low > -12.2478 )
						if( Short_Long_Diff <= -0.086923 )
							ret := 0.029276
						if( Short_Long_Diff > -0.086923 )
							ret := -0.074107
				if( Negative_Money_Flow_Sum > 7.48762e+08 )
					if( Short_MA <= 44.2255 )
						ret := -0.646465
					if( Short_MA > 44.2255 )
						if( Positive_Money_Flow_Sum <= 5.40001e+09 )
							ret := -0.145205
						if( Positive_Money_Flow_Sum > 5.40001e+09 )
							ret := -0.970588 // sell
			if( Long_MA > 116.649 )
...
float op_operation = decision_tree_0_RBLX_1Hour_0128ac58(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
