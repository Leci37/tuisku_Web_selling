			...
			if( bbp > 3.52408 )
				...
				if( bullPower > 4.74875 )
					...
					if( basis > 23.2244 )
						ret := 0.000000
	if( Upper_Band > 28.8116 )
		if( Upper_Band <= 32.4504 )
			if( Upper_Band <= 30.3419 )
				if( bullPower <= -0.264403 )
					ret := -0.722222 // sell
				if( bullPower > -0.264403 )
					if( bearPower <= 3.69556 )
						ret := 0.000000
					if( bearPower > 3.69556 )
						ret := 1.000000 // buy
			if( Upper_Band > 30.3419 )
				if( bearPower <= -4.37262 )
					ret := -0.250000
				if( bearPower > -4.37262 )
					if( bullPower <= -2.13321 )
						ret := 0.000000
					if( bullPower > -2.13321 )
						ret := -0.867769 // sell
		if( Upper_Band > 32.4504 )
			if( Lower_Band <= 72.3956 )
				if( Lower_Band <= 17.012 )
					if( bbm <= 2.452 )
						ret := 1.000000 // buy
					if( bbm > 2.452 )
						ret := -0.633663
				if( Lower_Band > 17.012 )
					if( Upper_Band <= 104.412 )
						ret := 0.039716
					if( Upper_Band > 104.412 )
						ret := 0.685185
			if( Lower_Band > 72.3956 )
				if( bearPower <= -15.8685 )
					if( bbp <= -19.765 )
						ret := 0.615385
					if( bbp > -19.765 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_3ad2cce3(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
