			...
			if( VIM > 1.13305 )
				...
				if( Negative_Money_Flow_Sum > 3.96327e+09 )
					...
					if( Negative_Money_Flow > 4.37703e+08 )
						ret := 1.000000 // buy
	if( Positive_Money_Flow_Sum > 2.9137e+09 )
		if( Typical_Price <= 271.035 )
			if( Typical_Price <= 193.256 )
				if( VIP_VIM <= 0.277047 )
					if( Positive_Money_Flow_Sum <= 4.40937e+09 )
						ret := 0.250000
					if( Positive_Money_Flow_Sum > 4.40937e+09 )
						ret := -0.625000
				if( VIP_VIM > 0.277047 )
					...
					if( VIP > 1.38339 )
						ret := 0.095238
			if( Typical_Price > 193.256 )
				if( Negative_Money_Flow_Sum <= 3.05927e+09 )
					if( VIM <= 0.877479 )
						ret := 0.048387
					if( VIM > 0.877479 )
						ret := 0.564516
				if( Negative_Money_Flow_Sum > 3.05927e+09 )
					if( Positive_Money_Flow <= 4.96569e+08 )
						ret := 0.097222
					if( Positive_Money_Flow > 4.96569e+08 )
						ret := -0.947368 // sell
		if( Typical_Price > 271.035 )
			if( Positive_Money_Flow_Sum <= 4.99061e+09 )
				if( VIM <= 0.814109 )
					ret := -1.000000 // sell
				if( VIM > 0.814109 )
					if( Typical_Price <= 341.314 )
						ret := -0.728682 // sell
					if( Typical_Price > 341.314 )
						ret := -0.153846
			if( Positive_Money_Flow_Sum > 4.99061e+09 )
				if( Typical_Price <= 288.166 )
					ret := 0.636364
				if( Typical_Price > 288.166 )
					if( VIP_VIM <= 0.128544 )
						ret := -0.294118
...
float op_operation = decision_tree_0_SPOT_1Day_de1cd1ba(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)
