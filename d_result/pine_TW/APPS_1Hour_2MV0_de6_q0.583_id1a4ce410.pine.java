				...
				if( Negative_Money_Flow_Sum <= 2.0015e+08 )
					if( Negative_Money_Flow_Sum <= 6.63089e+06 )
						...
						if( Negative_Money_Flow_Sum > 3.08801e+06 )
							ret := 0.034483
					if( Negative_Money_Flow_Sum > 6.63089e+06 )
						if( Positive_Money_Flow_Sum <= 1.14602e+07 )
							ret := -0.410596
						if( Positive_Money_Flow_Sum > 1.14602e+07 )
							ret := -0.705426 // sell
				if( Negative_Money_Flow_Sum > 2.0015e+08 )
					if( Typical_Price <= 67.3302 )
						if( Positive_Money_Flow <= 3.10158e+07 )
							ret := 0.666667
						if( Positive_Money_Flow > 3.10158e+07 )
							ret := 0.000000
					if( Typical_Price > 67.3302 )
						if( Money_Flow_Ratio <= 0.160347 )
							ret := -0.066667
						if( Money_Flow_Ratio > 0.160347 )
							ret := -0.600000
			if( Money_Flow_Ratio > 0.227028 )
				if( Negative_Money_Flow_Sum <= 2.76166e+08 )
					if( VIM <= 0.67449 )
						if( Positive_Money_Flow_Sum <= 8.52108e+06 )
							ret := -0.883721 // sell
						if( Positive_Money_Flow_Sum > 8.52108e+06 )
							ret := -0.174905
					if( VIM > 0.67449 )
						if( Positive_Money_Flow_Sum <= 8.08747e+07 )
							ret := -0.020634
						if( Positive_Money_Flow_Sum > 8.08747e+07 )
							ret := 0.108140
				if( Negative_Money_Flow_Sum > 2.76166e+08 )
					...
					if( MFI > 58.411 )
						ret := 1.000000 // buy
	if( Negative_Money_Flow > 1.63379 )
		if( Negative_Money_Flow_Sum <= 4.16496e+06 )
			if( Positive_Money_Flow_Sum <= 256682 )
				if( Typical_Price <= 2.73057 )
					if( Positive_Money_Flow <= 11.2782 )
						if( Typical_Price <= 1.35152 )
							ret := 0.225806
						if( Typical_Price > 1.35152 )
							ret := 0.764706 // buy
					if( Positive_Money_Flow > 11.2782 )
				...
				if( Typical_Price > 2.73057 )
					ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 256682 )
				if( Positive_Money_Flow <= 0.140644 )
					if( Negative_Money_Flow <= 323120 )
						if( MFI_Low <= -8.50119 )
							ret := -1.000000 // sell
						if( MFI_Low > -8.50119 )
							ret := 0.376777
					if( Negative_Money_Flow > 323120 )
						if( Negative_Money_Flow_Sum <= 2.90263e+06 )
							ret := -0.029724
						if( Negative_Money_Flow_Sum > 2.90263e+06 )
							ret := 0.278932
				if( Positive_Money_Flow > 0.140644 )
					if( MFI <= 82.3347 )
						if( Negative_Money_Flow_Sum <= 1.03562e+06 )
							ret := -0.431373
						if( Negative_Money_Flow_Sum > 1.03562e+06 )
							ret := 0.072027
					if( MFI > 82.3347 )
						if( Negative_Money_Flow_Sum <= 677614 )
							ret := 0.876543 // buy
						if( Negative_Money_Flow_Sum > 677614 )
							ret := 0.145161
		if( Negative_Money_Flow_Sum > 4.16496e+06 )
			if( Positive_Money_Flow_Sum <= 3.18508e+08 )
				if( VIP <= 0.50924 )
					if( Negative_Money_Flow_Sum <= 2.06283e+07 )
						ret := 0.333333
					if( Negative_Money_Flow_Sum > 2.06283e+07 )
						if( VIP_VIM <= -1.22493 )
							ret := 0.000000
				...
				if( VIP > 0.50924 )
					if( VIP_VIM <= 0.206888 )
						...
						if( MFI > 65.4285 )
							ret := -0.265655
					if( VIP_VIM > 0.206888 )
						if( Negative_Money_Flow_Sum <= 6.42944e+06 )
							ret := -0.213115
						if( Negative_Money_Flow_Sum > 6.42944e+06 )
							ret := 0.151881
			if( Positive_Money_Flow_Sum > 3.18508e+08 )
...
float op_operation = decision_tree_0_APPS_1Hour_1a4ce410(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
