				...
				if( kinjun_sen > 74.0098 )
					if( chinkou_span <= 87.3428 )
						...
						if( basis_minus > 3.19148 )
							ret := -0.378378
					if( chinkou_span > 87.3428 )
						if( senkou_span_a_displaced <= 77.9057 )
							ret := 0.344262
						if( senkou_span_a_displaced > 77.9057 )
							ret := 0.880597 // buy
	if( senkou_span_b > 81.8097 )
		if( senkou_span_b <= 87.0723 )
			if( chinkou_span <= 83.2435 )
				if( senkou_span_b_displaced <= 85.1189 )
					if( senkou_span_b <= 82.275 )
						ret := 0.111111
					if( senkou_span_b > 82.275 )
						ret := -0.736842 // sell
				if( senkou_span_b_displaced > 85.1189 )
					if( chinkou_span <= 74.8264 )
						if( chinkou_span <= 68.378 )
							ret := 1.000000 // buy
						if( chinkou_span > 68.378 )
							ret := -0.441558
					if( chinkou_span > 74.8264 )
						ret := 0.656250
			if( chinkou_span > 83.2435 )
				if( basis_max <= -0.273711 )
					ret := -0.353846
				if( basis_max > -0.273711 )
					if( kinjun_sen <= 83.925 )
						ret := -1.000000 // sell
					if( kinjun_sen > 83.925 )
						ret := 0.370588
		if( senkou_span_b > 87.0723 )
			if( chinkou_span <= 82.5254 )
				ret := -0.746667 // sell
			if( chinkou_span > 82.5254 )
				if( tenkan_sen <= 86.9413 )
					ret := 1.000000 // buy
				if( tenkan_sen > 86.9413 )
					ret := -0.400000
...
float op_operation = decision_tree_0_APPS_1Hour_41c9143b(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
