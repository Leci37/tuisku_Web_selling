			...
			if( tema > 177.597 )
				...
				if( rsi1 > 77.6738 )
					...
					if( tema > 184.884 )
						ret := 0.000000
		if( ema1 > 188.669 )
			if( smoothD_d <= 4.39177 )
				if( rsi1 <= 27.56 )
					if( smoothD_d <= -2.11976 )
						ret := 0.000000
					if( smoothD_d > -2.11976 )
						ret := -0.979592 // sell
				if( rsi1 > 27.56 )
...
float op_operation = decision_tree_0_SNOW_1Day_66f40c29(d_k, d, rsi1, k, smoothD_d, smoothK_k, ema1, tema, ema12, ema2, ema3, ema13)
