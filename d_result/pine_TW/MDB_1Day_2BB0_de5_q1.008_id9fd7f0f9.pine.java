			...
			if( Lower_Band <= 429.041 )
				if( Lower_Band <= 320.031 )
					...
					if( bullPower > -15.2525 )
						ret := 0.000000
				if( Lower_Band > 320.031 )
					if( Upper_Band <= 428.498 )
						ret := 0.181818
					if( Upper_Band > 428.498 )
						ret := -0.620000
			if( Lower_Band > 429.041 )
				if( bullPower <= 16.2963 )
					if( Lower_Band <= 442.418 )
						ret := 0.954545 // buy
					if( Lower_Band > 442.418 )
						ret := 0.375000
				if( bullPower > 16.2963 )
					ret := 0.000000
		if( basis > 502.457 )
			if( bullPower <= -25.6372 )
				if( bbm <= 26.3572 )
					ret := 1.000000 // buy
				if( bbm > 26.3572 )
					ret := 0.000000
			if( bullPower > -25.6372 )
				if( Upper_Band <= 601.158 )
					if( Upper_Band <= 571.471 )
						ret := -0.250000
					if( Upper_Band > 571.471 )
						ret := -0.958333 // sell
				if( Upper_Band > 601.158 )
...
float op_operation = decision_tree_0_MDB_1Day_9fd7f0f9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
