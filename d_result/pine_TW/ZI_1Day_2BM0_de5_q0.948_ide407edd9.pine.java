			...
			if( bearPower <= 0.734676 )
				...
				if( Typical_Price > 30.0035 )
					...
					if( MFI_High > -51.5528 )
						ret := 0.341137
			if( bearPower > 0.734676 )
				if( Negative_Money_Flow_Sum <= 3.71768e+08 )
					if( Typical_Price <= 41.6605 )
						ret := -0.750000 // sell
					if( Typical_Price > 41.6605 )
						ret := 0.179487
				if( Negative_Money_Flow_Sum > 3.71768e+08 )
					if( Negative_Money_Flow_Sum <= 3.96863e+08 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 3.96863e+08 )
						ret := -0.346535
		if( Negative_Money_Flow > 6.32666e+07 )
			if( MFI <= 77.8827 )
				if( bbm <= 4.285 )
					if( Negative_Money_Flow_Sum <= 8.12519e+08 )
						ret := -0.426036
					if( Negative_Money_Flow_Sum > 8.12519e+08 )
						ret := -0.110000
				if( bbm > 4.285 )
					if( bearPower <= -0.060535 )
						ret := -0.950000 // sell
					if( bearPower > -0.060535 )
						ret := -0.500000
			if( MFI > 77.8827 )
				if( bbm <= 1.0741 )
					...
					if( bbp > 1.23082 )
						ret := 1.000000 // buy
				if( bbm > 1.0741 )
					if( Positive_Money_Flow_Sum <= 1.60818e+09 )
						ret := -0.200000
					if( Positive_Money_Flow_Sum > 1.60818e+09 )
						ret := 0.750000 // buy
...
float op_operation = decision_tree_0_ZI_1Day_e407edd9(bbp, bullPower, BBPower_Color, bearPower, bbm, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
