				...
				if( val <= 0.293442 )
					if( basis <= 293.08 )
						...
						if( lowerKC > 285.219 )
							ret := -0.038462
					if( basis > 293.08 )
						if( avgHighLow <= 299.597 )
							ret := -0.783784 // sell
						if( avgHighLow > 299.597 )
							ret := 0.300000
				if( val > 0.293442 )
					if( val <= 3.14265 )
						if( avgHighLow <= 290.505 )
							ret := 0.142857
						if( avgHighLow > 290.505 )
							ret := 0.844828 // buy
					if( val > 3.14265 )
...
float op_operation = decision_tree_0_MDB_1Hour_4f847514(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
