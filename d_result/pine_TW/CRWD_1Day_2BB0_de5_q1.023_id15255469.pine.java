			...
			if( basis <= 64.743 )
				...
				if( bbp > 5.28551 )
					...
					if( bbm > 5.00891 )
						ret := -0.833333 // sell
			if( basis > 64.743 )
				if( Upper_Band <= 88.2835 )
					if( bbp <= 7.62188 )
						ret := 0.911111 // buy
					if( bbp > 7.62188 )
						ret := 0.500000
				if( Upper_Band > 88.2835 )
					if( Upper_Band <= 103.551 )
						ret := -0.620690
					if( Upper_Band > 103.551 )
						ret := -0.068342
...
float op_operation = decision_tree_0_CRWD_1Day_15255469(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
