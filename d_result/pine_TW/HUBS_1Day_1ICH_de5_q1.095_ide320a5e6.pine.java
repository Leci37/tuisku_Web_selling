		...
		if( senkou_span_a_displaced <= 717.706 )
			if( basis_max <= -18.3469 )
				if( chinkou_span <= 649.43 )
					if( basis_minus <= 31.5425 )
						ret := -0.838710 // sell
					if( basis_minus > 31.5425 )
						ret := -1.000000 // sell
				if( chinkou_span > 649.43 )
					if( senkou_span_a <= 761.096 )
						ret := 0.111111
					if( senkou_span_a > 761.096 )
						ret := -0.400000
			if( basis_max > -18.3469 )
				if( tenkan_sen <= 623.746 )
					if( chinkou_span <= 591.83 )
						ret := -0.280702
					if( chinkou_span > 591.83 )
						ret := 0.303030
				if( tenkan_sen > 623.746 )
					if( basis_minus <= 48.0894 )
						ret := -0.287879
					if( basis_minus > 48.0894 )
						ret := -0.961538 // sell
		if( senkou_span_a_displaced > 717.706 )
			if( chinkou_span <= 449.806 )
				ret := -0.500000
			if( chinkou_span > 449.806 )
				if( chinkou_span <= 488.398 )
					ret := -1.000000 // sell
				if( chinkou_span > 488.398 )
					if( kinjun_sen <= 750.25 )
						ret := -0.965517 // sell
					if( kinjun_sen > 750.25 )
						ret := -0.794118 // sell
...
float op_operation = decision_tree_0_HUBS_1Day_e320a5e6(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
