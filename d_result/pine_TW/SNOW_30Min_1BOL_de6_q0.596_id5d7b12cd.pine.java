				...
				if( BBupper <= 405.343 )
					if( BBlower <= 124.745 )
						...
						if( dif_source_BBupper > -40.7888 )
							ret := -0.352761
					if( BBlower > 124.745 )
						if( dif_source_BBlower <= 69.0452 )
							ret := 0.010486
						if( dif_source_BBlower > 69.0452 )
							ret := 0.406699
				if( BBupper > 405.343 )
					if( dif_source_BBupper <= -89.9787 )
						ret := 0.868421 // buy
					if( dif_source_BBupper > -89.9787 )
						if( BBlower <= 331.68 )
							ret := -0.564327
				...
				if( BBupper <= 294.976 )
					if( BBupper <= 291.137 )
						...
						if( vrsi > 97.3737 )
							ret := -0.302285
					if( BBupper > 291.137 )
						if( dif_source_BBupper <= -20.1926 )
							ret := 0.684783
						if( dif_source_BBupper > -20.1926 )
							ret := 0.084416
				if( BBupper > 294.976 )
					if( dif_source_BBlower <= -5.3 )
						ret := 0.950000 // buy
					if( dif_source_BBlower > -5.3 )
						if( BBupper <= 302.195 )
							ret := -0.707602 // sell
...
float op_operation = decision_tree_0_SNOW_30Min_5d7b12cd(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
