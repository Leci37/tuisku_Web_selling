			...
			if( bbm > 0.404577 )
				...
				if( basis > 185.352 )
					...
					if( basis > 215.363 )
						ret := -0.648148
		if( bbp > 6.89171 )
			if( Upper_Band <= 201.402 )
				ret := -1.000000 // sell
			if( Upper_Band > 201.402 )
				if( Upper_Band <= 208.377 )
					if( bbm <= 2.55296 )
						ret := 0.727273 // buy
					if( bbm > 2.55296 )
						ret := -0.400000
...
float op_operation = decision_tree_0_FFIV_5Min_7585622a(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
