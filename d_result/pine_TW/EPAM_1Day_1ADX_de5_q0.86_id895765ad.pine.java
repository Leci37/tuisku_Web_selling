			...
			if( diMinus <= 55.1292 )
				if( adx <= 34.9136 )
					...
					if( diMinus > 49.6505 )
						ret := -0.928571 // sell
				if( adx > 34.9136 )
					if( smoothedDirectionalMovementMinus <= 3.16062 )
						ret := 0.272727
					if( smoothedDirectionalMovementMinus > 3.16062 )
						ret := 0.941176 // buy
			if( diMinus > 55.1292 )
				if( trueRange <= 24.0159 )
					ret := -0.428571
				if( trueRange > 24.0159 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_EPAM_1Day_895765ad(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
