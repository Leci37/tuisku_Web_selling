			...
			if( verde_media <= -29.0696 )
				if( xmf <= 22.9357 )
					...
					if( BollOsc > -67.75 )
						ret := -1.000000 // sell
				if( xmf > 22.9357 )
					if( azul_mean <= -94.5713 )
						ret := 1.000000 // buy
					if( azul_mean > -94.5713 )
						ret := 0.000000
			if( verde_media > -29.0696 )
				if( pvimin <= 0.213031 )
					if( verde_azul <= 33.2919 )
						ret := 0.000000
					if( verde_azul > 33.2919 )
						ret := -0.983871 // sell
				if( pvimin > 0.213031 )
...
float op_operation = decision_tree_0_FFIV_1Day_df0f7da8(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
