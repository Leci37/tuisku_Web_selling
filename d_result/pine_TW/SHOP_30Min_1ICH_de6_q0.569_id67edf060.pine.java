			...
			if( basis_minus > -80.233 )
				if( chinkou_span <= 31.7078 )
					...
					if( tenkan_sen > 32.4651 )
						ret := -0.753968 // sell
				if( chinkou_span > 31.7078 )
					if( kinjun_sen <= 31.8675 )
						if( senkou_span_a_displaced <= 30.0162 )
							ret := 0.069767
						if( senkou_span_a_displaced > 30.0162 )
							ret := 0.675141
					if( kinjun_sen > 31.8675 )
						if( chinkou_span <= 36.2584 )
							ret := -0.114659
						if( chinkou_span > 36.2584 )
							ret := 0.052462
	if( basis_max > 13.555 )
		if( chinkou_span <= 923.465 )
			if( senkou_span_a_displaced <= 1029.32 )
				ret := -0.307317
			if( senkou_span_a_displaced > 1029.32 )
				ret := -0.881356 // sell
		if( chinkou_span > 923.465 )
			if( senkou_span_a_displaced <= 1232.09 )
				if( senkou_span_a <= 973.971 )
					ret := 0.812500 // buy
				if( senkou_span_a > 973.971 )
					if( basis_max <= 16.3158 )
						ret := -0.273504
					if( basis_max > 16.3158 )
						ret := 0.370787
			if( senkou_span_a_displaced > 1232.09 )
				if( senkou_span_b <= 1309.43 )
					if( senkou_span_b_displaced <= 1216.81 )
						ret := 0.750000 // buy
					if( senkou_span_b_displaced > 1216.81 )
						if( chinkou_span <= 1190.01 )
							ret := -0.916667 // sell
						if( chinkou_span > 1190.01 )
							ret := 0.250000
				if( senkou_span_b > 1309.43 )
					if( senkou_span_b <= 1357.57 )
						ret := 0.769231 // buy
					if( senkou_span_b > 1357.57 )
						ret := -0.355422
...
float op_operation = decision_tree_0_SHOP_30Min_67edf060(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
