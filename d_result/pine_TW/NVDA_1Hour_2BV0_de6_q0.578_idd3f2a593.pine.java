	...
	if( VIP <= 0.903616 )
		...
		if( bearPower > -10.8268 )
			...
			if( bbm > 8.74738 )
				if( VIM <= 1.21231 )
					if( bbm <= 10.6745 )
						if( bearPower <= -10.7237 )
							ret := 1.000000 // buy
						if( bearPower > -10.7237 )
							ret := -0.672414
					if( bbm > 10.6745 )
						if( bullPower <= 1.99726 )
							ret := 0.750000 // buy
						if( bullPower > 1.99726 )
							ret := -0.393701
				if( VIM > 1.21231 )
				...
				if( VIM > 0.567409 )
					if( bbm <= 15.5449 )
						...
						if( bbp > 2.48009 )
							ret := 0.220959
					if( bbm > 15.5449 )
						if( bullPower <= 20.6083 )
							ret := 0.879310 // buy
						if( bullPower > 20.6083 )
							ret := 0.250000
			if( VIM > 0.743053 )
				if( bullPower <= -3.20168 )
					if( VIP_VIM <= -0.352111 )
						if( VIP_VIM <= -0.473935 )
							ret := 0.423077
						if( VIP_VIM > -0.473935 )
							ret := -0.482759
					if( VIP_VIM > -0.352111 )
						if( bullPower <= -4.00009 )
							ret := 0.658879
						if( bullPower > -4.00009 )
							ret := 0.400000
				if( bullPower > -3.20168 )
					if( bearPower <= -6.08421 )
						if( bullPower <= 0.199724 )
							ret := -0.469003
						if( bullPower > 0.199724 )
							ret := -0.194561
					if( bearPower > -6.08421 )
						if( bullPower <= -2.25261 )
							ret := -0.260116
						if( bullPower > -2.25261 )
							ret := 0.027144
		if( VIP > 1.34744 )
			...
			if( bbp > -476.02 )
				if( bbm <= 1.61062 )
					if( bearPower <= 2.31343 )
						if( bullPower <= 1.216 )
							ret := 0.314286
						if( bullPower > 1.216 )
							ret := -0.191489
					if( bearPower > 2.31343 )
						if( bullPower <= 4.91316 )
							ret := 0.380240
						if( bullPower > 4.91316 )
							ret := 0.015686
				if( bbm > 1.61062 )
...
float op_operation = decision_tree_0_NVDA_1Hour_d3f2a593(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
