...
decision_tree_0_UBER_1Day_456bb257(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)=>
	...
	if( bearPower > -0.225444 )
		if( bbp <= 5.38514 )
			if( bullPower <= 3.22837 )
				if( bearPower <= 0.070493 )
					if( VIP_VIM <= 0.112958 )
						ret := -0.075472
					if( VIP_VIM > 0.112958 )
						ret := -0.621622
...
float op_operation = decision_tree_0_UBER_1Day_456bb257(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)
