				...
				if( k <= 87.8246 )
					...
					if( k > 85.4036 )
						...
						if( d > 64.3602 )
							ret := 0.165605
				if( k > 87.8246 )
					if( bullPower <= 1.35235 )
						if( d_k <= 3.90203 )
							ret := -0.208830
						if( d_k > 3.90203 )
							ret := -0.669492
					if( bullPower > 1.35235 )
						if( bearPower <= 4.41379 )
							ret := -0.764706 // sell
						if( bearPower > 4.41379 )
							ret := 1.000000 // buy
	if( d_k > 5.37647 )
		if( bbm <= 0.457842 )
			if( bearPower <= -0.153173 )
				if( smoothD_d <= 89.2763 )
					if( k <= 10.9925 )
						if( d_k <= 23.4435 )
							ret := 0.050379
						if( d_k > 23.4435 )
					...
					if( k > 10.9925 )
						...
						if( rsi1 > 43.065 )
							ret := 0.047475
				if( smoothD_d > 89.2763 )
					if( bearPower <= -0.158038 )
						if( bearPower <= -0.197314 )
							ret := 0.894737 // buy
						if( bearPower > -0.197314 )
							ret := 0.500000
					if( bearPower > -0.158038 )
...
float op_operation = decision_tree_0_ADSK_1Min_6ae04134(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
