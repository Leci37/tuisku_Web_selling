...
decision_tree_0_UNIUSDT_1Day_aa74e5e9(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)=>
	...
	if( Typical_Price > 23.6498 )
		if( Money_Flow_Ratio <= 1.06156 )
			...
			if( Short_MA > 25.4296 )
				if( Long_MA <= 34.1584 )
					if( Negative_Money_Flow_Sum <= 8.24345e+08 )
						ret := -0.548387
					if( Negative_Money_Flow_Sum > 8.24345e+08 )
						ret := 0.400000
				if( Long_MA > 34.1584 )
					if( Negative_Money_Flow_Sum <= 1.34203e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 1.34203e+09 )
						ret := -0.600000
		if( Money_Flow_Ratio > 1.06156 )
			if( Negative_Money_Flow_Sum <= 1.20924e+09 )
				if( Positive_Money_Flow_Sum <= 1.02456e+09 )
					if( Negative_Money_Flow <= 7.17211e+07 )
						ret := -0.191489
					if( Negative_Money_Flow > 7.17211e+07 )
						ret := 0.777778 // buy
				if( Positive_Money_Flow_Sum > 1.02456e+09 )
					if( Negative_Money_Flow_Sum <= 7.62254e+08 )
						ret := -0.859649 // sell
					if( Negative_Money_Flow_Sum > 7.62254e+08 )
						ret := -0.105263
			if( Negative_Money_Flow_Sum > 1.20924e+09 )
				if( Typical_Price <= 36.8958 )
					ret := 1.000000 // buy
				if( Typical_Price > 36.8958 )
					ret := 0.333333
...
float op_operation = decision_tree_0_UNIUSDT_1Day_aa74e5e9(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
