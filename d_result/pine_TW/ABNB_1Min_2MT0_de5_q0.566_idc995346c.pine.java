			...
			if( Typical_Price > 111.482 )
				...
				if( ema12 > -2.40415 )
					...
					if( Positive_Money_Flow_Sum > 1.97859e+07 )
						ret := 0.140724
	if( ema12 > 0.037687 )
		if( Positive_Money_Flow_Sum <= 5.68918e+07 )
			if( MFI_Low <= 76.0033 )
				if( ema12 <= 0.497673 )
					if( Negative_Money_Flow_Sum <= 1.51793e+07 )
						ret := -0.071542
					if( Negative_Money_Flow_Sum > 1.51793e+07 )
						ret := 0.080611
				if( ema12 > 0.497673 )
			...
			if( MFI_Low > 76.0033 )
				if( ema13 <= 0.775224 )
					if( Positive_Money_Flow <= 1.79667e+07 )
						ret := 0.604240
					if( Positive_Money_Flow > 1.79667e+07 )
						ret := -0.562500
				if( ema13 > 0.775224 )
					if( Positive_Money_Flow <= 1.08215e+07 )
						ret := -0.727273 // sell
					if( Positive_Money_Flow > 1.08215e+07 )
						ret := 0.500000
		if( Positive_Money_Flow_Sum > 5.68918e+07 )
			if( ema2 <= 127.752 )
				if( ema12 <= 0.138875 )
					...
					if( ema12 > 0.052919 )
						ret := -0.560976
				if( ema12 > 0.138875 )
					if( Positive_Money_Flow <= 35784.1 )
						ret := 0.705882 // buy
					if( Positive_Money_Flow > 35784.1 )
						ret := 0.066667
			if( ema2 > 127.752 )
				if( ema2 <= 148.406 )
					if( Positive_Money_Flow_Sum <= 7.75956e+07 )
						ret := -0.773438 // sell
					if( Positive_Money_Flow_Sum > 7.75956e+07 )
						ret := -0.212500
				if( ema2 > 148.406 )
...
float op_operation = decision_tree_0_ABNB_1Min_c995346c(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
