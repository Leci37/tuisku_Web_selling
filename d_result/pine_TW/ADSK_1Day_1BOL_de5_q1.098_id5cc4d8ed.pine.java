...
decision_tree_0_ADSK_1Day_5cc4d8ed(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)=>
	...
	if( dif_source_BBlower > 29.0465 )
		...
		if( dif_source_BBupper > -29.6787 )
			if( BBlower <= 162.22 )
				if( BBupper <= 207.581 )
					if( dif_source_BBlower <= 48.1379 )
						ret := -0.074297
					if( dif_source_BBlower > 48.1379 )
						ret := -0.504274
				if( BBupper > 207.581 )
					if( dif_source_BBlower <= 108.541 )
						ret := 0.650000
					if( dif_source_BBlower > 108.541 )
						ret := -0.225806
			if( BBlower > 162.22 )
...
float op_operation = decision_tree_0_ADSK_1Day_5cc4d8ed(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
