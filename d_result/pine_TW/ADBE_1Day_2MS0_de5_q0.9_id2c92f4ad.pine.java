	...
	if( Typical_Price > 543.16 )
		if( Money_Flow_Ratio <= 0.419146 )
			if( smoothK_k <= 0.026714 )
				ret := -0.500000
			if( smoothK_k > 0.026714 )
				if( Positive_Money_Flow_Sum <= 8.73739e+09 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 8.73739e+09 )
					ret := 0.000000
		if( Money_Flow_Ratio > 0.419146 )
			if( k <= 45.2135 )
				if( Positive_Money_Flow <= 1.47521e+09 )
					if( MFI_High <= -38.5579 )
						ret := -0.806452 // sell
					if( MFI_High > -38.5579 )
						ret := -0.218391
				if( Positive_Money_Flow > 1.47521e+09 )
					...
					if( k > 15.324 )
						ret := -0.985294 // sell
			if( k > 45.2135 )
				if( Typical_Price <= 571.576 )
					if( Money_Flow_Ratio <= 0.734576 )
						ret := 1.000000 // buy
					if( Money_Flow_Ratio > 0.734576 )
						ret := -0.600000
				if( Typical_Price > 571.576 )
					if( Raw_Money_Flow <= 1.82196e+09 )
						ret := 0.392857
					if( Raw_Money_Flow > 1.82196e+09 )
						ret := -0.800000 // sell
...
float op_operation = decision_tree_0_ADBE_1Day_2c92f4ad(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
