...
decision_tree_0_FFIV_1Day_c9ede342(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( Lower_Band > 103.134 )
		...
		if( basis > 206.444 )
			...
			if( Upper_Band > 223.644 )
				if( basis <= 231.615 )
					if( Upper_Band <= 229.834 )
						ret := -0.176471
					if( Upper_Band > 229.834 )
						ret := 0.511628
				if( basis > 231.615 )
					if( bullPower <= -1.19385 )
						ret := -0.187500
					if( bullPower > -1.19385 )
						ret := -0.965517 // sell
...
float op_operation = decision_tree_0_FFIV_1Day_c9ede342(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
