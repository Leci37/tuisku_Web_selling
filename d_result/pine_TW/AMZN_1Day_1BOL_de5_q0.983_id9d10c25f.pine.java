...
decision_tree_0_AMZN_1Day_9d10c25f(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)=>
	...
	if( BBlower > -349.181 )
		if( BBlower <= 1123.12 )
			if( dif_source_BBupper <= -118.49 )
				if( dif_source_BBlower <= 223.1 )
					if( vrsi <= 78.973 )
						ret := 0.909091 // buy
					if( vrsi > 78.973 )
						ret := -0.666667
			...
			if( dif_source_BBupper > -118.49 )
				...
				if( dif_source_BBlower > 40.287 )
					...
					if( BBlower > 77.381 )
						ret := 0.152334
		if( BBlower > 1123.12 )
			if( dif_source_BBlower <= 418.948 )
				if( dif_source_BBlower <= -1606.79 )
					ret := -1.000000 // sell
				if( dif_source_BBlower > -1606.79 )
					if( BBupper <= 3644.58 )
						ret := 0.275728
					if( BBupper > 3644.58 )
						ret := -0.160410
			if( dif_source_BBlower > 418.948 )
				if( dif_source_BBupper <= 34.5632 )
					if( dif_source_BBlower <= 875.949 )
						ret := -0.630058
					if( dif_source_BBlower > 875.949 )
						ret := -0.107784
				if( dif_source_BBupper > 34.5632 )
...
float op_operation = decision_tree_0_AMZN_1Day_9d10c25f(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
