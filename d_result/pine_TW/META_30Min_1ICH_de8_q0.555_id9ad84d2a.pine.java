				...
				if( senkou_span_b <= 105.128 )
					...
					if( basis_minus > 0.16834 )
						...
						if( chinkou_span > 103.695 )
							ret := 0.612245
				if( senkou_span_b > 105.128 )
					if( chinkou_span <= 506.302 )
						if( kinjun_sen <= 497.028 )
							if( basis_minus <= 1.66687 )
								if( chinkou_span <= 490.955 )
									ret := 0.010168
								if( chinkou_span > 490.955 )
									ret := 0.481481
							if( basis_minus > 1.66687 )
								if( chinkou_span <= 475.448 )
									ret := -0.067018
								if( chinkou_span > 475.448 )
									ret := 0.357337
						if( kinjun_sen > 497.028 )
							if( basis_max <= 0.036681 )
								ret := -0.652824
							if( basis_max > 0.036681 )
								if( chinkou_span <= 488.675 )
									ret := -0.706667 // sell
								if( chinkou_span > 488.675 )
									ret := -0.013289
					if( chinkou_span > 506.302 )
						if( kinjun_sen <= 516.631 )
							if( senkou_span_a <= 503.163 )
								ret := 0.641221
							if( senkou_span_a > 503.163 )
								ret := 0.298060
						if( kinjun_sen > 516.631 )
							if( chinkou_span <= 526.047 )
								if( tenkan_sen <= 520.574 )
									ret := 0.155378
								if( tenkan_sen > 520.574 )
									ret := -0.549645
							if( chinkou_span > 526.047 )
								if( senkou_span_a <= 590.4 )
									ret := 0.173504
								if( senkou_span_a > 590.4 )
									ret := -0.793103 // sell
...
float op_operation = decision_tree_0_META_30Min_9ad84d2a(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
