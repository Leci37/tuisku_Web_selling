				...
				if( MFI_Low > 28.5386 )
					...
					if( MFI > 53.7167 )
						...
						if( MA_Cross > 1.01163 )
							ret := -1.000000 // sell
		if( Raw_Money_Flow > 15658.9 )
			if( Short_Long_Diff <= 0.475964 )
				if( MFI_High <= -67.0485 )
					if( Long_MA <= 36.822 )
						if( Positive_Money_Flow_Sum <= 1.44451e+06 )
							ret := 0.474490
						if( Positive_Money_Flow_Sum > 1.44451e+06 )
							ret := 0.075540
					if( Long_MA > 36.822 )
						ret := 0.819277 // buy
				if( MFI_High > -67.0485 )
					if( Typical_Price <= 38.9547 )
						if( Negative_Money_Flow <= 9470.84 )
							ret := 0.393939
						if( Negative_Money_Flow > 9470.84 )
							ret := 0.009100
					if( Typical_Price > 38.9547 )
						if( Raw_Money_Flow <= 1.09048e+06 )
							ret := -0.826087 // sell
						if( Raw_Money_Flow > 1.09048e+06 )
							ret := -0.137500
			if( Short_Long_Diff > 0.475964 )
				if( MFI <= 42.2227 )
					if( Typical_Price <= 38.9683 )
						ret := 0.700000 // buy
					if( Typical_Price > 38.9683 )
						ret := -1.000000 // sell
				if( MFI > 42.2227 )
...
float op_operation = decision_tree_0_CRSR_1Hour_481040a4(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
