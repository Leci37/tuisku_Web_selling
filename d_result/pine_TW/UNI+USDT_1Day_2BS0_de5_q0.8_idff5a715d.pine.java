			...
			if( rsi1 <= 73.1938 )
				...
				if( bbp > 4.51106 )
					...
					if( d > 85.2509 )
						ret := -0.666667
			if( rsi1 > 73.1938 )
				if( bullPower <= 5.02237 )
					if( bullPower <= 1.71018 )
						ret := 0.312500
					if( bullPower > 1.71018 )
						ret := 0.833333 // buy
				if( bullPower > 5.02237 )
					if( smoothD_d <= 76.7043 )
						ret := -0.500000
					if( smoothD_d > 76.7043 )
						ret := 0.750000 // buy
...
float op_operation = decision_tree_0_UNIUSDT_1Day_ff5a715d(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)
