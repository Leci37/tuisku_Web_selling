			...
			if( senkou_span_a_displaced > 11.5598 )
				if( senkou_span_a_displaced <= 11.6888 )
					...
					if( tenkan_sen > 11.0978 )
						ret := 1.000000 // buy
				if( senkou_span_a_displaced > 11.6888 )
					if( senkou_span_b <= 13.9875 )
						ret := 0.548193
					if( senkou_span_b > 13.9875 )
						ret := 0.060000
		if( kinjun_sen > 13.36 )
			if( basis_minus <= 1.8618 )
				if( chinkou_span <= 12.4192 )
					if( senkou_span_a_displaced <= 27.2886 )
						ret := -0.684211
					if( senkou_span_a_displaced > 27.2886 )
						ret := -0.058824
				if( chinkou_span > 12.4192 )
					if( tenkan_sen <= 14.1298 )
						ret := 0.560606
					if( tenkan_sen > 14.1298 )
						ret := -0.138187
			if( basis_minus > 1.8618 )
				if( chinkou_span <= 21.938 )
					if( kinjun_sen <= 22.4505 )
						ret := 0.113208
					if( kinjun_sen > 22.4505 )
						ret := -0.705882 // sell
				if( chinkou_span > 21.938 )
					if( senkou_span_a_displaced <= 23.1506 )
						ret := 0.708333 // buy
					if( senkou_span_a_displaced > 23.1506 )
						ret := 0.164894
...
float op_operation = decision_tree_0_SNAP_1Day_b72586b2(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
