			...
			if( k > 93.9366 )
				...
				if( d > 98.0801 )
					...
					if( d > 99.2754 )
						ret := 0.000000
		if( rsi1 > 60.9722 )
			if( smoothD_d <= 71.2242 )
				if( smoothD_d <= 27.5311 )
					if( smoothD_d <= 17.3699 )
						ret := 0.152174
					if( smoothD_d > 17.3699 )
						ret := 0.812500 // buy
				if( smoothD_d > 27.5311 )
...
float op_operation = decision_tree_0_FFIV_1Day_74ed4fde(d, d_k, smoothK_k, k, rsi1, smoothD_d)
