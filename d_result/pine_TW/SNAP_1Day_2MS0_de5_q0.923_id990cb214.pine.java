			...
			if( Negative_Money_Flow > 7.94583e+08 )
				...
				if( k > 6.81537 )
					...
					if( Positive_Money_Flow_Sum > 3.08819e+09 )
						ret := 0.836207 // buy
		if( Positive_Money_Flow_Sum > 6.14002e+09 )
			if( smoothD_d <= 9.50734 )
				if( Raw_Money_Flow <= 1.27614e+09 )
					if( d_k <= 0.1418 )
						ret := 1.000000 // buy
					if( d_k > 0.1418 )
						ret := 0.181818
				if( Raw_Money_Flow > 1.27614e+09 )
					if( smoothK_k <= 8.52675 )
						ret := 0.000000
					if( smoothK_k > 8.52675 )
						ret := -1.000000 // sell
			if( smoothD_d > 9.50734 )
				if( Raw_Money_Flow <= 5.51969e+08 )
					if( MFI_High <= -6.77544 )
						ret := 0.606061
					if( MFI_High > -6.77544 )
						ret := -0.769231 // sell
				if( Raw_Money_Flow > 5.51969e+08 )
					if( Typical_Price <= 30.1793 )
						ret := -0.800000 // sell
					if( Typical_Price > 30.1793 )
						ret := -0.272131
...
float op_operation = decision_tree_0_SNAP_1Day_990cb214(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
