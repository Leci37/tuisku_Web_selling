			...
			if( Typical_Price > 21.0617 )
				if( MFI_Low <= 26.4966 )
					...
					if( Positive_Money_Flow > 5.2837e+07 )
						ret := -0.250000
				if( MFI_Low > 26.4966 )
					if( Negative_Money_Flow_Sum <= 5.04795e+08 )
						ret := 0.297872
					if( Negative_Money_Flow_Sum > 5.04795e+08 )
						ret := -0.154930
		if( Typical_Price > 40.9164 )
			if( Negative_Money_Flow <= 5.88419e+07 )
				if( Positive_Money_Flow_Sum <= 5.66725e+08 )
					if( Positive_Money_Flow <= 2.8546e+07 )
						ret := -0.611111
					if( Positive_Money_Flow > 2.8546e+07 )
						ret := 0.243243
				if( Positive_Money_Flow_Sum > 5.66725e+08 )
					...
					if( mf > -0.012965 )
						ret := -0.803030 // sell
			if( Negative_Money_Flow > 5.88419e+07 )
				if( Positive_Money_Flow_Sum <= 5.87386e+08 )
					ret := 0.500000
				if( Positive_Money_Flow_Sum > 5.87386e+08 )
					if( Money_Flow_Ratio <= 2.05667 )
						ret := 0.000000
					if( Money_Flow_Ratio > 2.05667 )
						ret := 0.250000
...
float op_operation = decision_tree_0_NVST_1Day_1c242511(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
