			...
			if( Upper_Band <= 84.0034 )
				...
				if( Lower_Band > 30.6064 )
					...
					if( Lower_Band > 51.2903 )
						ret := 0.684211
			if( Upper_Band > 84.0034 )
				if( Upper_Band <= 116.117 )
					if( bearPower <= 5.64836 )
						ret := -0.810127 // sell
					if( bearPower > 5.64836 )
						ret := -0.333333
				if( Upper_Band > 116.117 )
					if( Upper_Band <= 131.66 )
						ret := 0.562500
					if( Upper_Band > 131.66 )
						ret := -0.160955
		if( Upper_Band > 1635.12 )
			if( Upper_Band <= 1723.6 )
				ret := -0.714286 // sell
			if( Upper_Band > 1723.6 )
				if( Upper_Band <= 1743.53 )
					ret := -1.000000 // sell
				if( Upper_Band > 1743.53 )
					ret := -0.857143 // sell
...
float op_operation = decision_tree_0_SHOP_1Day_c52bd649(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
