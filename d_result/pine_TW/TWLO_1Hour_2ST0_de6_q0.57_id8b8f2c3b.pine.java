...
decision_tree_0_TWLO_1Hour_8b8f2c3b(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)=>
	...
	if( ema2 > 389.473 )
		if( ema1 <= 412.007 )
			if( ema3 <= 409.244 )
				if( smoothD_d <= 38.3307 )
					if( smoothK_k <= 2.39205 )
						if( ema1 <= 396.677 )
							ret := 0.281250
						if( ema1 > 396.677 )
							ret := -0.650000
...
float op_operation = decision_tree_0_TWLO_1Hour_8b8f2c3b(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)
