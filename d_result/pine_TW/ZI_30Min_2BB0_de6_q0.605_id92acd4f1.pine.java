	...
	if( bearPower <= 0.122505 )
		...
		if( Upper_Band > 9.27556 )
			...
			if( bbm > 0.023834 )
				...
				if( Upper_Band > 55.8517 )
					if( bbp <= -5.05046 )
						if( Upper_Band <= 60.6526 )
							ret := -1.000000 // sell
						if( Upper_Band > 60.6526 )
							ret := -0.500000
					if( bbp > -5.05046 )
						if( Lower_Band <= 47.2799 )
							ret := -0.790698 // sell
						if( Lower_Band > 47.2799 )
							ret := -0.056667
	if( bearPower > 0.122505 )
		if( bbp <= 5.33965 )
			if( bbm <= 0.06197 )
				if( Upper_Band <= 31.0969 )
					if( bbp <= 0.764753 )
						if( bearPower <= 0.168978 )
							ret := -0.342342
						if( bearPower > 0.168978 )
							ret := -0.640816
					if( bbp > 0.764753 )
						if( Lower_Band <= 15.2296 )
							ret := 0.739130 // buy
						if( Lower_Band > 15.2296 )
							ret := -0.487179
				if( Upper_Band > 31.0969 )
					if( bearPower <= 0.5831 )
						if( Upper_Band <= 42.588 )
							ret := 0.357895
						if( Upper_Band > 42.588 )
							ret := -0.138810
					if( bearPower > 0.5831 )
						if( Upper_Band <= 51.8334 )
							ret := -0.676647
						if( Upper_Band > 51.8334 )
							ret := -0.328671
			if( bbm > 0.06197 )
				if( Lower_Band <= 27.3686 )
					if( basis <= 26.2888 )
						if( bullPower <= 0.75717 )
							ret := 0.109735
						if( bullPower > 0.75717 )
							ret := -0.578947
					if( basis > 26.2888 )
				...
				if( Lower_Band > 27.3686 )
					if( bbm <= 0.530423 )
						if( bullPower <= 0.582785 )
							ret := -0.086505
						if( bullPower > 0.582785 )
							ret := -0.261877
					if( bbm > 0.530423 )
						if( Upper_Band <= 72.1659 )
							ret := -0.002778
						if( Upper_Band > 72.1659 )
							ret := -0.864865 // sell
		if( bbp > 5.33965 )
			if( bearPower <= 0.789742 )
				ret := 1.000000 // buy
			if( bearPower > 0.789742 )
				if( bearPower <= 2.36032 )
					ret := -1.000000 // sell
				if( bearPower > 2.36032 )
					if( Upper_Band <= 55.4418 )
						ret := -0.166667
					if( Upper_Band > 55.4418 )
						ret := -0.923077 // sell
...
float op_operation = decision_tree_0_ZI_30Min_92acd4f1(basis, Lower_Band, Upper_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
