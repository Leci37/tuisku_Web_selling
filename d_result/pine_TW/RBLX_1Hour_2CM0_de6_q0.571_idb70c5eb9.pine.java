			...
			if( ad_mf > -8847.38 )
				if( Typical_Price <= 40.0175 )
					if( Negative_Money_Flow_Sum <= 1.15423e+08 )
						if( Typical_Price <= 29.5402 )
							ret := -0.092958
						if( Typical_Price > 29.5402 )
							ret := 0.231923
					if( Negative_Money_Flow_Sum > 1.15423e+08 )
						if( Negative_Money_Flow <= 1.03464e+06 )
							ret := -0.005741
						if( Negative_Money_Flow > 1.03464e+06 )
							ret := 0.296552
				if( Typical_Price > 40.0175 )
					if( Positive_Money_Flow_Sum <= 1.95223e+09 )
						if( Positive_Money_Flow_Sum <= 1.45103e+09 )
							ret := -0.083863
						if( Positive_Money_Flow_Sum > 1.45103e+09 )
							ret := 0.718750 // buy
					if( Positive_Money_Flow_Sum > 1.95223e+09 )
						...
						if( mf > 0.376257 )
							ret := -0.871429 // sell
		if( Negative_Money_Flow_Sum > 2.99447e+08 )
			if( Raw_Money_Flow <= 6.31254e+08 )
				if( MFI_High <= -3.28475 )
					if( Typical_Price <= 90.6108 )
						if( mf <= 0.378858 )
							ret := -0.098449
						if( mf > 0.378858 )
							ret := 0.673913
					if( Typical_Price > 90.6108 )
						if( Positive_Money_Flow_Sum <= 2.63771e+09 )
							ret := 0.180077
						if( Positive_Money_Flow_Sum > 2.63771e+09 )
							ret := -0.455446
				if( MFI_High > -3.28475 )
					ret := 0.430657
			if( Raw_Money_Flow > 6.31254e+08 )
				if( Positive_Money_Flow_Sum <= 2.30584e+09 )
					ret := -0.770270 // sell
				if( Positive_Money_Flow_Sum > 2.30584e+09 )
					ret := -0.111111
...
float op_operation = decision_tree_0_RBLX_1Hour_b70c5eb9(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
