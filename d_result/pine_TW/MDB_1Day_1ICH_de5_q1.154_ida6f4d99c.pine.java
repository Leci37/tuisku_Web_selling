			...
			if( chinkou_span > 295.59 )
				...
				if( basis_minus > 3.58046 )
					...
					if( senkou_span_b_displaced > 341.071 )
						ret := -0.800000 // sell
	if( senkou_span_b > 299.938 )
		if( basis_max <= 28.8117 )
			if( basis_minus <= -69.853 )
				if( cross_up_tenkan_kinjunInt <= 0.5 )
					ret := 1.000000 // buy
				if( cross_up_tenkan_kinjunInt > 0.5 )
					ret := 0.000000
			if( basis_minus > -69.853 )
				if( chinkou_span <= 332.298 )
					if( basis_minus <= 32.9435 )
						ret := -0.684896
					if( basis_minus > 32.9435 )
						ret := 0.222222
				if( chinkou_span > 332.298 )
					if( senkou_span_b <= 432.929 )
						ret := 0.086154
					if( senkou_span_b > 432.929 )
						ret := -0.526570
		if( basis_max > 28.8117 )
			if( senkou_span_b <= 313.033 )
				ret := 0.250000
			if( senkou_span_b > 313.033 )
				if( basis_minus <= -41.9573 )
					if( senkou_span_b_displaced <= 372.355 )
						ret := 0.875000 // buy
					if( senkou_span_b_displaced > 372.355 )
						ret := 1.000000 // buy
				if( basis_minus > -41.9573 )
...
float op_operation = decision_tree_0_MDB_1Day_a6f4d99c(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
