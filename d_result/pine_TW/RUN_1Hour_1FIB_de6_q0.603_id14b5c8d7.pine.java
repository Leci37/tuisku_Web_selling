				...
				if( upper_6 > 92.743 )
					...
					if( upper_3 > 82.771 )
						...
						if( upper_5 > 90.4791 )
							ret := -0.085443
			if( basis_max > -20.2391 )
				if( basis_minus <= 17.3551 )
					if( basis_minus <= 1.91003 )
						if( lower_6 <= 12.5898 )
							ret := -0.038339
						if( lower_6 > 12.5898 )
							ret := 0.281287
...
float op_operation = decision_tree_0_RUN_1Hour_14b5c8d7(basis, upper_2, upper_3, lower_2, lower_6, lower_1, basis_minus, lower_3, upper_6, lower_5, lower_4, upper_5, upper_4, basis_max, upper_1)
