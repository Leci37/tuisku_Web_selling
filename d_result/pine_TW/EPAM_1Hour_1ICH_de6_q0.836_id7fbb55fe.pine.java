				...
				if( tenkan_sen > 331.93 )
					if( chinkou_span <= 331.652 )
						...
						if( basis_minus > -18.0419 )
							ret := -0.721232 // sell
					if( chinkou_span > 331.652 )
						if( kinjun_sen <= 366.936 )
							ret := -0.013171
						if( kinjun_sen > 366.936 )
							ret := -0.731707 // sell
			if( chinkou_span > 369.453 )
				if( senkou_span_a_displaced <= 420.953 )
					if( basis_max <= -8.71959 )
						ret := -0.523810
					if( basis_max > -8.71959 )
						if( chinkou_span <= 402.514 )
							ret := 0.386139
						if( chinkou_span > 402.514 )
							ret := 0.694737
				if( senkou_span_a_displaced > 420.953 )
					if( chinkou_span <= 676.339 )
						if( senkou_span_b_displaced <= 602.744 )
							ret := 0.066495
						if( senkou_span_b_displaced > 602.744 )
							ret := -0.296552
					if( chinkou_span > 676.339 )
						if( basis_minus <= 7.65594 )
							ret := 0.852459 // buy
						if( basis_minus > 7.65594 )
							ret := 0.028571
	if( senkou_span_a_displaced > 665.695 )
		if( basis_minus <= -14.4199 )
			if( chinkou_span <= 542.297 )
				ret := -1.000000 // sell
			if( chinkou_span > 542.297 )
				if( basis_minus <= -15.0712 )
					ret := -0.172414
				if( basis_minus > -15.0712 )
					ret := 1.000000 // buy
		if( basis_minus > -14.4199 )
			if( senkou_span_a_displaced <= 701.615 )
				ret := -0.754839 // sell
			if( senkou_span_a_displaced > 701.615 )
				ret := -0.058824
...
float op_operation = decision_tree_0_EPAM_1Hour_7fbb55fe(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
