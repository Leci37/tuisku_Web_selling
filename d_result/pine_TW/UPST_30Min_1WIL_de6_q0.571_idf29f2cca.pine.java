				...
				if( sDev <= 1.21949 )
					...
					if( midLine > 2.09634 )
						...
						if( colInt > 0.5 )
							ret := 0.281250
				if( sDev > 1.21949 )
					if( upperBand <= 4.36825 )
						if( wvf <= 5.69338 )
							ret := 0.075736
						if( wvf > 5.69338 )
							ret := 0.942857 // buy
					if( upperBand > 4.36825 )
						if( lowerBand <= -3.54403 )
							ret := 0.272727
						if( lowerBand > -3.54403 )
							ret := -0.078168
	if( midLine > 6.44785 )
		if( wvf <= 34.4679 )
			if( upperBand <= 39.1723 )
				if( Color_con2 <= -2.92168 )
					if( upperBand <= 18.9669 )
						if( sDev <= 9.30087 )
							ret := -0.252670
						if( sDev > 9.30087 )
							ret := 0.476636
...
float op_operation = decision_tree_0_UPST_30Min_f29f2cca(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
