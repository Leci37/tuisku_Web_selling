			...
			if( BBPower_Color > 0.5 )
				...
				if( Raw_Money_Flow > 8.7574e+06 )
					...
					if( Raw_Money_Flow > 5.42091e+08 )
						ret := -0.342857
	if( bearPower > 0.087412 )
		if( Typical_Price <= 101.197 )
			if( MFI_High <= -19.6689 )
				if( bullPower <= 4.17395 )
					if( MFI_Low <= 31.3711 )
						ret := 0.142857
					if( MFI_Low > 31.3711 )
						ret := 0.861111 // buy
				if( bullPower > 4.17395 )
					if( Raw_Money_Flow <= 1.87081e+08 )
						ret := -0.900000 // sell
					if( Raw_Money_Flow > 1.87081e+08 )
						ret := 0.125000
			if( MFI_High > -19.6689 )
				if( Positive_Money_Flow_Sum <= 1.04783e+08 )
					if( bbp <= 1.38782 )
						ret := 0.000000
					if( bbp > 1.38782 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 1.04783e+08 )
					if( Positive_Money_Flow_Sum <= 6.85415e+08 )
						ret := 0.846847 // buy
					if( Positive_Money_Flow_Sum > 6.85415e+08 )
						ret := 0.548173
		if( Typical_Price > 101.197 )
			if( Negative_Money_Flow_Sum <= 2.63266e+09 )
				if( Raw_Money_Flow <= 9.40978e+08 )
					if( bbp <= 35.3721 )
						ret := -0.632075
					if( bbp > 35.3721 )
						ret := 0.300000
				if( Raw_Money_Flow > 9.40978e+08 )
					if( Money_Flow_Ratio <= 5.33242 )
						ret := 0.533333
					if( Money_Flow_Ratio > 5.33242 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 2.63266e+09 )
				if( Money_Flow_Ratio <= 3.13843 )
					if( Typical_Price <= 137.507 )
						ret := -0.166667
					if( Typical_Price > 137.507 )
						ret := 0.523077
				if( Money_Flow_Ratio > 3.13843 )
...
float op_operation = decision_tree_0_SOLUSDT_1Day_58923442(bbm, bearPower, bbp, bullPower, BBPower_Color, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
