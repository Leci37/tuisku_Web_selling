			...
			if( Negative_Money_Flow > 5.32812e+09 )
				...
				if( Negative_Money_Flow_Sum > 1.29611e+11 )
					...
					if( Money_Flow_Ratio > 0.49448 )
						ret := 0.800000 // buy
	if( Negative_Money_Flow_Sum > 1.39637e+11 )
		if( Typical_Price <= 114.065 )
			if( Positive_Money_Flow_Sum <= 1.0951e+11 )
				ret := 1.000000 // buy
			if( Positive_Money_Flow_Sum > 1.0951e+11 )
				ret := 0.000000
		if( Typical_Price > 114.065 )
			if( MFI_Low <= 1.44741 )
				if( Money_Flow_Ratio <= 0.21559 )
					if( MFI <= 12.0645 )
						ret := 0.000000
					if( MFI > 12.0645 )
						ret := 1.000000 // buy
				if( Money_Flow_Ratio > 0.21559 )
					if( Negative_Money_Flow <= 2.6773e+10 )
						ret := 0.100000
					if( Negative_Money_Flow > 2.6773e+10 )
						ret := 1.000000 // buy
			if( MFI_Low > 1.44741 )
				if( Negative_Money_Flow <= 1.79361e+10 )
					if( MFI_High <= -28.8365 )
						ret := -0.774038 // sell
					if( MFI_High > -28.8365 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_AAPL_1Day_6b0d4347(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
