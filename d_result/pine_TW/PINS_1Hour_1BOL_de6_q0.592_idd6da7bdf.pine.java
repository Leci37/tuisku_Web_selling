...
decision_tree_0_PINS_1Hour_d6da7bdf(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower > 67.1726 )
		if( BBupper <= 72.4797 )
			ret := 0.457627
		if( BBupper > 72.4797 )
			if( dif_source_BBupper <= -26.0012 )
				ret := 1.000000 // buy
			if( dif_source_BBupper > -26.0012 )
				if( BBupper <= 90.771 )
					if( dif_source_BBupper <= -10.8563 )
						if( dif_source_BBlower <= -1.71894 )
							ret := -0.755102 // sell
						if( dif_source_BBlower > -1.71894 )
							ret := 0.211340
					if( dif_source_BBupper > -10.8563 )
...
float op_operation = decision_tree_0_PINS_1Hour_d6da7bdf(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
