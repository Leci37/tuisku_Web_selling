			...
			if( kinjun_sen <= 0.422044 )
				if( basis_minus <= 0.02304 )
					...
					if( chinkou_span > 0.281845 )
						ret := -0.379913
				if( basis_minus > 0.02304 )
					if( chinkou_span <= 0.36804 )
						ret := 0.931034 // buy
					if( chinkou_span > 0.36804 )
						ret := -0.100000
			if( kinjun_sen > 0.422044 )
				if( senkou_span_a <= 0.541582 )
					if( senkou_span_b_displaced <= 0.350107 )
						ret := 0.823529 // buy
					if( senkou_span_b_displaced > 0.350107 )
						ret := -0.509972
				if( senkou_span_a > 0.541582 )
					if( kinjun_sen <= 0.794474 )
						ret := -0.887500 // sell
					if( kinjun_sen > 0.794474 )
						ret := -0.250000
		if( chinkou_span > 0.462563 )
			if( senkou_span_b <= 0.602628 )
				if( tenkan_sen <= 0.4595 )
					if( senkou_span_a_displaced <= 0.498073 )
						ret := 0.800000 // buy
					if( senkou_span_a_displaced > 0.498073 )
						ret := 0.333333
				if( tenkan_sen > 0.4595 )
					if( senkou_span_a_displaced <= 0.474974 )
						ret := -0.284404
					if( senkou_span_a_displaced > 0.474974 )
						ret := 0.356201
			if( senkou_span_b > 0.602628 )
				if( senkou_span_b <= 1.11296 )
					if( chinkou_span <= 1.1422 )
						ret := -0.217993
					if( chinkou_span > 1.1422 )
						ret := 0.942529 // buy
				if( senkou_span_b > 1.11296 )
					if( basis_max <= 0.123962 )
						ret := -0.532020
					if( basis_max > 0.123962 )
						ret := 0.857143 // buy
...
float op_operation = decision_tree_0_XRPUSDT_1Day_f6988e61(basis_minus, senkou_span_b, cross_dn_tenkan_kinjunInt, cross_up_tenkan_kinjunInt, kinjun_sen, tenkan_sen, senkou_span_b_displaced, senkou_span_a, senkou_span_a_displaced, basis_max, chinkou_span)
