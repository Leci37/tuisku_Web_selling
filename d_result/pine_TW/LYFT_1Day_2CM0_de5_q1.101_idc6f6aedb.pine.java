...
decision_tree_0_LYFT_1Day_c6f6aedb(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Typical_Price > 13.0771 )
		...
		if( Money_Flow_Ratio > 0.199695 )
			if( MFI_Low <= 11.2981 )
				if( mf <= -0.220666 )
					if( Negative_Money_Flow_Sum <= 3.64702e+09 )
						ret := 0.888889 // buy
					if( Negative_Money_Flow_Sum > 3.64702e+09 )
						ret := 0.193548
				if( mf > -0.220666 )
					if( Negative_Money_Flow_Sum <= 4.17142e+09 )
						ret := 0.474359
					if( Negative_Money_Flow_Sum > 4.17142e+09 )
						ret := -0.888889 // sell
			if( MFI_Low > 11.2981 )
				if( Money_Flow_Ratio <= 0.799829 )
					if( mf <= -0.15351 )
						ret := -0.177778
					if( mf > -0.15351 )
						ret := -0.612440
...
float op_operation = decision_tree_0_LYFT_1Day_c6f6aedb(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
