...
decision_tree_0_ADSK_1Hour_80d2787c(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)=>
				...
				if( nvi_ema <= 0.728508 )
					if( azul_mean <= 21.5846 )
						...
						if( source > 226.885 )
							ret := 0.275862
					if( azul_mean > 21.5846 )
						if( verde_mean <= -10.5342 )
							ret := 0.777778 // buy
						if( verde_mean > -10.5342 )
							ret := -0.476471
				if( nvi_ema > 0.728508 )
					if( verde_mean <= -9.18248 )
						if( pvimin <= -0.007627 )
							ret := -0.682171
						if( pvimin > -0.007627 )
							ret := -0.117647
	...
	if( media_azul > 37.6279 )
		if( stoc <= 91.3007 )
			if( verde_media <= -34.7082 )
				if( pvimin <= -0.175636 )
					if( nvimin <= 0.368189 )
						if( verde_media <= -45.4147 )
							ret := 0.971429 // buy
						if( verde_media > -45.4147 )
							ret := 0.312500
					if( nvimin > 0.368189 )
						if( media_azul <= 53.0276 )
							ret := -0.260870
						if( media_azul > 53.0276 )
							ret := 0.500000
				if( pvimin > -0.175636 )
		...
		if( stoc > 91.3007 )
			if( nvimin <= 0.662635 )
				if( media_azul <= 60.5537 )
					if( azul_mean <= 12.9582 )
						ret := 0.181818
					if( azul_mean > 12.9582 )
						if( media <= 84.5935 )
							ret := -0.824324 // sell
...
float op_operation = decision_tree_0_ADSK_1Hour_80d2787c(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
