				...
				if( senkou_span_b_displaced <= 130.802 )
					if( senkou_span_b_displaced <= 128.706 )
						...
						if( senkou_span_b_displaced > 124.115 )
							ret := -0.972973 // sell
					if( senkou_span_b_displaced > 128.706 )
						if( senkou_span_a_displaced <= 129.157 )
							ret := 0.538462
						if( senkou_span_a_displaced > 129.157 )
							ret := -0.058824
				if( senkou_span_b_displaced > 130.802 )
					if( basis_max <= -0.512711 )
						ret := -1.000000 // sell
					if( basis_max > -0.512711 )
						if( basis_max <= 0.561479 )
							ret := -0.400000
						if( basis_max > 0.561479 )
							ret := -0.965517 // sell
			if( senkou_span_b_displaced > 134.588 )
				if( senkou_span_b <= 137.255 )
					ret := 0.300000
				if( senkou_span_b > 137.255 )
					ret := -0.454545
	if( basis_max > 2.93866 )
		if( tenkan_sen <= 37.3873 )
			ret := 0.454545
		if( tenkan_sen > 37.3873 )
			if( chinkou_span <= 76.99 )
				if( chinkou_span <= 64.9754 )
					if( kinjun_sen <= 54.3961 )
						if( basis_max <= 3.25563 )
							ret := -0.900000 // sell
						if( basis_max > 3.25563 )
							ret := -1.000000 // sell
					if( kinjun_sen > 54.3961 )
...
float op_operation = decision_tree_0_ASAN_30Min_233a077f(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
