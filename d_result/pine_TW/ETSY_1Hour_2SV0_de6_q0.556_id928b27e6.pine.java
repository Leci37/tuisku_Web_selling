...
decision_tree_0_ETSY_1Hour_928b27e6(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)=>
	...
	if( smoothK_k > 0.411083 )
		if( VIP_VIM <= -0.223635 )
			if( d_k <= 5.14851 )
				if( smoothK_k <= 89.5882 )
					if( smoothD_d <= 25.6329 )
						if( rsi1 <= 36.8806 )
							ret := -0.136555
						if( rsi1 > 36.8806 )
							ret := -0.351936
				...
				if( VIP_VIM <= 0.040981 )
					if( d <= 11.6031 )
						...
						if( k > 5.05172 )
							ret := 0.332703
					if( d > 11.6031 )
						if( smoothD_d <= 12.0751 )
							ret := -0.296137
						if( smoothD_d > 12.0751 )
							ret := 0.010091
				if( VIP_VIM > 0.040981 )
					if( smoothK_k <= 51.0431 )
						if( rsi1 <= 48.0859 )
							ret := -0.284483
						if( rsi1 > 48.0859 )
							ret := 0.211132
				...
				if( VIP_VIM <= 0.885605 )
					...
					if( VIM > 1.06553 )
						...
						if( rsi1 > 63.5224 )
							ret := -0.463722
				if( VIP_VIM > 0.885605 )
					if( smoothD_d <= 96.4466 )
						if( smoothD_d <= 93.5951 )
							ret := 0.284672
						if( smoothD_d > 93.5951 )
							ret := 0.732394 // buy
					if( smoothD_d > 96.4466 )
...
float op_operation = decision_tree_0_ETSY_1Hour_928b27e6(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)
