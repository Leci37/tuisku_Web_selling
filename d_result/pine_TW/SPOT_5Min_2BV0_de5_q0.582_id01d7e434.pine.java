			...
			if( bbp <= 5.104 )
				...
				if( bbm > 0.058075 )
					...
					if( bbp > 2.38063 )
						ret := 0.500000
			if( bbp > 5.104 )
				if( bullPower <= 2.93342 )
					if( VIP <= 1.73975 )
						ret := -1.000000 // sell
					if( VIP > 1.73975 )
						ret := 0.000000
				if( bullPower > 2.93342 )
					if( bearPower <= 1.74632 )
						ret := 0.000000
					if( bearPower > 1.74632 )
						ret := -0.961538 // sell
		if( VIP_VIM > -0.224374 )
			if( bullPower <= 16.9599 )
				if( bbp <= 10.3812 )
					if( bbp <= 8.39345 )
						ret := -0.146187
					if( bbp > 8.39345 )
...
float op_operation = decision_tree_0_SPOT_5Min_01d7e434(bbm, bearPower, bbp, bullPower, BBPower_Color, VIP_VIM, VIM, VIP)
