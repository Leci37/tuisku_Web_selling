...
decision_tree_0_TRXUSDT_1Day_cf734736(bbm, bearPower, bbp, bullPower, BBPower_Color, mf, ad, ad_mf)=>
	...
	if( bbp > -0.000401 )
		...
		if( bullPower > 0.001261 )
			if( mf <= -0.134916 )
				if( bullPower <= 0.002415 )
					ret := 0.285714
				if( bullPower > 0.002415 )
					if( bullPower <= 0.003384 )
						ret := 0.833333 // buy
					if( bullPower > 0.003384 )
						ret := 1.000000 // buy
			if( mf > -0.134916 )
				if( ad_mf <= -4.06229e+08 )
...
float op_operation = decision_tree_0_TRXUSDT_1Day_cf734736(bbm, bearPower, bbp, bullPower, BBPower_Color, mf, ad, ad_mf)
