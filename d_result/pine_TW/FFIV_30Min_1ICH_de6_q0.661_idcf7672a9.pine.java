		...
		if( tenkan_sen > 143.158 )
			if( chinkou_span <= 145.764 )
				if( tenkan_sen <= 146.12 )
					if( chinkou_span <= 143.712 )
						if( basis_minus <= 0.227289 )
							ret := -0.157546
						if( basis_minus > 0.227289 )
							ret := -0.529801
					if( chinkou_span > 143.712 )
						if( senkou_span_a_displaced <= 148.065 )
							ret := -0.030012
						if( senkou_span_a_displaced > 148.065 )
							ret := 0.796875 // buy
				if( tenkan_sen > 146.12 )
					if( senkou_span_b <= 146.453 )
						if( senkou_span_b_displaced <= 142.394 )
							ret := -0.817568 // sell
						if( senkou_span_b_displaced > 142.394 )
							ret := -0.336508
					if( senkou_span_b > 146.453 )
						ret := -0.764060 // sell
			if( chinkou_span > 145.764 )
				if( kinjun_sen <= 147.139 )
					if( senkou_span_a_displaced <= 146.153 )
						if( senkou_span_b_displaced <= 137.57 )
							ret := 0.929825 // buy
						if( senkou_span_b_displaced > 137.57 )
							ret := 0.190596
					if( senkou_span_a_displaced > 146.153 )
						ret := 0.573171
				if( kinjun_sen > 147.139 )
					if( tenkan_sen <= 200.065 )
						if( senkou_span_b <= 193.285 )
							ret := -0.012941
						if( senkou_span_b > 193.285 )
							ret := 0.202860
					if( tenkan_sen > 200.065 )
						if( chinkou_span <= 203.038 )
							ret := -0.406938
						if( chinkou_span > 203.038 )
							ret := 0.065594
	if( senkou_span_a_displaced > 238.802 )
...
float op_operation = decision_tree_0_FFIV_30Min_cf7672a9(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
