...
decision_tree_0_FFIV_1Day_e67db00b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Negative_Money_Flow_Sum > 3.52014e+08 )
			...
			if( MFI <= 60.0915 )
				...
				if( Positive_Money_Flow_Sum > 1.1721e+09 )
					...
					if( Positive_Money_Flow_Sum > 1.35205e+09 )
						ret := -0.941176 // sell
			if( MFI > 60.0915 )
				if( Negative_Money_Flow_Sum <= 8.90901e+08 )
					if( Negative_Money_Flow_Sum <= 4.55354e+08 )
						ret := 0.137931
					if( Negative_Money_Flow_Sum > 4.55354e+08 )
						ret := 0.673797
				if( Negative_Money_Flow_Sum > 8.90901e+08 )
		...
		if( Typical_Price > 142.068 )
			if( MFI <= 60.7057 )
				if( Raw_Money_Flow <= 4.43993e+07 )
					if( Negative_Money_Flow <= 3.43102e+06 )
						ret := 0.428571
					if( Negative_Money_Flow > 3.43102e+06 )
						ret := 0.863636 // buy
				if( Raw_Money_Flow > 4.43993e+07 )
					...
					if( Negative_Money_Flow_Sum > 1.557e+09 )
						ret := 0.539683
			if( MFI > 60.7057 )
				if( Positive_Money_Flow <= 8.54711e+07 )
					if( Positive_Money_Flow_Sum <= 1.48283e+09 )
						ret := 0.482759
					if( Positive_Money_Flow_Sum > 1.48283e+09 )
						ret := -0.342105
				if( Positive_Money_Flow > 8.54711e+07 )
...
float op_operation = decision_tree_0_FFIV_1Day_e67db00b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
