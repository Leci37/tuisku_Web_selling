...
decision_tree_0_BTCUSDT_1Day_795d1183(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)=>
	...
	if( Lower_Band > 7452.47 )
		if( Lower_Band <= 10274.1 )
			if( Upper_Band <= 9626 )
				if( basis <= 8544.54 )
					if( Lower_Band <= 7825.32 )
						ret := 1.000000 // buy
					if( Lower_Band > 7825.32 )
						ret := 0.000000
				if( basis > 8544.54 )
					if( Lower_Band <= 7621.41 )
						ret := -1.000000 // sell
					if( Lower_Band > 7621.41 )
						ret := 0.315789
			if( Upper_Band > 9626 )
				if( basis <= 10384.2 )
					if( Upper_Band <= 10934.3 )
						ret := -0.544681
					if( Upper_Band > 10934.3 )
						ret := 0.571429
				if( basis > 10384.2 )
		...
		if( Lower_Band > 10274.1 )
			if( Upper_Band <= 40133 )
				if( bearPower <= 844.296 )
					if( Lower_Band <= 12423.8 )
						ret := -0.125000
					if( Lower_Band > 12423.8 )
						ret := 0.165906
				if( bearPower > 844.296 )
					...
					if( bbm > 4282.84 )
						ret := -1.000000 // sell
			if( Upper_Band > 40133 )
				if( Upper_Band <= 42464.9 )
					if( basis <= 36066.2 )
						ret := -0.347826
					if( basis > 36066.2 )
						ret := -0.865672 // sell
				if( Upper_Band > 42464.9 )
					if( Lower_Band <= 39506.1 )
						ret := 0.109091
					if( Lower_Band > 39506.1 )
						ret := -0.191740
...
float op_operation = decision_tree_0_BTCUSDT_1Day_795d1183(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
