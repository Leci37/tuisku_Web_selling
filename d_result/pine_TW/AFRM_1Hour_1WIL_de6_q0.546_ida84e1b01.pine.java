...
decision_tree_0_AFRM_1Hour_a84e1b01(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)=>
			...
			if( upperBand > 28.9778 )
				if( midLine <= 23.7601 )
					...
					if( wvf > 27.1939 )
						ret := 0.000000
				if( midLine > 23.7601 )
					if( Color_con2 <= -3.31392 )
						if( upperBand <= 36.4507 )
							ret := -0.833333 // sell
						if( upperBand > 36.4507 )
							ret := 0.166667
					if( Color_con2 > -3.31392 )
	...
	if( sDev > 15.0813 )
		if( midLine <= 17.9403 )
			if( midLine <= 15.9023 )
				if( Color_con2 <= -22.0576 )
					ret := 0.416667
				if( Color_con2 > -22.0576 )
					ret := -0.738462 // sell
			if( midLine > 15.9023 )
				if( Color_con1 <= -31.703 )
					ret := 1.000000 // buy
				if( Color_con1 > -31.703 )
					ret := 0.233333
		if( midLine > 17.9403 )
			if( upperBand <= 47.7798 )
				if( wvf <= 13.0711 )
					ret := -0.888889 // sell
				if( wvf > 13.0711 )
					ret := -0.214286
...
float op_operation = decision_tree_0_AFRM_1Hour_a84e1b01(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
