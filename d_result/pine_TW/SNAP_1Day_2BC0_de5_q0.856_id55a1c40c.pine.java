	...
	if( bullPower > 0.888618 )
		if( bbp <= -0.429496 )
			...
			if( bbp > -0.587843 )
				ret := 1.000000 // buy
		if( bbp > -0.429496 )
			if( bearPower <= 0.492026 )
				if( mf <= 0.165968 )
					if( ad_mf <= -1.88269e+07 )
						ret := -0.040000
					if( ad_mf > -1.88269e+07 )
						ret := -0.603524
				if( mf > 0.165968 )
					if( bullPower <= 2.79599 )
						ret := 0.288462
					if( bullPower > 2.79599 )
						ret := -0.789474 // sell
			if( bearPower > 0.492026 )
...
float op_operation = decision_tree_0_SNAP_1Day_55a1c40c(bbm, bearPower, bbp, bullPower, BBPower_Color, mf, ad, ad_mf)
