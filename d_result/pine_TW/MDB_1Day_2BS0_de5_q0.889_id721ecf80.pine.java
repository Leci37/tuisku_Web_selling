			...
			if( bearPower > -23.3002 )
				...
				if( bbp > 4.62557 )
					...
					if( d > 25.8695 )
						ret := -0.753086 // sell
	if( smoothK_k > 37.8853 )
		if( bearPower <= 1.25947 )
			if( bearPower <= -21.2552 )
				if( bbm <= 12.5771 )
					if( bbm <= 8.95 )
						ret := 1.000000 // buy
					if( bbm > 8.95 )
...
float op_operation = decision_tree_0_MDB_1Day_721ecf80(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
