...
decision_tree_0_DBX_1Day_ddbd0250(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( lowerBand > 0.489456 )
		if( wvf <= 12.8846 )
			if( midLine <= 11.0999 )
				if( upperBand <= 10.1916 )
					if( upperBand <= 3.78165 )
						ret := 1.000000 // buy
					if( upperBand > 3.78165 )
						ret := -0.180723
				if( upperBand > 10.1916 )
			...
			if( midLine > 11.0999 )
				if( midLine <= 15.2479 )
					if( upperBand <= 19.2261 )
						ret := -0.086957
					if( upperBand > 19.2261 )
						ret := -0.784314 // sell
				if( midLine > 15.2479 )
					if( upperBand <= 33.4814 )
						ret := 0.566667
					if( upperBand > 33.4814 )
						ret := -0.391304
		if( wvf > 12.8846 )
			if( upperBand <= 23.0053 )
				if( Color_con2 <= -5.72475 )
					ret := -1.000000 // sell
				if( Color_con2 > -5.72475 )
					if( sDev <= 3.35604 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_DBX_1Day_ddbd0250(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
