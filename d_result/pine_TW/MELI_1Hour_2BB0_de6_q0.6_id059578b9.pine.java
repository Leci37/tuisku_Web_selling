...
decision_tree_0_MELI_1Hour_059578b9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( Lower_Band > 324.787 )
		...
		if( basis > 347.43 )
			if( basis <= 1597.34 )
				if( bearPower <= 44.5227 )
					if( bbm <= 41.1693 )
						if( bullPower <= 53.4759 )
							ret := 0.008593
						if( bullPower > 53.4759 )
							ret := 0.514851
					if( bbm > 41.1693 )
						if( bullPower <= -26.7983 )
							ret := 0.366667
						if( bullPower > -26.7983 )
							ret := -0.484000
				if( bearPower > 44.5227 )
					ret := 0.862500 // buy
			if( basis > 1597.34 )
				if( Lower_Band <= 1561.58 )
					if( bullPower <= 30.4019 )
						if( Upper_Band <= 1642.15 )
							ret := 1.000000 // buy
						if( Upper_Band > 1642.15 )
							ret := -0.703030 // sell
					if( bullPower > 30.4019 )
...
float op_operation = decision_tree_0_MELI_1Hour_059578b9(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
