			...
			if( smoothK_k > 79.337 )
				...
				if( Typical_Price > 123.924 )
					...
					if( Negative_Money_Flow > 2.24109e+08 )
						ret := -1.000000 // sell
	if( Positive_Money_Flow_Sum > 2.85615e+09 )
		if( Raw_Money_Flow <= 3.73955e+08 )
			if( d_k <= 10.2609 )
				if( MFI_High <= -7.65657 )
					if( Positive_Money_Flow_Sum <= 3.05797e+09 )
						ret := -0.538462
					if( Positive_Money_Flow_Sum > 3.05797e+09 )
						ret := 0.135417
				if( MFI_High > -7.65657 )
			...
			if( d_k > 10.2609 )
				...
				if( MFI_Low > 32.1532 )
					...
					if( MFI_High > -13.5674 )
						ret := 0.142857
		if( Raw_Money_Flow > 3.73955e+08 )
			if( smoothK_k <= 54.4569 )
				if( Positive_Money_Flow <= 3.80864e+06 )
					if( MFI_Low <= 28.5171 )
						ret := -0.166667
					if( MFI_Low > 28.5171 )
						ret := -0.564103
				if( Positive_Money_Flow > 3.80864e+06 )
					...
					if( rsi1 > 65.3986 )
						ret := -0.409091
			if( smoothK_k > 54.4569 )
				if( Negative_Money_Flow <= 4.55701e+08 )
					if( d <= 59.9137 )
						ret := 0.400000
					if( d > 59.9137 )
						ret := -0.370079
...
float op_operation = decision_tree_0_U_1Day_e03948be(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, rsi1, d, k, smoothD_d, d_k, smoothK_k)
