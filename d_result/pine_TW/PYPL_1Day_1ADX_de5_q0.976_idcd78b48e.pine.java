			...
			if( smoothedDirectionalMovementPlus <= 0.456821 )
				if( dx <= 11.3796 )
					...
					if( diPlus > 26.2909 )
						ret := 0.854545 // buy
				if( dx > 11.3796 )
					if( directionalMovementPlus <= 0.076817 )
						ret := 0.240602
					if( directionalMovementPlus > 0.076817 )
						ret := -0.083333
			if( smoothedDirectionalMovementPlus > 0.456821 )
				if( smoothedTrueRange <= 2.63432 )
					if( adx <= 48.5264 )
						ret := -0.135458
					if( adx > 48.5264 )
						ret := -0.666667
...
float op_operation = decision_tree_0_PYPL_1Day_cd78b48e(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
