	...
	if( Raw_Money_Flow <= 1.14225e+07 )
		...
		if( Typical_Price > 494.685 )
			...
			if( Negative_Money_Flow_Sum > 1.13434e+08 )
				ret := -0.720588 // sell
	if( Raw_Money_Flow > 1.14225e+07 )
		if( bullPower <= 1.16062 )
			if( Positive_Money_Flow_Sum <= 3.67295e+07 )
				if( Positive_Money_Flow_Sum <= 1.82137e+07 )
					if( MFI_High <= -41.9587 )
						ret := 0.500000
					if( MFI_High > -41.9587 )
						ret := -0.800000 // sell
			...
			if( Positive_Money_Flow_Sum > 3.67295e+07 )
				if( Typical_Price <= 488.298 )
					...
					if( bbm > 1.0025 )
						ret := 0.966102 // buy
				if( Typical_Price > 488.298 )
					if( bearPower <= -3.57602 )
						ret := -0.904762 // sell
					if( bearPower > -3.57602 )
						if( Negative_Money_Flow_Sum <= 5.54384e+07 )
							ret := -0.155844
						if( Negative_Money_Flow_Sum > 5.54384e+07 )
							ret := 0.758621 // buy
		if( bullPower > 1.16062 )
			if( bullPower <= 6.35635 )
				if( bbm <= 1.04386 )
					ret := -0.671642
				if( bbm > 1.04386 )
					if( MFI_High <= -32.9124 )
...
float op_operation = decision_tree_0_HUBS_1Min_cbeffab3(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
