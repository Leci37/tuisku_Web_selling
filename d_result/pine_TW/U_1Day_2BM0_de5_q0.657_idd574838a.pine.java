	...
	if( Negative_Money_Flow_Sum > 6.61054e+09 )
		...
		if( MFI_Low > 6.29697 )
			if( bbp <= -20.165 )
				ret := 0.000000
			if( bbp > -20.165 )
				if( Positive_Money_Flow_Sum <= 3.63224e+09 )
					ret := -0.777778 // sell
				if( Positive_Money_Flow_Sum > 3.63224e+09 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_U_1Day_d574838a(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
