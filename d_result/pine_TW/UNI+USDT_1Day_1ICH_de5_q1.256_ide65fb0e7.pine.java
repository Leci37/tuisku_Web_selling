			...
			if( kinjun_sen <= 10.0104 )
				...
				if( chinkou_span > 6.92728 )
					...
					if( senkou_span_a_displaced > 6.21875 )
						ret := 0.340206
			if( kinjun_sen > 10.0104 )
				if( basis_max <= 0.856179 )
					if( senkou_span_a <= 23.2985 )
						ret := -0.632653
					if( senkou_span_a > 23.2985 )
						ret := -0.296703
				if( basis_max > 0.856179 )
					if( tenkan_sen <= 18.9128 )
						ret := 0.575758
					if( tenkan_sen > 18.9128 )
						ret := -0.306667
		if( chinkou_span > 26.5443 )
			if( basis_max <= -0.333837 )
				if( basis_minus <= 4.3746 )
					if( senkou_span_a_displaced <= 19.8485 )
						ret := 0.939394 // buy
					if( senkou_span_a_displaced > 19.8485 )
						ret := -0.343750
				if( basis_minus > 4.3746 )
					if( senkou_span_a <= 18.4307 )
						ret := 0.285714
					if( senkou_span_a > 18.4307 )
						ret := -0.710526 // sell
			if( basis_max > -0.333837 )
				if( tenkan_sen <= 30.8797 )
					if( senkou_span_b_displaced <= 28.975 )
						ret := 0.937500 // buy
					if( senkou_span_b_displaced > 28.975 )
						ret := 0.000000
				if( tenkan_sen > 30.8797 )
...
float op_operation = decision_tree_0_UNIUSDT_1Day_e65fb0e7(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
