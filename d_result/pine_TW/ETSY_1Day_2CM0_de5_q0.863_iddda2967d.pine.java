			...
			if( Money_Flow_Ratio > 1.26065 )
				...
				if( mf > 0.225996 )
					...
					if( ad_mf > 1.51568e+06 )
						ret := -0.066667
		if( Negative_Money_Flow_Sum > 4.29388e+09 )
			if( Positive_Money_Flow_Sum <= 2.28368e+09 )
				if( ad_mf <= -319849 )
					ret := -0.333333
				if( ad_mf > -319849 )
					if( Negative_Money_Flow <= 4.94539e+08 )
						ret := -0.888889 // sell
					if( Negative_Money_Flow > 4.94539e+08 )
						ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 2.28368e+09 )
				if( Typical_Price <= 263.974 )
					if( ad <= 1.76721e+06 )
						ret := 0.663366
					if( ad > 1.76721e+06 )
						ret := -0.066667
...
float op_operation = decision_tree_0_ETSY_1Day_dda2967d(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
