			...
			if( smoothK_k > -2.90734 )
				...
				if( k > 10.0216 )
					...
					if( bbm > 5.72214 )
						ret := 0.365591
		if( smoothD_d > 65.7309 )
			if( bullPower <= 7.12265 )
				if( smoothD_d <= 85.6145 )
					if( bbm <= 3.295 )
						ret := -0.215278
					if( bbm > 3.295 )
						ret := 0.250000
				if( smoothD_d > 85.6145 )
					if( smoothD_d <= 93.6097 )
						ret := 0.649425
					if( smoothD_d > 93.6097 )
						ret := -0.046875
			if( bullPower > 7.12265 )
...
float op_operation = decision_tree_0_AMD_1Day_96cdc411(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
