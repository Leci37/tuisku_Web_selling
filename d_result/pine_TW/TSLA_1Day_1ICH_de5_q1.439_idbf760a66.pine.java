			...
			if( chinkou_span <= 417.117 )
				if( senkou_span_a <= 328.717 )
					...
					if( senkou_span_a > 224.261 )
						ret := 0.235955
				if( senkou_span_a > 328.717 )
					if( chinkou_span <= 300.311 )
						ret := -0.784091 // sell
					if( chinkou_span > 300.311 )
						ret := -0.272727
			if( chinkou_span > 417.117 )
				if( kinjun_sen <= 599.54 )
					if( senkou_span_b_displaced <= 273.21 )
						ret := -0.111111
					if( senkou_span_b_displaced > 273.21 )
						ret := 0.786364 // buy
				if( kinjun_sen > 599.54 )
					if( basis_max <= 73.1644 )
						ret := 0.420408
					if( basis_max > 73.1644 )
						ret := -0.923077 // sell
		if( kinjun_sen > 706.726 )
			if( chinkou_span <= 1094.47 )
				if( senkou_span_b_displaced <= 972.16 )
					if( basis_max <= -11.8489 )
						ret := -0.092683
					if( basis_max > -11.8489 )
						ret := -0.706140 // sell
				if( senkou_span_b_displaced > 972.16 )
					if( senkou_span_a_displaced <= 1436.81 )
						ret := 0.231707
					if( senkou_span_a_displaced > 1436.81 )
						ret := -0.705882 // sell
			if( chinkou_span > 1094.47 )
				if( senkou_span_b <= 965.976 )
					if( basis_max <= -13.6438 )
						ret := 0.859155 // buy
					if( basis_max > -13.6438 )
						ret := 0.000000
				if( senkou_span_b > 965.976 )
					if( senkou_span_a_displaced <= 844.34 )
						ret := 0.000000
					if( senkou_span_a_displaced > 844.34 )
						ret := -0.800000 // sell
...
float op_operation = decision_tree_0_TSLA_1Day_bf760a66(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
