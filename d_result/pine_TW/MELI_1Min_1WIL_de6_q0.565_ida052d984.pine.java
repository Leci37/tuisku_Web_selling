				...
				if( Color_con2 > 0.264948 )
					...
					if( Color_con2 > 0.526083 )
						...
						if( wvf > 1.21468 )
							ret := 0.166667
		if( upperBand > 1.53859 )
			if( Color_con2 <= -1.63206 )
				if( midLine <= 3.90532 )
					if( lowerBand <= 0.020931 )
						if( Color_con1 <= -5.30593 )
							ret := -0.363636
						if( Color_con1 > -5.30593 )
							ret := 0.669903
					if( lowerBand > 0.020931 )
						if( Color_con1 <= -1.40108 )
							ret := -0.235772
						if( Color_con1 > -1.40108 )
							ret := 0.893617 // buy
				if( midLine > 3.90532 )
				...
				if( sDev <= 0.682681 )
					if( wvf <= 1.43682 )
						...
						if( midLine > 1.28568 )
							ret := -0.716981 // sell
					if( wvf > 1.43682 )
						if( Color_con2 <= 0.373957 )
							ret := 0.414286
						if( Color_con2 > 0.373957 )
							ret := -1.000000 // sell
				if( sDev > 0.682681 )
					if( Color_con2 <= 2.44596 )
						if( upperBand <= 2.86564 )
							ret := -0.153880
						if( upperBand > 2.86564 )
							ret := 0.126543
					if( Color_con2 > 2.44596 )
						if( Color_con1 <= 0.727833 )
							ret := -1.000000 // sell
						if( Color_con1 > 0.727833 )
							ret := -0.789474 // sell
	if( sDev > 3.73732 )
		if( upperBand <= 8.00192 )
			if( wvf <= 5.25082 )
				ret := -0.142857
			if( wvf > 5.25082 )
				ret := 1.000000 // buy
...
float op_operation = decision_tree_0_MELI_1Min_a052d984(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
