				...
				if( wvf > 3.8214 )
					if( wvf <= 8.05171 )
						...
						if( midLine > 9.6785 )
							ret := 0.920000 // buy
					if( wvf > 8.05171 )
						if( Color_con1 <= -13.2917 )
							ret := 0.333333
						if( Color_con1 > -13.2917 )
							ret := -0.800000 // sell
			if( Color_con1 > -10.6815 )
				if( lowerBand <= 0.924619 )
					if( sDev <= 1.82368 )
						if( lowerBand <= -0.247422 )
							ret := 0.305942
						if( lowerBand > -0.247422 )
							ret := 0.042962
					if( sDev > 1.82368 )
...
float op_operation = decision_tree_0_FFIV_1Hour_011a9c4d(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
