	...
	if( Negative_Money_Flow_Sum > 6.52349e+08 )
		...
		if( ema2 > 73.0469 )
			if( ema13 <= -6.93908 )
				ret := 1.000000 // buy
			if( ema13 > -6.93908 )
				if( Positive_Money_Flow_Sum <= 1.08036e+10 )
					if( MFI_Low <= 16.1123 )
						ret := 0.000000
					if( MFI_Low > 16.1123 )
						ret := -0.828283 // sell
...
float op_operation = decision_tree_0_PINS_1Day_07440e33(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
