			...
			if( rsi1 > 50.9619 )
				...
				if( rsi1 > 66.2728 )
					...
					if( Positive_Money_Flow_Sum > 1.99164e+09 )
						ret := 0.678161
	if( Positive_Money_Flow_Sum > 2.24147e+09 )
		if( Money_Flow_Ratio <= 1.78598 )
			if( Negative_Money_Flow_Sum <= 4.57719e+09 )
				if( Negative_Money_Flow <= 4.1344e+08 )
					if( Negative_Money_Flow_Sum <= 1.7345e+09 )
						ret := -0.544828
					if( Negative_Money_Flow_Sum > 1.7345e+09 )
						ret := -0.209106
				if( Negative_Money_Flow > 4.1344e+08 )
					if( Raw_Money_Flow <= 9.25671e+08 )
						ret := -0.673077
					if( Raw_Money_Flow > 9.25671e+08 )
						ret := 0.750000 // buy
			if( Negative_Money_Flow_Sum > 4.57719e+09 )
				if( Money_Flow_Ratio <= 0.628975 )
					if( rsi1 <= 34.5387 )
						ret := 0.433333
					if( rsi1 > 34.5387 )
						ret := -0.538462
				if( Money_Flow_Ratio > 0.628975 )
					...
					if( d_k > 1.21123 )
						ret := 1.000000 // buy
		if( Money_Flow_Ratio > 1.78598 )
			if( Raw_Money_Flow <= 2.84736e+08 )
				if( Positive_Money_Flow_Sum <= 2.58898e+09 )
					if( d_k <= 0.109672 )
						ret := 0.250000
					if( d_k > 0.109672 )
						ret := 0.875000 // buy
			...
			if( Raw_Money_Flow > 2.84736e+08 )
				if( MFI_High <= -8.13196 )
					...
					if( rsi1 > 58.4722 )
						ret := -0.218579
				if( MFI_High > -8.13196 )
					if( Negative_Money_Flow_Sum <= 1.46144e+09 )
						ret := 0.009009
					if( Negative_Money_Flow_Sum > 1.46144e+09 )
						ret := 0.756098 // buy
...
float op_operation = decision_tree_0_ADSK_1Day_f3395d87(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
