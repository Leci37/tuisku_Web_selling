			...
			if( Long_MA <= 73.1869 )
				...
				if( Raw_Money_Flow > 9.4502e+08 )
					...
					if( Short_MA > 73.3787 )
						ret := 1.000000 // buy
			if( Long_MA > 73.1869 )
				if( Positive_Money_Flow_Sum <= 1.11132e+10 )
					if( MFI_High <= -21.9835 )
						ret := -0.975610 // sell
					if( MFI_High > -21.9835 )
						ret := -0.837838 // sell
...
float op_operation = decision_tree_0_PINS_1Day_9f0b7cdd(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
