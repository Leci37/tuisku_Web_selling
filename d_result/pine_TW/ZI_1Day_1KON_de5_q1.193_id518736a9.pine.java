...
decision_tree_0_ZI_1Day_518736a9(oscp, verde_media, verde, marron, azul, media, tprice, xrsi, pvimax, media_azul, nvi_ema, azul_mean, pvim, verde_mean, pvi_ema, xmf, nvi, BollOsc, source, nvimax, pvimin, stoc, marron_mean, pvi, nvim, nvimin, verde_azul)=>
	...
	if( marron_mean > 48.6263 )
		...
		if( azul_mean > -0.22825 )
			if( pvimin <= -0.050338 )
				if( verde_mean <= 78.5228 )
					if( verde_mean <= 70.0389 )
						ret := 0.166667
					if( verde_mean > 70.0389 )
						ret := 0.838710 // buy
				if( verde_mean > 78.5228 )
					...
					if( pvimin > -0.069129 )
						ret := 1.000000 // buy
			if( pvimin > -0.050338 )
				if( media_azul <= 69.677 )
					if( pvimax <= 0.299186 )
						ret := 0.600000
					if( pvimax > 0.299186 )
						ret := -0.703252 // sell
				if( media_azul > 69.677 )
					if( azul_mean <= 0.771416 )
						ret := -0.875000 // sell
					if( azul_mean > 0.771416 )
						ret := -0.075472
...
float op_operation = decision_tree_0_ZI_1Day_518736a9(oscp, verde_media, verde, marron, azul, media, tprice, xrsi, pvimax, media_azul, nvi_ema, azul_mean, pvim, verde_mean, pvi_ema, xmf, nvi, BollOsc, source, nvimax, pvimin, stoc, marron_mean, pvi, nvim, nvimin, verde_azul)
