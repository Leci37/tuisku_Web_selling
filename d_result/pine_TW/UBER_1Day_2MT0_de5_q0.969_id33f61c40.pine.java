			...
			if( Money_Flow_Ratio <= 0.799915 )
				if( ema13 <= -3.66944 )
					...
					if( Money_Flow_Ratio > 0.490569 )
						ret := -1.000000 // sell
				if( ema13 > -3.66944 )
					if( Negative_Money_Flow_Sum <= 1.2274e+10 )
						ret := -0.014286
					if( Negative_Money_Flow_Sum > 1.2274e+10 )
						ret := -0.558442
			if( Money_Flow_Ratio > 0.799915 )
				if( ema13 <= -1.00435 )
					if( Typical_Price <= 65.7581 )
						ret := 0.958904 // buy
					if( Typical_Price > 65.7581 )
						ret := 0.000000
				if( ema13 > -1.00435 )
					ret := 0.166667
		if( ema12 > -0.769243 )
			if( Positive_Money_Flow_Sum <= 4.19195e+09 )
				if( tema <= 32.2264 )
					if( Raw_Money_Flow <= 2.45858e+08 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 2.45858e+08 )
						ret := -0.210526
				if( tema > 32.2264 )
					...
					if( ema13 > -0.561503 )
						ret := -0.763158 // sell
			if( Positive_Money_Flow_Sum > 4.19195e+09 )
				if( Positive_Money_Flow_Sum <= 8.48542e+09 )
					if( MFI <= 72.5271 )
						ret := -0.055679
					if( MFI > 72.5271 )
						ret := 0.758621 // buy
				if( Positive_Money_Flow_Sum > 8.48542e+09 )
					if( Positive_Money_Flow_Sum <= 1.04294e+10 )
						ret := -0.502415
					if( Positive_Money_Flow_Sum > 1.04294e+10 )
						ret := -0.031469
...
float op_operation = decision_tree_0_UBER_1Day_33f61c40(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
