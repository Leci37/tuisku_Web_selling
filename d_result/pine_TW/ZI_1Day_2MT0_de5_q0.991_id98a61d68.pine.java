			...
			if( ema12 <= 0.261019 )
				...
				if( Raw_Money_Flow > 1.65955e+08 )
					...
					if( tema > 15.8305 )
						ret := -0.800000 // sell
			if( ema12 > 0.261019 )
				if( Raw_Money_Flow <= 4.73678e+07 )
					ret := 1.000000 // buy
				if( Raw_Money_Flow > 4.73678e+07 )
					if( Negative_Money_Flow <= 1.51348e+06 )
						ret := -0.428571
					if( Negative_Money_Flow > 1.51348e+06 )
						ret := -0.833333 // sell
		if( Money_Flow_Ratio > 1.36029 )
			if( ema12 <= 1.42369 )
				if( Negative_Money_Flow <= 5.55655e+07 )
					if( ema12 <= -0.328306 )
						ret := -1.000000 // sell
					if( ema12 > -0.328306 )
						ret := 0.303167
				if( Negative_Money_Flow > 5.55655e+07 )
					if( Money_Flow_Ratio <= 3.50394 )
						ret := -0.234694
					if( Money_Flow_Ratio > 3.50394 )
						ret := 0.833333 // buy
			if( ema12 > 1.42369 )
				if( Raw_Money_Flow <= 3.76184e+08 )
					if( MFI_Low <= 51.0177 )
						ret := -0.521739
					if( MFI_Low > 51.0177 )
						ret := -0.050847
				if( Raw_Money_Flow > 3.76184e+08 )
					if( Raw_Money_Flow <= 4.58804e+08 )
						ret := -0.923077 // sell
					if( Raw_Money_Flow > 4.58804e+08 )
						ret := 0.000000
...
float op_operation = decision_tree_0_ZI_1Day_98a61d68(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, ema2, tema, ema12, ema3, ema1, ema13)
