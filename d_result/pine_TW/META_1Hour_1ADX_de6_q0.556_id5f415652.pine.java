	...
	if( smoothedDirectionalMovementPlus > 0.065619 )
		...
		if( adx > 9.61322 )
			...
			if( adx > 15.1234 )
				if( adx <= 37.486 )
					if( diMinus <= 37.8357 )
						if( smoothedDirectionalMovementMinus <= 0.52002 )
							ret := 0.008690
						if( smoothedDirectionalMovementMinus > 0.52002 )
							ret := 0.150178
					if( diMinus > 37.8357 )
...
float op_operation = decision_tree_0_META_1Hour_5f415652(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
