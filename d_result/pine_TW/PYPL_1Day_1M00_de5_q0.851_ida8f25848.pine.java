	...
	if( Positive_Money_Flow_Sum > 4.60911e+09 )
		if( Money_Flow_Ratio <= 0.435249 )
			if( Typical_Price <= 99.86 )
				if( Negative_Money_Flow_Sum <= 1.33612e+10 )
					if( Positive_Money_Flow <= 2.7079e+08 )
						ret := 0.000000
					if( Positive_Money_Flow > 2.7079e+08 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 1.33612e+10 )
					if( Positive_Money_Flow <= 2.62673e+09 )
						ret := 0.606061
					if( Positive_Money_Flow > 2.62673e+09 )
						ret := -1.000000 // sell
			if( Typical_Price > 99.86 )
				if( Typical_Price <= 181.776 )
					if( MFI_High <= -58.6212 )
						ret := -0.500000
					if( MFI_High > -58.6212 )
						ret := -0.888889 // sell
				if( Typical_Price > 181.776 )
					if( Negative_Money_Flow <= 2.11828e+09 )
						ret := -0.791667 // sell
					if( Negative_Money_Flow > 2.11828e+09 )
						ret := -0.037037
		if( Money_Flow_Ratio > 0.435249 )
			if( MFI_High <= -31.9633 )
				if( Negative_Money_Flow <= 2.40504e+09 )
					if( Positive_Money_Flow <= 2.61031e+09 )
						ret := 0.194444
					if( Positive_Money_Flow > 2.61031e+09 )
						ret := -0.739130 // sell
				if( Negative_Money_Flow > 2.40504e+09 )
					if( Typical_Price <= 63.0693 )
						ret := 1.000000 // buy
					if( Typical_Price > 63.0693 )
						ret := -0.590909
			if( MFI_High > -31.9633 )
				if( Positive_Money_Flow_Sum <= 9.05899e+09 )
					if( Positive_Money_Flow_Sum <= 5.63653e+09 )
						ret := 0.093333
					if( Positive_Money_Flow_Sum > 5.63653e+09 )
						ret := -0.321981
				if( Positive_Money_Flow_Sum > 9.05899e+09 )
...
float op_operation = decision_tree_0_PYPL_1Day_a8f25848(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
