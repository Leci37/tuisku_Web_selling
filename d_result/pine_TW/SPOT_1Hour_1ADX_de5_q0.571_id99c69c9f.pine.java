...
decision_tree_0_SPOT_1Hour_99c69c9f(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)=>
	...
	if( diMinus > 48.9542 )
		if( adx <= 50.2399 )
			if( adx <= 33.7946 )
				if( trueRange <= 1.65283 )
					if( adx <= 27.3555 )
						ret := -0.739130 // sell
					if( adx > 27.3555 )
						ret := 0.166667
				if( trueRange > 1.65283 )
					if( smoothedDirectionalMovementPlus <= 0.498076 )
						ret := 0.774436 // buy
					if( smoothedDirectionalMovementPlus > 0.498076 )
						ret := 0.000000
			if( adx > 33.7946 )
				if( smoothedTrueRange <= 3.76912 )
					if( adx <= 43.0007 )
						ret := -0.482353
					if( adx > 43.0007 )
						ret := 0.254098
		...
		if( adx > 50.2399 )
			if( diPlus <= 6.49916 )
				if( smoothedDirectionalMovementMinus <= 0.845718 )
					ret := 0.680000
				if( smoothedDirectionalMovementMinus > 0.845718 )
					if( smoothedDirectionalMovementMinus <= 2.13537 )
						ret := -0.295775
					if( smoothedDirectionalMovementMinus > 2.13537 )
						ret := 0.700000 // buy
			if( diPlus > 6.49916 )
				if( smoothedTrueRange <= 2.17276 )
					if( adx <= 65.9486 )
						ret := 0.666667
					if( adx > 65.9486 )
						ret := -0.562500
...
float op_operation = decision_tree_0_SPOT_1Hour_99c69c9f(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)
