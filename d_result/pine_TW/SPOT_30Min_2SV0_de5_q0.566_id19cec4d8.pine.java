...
decision_tree_0_SPOT_30Min_19cec4d8(d_k, d, rsi1, k, smoothD_d, smoothK_k, VIP_VIM, VIM, VIP)=>
	...
	if( d_k > 17.125 )
			...
			if( rsi1 <= 40.635 )
				if( VIP_VIM <= -0.409637 )
					...
					if( rsi1 > 18.8903 )
						ret := -0.085399
				if( VIP_VIM > -0.409637 )
					if( smoothD_d <= 20.1444 )
						ret := -0.571429
					if( smoothD_d > 20.1444 )
						ret := 0.315508
			if( rsi1 > 40.635 )
				if( smoothK_k <= 56.4071 )
					if( d_k <= 17.8918 )
						ret := 0.456522
					if( d_k > 17.8918 )
						ret := -0.331210
		...
		if( VIP_VIM > 0.019358 )
			if( rsi1 <= 50.6784 )
				if( smoothK_k <= 9.09247 )
					if( smoothK_k <= -2.45168 )
						ret := 0.653846
					if( smoothK_k > -2.45168 )
						ret := -0.361702
				if( smoothK_k > 9.09247 )
...
float op_operation = decision_tree_0_SPOT_30Min_19cec4d8(d_k, d, rsi1, k, smoothD_d, smoothK_k, VIP_VIM, VIM, VIP)
