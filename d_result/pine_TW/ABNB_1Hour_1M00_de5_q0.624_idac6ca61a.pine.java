		...
		if( MFI <= 92.4265 )
			if( Money_Flow_Ratio <= 0.283902 )
				if( Typical_Price <= 116.962 )
					if( Raw_Money_Flow <= 1.55674e+07 )
						ret := 0.780374 // buy
					if( Raw_Money_Flow > 1.55674e+07 )
						ret := 0.225166
				if( Typical_Price > 116.962 )
					if( Positive_Money_Flow_Sum <= 2.37638e+08 )
						ret := -0.070149
					if( Positive_Money_Flow_Sum > 2.37638e+08 )
						ret := 0.393258
			if( Money_Flow_Ratio > 0.283902 )
				if( Positive_Money_Flow_Sum <= 2.12054e+09 )
					if( Typical_Price <= 150.652 )
						ret := 0.061951
					if( Typical_Price > 150.652 )
						ret := -0.111386
				if( Positive_Money_Flow_Sum > 2.12054e+09 )
					if( Positive_Money_Flow_Sum <= 4.30403e+09 )
						ret := -0.614458
					if( Positive_Money_Flow_Sum > 4.30403e+09 )
						ret := 0.790698 // buy
		if( MFI > 92.4265 )
			if( Positive_Money_Flow <= 1.16576e+08 )
				if( Typical_Price <= 157.997 )
					if( Typical_Price <= 128.501 )
						ret := 0.638655
					if( Typical_Price > 128.501 )
						ret := -0.149533
				if( Typical_Price > 157.997 )
					if( Positive_Money_Flow <= 1.00582e+07 )
						ret := 0.813187 // buy
					if( Positive_Money_Flow > 1.00582e+07 )
						ret := 0.142857
			if( Positive_Money_Flow > 1.16576e+08 )
				if( Typical_Price <= 129.189 )
					ret := -0.629630
				if( Typical_Price > 129.189 )
					if( Positive_Money_Flow_Sum <= 9.71318e+08 )
						ret := -0.571429
					if( Positive_Money_Flow_Sum > 9.71318e+08 )
						ret := 0.325581
...
float op_operation = decision_tree_0_ABNB_1Hour_ac6ca61a(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
