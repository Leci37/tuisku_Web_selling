				...
				if( chinkou_span > 112.644 )
					if( tenkan_sen <= 134.747 )
						...
						if( senkou_span_a_displaced > 116.484 )
							ret := 0.017086
					if( tenkan_sen > 134.747 )
						if( chinkou_span <= 135.715 )
							ret := -0.630499
						if( chinkou_span > 135.715 )
							ret := -0.193617
			if( chinkou_span > 139.466 )
				if( basis_minus <= -0.906607 )
					if( tenkan_sen <= 143.711 )
						if( chinkou_span <= 145.296 )
							ret := 0.631373
						if( chinkou_span > 145.296 )
							ret := 0.905263 // buy
					if( tenkan_sen > 143.711 )
						ret := 0.047619
				if( basis_minus > -0.906607 )
					if( kinjun_sen <= 137.97 )
						if( senkou_span_a_displaced <= 128.244 )
							ret := -0.583333
						if( senkou_span_a_displaced > 128.244 )
							ret := 0.721569 // buy
					if( kinjun_sen > 137.97 )
						if( senkou_span_b_displaced <= 140.192 )
							ret := 0.486653
						if( senkou_span_b_displaced > 140.192 )
							ret := 0.049683
		if( senkou_span_b > 145.837 )
			if( chinkou_span <= 148.071 )
				if( senkou_span_b_displaced <= 152.957 )
					if( chinkou_span <= 145.238 )
						if( senkou_span_a_displaced <= 154.98 )
							ret := -0.752336 // sell
						if( senkou_span_a_displaced > 154.98 )
							ret := -0.200000
					if( chinkou_span > 145.238 )
						if( kinjun_sen <= 148.672 )
							ret := -0.191837
						if( kinjun_sen > 148.672 )
							ret := -0.616327
				if( senkou_span_b_displaced > 152.957 )
					if( senkou_span_b_displaced <= 155.511 )
						if( tenkan_sen <= 149.47 )
							ret := 0.831579 // buy
						if( tenkan_sen > 149.47 )
							ret := -0.181818
					if( senkou_span_b_displaced > 155.511 )
						if( kinjun_sen <= 132.76 )
							ret := 1.000000 // buy
						if( kinjun_sen > 132.76 )
							ret := -0.445283
			if( chinkou_span > 148.071 )
				if( kinjun_sen <= 152.694 )
					if( chinkou_span <= 151.452 )
						if( senkou_span_a <= 148.781 )
							ret := 0.314943
						if( senkou_span_a > 148.781 )
							ret := -0.228637
					if( chinkou_span > 151.452 )
						if( basis_minus <= -0.715841 )
							ret := 0.756972 // buy
						if( basis_minus > -0.715841 )
							ret := 0.290064
				if( kinjun_sen > 152.694 )
					if( chinkou_span <= 161.3 )
						if( tenkan_sen <= 162.18 )
							ret := -0.153002
						if( tenkan_sen > 162.18 )
							ret := -0.750600 // sell
					if( chinkou_span > 161.3 )
						if( senkou_span_b <= 162.188 )
							ret := 0.430481
						if( senkou_span_b > 162.188 )
							ret := -0.013318
...
float op_operation = decision_tree_0_AAPL_1Hour_4daff465(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
