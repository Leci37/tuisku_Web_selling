			...
			if( mf > -0.083114 )
				...
				if( ad > 1.07843e+08 )
					...
					if( rsi1 > 52.8881 )
						ret := 0.812500 // buy
	if( rsi1 > 66.03 )
		if( ad_mf <= -1.66702e+06 )
			if( ad <= -2.75131e+06 )
				if( ad_mf <= -1.24927e+07 )
					if( mf <= 0.168518 )
						ret := 0.628571
					if( mf > 0.168518 )
						ret := 0.000000
...
float op_operation = decision_tree_0_TSLA_1Day_0c247637(ad_mf, mf, ad, rsi1, d, k, smoothD_d, d_k, smoothK_k)
