	...
	if( Typical_Price > 108.791 )
		if( Negative_Money_Flow_Sum <= 1.5774e+09 )
			if( Short_Long_Diff <= 2.74448 )
				if( Short_MA <= 126.378 )
					if( Positive_Money_Flow <= 9.43326e+07 )
						ret := 0.000000
					if( Positive_Money_Flow > 9.43326e+07 )
						ret := -0.900000 // sell
				if( Short_MA > 126.378 )
					...
					if( Short_MA > 155.975 )
						ret := -0.600000
			if( Short_Long_Diff > 2.74448 )
				if( Raw_Money_Flow <= 1.5693e+08 )
					if( Money_Flow_Ratio <= 3.98045 )
						ret := 0.361702
					if( Money_Flow_Ratio > 3.98045 )
						ret := -0.727273 // sell
				if( Raw_Money_Flow > 1.5693e+08 )
					if( Positive_Money_Flow_Sum <= 2.36785e+09 )
						ret := -0.729064 // sell
					if( Positive_Money_Flow_Sum > 2.36785e+09 )
						ret := -0.048780
		if( Negative_Money_Flow_Sum > 1.5774e+09 )
			if( Positive_Money_Flow_Sum <= 1.63739e+10 )
				if( Short_Long_Diff <= -7.49476 )
					if( Negative_Money_Flow_Sum <= 2.53146e+10 )
						ret := -0.199352
					if( Negative_Money_Flow_Sum > 2.53146e+10 )
						ret := 0.533333
				if( Short_Long_Diff > -7.49476 )
					if( Positive_Money_Flow <= 9.30832e+08 )
						ret := 0.091241
					if( Positive_Money_Flow > 9.30832e+08 )
						ret := 0.539267
			if( Positive_Money_Flow_Sum > 1.63739e+10 )
				if( Long_MA <= 625.113 )
					if( Positive_Money_Flow <= 2.66921e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow > 2.66921e+09 )
						ret := 0.000000
				if( Long_MA > 625.113 )
					if( Positive_Money_Flow_Sum <= 2.4333e+10 )
						ret := -0.690476
					if( Positive_Money_Flow_Sum > 2.4333e+10 )
						ret := 0.055556
...
float op_operation = decision_tree_0_SHOP_1Day_84312bc8(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
