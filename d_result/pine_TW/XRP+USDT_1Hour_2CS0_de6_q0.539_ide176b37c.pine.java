				...
				if( ad_mf > -7.12085e+07 )
					if( rsi1 <= 48.0123 )
						...
						if( d_k > 1.28834 )
							ret := 0.479532
					if( rsi1 > 48.0123 )
						if( ad_mf <= -4.49679e+07 )
							ret := 0.000000
						if( ad_mf > -4.49679e+07 )
							ret := -0.826087 // sell
			if( ad > -3.52928e+07 )
				if( rsi1 <= 40.0571 )
					if( smoothD_d <= 11.1557 )
						if( ad_mf <= -3.18663e+07 )
							ret := 0.533333
						if( ad_mf > -3.18663e+07 )
							ret := -0.238453
					if( smoothD_d > 11.1557 )
...
float op_operation = decision_tree_0_XRPUSDT_1Hour_e176b37c(ad, ad_mf, mf, smoothK_k, d_k, k, smoothD_d, rsi1, d)
