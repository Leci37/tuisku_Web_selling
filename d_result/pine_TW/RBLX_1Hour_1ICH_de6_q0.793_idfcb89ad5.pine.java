			...
			if( chinkou_span <= 37.0698 )
				if( tenkan_sen <= 36.5042 )
					if( senkou_span_a_displaced <= 34.7043 )
						if( kinjun_sen <= 35.5791 )
							ret := -0.031250
						if( kinjun_sen > 35.5791 )
							ret := 0.816667 // buy
					if( senkou_span_a_displaced > 34.7043 )
						if( tenkan_sen <= 32.1217 )
							ret := 1.000000 // buy
						if( tenkan_sen > 32.1217 )
							ret := -0.267686
				if( tenkan_sen > 36.5042 )
					if( chinkou_span <= 35.0352 )
						ret := -0.765027 // sell
					if( chinkou_span > 35.0352 )
						if( basis_max <= -0.097979 )
							ret := -0.753488 // sell
						if( basis_max > -0.097979 )
							ret := -0.289823
			if( chinkou_span > 37.0698 )
				if( senkou_span_a <= 40.1013 )
					if( basis_max <= -0.804375 )
						if( kinjun_sen <= 36.091 )
							ret := 0.700000 // buy
						if( kinjun_sen > 36.091 )
							ret := -0.777778 // sell
					if( basis_max > -0.804375 )
						if( senkou_span_a_displaced <= 41.5806 )
							ret := 0.294660
						if( senkou_span_a_displaced > 41.5806 )
							ret := -0.460317
				if( senkou_span_a > 40.1013 )
					if( chinkou_span <= 39.6975 )
						if( senkou_span_a <= 40.8737 )
							ret := -0.222826
						if( senkou_span_a > 40.8737 )
							ret := -0.606004
					if( chinkou_span > 39.6975 )
						if( tenkan_sen <= 43.6167 )
							ret := 0.142989
						if( tenkan_sen > 43.6167 )
							ret := -0.074041
...
float op_operation = decision_tree_0_RBLX_1Hour_fcb89ad5(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
