...
decision_tree_0_BTCUSDT_1Day_99db6e36(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)=>
	...
	if( bearPower > -219.623 )
			...
			if( bearPower <= 3111.1 )
				if( bullPower <= 943.781 )
					...
					if( bbm > 873.416 )
						ret := 0.700000 // buy
				if( bullPower > 943.781 )
					if( bearPower <= 850.679 )
						ret := -0.191919
					if( bearPower > 850.679 )
						ret := 0.136150
			if( bearPower > 3111.1 )
				if( bearPower <= 4102.26 )
					if( ad_mf <= -10006.9 )
						ret := 1.000000 // buy
					if( ad_mf > -10006.9 )
						ret := 0.666667
		...
		if( mf > 0.256136 )
			...
			if( bearPower > 1166.04 )
				if( bbm <= 3140.4 )
					if( bearPower <= 1812.55 )
						ret := -0.360000
					if( bearPower > 1812.55 )
						ret := 0.629630
				if( bbm > 3140.4 )
					if( bearPower <= 2223.29 )
						ret := -0.428571
					if( bearPower > 2223.29 )
						ret := -0.900000 // sell
...
float op_operation = decision_tree_0_BTCUSDT_1Day_99db6e36(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)
