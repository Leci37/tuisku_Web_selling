			...
			if( Upper_Band > 1.69713 )
				...
				if( Lower_Band > 118.272 )
					if( Lower_Band <= 124.5 )
						ret := 0.636943
					if( Lower_Band > 124.5 )
						if( bearPower <= -1.49902 )
							ret := 0.210480
						if( bearPower > -1.49902 )
							ret := -0.026131
		if( basis > 144.306 )
			if( bullPower <= 10.6864 )
				if( Upper_Band <= 156.566 )
					if( Upper_Band <= 153.642 )
						if( basis <= 148.948 )
							ret := -0.162870
						if( basis > 148.948 )
							ret := 0.486111
					if( Upper_Band > 153.642 )
						if( Lower_Band <= 146.875 )
							ret := -0.528529
						if( Lower_Band > 146.875 )
							ret := -0.161765
				if( Upper_Band > 156.566 )
					if( Lower_Band <= 190.418 )
						if( bbm <= 3.46749 )
							ret := -0.062445
						if( bbm > 3.46749 )
							ret := 0.092629
...
float op_operation = decision_tree_0_SOLUSDT_1Hour_6a7736ed(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
