...
decision_tree_0_SPOT_30Min_963b2b7e(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( Positive_Money_Flow > 15.3056 )
		if( Negative_Money_Flow_Sum <= 8.19412e+07 )
			if( Typical_Price <= 78.487 )
				if( Negative_Money_Flow_Sum <= 4.5188e+07 )
					if( Raw_Money_Flow <= 100153 )
						ret := 0.888889 // buy
					if( Raw_Money_Flow > 100153 )
						ret := 0.351064
				if( Negative_Money_Flow_Sum > 4.5188e+07 )
					if( Positive_Money_Flow <= 6.88628e+06 )
						ret := -0.500000
					if( Positive_Money_Flow > 6.88628e+06 )
						ret := 0.166667
			if( Typical_Price > 78.487 )
				if( ema12 <= 0.739857 )
					if( Money_Flow_Ratio <= 0.165669 )
						ret := -0.650000
					if( Money_Flow_Ratio > 0.165669 )
						ret := 0.035243
				if( ema12 > 0.739857 )
		...
		if( Negative_Money_Flow_Sum > 8.19412e+07 )
			if( MFI_Low <= -17.3602 )
				if( Positive_Money_Flow_Sum <= 297632 )
					ret := 0.800000 // buy
				if( Positive_Money_Flow_Sum > 297632 )
					if( ema1 <= 110.96 )
						ret := 1.000000 // buy
					if( ema1 > 110.96 )
						ret := -0.788136 // sell
			if( MFI_Low > -17.3602 )
				if( Positive_Money_Flow <= 1.37084e+08 )
					if( Negative_Money_Flow_Sum <= 1.48998e+09 )
						ret := -0.092208
					if( Negative_Money_Flow_Sum > 1.48998e+09 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow > 1.37084e+08 )
...
float op_operation = decision_tree_0_SPOT_30Min_963b2b7e(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
