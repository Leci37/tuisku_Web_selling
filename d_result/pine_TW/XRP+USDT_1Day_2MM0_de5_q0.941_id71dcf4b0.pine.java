			...
			if( Typical_Price > 0.486703 )
				...
				if( Positive_Money_Flow_Sum > 1.8991e+09 )
					...
					if( Negative_Money_Flow_Sum > 2.81027e+09 )
						ret := -0.849057 // sell
	if( Short_MA > 0.622409 )
		if( Negative_Money_Flow_Sum <= 1.64065e+10 )
			if( MFI <= 82.9428 )
				if( Negative_Money_Flow <= 2.2084e+08 )
					if( Negative_Money_Flow_Sum <= 1.35197e+09 )
						ret := -0.821782 // sell
					if( Negative_Money_Flow_Sum > 1.35197e+09 )
						ret := -0.424908
				if( Negative_Money_Flow > 2.2084e+08 )
					if( Short_Long_Diff <= 0.120442 )
						ret := 0.000000
					if( Short_Long_Diff > 0.120442 )
						ret := -0.885714 // sell
			if( MFI > 82.9428 )
				if( Long_MA <= 0.809688 )
					if( Negative_Money_Flow_Sum <= 5.72346e+08 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 5.72346e+08 )
						ret := 1.000000 // buy
				if( Long_MA > 0.809688 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_71dcf4b0(MA_Cross, Long_MA, Short_Long_Diff, Short_MA, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
