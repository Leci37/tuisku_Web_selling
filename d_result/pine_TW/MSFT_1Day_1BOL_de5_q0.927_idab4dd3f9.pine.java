...
decision_tree_0_MSFT_1Day_ab4dd3f9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( vrsi > 28.853 )
		...
		if( dif_source_BBupper > -88.9891 )
			if( BBupper <= 304.121 )
				if( BBlower <= 170.131 )
					if( dif_source_BBlower <= 78.9809 )
						ret := 0.087850
					if( dif_source_BBlower > 78.9809 )
						ret := -0.746667 // sell
				if( BBlower > 170.131 )
					if( dif_source_BBupper <= -31.7288 )
						ret := 0.837209 // buy
					if( dif_source_BBupper > -31.7288 )
						ret := 0.205128
			if( BBupper > 304.121 )
				if( dif_source_BBlower <= 38.3676 )
					if( BBupper <= 347.991 )
						ret := -0.716667 // sell
					if( BBupper > 347.991 )
						ret := 0.347826
...
float op_operation = decision_tree_0_MSFT_1Day_ab4dd3f9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
