...
decision_tree_0_NVST_1Day_72e47c4c(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Raw_Money_Flow > 6.85563e+07 )
		if( Negative_Money_Flow_Sum <= 1.8465e+09 )
			if( Typical_Price <= 17.2008 )
				if( Positive_Money_Flow <= 7.20115e+07 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow > 7.20115e+07 )
					ret := 0.500000
			if( Typical_Price > 17.2008 )
				if( Money_Flow_Ratio <= 0.190843 )
					ret := -1.000000 // sell
				if( Money_Flow_Ratio > 0.190843 )
					if( MFI <= 30.3932 )
						ret := 0.305556
					if( MFI > 30.3932 )
						ret := -0.359914
		if( Negative_Money_Flow_Sum > 1.8465e+09 )
			if( Negative_Money_Flow_Sum <= 2.24977e+09 )
				ret := 1.000000 // buy
			if( Negative_Money_Flow_Sum > 2.24977e+09 )
				ret := 0.250000
...
float op_operation = decision_tree_0_NVST_1Day_72e47c4c(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
