			...
			if( adx > 59.5668 )
				if( smoothedDirectionalMovementPlus <= 0.989849 )
					...
					if( dx > 50.1449 )
						ret := 0.695652
				if( smoothedDirectionalMovementPlus > 0.989849 )
					if( directionalMovementPlus <= 1.51 )
						ret := 0.000000
					if( directionalMovementPlus > 1.51 )
						ret := -0.615385
...
float op_operation = decision_tree_0_PINS_1Day_26ccee81(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
