			...
			if( Color_con1 > -10.2356 )
				...
				if( Color_con2 > -1.78033 )
					...
					if( Color_con2 > 2.13727 )
						ret := -0.750000 // sell
	if( midLine > 21.4222 )
		if( Color_con1 <= -17.894 )
			if( midLine <= 27.0127 )
				if( upperBand <= 37.5401 )
					ret := 0.000000
				if( upperBand > 37.5401 )
					if( upperBand <= 49.5666 )
						ret := -1.000000 // sell
					if( upperBand > 49.5666 )
						ret := -0.166667
			if( midLine > 27.0127 )
				if( wvf <= 15.6758 )
					if( upperBand <= 45.3304 )
						ret := 0.500000
					if( upperBand > 45.3304 )
						ret := 1.000000 // buy
				if( wvf > 15.6758 )
					ret := -0.333333
		if( Color_con1 > -17.894 )
			if( Color_con2 <= -4.8174 )
				if( sDev <= 16.1017 )
					if( Color_con1 <= -11.7722 )
						ret := 1.000000 // buy
					if( Color_con1 > -11.7722 )
						ret := 0.916667 // buy
				if( sDev > 16.1017 )
					ret := 0.800000 // buy
			if( Color_con2 > -4.8174 )
				if( Color_con1 <= -14.0789 )
					ret := -0.166667
				if( Color_con1 > -14.0789 )
					if( lowerBand <= 16.2209 )
						ret := 0.684211
					if( lowerBand > 16.2209 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_MELI_1Day_5959204e(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
