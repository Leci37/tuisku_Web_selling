...
decision_tree_0_NVST_1Day_dca47c28(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( MFI_High > -36.498 )
		if( Typical_Price <= 40.7289 )
			...
			if( Short_Long_Diff > -0.654092 )
				if( Long_MA <= 24.2698 )
					if( Raw_Money_Flow <= 3.16092e+07 )
						ret := 0.410256
					if( Raw_Money_Flow > 3.16092e+07 )
						ret := -0.174274
				if( Long_MA > 24.2698 )
					if( Positive_Money_Flow <= 7.25394e+07 )
						ret := 0.437788
					if( Positive_Money_Flow > 7.25394e+07 )
						ret := -0.035294
		if( Typical_Price > 40.7289 )
			if( Short_Long_Diff <= -0.50776 )
				if( Money_Flow_Ratio <= 1.14559 )
					if( Raw_Money_Flow <= 1.08251e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 1.08251e+08 )
						ret := 1.000000 // buy
				if( Money_Flow_Ratio > 1.14559 )
					...
					if( Long_MA > 43.8093 )
						ret := 0.000000
			if( Short_Long_Diff > -0.50776 )
				if( Positive_Money_Flow_Sum <= 4.20001e+08 )
					if( Positive_Money_Flow_Sum <= 4.03557e+08 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 4.03557e+08 )
						ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 4.20001e+08 )
...
float op_operation = decision_tree_0_NVST_1Day_dca47c28(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
