			...
			if( Lower_Band > 21.1471 )
				...
				if( bullPower > -0.038103 )
					if( Lower_Band <= 21.6806 )
						ret := 0.839024 // buy
					if( Lower_Band > 21.6806 )
						if( Lower_Band <= 21.7542 )
							ret := -0.423077
						if( Lower_Band > 21.7542 )
							ret := 0.743902 // buy
	if( Lower_Band > 21.9611 )
		if( bullPower <= 2.89775 )
			if( bbm <= 0.633822 )
				if( basis <= 22.6231 )
					ret := -1.000000 // sell
				if( basis > 22.6231 )
					if( bbp <= 0.424689 )
						if( Upper_Band <= 64.2002 )
							ret := -0.065503
						if( Upper_Band > 64.2002 )
							ret := 0.087235
					if( bbp > 0.424689 )
			...
			if( bbm > 0.633822 )
				...
				if( basis > 23.3994 )
					if( basis <= 26.597 )
						if( bearPower <= -0.282339 )
							ret := -0.118110
						if( bearPower > -0.282339 )
							ret := -0.791045 // sell
					if( basis > 26.597 )
						if( Upper_Band <= 28.0572 )
							ret := 0.672414
						if( Upper_Band > 28.0572 )
							ret := 0.042410
		if( bullPower > 2.89775 )
			if( Upper_Band <= 39.5017 )
				ret := -0.611111
			if( Upper_Band > 39.5017 )
				ret := 0.736486 // buy
...
float op_operation = decision_tree_0_UBER_1Hour_da6e5078(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
