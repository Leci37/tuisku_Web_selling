			...
			if( Raw_Money_Flow > 5387.25 )
				if( Negative_Money_Flow <= 2.40984e+06 )
					...
					if( Positive_Money_Flow_Sum > 3.0237e+08 )
						ret := 0.444444
				if( Negative_Money_Flow > 2.40984e+06 )
					if( Positive_Money_Flow_Sum <= 1.47761e+08 )
						ret := 0.092105
					if( Positive_Money_Flow_Sum > 1.47761e+08 )
						ret := -0.657895
		if( Raw_Money_Flow > 5.29358e+06 )
			if( Typical_Price <= 33.8417 )
				if( Positive_Money_Flow <= 1.04918e+07 )
					if( Positive_Money_Flow_Sum <= 1.6487e+08 )
						ret := -0.235294
					if( Positive_Money_Flow_Sum > 1.6487e+08 )
						if( Typical_Price <= 28.2116 )
							ret := 0.888889 // buy
						if( Typical_Price > 28.2116 )
							ret := 0.052632
				if( Positive_Money_Flow > 1.04918e+07 )
					if( Short_Long_Diff <= 0.225079 )
						if( Short_Long_Diff <= -0.372601 )
							ret := -0.175000
						if( Short_Long_Diff > -0.372601 )
							ret := 0.593750
					if( Short_Long_Diff > 0.225079 )
						if( Money_Flow_Ratio <= 10.1337 )
							ret := -0.416667
						if( Money_Flow_Ratio > 10.1337 )
							ret := 0.888889 // buy
			if( Typical_Price > 33.8417 )
				if( Positive_Money_Flow_Sum <= 1.65115e+08 )
					if( Positive_Money_Flow_Sum <= 1.02508e+08 )
						ret := -0.575758
					if( Positive_Money_Flow_Sum > 1.02508e+08 )
						if( MFI_High <= -31.2175 )
							ret := -0.438356
...
float op_operation = decision_tree_0_NVST_1Hour_9405d429(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
