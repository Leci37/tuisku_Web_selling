				...
				if( lower_6 > 46.2735 )
					if( upper_3 <= 66.9292 )
						...
						if( lower_4 > 52.6937 )
							ret := -0.740741 // sell
					if( upper_3 > 66.9292 )
						if( basis_minus <= 14.1095 )
							ret := 1.000000 // buy
						if( basis_minus > 14.1095 )
							ret := 0.642202
			if( lower_6 > 48.8213 )
				if( lower_5 <= 57.6727 )
					if( basis_minus <= 7.43445 )
						if( upper_6 <= 68.8308 )
							ret := -0.439655
						if( upper_6 > 68.8308 )
							ret := -0.934066 // sell
...
float op_operation = decision_tree_0_ZI_1Hour_1c340bc2(basis_minus, lower_4, lower_6, upper_1, upper_3, lower_2, basis, upper_4, upper_5, lower_1, upper_6, lower_3, basis_max, lower_5, upper_2)
