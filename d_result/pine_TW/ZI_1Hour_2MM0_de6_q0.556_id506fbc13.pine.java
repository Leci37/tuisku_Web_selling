				...
				if( Short_Long_Diff > -1.95791 )
					...
					if( Positive_Money_Flow_Sum > 5.62196e+08 )
						...
						if( Negative_Money_Flow > 1.05184e+07 )
							ret := -0.500000
		if( MFI_High > 10.4752 )
			if( Short_Long_Diff <= 0.469464 )
				if( Money_Flow_Ratio <= 17.524 )
					if( Long_MA <= 12.5856 )
						if( Short_Long_Diff <= 0.148345 )
							ret := 0.333333
						if( Short_Long_Diff > 0.148345 )
							ret := -0.772727 // sell
					if( Long_MA > 12.5856 )
						if( Raw_Money_Flow <= 1.66226e+07 )
							ret := 0.580645
						if( Raw_Money_Flow > 1.66226e+07 )
							ret := -0.250000
				if( Money_Flow_Ratio > 17.524 )
					if( Short_MA <= 10.6114 )
						ret := 0.888889 // buy
					if( Short_MA > 10.6114 )
						if( Short_Long_Diff <= 0.254558 )
							ret := -0.434783
						if( Short_Long_Diff > 0.254558 )
							ret := -0.913043 // sell
			if( Short_Long_Diff > 0.469464 )
				if( Positive_Money_Flow <= 2.69573e+06 )
					if( Raw_Money_Flow <= 7295 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 7295 )
						if( MFI_High <= 19.9876 )
							ret := -0.915094 // sell
						if( MFI_High > 19.9876 )
							ret := 0.000000
				if( Positive_Money_Flow > 2.69573e+06 )
					if( Negative_Money_Flow_Sum <= 1.75661e+07 )
						if( MFI_Low <= 76.2614 )
							ret := -0.868421 // sell
						if( MFI_Low > 76.2614 )
							ret := -0.111111
					if( Negative_Money_Flow_Sum > 1.75661e+07 )
						if( Raw_Money_Flow <= 3.62954e+07 )
							ret := 0.696970
						if( Raw_Money_Flow > 3.62954e+07 )
							ret := -0.833333 // sell
	if( Short_MA > 47.0984 )
		if( Positive_Money_Flow_Sum <= 6.58395e+08 )
			if( Positive_Money_Flow_Sum <= 6.3476e+08 )
				if( Short_Long_Diff <= -1.8266 )
					if( Negative_Money_Flow <= 2.00609e+07 )
						if( Short_MA <= 48.0933 )
							ret := -0.333333
						if( Short_MA > 48.0933 )
							ret := 0.683168
					if( Negative_Money_Flow > 2.00609e+07 )
						if( Short_Long_Diff <= -2.42691 )
							ret := 0.142857
						if( Short_Long_Diff > -2.42691 )
							ret := -0.933333 // sell
				if( Short_Long_Diff > -1.8266 )
					if( MFI_Low <= 75.496 )
						if( Positive_Money_Flow <= 2.00711e+07 )
							ret := -0.086056
						if( Positive_Money_Flow > 2.00711e+07 )
							ret := -0.322034
					if( MFI_Low > 75.496 )
						if( Money_Flow_Ratio <= 1841.64 )
							ret := -0.864865 // sell
						if( Money_Flow_Ratio > 1841.64 )
							ret := 0.000000
			if( Positive_Money_Flow_Sum > 6.3476e+08 )
...
float op_operation = decision_tree_0_ZI_1Hour_506fbc13(MA_Cross, Long_MA, Short_Long_Diff, Short_MA, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
