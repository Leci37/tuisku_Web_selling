...
decision_tree_0_DOTUSDT_1Day_c4a34fc1(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)=>
	...
	if( dx > 63.28 )
		if( adx <= 25.9617 )
			if( directionalMovementPlus <= 0.013952 )
				ret := 0.285714
			if( directionalMovementPlus > 0.013952 )
				ret := 1.000000 // buy
		if( adx > 25.9617 )
			if( dx <= 90.4372 )
				if( trueRange <= 1.08861 )
					if( smoothedTrueRange <= 0.718614 )
						ret := 0.233645
					if( smoothedTrueRange > 0.718614 )
						ret := -0.642857
				if( trueRange > 1.08861 )
					...
					if( diMinus > 6.47187 )
						ret := 0.225352
			if( dx > 90.4372 )
				if( smoothedDirectionalMovementPlus <= 0.342534 )
					ret := 1.000000 // buy
				if( smoothedDirectionalMovementPlus > 0.342534 )
					ret := 0.200000
...
float op_operation = decision_tree_0_DOTUSDT_1Day_c4a34fc1(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
