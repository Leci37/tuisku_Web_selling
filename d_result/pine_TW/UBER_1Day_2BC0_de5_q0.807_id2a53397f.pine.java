		...
		if( bullPower <= 4.04953 )
			...
			if( bearPower > 1.87837 )
				...
				if( bullPower > 3.5294 )
					ret := 0.000000
		if( bullPower > 4.04953 )
			if( bearPower <= 4.70185 )
				if( ad_mf <= 4.13758e+07 )
					if( mf <= -0.017633 )
						ret := 0.615385
					if( mf > -0.017633 )
						ret := 0.086207
...
float op_operation = decision_tree_0_UBER_1Day_2a53397f(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)
