	...
	if( Positive_Money_Flow > 1.72145e+08 )
		if( MFI_Low <= 30.4341 )
			if( MFI_Low <= 12.3751 )
				ret := -0.600000
			if( MFI_Low > 12.3751 )
				if( Negative_Money_Flow_Sum <= 1.58405e+09 )
					if( Short_Long_Diff <= -1.14286 )
						ret := -0.500000
					if( Short_Long_Diff > -1.14286 )
						ret := 0.272727
				if( Negative_Money_Flow_Sum > 1.58405e+09 )
					if( Positive_Money_Flow <= 2.5776e+08 )
						ret := 0.555556
					if( Positive_Money_Flow > 2.5776e+08 )
						ret := 0.636364
		if( MFI_Low > 30.4341 )
			if( Long_MA <= 39.2636 )
				...
				if( MFI > 62.8796 )
					ret := 0.117647
			if( Long_MA > 39.2636 )
				if( Money_Flow_Ratio <= 1.70701 )
					if( Long_MA <= 44.6769 )
						ret := -1.000000 // sell
					if( Long_MA > 44.6769 )
						ret := -0.615385
				if( Money_Flow_Ratio > 1.70701 )
					if( Short_Long_Diff <= 2.00448 )
						ret := -0.222222
					if( Short_Long_Diff > 2.00448 )
						ret := -0.600000
...
float op_operation = decision_tree_0_ZI_1Day_c66502ed(MA_Cross, Long_MA, Short_Long_Diff, Short_MA, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
