				...
				if( basis <= 29.8521 )
					...
					if( upperKC > 29.7425 )
						...
						if( val > -0.009378 )
							ret := 0.068182
				if( basis > 29.8521 )
					if( priceRange <= 0.118911 )
						if( avgHighLow <= 29.8809 )
							ret := 0.238095
						if( avgHighLow > 29.8809 )
							ret := -0.500000
					if( priceRange > 0.118911 )
			...
			if( basis <= 37.4538 )
				if( upperKC <= 37.5347 )
					if( ma <= 37.4031 )
						ret := -1.000000 // sell
					if( ma > 37.4031 )
						if( avgHighLow <= 37.3998 )
							ret := 1.000000 // buy
						if( avgHighLow > 37.3998 )
							ret := 0.000000
				if( upperKC > 37.5347 )
					if( avgHighLow <= 37.3795 )
						if( upperKC <= 37.7648 )
							ret := -0.571429
						if( upperKC > 37.7648 )
							ret := 1.000000 // buy
					if( avgHighLow > 37.3795 )
						if( priceRange <= 0.059215 )
							ret := -0.250000
						if( priceRange > 0.059215 )
							ret := -0.989474 // sell
			if( basis > 37.4538 )
				if( val <= 0.025857 )
					if( avgHighLow <= 81.2425 )
						if( lowerBB <= 80.7598 )
							ret := -0.004913
						if( lowerBB > 80.7598 )
							ret := 0.518519
...
float op_operation = decision_tree_0_UBER_5Min_ccba2aae(lowerBB, noSqzInt, avgHighLow, rangema, sqzOffInt, upperKC, ma, basis, val, sqzOnInt, dev, priceRange, lowerKC, upperBB)
