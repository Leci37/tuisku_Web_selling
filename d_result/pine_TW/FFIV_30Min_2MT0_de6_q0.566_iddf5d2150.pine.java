	...
	if( ema13 <= 4.15068 )
		...
		if( Negative_Money_Flow_Sum > 1.6354e+08 )
			if( ema12 <= -1.12838 )
				if( MFI <= 36.7504 )
					if( tema <= 170.001 )
						if( Positive_Money_Flow <= 1.33066e+07 )
							ret := 0.571429
						if( Positive_Money_Flow > 1.33066e+07 )
							ret := -0.866667 // sell
					if( tema > 170.001 )
				...
				if( MFI > 36.7504 )
					...
					if( MFI_Low > 33.8062 )
						ret := 0.000000
			if( ema12 > -1.12838 )
				if( Positive_Money_Flow <= 1.26904e+07 )
					if( Negative_Money_Flow_Sum <= 2.06577e+08 )
						if( Positive_Money_Flow <= 1.22194e+07 )
							ret := 0.600000
						if( Positive_Money_Flow > 1.22194e+07 )
							ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 2.06577e+08 )
						if( Positive_Money_Flow <= 8.28076e+06 )
							ret := 0.195584
						if( Positive_Money_Flow > 8.28076e+06 )
							ret := -0.888889 // sell
				if( Positive_Money_Flow > 1.26904e+07 )
					if( ema12 <= -0.771111 )
						ret := -1.000000 // sell
					if( ema12 > -0.771111 )
						if( Positive_Money_Flow <= 9.61572e+07 )
							ret := 0.773913 // buy
						if( Positive_Money_Flow > 9.61572e+07 )
							ret := -1.000000 // sell
	if( ema13 > 4.15068 )
		if( Negative_Money_Flow_Sum <= 3.9822e+07 )
			if( Raw_Money_Flow <= 1.93947e+06 )
				if( ema3 <= 112.671 )
					ret := -0.400000
				if( ema3 > 112.671 )
					if( ema13 <= 7.82949 )
			...
			if( Raw_Money_Flow > 1.93947e+06 )
				...
				if( ema1 > 163.255 )
					ret := 0.600000
		if( Negative_Money_Flow_Sum > 3.9822e+07 )
			if( Positive_Money_Flow_Sum <= 1.60863e+08 )
				if( Positive_Money_Flow_Sum <= 8.27062e+07 )
					if( ema12 <= 5.30711 )
						if( Typical_Price <= 149.173 )
							ret := -0.125000
						if( Typical_Price > 149.173 )
							ret := -1.000000 // sell
					if( ema12 > 5.30711 )
				...
				if( Positive_Money_Flow_Sum > 8.27062e+07 )
					if( ema3 <= 185.165 )
						...
						if( ema13 > 4.17829 )
							ret := 0.866667 // buy
					if( ema3 > 185.165 )
						if( Negative_Money_Flow_Sum <= 5.31931e+07 )
							ret := -1.000000 // sell
						if( Negative_Money_Flow_Sum > 5.31931e+07 )
							ret := 0.263158
			if( Positive_Money_Flow_Sum > 1.60863e+08 )
				if( Raw_Money_Flow <= 4.64254e+06 )
					ret := 1.000000 // buy
				if( Raw_Money_Flow > 4.64254e+06 )
					if( MFI_Low <= 31.1722 )
						ret := 0.000000
...
float op_operation = decision_tree_0_FFIV_30Min_df5d2150(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
