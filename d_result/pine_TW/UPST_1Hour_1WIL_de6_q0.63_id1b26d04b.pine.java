				...
				if( Color_con1 > -16.7794 )
					...
					if( lowerBand > -1.51195 )
						...
						if( Color_con2 > -8.42028 )
							ret := -0.137363
	if( Color_con1 > -12.5756 )
		if( Color_con2 <= -12.5932 )
			if( Color_con1 <= -6.3606 )
				if( wvf <= 1.51744 )
					if( midLine <= 3.67531 )
						if( wvf <= 0.485574 )
							ret := 0.000000
				...
				if( wvf > 1.51744 )
					...
					if( sDev > 4.72574 )
						...
						if( sDev > 8.67622 )
							ret := 0.142857
			if( Color_con1 > -6.3606 )
				if( Color_con2 <= -14.5433 )
					if( midLine <= 5.80765 )
						if( Color_con1 <= -4.39698 )
							ret := -0.689655
						if( Color_con1 > -4.39698 )
							ret := -0.126437
					if( midLine > 5.80765 )
						if( Color_con1 <= -4.53479 )
							ret := 0.363636
						if( Color_con1 > -4.53479 )
							ret := 0.956522 // buy
				if( Color_con2 > -14.5433 )
		...
		if( Color_con2 > -12.5932 )
			if( sDev <= 4.232 )
				if( midLine <= 1.67299 )
					if( Color_con2 <= -2.34828 )
						if( Color_con1 <= -1.22052 )
							ret := -0.252236
						if( Color_con1 > -1.22052 )
							ret := -0.789474 // sell
					if( Color_con2 > -2.34828 )
				...
				if( midLine > 1.67299 )
					...
					if( wvf > 1.55895 )
						...
						if( wvf > 5.9985 )
							ret := -0.131812
			if( sDev > 4.232 )
				if( upperBand <= 7.82252 )
					if( Color_con2 <= 5.07267 )
						if( Color_con1 <= -0.102022 )
							ret := -0.526667
						if( Color_con1 > -0.102022 )
							ret := -0.043478
					if( Color_con2 > 5.07267 )
				...
				if( upperBand > 7.82252 )
					if( sDev <= 6.56473 )
						if( upperBand <= 11.2536 )
							ret := -0.028351
						if( upperBand > 11.2536 )
							ret := -0.180570
					if( sDev > 6.56473 )
						if( Color_con1 <= -6.72736 )
							ret := 0.173633
						if( Color_con1 > -6.72736 )
							ret := -0.118451
...
float op_operation = decision_tree_0_UPST_1Hour_1b26d04b(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
