			...
			if( MFI_High > -23.8755 )
				...
				if( Positive_Money_Flow_Sum > 1.30362e+09 )
					...
					if( MFI > 71.6553 )
						ret := -0.666667
	if( Typical_Price > 143.321 )
		if( Raw_Money_Flow <= 1.28794e+08 )
			if( Positive_Money_Flow_Sum <= 9.90136e+08 )
				if( Positive_Money_Flow_Sum <= 4.02811e+08 )
					if( Typical_Price <= 157.707 )
						ret := 0.100000
					if( Typical_Price > 157.707 )
						ret := 0.602740
				if( Positive_Money_Flow_Sum > 4.02811e+08 )
					...
					if( ad_mf > 17159.9 )
						ret := -0.351039
			if( Positive_Money_Flow_Sum > 9.90136e+08 )
				if( Positive_Money_Flow <= 8.28349e+07 )
					if( Positive_Money_Flow_Sum <= 1.50416e+09 )
						ret := 0.509434
					if( Positive_Money_Flow_Sum > 1.50416e+09 )
						ret := -0.466667
				if( Positive_Money_Flow > 8.28349e+07 )
					if( Typical_Price <= 156.687 )
						ret := -0.642857
					if( Typical_Price > 156.687 )
						ret := 0.101449
		if( Raw_Money_Flow > 1.28794e+08 )
			if( ad <= -641091 )
				if( Negative_Money_Flow_Sum <= 1.324e+09 )
					if( Positive_Money_Flow <= 1.71321e+08 )
						ret := -0.419355
					if( Positive_Money_Flow > 1.71321e+08 )
						ret := 0.615385
				if( Negative_Money_Flow_Sum > 1.324e+09 )
					if( Positive_Money_Flow_Sum <= 6.05533e+08 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 6.05533e+08 )
						ret := 0.428571
			if( ad > -641091 )
				if( Negative_Money_Flow_Sum <= 6.8995e+08 )
					if( Positive_Money_Flow_Sum <= 1.47742e+09 )
						ret := 0.140625
					if( Positive_Money_Flow_Sum > 1.47742e+09 )
						ret := -0.568966
				if( Negative_Money_Flow_Sum > 6.8995e+08 )
					if( Raw_Money_Flow <= 2.2588e+08 )
						ret := -0.600858
					if( Raw_Money_Flow > 2.2588e+08 )
						ret := -0.025641
...
float op_operation = decision_tree_0_FFIV_1Day_92085fc2(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
