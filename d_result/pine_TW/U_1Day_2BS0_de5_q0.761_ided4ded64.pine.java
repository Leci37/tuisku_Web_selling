			...
			if( d <= 90.5917 )
				...
				if( rsi1 > 73.0793 )
					...
					if( d_k > 3.79503 )
						ret := -0.888889 // sell
			if( d > 90.5917 )
				if( bearPower <= -1.25648 )
					if( bearPower <= -1.55496 )
						ret := 0.235294
					if( bearPower > -1.55496 )
						ret := 1.000000 // buy
				if( bearPower > -1.25648 )
			...
			if( smoothK_k <= 33.1371 )
				...
				if( d_k > 22.4 )
					...
					if( bbm > 3.80554 )
						ret := 0.857143 // buy
			if( smoothK_k > 33.1371 )
				if( smoothK_k <= 35.6262 )
					if( bbm <= 4.62482 )
						ret := -0.200000
					if( bbm > 4.62482 )
						ret := -1.000000 // sell
				if( smoothK_k > 35.6262 )
					if( bearPower <= 0.459234 )
						ret := 0.538462
					if( bearPower > 0.459234 )
						ret := -0.200000
...
float op_operation = decision_tree_0_U_1Day_ed4ded64(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)
