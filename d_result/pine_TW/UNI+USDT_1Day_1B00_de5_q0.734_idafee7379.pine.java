			...
			if( bearPower <= -0.07002 )
				if( bbm <= 0.951328 )
					...
					if( bbp > -0.027562 )
						ret := -0.153333
				if( bbm > 0.951328 )
					if( bullPower <= 1.27898 )
						ret := 0.645833
					if( bullPower > 1.27898 )
						ret := -0.068966
			if( bearPower > -0.07002 )
				if( bullPower <= 0.544811 )
					if( bullPower <= 0.447615 )
						ret := 0.461039
					if( bullPower > 0.447615 )
						ret := 0.034483
				if( bullPower > 0.544811 )
					ret := 0.750000 // buy
		if( bbp > 0.687366 )
			if( bearPower <= 0.287395 )
				if( bbp <= 0.767632 )
					if( bearPower <= -0.336548 )
						ret := 0.285714
					if( bearPower > -0.336548 )
						ret := -0.760563 // sell
				if( bbp > 0.767632 )
					if( bullPower <= 1.56957 )
						ret := 0.031847
					if( bullPower > 1.56957 )
						ret := -0.211864
			if( bearPower > 0.287395 )
				if( bullPower <= 1.24417 )
					if( bbm <= 0.525236 )
						ret := 0.423077
					if( bbm > 0.525236 )
						ret := -0.350000
				if( bullPower > 1.24417 )
					if( bullPower <= 3.08461 )
						ret := 0.479167
					if( bullPower > 3.08461 )
						ret := 0.010870
...
float op_operation = decision_tree_0_UNIUSDT_1Day_afee7379(bbp, bullPower, BBPower_Color, bearPower, bbm)
