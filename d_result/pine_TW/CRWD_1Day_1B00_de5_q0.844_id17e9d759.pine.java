			...
			if( bbp <= -17.8942 )
				...
				if( bearPower > -23.7058 )
					...
					if( bbp > -21.302 )
						ret := 0.853659 // buy
			if( bbp > -17.8942 )
				if( bullPower <= 5.39966 )
					if( bearPower <= -15.2878 )
						ret := 0.000000
					if( bearPower > -15.2878 )
						ret := -0.750000 // sell
				if( bullPower > 5.39966 )
...
float op_operation = decision_tree_0_CRWD_1Day_17e9d759(bearPower, bbm, bbp, bullPower, BBPower_Color)
