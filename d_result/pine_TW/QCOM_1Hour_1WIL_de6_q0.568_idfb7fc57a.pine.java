...
decision_tree_0_QCOM_1Hour_fb7fc57a(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)=>
	...
	if( Color_con1 > 0.318515 )
		if( sDev <= 2.46229 )
			if( Color_con2 <= 2.63029 )
				if( lowerBand <= -0.857063 )
					ret := -0.532258
				if( lowerBand > -0.857063 )
					if( Color_con2 <= -1.3764 )
						if( Color_con1 <= 0.375841 )
							ret := 1.000000 // buy
						if( Color_con1 > 0.375841 )
							ret := -0.647059
					if( Color_con2 > -1.3764 )
						if( Color_con2 <= -0.161422 )
							ret := 0.359375
						if( Color_con2 > -0.161422 )
							ret := -0.106383
			if( Color_con2 > 2.63029 )
				ret := 0.842105 // buy
		if( sDev > 2.46229 )
			if( upperBand <= 8.11766 )
				ret := -0.707921 // sell
			if( upperBand > 8.11766 )
				if( Color_con2 <= 8.52819 )
					if( Color_con2 <= 1.4672 )
						ret := -1.000000 // sell
					if( Color_con2 > 1.4672 )
						ret := 0.642857
				if( Color_con2 > 8.52819 )
...
float op_operation = decision_tree_0_QCOM_1Hour_fb7fc57a(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
