	...
	if( senkou_span_b > 11.4062 )
		if( chinkou_span <= 11.6698 )
			...
			if( tenkan_sen > 11.9156 )
				ret := -0.703704 // sell
		if( chinkou_span > 11.6698 )
			if( tenkan_sen <= 11.7848 )
				if( senkou_span_b_displaced <= 11.7737 )
					if( senkou_span_a_displaced <= 11.5119 )
						if( senkou_span_b_displaced <= 11.3601 )
							ret := 0.933333 // buy
						if( senkou_span_b_displaced > 11.3601 )
							ret := -0.069767
					if( senkou_span_a_displaced > 11.5119 )
						ret := 0.607973
				if( senkou_span_b_displaced > 11.7737 )
					if( senkou_span_a_displaced <= 11.9288 )
						ret := -0.060345
					if( senkou_span_a_displaced > 11.9288 )
						ret := 0.742857 // buy
			if( tenkan_sen > 11.7848 )
				if( chinkou_span <= 23.3199 )
					if( senkou_span_b <= 23.2708 )
						if( kinjun_sen <= 22.8951 )
							ret := -0.000208
						if( kinjun_sen > 22.8951 )
							ret := -0.436275
					if( senkou_span_b > 23.2708 )
						if( senkou_span_b_displaced <= 23.9423 )
							ret := -0.321970
						if( senkou_span_b_displaced > 23.9423 )
							ret := -0.775330 // sell
				if( chinkou_span > 23.3199 )
					if( tenkan_sen <= 23.9469 )
						if( senkou_span_a_displaced <= 23.1779 )
							ret := 0.611486
						if( senkou_span_a_displaced > 23.1779 )
							ret := 0.248796
					if( tenkan_sen > 23.9469 )
						if( senkou_span_a <= 25.4737 )
							ret := -0.114065
						if( senkou_span_a > 25.4737 )
							ret := -0.909091 // sell
...
float op_operation = decision_tree_0_ASAN_5Min_c3d095de(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
