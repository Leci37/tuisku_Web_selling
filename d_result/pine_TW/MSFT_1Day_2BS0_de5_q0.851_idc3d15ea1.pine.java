...
decision_tree_0_MSFT_1Day_c3d15ea1(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( rsi1 > 41.5186 )
		...
		if( bbp > -5.65572 )
			if( rsi1 <= 67.2579 )
				if( smoothD_d <= 93.8847 )
					if( bullPower <= -0.039252 )
						ret := 0.450980
					if( bullPower > -0.039252 )
						ret := 0.064636
				if( smoothD_d > 93.8847 )
					if( smoothK_k <= 96.5498 )
						ret := -0.680851
					if( smoothK_k > 96.5498 )
						ret := 0.833333 // buy
			if( rsi1 > 67.2579 )
				if( smoothD_d <= 95.0821 )
					if( bullPower <= 1.97049 )
						ret := 0.159091
					if( bullPower > 1.97049 )
						ret := -0.307252
				if( smoothD_d > 95.0821 )
...
float op_operation = decision_tree_0_MSFT_1Day_c3d15ea1(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
