		...
		if( bearPower <= 22.0308 )
			...
			if( bullPower > 41.762 )
				...
				if( bbm > 57.7821 )
					ret := 0.857143 // buy
		if( bearPower > 22.0308 )
			if( bullPower <= 41.2963 )
				ret := 0.000000
			if( bullPower > 41.2963 )
				if( bearPower <= 31.0184 )
					if( bbm <= 22.0637 )
						ret := -0.687500
					if( bbm > 22.0637 )
						ret := -0.923077 // sell
				if( bearPower > 31.0184 )
					if( bearPower <= 38.4468 )
						ret := -0.500000
					if( bearPower > 38.4468 )
						ret := 0.000000
...
float op_operation = decision_tree_0_HUBS_1Day_b57f2f14(bearPower, bbm, bbp, bullPower, BBPower_Color)
