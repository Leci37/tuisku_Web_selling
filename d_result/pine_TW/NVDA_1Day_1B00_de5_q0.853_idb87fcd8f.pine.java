...
decision_tree_0_NVDA_1Day_b87fcd8f(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bbp > 105.133 )
		if( bbm <= 34.5813 )
			if( bbm <= 28.4988 )
				if( bearPower <= 43.2466 )
					ret := -1.000000 // sell
				if( bearPower > 43.2466 )
					ret := -0.166667
			if( bbm > 28.4988 )
				if( bullPower <= 71.3055 )
					ret := -0.900000 // sell
				if( bullPower > 71.3055 )
					ret := -1.000000 // sell
		if( bbm > 34.5813 )
			if( bearPower <= 60.3094 )
				ret := 0.571429
			if( bearPower > 60.3094 )
				if( bearPower <= 70.3089 )
					ret := -1.000000 // sell
				if( bearPower > 70.3089 )
					if( bullPower <= 125.027 )
						ret := 1.000000 // buy
					if( bullPower > 125.027 )
						ret := -0.533333
...
float op_operation = decision_tree_0_NVDA_1Day_b87fcd8f(bearPower, bbm, bbp, bullPower, BBPower_Color)
