	...
	if( chinkou_span > 10.7893 )
		if( senkou_span_a <= 11.6833 )
			...
			if( chinkou_span > 12.2398 )
				ret := 0.838129 // buy
		if( senkou_span_a > 11.6833 )
			if( senkou_span_b_displaced <= 75.4568 )
				if( chinkou_span <= 60.9092 )
					if( senkou_span_a <= 60.6489 )
						if( chinkou_span <= 11.8214 )
							ret := -0.500000
						if( chinkou_span > 11.8214 )
							ret := 0.011282
					if( senkou_span_a > 60.6489 )
						if( senkou_span_b_displaced <= 70.4871 )
							ret := -0.765517 // sell
						if( senkou_span_b_displaced > 70.4871 )
							ret := 0.214286
				if( chinkou_span > 60.9092 )
					if( tenkan_sen <= 60.5061 )
						ret := 0.688000
					if( tenkan_sen > 60.5061 )
						if( chinkou_span <= 67.7618 )
							ret := -0.072581
						if( chinkou_span > 67.7618 )
							ret := 0.455046
			if( senkou_span_b_displaced > 75.4568 )
				if( basis_minus <= -4.86777 )
					if( basis_max <= 0.88134 )
						ret := -0.272727
					if( basis_max > 0.88134 )
						ret := 0.813953 // buy
				if( basis_minus > -4.86777 )
					if( chinkou_span <= 77.8191 )
						ret := -0.655696
					if( chinkou_span > 77.8191 )
						if( senkou_span_b <= 87.0146 )
							ret := 0.279412
						if( senkou_span_b > 87.0146 )
							ret := -0.323077
...
float op_operation = decision_tree_0_RUN_1Hour_c32e8d3d(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
