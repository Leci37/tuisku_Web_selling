			...
			if( bearPower <= -1.45094 )
				...
				if( VIM > 1.32963 )
					...
					if( bbm > 0.950939 )
						ret := 0.906250 // buy
			if( bearPower > -1.45094 )
				if( bullPower <= 1.33653 )
					if( bullPower <= 0.071504 )
						ret := 0.111111
					if( bullPower > 0.071504 )
						ret := -0.342857
				if( bullPower > 1.33653 )
...
float op_operation = decision_tree_0_ASAN_1Day_3597eb4d(bullPower, bbp, bearPower, bbm, BBPower_Color, VIP, VIM, VIP_VIM)
