			...
			if( Positive_Money_Flow_Sum <= 6.10211e+09 )
				if( smoothK_k <= 95.9883 )
					...
					if( k > 67.101 )
						ret := 0.083333
				if( smoothK_k > 95.9883 )
					if( Raw_Money_Flow <= 7.80196e+07 )
						ret := -0.153846
					if( Raw_Money_Flow > 7.80196e+07 )
						ret := -0.770492 // sell
			if( Positive_Money_Flow_Sum > 6.10211e+09 )
				if( Money_Flow_Ratio <= 1.41457 )
					if( Typical_Price <= 168.768 )
						ret := 0.290909
					if( Typical_Price > 168.768 )
						ret := -0.702703 // sell
				if( Money_Flow_Ratio > 1.41457 )
					if( Typical_Price <= 161.038 )
						ret := 0.625000
					if( Typical_Price > 161.038 )
						ret := 0.128571
		if( Positive_Money_Flow_Sum > 7.00331e+10 )
			if( smoothK_k <= -2.98873 )
				if( Raw_Money_Flow <= 3.3461e+09 )
					ret := -1.000000 // sell
				if( Raw_Money_Flow > 3.3461e+09 )
					if( Negative_Money_Flow <= 4.13887e+09 )
						ret := 0.000000
					if( Negative_Money_Flow > 4.13887e+09 )
						ret := -1.000000 // sell
			if( smoothK_k > -2.98873 )
...
float op_operation = decision_tree_0_GME_1Day_d9d477ab(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
