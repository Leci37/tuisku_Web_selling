				...
				if( chinkou_span > 131.698 )
					...
					if( senkou_span_a > 124.257 )
						...
						if( senkou_span_b > 138.785 )
							ret := 1.000000 // buy
			if( tenkan_sen > 139.152 )
				if( basis_max <= -0.918106 )
					if( senkou_span_b <= 148.241 )
						if( senkou_span_a_displaced <= 124.164 )
							ret := -0.562500
						if( senkou_span_a_displaced > 124.164 )
							ret := -0.961538 // sell
					if( senkou_span_b > 148.241 )
						ret := 0.000000
				if( basis_max > -0.918106 )
					if( senkou_span_b <= 159.516 )
						if( basis_minus <= 8.5729 )
							ret := -0.069486
						if( basis_minus > 8.5729 )
							ret := -1.000000 // sell
					if( senkou_span_b > 159.516 )
						if( basis_minus <= -0.709652 )
							ret := -0.729730 // sell
						if( basis_minus > -0.709652 )
							ret := -1.000000 // sell
		if( chinkou_span > 150.893 )
			if( senkou_span_a <= 151.084 )
				if( chinkou_span <= 158.145 )
					if( basis_max <= 0.025726 )
						if( senkou_span_a_displaced <= 153.397 )
							ret := 0.714286 // buy
						if( senkou_span_a_displaced > 153.397 )
							ret := -0.125000
					if( basis_max > 0.025726 )
						if( senkou_span_a_displaced <= 152.539 )
							ret := -0.433962
						if( senkou_span_a_displaced > 152.539 )
							ret := 0.757576 // buy
				if( chinkou_span > 158.145 )
					if( kinjun_sen <= 149.567 )
						if( chinkou_span <= 170.377 )
							ret := 0.977011 // buy
						if( chinkou_span > 170.377 )
							ret := 0.818182 // buy
					if( kinjun_sen > 149.567 )
						if( basis_max <= 0.612075 )
							ret := 0.437500
						if( basis_max > 0.612075 )
							ret := 0.956522 // buy
			if( senkou_span_a > 151.084 )
				if( chinkou_span <= 179.977 )
					if( tenkan_sen <= 169.139 )
						if( chinkou_span <= 156.081 )
							ret := -0.491228
						if( chinkou_span > 156.081 )
							ret := 0.067701
					if( tenkan_sen > 169.139 )
						if( chinkou_span <= 172.153 )
							ret := -0.671827
						if( chinkou_span > 172.153 )
							ret := -0.169048
				if( chinkou_span > 179.977 )
					if( kinjun_sen <= 178.313 )
						if( senkou_span_b_displaced <= 181.482 )
							ret := 0.775194 // buy
						if( senkou_span_b_displaced > 181.482 )
							ret := -0.384615
					if( kinjun_sen > 178.313 )
						if( tenkan_sen <= 828.817 )
							ret := -0.004487
						if( tenkan_sen > 828.817 )
							ret := -0.688172
...
float op_operation = decision_tree_0_HUBS_1Hour_d3cead87(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
