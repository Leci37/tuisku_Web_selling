...
decision_tree_0_ADBE_5Min_9e4e2d8e(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)=>
				...
				if( marron_mean <= -9.42483 )
					if( nvimin <= 0.228594 )
						...
						if( media > -1.87926 )
							ret := 0.634783
					if( nvimin > 0.228594 )
						if( media_azul <= 70.3329 )
							ret := -0.285714
						if( media_azul > 70.3329 )
							ret := -0.818182 // sell
				if( marron_mean > -9.42483 )
					if( verde <= -39.0971 )
						if( verde_mean <= -44.3124 )
							ret := 0.583333
						if( verde_mean > -44.3124 )
							ret := -0.066667
					if( verde > -39.0971 )
	...
	if( marron_mean > -5.89949 )
		...
		if( BollOsc > 49.6828 )
			if( xmf <= 95.8801 )
				if( media_azul <= 132.705 )
					if( verde_media <= 7.18085 )
						if( azul_mean <= 40.4286 )
							ret := 0.150000
						if( azul_mean > 40.4286 )
							ret := 0.960000 // buy
					if( verde_media > 7.18085 )
			...
			if( xmf > 95.8801 )
				if( xrsi <= 84.2279 )
					if( media_azul <= 77.3744 )
						if( pvi <= 0.181645 )
							ret := -0.550000
						if( pvi > 0.181645 )
							ret := 0.234177
					if( media_azul > 77.3744 )
						if( verde_azul <= 236.221 )
							ret := 0.711656 // buy
						if( verde_azul > 236.221 )
							ret := -0.333333
				if( xrsi > 84.2279 )
...
float op_operation = decision_tree_0_ADBE_5Min_9e4e2d8e(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
