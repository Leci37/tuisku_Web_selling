			...
			if( Positive_Money_Flow_Sum <= 1.79633e+09 )
				if( Typical_Price <= 330.384 )
					...
					if( MFI_Low > 19.4436 )
						ret := 0.335570
				if( Typical_Price > 330.384 )
					if( Money_Flow_Ratio <= 0.610259 )
						ret := 0.625000
					if( Money_Flow_Ratio > 0.610259 )
						ret := -0.378788
			if( Positive_Money_Flow_Sum > 1.79633e+09 )
				if( Negative_Money_Flow <= 1.47235e+07 )
					if( Typical_Price <= 343.512 )
						ret := -0.482759
					if( Typical_Price > 343.512 )
						ret := 0.011765
				if( Negative_Money_Flow > 1.47235e+07 )
					if( Negative_Money_Flow_Sum <= 1.38735e+09 )
						ret := -0.854369 // sell
					if( Negative_Money_Flow_Sum > 1.38735e+09 )
						ret := -0.316456
		if( Raw_Money_Flow > 2.77619e+08 )
			if( Negative_Money_Flow_Sum <= 3.38206e+09 )
				if( Positive_Money_Flow_Sum <= 4.31042e+09 )
					if( Negative_Money_Flow_Sum <= 2.6613e+09 )
						ret := 0.130435
					if( Negative_Money_Flow_Sum > 2.6613e+09 )
						ret := 0.740541 // buy
				if( Positive_Money_Flow_Sum > 4.31042e+09 )
					...
					if( MFI_Low > 51.1144 )
						ret := 0.263415
			if( Negative_Money_Flow_Sum > 3.38206e+09 )
				if( Negative_Money_Flow_Sum <= 4.83139e+09 )
					if( Positive_Money_Flow_Sum <= 2.86691e+09 )
						ret := 0.147826
					if( Positive_Money_Flow_Sum > 2.86691e+09 )
						ret := -0.320574
				if( Negative_Money_Flow_Sum > 4.83139e+09 )
					if( Typical_Price <= 1474.58 )
						ret := 0.235412
					if( Typical_Price > 1474.58 )
						ret := -0.370968
...
float op_operation = decision_tree_0_MELI_1Day_a8ac7660(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
