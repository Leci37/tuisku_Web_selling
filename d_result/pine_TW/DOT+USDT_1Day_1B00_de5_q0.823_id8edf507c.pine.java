			...
			if( bbp <= -0.356574 )
				...
				if( bullPower > -0.129818 )
					...
					if( bbp > -0.50993 )
						ret := -0.258065
			if( bbp > -0.356574 )
				if( bearPower <= 1.97388 )
					if( bearPower <= 1.01281 )
						ret := -0.011765
					if( bearPower > 1.01281 )
						ret := 0.630952
				if( bearPower > 1.97388 )
					if( bullPower <= 4.73209 )
						ret := -0.689655
					if( bullPower > 4.73209 )
						ret := -0.020408
...
float op_operation = decision_tree_0_DOTUSDT_1Day_8edf507c(bearPower, bbm, bbp, bullPower, BBPower_Color)
