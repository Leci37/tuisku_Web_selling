				...
				if( bullPower > -0.168714 )
					...
					if( Lower_Band > 26.1591 )
						...
						if( bbp > -0.480296 )
							ret := -0.074720
	if( bullPower > 0.049631 )
		if( Lower_Band <= 133.542 )
			if( bbp <= 4.00642 )
				if( bullPower <= 0.550308 )
					if( bbm <= 0.04417 )
						if( Lower_Band <= 16.429 )
							ret := -0.305310
						if( Lower_Band > 16.429 )
							ret := -0.061959
					if( bbm > 0.04417 )
						if( Lower_Band <= 17.6509 )
							ret := 0.104381
						if( Lower_Band > 17.6509 )
							ret := -0.034088
				if( bullPower > 0.550308 )
					...
					if( bbm > 0.289699 )
						...
						if( bbm > 0.457341 )
							ret := -0.137921
			if( bbp > 4.00642 )
				if( Lower_Band <= 20.1812 )
					ret := -1.000000 // sell
				if( Lower_Band > 20.1812 )
					if( Lower_Band <= 64.7193 )
						if( bbm <= 0.955 )
							ret := 0.817204 // buy
						if( bbm > 0.955 )
							ret := 0.307143
...
float op_operation = decision_tree_0_ASAN_30Min_6830b2d7(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
