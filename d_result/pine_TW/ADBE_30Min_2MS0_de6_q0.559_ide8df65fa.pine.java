		...
		if( Negative_Money_Flow_Sum > 3.4147e+08 )
			...
			if( d_k > 5.65879 )
				if( Money_Flow_Ratio <= 0.0537 )
					ret := -0.207493
				if( Money_Flow_Ratio > 0.0537 )
					if( Positive_Money_Flow <= 8.58393e+07 )
						ret := 0.141894
					if( Positive_Money_Flow > 8.58393e+07 )
						ret := -0.255682
	if( rsi1 > 50.3341 )
		if( Positive_Money_Flow_Sum <= 6.26884e+08 )
			if( MFI_High <= 18.5767 )
				if( MFI_Low <= 74.7317 )
					ret := -0.046538
				if( MFI_Low > 74.7317 )
					ret := 0.324503
			if( MFI_High > 18.5767 )
				if( Raw_Money_Flow <= 1.90059e+06 )
					ret := -0.641711
				if( Raw_Money_Flow > 1.90059e+06 )
					ret := -0.145985
		if( Positive_Money_Flow_Sum > 6.26884e+08 )
			if( Positive_Money_Flow <= 37872.8 )
				if( MFI_Low <= 67.4634 )
					ret := 0.194050
				if( MFI_Low > 67.4634 )
					if( Negative_Money_Flow_Sum <= 3.66341e+06 )
						ret := 0.666667
					if( Negative_Money_Flow_Sum > 3.66341e+06 )
						ret := -0.134357
			if( Positive_Money_Flow > 37872.8 )
				if( Positive_Money_Flow <= 4.03491e+07 )
					if( Negative_Money_Flow_Sum <= 7.72994e+07 )
						if( Positive_Money_Flow <= 1.04049e+06 )
							ret := -0.154229
						if( Positive_Money_Flow > 1.04049e+06 )
							ret := -0.709091 // sell
					if( Negative_Money_Flow_Sum > 7.72994e+07 )
...
float op_operation = decision_tree_0_ADBE_30Min_e8df65fa(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
