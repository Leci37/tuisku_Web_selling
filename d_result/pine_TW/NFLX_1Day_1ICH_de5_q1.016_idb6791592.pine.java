		...
		if( kinjun_sen <= 508.402 )
			if( basis_minus <= 19.6024 )
				if( senkou_span_b_displaced <= 322.924 )
					ret := -0.555556
				if( senkou_span_b_displaced > 322.924 )
					if( basis_minus <= -21.2201 )
						ret := 0.210526
					if( basis_minus > -21.2201 )
						ret := 0.742160 // buy
			if( basis_minus > 19.6024 )
				if( senkou_span_a_displaced <= 384.039 )
					if( basis_minus <= 41.7084 )
						ret := -0.150000
					if( basis_minus > 41.7084 )
						ret := -0.882353 // sell
				if( senkou_span_a_displaced > 384.039 )
					if( kinjun_sen <= 487.607 )
						ret := 0.523077
					if( kinjun_sen > 487.607 )
						ret := -0.714286 // sell
		if( kinjun_sen > 508.402 )
			if( chinkou_span <= 591.41 )
				if( tenkan_sen <= 519.906 )
					if( basis_minus <= 11.4478 )
						ret := 0.377551
					if( basis_minus > 11.4478 )
						ret := -0.700000 // sell
				if( tenkan_sen > 519.906 )
					if( senkou_span_b_displaced <= 504.166 )
						ret := -1.000000 // sell
					if( senkou_span_b_displaced > 504.166 )
						ret := -0.418301
			if( chinkou_span > 591.41 )
				if( tenkan_sen <= 583.961 )
					if( senkou_span_b_displaced <= 461.542 )
						ret := 0.111111
					if( senkou_span_b_displaced > 461.542 )
						ret := 0.704918 // buy
				if( tenkan_sen > 583.961 )
					if( senkou_span_b_displaced <= 569.669 )
						ret := -0.285714
					if( senkou_span_b_displaced > 569.669 )
						ret := 0.314286
...
float op_operation = decision_tree_0_NFLX_1Day_b6791592(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
