	...
	if( ema3 <= 286.082 )
		...
		if( ema3 > 213.714 )
			if( ema1 <= 219.704 )
				if( ema12 <= 2.02632 )
					if( ema2 <= 216.214 )
						if( bullPower <= 0.023982 )
							ret := 0.821429 // buy
						if( bullPower > 0.023982 )
							ret := 0.433333
					if( ema2 > 216.214 )
						if( bullPower <= 4.45672 )
							ret := 0.935484 // buy
						if( bullPower > 4.45672 )
							ret := 0.000000
				if( ema12 > 2.02632 )
...
float op_operation = decision_tree_0_HUBS_30Min_5be86826(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
