				...
				if( VIP > 1.20565 )
					...
					if( VIP_VIM > -0.617667 )
						...
						if( bbp > -1.56102 )
							ret := 0.636364
	if( bbp > -1.36207 )
		if( bullPower <= 0.675144 )
			if( VIP <= 1.22175 )
				if( bullPower <= -0.129214 )
					if( VIM <= 1.02182 )
						if( bbm <= 0.061099 )
							ret := 0.210526
						if( bbm > 0.061099 )
		...
		if( bullPower > 0.675144 )
			if( bbm <= 0.074755 )
				if( bearPower <= 1.60082 )
					if( bullPower <= 1.52726 )
						if( bullPower <= 1.0768 )
							ret := -0.207273
						if( bullPower > 1.0768 )
							ret := -0.460265
...
float op_operation = decision_tree_0_DDOG_30Min_02826bb1(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
