...
decision_tree_0_HUBS_1Day_09014325(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)=>
	...
	if( VIP_VIM > 0.067227 )
		...
		if( bbm > 20.1114 )
			if( VIP_VIM <= 0.342859 )
				if( VIP <= 1.0824 )
					if( bearPower <= 0.333624 )
						ret := -0.518519
					if( bearPower > 0.333624 )
						ret := 0.666667
				if( VIP > 1.0824 )
					if( bullPower <= 18.0194 )
						ret := 0.307692
					if( bullPower > 18.0194 )
						ret := -0.790210 // sell
			if( VIP_VIM > 0.342859 )
				if( bullPower <= 44.7418 )
					if( bbm <= 22.3019 )
						ret := -0.363636
					if( bbm > 22.3019 )
						ret := 0.480000
...
float op_operation = decision_tree_0_HUBS_1Day_09014325(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
