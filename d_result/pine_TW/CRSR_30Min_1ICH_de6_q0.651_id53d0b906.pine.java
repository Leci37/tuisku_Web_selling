		...
		if( kinjun_sen <= 39.0368 )
			if( basis_minus <= 0.973681 )
				...
				if( basis_max > 0.071942 )
					ret := 0.756667 // buy
			if( basis_minus > 0.973681 )
				if( basis_max <= -0.222116 )
					ret := 0.290541
				if( basis_max > -0.222116 )
					ret := -0.325000
		if( kinjun_sen > 39.0368 )
			if( chinkou_span <= 41.8301 )
				if( senkou_span_a_displaced <= 38.4118 )
					if( chinkou_span <= 38.5258 )
						ret := -1.000000 // sell
					if( chinkou_span > 38.5258 )
						ret := 0.630435
				if( senkou_span_a_displaced > 38.4118 )
					if( senkou_span_b <= 38.9313 )
						ret := -0.937500 // sell
					if( senkou_span_b > 38.9313 )
						ret := -0.281538
			if( chinkou_span > 41.8301 )
				if( senkou_span_b <= 45.4575 )
					if( chinkou_span <= 43.0066 )
						if( tenkan_sen <= 40.3134 )
							ret := 0.815789 // buy
						if( tenkan_sen > 40.3134 )
							ret := 0.000000
					if( chinkou_span > 43.0066 )
						if( tenkan_sen <= 45.1025 )
							ret := 0.758197 // buy
						if( tenkan_sen > 45.1025 )
							ret := 0.285714
				if( senkou_span_b > 45.4575 )
...
float op_operation = decision_tree_0_CRSR_30Min_53d0b906(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
