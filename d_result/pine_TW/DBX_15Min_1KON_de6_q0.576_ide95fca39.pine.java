			...
			if( verde_media > -24.4824 )
				...
				if( media_azul > 111.696 )
					if( stoc <= 40.5486 )
						ret := -0.403846
					if( stoc > 40.5486 )
						if( verde_media <= -5.11325 )
							ret := 0.492355
						if( verde_media > -5.11325 )
							ret := 0.131447
		if( BollOsc > 37.6928 )
			if( media_azul <= 37.6588 )
				if( BollOsc <= 60.9291 )
					ret := -0.272809
				if( BollOsc > 60.9291 )
					if( marron <= 145.656 )
...
float op_operation = decision_tree_0_DBX_15Min_e95fca39(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
