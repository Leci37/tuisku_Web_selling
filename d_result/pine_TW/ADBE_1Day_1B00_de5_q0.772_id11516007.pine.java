...
decision_tree_0_ADBE_1Day_11516007(bullPower, bbp, bearPower, bbm, BBPower_Color)=>
	...
	if( bbm > 4.4056 )
		if( bullPower <= -2.70802 )
			...
			if( bullPower > -7.19917 )
				if( bbm <= 6.99712 )
					if( bearPower <= -9.12919 )
						ret := 1.000000 // buy
					if( bearPower > -9.12919 )
						ret := 0.500000
				if( bbm > 6.99712 )
					if( bearPower <= -12.8003 )
						ret := 0.536913
					if( bearPower > -12.8003 )
						ret := -0.714286 // sell
		if( bullPower > -2.70802 )
			if( bbp <= 7.00458 )
				if( bearPower <= -12.595 )
					...
					if( bbp > -25.7667 )
						ret := -0.656934
				if( bearPower > -12.595 )
					if( bearPower <= -8.11172 )
						ret := 0.076923
					if( bearPower > -8.11172 )
						ret := -0.392857
			if( bbp > 7.00458 )
				if( bullPower <= 8.25508 )
					if( bullPower <= 7.69812 )
						ret := -0.063830
					if( bullPower > 7.69812 )
						ret := -0.816327 // sell
				if( bullPower > 8.25508 )
					if( bearPower <= 0.880305 )
						ret := 0.417062
					if( bearPower > 0.880305 )
						ret := 0.048011
...
float op_operation = decision_tree_0_ADBE_1Day_11516007(bullPower, bbp, bearPower, bbm, BBPower_Color)
