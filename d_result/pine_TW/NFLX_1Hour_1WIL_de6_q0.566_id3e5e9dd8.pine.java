...
decision_tree_0_NFLX_1Hour_3e5e9dd8(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( sDev > 2.54879 )
		if( wvf <= 16.8365 )
			if( wvf <= 10.078 )
				if( lowerBand <= 5.69104 )
					if( Color_con1 <= -13.6624 )
						ret := -0.747664 // sell
					if( Color_con1 > -13.6624 )
						if( Color_con2 <= -7.72687 )
							ret := 0.356757
						if( Color_con2 > -7.72687 )
							ret := -0.095986
				if( lowerBand > 5.69104 )
...
float op_operation = decision_tree_0_NFLX_1Hour_3e5e9dd8(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
