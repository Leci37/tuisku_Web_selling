		...
		if( wvf > 14.6456 )
			if( upperBand <= 53.4935 )
				if( Color_con1 <= -22.2927 )
					ret := -0.333333
				if( Color_con1 > -22.2927 )
					if( lowerBand <= 18.4337 )
						ret := 0.461538
					if( lowerBand > 18.4337 )
						ret := 0.868421 // buy
			if( upperBand > 53.4935 )
				if( wvf <= 31.9365 )
					if( lowerBand <= 24.6016 )
						ret := 0.916667 // buy
					if( lowerBand > 24.6016 )
						ret := 0.125000
				if( wvf > 31.9365 )
...
float op_operation = decision_tree_0_NIO_1Day_8b718e94(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
