	...
	if( Money_Flow_Ratio > 0.763358 )
		...
		if( MFI > 68.9514 )
			if( Positive_Money_Flow_Sum <= 7.30299e+10 )
				if( Positive_Money_Flow_Sum <= 3.68996e+10 )
					if( ema12 <= 1.01499 )
						ret := 0.928571 // buy
					if( ema12 > 1.01499 )
						ret := 0.000000
			...
			if( Positive_Money_Flow_Sum > 7.30299e+10 )
				if( ema13 <= 12.4064 )
					if( Positive_Money_Flow <= 1.14411e+10 )
						ret := 0.000000
					if( Positive_Money_Flow > 1.14411e+10 )
						ret := 0.888889 // buy
				if( ema13 > 12.4064 )
...
float op_operation = decision_tree_0_META_1Day_7b740332(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
