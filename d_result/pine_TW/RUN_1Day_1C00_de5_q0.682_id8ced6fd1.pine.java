...
decision_tree_0_RUN_1Day_8ced6fd1(mf, ad, ad_mf)=>
	...
	if( mf > -0.257486 )
			...
			if( ad_mf <= 4.75833e+06 )
				if( ad_mf <= 4.47658e+06 )
					...
					if( ad_mf > 1.61223e+06 )
						ret := -0.121901
				if( ad_mf > 4.47658e+06 )
					if( ad_mf <= 4.67833e+06 )
						ret := 0.450000
					if( ad_mf > 4.67833e+06 )
						ret := 0.923077 // buy
			if( ad_mf > 4.75833e+06 )
				if( ad <= 5.85304e+06 )
					if( ad_mf <= 5.21931e+06 )
						ret := -0.666667
					if( ad_mf > 5.21931e+06 )
						ret := 0.000000
				if( ad > 5.85304e+06 )
		...
		if( ad_mf > 6.4534e+06 )
			...
			if( mf > -0.045435 )
				if( ad <= 1.50337e+07 )
					if( ad_mf <= 1.29427e+07 )
						ret := -0.014706
					if( ad_mf > 1.29427e+07 )
						ret := -0.565217
				if( ad > 1.50337e+07 )
					if( ad_mf <= 1.79913e+07 )
						ret := 0.833333 // buy
					if( ad_mf > 1.79913e+07 )
						ret := 0.000000
...
float op_operation = decision_tree_0_RUN_1Day_8ced6fd1(mf, ad, ad_mf)
