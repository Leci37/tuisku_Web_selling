			...
			if( midLine <= 12.0854 )
				...
				if( Color_con1 > -6.023 )
					...
					if( sDev > 9.03962 )
						ret := -0.809816 // sell
			if( midLine > 12.0854 )
				if( Color_con1 <= -13.1469 )
					if( lowerBand <= -3.36552 )
						ret := 0.842105 // buy
					if( lowerBand > -3.36552 )
						ret := -0.580153
				if( Color_con1 > -13.1469 )
					...
					if( upperBand > 20.128 )
						ret := 0.733813 // buy
		if( Color_con2 > 6.34877 )
			if( Color_con2 <= 10.375 )
				if( midLine <= 2.32004 )
					ret := 0.000000
				if( midLine > 2.32004 )
					if( lowerBand <= -5.28763 )
						ret := 0.000000
					if( lowerBand > -5.28763 )
						ret := 0.925000 // buy
			if( Color_con2 > 10.375 )
...
float op_operation = decision_tree_0_AMZN_1Day_fdcfe590(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
