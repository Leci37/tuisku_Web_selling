			...
			if( smoothK_k <= 7.16196 )
				if( rsi1 <= 31.9133 )
					...
					if( Negative_Money_Flow > 5.96815e+09 )
						ret := -0.714286 // sell
				if( rsi1 > 31.9133 )
					if( Positive_Money_Flow_Sum <= 2.88046e+10 )
						ret := -0.500000
					if( Positive_Money_Flow_Sum > 2.88046e+10 )
						ret := 0.250000
			if( smoothK_k > 7.16196 )
				if( Typical_Price <= 521.977 )
					if( d_k <= -16.0489 )
						ret := 0.375000
					if( d_k > -16.0489 )
						ret := -0.764957 // sell
				if( Typical_Price > 521.977 )
					if( Raw_Money_Flow <= 2.04533e+09 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 2.04533e+09 )
						ret := 0.000000
		if( Positive_Money_Flow_Sum > 3.15035e+10 )
			if( Raw_Money_Flow <= 3.5354e+09 )
				if( smoothD_d <= 94.7852 )
					if( MFI_High <= -35.2399 )
						ret := 0.500000
					if( MFI_High > -35.2399 )
						ret := 0.000000
...
float op_operation = decision_tree_0_NFLX_1Day_6d2e9245(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
