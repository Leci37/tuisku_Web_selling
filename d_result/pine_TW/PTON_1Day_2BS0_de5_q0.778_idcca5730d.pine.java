			...
			if( k > 73.2228 )
				...
				if( bullPower > -0.63724 )
					...
					if( k > 78.6535 )
						ret := -0.739726 // sell
		if( bbp > -0.934742 )
			if( bearPower <= 6.25586 )
				if( smoothD_d <= 91.7037 )
					if( smoothD_d <= 86.2151 )
						ret := -0.006954
					if( smoothD_d > 86.2151 )
						ret := 0.376344
				if( smoothD_d > 91.7037 )
...
float op_operation = decision_tree_0_PTON_1Day_cca5730d(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
