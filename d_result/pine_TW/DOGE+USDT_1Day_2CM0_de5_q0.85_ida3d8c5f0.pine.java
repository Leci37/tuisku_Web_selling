			...
			if( Negative_Money_Flow_Sum <= 2.18758e+09 )
				...
				if( Negative_Money_Flow_Sum > 1.14057e+09 )
					...
					if( ad > -1.76789e+08 )
						ret := 0.532374
			if( Negative_Money_Flow_Sum > 2.18758e+09 )
				if( Raw_Money_Flow <= 5.31884e+08 )
					if( Negative_Money_Flow <= 2.39118e+08 )
						ret := -0.846512 // sell
					if( Negative_Money_Flow > 2.39118e+08 )
						ret := -0.053333
				if( Raw_Money_Flow > 5.31884e+08 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_a3d8c5f0(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
