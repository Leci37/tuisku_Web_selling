		...
		if( Positive_Money_Flow_Sum <= 3.19805e+09 )
			if( Raw_Money_Flow <= 1.4601e+08 )
				...
				if( Typical_Price > 10727.4 )
					ret := -1.000000 // sell
			if( Raw_Money_Flow > 1.4601e+08 )
				if( Negative_Money_Flow <= 3.64503e+06 )
					if( MFI_Low <= 8.2847 )
						ret := -0.766667 // sell
					if( MFI_Low > 8.2847 )
						ret := 0.086957
				if( Negative_Money_Flow > 3.64503e+06 )
					if( Typical_Price <= 8039.36 )
						ret := -0.197802
					if( Typical_Price > 8039.36 )
						ret := -0.554974
		if( Positive_Money_Flow_Sum > 3.19805e+09 )
			if( Negative_Money_Flow_Sum <= 9.4238e+09 )
				if( Negative_Money_Flow_Sum <= 1.33163e+09 )
					if( Positive_Money_Flow_Sum <= 5.51257e+09 )
						ret := 0.180000
					if( Positive_Money_Flow_Sum > 5.51257e+09 )
						ret := -0.744681 // sell
				if( Negative_Money_Flow_Sum > 1.33163e+09 )
					if( Raw_Money_Flow <= 2.47705e+09 )
						ret := 0.189696
					if( Raw_Money_Flow > 2.47705e+09 )
						ret := 0.621053
			if( Negative_Money_Flow_Sum > 9.4238e+09 )
				if( ad_mf <= 63919.1 )
					...
					if( mf > 0.1024 )
						ret := -0.371166
				if( ad_mf > 63919.1 )
					if( Positive_Money_Flow <= 4.02843e+09 )
						ret := 0.633803
					if( Positive_Money_Flow > 4.02843e+09 )
						ret := 0.227273
...
float op_operation = decision_tree_0_BTCUSDT_1Day_cf0eee84(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
