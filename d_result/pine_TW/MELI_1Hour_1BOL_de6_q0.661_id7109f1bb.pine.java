	...
	if( BBlower > 777.427 )
		...
		if( BBlower > 909.809 )
			if( BBupper <= 1038.97 )
				ret := 1.000000 // buy
			if( BBupper > 1038.97 )
				if( dif_source_BBlower <= 0.91347 )
					if( dif_source_BBlower <= -23.2186 )
						if( BBlower <= 1067.18 )
							ret := 0.693548
						if( BBlower > 1067.18 )
							ret := -0.049724
...
float op_operation = decision_tree_0_MELI_1Hour_7109f1bb(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
