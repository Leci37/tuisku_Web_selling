				...
				if( Negative_Money_Flow_Sum <= 1.20167e+07 )
					...
					if( Long_MA > 19.5701 )
						...
						if( MFI > 96.4955 )
							ret := 0.160920
				if( Negative_Money_Flow_Sum > 1.20167e+07 )
					if( Positive_Money_Flow_Sum <= 4.9226e+08 )
						if( Short_MA <= 9.304 )
							ret := 0.549296
						if( Short_MA > 9.304 )
							ret := -0.054810
					if( Positive_Money_Flow_Sum > 4.9226e+08 )
						if( Positive_Money_Flow_Sum <= 9.66785e+08 )
							ret := -0.621053
						if( Positive_Money_Flow_Sum > 9.66785e+08 )
							ret := 0.153846
			if( MFI_Low > 79.8829 )
				if( Negative_Money_Flow_Sum <= 90433.7 )
					if( MFI <= 99.9843 )
						if( Raw_Money_Flow <= 9.55818e+06 )
							ret := -1.000000 // sell
						if( Raw_Money_Flow > 9.55818e+06 )
							ret := -0.714286 // sell
					if( MFI > 99.9843 )
						ret := -0.111111
				if( Negative_Money_Flow_Sum > 90433.7 )
					if( Negative_Money_Flow_Sum <= 461080 )
						if( Raw_Money_Flow <= 1.37307e+07 )
							ret := -0.071429
						if( Raw_Money_Flow > 1.37307e+07 )
							ret := -0.480000
					if( Negative_Money_Flow_Sum > 461080 )
						ret := -1.000000 // sell
	if( Short_Long_Diff > 1.93225 )
		if( Money_Flow_Ratio <= 32.3827 )
			if( Typical_Price <= 67.4185 )
				if( Negative_Money_Flow_Sum <= 2.88617e+07 )
					ret := -0.375000
				if( Negative_Money_Flow_Sum > 2.88617e+07 )
					if( Typical_Price <= 52.8815 )
						if( Money_Flow_Ratio <= 11.5601 )
							ret := 0.811594 // buy
						if( Money_Flow_Ratio > 11.5601 )
							ret := 0.142857
					if( Typical_Price > 52.8815 )
			...
			if( Typical_Price > 67.4185 )
				if( Long_MA <= 75.6539 )
					if( Positive_Money_Flow_Sum <= 3.44809e+08 )
						ret := 0.555556
					if( Positive_Money_Flow_Sum > 3.44809e+08 )
						if( Positive_Money_Flow_Sum <= 4.35397e+08 )
							ret := 0.833333 // buy
						if( Positive_Money_Flow_Sum > 4.35397e+08 )
							ret := 1.000000 // buy
				if( Long_MA > 75.6539 )
					if( Positive_Money_Flow_Sum <= 6.58295e+08 )
						ret := 0.076923
					if( Positive_Money_Flow_Sum > 6.58295e+08 )
						if( MFI_High <= 6.92628 )
							ret := 0.931034 // buy
		...
		if( Money_Flow_Ratio > 32.3827 )
			if( Short_MA <= 62.3873 )
				if( Positive_Money_Flow <= 1.08976e+06 )
					ret := 0.714286 // buy
				if( Positive_Money_Flow > 1.08976e+06 )
					if( Short_Long_Diff <= 2.3595 )
						ret := -0.428571
					if( Short_Long_Diff > 2.3595 )
						ret := -0.714286 // sell
			if( Short_MA > 62.3873 )
...
float op_operation = decision_tree_0_RUN_1Hour_50f8cd3d(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
