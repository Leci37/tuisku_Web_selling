			...
			if( rsi1 > 61.9788 )
				...
				if( d_k > -10.6291 )
					...
					if( ema3 > 865.307 )
						ret := 0.438849
		if( rsi1 > 79.8285 )
			if( smoothK_k <= 96.6906 )
				if( smoothK_k <= 80.6513 )
					if( smoothK_k <= 78.8002 )
						ret := 0.000000
					if( smoothK_k > 78.8002 )
						ret := 1.000000 // buy
				if( smoothK_k > 80.6513 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_e4f5bf91(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)
