			...
			if( Positive_Money_Flow_Sum > 2.69151e+09 )
				...
				if( Short_Long_Diff > 26.6606 )
					...
					if( MFI_Low > 66.3164 )
						ret := -0.833333 // sell
	if( Short_MA > 508.091 )
		if( Short_Long_Diff <= -22.6302 )
			if( Negative_Money_Flow <= 7.63606e+08 )
				if( Typical_Price <= 516.066 )
					if( Short_Long_Diff <= -73.7866 )
						ret := -1.000000 // sell
					if( Short_Long_Diff > -73.7866 )
						ret := -0.285714
				if( Typical_Price > 516.066 )
			...
			if( Negative_Money_Flow > 7.63606e+08 )
				ret := -0.555556
		if( Short_Long_Diff > -22.6302 )
			if( Positive_Money_Flow_Sum <= 1.94774e+09 )
				if( Negative_Money_Flow <= 4.69956e+08 )
					if( Raw_Money_Flow <= 1.33149e+08 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 1.33149e+08 )
						ret := -0.102273
				if( Negative_Money_Flow > 4.69956e+08 )
...
float op_operation = decision_tree_0_HUBS_1Day_e49f0f06(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
