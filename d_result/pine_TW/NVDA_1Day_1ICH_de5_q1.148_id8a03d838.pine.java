			...
			if( chinkou_span > 194.62 )
				...
				if( senkou_span_b > 261.017 )
					...
					if( chinkou_span > 228.464 )
						ret := -0.788571 // sell
	if( chinkou_span > 284.188 )
		if( senkou_span_a <= 863.297 )
			if( senkou_span_a <= 533.821 )
				if( basis_minus <= 49.039 )
					if( senkou_span_a_displaced <= 560.876 )
						ret := 0.520833
					if( senkou_span_a_displaced > 560.876 )
						ret := 0.937500 // buy
				if( basis_minus > 49.039 )
					if( senkou_span_b <= 385.335 )
						ret := 0.250000
					if( senkou_span_b > 385.335 )
						ret := -1.000000 // sell
			if( senkou_span_a > 533.821 )
				if( chinkou_span <= 759.945 )
					if( kinjun_sen <= 549.132 )
						ret := 0.046512
					if( kinjun_sen > 549.132 )
						ret := -0.671642
				if( chinkou_span > 759.945 )
					if( basis_max <= -33.6938 )
						ret := -0.111111
					if( basis_max > -33.6938 )
						ret := 0.675676
		if( senkou_span_a > 863.297 )
			if( tenkan_sen <= 906.847 )
				ret := -1.000000 // sell
			if( tenkan_sen > 906.847 )
				if( senkou_span_a_displaced <= 672.616 )
					ret := -1.000000 // sell
				if( senkou_span_a_displaced > 672.616 )
					ret := 0.000000
...
float op_operation = decision_tree_0_NVDA_1Day_8a03d838(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
