			...
			if( tenkan_sen > 91.6225 )
				...
				if( basis_minus > -14.6612 )
					...
					if( basis_max > 0.02859 )
						ret := -0.523179
		if( chinkou_span > 167.605 )
			if( tenkan_sen <= 175.384 )
				if( senkou_span_b_displaced <= 194.497 )
					if( kinjun_sen <= 162.193 )
						ret := 0.726316 // buy
					if( kinjun_sen > 162.193 )
						ret := 0.460396
				if( senkou_span_b_displaced > 194.497 )
					if( tenkan_sen <= 168.885 )
						ret := 0.000000
					if( tenkan_sen > 168.885 )
						ret := -1.000000 // sell
			if( tenkan_sen > 175.384 )
				if( senkou_span_b <= 284.202 )
					if( basis_minus <= -5.425 )
						ret := 0.582781
					if( basis_minus > -5.425 )
						ret := -0.089443
				if( senkou_span_b > 284.202 )
					if( tenkan_sen <= 266.833 )
						ret := -0.882353 // sell
					if( tenkan_sen > 266.833 )
						ret := -0.325000
...
float op_operation = decision_tree_0_BABA_1Day_3e697494(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
