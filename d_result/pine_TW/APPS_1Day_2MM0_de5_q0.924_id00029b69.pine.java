			...
			if( Negative_Money_Flow > 929.497 )
				...
				if( Positive_Money_Flow_Sum > 1.01294e+07 )
					...
					if( Positive_Money_Flow_Sum > 4.66749e+07 )
						ret := -0.166667
	if( Negative_Money_Flow_Sum > 4.47757e+07 )
		if( Negative_Money_Flow_Sum <= 8.178e+08 )
			if( MA_Cross <= 0.095067 )
				if( Long_MA <= 3.19548 )
					if( Short_Long_Diff <= -0.253938 )
						ret := -0.125000
					if( Short_Long_Diff > -0.253938 )
						ret := -0.903226 // sell
				if( Long_MA > 3.19548 )
					...
					if( Long_MA > 16.1624 )
						ret := -0.414948
			if( MA_Cross > 0.095067 )
				if( Positive_Money_Flow_Sum <= 2.63676e+08 )
					ret := 0.909091 // buy
				if( Positive_Money_Flow_Sum > 2.63676e+08 )
					ret := 0.000000
		if( Negative_Money_Flow_Sum > 8.178e+08 )
			if( Long_MA <= 56.623 )
				if( Negative_Money_Flow_Sum <= 1.5423e+09 )
					if( Money_Flow_Ratio <= 0.46238 )
						ret := -0.094340
					if( Money_Flow_Ratio > 0.46238 )
						ret := 0.675532
				if( Negative_Money_Flow_Sum > 1.5423e+09 )
					if( Short_Long_Diff <= -5.10476 )
						ret := 0.894737 // buy
					if( Short_Long_Diff > -5.10476 )
						ret := -0.634146
			if( Long_MA > 56.623 )
				if( Positive_Money_Flow_Sum <= 2.41667e+09 )
					if( Long_MA <= 69.1645 )
						ret := -0.092199
					if( Long_MA > 69.1645 )
						ret := -0.614035
				if( Positive_Money_Flow_Sum > 2.41667e+09 )
					if( Typical_Price <= 78.545 )
						ret := 0.826087 // buy
					if( Typical_Price > 78.545 )
						ret := 0.000000
...
float op_operation = decision_tree_0_APPS_1Day_00029b69(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
