		...
		if( Upper_Band <= 133.992 )
			if( Upper_Band <= 131.445 )
				...
				if( bearPower > -0.84938 )
					ret := 0.000000
			if( Upper_Band > 131.445 )
				if( bullPower <= -0.196443 )
					if( bbm <= 0.09 )
						ret := -1.000000 // sell
					if( bbm > 0.09 )
						ret := 0.076923
				if( bullPower > -0.196443 )
					if( Lower_Band <= 130.952 )
						ret := -0.737179 // sell
					if( Lower_Band > 130.952 )
						ret := 0.000000
		if( Upper_Band > 133.992 )
			if( Upper_Band <= 364.555 )
				if( bearPower <= -13.8698 )
					if( bbp <= -60.8579 )
						ret := -0.500000
					if( bbp > -60.8579 )
						ret := 0.744048 // buy
				if( bearPower > -13.8698 )
					if( Lower_Band <= 138.398 )
						ret := 0.127001
					if( Lower_Band > 138.398 )
						ret := -0.030271
			if( Upper_Band > 364.555 )
				if( Lower_Band <= 307.489 )
					if( basis <= 341.564 )
						ret := 0.944444 // buy
					if( basis > 341.564 )
						ret := 0.000000
				if( Lower_Band > 307.489 )
					if( Upper_Band <= 372.418 )
						ret := -0.577114
					if( Upper_Band > 372.418 )
						ret := -0.160784
...
float op_operation = decision_tree_0_SNOW_1Hour_64a21ca4(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
