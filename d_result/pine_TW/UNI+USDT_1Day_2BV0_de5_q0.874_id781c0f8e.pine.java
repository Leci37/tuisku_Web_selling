			...
			if( bullPower > -0.187856 )
				...
				if( bbp > -0.199628 )
					...
					if( bearPower > -0.170125 )
						ret := 0.000000
	if( VIP_VIM > 0.422804 )
		if( bullPower <= 5.44247 )
			if( bullPower <= 1.43362 )
				if( bullPower <= 0.504679 )
					ret := 0.833333 // buy
				if( bullPower > 0.504679 )
					ret := 0.000000
			if( bullPower > 1.43362 )
				if( bullPower <= 2.45286 )
					if( VIP_VIM <= 0.497582 )
						ret := 1.000000 // buy
					if( VIP_VIM > 0.497582 )
						ret := 0.727273 // buy
...
float op_operation = decision_tree_0_UNIUSDT_1Day_781c0f8e(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)
