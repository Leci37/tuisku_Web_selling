				...
				if( d_k <= 11.3273 )
					if( d_k <= 1.31901 )
						...
						if( VIP > 1.07791 )
							ret := -0.099744
					if( d_k > 1.31901 )
						if( smoothK_k <= 66.5932 )
							ret := 0.296163
						if( smoothK_k > 66.5932 )
							ret := -0.200000
				if( d_k > 11.3273 )
					if( smoothD_d <= 49.9574 )
						if( VIP <= 1.11013 )
							ret := -0.578125
						if( VIP > 1.11013 )
							ret := -0.205128
	...
	if( rsi1 > 64.249 )
		if( VIP_VIM <= 0.637655 )
			if( d <= 99.5846 )
				...
				if( smoothK_k > 66.543 )
					if( d_k <= 6.79421 )
						if( smoothD_d <= 55.8131 )
							ret := 0.257812
						if( smoothD_d > 55.8131 )
							ret := -0.191540
					if( d_k > 6.79421 )
						if( smoothK_k <= 74.6007 )
							ret := -0.235849
						if( smoothK_k > 74.6007 )
							ret := 0.474026
			if( d > 99.5846 )
				...
				if( rsi1 <= 74.3441 )
					...
					if( VIM > 0.667376 )
						...
						if( VIM > 0.815997 )
							ret := -0.625000
				if( rsi1 > 74.3441 )
					if( smoothD_d <= 96.9374 )
						if( smoothK_k <= 30.8752 )
							ret := 0.709677 // buy
						if( smoothK_k > 30.8752 )
							ret := 0.186924
					if( smoothD_d > 96.9374 )
						...
						if( VIP_VIM > 1.02888 )
							ret := -1.000000 // sell
			if( rsi1 > 89.9565 )
				if( smoothK_k <= 96.9824 )
					if( smoothD_d <= 95.3027 )
						if( d_k <= 0.434921 )
							ret := 0.294643
						if( d_k > 0.434921 )
							ret := -0.590361
...
float op_operation = decision_tree_0_NFLX_1Hour_2aa43dbe(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)
