...
decision_tree_0_SNOW_1Day_960f9f16(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)=>
	...
	if( VIP_VIM > 0.073625 )
		if( Positive_Money_Flow_Sum <= 8.20898e+09 )
			if( VIP <= 1.20934 )
				if( MFI_Low <= 38.8374 )
					if( Raw_Money_Flow <= 9.62793e+08 )
						ret := -0.157895
					if( Raw_Money_Flow > 9.62793e+08 )
						ret := 0.638889
				if( MFI_Low > 38.8374 )
					if( Positive_Money_Flow_Sum <= 3.84598e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 3.84598e+09 )
						ret := -0.573034
			if( VIP > 1.20934 )
				if( Negative_Money_Flow_Sum <= 3.73952e+09 )
					if( Negative_Money_Flow <= 5.39766e+07 )
						ret := 0.294118
					if( Negative_Money_Flow > 5.39766e+07 )
						ret := 0.948718 // buy
				if( Negative_Money_Flow_Sum > 3.73952e+09 )
			...
			if( VIM <= 0.748417 )
				if( MFI_Low <= 65.7645 )
					...
					if( MFI_High > -10.7887 )
						ret := -0.936508 // sell
				if( MFI_Low > 65.7645 )
					if( Typical_Price <= 378.492 )
						ret := 0.000000
					if( Typical_Price > 378.492 )
						ret := -1.000000 // sell
			if( VIM > 0.748417 )
				if( Money_Flow_Ratio <= 1.07403 )
					if( VIM <= 1.02679 )
						ret := -0.250000
					if( VIM > 1.02679 )
						ret := 1.000000 // buy
				if( Money_Flow_Ratio > 1.07403 )
					if( Typical_Price <= 150.25 )
						ret := 0.166667
					if( Typical_Price > 150.25 )
						ret := -0.506329
...
float op_operation = decision_tree_0_SNOW_1Day_960f9f16(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)
