			...
			if( midLine > 6.02665 )
				if( sDev <= 4.77007 )
					if( wvf <= 3.54213 )
						ret := 0.629167
					if( wvf > 3.54213 )
						if( Color_con2 <= -9.80742 )
							ret := -0.490000
						if( Color_con2 > -9.80742 )
							ret := 0.157411
				if( sDev > 4.77007 )
					if( upperBand <= 26.1951 )
						ret := 0.003810
					if( upperBand > 26.1951 )
						if( Color_con1 <= -22.5327 )
							ret := -0.024096
						if( Color_con1 > -22.5327 )
							ret := -0.857143 // sell
	if( wvf > 10.9399 )
		if( Color_con1 <= -0.544697 )
			if( Color_con2 <= -32.3652 )
				ret := 0.833333 // buy
			if( Color_con2 > -32.3652 )
				if( lowerBand <= 21.24 )
					if( midLine <= 23.0658 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Hour_7929fbce(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
