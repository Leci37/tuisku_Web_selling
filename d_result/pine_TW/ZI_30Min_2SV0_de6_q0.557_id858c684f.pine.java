	...
	if( rsi1 > 50.2657 )
		if( VIM <= 1.15555 )
			if( d <= 88.2605 )
				...
				if( rsi1 > 69.8447 )
					if( k <= 18.9367 )
						if( smoothK_k <= 4.59988 )
							ret := -0.090909
						if( smoothK_k > 4.59988 )
							ret := -0.786517 // sell
					if( k > 18.9367 )
						if( smoothD_d <= 83.6124 )
							ret := -0.130007
						if( smoothD_d > 83.6124 )
							ret := -0.458333
			if( d > 88.2605 )
				...
				if( rsi1 > 65.6753 )
					...
					if( k > 97.0146 )
						...
						if( rsi1 > 72.1276 )
							ret := -0.083793
		if( VIM > 1.15555 )
			if( smoothD_d <= 31.6754 )
				if( rsi1 <= 65.7531 )
					if( smoothD_d <= 29.4131 )
						if( VIP <= 1.11546 )
							ret := 0.330357
						if( VIP > 1.11546 )
							ret := -0.170787
...
float op_operation = decision_tree_0_ZI_30Min_858c684f(smoothK_k, d_k, k, smoothD_d, rsi1, d, VIP_VIM, VIP, VIM)
