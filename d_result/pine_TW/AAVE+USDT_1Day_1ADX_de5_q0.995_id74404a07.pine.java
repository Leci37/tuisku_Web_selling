			...
			if( smoothedDirectionalMovementMinus <= 6.43364 )
				...
				if( directionalMovementPlus > 2.9957 )
					...
					if( adx > 43.1042 )
						ret := 0.800000 // buy
			if( smoothedDirectionalMovementMinus > 6.43364 )
				if( smoothedDirectionalMovementPlus <= 0.942857 )
					if( smoothedDirectionalMovementMinus <= 7.25941 )
						ret := -1.000000 // sell
					if( smoothedDirectionalMovementMinus > 7.25941 )
						ret := 0.000000
				if( smoothedDirectionalMovementPlus > 0.942857 )
			...
			if( adx <= 45.2365 )
				if( diPlus <= 18.6374 )
					...
					if( adx > 32.2464 )
						ret := 0.193548
				if( diPlus > 18.6374 )
					if( smoothedDirectionalMovementMinus <= 13.3362 )
						ret := -0.700980 // sell
					if( smoothedDirectionalMovementMinus > 13.3362 )
						ret := 0.416667
			if( adx > 45.2365 )
				if( adx <= 57.2088 )
					...
					if( diMinus > 33.8416 )
						ret := -0.769231 // sell
				if( adx > 57.2088 )
					if( directionalMovementMinus <= 10.955 )
						ret := -0.838710 // sell
					if( directionalMovementMinus > 10.955 )
						ret := -0.333333
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_74404a07(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)
