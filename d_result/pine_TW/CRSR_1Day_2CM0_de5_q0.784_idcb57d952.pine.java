	...
	if( mf > 0.071347 )
		if( Negative_Money_Flow_Sum <= 7.16273e+07 )
			...
			if( Positive_Money_Flow_Sum > 1.32062e+08 )
				ret := -1.000000 // sell
		if( Negative_Money_Flow_Sum > 7.16273e+07 )
			if( Typical_Price <= 16.2563 )
				if( Raw_Money_Flow <= 1.06829e+07 )
					ret := -1.000000 // sell
				if( Raw_Money_Flow > 1.06829e+07 )
					if( Negative_Money_Flow <= 6.04421e+06 )
						ret := 0.000000
					if( Negative_Money_Flow > 6.04421e+06 )
						ret := -1.000000 // sell
			if( Typical_Price > 16.2563 )
				if( Positive_Money_Flow_Sum <= 9.43284e+08 )
					if( MFI_Low <= 61.6233 )
						ret := -0.411765
					if( MFI_Low > 61.6233 )
						ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 9.43284e+08 )
					if( Money_Flow_Ratio <= 0.925062 )
						ret := 0.000000
					if( Money_Flow_Ratio > 0.925062 )
						ret := -0.965517 // sell
...
float op_operation = decision_tree_0_CRSR_1Day_cb57d952(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
