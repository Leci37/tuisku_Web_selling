				...
				if( sDev > 7.37493 )
					...
					if( wvf > 2.28389 )
						...
						if( upperBand > 18.3634 )
							ret := -0.157895
		if( sDev > 9.23194 )
			if( Color_con2 <= -13.2458 )
				if( Color_con2 <= -16.7457 )
					if( sDev <= 16.3853 )
						ret := -0.677966
					if( sDev > 16.3853 )
						ret := -0.090909
				if( Color_con2 > -16.7457 )
					if( Color_con1 <= -9.50928 )
						ret := 0.794118 // buy
					if( Color_con1 > -9.50928 )
						ret := -0.962963 // sell
			if( Color_con2 > -13.2458 )
				if( upperBand <= 17.9015 )
					if( lowerBand <= -3.36342 )
						if( Color_con2 <= -8.73319 )
							ret := 0.333333
						if( Color_con2 > -8.73319 )
							ret := -0.579545
					if( lowerBand > -3.36342 )
						if( Color_con2 <= -0.704863 )
							ret := -0.339286
						if( Color_con2 > -0.704863 )
							ret := 0.891304 // buy
				if( upperBand > 17.9015 )
					if( Color_con2 <= 9.83019 )
						if( midLine <= 13.7794 )
							ret := -0.744770 // sell
						if( midLine > 13.7794 )
							ret := 0.466667
					if( Color_con2 > 9.83019 )
						if( upperBand <= 24.5684 )
							ret := 1.000000 // buy
						if( upperBand > 24.5684 )
							ret := -0.500000
	if( midLine > 15.5957 )
		if( Color_con1 <= -10.802 )
			ret := 0.690476
		if( Color_con1 > -10.802 )
			ret := 0.074074
...
float op_operation = decision_tree_0_RBLX_1Hour_97ebd576(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
