			...
			if( Negative_Money_Flow_Sum > 1.85551e+10 )
				...
				if( bullPower > -10.8408 )
					...
					if( Negative_Money_Flow_Sum > 3.03474e+10 )
						ret := 0.305556
	if( bearPower > 0.821861 )
		if( Negative_Money_Flow_Sum <= 1.81604e+10 )
			if( Positive_Money_Flow_Sum <= 4.14702e+10 )
				if( MFI_High <= 1.29303 )
					if( Negative_Money_Flow_Sum <= 1.71987e+10 )
						ret := 0.078898
					if( Negative_Money_Flow_Sum > 1.71987e+10 )
						ret := 0.829268 // buy
				if( MFI_High > 1.29303 )
					if( bearPower <= 16.9429 )
						ret := 0.226614
					if( bearPower > 16.9429 )
						ret := 0.617371
			if( Positive_Money_Flow_Sum > 4.14702e+10 )
				if( MFI_High <= 19.1353 )
					...
					if( BBPower_Color > 0.5 )
						ret := -0.945946 // sell
				if( MFI_High > 19.1353 )
					if( bearPower <= 6.76177 )
						ret := 1.000000 // buy
					if( bearPower > 6.76177 )
						ret := -0.363636
		if( Negative_Money_Flow_Sum > 1.81604e+10 )
			if( bbp <= 9.45978 )
				if( Typical_Price <= 618.162 )
					if( Negative_Money_Flow_Sum <= 1.9672e+10 )
						ret := -0.761905 // sell
					if( Negative_Money_Flow_Sum > 1.9672e+10 )
						ret := -0.161290
				if( Typical_Price > 618.162 )
			...
			if( bbp > 9.45978 )
				if( MFI_High <= -23.17 )
					if( Positive_Money_Flow <= 2.71042e+08 )
						ret := -0.684685
					if( Positive_Money_Flow > 2.71042e+08 )
						ret := 0.076923
				if( MFI_High > -23.17 )
...
float op_operation = decision_tree_0_TSLA_1Hour_615463ae(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
