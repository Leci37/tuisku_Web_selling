			...
			if( bullPower <= -0.33907 )
				...
				if( bbm > 1.18376 )
					...
					if( basis > 23.6128 )
						ret := 0.500000
			if( bullPower > -0.33907 )
				if( Lower_Band <= 21.7591 )
					if( bbp <= -0.856653 )
						ret := 0.421053
					if( bbp > -0.856653 )
						ret := -0.721311 // sell
				if( Lower_Band > 21.7591 )
					if( Lower_Band <= 29.7293 )
						ret := 0.258503
					if( Lower_Band > 29.7293 )
						ret := -0.633333
		if( bearPower > -0.29385 )
			if( basis <= 30.9158 )
				if( bbp <= 0.391604 )
					...
					if( bbp > 0.122832 )
						ret := -0.805556 // sell
				if( bbp > 0.391604 )
					if( Lower_Band <= 20.8295 )
						ret := -0.894737 // sell
					if( Lower_Band > 20.8295 )
						ret := -0.111801
			if( basis > 30.9158 )
				if( bbm <= 1.15 )
					if( bullPower <= 0.927235 )
						ret := -0.833333 // sell
					if( bullPower > 0.927235 )
						ret := 0.000000
				if( bbm > 1.15 )
...
float op_operation = decision_tree_0_DBX_1Day_e1d20724(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
