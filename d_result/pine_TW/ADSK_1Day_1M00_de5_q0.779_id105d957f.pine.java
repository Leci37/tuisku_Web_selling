		...
		if( Money_Flow_Ratio <= 2.43168 )
			if( Typical_Price <= 201.536 )
				if( Negative_Money_Flow <= 4.74107e+08 )
					if( Typical_Price <= 133.327 )
						ret := 0.363636
					if( Typical_Price > 133.327 )
						ret := -0.063333
				if( Negative_Money_Flow > 4.74107e+08 )
					if( Typical_Price <= 133.804 )
						ret := -0.230769
					if( Typical_Price > 133.804 )
						ret := 0.547619
			if( Typical_Price > 201.536 )
				if( MFI_High <= -37.7388 )
					if( Negative_Money_Flow <= 3.83286e+08 )
						ret := 0.085106
					if( Negative_Money_Flow > 3.83286e+08 )
						ret := -0.255556
				if( MFI_High > -37.7388 )
					...
					if( MFI_High > -28.4208 )
						ret := -0.212418
		if( Money_Flow_Ratio > 2.43168 )
			if( Negative_Money_Flow <= 3.67433e+08 )
				if( Negative_Money_Flow_Sum <= 1.52665e+09 )
					if( Negative_Money_Flow_Sum <= 1.48991e+09 )
						ret := 0.010000
					if( Negative_Money_Flow_Sum > 1.48991e+09 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 1.52665e+09 )
					if( Positive_Money_Flow_Sum <= 5.19584e+09 )
						ret := 0.950000 // buy
					if( Positive_Money_Flow_Sum > 5.19584e+09 )
						ret := 0.000000
			if( Negative_Money_Flow > 3.67433e+08 )
...
float op_operation = decision_tree_0_ADSK_1Day_105d957f(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
