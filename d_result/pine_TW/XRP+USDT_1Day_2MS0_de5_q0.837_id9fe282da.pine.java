			...
			if( Typical_Price > 0.5982 )
				...
				if( Money_Flow_Ratio > 4.29273 )
					...
					if( Money_Flow_Ratio > 7.74311 )
						ret := -0.625000
	if( Negative_Money_Flow_Sum > 2.82525e+09 )
		if( Typical_Price <= 0.251185 )
			if( smoothD_d <= 25.2513 )
				if( k <= 3.02887 )
					ret := 0.000000
				if( k > 3.02887 )
					ret := 1.000000 // buy
			if( smoothD_d > 25.2513 )
				ret := 0.000000
		if( Typical_Price > 0.251185 )
			if( Negative_Money_Flow_Sum <= 1.50764e+10 )
				if( Negative_Money_Flow <= 5.66319e+08 )
					if( smoothD_d <= -1.37805 )
						ret := 0.750000 // buy
					if( smoothD_d > -1.37805 )
						ret := -0.631098
				if( Negative_Money_Flow > 5.66319e+08 )
					if( Typical_Price <= 1.44001 )
						ret := 0.160714
					if( Typical_Price > 1.44001 )
						ret := -0.952381 // sell
			if( Negative_Money_Flow_Sum > 1.50764e+10 )
				if( smoothD_d <= 6.05571 )
					ret := 1.000000 // buy
				if( smoothD_d > 6.05571 )
					if( Typical_Price <= 1.01548 )
						ret := 0.818182 // buy
					if( Typical_Price > 1.01548 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_XRPUSDT_1Day_9fe282da(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, smoothK_k, d_k, k, smoothD_d, rsi1, d)
