			...
			if( tema > 12.0847 )
				...
				if( ema13 > 0.443944 )
					...
					if( rsi1 > 73.5893 )
						ret := -0.344828
	if( ema3 > 14.4914 )
		if( smoothK_k <= -0.532499 )
			if( ema3 <= 62.6102 )
				if( d <= 0.606792 )
					if( smoothD_d <= -2.42395 )
						ret := -0.551724
					if( smoothD_d > -2.42395 )
						ret := 1.000000 // buy
				if( d > 0.606792 )
...
float op_operation = decision_tree_0_SNAP_1Day_3cd57bb5(d_k, d, rsi1, k, smoothD_d, smoothK_k, ema1, tema, ema12, ema2, ema3, ema13)
