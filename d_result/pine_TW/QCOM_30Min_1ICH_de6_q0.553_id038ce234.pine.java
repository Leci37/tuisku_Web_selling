				...
				if( basis_max <= -0.809321 )
					...
					if( tenkan_sen > 175.395 )
						...
						if( chinkou_span > 183.99 )
							ret := 0.562500
				if( basis_max > -0.809321 )
					if( senkou_span_b <= 178.312 )
						if( basis_minus <= -1.98392 )
							ret := 0.939024 // buy
						if( basis_minus > -1.98392 )
							ret := 0.659889
					if( senkou_span_b > 178.312 )
						...
						if( basis_max > 1.185 )
							ret := -0.904762 // sell
		if( senkou_span_b > 180.242 )
			if( chinkou_span <= 183.062 )
				if( kinjun_sen <= 178.52 )
					if( senkou_span_a_displaced <= 183.048 )
						if( senkou_span_b <= 182.736 )
							ret := -0.333333
						if( senkou_span_b > 182.736 )
							ret := -0.923077 // sell
					if( senkou_span_a_displaced > 183.048 )
						if( basis_minus <= -5.12945 )
							ret := 0.000000
						if( basis_minus > -5.12945 )
							ret := 1.000000 // buy
				if( kinjun_sen > 178.52 )
					if( basis_minus <= -4.42475 )
						if( senkou_span_a_displaced <= 183.468 )
							ret := 0.684211
						if( senkou_span_a_displaced > 183.468 )
							ret := -0.285714
					if( basis_minus > -4.42475 )
						if( basis_max <= 1.69908 )
							ret := -0.492571
						if( basis_max > 1.69908 )
							ret := -0.893617 // sell
			if( chinkou_span > 183.062 )
				if( senkou_span_a <= 185.349 )
					if( senkou_span_a_displaced <= 182.84 )
						if( chinkou_span <= 183.878 )
							ret := -0.550000
						if( chinkou_span > 183.878 )
							ret := 0.308140
					if( senkou_span_a_displaced > 182.84 )
						if( senkou_span_b <= 184.142 )
							ret := 1.000000 // buy
						if( senkou_span_b > 184.142 )
							ret := 0.551136
				if( senkou_span_a > 185.349 )
					if( chinkou_span <= 193.289 )
						if( senkou_span_a <= 193.718 )
							ret := -0.170426
						if( senkou_span_a > 193.718 )
							ret := -0.778481 // sell
					if( chinkou_span > 193.289 )
						if( senkou_span_b <= 198.336 )
							ret := 0.584362
						if( senkou_span_b > 198.336 )
							ret := -0.046717
...
float op_operation = decision_tree_0_QCOM_30Min_038ce234(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
