			...
			if( bbp > -946.66 )
				...
				if( bbp > 2161.28 )
					...
					if( bbp > 5259.84 )
						ret := 1.000000 // buy
	if( bearPower > -79.7583 )
		if( bullPower <= 7019.69 )
			if( bullPower <= 854.457 )
				if( bbm <= 343.822 )
					if( bbm <= 215.547 )
						ret := 0.052239
					if( bbm > 215.547 )
...
float op_operation = decision_tree_0_BTCUSDT_1Day_b4e87bfc(bullPower, bbp, bearPower, bbm, BBPower_Color)
