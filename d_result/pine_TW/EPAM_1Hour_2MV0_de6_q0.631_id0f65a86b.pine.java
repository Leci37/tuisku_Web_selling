...
decision_tree_0_EPAM_1Hour_0f65a86b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
		...
		if( VIP > 1.04097 )
			if( VIM <= 0.956032 )
				if( Typical_Price <= 130.403 )
					if( Negative_Money_Flow_Sum <= 2.75084e+07 )
						if( VIM <= 0.757237 )
							ret := 0.000000
						if( VIM > 0.757237 )
							ret := 0.771186 // buy
					if( Negative_Money_Flow_Sum > 2.75084e+07 )
						if( Positive_Money_Flow <= 5.06337e+06 )
							ret := 0.280000
						if( Positive_Money_Flow > 5.06337e+06 )
							ret := -0.625000
				if( Typical_Price > 130.403 )
					if( Positive_Money_Flow_Sum <= 1.4097e+08 )
						if( VIP <= 1.23195 )
							ret := 0.009421
						if( VIP > 1.23195 )
							ret := -0.210055
			...
			if( VIM > 0.956032 )
				if( VIP_VIM <= 0.313283 )
					if( Negative_Money_Flow <= 1.77029e+07 )
						if( Typical_Price <= 114.001 )
							ret := 0.933333 // buy
						if( Typical_Price > 114.001 )
							ret := 0.083356
					if( Negative_Money_Flow > 1.77029e+07 )
						if( Negative_Money_Flow_Sum <= 1.71856e+08 )
							ret := 0.490291
						if( Negative_Money_Flow_Sum > 1.71856e+08 )
							ret := 0.013245
				if( VIP_VIM > 0.313283 )
					if( Positive_Money_Flow <= 8.93663e+06 )
						if( Positive_Money_Flow_Sum <= 1.59209e+08 )
							ret := 0.107438
						if( Positive_Money_Flow_Sum > 1.59209e+08 )
							ret := 0.760000 // buy
					if( Positive_Money_Flow > 8.93663e+06 )
	...
	if( Positive_Money_Flow_Sum > 1.86083e+08 )
		if( VIM <= 1.40996 )
			if( MFI_Low <= 8.76354 )
				if( Positive_Money_Flow <= 7.23216e+06 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow > 7.23216e+06 )
					ret := 0.454545
			if( MFI_Low > 8.76354 )
				if( Typical_Price <= 284.257 )
					if( VIP <= 0.946583 )
						if( Negative_Money_Flow_Sum <= 1.47893e+08 )
							ret := -0.818182 // sell
						if( Negative_Money_Flow_Sum > 1.47893e+08 )
							ret := -0.272727
					if( VIP > 0.946583 )
				...
				if( Typical_Price > 284.257 )
					if( VIP <= 1.17621 )
						if( Positive_Money_Flow <= 3.21673e+07 )
							ret := -0.290210
						if( Positive_Money_Flow > 3.21673e+07 )
							ret := -0.646643
					if( VIP > 1.17621 )
		...
		if( VIM > 1.40996 )
			if( VIP <= 0.648014 )
				if( Negative_Money_Flow <= 500821 )
					ret := -1.000000 // sell
				if( Negative_Money_Flow > 500821 )
					if( Typical_Price <= 262.033 )
						ret := 1.000000 // buy
					if( Typical_Price > 262.033 )
						ret := 0.300000
			if( VIP > 0.648014 )
				if( Money_Flow_Ratio <= 0.74846 )
					if( VIM <= 1.44065 )
						ret := 0.615385
					if( VIM > 1.44065 )
						if( Money_Flow_Ratio <= 0.623693 )
							ret := 1.000000 // buy
						if( Money_Flow_Ratio > 0.623693 )
							ret := 0.875000 // buy
				if( Money_Flow_Ratio > 0.74846 )
...
float op_operation = decision_tree_0_EPAM_1Hour_0f65a86b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
