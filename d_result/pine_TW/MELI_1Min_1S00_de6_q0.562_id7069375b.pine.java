...
decision_tree_0_MELI_1Min_7069375b(d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( smoothK_k > -2.63038 )
		if( smoothK_k <= 94.948 )
			...
			if( k > 1.77303 )
				if( d <= 1.37838 )
					if( smoothD_d <= -2.15381 )
						ret := -0.153846
					if( smoothD_d > -2.15381 )
						ret := 0.679012
				if( d > 1.37838 )
					if( smoothK_k <= 93.7013 )
						if( d_k <= 11.6979 )
							ret := -0.017996
						if( d_k > 11.6979 )
							ret := 0.082463
					if( smoothK_k > 93.7013 )
						...
						if( d > 86.1516 )
							ret := 0.266898
		if( smoothK_k > 94.948 )
			if( smoothK_k <= 96.1078 )
				ret := -0.369128
			if( smoothK_k > 96.1078 )
				if( smoothK_k <= 96.9436 )
					if( d <= 89.6008 )
						ret := -0.246377
					if( d > 89.6008 )
						if( d_k <= -2.80603 )
...
float op_operation = decision_tree_0_MELI_1Min_7069375b(d, d_k, smoothK_k, k, rsi1, smoothD_d)
