...
decision_tree_0_SHOP_1Day_af2de468(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)=>
	...
	if( Raw_Money_Flow > 7.75773e+08 )
		if( Positive_Money_Flow_Sum <= 2.40223e+10 )
			...
			if( Typical_Price > 31.3633 )
				if( MFI_High <= -61.1254 )
					if( Typical_Price <= 477.414 )
						ret := 0.000000
					if( Typical_Price > 477.414 )
						ret := -0.961538 // sell
				if( MFI_High > -61.1254 )
					if( Typical_Price <= 893.962 )
						ret := -0.231522
					if( Typical_Price > 893.962 )
						ret := -0.001883
		if( Positive_Money_Flow_Sum > 2.40223e+10 )
			if( Negative_Money_Flow <= 1.02338e+08 )
				if( Positive_Money_Flow <= 3.45951e+09 )
					if( Positive_Money_Flow_Sum <= 2.50937e+10 )
						ret := 0.600000
					if( Positive_Money_Flow_Sum > 2.50937e+10 )
						ret := 0.000000
				if( Positive_Money_Flow > 3.45951e+09 )
					ret := 0.714286 // buy
			if( Negative_Money_Flow > 1.02338e+08 )
				if( Negative_Money_Flow_Sum <= 1.06287e+10 )
					ret := 0.500000
				if( Negative_Money_Flow_Sum > 1.06287e+10 )
					if( Negative_Money_Flow_Sum <= 1.30729e+10 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow_Sum > 1.30729e+10 )
						ret := 0.800000 // buy
...
float op_operation = decision_tree_0_SHOP_1Day_af2de468(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
