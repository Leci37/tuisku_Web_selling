...
decision_tree_0_PTON_1Day_cb735e5f(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Negative_Money_Flow > 2.5117e+07 )
		if( mf <= -0.14467 )
			if( Negative_Money_Flow <= 6.62407e+07 )
				if( Positive_Money_Flow_Sum <= 3.05451e+08 )
					if( Typical_Price <= 3.37998 )
						ret := 0.250000
					if( Typical_Price > 3.37998 )
						ret := -0.863636 // sell
				if( Positive_Money_Flow_Sum > 3.05451e+08 )
			...
			if( Negative_Money_Flow > 6.62407e+07 )
				...
				if( Raw_Money_Flow > 5.85705e+08 )
					...
					if( ad > -2.33153e+07 )
						ret := 0.000000
		if( mf > -0.14467 )
			if( Typical_Price <= 38.6084 )
				if( Typical_Price <= 9.00684 )
					if( Negative_Money_Flow_Sum <= 6.98037e+08 )
						ret := -0.240964
					if( Negative_Money_Flow_Sum > 6.98037e+08 )
						ret := 0.526316
				if( Typical_Price > 9.00684 )
					if( Typical_Price <= 22.6935 )
						ret := -0.646288
					if( Typical_Price > 22.6935 )
						ret := -0.269231
			if( Typical_Price > 38.6084 )
				if( mf <= 0.018063 )
					if( Raw_Money_Flow <= 4.11713e+08 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 4.11713e+08 )
						ret := -0.344828
				if( mf > 0.018063 )
...
float op_operation = decision_tree_0_PTON_1Day_cb735e5f(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
