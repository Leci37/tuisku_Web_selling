			...
			if( verde <= -18.553 )
				...
				if( nvimin > -0.897336 )
					...
					if( azul > -34.0238 )
						ret := -0.230769
			if( verde > -18.553 )
				if( verde_media <= -29.2618 )
					if( pvi_ema <= 4.58185 )
						ret := -0.767196 // sell
					if( pvi_ema > 4.58185 )
						ret := 0.600000
				if( verde_media > -29.2618 )
					if( verde_media <= -10.0107 )
						ret := 0.230337
					if( verde_media > -10.0107 )
						ret := -0.411032
...
float op_operation = decision_tree_0_RUN_1Day_bc5e18ff(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
