		...
		if( bullPower > 12.8883 )
			...
			if( Lower_Band > 140.078 )
				...
				if( bbp > 66.4115 )
					ret := -1.000000 // sell
	if( Upper_Band > 391.992 )
		if( Lower_Band <= 373.643 )
			if( Lower_Band <= 359.929 )
				if( bbm <= 25.7798 )
					if( bbp <= -44.6867 )
						ret := -0.692308
					if( bbp > -44.6867 )
		...
		if( Lower_Band > 373.643 )
			if( basis <= 391.051 )
				if( bearPower <= -8.59029 )
					ret := -0.500000
				if( bearPower > -8.59029 )
					ret := 0.877049 // buy
			if( basis > 391.051 )
				if( bbp <= -19.1351 )
					if( Lower_Band <= 449.361 )
						if( Upper_Band <= 540.333 )
							ret := 0.145570
						if( Upper_Band > 540.333 )
							ret := -1.000000 // sell
					if( Lower_Band > 449.361 )
...
float op_operation = decision_tree_0_AAVEUSDT_1Hour_13e06612(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
