				...
				if( basis_max > -0.430892 )
					if( senkou_span_b_displaced <= 101.299 )
						...
						if( chinkou_span > 97.4779 )
							ret := -0.376471
					if( senkou_span_b_displaced > 101.299 )
						if( tenkan_sen <= 94.7555 )
							ret := 0.777778 // buy
						if( tenkan_sen > 94.7555 )
							ret := -0.435644
		if( chinkou_span > 98.174 )
			if( kinjun_sen <= 98.3228 )
				if( basis_minus <= -1.85896 )
					ret := -1.000000 // sell
				if( basis_minus > -1.85896 )
					if( senkou_span_a_displaced <= 91.624 )
						if( basis_minus <= 1.71204 )
							ret := -0.666667
						if( basis_minus > 1.71204 )
							ret := 0.142857
					if( senkou_span_a_displaced > 91.624 )
						...
						if( basis_max > 0.4535 )
							ret := -0.222222
			if( kinjun_sen > 98.3228 )
				if( basis_minus <= -0.98737 )
					if( basis_max <= 36.3725 )
						if( basis_max <= 19.3838 )
							ret := 0.101318
						if( basis_max > 19.3838 )
							ret := -0.232848
					if( basis_max > 36.3725 )
						ret := 0.947368 // buy
				if( basis_minus > -0.98737 )
					if( kinjun_sen <= 2824.6 )
						if( chinkou_span <= 2769.24 )
							ret := -0.034969
						if( chinkou_span > 2769.24 )
							ret := 0.629969
					if( kinjun_sen > 2824.6 )
						if( chinkou_span <= 2885.76 )
							ret := -0.692982
						if( chinkou_span > 2885.76 )
							ret := -0.081871
...
float op_operation = decision_tree_0_GOOG_1Hour_5f14fba9(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
