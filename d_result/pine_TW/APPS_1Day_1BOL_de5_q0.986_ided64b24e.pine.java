...
decision_tree_0_APPS_1Day_ed64b24e(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)=>
	...
	if( dif_source_BBupper > -5.86768 )
			...
			if( BBupper <= 1.39621 )
				...
				if( BBlower > 0.667985 )
					...
					if( vrsi > 53.4249 )
						ret := 0.000000
			if( BBupper > 1.39621 )
				if( dif_source_BBlower <= 0.691777 )
					if( BBlower <= 1.09432 )
						ret := 0.660633
					if( BBlower > 1.09432 )
						ret := 0.266055
		...
		if( dif_source_BBlower > 73.3167 )
			if( vrsi <= 54.0563 )
				if( dif_source_BBupper <= -1.6765 )
					ret := 1.000000 // buy
				if( dif_source_BBupper > -1.6765 )
					ret := 0.000000
			if( vrsi > 54.0563 )
				if( dif_source_BBlower <= 99.4555 )
					if( BBlower <= -7.98148 )
						ret := -0.333333
					if( BBlower > -7.98148 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_APPS_1Day_ed64b24e(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
