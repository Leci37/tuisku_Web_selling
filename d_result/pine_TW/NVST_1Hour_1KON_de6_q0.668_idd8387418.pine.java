			...
			if( xrsi > 77.4231 )
				...
				if( pvim > -0.283895 )
					...
					if( azul_mean > 59.3166 )
						ret := 0.545455
		if( nvimin > 0.597423 )
			if( media_azul <= 55.3705 )
				if( xmf <= 61.3325 )
					if( verde_azul <= 47.8062 )
						ret := -1.000000 // sell
					if( verde_azul > 47.8062 )
						if( media_azul <= 50.2905 )
							ret := 0.058824
						if( media_azul > 50.2905 )
							ret := 0.800000 // buy
				if( xmf > 61.3325 )
...
float op_operation = decision_tree_0_NVST_1Hour_d8387418(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
