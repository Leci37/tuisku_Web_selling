		...
		if( d_k <= -0.547952 )
			...
			if( k > 99.1146 )
				...
				if( rsi1 > 88.8903 )
					ret := 0.714286 // buy
		if( d_k > -0.547952 )
			if( smoothD_d <= 59.9089 )
				if( k <= 46.0624 )
					if( smoothD_d <= 42.2578 )
						ret := -0.625000
					if( smoothD_d > 42.2578 )
						ret := -1.000000 // sell
				if( k > 46.0624 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_7f21dcfc(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)
