				...
				if( Negative_Money_Flow_Sum > 1.56391e+08 )
					...
					if( Negative_Money_Flow_Sum > 1.95055e+08 )
						...
						if( MFI_Low > 22.0812 )
							ret := 0.544828
			if( Typical_Price > 200.636 )
				if( Negative_Money_Flow_Sum <= 1.30492e+08 )
					if( ema12 <= 0.636432 )
						if( Negative_Money_Flow_Sum <= 1.04929e+08 )
							ret := -0.253067
						if( Negative_Money_Flow_Sum > 1.04929e+08 )
							ret := 0.139423
					if( ema12 > 0.636432 )
						if( Positive_Money_Flow_Sum <= 1.68743e+08 )
							ret := 0.062678
						if( Positive_Money_Flow_Sum > 1.68743e+08 )
							ret := 0.568493
				if( Negative_Money_Flow_Sum > 1.30492e+08 )
					...
					if( ema3 > 205.602 )
						...
						if( ema12 > -0.173576 )
							ret := -0.436709
	if( ema12 > 2.54991 )
		if( Raw_Money_Flow <= 2.41448e+07 )
			ret := -0.787500 // sell
		if( Raw_Money_Flow > 2.41448e+07 )
			if( Positive_Money_Flow_Sum <= 2.24203e+08 )
				if( Money_Flow_Ratio <= 2.03153 )
					ret := 0.000000
				if( Money_Flow_Ratio > 2.03153 )
					ret := 0.769231 // buy
			if( Positive_Money_Flow_Sum > 2.24203e+08 )
...
float op_operation = decision_tree_0_FFIV_1Hour_9ec2cfa6(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
