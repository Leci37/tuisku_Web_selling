			...
			if( senkou_span_a > 54.6527 )
				...
				if( basis_minus > 5.09321 )
					...
					if( chinkou_span > 55.875 )
						ret := -0.600000
		if( chinkou_span > 58.87 )
			if( senkou_span_a <= 73.9454 )
				if( basis_minus <= 1.11553 )
					if( basis_max <= -1.30812 )
						ret := 0.166667
					if( basis_max > -1.30812 )
						ret := 0.693122
				if( basis_minus > 1.11553 )
					if( senkou_span_a_displaced <= 46.0087 )
						ret := -0.473684
					if( senkou_span_a_displaced > 46.0087 )
						ret := 0.330769
			if( senkou_span_a > 73.9454 )
				if( chinkou_span <= 78.7877 )
					if( basis_max <= 3.2173 )
						ret := -0.538117
					if( basis_max > 3.2173 )
						ret := 0.242424
				if( chinkou_span > 78.7877 )
					if( senkou_span_b_displaced <= 653.396 )
						ret := 0.069684
					if( senkou_span_b_displaced > 653.396 )
						ret := -0.315789
...
float op_operation = decision_tree_0_TTD_1Day_3dbfbd4f(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
