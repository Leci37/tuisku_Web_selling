...
decision_tree_0_GME_1Day_59c33722(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( Lower_Band > 12.1858 )
		...
		if( Upper_Band > 233.007 )
			if( basis <= 230.284 )
				if( basis <= 198.457 )
					if( Upper_Band <= 265.566 )
						ret := -0.642857
					if( Upper_Band > 265.566 )
						ret := 0.000000
				if( basis > 198.457 )
					if( Lower_Band <= 163.756 )
						ret := -1.000000 // sell
					if( Lower_Band > 163.756 )
						ret := -0.777778 // sell
			if( basis > 230.284 )
...
float op_operation = decision_tree_0_GME_1Day_59c33722(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
