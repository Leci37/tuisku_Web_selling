			...
			if( Negative_Money_Flow_Sum <= 2.39113e+08 )
				...
				if( MFI_High > -76.7222 )
					...
					if( mf > -0.016059 )
						ret := -0.837607 // sell
			if( Negative_Money_Flow_Sum > 2.39113e+08 )
				if( Positive_Money_Flow_Sum <= 6.13726e+06 )
					if( mf <= -0.546316 )
						ret := -1.000000 // sell
					if( mf > -0.546316 )
						ret := 0.673469
				if( Positive_Money_Flow_Sum > 6.13726e+06 )
					if( Positive_Money_Flow_Sum <= 3.34965e+07 )
						ret := -0.780822 // sell
					if( Positive_Money_Flow_Sum > 3.34965e+07 )
						ret := -0.158405
		if( Raw_Money_Flow > 606771 )
			if( Negative_Money_Flow_Sum <= 3.14215e+09 )
				if( ad_mf <= -2.08059e+06 )
					if( Negative_Money_Flow <= 1.1141e+08 )
						ret := -0.641509
					if( Negative_Money_Flow > 1.1141e+08 )
						ret := 0.127660
				if( ad_mf > -2.08059e+06 )
					if( Positive_Money_Flow_Sum <= 2.45196e+09 )
						ret := -0.031857
					if( Positive_Money_Flow_Sum > 2.45196e+09 )
						ret := -0.589041
			if( Negative_Money_Flow_Sum > 3.14215e+09 )
...
float op_operation = decision_tree_0_AFRM_1Hour_839a0673(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
