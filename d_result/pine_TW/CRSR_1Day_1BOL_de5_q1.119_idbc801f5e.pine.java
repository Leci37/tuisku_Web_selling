...
decision_tree_0_CRSR_1Day_bc801f5e(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)=>
	...
	if( dif_source_BBupper > -15.2947 )
		...
		if( dif_source_BBlower > -1.43429 )
			if( BBlower <= 15.9915 )
				if( dif_source_BBupper <= -6.73914 )
					if( dif_source_BBlower <= 3.27546 )
						ret := 0.325000
					if( dif_source_BBlower > 3.27546 )
						ret := -0.297872
				if( dif_source_BBupper > -6.73914 )
...
float op_operation = decision_tree_0_CRSR_1Day_bc801f5e(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
