		...
		if( kinjun_sen <= 162.9 )
			if( senkou_span_b_displaced <= 140.959 )
				...
				if( chinkou_span > 174.625 )
					ret := 0.250000
			if( senkou_span_b_displaced > 140.959 )
				if( tenkan_sen <= 149.897 )
					if( kinjun_sen <= 145.424 )
						ret := 0.250000
					if( kinjun_sen > 145.424 )
						ret := 0.000000
				if( tenkan_sen > 149.897 )
					if( basis_max <= 1.06638 )
						ret := 0.870370 // buy
					if( basis_max > 1.06638 )
						ret := 0.411765
		if( kinjun_sen > 162.9 )
			if( senkou_span_a_displaced <= 307.061 )
				if( chinkou_span <= 221.497 )
					if( kinjun_sen <= 195.943 )
						ret := 0.148897
					if( kinjun_sen > 195.943 )
						ret := -0.490826
				if( chinkou_span > 221.497 )
					if( senkou_span_a_displaced <= 285.11 )
						ret := 0.586538
					if( senkou_span_a_displaced > 285.11 )
						ret := -0.097222
			if( senkou_span_a_displaced > 307.061 )
				if( senkou_span_a <= 271.444 )
					if( senkou_span_a_displaced <= 314.29 )
						ret := 0.909091 // buy
					if( senkou_span_a_displaced > 314.29 )
						ret := -0.666667
				if( senkou_span_a > 271.444 )
					if( basis_max <= -7.85101 )
						ret := -0.166667
					if( basis_max > -7.85101 )
						ret := -0.912281 // sell
...
float op_operation = decision_tree_0_AAPL_1Day_06ecf80e(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
