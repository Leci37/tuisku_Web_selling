				...
				if( rsi1 > 87.3239 )
					if( d <= 89.8167 )
						...
						if( d_k > -0.694489 )
							ret := -0.708333 // sell
					if( d > 89.8167 )
						if( bearPower <= 0.086374 )
							ret := 0.646154
						if( bearPower > 0.086374 )
							ret := -0.142857
			if( bullPower > 0.22976 )
				if( d <= 76.8753 )
					if( smoothD_d <= 30.1102 )
						if( bearPower <= -0.189209 )
							ret := -0.636364
						if( bearPower > -0.189209 )
							ret := -1.000000 // sell
					if( smoothD_d > 30.1102 )
...
float op_operation = decision_tree_0_DBX_5Min_4f1bfb97(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
