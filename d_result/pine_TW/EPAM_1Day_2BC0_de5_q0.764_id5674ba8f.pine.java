			...
			if( bearPower > -8.46972 )
				if( bearPower <= -1.12759 )
					...
					if( bullPower > 2.41055 )
						ret := -0.960000 // sell
				if( bearPower > -1.12759 )
					if( bullPower <= 3.45718 )
						ret := -0.045455
					if( bullPower > 3.45718 )
						ret := -0.500000
		if( mf > 0.119449 )
			if( bearPower <= 31.0686 )
				if( bearPower <= -14.5981 )
					if( bbp <= -32.2476 )
						ret := -0.400000
					if( bbp > -32.2476 )
						ret := -0.850000 // sell
				if( bearPower > -14.5981 )
					if( bullPower <= 1.07839 )
						ret := 0.167939
					if( bullPower > 1.07839 )
						ret := -0.114286
			if( bearPower > 31.0686 )
...
float op_operation = decision_tree_0_EPAM_1Day_5674ba8f(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
