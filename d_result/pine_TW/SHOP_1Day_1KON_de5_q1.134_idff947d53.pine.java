...
decision_tree_0_SHOP_1Day_ff947d53(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)=>
	...
	if( pvim > 3.4536 )
		...
		if( source > 49.5615 )
			if( nvimin <= -0.46788 )
				if( azul <= -4.40477 )
					if( verde_azul <= 68.4063 )
						ret := 0.707317 // buy
					if( verde_azul > 68.4063 )
						ret := 0.142857
				if( azul > -4.40477 )
					if( media_azul <= 81.7227 )
						ret := 0.000000
					if( media_azul > 81.7227 )
						ret := -0.615385
			if( nvimin > -0.46788 )
				if( nvimax <= 1.19449 )
					if( azul_mean <= -8.84252 )
						ret := -0.303483
					if( azul_mean > -8.84252 )
						ret := -0.769231 // sell
				if( nvimax > 1.19449 )
...
float op_operation = decision_tree_0_SHOP_1Day_ff947d53(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
