			...
			if( Negative_Money_Flow_Sum <= 2.74674e+09 )
				if( bbp <= 0.142225 )
					...
					if( MFI_Low > 42.4453 )
						ret := 0.627907
				if( bbp > 0.142225 )
					if( Positive_Money_Flow_Sum <= 2.50183e+09 )
						ret := 0.228571
					if( Positive_Money_Flow_Sum > 2.50183e+09 )
						ret := -0.358491
			if( Negative_Money_Flow_Sum > 2.74674e+09 )
				...
				if( MFI > 44.362 )
					ret := -0.827778 // sell
		if( Positive_Money_Flow_Sum > 3.41241e+09 )
			if( Negative_Money_Flow_Sum <= 1.38171e+09 )
				if( bbp <= 18.5976 )
					if( Negative_Money_Flow <= 1.98751e+08 )
						ret := -0.759259 // sell
					if( Negative_Money_Flow > 1.98751e+08 )
						ret := 0.000000
				if( bbp > 18.5976 )
			...
			if( Negative_Money_Flow_Sum > 1.38171e+09 )
				if( Money_Flow_Ratio <= 2.43168 )
					if( bullPower <= -0.146417 )
						ret := 0.774194 // buy
					if( bullPower > -0.146417 )
						ret := -0.039801
				if( Money_Flow_Ratio > 2.43168 )
					if( bearPower <= 2.48965 )
						ret := 0.860000 // buy
					if( bearPower > 2.48965 )
						ret := 0.229167
...
float op_operation = decision_tree_0_ADSK_1Day_c1d308e7(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
