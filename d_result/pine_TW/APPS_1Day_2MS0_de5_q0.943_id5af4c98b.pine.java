			...
			if( Raw_Money_Flow > 796251 )
				...
				if( d > 94.11 )
					...
					if( Negative_Money_Flow_Sum > 1.19437e+07 )
						ret := -0.931034 // sell
	if( Negative_Money_Flow_Sum > 4.37621e+07 )
		if( Typical_Price <= 3.90083 )
			if( Negative_Money_Flow_Sum <= 1.04565e+08 )
				if( rsi1 <= 16.3015 )
					if( Negative_Money_Flow <= 3.77505e+06 )
						ret := -0.100000
					if( Negative_Money_Flow > 3.77505e+06 )
						ret := -1.000000 // sell
				if( rsi1 > 16.3015 )
					if( smoothK_k <= 12.3217 )
						ret := -0.800000 // sell
					if( smoothK_k > 12.3217 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 1.04565e+08 )
				...
				if( MFI_Low > 4.4378 )
					ret := 0.625000
		if( Typical_Price > 3.90083 )
			if( Negative_Money_Flow <= 5.42014e+07 )
				if( Negative_Money_Flow_Sum <= 8.18657e+08 )
					if( Typical_Price <= 16.6295 )
						ret := 0.037736
					if( Typical_Price > 16.6295 )
						ret := -0.364662
				if( Negative_Money_Flow_Sum > 8.18657e+08 )
					if( Raw_Money_Flow <= 1.64269e+08 )
						ret := 0.728070 // buy
					if( Raw_Money_Flow > 1.64269e+08 )
						ret := 0.000000
			if( Negative_Money_Flow > 5.42014e+07 )
				if( k <= 42.4868 )
					...
					if( MFI_High > -58.7699 )
						ret := -0.625483
				if( k > 42.4868 )
					if( Positive_Money_Flow_Sum <= 7.52254e+08 )
						ret := -0.400000
					if( Positive_Money_Flow_Sum > 7.52254e+08 )
						ret := 0.291667
...
float op_operation = decision_tree_0_APPS_1Day_5af4c98b(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
