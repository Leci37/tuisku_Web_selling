				...
				if( lower_5 <= 5.74568 )
					...
					if( upper_6 > 6.07918 )
						...
						if( upper_1 > 6.03686 )
							ret := 0.610169
				if( lower_5 > 5.74568 )
					if( basis_max <= -0.220817 )
						if( basis_max <= -0.280299 )
							ret := -0.112903
						if( basis_max > -0.280299 )
							ret := -0.733010 // sell
					if( basis_max > -0.220817 )
				...
				if( lower_1 <= 6.4709 )
					...
					if( upper_3 > 6.82338 )
						...
						if( lower_5 > 6.16472 )
							ret := 0.600000
				if( lower_1 > 6.4709 )
					if( basis_max <= -0.206515 )
						if( basis_minus <= 1.14427 )
							ret := -0.077877
						if( basis_minus > 1.14427 )
							ret := 0.157742
					if( basis_max > -0.206515 )
...
float op_operation = decision_tree_0_CRSR_1Min_0587159a(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
