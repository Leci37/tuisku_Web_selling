			...
			if( MFI_High > -24.6256 )
				if( MFI_High <= -18.9647 )
					...
					if( k > 88.7008 )
						ret := 0.125000
				if( MFI_High > -18.9647 )
					if( Negative_Money_Flow <= 8.13009e+07 )
						ret := 0.037037
					if( Negative_Money_Flow > 8.13009e+07 )
						ret := 0.538462
		if( Typical_Price > 98.6149 )
			if( MFI <= 66.3529 )
				if( d <= 31.1063 )
					...
					if( rsi1 > 28.7372 )
						ret := -0.411765
				if( d > 31.1063 )
					if( Positive_Money_Flow_Sum <= 3.44468e+09 )
						ret := 0.404412
					if( Positive_Money_Flow_Sum > 3.44468e+09 )
						ret := -0.080569
			if( MFI > 66.3529 )
				if( Raw_Money_Flow <= 3.08736e+08 )
					if( smoothD_d <= 89.5814 )
						ret := -0.887324 // sell
					if( smoothD_d > 89.5814 )
						ret := 0.000000
				if( Raw_Money_Flow > 3.08736e+08 )
					if( Negative_Money_Flow_Sum <= 1.77336e+09 )
						ret := -0.020619
					if( Negative_Money_Flow_Sum > 1.77336e+09 )
						ret := -0.600000
...
float op_operation = decision_tree_0_DDOG_1Day_d46f1a35(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
