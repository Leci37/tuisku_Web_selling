			...
			if( midLine > 7.51294 )
				...
				if( Color_con1 > -1.0247 )
					...
					if( Color_con1 > -0.050541 )
						ret := -1.000000 // sell
	if( wvf > 11.4598 )
		if( Color_con1 <= -20.6105 )
			ret := -0.945946 // sell
		if( Color_con1 > -20.6105 )
			if( Color_con2 <= 2.39786 )
				if( midLine <= 26.5098 )
					if( lowerBand <= -0.040694 )
						if( wvf <= 16.985 )
							ret := 0.578947
						if( wvf > 16.985 )
							ret := -0.200000
				...
				if( midLine > 26.5098 )
					ret := -0.875000 // sell
			if( Color_con2 > 2.39786 )
				if( Color_con2 <= 7.90653 )
					if( lowerBand <= -1.84938 )
						if( lowerBand <= -4.1388 )
							ret := 0.823529 // buy
						if( lowerBand > -4.1388 )
							ret := -0.814815 // sell
...
float op_operation = decision_tree_0_U_30Min_fe975ec6(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
