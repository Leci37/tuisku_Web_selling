...
decision_tree_0_ETSY_1Hour_f76e2c54(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema3 > 53.6727 )
		...
		if( ema13 > -3.55513 )
			...
			if( smoothK_k > 0.858213 )
				if( ema2 <= 56.6239 )
					if( smoothD_d <= 86.8571 )
						if( smoothD_d <= 2.23847 )
							ret := -0.597701
						if( smoothD_d > 2.23847 )
							ret := -0.032944
					if( smoothD_d > 86.8571 )
						if( smoothK_k <= 96.9944 )
							ret := -0.635897
						if( smoothK_k > 96.9944 )
							ret := -0.034483
				if( ema2 > 56.6239 )
...
float op_operation = decision_tree_0_ETSY_1Hour_f76e2c54(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)
