...
decision_tree_0_DOCN_1Hour_4252b8e2(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( upper_5 > 37.4763 )
		if( upper_5 <= 39.9391 )
			if( lower_1 <= 29.2735 )
				if( lower_3 <= 26.228 )
					if( basis_max <= -9.34645 )
						if( basis_max <= -9.44544 )
							ret := -0.515152
						if( basis_max > -9.44544 )
							ret := -0.076923
					if( basis_max > -9.34645 )
...
float op_operation = decision_tree_0_DOCN_1Hour_4252b8e2(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
