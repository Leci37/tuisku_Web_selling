...
decision_tree_0_NIO_1Hour_b93b30d1(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bearPower > -1.19584 )
		...
		if( bearPower > -0.868643 )
			if( bbm <= 0.019995 )
				if( bearPower <= 0.058468 )
					if( bbm <= 0.019013 )
						if( bearPower <= 0.011237 )
							ret := 0.111111
						if( bearPower > 0.011237 )
							ret := 0.384615
					if( bbm > 0.019013 )
			...
			if( bbm > 0.019995 )
				if( bbp <= 5.161 )
					if( bbm <= 1.85003 )
						if( bullPower <= 2.31481 )
							ret := -0.014968
						if( bullPower > 2.31481 )
							ret := -0.362069
					if( bbm > 1.85003 )
						if( bullPower <= 2.32566 )
							ret := 0.490741
						if( bullPower > 2.32566 )
							ret := -0.172414
				if( bbp > 5.161 )
...
float op_operation = decision_tree_0_NIO_1Hour_b93b30d1(bearPower, bbm, bbp, bullPower, BBPower_Color)
