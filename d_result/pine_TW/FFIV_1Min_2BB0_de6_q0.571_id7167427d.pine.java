		...
		if( Upper_Band > 165.797 )
			if( Lower_Band <= 164.375 )
				...
				if( bbm > 0.929203 )
					ret := 0.782609 // buy
			if( Lower_Band > 164.375 )
				if( Upper_Band <= 222.823 )
					if( bbp <= 13.5323 )
						if( Upper_Band <= 196.31 )
							ret := -0.039580
						if( Upper_Band > 196.31 )
							ret := 0.013574
					if( bbp > 13.5323 )
...
float op_operation = decision_tree_0_FFIV_1Min_7167427d(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
