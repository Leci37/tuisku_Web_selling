...
decision_tree_0_TRXUSDT_15Min_552b3139(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)=>
	...
	if( k > 46.2473 )
		if( k <= 72.2916 )
			if( Positive_Money_Flow <= 1672.01 )
				if( Positive_Money_Flow_Sum <= 5.93609e+06 )
					if( rsi1 <= 50.583 )
						ret := 0.066108
					if( rsi1 > 50.583 )
						ret := 0.354626
			...
			if( Positive_Money_Flow > 1672.01 )
				if( rsi1 <= 64.3215 )
					...
					if( MFI > 57.6371 )
						ret := -0.218760
				if( rsi1 > 64.3215 )
					if( Typical_Price <= 0.072842 )
						ret := -0.015296
					if( Typical_Price > 0.072842 )
						ret := 0.341390
		if( k > 72.2916 )
			if( rsi1 <= 69.5933 )
				if( Money_Flow_Ratio <= 1.18756 )
					if( rsi1 <= 54.457 )
						ret := 0.154493
					if( rsi1 > 54.457 )
						ret := 0.459925
				if( Money_Flow_Ratio > 1.18756 )
					if( Typical_Price <= 0.08235 )
						ret := 0.043865
					if( Typical_Price > 0.08235 )
						ret := 0.287115
			if( rsi1 > 69.5933 )
				if( Typical_Price <= 0.073467 )
					if( MFI_Low <= 44.2562 )
						ret := 0.532067
					if( MFI_Low > 44.2562 )
						ret := 0.041493
				if( Typical_Price > 0.073467 )
					if( Positive_Money_Flow_Sum <= 1.01934e+07 )
						ret := 0.620402
					if( Positive_Money_Flow_Sum > 1.01934e+07 )
						ret := 0.184946
...
float op_operation = decision_tree_0_TRXUSDT_15Min_552b3139(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
