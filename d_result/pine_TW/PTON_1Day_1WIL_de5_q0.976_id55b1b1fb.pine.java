...
decision_tree_0_PTON_1Day_55b1b1fb(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( lowerBand > -1.80255 )
			...
			if( sDev <= 13.5004 )
				if( wvf <= 14.0589 )
					...
					if( Color_con1 > -13.6002 )
						ret := 0.152174
				if( wvf > 14.0589 )
					if( lowerBand <= -0.265266 )
						ret := 0.200000
					if( lowerBand > -0.265266 )
						ret := 0.865385 // buy
			if( sDev > 13.5004 )
				if( wvf <= 36.4533 )
					if( upperBand <= 42.6789 )
						ret := 0.052239
					if( upperBand > 42.6789 )
						ret := -0.695652
				if( wvf > 36.4533 )
		...
		if( lowerBand > 2.07837 )
			if( wvf <= 35.1486 )
				if( Color_con1 <= -10.0656 )
					if( Color_con1 <= -24.7824 )
						ret := -0.443750
					if( Color_con1 > -24.7824 )
						ret := 0.204545
				if( Color_con1 > -10.0656 )
...
float op_operation = decision_tree_0_PTON_1Day_55b1b1fb(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
