...
decision_tree_0_LTCUSDT_1Day_7026e4da(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Short_MA > 57.8655 )
		...
		if( Negative_Money_Flow_Sum > 8.34646e+07 )
			if( Short_MA <= 272.689 )
				if( Raw_Money_Flow <= 3.65815e+07 )
					if( Positive_Money_Flow_Sum <= 1.27868e+08 )
						ret := 0.083333
					if( Positive_Money_Flow_Sum > 1.27868e+08 )
						ret := -0.318569
				if( Raw_Money_Flow > 3.65815e+07 )
					if( Short_Long_Diff <= -6.05865 )
						ret := 0.293333
					if( Short_Long_Diff > -6.05865 )
						ret := -0.007530
			if( Short_MA > 272.689 )
				if( Raw_Money_Flow <= 9.27482e+08 )
					if( Negative_Money_Flow_Sum <= 1.14794e+09 )
						ret := -0.666667
					if( Negative_Money_Flow_Sum > 1.14794e+09 )
						ret := -1.000000 // sell
				if( Raw_Money_Flow > 9.27482e+08 )
...
float op_operation = decision_tree_0_LTCUSDT_1Day_7026e4da(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
