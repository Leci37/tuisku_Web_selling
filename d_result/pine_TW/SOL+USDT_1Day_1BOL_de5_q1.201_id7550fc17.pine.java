			...
			if( BBupper <= 201.944 )
				if( BBlower <= -10.7535 )
					...
					if( BBupper > 77.0186 )
						ret := 0.203297
				if( BBlower > -10.7535 )
					if( dif_source_BBupper <= -0.862587 )
						ret := 0.146045
					if( dif_source_BBupper > -0.862587 )
						ret := 0.641509
			if( BBupper > 201.944 )
				if( dif_source_BBlower <= 99.2435 )
					if( BBupper <= 203.465 )
						ret := -0.263158
					if( BBupper > 203.465 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_SOLUSDT_1Day_7550fc17(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
