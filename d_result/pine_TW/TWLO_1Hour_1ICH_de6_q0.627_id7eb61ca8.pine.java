			...
			if( senkou_span_a_displaced <= 45.3948 )
				if( senkou_span_b_displaced <= 46.2896 )
					...
					if( chinkou_span > 51.4557 )
						ret := 0.807692 // buy
				if( senkou_span_b_displaced > 46.2896 )
					if( senkou_span_b_displaced <= 55.6075 )
						if( basis_max <= -0.145818 )
							ret := 0.880000 // buy
						if( basis_max > -0.145818 )
							ret := 1.000000 // buy
					if( senkou_span_b_displaced > 55.6075 )
						ret := 0.750000 // buy
			if( senkou_span_a_displaced > 45.3948 )
				if( basis_max <= 0.196087 )
					if( basis_minus <= -1.62879 )
						if( chinkou_span <= 46.5448 )
							ret := 1.000000 // buy
						if( chinkou_span > 46.5448 )
							ret := 0.875000 // buy
					if( basis_minus > -1.62879 )
						if( chinkou_span <= 50.9672 )
							ret := 0.376812
						if( chinkou_span > 50.9672 )
							ret := 0.818182 // buy
				if( basis_max > 0.196087 )
					if( senkou_span_a_displaced <= 48.3972 )
						if( chinkou_span <= 47.3916 )
							ret := -1.000000 // sell
						if( chinkou_span > 47.3916 )
							ret := 0.166667
					if( senkou_span_a_displaced > 48.3972 )
						if( chinkou_span <= 46.8674 )
							ret := 0.846154 // buy
						if( chinkou_span > 46.8674 )
							ret := 0.384615
		if( senkou_span_b > 48.9962 )
			if( senkou_span_b_displaced <= 360.12 )
				if( senkou_span_b <= 343.306 )
					if( chinkou_span <= 86.9534 )
						if( tenkan_sen <= 73.949 )
							ret := 0.004208
						if( tenkan_sen > 73.949 )
							ret := -0.315424
					if( chinkou_span > 86.9534 )
						if( senkou_span_a_displaced <= 84.6512 )
							ret := 0.628959
						if( senkou_span_a_displaced > 84.6512 )
							ret := 0.023600
				if( senkou_span_b > 343.306 )
					if( chinkou_span <= 364.705 )
						if( tenkan_sen <= 366.938 )
							ret := 0.310734
						if( tenkan_sen > 366.938 )
							ret := -0.800000 // sell
					if( chinkou_span > 364.705 )
						if( tenkan_sen <= 383.294 )
							ret := 0.649351
						if( tenkan_sen > 383.294 )
							ret := -0.295455
			if( senkou_span_b_displaced > 360.12 )
				if( chinkou_span <= 361.318 )
					if( basis_minus <= -19.8494 )
						if( basis_max <= 4.08432 )
							ret := 0.866667 // buy
						if( basis_max > 4.08432 )
							ret := 0.473684
					if( basis_minus > -19.8494 )
						if( senkou_span_b <= 372.768 )
							ret := -0.419231
						if( senkou_span_b > 372.768 )
							ret := -0.800830 // sell
				if( chinkou_span > 361.318 )
					if( kinjun_sen <= 427.154 )
						if( basis_minus <= -8.18976 )
							ret := 0.516588
						if( basis_minus > -8.18976 )
							ret := -0.049008
					if( kinjun_sen > 427.154 )
						if( basis_minus <= 7.26224 )
							ret := -0.742857 // sell
						if( basis_minus > 7.26224 )
							ret := -1.000000 // sell
...
float op_operation = decision_tree_0_TWLO_1Hour_7eb61ca8(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
