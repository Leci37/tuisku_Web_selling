...
decision_tree_0_CRSR_1Min_6cbbeba0(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)=>
	...
	if( bbp > 0.122092 )
		if( bbm <= 0.003857 )
			if( Positive_Money_Flow <= 97.1495 )
				if( MFI_Low <= 4.40084 )
					ret := -0.666667
				if( MFI_Low > 4.40084 )
					if( Negative_Money_Flow <= 1122.45 )
						ret := -0.333333
					if( Negative_Money_Flow > 1122.45 )
						ret := 0.636364
			if( Positive_Money_Flow > 97.1495 )
				if( Positive_Money_Flow <= 1201.1 )
					ret := -0.988636 // sell
				if( Positive_Money_Flow > 1201.1 )
					if( Positive_Money_Flow_Sum <= 95032.3 )
						ret := -0.200000
					if( Positive_Money_Flow_Sum > 95032.3 )
						ret := -0.730435 // sell
		if( bbm > 0.003857 )
			if( Typical_Price <= 10.4366 )
				if( MFI <= 90.4069 )
					if( Raw_Money_Flow <= 10396.7 )
						ret := -0.213115
					if( Raw_Money_Flow > 10396.7 )
						ret := -0.795918 // sell
				if( MFI > 90.4069 )
					...
					if( MFI_High > 11.9452 )
						ret := -0.298246
			if( Typical_Price > 10.4366 )
				if( bearPower <= 0.054871 )
					if( Typical_Price <= 10.955 )
						ret := 0.727273 // buy
					if( Typical_Price > 10.955 )
						ret := -0.804878 // sell
				if( bearPower > 0.054871 )
					if( Positive_Money_Flow_Sum <= 375073 )
						ret := -0.014286
					if( Positive_Money_Flow_Sum > 375073 )
						ret := 0.622642
...
float op_operation = decision_tree_0_CRSR_1Min_6cbbeba0(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
