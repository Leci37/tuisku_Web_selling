			...
			if( Typical_Price > 61.6438 )
				...
				if( Typical_Price > 78.1349 )
					...
					if( MFI > 16.8521 )
						ret := 1.000000 // buy
	if( Positive_Money_Flow_Sum > 1.15615e+09 )
		if( Negative_Money_Flow_Sum <= 1.63254e+09 )
			if( Negative_Money_Flow_Sum <= 1.35528e+09 )
				if( VIM <= 0.962649 )
					if( Positive_Money_Flow_Sum <= 1.97371e+09 )
						ret := -0.616438
					if( Positive_Money_Flow_Sum > 1.97371e+09 )
						ret := 0.005000
				if( VIM > 0.962649 )
					...
					if( MFI > 54.4772 )
						ret := 0.652174
			if( Negative_Money_Flow_Sum > 1.35528e+09 )
				if( Money_Flow_Ratio <= 3.66761 )
					if( Typical_Price <= 102.338 )
						ret := -0.513514
					if( Typical_Price > 102.338 )
						ret := -0.893939 // sell
				if( Money_Flow_Ratio > 3.66761 )
					ret := 1.000000 // buy
		if( Negative_Money_Flow_Sum > 1.63254e+09 )
			if( Raw_Money_Flow <= 8.38887e+08 )
				if( Negative_Money_Flow_Sum <= 4.18728e+09 )
					if( Negative_Money_Flow_Sum <= 2.88813e+09 )
						ret := 0.170732
					if( Negative_Money_Flow_Sum > 2.88813e+09 )
						ret := -0.292683
				if( Negative_Money_Flow_Sum > 4.18728e+09 )
					if( Positive_Money_Flow_Sum <= 2.09043e+09 )
						ret := -0.750000 // sell
					if( Positive_Money_Flow_Sum > 2.09043e+09 )
						ret := 0.490196
			if( Raw_Money_Flow > 8.38887e+08 )
				if( Raw_Money_Flow <= 1.69023e+09 )
					if( Typical_Price <= 135.344 )
						ret := -0.166667
					if( Typical_Price > 135.344 )
						ret := -0.810127 // sell
				if( Raw_Money_Flow > 1.69023e+09 )
					if( Raw_Money_Flow <= 2.58228e+09 )
						ret := 0.000000
					if( Raw_Money_Flow > 2.58228e+09 )
						ret := 0.800000 // buy
...
float op_operation = decision_tree_0_ETSY_1Day_7bfeab37(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
