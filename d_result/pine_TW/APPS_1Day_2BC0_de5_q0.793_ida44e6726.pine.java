			...
			if( bearPower <= -0.050654 )
				...
				if( ad_mf > 1.93774e+06 )
					...
					if( bbm > 1.20538 )
						ret := 0.678571
			if( bearPower > -0.050654 )
				if( bearPower <= -0.037076 )
					if( bullPower <= 0.009756 )
						ret := 1.000000 // buy
					if( bullPower > 0.009756 )
						ret := 0.303030
				if( bearPower > -0.037076 )
...
float op_operation = decision_tree_0_APPS_1Day_a44e6726(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)
