...
decision_tree_0_SPOT_1Day_bdaf8401(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)=>
	...
	if( Positive_Money_Flow_Sum > 3.075e+09 )
		if( Short_MA <= 266.871 )
			if( Typical_Price <= 220.353 )
				if( Positive_Money_Flow_Sum <= 4.16987e+09 )
					if( Negative_Money_Flow_Sum <= 6.75002e+08 )
						ret := -0.941176 // sell
					if( Negative_Money_Flow_Sum > 6.75002e+08 )
						ret := -0.114504
				if( Positive_Money_Flow_Sum > 4.16987e+09 )
					if( Typical_Price <= 218.214 )
						ret := -0.702128 // sell
					if( Typical_Price > 218.214 )
						ret := 1.000000 // buy
			if( Typical_Price > 220.353 )
				if( Short_MA <= 218.882 )
					ret := 1.000000 // buy
				if( Short_MA > 218.882 )
					if( Short_Long_Diff <= 8.7691 )
						ret := 0.285714
					if( Short_Long_Diff > 8.7691 )
						ret := -0.192771
		if( Short_MA > 266.871 )
			if( Negative_Money_Flow_Sum <= 7.6387e+09 )
				if( Positive_Money_Flow_Sum <= 8.44912e+09 )
					if( Positive_Money_Flow <= 1.33543e+08 )
						ret := -0.258824
					if( Positive_Money_Flow > 1.33543e+08 )
						ret := -0.646067
				if( Positive_Money_Flow_Sum > 8.44912e+09 )
...
float op_operation = decision_tree_0_SPOT_1Day_bdaf8401(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
