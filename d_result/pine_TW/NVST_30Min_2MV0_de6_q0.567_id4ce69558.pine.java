...
decision_tree_0_NVST_30Min_4ce69558(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Negative_Money_Flow_Sum > 7.64431e+07 )
		if( VIM <= 1.18351 )
			if( Positive_Money_Flow <= 9.95528e+06 )
				if( Positive_Money_Flow_Sum <= 1.3296e+07 )
					ret := 0.704545 // buy
				if( Positive_Money_Flow_Sum > 1.3296e+07 )
					if( VIM <= 1.0051 )
						ret := -0.429907
					if( VIM > 1.0051 )
						if( Raw_Money_Flow <= 2.39684e+06 )
							ret := -0.408602
						if( Raw_Money_Flow > 2.39684e+06 )
							ret := 0.134680
			if( Positive_Money_Flow > 9.95528e+06 )
				...
				if( MFI_Low > 11.4362 )
					ret := 0.238095
		if( VIM > 1.18351 )
			if( Raw_Money_Flow <= 1.62459e+06 )
				ret := 0.852632 // buy
			if( Raw_Money_Flow > 1.62459e+06 )
				if( Typical_Price <= 24.0034 )
					ret := 0.888889 // buy
				if( Typical_Price > 24.0034 )
					if( Typical_Price <= 31.51 )
						if( Negative_Money_Flow_Sum <= 8.41073e+07 )
							ret := -0.857143 // sell
						if( Negative_Money_Flow_Sum > 8.41073e+07 )
							ret := 0.122951
					if( Typical_Price > 31.51 )
						if( Raw_Money_Flow <= 2.11785e+06 )
							ret := -0.206897
						if( Raw_Money_Flow > 2.11785e+06 )
							ret := 0.443750
...
float op_operation = decision_tree_0_NVST_30Min_4ce69558(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
