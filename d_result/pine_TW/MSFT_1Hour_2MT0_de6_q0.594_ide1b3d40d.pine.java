...
decision_tree_0_MSFT_1Hour_e1b3d40d(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( Negative_Money_Flow_Sum > 9.1067e+09 )
		if( Positive_Money_Flow_Sum <= 7.24029e+09 )
			if( ema13 <= -3.57035 )
				if( Money_Flow_Ratio <= 0.531039 )
					if( Raw_Money_Flow <= 1.74414e+07 )
						if( Negative_Money_Flow_Sum <= 1.0394e+10 )
							ret := 0.870968 // buy
						if( Negative_Money_Flow_Sum > 1.0394e+10 )
							ret := -0.348485
					if( Raw_Money_Flow > 1.74414e+07 )
						if( Positive_Money_Flow <= 2.84062e+09 )
							ret := 0.755172 // buy
						if( Positive_Money_Flow > 2.84062e+09 )
							ret := -0.833333 // sell
				if( Money_Flow_Ratio > 0.531039 )
...
float op_operation = decision_tree_0_MSFT_1Hour_e1b3d40d(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
