			...
			if( Positive_Money_Flow_Sum <= 7.0444e+10 )
				if( Negative_Money_Flow <= 5.50572e+09 )
					...
					if( Money_Flow_Ratio > 1.09161 )
						ret := -0.254450
				if( Negative_Money_Flow > 5.50572e+09 )
					if( Negative_Money_Flow_Sum <= 4.61616e+10 )
						ret := -0.692913
					if( Negative_Money_Flow_Sum > 4.61616e+10 )
						ret := 0.090909
			if( Positive_Money_Flow_Sum > 7.0444e+10 )
				if( Long_MA <= 285.51 )
					...
					if( Short_MA > 227.318 )
						ret := -1.000000 // sell
				if( Long_MA > 285.51 )
					if( Raw_Money_Flow <= 7.36029e+09 )
						ret := 0.320000
					if( Raw_Money_Flow > 7.36029e+09 )
						ret := 0.857143 // buy
		if( Money_Flow_Ratio > 2.11163 )
			if( Positive_Money_Flow_Sum <= 7.5346e+10 )
				if( Short_Long_Diff <= 7.52723 )
					if( Positive_Money_Flow <= 6.01903e+09 )
						ret := 0.167568
					if( Positive_Money_Flow > 6.01903e+09 )
						ret := -0.607143
				if( Short_Long_Diff > 7.52723 )
					if( Positive_Money_Flow_Sum <= 5.75215e+10 )
						ret := 0.873418 // buy
					if( Positive_Money_Flow_Sum > 5.75215e+10 )
						ret := 0.320988
			if( Positive_Money_Flow_Sum > 7.5346e+10 )
				if( Long_MA <= 278.302 )
					if( Raw_Money_Flow <= 4.78993e+09 )
						ret := -0.400000
					if( Raw_Money_Flow > 4.78993e+09 )
						ret := -0.946429 // sell
				if( Long_MA > 278.302 )
					if( Short_Long_Diff <= 8.78857 )
						ret := 0.857143 // buy
					if( Short_Long_Diff > 8.78857 )
						ret := -0.080000
...
float op_operation = decision_tree_0_META_1Day_b2a8b055(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
