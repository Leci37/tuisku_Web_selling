	...
	if( lower_5 > 10.2243 )
		if( lower_5 <= 11.1433 )
			...
			if( lower_5 > 10.7975 )
				ret := -0.469565
		if( lower_5 > 11.1433 )
			if( basis_minus <= 13.2684 )
				if( lower_4 <= 11.611 )
					ret := 0.737288 // buy
				if( lower_4 > 11.611 )
					if( basis_minus <= 9.56493 )
						if( basis_minus <= 8.43016 )
							ret := 0.052213
						if( basis_minus > 8.43016 )
							ret := -0.236710
					if( basis_minus > 9.56493 )
...
float op_operation = decision_tree_0_AFRM_30Min_59686581(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
