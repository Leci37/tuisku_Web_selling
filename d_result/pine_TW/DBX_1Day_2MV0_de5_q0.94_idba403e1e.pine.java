			...
			if( Typical_Price <= 29.7262 )
				...
				if( VIP_VIM > 0.526593 )
					...
					if( Money_Flow_Ratio > 4.84619 )
						ret := -1.000000 // sell
			if( Typical_Price > 29.7262 )
				if( Positive_Money_Flow_Sum <= 7.60297e+08 )
					ret := -0.500000
				if( Positive_Money_Flow_Sum > 7.60297e+08 )
					ret := 0.000000
		if( Raw_Money_Flow > 7.49543e+07 )
			if( VIM <= 0.84143 )
				if( Typical_Price <= 33.7953 )
					if( Money_Flow_Ratio <= 7.15604 )
						ret := 0.120482
					if( Money_Flow_Ratio > 7.15604 )
						ret := -0.769231 // sell
				if( Typical_Price > 33.7953 )
					ret := -1.000000 // sell
			if( VIM > 0.84143 )
				if( Negative_Money_Flow_Sum <= 3.38938e+08 )
					if( Raw_Money_Flow <= 7.7818e+07 )
						ret := 0.666667
					if( Raw_Money_Flow > 7.7818e+07 )
						ret := -0.800000 // sell
				if( Negative_Money_Flow_Sum > 3.38938e+08 )
					if( Positive_Money_Flow_Sum <= 1.09975e+09 )
						ret := -0.421053
					if( Positive_Money_Flow_Sum > 1.09975e+09 )
						ret := -0.754098 // sell
...
float op_operation = decision_tree_0_DBX_1Day_ba403e1e(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
