...
decision_tree_0_PYPL_1Day_4f112fa6(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema1 > 84.2171 )
		...
		if( ema2 > 95.8518 )
			if( ema3 <= 111.902 )
				if( bullPower <= 0.371198 )
					if( bearPower <= -7.31238 )
						ret := -0.222222
					if( bearPower > -7.31238 )
						ret := 0.845070 // buy
				if( bullPower > 0.371198 )
...
float op_operation = decision_tree_0_PYPL_1Day_4f112fa6(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
