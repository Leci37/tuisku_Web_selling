			...
			if( Upper_Band > 119.473 )
				if( bbp <= -19.9387 )
					...
					if( basis > 109.696 )
						ret := -1.000000 // sell
				if( bbp > -19.9387 )
					if( Lower_Band <= 108.027 )
						ret := -0.910345 // sell
					if( Lower_Band > 108.027 )
						ret := 0.000000
		if( basis > 119.545 )
			if( Lower_Band <= 173.605 )
				if( bbm <= 2.32165 )
					if( Upper_Band <= 184.739 )
						ret := 0.723404 // buy
					if( Upper_Band > 184.739 )
						ret := -0.500000
				if( bbm > 2.32165 )
					if( Upper_Band <= 185.35 )
						ret := -0.048013
					if( Upper_Band > 185.35 )
						ret := 0.339695
			if( Lower_Band > 173.605 )
...
float op_operation = decision_tree_0_BABA_1Day_be444cee(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
