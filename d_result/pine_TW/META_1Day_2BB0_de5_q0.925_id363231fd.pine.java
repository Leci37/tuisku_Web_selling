			...
			if( bbm > 3.47228 )
				if( Upper_Band <= 147.037 )
					...
					if( bearPower > -0.34037 )
						ret := -0.571429
				if( Upper_Band > 147.037 )
					if( Upper_Band <= 155.167 )
						ret := 0.633333
					if( Upper_Band > 155.167 )
						ret := -0.204479
		if( Lower_Band > 222.78 )
			if( Upper_Band <= 280.624 )
				if( bbp <= 22.624 )
					if( basis <= 264.648 )
						ret := 0.865169 // buy
					if( basis > 264.648 )
			...
			if( Upper_Band > 280.624 )
				if( basis <= 502.542 )
					if( Upper_Band <= 395.978 )
						ret := -0.008464
					if( Upper_Band > 395.978 )
						ret := 0.655000
				if( basis > 502.542 )
					if( Lower_Band <= 486.961 )
						ret := -0.840426 // sell
					if( Lower_Band > 486.961 )
						ret := 0.621622
...
float op_operation = decision_tree_0_META_1Day_363231fd(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
