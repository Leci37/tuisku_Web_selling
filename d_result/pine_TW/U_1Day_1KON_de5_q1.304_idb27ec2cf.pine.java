...
decision_tree_0_U_1Day_b27ec2cf(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)=>
	...
	if( pvim > 0.182445 )
		...
		if( verde_mean > 94.0044 )
			...
			if( marron > 94.3977 )
				if( oscp <= 20.7491 )
					if( verde_azul <= 106.031 )
						ret := -0.066667
					if( verde_azul > 106.031 )
						ret := -0.769231 // sell
				if( oscp > 20.7491 )
					if( media_azul <= 92.1552 )
						ret := 0.555556
					if( media_azul > 92.1552 )
						ret := -0.217391
...
float op_operation = decision_tree_0_U_1Day_b27ec2cf(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
