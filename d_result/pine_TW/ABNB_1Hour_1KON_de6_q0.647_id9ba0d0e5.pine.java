	...
	if( tprice > 116.425 )
		if( pvi <= 0.022306 )
			if( nvi_ema <= 0.258781 )
				if( verde <= 110.221 )
					if( azul <= 14.5768 )
						if( verde_media <= 24.4308 )
							ret := 0.249789
						if( verde_media > 24.4308 )
							ret := 0.679245
					if( azul > 14.5768 )
						if( marron_mean <= 13.0174 )
							ret := -0.559322
						if( marron_mean > 13.0174 )
							ret := 0.056818
				if( verde > 110.221 )
...
float op_operation = decision_tree_0_ABNB_1Hour_9ba0d0e5(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
