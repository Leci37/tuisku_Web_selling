...
decision_tree_0_ADSK_5Min_c419e285(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)=>
	...
	if( Lower_Band > 201.634 )
		if( basis <= 203.959 )
			if( Upper_Band <= 202.912 )
				if( bbp <= -0.087922 )
					if( Upper_Band <= 202.649 )
						ret := 0.909091 // buy
					if( Upper_Band > 202.649 )
						ret := 0.777778 // buy
				if( bbp > -0.087922 )
			...
			if( Upper_Band > 202.912 )
				...
				if( bearPower > -0.119972 )
					...
					if( bbm > 0.084102 )
						ret := -0.274306
		if( basis > 203.959 )
			if( Lower_Band <= 259.867 )
				if( Upper_Band <= 205.203 )
					if( bbm <= 0.466436 )
						ret := 0.487395
					if( bbm > 0.466436 )
						ret := 0.937500 // buy
				if( Upper_Band > 205.203 )
					if( Upper_Band <= 223.664 )
						ret := -0.002159
					if( Upper_Band > 223.664 )
						ret := 0.070553
			if( Lower_Band > 259.867 )
				if( Lower_Band <= 261.935 )
					if( bullPower <= 1.18913 )
						ret := -0.325758
					if( bullPower > 1.18913 )
						ret := 0.366667
				if( Lower_Band > 261.935 )
					if( Upper_Band <= 263.624 )
						ret := 0.925926 // buy
					if( Upper_Band > 263.624 )
						ret := -0.017325
...
float op_operation = decision_tree_0_ADSK_5Min_c419e285(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
