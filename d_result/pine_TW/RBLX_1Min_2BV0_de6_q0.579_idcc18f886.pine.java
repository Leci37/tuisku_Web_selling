...
decision_tree_0_RBLX_1Min_cc18f886(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)=>
	...
	if( bearPower <= 0.040129 )
		...
		if( VIP > 6.5681 )
			if( bbp <= 0.018945 )
				if( VIP_VIM <= 0.340588 )
					if( bullPower <= 0.002601 )
						if( bearPower <= -0.027075 )
							ret := 0.644689
						if( bearPower > -0.027075 )
							ret := 0.440299
					if( bullPower > 0.002601 )
...
float op_operation = decision_tree_0_RBLX_1Min_cc18f886(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)
