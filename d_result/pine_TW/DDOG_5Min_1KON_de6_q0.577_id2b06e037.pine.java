				...
				if( tprice <= 129.893 )
					if( xmf <= 57.6724 )
						...
						if( verde > 72.4551 )
							ret := -0.261965
					if( xmf > 57.6724 )
						if( azul_mean <= -72.8246 )
							ret := -0.404040
						if( azul_mean > -72.8246 )
							ret := 0.212352
				if( tprice > 129.893 )
					if( verde_azul <= 39.3909 )
						if( media <= 25.7325 )
							ret := 0.191011
						if( media > 25.7325 )
							ret := -0.496466
					if( verde_azul > 39.3909 )
						...
						if( pvi > 0.568499 )
							ret := -0.060172
	if( xrsi > 51.0716 )
		if( verde_media <= 69.79 )
			if( verde <= 22.8285 )
				if( verde_media <= -65.7094 )
					if( oscp <= -65.6925 )
						ret := -0.875000 // sell
					if( oscp > -65.6925 )
						ret := 0.750000 // buy
				...
				if( azul > -54.884 )
					...
					if( pvimin > 0.002991 )
						...
						if( source > 72.3618 )
							ret := -0.052419
		if( verde_media > 69.79 )
			if( marron_mean <= 100.993 )
				if( azul <= -10.4049 )
					if( tprice <= 120.383 )
						if( azul_mean <= -77.3068 )
							ret := -1.000000 // sell
						if( azul_mean > -77.3068 )
							ret := 0.096970
					if( tprice > 120.383 )
						...
						if( media > 77.1354 )
							ret := 0.085714
				if( azul > -10.4049 )
					if( media_azul <= 92.6198 )
						if( verde_azul <= 137.134 )
							ret := -0.278351
						if( verde_azul > 137.134 )
							ret := -0.600304
					if( media_azul > 92.6198 )
						if( marron_mean <= 96.0856 )
							ret := 0.083333
						if( marron_mean > 96.0856 )
							ret := 0.666667
			if( marron_mean > 100.993 )
				if( xmf <= 81.3608 )
					if( verde_azul <= 160.137 )
						if( azul_mean <= 16.3715 )
							ret := -0.744186 // sell
						if( azul_mean > 16.3715 )
							ret := 0.482759
					if( verde_azul > 160.137 )
				...
				if( xmf > 81.3608 )
					if( pvi <= 0.198659 )
						if( verde_mean <= 195.116 )
							ret := 0.822581 // buy
						if( verde_mean > 195.116 )
							ret := 0.083333
					if( pvi > 0.198659 )
						if( verde_mean <= 132.312 )
							ret := 0.553571
						if( verde_mean > 132.312 )
							ret := -0.377717
...
float op_operation = decision_tree_0_DDOG_5Min_2b06e037(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
