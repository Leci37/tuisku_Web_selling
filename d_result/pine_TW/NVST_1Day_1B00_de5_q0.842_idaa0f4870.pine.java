...
decision_tree_0_NVST_1Day_aa0f4870(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bearPower > -2.41664 )
		...
		if( bullPower > -0.537735 )
			if( bbp <= 4.88802 )
				if( bullPower <= 1.31303 )
					if( bullPower <= 1.07631 )
						ret := 0.000971
					if( bullPower > 1.07631 )
						ret := -0.428571
				if( bullPower > 1.31303 )
					...
					if( bbp > 1.84194 )
						ret := 0.136564
			if( bbp > 4.88802 )
				if( bearPower <= 2.05915 )
					if( bearPower <= 1.67952 )
						ret := 0.000000
					if( bearPower > 1.67952 )
						ret := -0.947368 // sell
				if( bearPower > 2.05915 )
					if( bullPower <= 3.95781 )
						ret := -0.142857
					if( bullPower > 3.95781 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_NVST_1Day_aa0f4870(bearPower, bbm, bbp, bullPower, BBPower_Color)
