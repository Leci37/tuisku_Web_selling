			...
			if( upperBand > 41.6653 )
				...
				if( Color_con2 > -27.6168 )
					...
					if( wvf > 19.0481 )
						ret := -0.761905 // sell
		if( Color_con1 > -34.1207 )
			if( lowerBand <= 7.38121 )
				if( wvf <= 28.5406 )
					if( Color_con2 <= 2.25531 )
						ret := 0.273632
					if( Color_con2 > 2.25531 )
						ret := -0.506667
				if( wvf > 28.5406 )
					if( lowerBand <= -3.63674 )
						ret := -0.083333
					if( lowerBand > -3.63674 )
						ret := 0.725926 // buy
			if( lowerBand > 7.38121 )
				if( upperBand <= 38.3134 )
					if( wvf <= 12.7679 )
						ret := 0.727273 // buy
					if( wvf > 12.7679 )
						ret := -0.648810
				if( upperBand > 38.3134 )
					if( Color_con1 <= -21.5445 )
						ret := -0.194030
					if( Color_con1 > -21.5445 )
						ret := 0.559441
...
float op_operation = decision_tree_0_UNIUSDT_1Day_90381afc(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
