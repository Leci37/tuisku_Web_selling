			...
			if( lowerBand <= 0.669084 )
				if( sDev <= 3.16658 )
					...
					if( Color_con1 > -1.97029 )
						ret := -0.190400
				if( sDev > 3.16658 )
					if( upperBand <= 10.6973 )
						ret := 0.292639
					if( upperBand > 10.6973 )
						ret := -0.063927
			if( lowerBand > 0.669084 )
				if( lowerBand <= 2.40537 )
					if( wvf <= 2.95504 )
						ret := 0.364486
					if( wvf > 2.95504 )
						ret := 0.686084
				if( lowerBand > 2.40537 )
					if( upperBand <= 13.9844 )
						ret := 0.375000
					if( upperBand > 13.9844 )
						ret := -0.376623
...
float op_operation = decision_tree_0_MSFT_1Day_73b2d9b9(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
