			...
			if( rsi1 <= 68.2368 )
				...
				if( d_k > 7.57165 )
					if( rsi1 <= 55.5077 )
						ret := -0.335242
					if( rsi1 > 55.5077 )
						if( smoothD_d <= 81.1248 )
							ret := -0.184331
						if( smoothD_d > 81.1248 )
							ret := 0.114322
			if( rsi1 > 68.2368 )
				if( smoothD_d <= 90.1755 )
					if( d_k <= 16.0857 )
						ret := 0.319149
					if( d_k > 16.0857 )
						ret := -0.093333
...
float op_operation = decision_tree_0_AVAXUSDT_30Min_eae00200(rsi1, smoothK_k, d_k, k, d, smoothD_d)
