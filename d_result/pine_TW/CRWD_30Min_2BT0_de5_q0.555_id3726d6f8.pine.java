			...
			if( bearPower > -1.34913 )
				...
				if( bbm > 2.81437 )
					...
					if( ema12 > -0.345918 )
						ret := -0.598214
		if( ema13 > -0.186801 )
			if( bullPower <= 0.174975 )
				if( ema2 <= 49.4483 )
					if( bearPower <= -0.948382 )
						ret := 0.000000
					if( bearPower > -0.948382 )
						ret := 0.653631
				if( ema2 > 49.4483 )
...
float op_operation = decision_tree_0_CRWD_30Min_3726d6f8(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
