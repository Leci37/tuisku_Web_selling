			...
			if( Raw_Money_Flow > 2.93932e+08 )
				...
				if( bullPower > 3.20924 )
					...
					if( bbm > 5.04239 )
						ret := 0.869565 // buy
	if( Positive_Money_Flow_Sum > 3.3175e+09 )
		if( Typical_Price <= 103.563 )
			if( Negative_Money_Flow_Sum <= 3.50659e+09 )
				if( Positive_Money_Flow_Sum <= 4.22217e+09 )
					if( Typical_Price <= 79.0412 )
						ret := 0.206897
					if( Typical_Price > 79.0412 )
						ret := -0.460000
				if( Positive_Money_Flow_Sum > 4.22217e+09 )
					if( Positive_Money_Flow_Sum <= 4.58369e+09 )
						ret := 0.793103 // buy
					if( Positive_Money_Flow_Sum > 4.58369e+09 )
						ret := 0.071429
			if( Negative_Money_Flow_Sum > 3.50659e+09 )
		...
		if( Typical_Price > 103.563 )
			...
			if( bearPower > -16.5785 )
				if( bbp <= 11.8301 )
					if( Positive_Money_Flow_Sum <= 5.453e+09 )
						ret := -0.436782
					if( Positive_Money_Flow_Sum > 5.453e+09 )
						ret := -0.855263 // sell
				if( bbp > 11.8301 )
...
float op_operation = decision_tree_0_DDOG_1Day_99cd27dc(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
