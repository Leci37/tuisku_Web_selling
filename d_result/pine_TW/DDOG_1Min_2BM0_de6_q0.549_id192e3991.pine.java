				...
				if( Positive_Money_Flow_Sum <= 1.04575e+06 )
					...
					if( Negative_Money_Flow_Sum > 270272 )
						...
						if( Positive_Money_Flow_Sum > 85123 )
							ret := -0.117985
				if( Positive_Money_Flow_Sum > 1.04575e+06 )
					if( Negative_Money_Flow_Sum <= 1.11633e+08 )
						if( Negative_Money_Flow_Sum <= 1.0107e+08 )
							ret := -0.001750
						if( Negative_Money_Flow_Sum > 1.0107e+08 )
							ret := -0.800000 // sell
					if( Negative_Money_Flow_Sum > 1.11633e+08 )
						ret := 0.769231 // buy
	if( bearPower > 0.311818 )
		if( Negative_Money_Flow_Sum <= 3.02317e+07 )
			if( Negative_Money_Flow_Sum <= 2.128e+07 )
				if( Positive_Money_Flow_Sum <= 2.17041e+07 )
					if( MFI <= 96.3115 )
						if( Negative_Money_Flow_Sum <= 2.00287e+06 )
							ret := -0.358974
						if( Negative_Money_Flow_Sum > 2.00287e+06 )
							ret := -0.079932
					if( MFI > 96.3115 )
						ret := 0.658537
				if( Positive_Money_Flow_Sum > 2.17041e+07 )
					if( Raw_Money_Flow <= 135617 )
						if( Money_Flow_Ratio <= 62.7918 )
							ret := 0.190083
						if( Money_Flow_Ratio > 62.7918 )
							ret := -0.773585 // sell
					if( Raw_Money_Flow > 135617 )
						ret := -0.671388
			if( Negative_Money_Flow_Sum > 2.128e+07 )
				if( Positive_Money_Flow_Sum <= 4.0729e+07 )
					ret := -0.888889 // sell
				if( Positive_Money_Flow_Sum > 4.0729e+07 )
					ret := 0.772727 // buy
		if( Negative_Money_Flow_Sum > 3.02317e+07 )
...
float op_operation = decision_tree_0_DDOG_1Min_192e3991(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
