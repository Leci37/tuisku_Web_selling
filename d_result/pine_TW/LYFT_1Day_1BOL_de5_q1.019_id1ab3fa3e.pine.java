			...
			if( vrsi <= 50.55 )
				if( vrsi <= 3.60777 )
					...
					if( BBupper > 66.1508 )
						ret := -1.000000 // sell
				if( vrsi > 3.60777 )
					if( dif_source_BBlower <= 2.44054 )
						ret := -0.057143
					if( dif_source_BBlower > 2.44054 )
						ret := -0.625954
			if( vrsi > 50.55 )
				if( BBupper <= 62.5389 )
					if( dif_source_BBupper <= -23.8039 )
						ret := -0.750000 // sell
					if( dif_source_BBupper > -23.8039 )
						ret := -1.000000 // sell
				if( BBupper > 62.5389 )
...
float op_operation = decision_tree_0_LYFT_1Day_1ab3fa3e(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
