...
decision_tree_0_TSLA_1Hour_464e7aba(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)=>
	...
	if( Money_Flow_Ratio > 4.35427 )
		if( ema12 <= 3.57712 )
			if( Positive_Money_Flow_Sum <= 1.0887e+09 )
				ret := 0.626506
			if( Positive_Money_Flow_Sum > 1.0887e+09 )
				if( ema3 <= 164.68 )
					ret := 0.617647
				if( ema3 > 164.68 )
					...
					if( MFI > 82.9995 )
						ret := -0.033011
		if( ema12 > 3.57712 )
			if( Positive_Money_Flow <= 6.17703e+09 )
				if( ema13 <= 32.235 )
					if( Positive_Money_Flow_Sum <= 2.20761e+09 )
						ret := -0.764706 // sell
					if( Positive_Money_Flow_Sum > 2.20761e+09 )
						ret := 0.353107
				if( ema13 > 32.235 )
			...
			if( Positive_Money_Flow > 6.17703e+09 )
				if( ema1 <= 1020.67 )
					if( Positive_Money_Flow_Sum <= 2.9887e+10 )
						ret := 0.458333
					if( Positive_Money_Flow_Sum > 2.9887e+10 )
						ret := -0.555556
				if( ema1 > 1020.67 )
...
float op_operation = decision_tree_0_TSLA_1Hour_464e7aba(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
