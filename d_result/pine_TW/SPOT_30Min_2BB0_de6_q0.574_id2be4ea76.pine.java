...
decision_tree_0_SPOT_30Min_2be4ea76(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)=>
	...
	if( bbp > -0.797159 )
		if( basis <= 76.6018 )
			if( Lower_Band <= 70.881 )
				ret := 0.781609 // buy
			if( Lower_Band > 70.881 )
				if( Upper_Band <= 74.6689 )
					if( bbp <= 1.29039 )
						ret := -0.755102 // sell
					if( bbp > 1.29039 )
						ret := 0.294118
				if( Upper_Band > 74.6689 )
					...
					if( bbp > -0.197748 )
						ret := 0.624161
		if( basis > 76.6018 )
			if( Upper_Band <= 377.679 )
				if( bullPower <= 6.86805 )
					if( bbp <= 2.64422 )
						if( basis <= 228.894 )
							ret := -0.044566
						if( basis > 228.894 )
					...
					if( bbp > 2.64422 )
						...
						if( basis > 100.025 )
							ret := -0.117926
				if( bullPower > 6.86805 )
					if( Upper_Band <= 358.375 )
						if( bearPower <= 11.1743 )
							ret := 0.265501
						if( bearPower > 11.1743 )
							ret := -0.652174
					if( Upper_Band > 358.375 )
...
float op_operation = decision_tree_0_SPOT_30Min_2be4ea76(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
