			...
			if( VIM > 1.20756 )
				...
				if( Raw_Money_Flow > 3.8877e+07 )
					...
					if( Raw_Money_Flow > 5.62169e+07 )
						ret := -0.181818
		if( Positive_Money_Flow_Sum > 2.16184e+08 )
			if( Raw_Money_Flow <= 1.7282e+07 )
				if( Typical_Price <= 130.363 )
					if( VIM <= 0.935546 )
						ret := 0.227273
					if( VIM > 0.935546 )
						ret := 0.769231 // buy
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_9f9d6a17(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
