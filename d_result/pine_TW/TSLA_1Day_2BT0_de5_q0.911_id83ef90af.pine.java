			...
			if( ema1 <= 1059.21 )
				if( tema <= 372.962 )
					...
					if( ema12 > 16.739 )
						ret := -0.666667
				if( tema > 372.962 )
					if( bearPower <= 53.3234 )
						ret := 0.720395 // buy
					if( bearPower > 53.3234 )
						ret := 0.229885
			if( ema1 > 1059.21 )
				if( bbp <= 311.024 )
					if( bearPower <= 35.0667 )
						ret := -0.500000
					if( bearPower > 35.0667 )
						ret := -1.000000 // sell
				if( bbp > 311.024 )
...
float op_operation = decision_tree_0_TSLA_1Day_83ef90af(bbp, bullPower, BBPower_Color, bearPower, bbm, ema2, ema1, ema12, ema3, ema13, tema)
