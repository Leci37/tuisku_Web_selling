			...
			if( Positive_Money_Flow_Sum > 939187 )
				...
				if( MFI > 22.862 )
					...
					if( Typical_Price > 30.2419 )
						ret := -0.010163
	if( Raw_Money_Flow > 308373 )
		if( Negative_Money_Flow <= 3.41707e+06 )
			if( Typical_Price <= 16.1208 )
				if( Short_MA <= 15.7912 )
					ret := 0.750000 // buy
				if( Short_MA > 15.7912 )
					ret := 1.000000 // buy
			if( Typical_Price > 16.1208 )
				if( Negative_Money_Flow_Sum <= 2.1216e+07 )
		...
		if( Negative_Money_Flow > 3.41707e+06 )
			if( Short_MA <= 23.6702 )
				if( Negative_Money_Flow_Sum <= 1.16342e+07 )
					if( MFI <= 52.7322 )
						ret := -0.238342
					if( MFI > 52.7322 )
						ret := 0.133094
				if( Negative_Money_Flow_Sum > 1.16342e+07 )
					if( Positive_Money_Flow_Sum <= 1.60333e+07 )
						ret := 0.296119
					if( Positive_Money_Flow_Sum > 1.60333e+07 )
						ret := 0.152542
			if( Short_MA > 23.6702 )
				if( Short_Long_Diff <= -0.465074 )
					if( Positive_Money_Flow_Sum <= 7.27489e+07 )
						ret := -0.568862
					if( Positive_Money_Flow_Sum > 7.27489e+07 )
						ret := 0.625000
				if( Short_Long_Diff > -0.465074 )
					if( Negative_Money_Flow <= 2.5713e+07 )
						ret := 0.004182
					if( Negative_Money_Flow > 2.5713e+07 )
						ret := 0.476415
...
float op_operation = decision_tree_0_DBX_15Min_a213aaed(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
