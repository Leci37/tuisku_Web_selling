			...
			if( ema13 <= 12.3679 )
				...
				if( MFI_High > -38.7451 )
					...
					if( tema > 165.277 )
						ret := -0.371134
			if( ema13 > 12.3679 )
				if( Raw_Money_Flow <= 3.9164e+10 )
					if( Money_Flow_Ratio <= 1.19193 )
						ret := 0.904762 // buy
					if( Money_Flow_Ratio > 1.19193 )
						ret := 0.611111
				if( Raw_Money_Flow > 3.9164e+10 )
					if( Negative_Money_Flow_Sum <= 1.5424e+11 )
						ret := -0.454545
					if( Negative_Money_Flow_Sum > 1.5424e+11 )
						ret := 0.416667
		if( ema3 > 679.45 )
			if( Negative_Money_Flow_Sum <= 2.89772e+11 )
				if( Positive_Money_Flow <= 1.91285e+10 )
					if( Negative_Money_Flow_Sum <= 1.62526e+11 )
						ret := -0.840237 // sell
					if( Negative_Money_Flow_Sum > 1.62526e+11 )
						ret := -0.401042
				if( Positive_Money_Flow > 1.91285e+10 )
					if( Positive_Money_Flow_Sum <= 1.64144e+11 )
						ret := 0.320000
					if( Positive_Money_Flow_Sum > 1.64144e+11 )
						ret := -0.441558
			if( Negative_Money_Flow_Sum > 2.89772e+11 )
...
float op_operation = decision_tree_0_TSLA_1Day_dd0e8612(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
