	...
	if( midLine > 4.11145 )
		if( Color_con1 <= -3.96695 )
			if( Color_con1 <= -13.4924 )
				if( sDev <= 12.8287 )
					if( Color_con1 <= -21.5189 )
						ret := -0.266667
					if( Color_con1 > -21.5189 )
						ret := 0.524194
				if( sDev > 12.8287 )
					if( Color_con2 <= -22.0695 )
						ret := 0.818182 // buy
					if( Color_con2 > -22.0695 )
						ret := -0.509615
			if( Color_con1 > -13.4924 )
				if( wvf <= 17.2881 )
					...
					if( sDev > 6.31529 )
						ret := -0.347909
				if( wvf > 17.2881 )
					if( upperBand <= 35.5516 )
						ret := 0.592105
					if( upperBand > 35.5516 )
						ret := -0.666667
		if( Color_con1 > -3.96695 )
			if( lowerBand <= -5.02889 )
				if( lowerBand <= -6.52194 )
					ret := 0.250000
				if( lowerBand > -6.52194 )
					if( lowerBand <= -5.92028 )
						ret := -1.000000 // sell
					if( lowerBand > -5.92028 )
						ret := -0.250000
			if( lowerBand > -5.02889 )
				if( Color_con2 <= 6.3803 )
					if( lowerBand <= 1.23466 )
						ret := 0.151125
					if( lowerBand > 1.23466 )
						ret := 0.523077
				if( Color_con2 > 6.3803 )
...
float op_operation = decision_tree_0_ADSK_1Day_739cec2d(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
