...
decision_tree_0_LTCUSDT_1Hour_2b89a408(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( d_k > -1.78643 )
		if( rsi1 <= 50.8086 )
			if( Positive_Money_Flow <= 627198 )
				if( Typical_Price <= 52.3989 )
					if( Typical_Price <= 35.21 )
						ret := 0.711111 // buy
					if( Typical_Price > 35.21 )
						ret := -0.028972
				if( Typical_Price > 52.3989 )
			...
			if( Positive_Money_Flow > 627198 )
				...
				if( Typical_Price > 61.4762 )
					...
					if( rsi1 > 35.0797 )
						ret := -0.393350
		if( rsi1 > 50.8086 )
			if( Positive_Money_Flow <= 833608 )
				if( MFI_Low <= 38.3255 )
					if( Negative_Money_Flow <= 2.52453e+07 )
						ret := 0.215809
					if( Negative_Money_Flow > 2.52453e+07 )
						ret := 0.875000 // buy
				if( MFI_Low > 38.3255 )
...
float op_operation = decision_tree_0_LTCUSDT_1Hour_2b89a408(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
