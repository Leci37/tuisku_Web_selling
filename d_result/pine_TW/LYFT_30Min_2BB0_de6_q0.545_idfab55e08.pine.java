		...
		if( basis <= 72.5272 )
			if( bullPower <= 0.612544 )
				if( Lower_Band <= 12.5412 )
					if( Upper_Band <= 12.3901 )
						if( Lower_Band <= 11.644 )
							ret := 0.022848
						if( Lower_Band > 11.644 )
							ret := -0.425000
					if( Upper_Band > 12.3901 )
						if( Upper_Band <= 13.4517 )
							ret := 0.221292
						if( Upper_Band > 13.4517 )
							ret := -0.083721
				if( Lower_Band > 12.5412 )
					if( Lower_Band <= 20.427 )
						if( basis <= 19.5549 )
							ret := -0.067559
						if( basis > 19.5549 )
							ret := -0.352250
					if( Lower_Band > 20.427 )
						if( Lower_Band <= 21.3072 )
							ret := 0.684848
						if( Lower_Band > 21.3072 )
							ret := -0.004542
			if( bullPower > 0.612544 )
				if( Upper_Band <= 30.3501 )
					if( Lower_Band <= 19.2822 )
						if( basis <= 17.4351 )
							ret := 0.277108
						if( basis > 17.4351 )
							ret := -0.412281
					if( Lower_Band > 19.2822 )
						if( bullPower <= 1.35064 )
							ret := 0.629808
						if( bullPower > 1.35064 )
							ret := -0.452055
				if( Upper_Band > 30.3501 )
...
float op_operation = decision_tree_0_LYFT_30Min_fab55e08(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
