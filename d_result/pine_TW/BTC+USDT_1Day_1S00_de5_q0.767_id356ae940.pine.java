			...
			if( k > 50.0113 )
				...
				if( smoothK_k > 71.6999 )
					...
					if( d_k > 13.1106 )
						ret := -0.166667
	if( rsi1 > 79.1489 )
		if( smoothD_d <= 92.9094 )
			if( smoothK_k <= 77.7677 )
				if( rsi1 <= 81.3232 )
					if( d_k <= 12.3081 )
						ret := 0.428571
					if( d_k > 12.3081 )
...
float op_operation = decision_tree_0_BTCUSDT_1Day_356ae940(rsi1, smoothK_k, d_k, k, d, smoothD_d)
