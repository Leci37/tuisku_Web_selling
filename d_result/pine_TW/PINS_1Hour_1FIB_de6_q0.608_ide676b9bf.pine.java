...
decision_tree_0_PINS_1Hour_e676b9bf(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( lower_2 > 69.171 )
		...
		if( lower_6 > 64.7001 )
			if( upper_1 <= 85.5184 )
				if( basis_max <= -11.4596 )
					ret := -0.925926 // sell
				if( basis_max > -11.4596 )
					if( basis_minus <= 10.6818 )
						ret := -0.622159
					if( basis_minus > 10.6818 )
						ret := 0.333333
			if( upper_1 > 85.5184 )
				if( basis_max <= -9.32047 )
					if( upper_4 <= 89.408 )
						ret := 0.740000 // buy
					if( upper_4 > 89.408 )
						ret := -0.400000
...
float op_operation = decision_tree_0_PINS_1Hour_e676b9bf(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
