			...
			if( d_k <= 12.109 )
				if( bbm <= 0.524402 )
					...
					if( d_k > 5.7456 )
						ret := -0.777778 // sell
				if( bbm > 0.524402 )
					if( bullPower <= 1.03342 )
						ret := -0.846154 // sell
					if( bullPower > 1.03342 )
						ret := 0.000000
			if( d_k > 12.109 )
				if( smoothD_d <= 39.5589 )
					if( smoothD_d <= 20.7389 )
						ret := 0.142857
					if( smoothD_d > 20.7389 )
						ret := 0.833333 // buy
				if( smoothD_d > 39.5589 )
					if( smoothD_d <= 44.4623 )
						ret := -0.916667 // sell
					if( smoothD_d > 44.4623 )
						ret := 0.000000
		if( smoothK_k > 22.32 )
			if( bullPower <= 1.88275 )
				if( bearPower <= -0.336133 )
					if( smoothK_k <= 81.8932 )
						ret := -0.044304
					if( smoothK_k > 81.8932 )
						ret := 0.698413
				if( bearPower > -0.336133 )
...
float op_operation = decision_tree_0_DBX_1Day_e4cca72f(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
