				...
				if( BBlower > 31.1164 )
					...
					if( BBlower > 33.9802 )
						...
						if( vrsi > 36.9779 )
							ret := 0.148330
			if( vrsi > 43.9762 )
				if( dif_source_BBlower <= 16.9055 )
					if( BBupper <= 70.7796 )
						ret := -0.056067
					if( BBupper > 70.7796 )
						if( dif_source_BBlower <= 7.05021 )
							ret := -0.270588
						if( dif_source_BBlower > 7.05021 )
							ret := 0.107477
				if( dif_source_BBlower > 16.9055 )
					if( dif_source_BBupper <= -1.54726 )
						ret := -0.004854
					if( dif_source_BBupper > -1.54726 )
						if( BBupper <= 86.8084 )
							ret := 0.009901
...
float op_operation = decision_tree_0_GTLB_15Min_11b929f8(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
