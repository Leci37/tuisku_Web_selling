...
decision_tree_0_DOCN_30Min_6c06f742(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bbp > -0.921494 )
		...
		if( bearPower > 0.472997 )
			if( bbp <= 1.41534 )
				if( bullPower <= 0.846898 )
					if( bearPower <= 0.602285 )
						if( bbm <= 0.290222 )
							ret := -0.209026
						if( bbm > 0.290222 )
							ret := -0.680851
...
float op_operation = decision_tree_0_DOCN_30Min_6c06f742(bearPower, bbm, bbp, bullPower, BBPower_Color)
