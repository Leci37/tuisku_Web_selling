			...
			if( Positive_Money_Flow_Sum <= 5.09674e+09 )
				if( Positive_Money_Flow <= 4.4773e+08 )
					...
					if( Positive_Money_Flow > 3.70972e+08 )
						ret := 0.736842 // buy
				if( Positive_Money_Flow > 4.4773e+08 )
					if( Positive_Money_Flow_Sum <= 3.95374e+09 )
						ret := 0.400000
					if( Positive_Money_Flow_Sum > 3.95374e+09 )
						ret := -0.631579
			if( Positive_Money_Flow_Sum > 5.09674e+09 )
				if( MFI_High <= -18.6741 )
					ret := 1.000000 // buy
				if( MFI_High > -18.6741 )
					if( Positive_Money_Flow <= 3.26141e+08 )
						ret := 0.785714 // buy
					if( Positive_Money_Flow > 3.26141e+08 )
						ret := 0.000000
		if( Short_MA > 98.0705 )
			if( Short_Long_Diff <= -12.5937 )
				ret := 1.000000 // buy
			if( Short_Long_Diff > -12.5937 )
				if( Typical_Price <= 124.076 )
					if( MA_Cross <= 10.2733 )
						ret := -0.657718
					if( MA_Cross > 10.2733 )
						ret := 0.461538
				if( Typical_Price > 124.076 )
					if( Negative_Money_Flow_Sum <= 3.4576e+09 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 3.4576e+09 )
						ret := -0.535088
...
float op_operation = decision_tree_0_DDOG_1Day_e89ffc55(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
