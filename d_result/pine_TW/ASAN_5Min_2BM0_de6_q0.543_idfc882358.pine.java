...
decision_tree_0_ASAN_5Min_fc882358(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)=>
	...
	if( bullPower > 0.035655 )
		if( bbm <= 0.018744 )
			if( bullPower <= 0.153122 )
				if( Negative_Money_Flow_Sum <= 8.35658e+06 )
					if( Typical_Price <= 22.9612 )
						if( Money_Flow_Ratio <= 0.712756 )
							ret := -0.524085
						if( Money_Flow_Ratio > 0.712756 )
							ret := -0.216036
					if( Typical_Price > 22.9612 )
			...
			if( bullPower > 0.153122 )
				ret := -0.597956
		if( bbm > 0.018744 )
			if( Negative_Money_Flow_Sum <= 8.35573e+06 )
				if( Negative_Money_Flow_Sum <= 3.2232e+06 )
					if( MFI_Low <= -9.51933 )
						ret := -0.788136 // sell
					if( MFI_Low > -9.51933 )
						ret := -0.046925
				if( Negative_Money_Flow_Sum > 3.2232e+06 )
					if( Positive_Money_Flow_Sum <= 1.91415e+07 )
						if( Positive_Money_Flow_Sum <= 4.74637e+06 )
							ret := -0.001082
						if( Positive_Money_Flow_Sum > 4.74637e+06 )
							ret := 0.199513
					if( Positive_Money_Flow_Sum > 1.91415e+07 )
						ret := -0.757576 // sell
			if( Negative_Money_Flow_Sum > 8.35573e+06 )
				if( Raw_Money_Flow <= 42437.4 )
					if( Positive_Money_Flow_Sum <= 1.41783e+06 )
						ret := -0.750000 // sell
					if( Positive_Money_Flow_Sum > 1.41783e+06 )
						ret := 0.583333
				if( Raw_Money_Flow > 42437.4 )
...
float op_operation = decision_tree_0_ASAN_5Min_fc882358(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
