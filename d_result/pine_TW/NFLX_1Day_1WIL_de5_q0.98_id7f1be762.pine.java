			...
			if( Color_con2 <= -5.59284 )
				...
				if( upperBand > 3.14865 )
					...
					if( upperBand > 4.91448 )
						ret := -1.000000 // sell
			if( Color_con2 > -5.59284 )
				if( Color_con2 <= -2.43757 )
					if( upperBand <= 3.61511 )
						ret := 0.000000
					if( upperBand > 3.61511 )
						ret := -0.776119 // sell
				if( Color_con2 > -2.43757 )
					if( lowerBand <= 0.395898 )
						ret := 0.214286
					if( lowerBand > 0.395898 )
						ret := -0.750000 // sell
		if( midLine > 2.17906 )
...
float op_operation = decision_tree_0_NFLX_1Day_7f1be762(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
