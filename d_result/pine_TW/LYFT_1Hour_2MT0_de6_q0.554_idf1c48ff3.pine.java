...
decision_tree_0_LYFT_1Hour_f1c48ff3(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( tema > 10.2468 )
		if( ema3 <= 72.0256 )
			if( Positive_Money_Flow_Sum <= 6.3308e+08 )
				if( ema13 <= 2.27848 )
					if( ema13 <= 0.751962 )
						if( ema2 <= 14.5388 )
							ret := 0.031473
				...
				if( ema13 > 2.27848 )
					ret := -0.854839 // sell
			if( Positive_Money_Flow_Sum > 6.3308e+08 )
				if( Positive_Money_Flow_Sum <= 8.15438e+08 )
					if( Raw_Money_Flow <= 4.17234e+07 )
						ret := 0.872727 // buy
					if( Raw_Money_Flow > 4.17234e+07 )
						if( tema <= 54.8322 )
							ret := 0.512821
				...
				if( Positive_Money_Flow_Sum > 8.15438e+08 )
					if( MFI <= 81.887 )
						if( Negative_Money_Flow <= 3092.8 )
							ret := -0.088235
						if( Negative_Money_Flow > 3092.8 )
							ret := 0.820000 // buy
					if( MFI > 81.887 )
						if( Positive_Money_Flow_Sum <= 1.57596e+09 )
							ret := -0.376238
						if( Positive_Money_Flow_Sum > 1.57596e+09 )
							ret := 0.652174
		if( ema3 > 72.0256 )
...
float op_operation = decision_tree_0_LYFT_1Hour_f1c48ff3(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
