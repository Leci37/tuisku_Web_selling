			...
			if( MFI_Low > 9.77955 )
				if( Short_Long_Diff <= 0.001935 )
					...
					if( Raw_Money_Flow > 1.09286e+08 )
						ret := -0.676471
				if( Short_Long_Diff > 0.001935 )
					if( Short_Long_Diff <= 0.004176 )
						ret := 0.818182 // buy
					if( Short_Long_Diff > 0.004176 )
						ret := -0.363636
		if( MFI_High > -29.7194 )
			if( Short_Long_Diff <= 0.001663 )
				if( Negative_Money_Flow_Sum <= 2.93634e+08 )
					if( Raw_Money_Flow <= 2.22361e+07 )
						ret := 0.298387
					if( Raw_Money_Flow > 2.22361e+07 )
						ret := -0.090426
				if( Negative_Money_Flow_Sum > 2.93634e+08 )
					if( Typical_Price <= 0.113787 )
						ret := 0.589623
					if( Typical_Price > 0.113787 )
						ret := -0.900000 // sell
			if( Short_Long_Diff > 0.001663 )
				if( Negative_Money_Flow_Sum <= 3.23323e+07 )
					if( Long_MA <= 0.014815 )
						ret := 0.000000
					if( Long_MA > 0.014815 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 3.23323e+07 )
					if( Typical_Price <= 0.022068 )
						ret := 0.704545 // buy
					if( Typical_Price > 0.022068 )
						ret := -0.117302
...
float op_operation = decision_tree_0_TRXUSDT_1Day_57f7acc3(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
