	...
	if( Upper_Band > 41.0546 )
		if( bbp <= 0.37333 )
			...
			if( basis > 95.3203 )
				...
				if( Lower_Band > 95.5967 )
					if( basis <= 116.227 )
						if( bearPower <= -0.206409 )
							ret := -0.328358
						if( bearPower > -0.206409 )
							ret := 0.739130 // buy
					if( basis > 116.227 )
						if( Upper_Band <= 132.336 )
							ret := 0.608333
						if( Upper_Band > 132.336 )
							ret := -0.333333
		if( bbp > 0.37333 )
...
float op_operation = decision_tree_0_RBLX_1Hour_53afa0bd(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
