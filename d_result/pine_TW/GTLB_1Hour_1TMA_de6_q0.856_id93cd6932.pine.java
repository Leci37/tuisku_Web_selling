...
// ID_model: GTLB_1Hour_1TMA_93cd6932 Date Creation: 2024/10/18 Recommended expiry date : 2025/06/18
//@version=5
strategy("Tuisku_GTLB_1Hour_1TMA_93cd6932", overlay=true, margin_long=1000, margin_short=1000, pyramiding=1)
//RANDOM FOREST AI 
decision_tree_0_GTLB_1Hour_93cd6932(bullishEngulfingInt, smma4, bullSigInt, smma2, ema2, bearSigInt, bearishEngulfingInt, smma3, smma1)=>
	var float ret = 0  // # DecisionTreeRegressor(max_depth=6, max_features=0.82, max_leaf_nodes=30,min_samples_split=5, random_state=843828734)
	if( smma2 <= 45.352 )
		if( smma3 <= 45.1686 )
			if( smma4 <= 44.971 )
				if( smma2 <= 40.6644 )
...
float op_operation = decision_tree_0_GTLB_1Hour_93cd6932(bullishEngulfingInt, smma4, bullSigInt, smma2, ema2, bearSigInt, bearishEngulfingInt, smma3, smma1)
