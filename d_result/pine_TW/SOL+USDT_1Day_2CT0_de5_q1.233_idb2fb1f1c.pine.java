			...
			if( ema13 > 3.00063 )
				...
				if( ad_mf > 8.16254e+06 )
					...
					if( tema > 56.5575 )
						ret := -0.857143 // sell
		if( ema3 > 93.2453 )
			if( ad_mf <= -3.52144e+06 )
				if( ad_mf <= -4.22236e+06 )
					ret := 0.000000
				if( ad_mf > -4.22236e+06 )
					if( ema12 <= 9.07158 )
						ret := 0.888889 // buy
...
float op_operation = decision_tree_0_SOLUSDT_1Day_b2fb1f1c(mf, ad, ad_mf, ema1, tema, ema12, ema2, ema3, ema13)
