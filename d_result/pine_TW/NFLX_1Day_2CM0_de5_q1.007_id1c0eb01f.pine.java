			...
			if( Negative_Money_Flow_Sum <= 1.93079e+10 )
				...
				if( Raw_Money_Flow > 3.56274e+09 )
					...
					if( Positive_Money_Flow > 4.12293e+09 )
						ret := -0.395349
			if( Negative_Money_Flow_Sum > 1.93079e+10 )
				if( Positive_Money_Flow_Sum <= 2.21621e+10 )
					if( Money_Flow_Ratio <= 0.539148 )
						ret := -0.133333
					if( Money_Flow_Ratio > 0.539148 )
						ret := 0.729730 // buy
				if( Positive_Money_Flow_Sum > 2.21621e+10 )
					...
					if( MFI_High > -33.1957 )
						ret := -0.152174
		if( ad > 2.88804e+06 )
			if( Negative_Money_Flow_Sum <= 1.98126e+10 )
				if( MFI_Low <= 60.501 )
					if( Typical_Price <= 353.985 )
						ret := 0.702703 // buy
					if( Typical_Price > 353.985 )
						ret := 0.121951
				if( MFI_Low > 60.501 )
					if( Positive_Money_Flow_Sum <= 3.80537e+10 )
						ret := 0.166667
					if( Positive_Money_Flow_Sum > 3.80537e+10 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 1.98126e+10 )
				if( Typical_Price <= 313.297 )
					if( Money_Flow_Ratio <= 1.03021 )
						ret := 0.578947
					if( Money_Flow_Ratio > 1.03021 )
						ret := -0.416667
				if( Typical_Price > 313.297 )
					if( Money_Flow_Ratio <= 0.338582 )
						ret := 0.454545
					if( Money_Flow_Ratio > 0.338582 )
						ret := -0.650794
...
float op_operation = decision_tree_0_NFLX_1Day_1c0eb01f(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
