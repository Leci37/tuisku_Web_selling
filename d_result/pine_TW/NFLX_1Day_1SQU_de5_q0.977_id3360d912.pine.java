			...
			if( val > -1.13786 )
				...
				if( avgHighLow > 360.923 )
					...
					if( dev > 29.9307 )
						ret := 0.309091
		if( upperBB > 433.117 )
			if( priceRange <= 23.9137 )
				if( avgHighLow <= 520.033 )
					if( val <= 2.34483 )
						ret := 0.394521
					if( val > 2.34483 )
						ret := -0.642857
...
float op_operation = decision_tree_0_NFLX_1Day_3360d912(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
