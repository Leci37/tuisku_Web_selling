		...
		if( Positive_Money_Flow <= 1.57374e+09 )
			if( Positive_Money_Flow_Sum <= 1.2076e+09 )
				...
				if( Positive_Money_Flow_Sum > 9.93869e+08 )
					ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 1.2076e+09 )
				if( Raw_Money_Flow <= 1.40264e+08 )
					ret := 0.333333
				if( Raw_Money_Flow > 1.40264e+08 )
					if( Typical_Price <= 39.4337 )
						ret := -0.600000
					if( Typical_Price > 39.4337 )
						ret := -0.100000
		if( Positive_Money_Flow > 1.57374e+09 )
...
float op_operation = decision_tree_0_PTON_1Day_30444d5f(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
