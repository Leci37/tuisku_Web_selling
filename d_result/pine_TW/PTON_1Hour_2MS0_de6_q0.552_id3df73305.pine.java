...
decision_tree_0_PTON_1Hour_3df73305(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( k > 42.0709 )
				...
				if( Positive_Money_Flow_Sum <= 1.65698e+09 )
					if( Negative_Money_Flow <= 739083 )
						...
						if( Positive_Money_Flow > 3.0693e+07 )
							ret := -0.102612
					if( Negative_Money_Flow > 739083 )
						if( Negative_Money_Flow <= 4.85129e+07 )
							ret := -0.128533
						if( Negative_Money_Flow > 4.85129e+07 )
							ret := 0.197397
				if( Positive_Money_Flow_Sum > 1.65698e+09 )
		...
		if( MFI_Low > 41.6146 )
			if( d_k <= -20.7566 )
				if( Positive_Money_Flow <= 2.37729e+07 )
					if( Positive_Money_Flow_Sum <= 7.26418e+07 )
						ret := -0.246575
					if( Positive_Money_Flow_Sum > 7.26418e+07 )
						ret := 0.400000
				if( Positive_Money_Flow > 2.37729e+07 )
					ret := 0.533742
			if( d_k > -20.7566 )
				if( Positive_Money_Flow_Sum <= 4.0015e+08 )
					if( Positive_Money_Flow_Sum <= 1.96184e+08 )
						if( d_k <= -3.85091 )
							ret := -0.185641
						if( d_k > -3.85091 )
							ret := 0.068327
					if( Positive_Money_Flow_Sum > 1.96184e+08 )
						if( smoothK_k <= 90.6195 )
							ret := 0.145422
						if( smoothK_k > 90.6195 )
							ret := 0.542169
				if( Positive_Money_Flow_Sum > 4.0015e+08 )
					if( Typical_Price <= 76.87 )
						if( Typical_Price <= 27.308 )
							ret := 0.275000
						if( Typical_Price > 27.308 )
							ret := -0.442857
					if( Typical_Price > 76.87 )
...
float op_operation = decision_tree_0_PTON_1Hour_3df73305(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
