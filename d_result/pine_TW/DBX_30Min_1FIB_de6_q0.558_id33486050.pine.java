				...
				if( lower_5 <= 27.3515 )
					...
					if( basis > 37.6384 )
						...
						if( lower_3 > 30.8914 )
							ret := -0.500000
				if( lower_5 > 27.3515 )
					if( basis_minus <= 2.28923 )
						ret := -0.692308
					if( basis_minus > 2.28923 )
						if( basis_minus <= 2.39868 )
							ret := 0.657534
						if( basis_minus > 2.39868 )
							ret := 0.245763
			if( lower_3 > 31.1904 )
...
float op_operation = decision_tree_0_DBX_30Min_33486050(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
