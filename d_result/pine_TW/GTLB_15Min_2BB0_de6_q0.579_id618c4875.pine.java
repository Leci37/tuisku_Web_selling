...
decision_tree_0_GTLB_15Min_618c4875(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
			...
			if( bbm > 0.410622 )
				if( bbm <= 1.1056 )
					if( Upper_Band <= 123.883 )
						ret := -0.129913
					if( Upper_Band > 123.883 )
						if( Upper_Band <= 132.636 )
							ret := -0.652174
						if( Upper_Band > 132.636 )
							ret := 0.500000
				if( bbm > 1.1056 )
					if( bbp <= -0.549017 )
						if( Lower_Band <= 54.8529 )
							ret := -0.456000
						if( Lower_Band > 54.8529 )
							ret := 0.035218
					if( bbp > -0.549017 )
	...
	if( bbp > 0.560646 )
		if( bbm <= 0.002603 )
			if( bearPower <= 0.922874 )
				ret := -0.282655
			if( bearPower > 0.922874 )
				ret := -0.639004
		if( bbm > 0.002603 )
			if( Upper_Band <= 126.66 )
				if( Upper_Band <= 103.84 )
					if( Lower_Band <= 47.714 )
						if( bullPower <= 1.41708 )
							ret := -0.075074
						if( bullPower > 1.41708 )
							ret := 0.181061
					if( Lower_Band > 47.714 )
...
float op_operation = decision_tree_0_GTLB_15Min_618c4875(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
