...
decision_tree_0_SNOW_1Hour_5556fa14(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)=>
	...
	if( wvf <= 15.354 )
		...
		if( Color_con2 > 0.140954 )
			...
			if( lowerBand > -2.07012 )
				if( wvf <= 10.4963 )
					if( upperBand <= 9.25584 )
						if( Color_con2 <= 2.70555 )
							ret := -0.122924
						if( Color_con2 > 2.70555 )
							ret := 0.157706
					if( upperBand > 9.25584 )
						if( lowerBand <= -1.08979 )
							ret := -0.680851
						if( lowerBand > -1.08979 )
							ret := -0.233173
				if( wvf > 10.4963 )
					if( lowerBand <= 2.41385 )
						if( sDev <= 8.65651 )
							ret := 0.628821
						if( sDev > 8.65651 )
							ret := -0.088235
					if( lowerBand > 2.41385 )
						...
						if( lowerBand > 3.9989 )
							ret := 0.396825
	if( wvf > 15.354 )
		if( upperBand <= 14.5485 )
			if( Color_con1 <= 4.19717 )
				ret := -0.777778 // sell
			if( Color_con1 > 4.19717 )
				ret := 0.400000
		if( upperBand > 14.5485 )
...
float op_operation = decision_tree_0_SNOW_1Hour_5556fa14(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
