			...
			if( BBlower <= 211.599 )
				if( BBlower <= 132.42 )
					...
					if( BBlower > 130.883 )
						ret := -0.373333
				if( BBlower > 132.42 )
					if( dif_source_BBupper <= 3.24506 )
						ret := 0.275556
					if( dif_source_BBupper > 3.24506 )
						ret := -0.171598
			if( BBlower > 211.599 )
				if( dif_source_BBupper <= -29.8274 )
					if( BBupper <= 339.521 )
						ret := -0.617117
					if( BBupper > 339.521 )
						ret := 0.033465
				if( dif_source_BBupper > -29.8274 )
					if( dif_source_BBlower <= 42.3652 )
						ret := 0.217604
					if( dif_source_BBlower > 42.3652 )
						ret := -0.012205
		if( BBlower > 539.286 )
			if( BBupper <= 722.646 )
				if( dif_source_BBlower <= 132.31 )
					if( vrsi <= 99.9743 )
						ret := 0.657407
					if( vrsi > 99.9743 )
						ret := -0.133333
...
float op_operation = decision_tree_0_NVDA_1Hour_4e89ed47(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
