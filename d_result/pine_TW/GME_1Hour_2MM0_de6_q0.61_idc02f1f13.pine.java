...
decision_tree_0_GME_1Hour_c02f1f13(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Money_Flow_Ratio > 1.36708 )
				...
				if( Negative_Money_Flow_Sum <= 6.04711e+08 )
					if( Typical_Price <= 4.09613 )
						...
						if( Positive_Money_Flow_Sum > 7.5122e+06 )
							ret := 0.438953
					if( Typical_Price > 4.09613 )
						if( Negative_Money_Flow_Sum <= 1.06366e+07 )
							ret := -0.048494
						if( Negative_Money_Flow_Sum > 1.06366e+07 )
							ret := 0.081066
				if( Negative_Money_Flow_Sum > 6.04711e+08 )
					if( Negative_Money_Flow_Sum <= 8.5347e+08 )
						if( Positive_Money_Flow <= 4.06654e+08 )
							ret := 0.708487 // buy
						if( Positive_Money_Flow > 4.06654e+08 )
							ret := -0.320000
					if( Negative_Money_Flow_Sum > 8.5347e+08 )
						if( Negative_Money_Flow_Sum <= 1.57714e+09 )
							ret := -0.108392
						if( Negative_Money_Flow_Sum > 1.57714e+09 )
							ret := 0.509901
			if( Typical_Price > 259.324 )
				if( Positive_Money_Flow_Sum <= 2.28013e+09 )
					ret := 0.944444 // buy
				if( Positive_Money_Flow_Sum > 2.28013e+09 )
					if( Long_MA <= 238.791 )
						if( Negative_Money_Flow_Sum <= 2.15799e+09 )
							ret := 0.857143 // buy
						if( Negative_Money_Flow_Sum > 2.15799e+09 )
							ret := -0.818182 // sell
					if( Long_MA > 238.791 )
		...
		if( MFI > 96.2223 )
			if( Short_MA <= 124.052 )
				if( Long_MA <= 90.5508 )
					if( Positive_Money_Flow <= 1.18803e+09 )
						if( Negative_Money_Flow_Sum <= 3.176e+06 )
							ret := -0.110236
						if( Negative_Money_Flow_Sum > 3.176e+06 )
							ret := -0.696078
					if( Positive_Money_Flow > 1.18803e+09 )
...
float op_operation = decision_tree_0_GME_1Hour_c02f1f13(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
