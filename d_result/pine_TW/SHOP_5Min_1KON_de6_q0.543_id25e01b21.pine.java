				...
				if( nvi_ema <= 0.005355 )
					...
					if( source > 46.2875 )
						...
						if( nvimin > -0.00274 )
							ret := -0.064516
				if( nvi_ema > 0.005355 )
					if( verde_mean <= -3.55043 )
						if( verde <= -10.8597 )
							ret := 0.812500 // buy
						if( verde > -10.8597 )
							ret := -0.333333
					if( verde_mean > -3.55043 )
						if( marron_mean <= 68.5897 )
							ret := 0.960526 // buy
						if( marron_mean > 68.5897 )
							ret := 0.000000
			if( source > 46.4425 )
				...
				if( xrsi > 24.3992 )
					if( media <= 24.8645 )
						...
						if( nvimin > 0.074108 )
							ret := 0.180291
					if( media > 24.8645 )
						if( azul_mean <= -82.7476 )
							ret := 0.424603
						if( azul_mean > -82.7476 )
							ret := 0.006128
		if( xrsi > 55.8482 )
			if( media_azul <= 82.0954 )
				if( xrsi <= 82.7937 )
					if( pvimax <= -0.09638 )
						if( azul_mean <= 29.8209 )
							ret := 0.610687
						if( azul_mean > 29.8209 )
							ret := -0.171429
					if( pvimax > -0.09638 )
						if( media_azul <= -24.539 )
							ret := -0.468966
						if( media_azul > -24.539 )
							ret := -0.099154
				if( xrsi > 82.7937 )
...
float op_operation = decision_tree_0_SHOP_5Min_25e01b21(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
