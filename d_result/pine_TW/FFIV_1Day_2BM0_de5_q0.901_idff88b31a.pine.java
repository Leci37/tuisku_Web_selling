			...
			if( MFI_Low <= 40.0915 )
				...
				if( MFI_High > -36.0124 )
					...
					if( Positive_Money_Flow_Sum > 9.4628e+08 )
						ret := -0.336538
			if( MFI_Low > 40.0915 )
				if( Typical_Price <= 106.022 )
					if( Positive_Money_Flow_Sum <= 1.35736e+09 )
						ret := 0.230769
					if( Positive_Money_Flow_Sum > 1.35736e+09 )
						ret := -0.928571 // sell
				if( Typical_Price > 106.022 )
					...
					if( MFI_High > -11.5116 )
						ret := 0.200000
		if( Typical_Price > 142.068 )
			if( Money_Flow_Ratio <= 1.54699 )
				if( Negative_Money_Flow_Sum <= 1.557e+09 )
					if( Positive_Money_Flow <= 1.28398e+08 )
						ret := -0.165771
					if( Positive_Money_Flow > 1.28398e+08 )
						ret := -0.616667
				if( Negative_Money_Flow_Sum > 1.557e+09 )
					if( Negative_Money_Flow <= 7.15463e+07 )
						ret := -0.052632
					if( Negative_Money_Flow > 7.15463e+07 )
						ret := 0.795455 // buy
			if( Money_Flow_Ratio > 1.54699 )
				if( Positive_Money_Flow_Sum <= 1.48767e+09 )
					if( Positive_Money_Flow <= 8.55003e+07 )
						ret := 0.460094
					if( Positive_Money_Flow > 8.55003e+07 )
						ret := 0.049383
				if( Positive_Money_Flow_Sum > 1.48767e+09 )
					if( Typical_Price <= 158.149 )
						ret := -0.837838 // sell
					if( Typical_Price > 158.149 )
						ret := -0.173913
...
float op_operation = decision_tree_0_FFIV_1Day_ff88b31a(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
