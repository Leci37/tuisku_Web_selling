			...
			if( senkou_span_b_displaced <= 383.077 )
				if( senkou_span_a <= 116.373 )
					...
					if( basis_max > 0.312779 )
						ret := 0.923077 // buy
				if( senkou_span_a > 116.373 )
					if( chinkou_span <= 145.995 )
						ret := -0.602273
					if( chinkou_span > 145.995 )
						ret := 0.160563
			if( senkou_span_b_displaced > 383.077 )
				if( basis_max <= 33.793 )
					if( chinkou_span <= 517.484 )
						ret := -0.810277 // sell
					if( chinkou_span > 517.484 )
						ret := -0.421687
				if( basis_max > 33.793 )
					if( senkou_span_b_displaced <= 932.594 )
						ret := 0.517857
					if( senkou_span_b_displaced > 932.594 )
						ret := -0.745283 // sell
		if( chinkou_span > 1208.77 )
			if( senkou_span_a_displaced <= 2926.05 )
				if( senkou_span_a_displaced <= 1635.51 )
					if( senkou_span_b_displaced <= 1178.89 )
						ret := 0.947368 // buy
					if( senkou_span_b_displaced > 1178.89 )
						ret := 0.457364
				if( senkou_span_a_displaced > 1635.51 )
					if( kinjun_sen <= 2010.39 )
						ret := -0.127389
					if( kinjun_sen > 2010.39 )
						ret := 0.448485
			if( senkou_span_a_displaced > 2926.05 )
				if( chinkou_span <= 3909.18 )
					if( kinjun_sen <= 3398.04 )
						ret := -0.229947
					if( kinjun_sen > 3398.04 )
						ret := -0.666667
				if( chinkou_span > 3909.18 )
					if( senkou_span_a_displaced <= 4080.31 )
						ret := 0.750000 // buy
					if( senkou_span_a_displaced > 4080.31 )
						ret := 0.000000
...
float op_operation = decision_tree_0_ETHUSDT_1Day_eb5ab61c(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
