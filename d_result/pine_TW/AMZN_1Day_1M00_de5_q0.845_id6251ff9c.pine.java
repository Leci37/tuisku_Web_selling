		...
		if( Typical_Price <= 3142.86 )
			if( Negative_Money_Flow_Sum <= 1.49758e+11 )
				if( Positive_Money_Flow_Sum <= 1.0747e+11 )
					if( Positive_Money_Flow_Sum <= 3.7845e+10 )
						ret := -0.742857 // sell
					if( Positive_Money_Flow_Sum > 3.7845e+10 )
						ret := -0.247253
				if( Positive_Money_Flow_Sum > 1.0747e+11 )
					if( Positive_Money_Flow <= 1.93324e+10 )
						ret := 0.611650
					if( Positive_Money_Flow > 1.93324e+10 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 1.49758e+11 )
				if( Positive_Money_Flow_Sum <= 5.35992e+10 )
					if( MFI_Low <= 0.522537 )
						ret := 0.888889 // buy
					if( MFI_Low > 0.522537 )
						ret := -0.333333
				if( Positive_Money_Flow_Sum > 5.35992e+10 )
					if( Negative_Money_Flow <= 9.90975e+09 )
						ret := 0.750000 // buy
					if( Negative_Money_Flow > 9.90975e+09 )
						ret := 1.000000 // buy
		if( Typical_Price > 3142.86 )
			if( Positive_Money_Flow_Sum <= 1.39544e+11 )
				if( MFI_Low <= 29.8358 )
					if( Positive_Money_Flow_Sum <= 1.18115e+11 )
						ret := -0.460000
					if( Positive_Money_Flow_Sum > 1.18115e+11 )
						ret := -0.954545 // sell
				if( MFI_Low > 29.8358 )
					if( Raw_Money_Flow <= 1.66315e+10 )
						ret := 0.105263
					if( Raw_Money_Flow > 1.66315e+10 )
						ret := -0.448276
			if( Positive_Money_Flow_Sum > 1.39544e+11 )
				if( Raw_Money_Flow <= 1.19618e+10 )
					ret := -0.583333
				if( Raw_Money_Flow > 1.19618e+10 )
					if( Typical_Price <= 3219.43 )
						ret := -0.800000 // sell
					if( Typical_Price > 3219.43 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_AMZN_1Day_6251ff9c(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
