	...
	if( Negative_Money_Flow_Sum > 4.41198e+10 )
			...
			if( ema3 <= 152.795 )
				if( MFI_Low <= -2.37187 )
					...
					if( MFI > 14.3178 )
						ret := 0.000000
				if( MFI_Low > -2.37187 )
					if( Negative_Money_Flow_Sum <= 1.10161e+11 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow_Sum > 1.10161e+11 )
						ret := 0.750000 // buy
			if( ema3 > 152.795 )
				if( Raw_Money_Flow <= 1.07796e+10 )
					ret := 0.000000
				if( Raw_Money_Flow > 1.07796e+10 )
					if( MFI_High <= -51.8415 )
						ret := 0.000000
		...
		if( ema13 > -10.2679 )
			if( Raw_Money_Flow <= 5.80573e+09 )
				if( ema3 <= 99.6132 )
					if( Negative_Money_Flow_Sum <= 5.55262e+10 )
						ret := -0.117647
					if( Negative_Money_Flow_Sum > 5.55262e+10 )
						ret := -0.850000 // sell
				if( ema3 > 99.6132 )
...
float op_operation = decision_tree_0_AMD_1Day_70b389b5(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
