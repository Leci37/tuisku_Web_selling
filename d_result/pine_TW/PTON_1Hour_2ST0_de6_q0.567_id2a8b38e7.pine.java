			...
			if( ema3 <= 27.2981 )
				if( ema1 <= 7.38155 )
					if( rsi1 <= 59.2132 )
						ret := 0.581081
					if( rsi1 > 59.2132 )
						if( smoothD_d <= 89.8148 )
							ret := -0.286282
						if( smoothD_d > 89.8148 )
							ret := 0.102740
				if( ema1 > 7.38155 )
					if( smoothK_k <= 5.58776 )
						ret := 0.633188
					if( smoothK_k > 5.58776 )
						if( rsi1 <= 87.2629 )
							ret := 0.166163
...
float op_operation = decision_tree_0_PTON_1Hour_2a8b38e7(d, d_k, smoothK_k, k, rsi1, smoothD_d, ema12, ema3, ema13, tema, ema1, ema2)
