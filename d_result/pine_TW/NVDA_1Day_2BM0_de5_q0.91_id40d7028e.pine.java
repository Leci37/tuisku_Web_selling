			...
			if( Typical_Price <= 170.076 )
				if( Typical_Price <= 49.3466 )
					...
					if( Typical_Price > 28.0515 )
						ret := 0.058824
				if( Typical_Price > 49.3466 )
					if( Negative_Money_Flow <= 6.52641e+09 )
						ret := 0.536913
					if( Negative_Money_Flow > 6.52641e+09 )
						ret := 0.842105 // buy
			if( Typical_Price > 170.076 )
				if( Positive_Money_Flow_Sum <= 1.89898e+11 )
					if( Negative_Money_Flow_Sum <= 5.97997e+10 )
						ret := 0.203125
					if( Negative_Money_Flow_Sum > 5.97997e+10 )
						ret := -0.245509
				if( Positive_Money_Flow_Sum > 1.89898e+11 )
					if( bullPower <= 58.0892 )
						ret := 0.786667 // buy
					if( bullPower > 58.0892 )
						ret := -0.473684
		if( Money_Flow_Ratio > 1.95516 )
			if( Negative_Money_Flow <= 6.63296e+08 )
				if( bullPower <= 45.5656 )
					if( Raw_Money_Flow <= 3.21698e+09 )
						ret := -0.049774
					if( Raw_Money_Flow > 3.21698e+09 )
						ret := 0.183099
				if( bullPower > 45.5656 )
					if( Positive_Money_Flow_Sum <= 5.15224e+11 )
						ret := -0.238095
					if( Positive_Money_Flow_Sum > 5.15224e+11 )
						ret := -1.000000 // sell
			if( Negative_Money_Flow > 6.63296e+08 )
				if( MFI <= 71.544 )
					...
					if( bbm > 15.164 )
						ret := 0.250000
				if( MFI > 71.544 )
					if( Positive_Money_Flow_Sum <= 1.75498e+10 )
						ret := -0.545455
					if( Positive_Money_Flow_Sum > 1.75498e+10 )
						ret := 0.100000
...
float op_operation = decision_tree_0_NVDA_1Day_40d7028e(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
