...
decision_tree_0_MELI_1Day_d5481ded(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema12 > -2.08717 )
		if( Negative_Money_Flow_Sum <= 3.19181e+09 )
			...
			if( ema1 > 519.274 )
				if( MFI_Low <= 44.6267 )
					if( Positive_Money_Flow_Sum <= 4.75e+09 )
						ret := 0.408163
					if( Positive_Money_Flow_Sum > 4.75e+09 )
						ret := -0.875000 // sell
				if( MFI_Low > 44.6267 )
					if( Negative_Money_Flow_Sum <= 2.35858e+09 )
						ret := 0.240816
					if( Negative_Money_Flow_Sum > 2.35858e+09 )
						ret := -0.275862
		if( Negative_Money_Flow_Sum > 3.19181e+09 )
			if( tema <= 1129.75 )
				if( MFI <= 43.2895 )
					if( Negative_Money_Flow_Sum <= 4.1053e+09 )
						ret := 0.923077 // buy
					if( Negative_Money_Flow_Sum > 4.1053e+09 )
						ret := -1.000000 // sell
				if( MFI > 43.2895 )
					if( Positive_Money_Flow_Sum <= 5.24474e+09 )
						ret := -0.813953 // sell
					if( Positive_Money_Flow_Sum > 5.24474e+09 )
						ret := -0.418919
			if( tema > 1129.75 )
				if( Positive_Money_Flow_Sum <= 3.54595e+09 )
					if( ema3 <= 1575.22 )
						ret := 0.789474 // buy
					if( ema3 > 1575.22 )
						ret := -0.230769
				if( Positive_Money_Flow_Sum > 3.54595e+09 )
					if( Positive_Money_Flow_Sum <= 5.31005e+09 )
						ret := -0.306818
					if( Positive_Money_Flow_Sum > 5.31005e+09 )
						ret := 0.017241
...
float op_operation = decision_tree_0_MELI_1Day_d5481ded(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
