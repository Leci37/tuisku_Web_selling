			...
			if( ema2 > 157.524 )
				...
				if( Positive_Money_Flow_Sum > 1.74132e+09 )
					...
					if( Money_Flow_Ratio > 3.17502 )
						ret := 0.950000 // buy
	if( Positive_Money_Flow_Sum > 2.78598e+09 )
		if( Raw_Money_Flow <= 1.14213e+09 )
			if( MFI_High <= -39.4362 )
				if( ema13 <= -7.95663 )
					if( Raw_Money_Flow <= 5.23349e+08 )
						ret := 0.285714
					if( Raw_Money_Flow > 5.23349e+08 )
						ret := -0.750000 // sell
				if( ema13 > -7.95663 )
		...
		if( Raw_Money_Flow > 1.14213e+09 )
			if( ema1 <= 162.394 )
				if( Money_Flow_Ratio <= 2.55301 )
					ret := -1.000000 // sell
				if( Money_Flow_Ratio > 2.55301 )
					ret := 0.000000
			if( ema1 > 162.394 )
				if( Typical_Price <= 291.676 )
					if( tema <= 224.599 )
						ret := 1.000000 // buy
					if( tema > 224.599 )
						ret := 0.523810
				if( Typical_Price > 291.676 )
					if( Negative_Money_Flow <= 1.45827e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow > 1.45827e+09 )
						ret := 0.000000
...
float op_operation = decision_tree_0_SPOT_1Day_19c5c6f3(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
