				...
				if( tenkan_sen <= 5.32873 )
					...
					if( chinkou_span > 5.26 )
						...
						if( basis_max > 0.017124 )
							ret := 0.319672
				if( tenkan_sen > 5.32873 )
					if( basis_max <= 0.050578 )
						ret := -0.798920 // sell
					if( basis_max > 0.050578 )
						ret := 0.158730
			if( chinkou_span > 5.283 )
				if( senkou_span_b <= 5.325 )
					if( chinkou_span <= 5.33173 )
						if( tenkan_sen <= 5.30913 )
							ret := 0.235955
						if( tenkan_sen > 5.30913 )
							ret := -0.171701
					if( chinkou_span > 5.33173 )
						if( senkou_span_a <= 5.33397 )
							ret := 0.563549
						if( senkou_span_a > 5.33397 )
							if( chinkou_span <= 5.38143 )
								ret := -0.320442
							if( chinkou_span > 5.38143 )
								ret := 0.534884
				if( senkou_span_b > 5.325 )
					if( chinkou_span <= 5.37046 )
						if( senkou_span_a_displaced <= 5.54554 )
							if( kinjun_sen <= 5.34495 )
								ret := 0.000000
							if( kinjun_sen > 5.34495 )
								ret := -0.283342
						if( senkou_span_a_displaced > 5.54554 )
							ret := -0.904459 // sell
					if( chinkou_span > 5.37046 )
						if( senkou_span_a <= 5.39362 )
							if( chinkou_span <= 5.40064 )
								ret := 0.225664
							if( chinkou_span > 5.40064 )
								ret := 0.585052
						if( senkou_span_a > 5.39362 )
							if( chinkou_span <= 5.47659 )
								ret := -0.176948
							if( chinkou_span > 5.47659 )
								ret := 0.000236
...
float op_operation = decision_tree_0_NIO_1Min_24a81245(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
