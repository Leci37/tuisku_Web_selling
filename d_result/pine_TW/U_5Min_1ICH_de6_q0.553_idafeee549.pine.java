		...
		if( senkou_span_b_displaced > 16.1697 )
			if( chinkou_span <= 16.0998 )
				...
				if( tenkan_sen > 16.3047 )
					ret := -0.819277 // sell
			if( chinkou_span > 16.0998 )
				if( chinkou_span <= 43.561 )
					if( senkou_span_a <= 43.303 )
						if( chinkou_span <= 40.8178 )
							ret := -0.006673
						if( chinkou_span > 40.8178 )
							ret := 0.180801
					if( senkou_span_a > 43.303 )
						...
						if( senkou_span_a_displaced > 43.4338 )
							ret := -0.364747
				if( chinkou_span > 43.561 )
					if( senkou_span_b <= 42.4179 )
						if( basis_minus <= 0.000324 )
							ret := 0.687500
						if( basis_minus > 0.000324 )
							ret := -0.361702
					if( senkou_span_b > 42.4179 )
						if( basis_max <= -0.058218 )
							ret := 0.016667
						if( basis_max > -0.058218 )
							ret := 0.400978
	if( senkou_span_a_displaced > 44.9727 )
		if( chinkou_span <= 44.7975 )
			ret := -0.580709
		if( chinkou_span > 44.7975 )
			if( kinjun_sen <= 48.4026 )
				if( chinkou_span <= 47.7814 )
					if( kinjun_sen <= 47.2352 )
						if( tenkan_sen <= 44.7994 )
							ret := 0.808511 // buy
						if( tenkan_sen > 44.7994 )
							ret := -0.051664
					if( kinjun_sen > 47.2352 )
...
float op_operation = decision_tree_0_U_5Min_afeee549(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
