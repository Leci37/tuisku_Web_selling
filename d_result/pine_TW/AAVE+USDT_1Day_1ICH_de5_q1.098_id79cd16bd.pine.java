			...
			if( kinjun_sen <= 147.512 )
				if( senkou_span_b <= 132.65 )
					...
					if( senkou_span_a > 123.977 )
						ret := 0.714286 // buy
				if( senkou_span_b > 132.65 )
					if( senkou_span_b <= 153.481 )
						ret := 0.937500 // buy
					if( senkou_span_b > 153.481 )
						ret := 0.529412
			if( kinjun_sen > 147.512 )
				if( basis_max <= 15.0486 )
					if( senkou_span_b <= 178.908 )
						ret := 0.571429
					if( senkou_span_b > 178.908 )
						ret := -0.786047 // sell
				if( basis_max > 15.0486 )
					if( tenkan_sen <= 153.05 )
						ret := 0.714286 // buy
					if( tenkan_sen > 153.05 )
						ret := -0.071429
		if( chinkou_span > 171.109 )
			if( kinjun_sen <= 227.134 )
				if( basis_max <= 9.35593 )
					if( chinkou_span <= 195.456 )
						ret := 0.870968 // buy
					if( chinkou_span > 195.456 )
						ret := 0.222222
				if( basis_max > 9.35593 )
					if( basis_max <= 18.9761 )
						ret := 1.000000 // buy
					if( basis_max > 18.9761 )
						ret := 0.857143 // buy
			if( kinjun_sen > 227.134 )
				if( tenkan_sen <= 391.76 )
					if( chinkou_span <= 305.726 )
						ret := -0.432099
					if( chinkou_span > 305.726 )
						ret := 0.400901
				if( tenkan_sen > 391.76 )
					if( chinkou_span <= 440.03 )
						ret := -0.500000
					if( chinkou_span > 440.03 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_79cd16bd(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
