			...
			if( Raw_Money_Flow <= 3.63506e+08 )
				...
				if( Typical_Price > 10.6567 )
					...
					if( Negative_Money_Flow_Sum > 2.63279e+09 )
						ret := -0.217391
			if( Raw_Money_Flow > 3.63506e+08 )
				if( Negative_Money_Flow_Sum <= 1.0153e+10 )
					if( Positive_Money_Flow <= 2.75529e+08 )
						ret := -0.983333 // sell
					if( Positive_Money_Flow > 2.75529e+08 )
						ret := -0.714286 // sell
				if( Negative_Money_Flow_Sum > 1.0153e+10 )
					ret := 0.285714
		if( MFI_High > -55.715 )
			if( Negative_Money_Flow_Sum <= 3.03962e+09 )
				if( Positive_Money_Flow_Sum <= 6.23442e+09 )
					if( Raw_Money_Flow <= 7.30643e+08 )
						ret := -0.255670
					if( Raw_Money_Flow > 7.30643e+08 )
						ret := 0.384615
				if( Positive_Money_Flow_Sum > 6.23442e+09 )
					if( Raw_Money_Flow <= 1.07761e+09 )
						ret := -0.784615 // sell
					if( Raw_Money_Flow > 1.07761e+09 )
						ret := -0.142857
			if( Negative_Money_Flow_Sum > 3.03962e+09 )
				if( mf <= -0.04948 )
					if( Positive_Money_Flow_Sum <= 5.648e+09 )
						ret := 0.448276
					if( Positive_Money_Flow_Sum > 5.648e+09 )
						ret := -0.044444
				if( mf > -0.04948 )
					if( Typical_Price <= 9.91222 )
						ret := 0.852941 // buy
					if( Typical_Price > 9.91222 )
						ret := -0.082474
...
float op_operation = decision_tree_0_SNAP_1Day_dd05367a(mf, ad, ad_mf, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
