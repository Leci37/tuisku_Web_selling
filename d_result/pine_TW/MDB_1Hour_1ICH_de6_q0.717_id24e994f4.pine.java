		...
		if( chinkou_span > 284.267 )
			...
			if( basis_minus > 12.8783 )
				...
				if( kinjun_sen > 337.607 )
					ret := 0.691358
	if( senkou_span_b > 341.902 )
		if( chinkou_span <= 333.972 )
			if( senkou_span_a <= 308.849 )
				ret := 1.000000 // buy
			if( senkou_span_a > 308.849 )
				ret := -0.678125
		if( chinkou_span > 333.972 )
			if( chinkou_span <= 548.255 )
				if( senkou_span_b_displaced <= 409.028 )
					if( chinkou_span <= 359.885 )
						if( senkou_span_a <= 375.423 )
							ret := -0.170481
						if( senkou_span_a > 375.423 )
							ret := -0.697917
					if( chinkou_span > 359.885 )
						if( senkou_span_a <= 366.403 )
							ret := 0.411765
						if( senkou_span_a > 366.403 )
							ret := 0.056344
				if( senkou_span_b_displaced > 409.028 )
					if( senkou_span_a_displaced <= 508.765 )
						if( basis_max <= -0.002549 )
							ret := -0.313603
						if( basis_max > -0.002549 )
							ret := -0.044813
					if( senkou_span_a_displaced > 508.765 )
...
float op_operation = decision_tree_0_MDB_1Hour_24e994f4(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
