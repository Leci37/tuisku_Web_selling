			...
			if( ema12 <= -0.02177 )
				if( tema <= 0.354868 )
					...
					if( tema > 0.314931 )
						ret := 0.500000
				if( tema > 0.354868 )
					if( bullPower <= -0.004727 )
						ret := -0.666667
					if( bullPower > -0.004727 )
						ret := 1.000000 // buy
			if( ema12 > -0.02177 )
				if( bbm <= 0.116027 )
					if( bearPower <= -0.01417 )
						ret := -0.454545
					if( bearPower > -0.01417 )
						ret := -0.871429 // sell
				if( bbm > 0.116027 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_33763fa6(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
