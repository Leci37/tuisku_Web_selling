			...
			if( diPlus > 41.4455 )
				if( adx <= 41.8265 )
					...
					if( diMinus > 8.34717 )
						ret := 0.877551 // buy
				if( adx > 41.8265 )
					if( directionalMovementMinus <= 0.084132 )
						ret := -0.263158
					if( directionalMovementMinus > 0.084132 )
						ret := 0.680000
...
float op_operation = decision_tree_0_ETSY_1Day_fb67b72b(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
