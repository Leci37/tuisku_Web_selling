				...
				if( ema3 > 243.336 )
					if( ema1 <= 243.767 )
						...
						if( ema3 > 250.988 )
							ret := -1.000000 // sell
					if( ema1 > 243.767 )
						if( smoothD_d <= 4.24589 )
							ret := 0.389408
						if( smoothD_d > 4.24589 )
							ret := 0.063558
			if( ema3 > 279.04 )
				if( smoothD_d <= 34.9124 )
					if( ema2 <= 281.892 )
						if( ema3 <= 280.685 )
							ret := 0.019608
						if( ema3 > 280.685 )
...
float op_operation = decision_tree_0_SPOT_1Hour_2c4ab225(d_k, d, rsi1, k, smoothD_d, smoothK_k, ema1, tema, ema12, ema2, ema3, ema13)
