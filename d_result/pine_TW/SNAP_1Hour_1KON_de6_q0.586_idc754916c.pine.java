				...
				if( xrsi > 16.1944 )
					...
					if( verde_mean > -17.8619 )
						...
						if( xrsi > 24.1436 )
							ret := -0.318519
			if( xmf > 3.24338 )
				if( azul_mean <= 54.3779 )
					if( nvi <= 1.69945 )
						if( verde_mean <= 157.873 )
							ret := 0.004102
						if( verde_mean > 157.873 )
							ret := 0.305447
					if( nvi > 1.69945 )
						if( verde_azul <= 64.7169 )
							ret := -0.254468
						if( verde_azul > 64.7169 )
							ret := 0.086280
				if( azul_mean > 54.3779 )
...
float op_operation = decision_tree_0_SNAP_1Hour_c754916c(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
