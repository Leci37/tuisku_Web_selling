				...
				if( tprice <= 9.84364 )
					if( oscp <= -0.560898 )
						...
						if( stoc > 60.8752 )
							ret := -0.769231 // sell
					if( oscp > -0.560898 )
						if( azul_mean <= 11.7828 )
							ret := 0.718750 // buy
						if( azul_mean > 11.7828 )
							ret := -0.071429
				if( tprice > 9.84364 )
					if( azul_mean <= 7.53942 )
						if( stoc <= 29.4823 )
							ret := 0.194946
						if( stoc > 29.4823 )
							ret := -0.051474
				...
				if( azul > 35.8845 )
					...
					if( tprice > 110.632 )
						...
						if( nvimax > 0.126626 )
							ret := 0.750000 // buy
			if( media_azul > 106.536 )
				if( marron_mean <= 120.809 )
					if( xmf <= 68.5647 )
						if( azul_mean <= -38.9894 )
							ret := 0.583333
						if( azul_mean > -38.9894 )
							ret := -0.538462
					if( xmf > 68.5647 )
...
float op_operation = decision_tree_0_AFRM_1Hour_93ac8633(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
