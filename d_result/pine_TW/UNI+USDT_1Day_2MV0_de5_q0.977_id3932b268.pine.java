...
decision_tree_0_UNIUSDT_1Day_3932b268(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)=>
	...
	if( Typical_Price > 6.11717 )
		...
		if( VIM > 0.76881 )
			...
			if( Positive_Money_Flow_Sum > 2.51342e+08 )
				if( VIP <= 1.092 )
					if( Typical_Price <= 25.3281 )
						ret := 0.382900
					if( Typical_Price > 25.3281 )
						ret := -0.318841
				if( VIP > 1.092 )
					if( Negative_Money_Flow_Sum <= 2.52624e+08 )
						ret := -0.063158
					if( Negative_Money_Flow_Sum > 2.52624e+08 )
						ret := -0.488889
...
float op_operation = decision_tree_0_UNIUSDT_1Day_3932b268(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
