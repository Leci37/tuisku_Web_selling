			...
			if( senkou_span_a <= 27.7013 )
				...
				if( senkou_span_a > 27.1469 )
					if( senkou_span_b_displaced <= 27.3788 )
						if( basis_max <= -0.102828 )
							ret := 0.810811 // buy
						if( basis_max > -0.102828 )
							ret := -0.175000
					if( senkou_span_b_displaced > 27.3788 )
						if( senkou_span_a_displaced <= 27.6962 )
							ret := 0.927273 // buy
						if( senkou_span_a_displaced > 27.6962 )
							ret := 0.642857
			if( senkou_span_a > 27.7013 )
				if( basis_max <= -0.08436 )
					if( basis_minus <= 0.664298 )
						if( senkou_span_b_displaced <= 28.8903 )
							ret := 0.676259
						if( senkou_span_b_displaced > 28.8903 )
							ret := -0.090909
					if( basis_minus > 0.664298 )
						ret := -1.000000 // sell
				if( basis_max > -0.08436 )
					if( senkou_span_b_displaced <= 27.664 )
						if( kinjun_sen <= 27.8188 )
							ret := 0.105263
						if( kinjun_sen > 27.8188 )
							ret := 0.900000 // buy
					if( senkou_span_b_displaced > 27.664 )
						if( senkou_span_b_displaced <= 28.4077 )
							ret := -0.262500
						if( senkou_span_b_displaced > 28.4077 )
							ret := 0.500000
	if( senkou_span_b_displaced > 29.1762 )
		if( chinkou_span <= 27.4025 )
			ret := 1.000000 // buy
		if( chinkou_span > 27.4025 )
			if( senkou_span_a_displaced <= 29.6794 )
				ret := -0.958763 // sell
			if( senkou_span_a_displaced > 29.6794 )
				if( kinjun_sen <= 29.46 )
					ret := 0.000000
...
float op_operation = decision_tree_0_ZI_5Min_0e75f723(basis_minus, senkou_span_b, cross_dn_tenkan_kinjunInt, cross_up_tenkan_kinjunInt, kinjun_sen, tenkan_sen, senkou_span_b_displaced, senkou_span_a, senkou_span_a_displaced, basis_max, chinkou_span)
