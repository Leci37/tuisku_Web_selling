				...
				if( Lower_Band <= 1004.49 )
					...
					if( basis > 733.894 )
						...
						if( basis > 750.125 )
							ret := -0.258824
				if( Lower_Band > 1004.49 )
					if( bearPower <= 5.04329 )
						if( bullPower <= 40.7565 )
							ret := -0.655172
						if( bullPower > 40.7565 )
							ret := 0.857143 // buy
					if( bearPower > 5.04329 )
						if( bullPower <= 49.6866 )
							ret := 0.722222 // buy
						if( bullPower > 49.6866 )
							ret := -1.000000 // sell
		if( bearPower > 12.5373 )
			if( Lower_Band <= 341.474 )
				ret := -0.857143 // sell
			if( Lower_Band > 341.474 )
				if( Upper_Band <= 1665.7 )
					if( Lower_Band <= 1086.44 )
						if( Upper_Band <= 1198.94 )
							ret := 0.312682
						if( Upper_Band > 1198.94 )
							ret := -0.393939
					if( Lower_Band > 1086.44 )
				...
				if( Upper_Band > 1665.7 )
					if( basis <= 1627.46 )
						if( Lower_Band <= 1532.75 )
							ret := -1.000000 // sell
						if( Lower_Band > 1532.75 )
							ret := 0.800000 // buy
					if( basis > 1627.46 )
						if( Lower_Band <= 1959.38 )
							ret := 0.637931
						if( Lower_Band > 1959.38 )
							ret := -0.261905
...
float op_operation = decision_tree_0_TSLA_1Hour_c68101c2(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
