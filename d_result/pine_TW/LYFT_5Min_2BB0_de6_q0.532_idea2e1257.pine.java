		...
		if( Upper_Band <= 10.1854 )
			if( Lower_Band <= 8.47793 )
				...
				if( Upper_Band > 8.57236 )
					ret := -0.457627
			if( Lower_Band > 8.47793 )
				if( Lower_Band <= 8.97926 )
					if( Upper_Band <= 9.06281 )
						ret := 0.129512
					if( Upper_Band > 9.06281 )
						ret := 0.786047 // buy
				if( Lower_Band > 8.97926 )
					if( Lower_Band <= 9.42083 )
					...
					if( Lower_Band > 9.42083 )
						...
						if( bbm > 0.009943 )
							ret := 0.188976
		if( Upper_Band > 10.1854 )
			if( Lower_Band <= 16.8151 )
				if( Lower_Band <= 16.3558 )
					if( basis <= 16.7112 )
						if( Upper_Band <= 16.8489 )
							ret := -0.049704
						if( Upper_Band > 16.8489 )
							ret := -0.605769
					if( basis > 16.7112 )
						ret := 0.698925
				if( Lower_Band > 16.3558 )
					if( bearPower <= 0.103177 )
						ret := 0.219239
					if( bearPower > 0.103177 )
						ret := -0.772727 // sell
			if( Lower_Band > 16.8151 )
				if( bearPower <= 0.197986 )
					ret := -0.149199
				if( bearPower > 0.197986 )
					ret := 0.731343 // buy
...
float op_operation = decision_tree_0_LYFT_5Min_ea2e1257(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
