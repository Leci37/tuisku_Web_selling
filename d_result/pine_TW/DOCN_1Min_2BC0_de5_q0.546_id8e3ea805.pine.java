		...
		if( ad_mf <= -44948.5 )
			if( bbp <= -0.039579 )
				...
				if( mf > -0.589754 )
					ret := 1.000000 // buy
			if( bbp > -0.039579 )
				if( bullPower <= 0.043123 )
					ret := 0.142857
				if( bullPower > 0.043123 )
					if( bearPower <= 0.02301 )
						ret := 0.636364
					if( bearPower > 0.02301 )
						ret := 1.000000 // buy
		if( ad_mf > -44948.5 )
...
float op_operation = decision_tree_0_DOCN_1Min_8e3ea805(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
