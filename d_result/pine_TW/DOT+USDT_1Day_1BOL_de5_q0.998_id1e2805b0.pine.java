			...
			if( BBlower > 7.07637 )
				...
				if( dif_source_BBlower > 11.9478 )
					...
					if( dif_source_BBlower > 23.2202 )
						ret := -0.090000
	if( vrsi > 88.6178 )
		if( dif_source_BBlower <= 10.6764 )
			if( dif_source_BBupper <= -30.2857 )
				ret := 1.000000 // buy
			if( dif_source_BBupper > -30.2857 )
				if( BBupper <= 8.96996 )
					if( vrsi <= 97.4708 )
...
float op_operation = decision_tree_0_DOTUSDT_1Day_1e2805b0(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
