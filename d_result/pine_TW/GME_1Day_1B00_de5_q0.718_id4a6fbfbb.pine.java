			...
			if( bbp > 0.557636 )
				...
				if( bullPower > 1.50945 )
					...
					if( bbm > 1.46248 )
						ret := 0.341463
	if( bbp > 2.09778 )
		if( bullPower <= 4.09439 )
			if( bullPower <= 2.03147 )
				if( bullPower <= 1.75493 )
					if( bearPower <= 0.858363 )
						ret := -0.538462
					if( bearPower > 0.858363 )
						ret := 0.000000
				if( bullPower > 1.75493 )
					if( bearPower <= 0.607843 )
						ret := -0.071429
					if( bearPower > 0.607843 )
						ret := 0.633333
			if( bullPower > 2.03147 )
				if( bullPower <= 2.95728 )
					if( bbp <= 2.8878 )
						ret := -0.807692 // sell
					if( bbp > 2.8878 )
						ret := -0.278689
				if( bullPower > 2.95728 )
					...
					if( bbp > 4.47128 )
						ret := -0.578947
		if( bullPower > 4.09439 )
			if( bearPower <= 24.1452 )
				if( bearPower <= 18.4165 )
					if( bbp <= 24.8801 )
						ret := 0.026178
					if( bbp > 24.8801 )
						ret := -0.500000
...
float op_operation = decision_tree_0_GME_1Day_4a6fbfbb(bearPower, bbm, bbp, bullPower, BBPower_Color)
