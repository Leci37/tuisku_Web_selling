	...
	if( Typical_Price > 0.288861 )
		if( Negative_Money_Flow_Sum <= 1.68273e+10 )
			if( Negative_Money_Flow_Sum <= 4.37834e+09 )
				if( MFI <= 31.0677 )
					if( bearPower <= -0.077672 )
						ret := 0.225352
					if( bearPower > -0.077672 )
						ret := -0.664865
				if( MFI > 31.0677 )
					if( Typical_Price <= 0.608098 )
						ret := 0.052795
					if( Typical_Price > 0.608098 )
						ret := -0.147761
			if( Negative_Money_Flow_Sum > 4.37834e+09 )
				if( bearPower <= -0.171395 )
					if( Typical_Price <= 1.00568 )
						ret := 0.750000 // buy
					if( Typical_Price > 1.00568 )
						ret := -0.840000 // sell
				if( bearPower > -0.171395 )
					if( Raw_Money_Flow <= 6.78736e+08 )
						ret := -0.571429
					if( Raw_Money_Flow > 6.78736e+08 )
						ret := -0.857143 // sell
		if( Negative_Money_Flow_Sum > 1.68273e+10 )
			if( bullPower <= -0.239753 )
				ret := 0.000000
			if( bullPower > -0.239753 )
				ret := 1.000000 // buy
...
float op_operation = decision_tree_0_XRPUSDT_1Day_f127bc26(bbp, bullPower, BBPower_Color, bearPower, bbm, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
