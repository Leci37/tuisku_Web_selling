			...
			if( upperBand <= 60.4831 )
				...
				if( wvf > 25.6119 )
					...
					if( midLine > 22.823 )
						ret := 0.975000 // buy
			if( upperBand > 60.4831 )
				if( Color_con1 <= -18.3745 )
					if( Color_con2 <= -18.7609 )
						ret := 0.482759
					if( Color_con2 > -18.7609 )
						ret := -0.636364
				if( Color_con1 > -18.3745 )
...
float op_operation = decision_tree_0_TTD_1Day_d5f30fd7(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
