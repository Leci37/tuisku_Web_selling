			...
			if( Upper_Band <= 182.561 )
				...
				if( basis > 15.2073 )
					...
					if( bbm > 1.10408 )
						ret := -0.013248
			if( Upper_Band > 182.561 )
				if( Lower_Band <= 157.378 )
					if( bullPower <= 3.04852 )
						ret := -0.375000
					if( bullPower > 3.04852 )
						ret := -0.871429 // sell
				if( Lower_Band > 157.378 )
...
float op_operation = decision_tree_0_AMD_1Day_75e85333(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
