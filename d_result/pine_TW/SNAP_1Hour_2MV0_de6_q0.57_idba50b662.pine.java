			...
			if( Negative_Money_Flow <= 1.05536e+07 )
				if( VIM <= 1.26346 )
					if( Negative_Money_Flow_Sum <= 8.06596e+08 )
						if( Positive_Money_Flow_Sum <= 1.66644e+09 )
							ret := 0.124310
						if( Positive_Money_Flow_Sum > 1.66644e+09 )
							ret := -0.463918
					if( Negative_Money_Flow_Sum > 8.06596e+08 )
						...
						if( VIP > 0.870148 )
							ret := 0.072034
				if( VIM > 1.26346 )
					if( Positive_Money_Flow_Sum <= 7.96138e+08 )
						if( Negative_Money_Flow <= 1.73048e+06 )
							ret := -0.127720
						if( Negative_Money_Flow > 1.73048e+06 )
							ret := 0.377049
					if( Positive_Money_Flow_Sum > 7.96138e+08 )
						if( Money_Flow_Ratio <= 1.32008 )
							ret := -0.978261 // sell
						if( Money_Flow_Ratio > 1.32008 )
							ret := 1.000000 // buy
			if( Negative_Money_Flow > 1.05536e+07 )
				if( Positive_Money_Flow_Sum <= 7.4192e+08 )
					if( Typical_Price <= 10.2303 )
						if( VIP_VIM <= -0.10538 )
							ret := 0.284314
						if( VIP_VIM > -0.10538 )
							ret := -0.082616
					if( Typical_Price > 10.2303 )
						...
						if( VIP_VIM > -0.810434 )
							ret := -0.054905
				if( Positive_Money_Flow_Sum > 7.4192e+08 )
					if( Positive_Money_Flow_Sum <= 4.33997e+09 )
						if( Negative_Money_Flow_Sum <= 1.0116e+09 )
							ret := 0.206897
						if( Negative_Money_Flow_Sum > 1.0116e+09 )
							ret := 0.721311 // buy
					if( Positive_Money_Flow_Sum > 4.33997e+09 )
...
float op_operation = decision_tree_0_SNAP_1Hour_ba50b662(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)
