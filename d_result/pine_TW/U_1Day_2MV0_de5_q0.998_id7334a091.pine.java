...
decision_tree_0_U_1Day_7334a091(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)=>
	...
	if( Typical_Price > 39.1535 )
		...
		if( Positive_Money_Flow_Sum > 2.36782e+09 )
			if( VIM <= 0.919683 )
				if( VIP_VIM <= 0.623142 )
					if( Negative_Money_Flow_Sum <= 3.94232e+09 )
						ret := 0.064220
					if( Negative_Money_Flow_Sum > 3.94232e+09 )
						ret := -0.846154 // sell
				if( VIP_VIM > 0.623142 )
					if( Positive_Money_Flow_Sum <= 6.67609e+09 )
						ret := -0.416667
					if( Positive_Money_Flow_Sum > 6.67609e+09 )
						ret := -0.900000 // sell
			if( VIM > 0.919683 )
				if( MFI_Low <= 3.71867 )
					if( Negative_Money_Flow_Sum <= 1.13644e+10 )
						ret := 0.750000 // buy
					if( Negative_Money_Flow_Sum > 1.13644e+10 )
						ret := -0.250000
				if( MFI_Low > 3.71867 )
					if( Negative_Money_Flow <= 4.20816e+08 )
						ret := -0.610577
					if( Negative_Money_Flow > 4.20816e+08 )
						ret := -0.160714
...
float op_operation = decision_tree_0_U_1Day_7334a091(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
