		...
		if( upperBand > 45.6725 )
			if( midLine <= 22.7254 )
				...
				if( lowerBand > -3.94238 )
					ret := 1.000000 // buy
			if( midLine > 22.7254 )
				if( Color_con2 <= -30.0893 )
					if( upperBand <= 55.8755 )
						ret := 0.260870
					if( upperBand > 55.8755 )
						ret := 0.887097 // buy
				if( Color_con2 > -30.0893 )
...
float op_operation = decision_tree_0_APPS_1Day_40d541d8(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
