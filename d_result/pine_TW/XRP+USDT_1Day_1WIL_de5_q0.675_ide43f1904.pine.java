...
decision_tree_0_XRPUSDT_1Day_e43f1904(wvf, sDev, upperBand, Color_con2, colInt, rangeHigh, Color_con1, lowerBand, midLine, rangeLow)=>
	...
	if( sDev > 12.6243 )
		...
		if( Color_con2 > 12.5829 )
			...
			if( sDev > 19.4692 )
				if( sDev <= 25.5124 )
					if( lowerBand <= 4.98234 )
						ret := 1.000000 // buy
					if( lowerBand > 4.98234 )
						ret := 0.153846
				if( sDev > 25.5124 )
					if( upperBand <= 76.6492 )
						ret := -0.105263
					if( upperBand > 76.6492 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_XRPUSDT_1Day_e43f1904(wvf, sDev, upperBand, Color_con2, colInt, rangeHigh, Color_con1, lowerBand, midLine, rangeLow)
