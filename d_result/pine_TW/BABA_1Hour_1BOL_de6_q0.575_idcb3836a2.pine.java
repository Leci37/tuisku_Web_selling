				...
				if( BBupper <= 160.678 )
					...
					if( BBlower > 129.872 )
						...
						if( BBupper > 155.388 )
							ret := 0.330986
				if( BBupper > 160.678 )
					if( dif_source_BBupper <= -44.8096 )
						if( BBupper <= 316.244 )
							ret := 0.715278 // buy
						if( BBupper > 316.244 )
							ret := -0.285714
					if( dif_source_BBupper > -44.8096 )
						if( dif_source_BBlower <= 11.7789 )
							ret := 0.039530
						if( dif_source_BBlower > 11.7789 )
							ret := -0.061750
	if( dif_source_BBlower > 49.8334 )
		if( BBupper <= 259.882 )
			if( dif_source_BBupper <= 11.4358 )
				if( BBupper <= 255.355 )
					if( BBupper <= 253.511 )
						ret := 1.000000 // buy
					if( BBupper > 253.511 )
			...
			if( dif_source_BBupper > 11.4358 )
				...
				if( vrsi > 95.4272 )
					ret := 1.000000 // buy
		if( BBupper > 259.882 )
			if( dif_source_BBupper <= 4.78922 )
				if( vrsi <= 83.8487 )
					if( BBlower <= 209.035 )
						if( dif_source_BBupper <= -4.54125 )
							ret := -0.840000 // sell
						if( dif_source_BBupper > -4.54125 )
							ret := 0.428571
					if( BBlower > 209.035 )
...
float op_operation = decision_tree_0_BABA_1Hour_cb3836a2(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
