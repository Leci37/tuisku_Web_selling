		...
		if( Raw_Money_Flow > 1.86798e+09 )
			if( ema13 <= -10.0245 )
				...
				if( ema12 > -4.87436 )
					ret := 0.857143 // buy
			if( ema13 > -10.0245 )
				if( Negative_Money_Flow_Sum <= 1.69788e+08 )
					if( ema1 <= 206.746 )
						if( ema12 <= 1.18096 )
							ret := 0.451613
						if( ema12 > 1.18096 )
							ret := -0.153846
					if( ema1 > 206.746 )
						if( Negative_Money_Flow_Sum <= 1.34026e+08 )
							ret := 0.642857
						if( Negative_Money_Flow_Sum > 1.34026e+08 )
							ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 1.69788e+08 )
					if( Positive_Money_Flow_Sum <= 1.49218e+10 )
						if( Negative_Money_Flow_Sum <= 2.33937e+10 )
							ret := -0.151962
						if( Negative_Money_Flow_Sum > 2.33937e+10 )
							ret := 0.633333
					if( Positive_Money_Flow_Sum > 1.49218e+10 )
						if( Positive_Money_Flow <= 3.57477e+09 )
							ret := -0.656934
						if( Positive_Money_Flow > 3.57477e+09 )
							ret := -0.234375
	if( Positive_Money_Flow_Sum > 1.98498e+10 )
		if( ema3 <= 150.328 )
			if( tema <= 126.478 )
				...
				if( ema13 > -0.840338 )
					ret := 0.941176 // buy
			if( tema > 126.478 )
				if( Raw_Money_Flow <= 6.17332e+08 )
					if( Negative_Money_Flow_Sum <= 5.18542e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 5.18542e+09 )
						ret := -0.777778 // sell
				if( Raw_Money_Flow > 6.17332e+08 )
					ret := -0.500000
		if( ema3 > 150.328 )
			if( Money_Flow_Ratio <= 3.17137 )
				if( ema1 <= 426.865 )
					if( ema3 <= 220.723 )
						if( Negative_Money_Flow_Sum <= 1.08696e+10 )
							ret := 1.000000 // buy
						if( Negative_Money_Flow_Sum > 1.08696e+10 )
							ret := 0.307692
					if( ema3 > 220.723 )
						if( Typical_Price <= 129.299 )
							ret := 0.888889 // buy
						if( Typical_Price > 129.299 )
							ret := 1.000000 // buy
				if( ema1 > 426.865 )
					ret := 0.333333
			if( Money_Flow_Ratio > 3.17137 )
				if( Negative_Money_Flow_Sum <= 5.34426e+09 )
					if( ema13 <= -0.726169 )
						ret := -0.777778 // sell
					if( ema13 > -0.726169 )
						if( Money_Flow_Ratio <= 33.0935 )
							ret := 0.739130 // buy
						if( Money_Flow_Ratio > 33.0935 )
							ret := 0.129032
				if( Negative_Money_Flow_Sum > 5.34426e+09 )
...
float op_operation = decision_tree_0_AAPL_1Hour_3ce8a2c7(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
