			...
			if( bbm > 1.7985 )
				...
				if( bbm > 39.2615 )
					...
					if( bbp > -70.8722 )
						ret := -1.000000 // sell
		if( bullPower > 1.81631 )
			if( bullPower <= 16.2433 )
				if( bbm <= 1.9508 )
					if( bearPower <= 0.143537 )
						ret := 1.000000 // buy
					if( bearPower > 0.143537 )
						ret := 0.063636
				if( bbm > 1.9508 )
					if( bearPower <= -8.37013 )
						ret := -0.662791
					if( bearPower > -8.37013 )
						ret := -0.259375
			if( bullPower > 16.2433 )
...
float op_operation = decision_tree_0_TTD_1Day_dfafa03a(bbp, bullPower, BBPower_Color, bearPower, bbm)
