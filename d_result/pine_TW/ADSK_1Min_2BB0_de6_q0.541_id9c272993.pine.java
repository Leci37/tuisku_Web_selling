				...
				if( basis > 214.268 )
					...
					if( Lower_Band > 244.33 )
						...
						if( Upper_Band > 255.838 )
							ret := 0.204900
	if( bullPower > -0.510967 )
		if( bullPower <= 0.237043 )
			if( basis <= 271.69 )
				if( bearPower <= 0.016832 )
					if( Lower_Band <= 257.109 )
						if( Upper_Band <= 257.915 )
							ret := 0.026223
						if( Upper_Band > 257.915 )
							ret := 0.686916
					if( Lower_Band > 257.109 )
						if( Lower_Band <= 265.332 )
							ret := -0.150618
						if( Lower_Band > 265.332 )
							ret := -0.014804
				if( bearPower > 0.016832 )
					if( basis <= 209.878 )
						if( Lower_Band <= 200.249 )
							ret := -0.048951
						if( Lower_Band > 200.249 )
							ret := 0.449102
					if( basis > 209.878 )
						if( Lower_Band <= 216.382 )
							ret := -0.129751
						if( Lower_Band > 216.382 )
							ret := -0.007474
			if( basis > 271.69 )
				if( bullPower <= -0.212635 )
					if( basis <= 276.759 )
						if( Lower_Band <= 270.9 )
							ret := -0.888889 // sell
						if( Lower_Band > 270.9 )
					...
					if( basis > 276.759 )
						...
						if( basis > 282.605 )
							ret := 0.628571
				if( bullPower > -0.212635 )
					if( Upper_Band <= 272.536 )
						if( Lower_Band <= 271.287 )
							ret := -0.714286 // sell
						if( Lower_Band > 271.287 )
							ret := 0.680851
					if( Upper_Band > 272.536 )
		...
		if( bullPower > 0.237043 )
			if( basis <= 214.797 )
				if( Upper_Band <= 213.946 )
					if( Lower_Band <= 198.106 )
						if( Upper_Band <= 197.979 )
							ret := -0.103448
						if( Upper_Band > 197.979 )
							ret := 0.883721 // buy
					if( Lower_Band > 198.106 )
						...
						if( bbm > 0.683174 )
							ret := -0.750000 // sell
				if( Upper_Band > 213.946 )
					if( bearPower <= 1.27534 )
						if( Lower_Band <= 212.675 )
							ret := 0.681818
						if( Lower_Band > 212.675 )
							ret := 0.186441
					if( bearPower > 1.27534 )
			...
			if( basis > 214.797 )
				if( bbm <= 0.019904 )
					if( bearPower <= 1.05999 )
						if( bullPower <= 0.643073 )
							ret := 0.034856
						if( bullPower > 0.643073 )
							ret := 0.489510
					if( bearPower > 1.05999 )
						if( bullPower <= 2.90928 )
							ret := -0.460000
						if( bullPower > 2.90928 )
							ret := 0.466667
				if( bbm > 0.019904 )
					if( bbp <= 4.69868 )
						if( bullPower <= 1.68003 )
							ret := -0.098382
						if( bullPower > 1.68003 )
							ret := 0.306220
					if( bbp > 4.69868 )
						if( Upper_Band <= 268.833 )
							ret := -0.319149
						if( Upper_Band > 268.833 )
							ret := -1.000000 // sell
...
float op_operation = decision_tree_0_ADSK_1Min_9c272993(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
