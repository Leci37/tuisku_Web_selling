			...
			if( Typical_Price <= 38.5483 )
				...
				if( bbm > 1.925 )
					...
					if( Positive_Money_Flow > 1.07745e+07 )
						ret := -0.302326
			if( Typical_Price > 38.5483 )
				if( bullPower <= -5.26594 )
					ret := 0.571429
				if( bullPower > -5.26594 )
					if( Positive_Money_Flow <= 1.13542e+08 )
						ret := -0.865385 // sell
					if( Positive_Money_Flow > 1.13542e+08 )
						ret := 0.083333
		if( Positive_Money_Flow_Sum > 7.26815e+08 )
			if( MFI_High <= -36.1462 )
				if( bearPower <= -2.07129 )
					if( bullPower <= -4.01762 )
						ret := 0.000000
					if( bullPower > -4.01762 )
						ret := 0.676471
				if( bearPower > -2.07129 )
					ret := -0.444444
			if( MFI_High > -36.1462 )
				if( Typical_Price <= 39.2053 )
					if( Negative_Money_Flow_Sum <= 2.75849e+08 )
						ret := 0.750000 // buy
					if( Negative_Money_Flow_Sum > 2.75849e+08 )
						ret := -0.512195
				if( Typical_Price > 39.2053 )
					if( Typical_Price <= 97.1215 )
						ret := 0.118971
					if( Typical_Price > 97.1215 )
						ret := -0.548780
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_06685b34(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
