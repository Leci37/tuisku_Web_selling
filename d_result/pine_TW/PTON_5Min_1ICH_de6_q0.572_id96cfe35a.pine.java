			...
			if( senkou_span_a_displaced <= 3.32616 )
				if( senkou_span_a <= 3.08331 )
					...
					if( kinjun_sen > 3.05415 )
						ret := 0.701705 // buy
				if( senkou_span_a > 3.08331 )
					if( chinkou_span <= 3.18824 )
						if( tenkan_sen <= 3.20504 )
							ret := -0.052830
						if( tenkan_sen > 3.20504 )
							ret := -0.428030
					if( chinkou_span > 3.18824 )
						if( chinkou_span <= 3.35289 )
							ret := 0.180295
						if( chinkou_span > 3.35289 )
							ret := 0.505747
			if( senkou_span_a_displaced > 3.32616 )
				if( chinkou_span <= 3.40968 )
					if( senkou_span_b <= 3.46274 )
						if( basis_minus <= 0.001265 )
							ret := -0.050847
						if( basis_minus > 0.001265 )
							ret := -0.593909
					if( senkou_span_b > 3.46274 )
						if( senkou_span_b_displaced <= 3.39402 )
							ret := 0.500000
						if( senkou_span_b_displaced > 3.39402 )
							ret := -0.661850
				if( chinkou_span > 3.40968 )
					if( tenkan_sen <= 3.6383 )
						if( chinkou_span <= 3.61001 )
							ret := 0.049426
						if( chinkou_span > 3.61001 )
							ret := 0.418733
					if( tenkan_sen > 3.6383 )
						if( tenkan_sen <= 9.63631 )
							ret := -0.007403
						if( tenkan_sen > 9.63631 )
							ret := -0.489614
...
float op_operation = decision_tree_0_PTON_5Min_96cfe35a(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
