			...
			if( BBupper > 470.963 )
				...
				if( BBlower > 1072.38 )
					...
					if( BBupper > 1812.84 )
						ret := 0.289855
		if( BBupper > 1933.49 )
			if( dif_source_BBupper <= -464.244 )
				if( dif_source_BBlower <= 636.174 )
					if( BBlower <= 907.249 )
						ret := -0.692308
					if( BBlower > 907.249 )
						ret := -0.134615
...
float op_operation = decision_tree_0_MELI_1Day_081f0cd6(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
