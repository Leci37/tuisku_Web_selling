			...
			if( mf > -0.121302 )
				...
				if( rsi1 > 78.2232 )
					...
					if( d > 85.5204 )
						ret := 0.736842 // buy
		if( k > 95.8241 )
			if( ad_mf <= -1.36158e+06 )
				if( smoothK_k <= 96.6531 )
					if( smoothD_d <= 89.5893 )
						ret := 0.500000
					if( smoothD_d > 89.5893 )
						ret := 1.000000 // buy
				if( smoothK_k > 96.6531 )
...
float op_operation = decision_tree_0_ASAN_1Day_11b3b20f(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)
