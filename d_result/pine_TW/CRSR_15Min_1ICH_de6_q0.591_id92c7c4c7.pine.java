	...
	if( chinkou_span <= 38.663 )
		...
		if( tenkan_sen > 39.1383 )
			...
			if( senkou_span_a_displaced > 44.3009 )
				ret := 1.000000 // buy
	if( chinkou_span > 38.663 )
		if( senkou_span_b_displaced <= 42.6725 )
			if( tenkan_sen <= 38.465 )
				if( kinjun_sen <= 37.6519 )
					if( senkou_span_a <= 36.7982 )
						ret := 0.720000 // buy
					if( senkou_span_a > 36.7982 )
						if( basis_minus <= 0.451342 )
							ret := -0.509434
						if( basis_minus > 0.451342 )
							ret := 0.329787
				if( kinjun_sen > 37.6519 )
					ret := 0.716667 // buy
			if( tenkan_sen > 38.465 )
				if( chinkou_span <= 40.9304 )
					if( tenkan_sen <= 42.105 )
						if( basis_max <= -0.264136 )
							ret := -0.392405
						if( basis_max > -0.264136 )
							ret := 0.195719
					if( tenkan_sen > 42.105 )
						ret := -0.824324 // sell
				if( chinkou_span > 40.9304 )
					if( senkou_span_a_displaced <= 38.9002 )
						ret := 0.730038 // buy
					if( senkou_span_a_displaced > 38.9002 )
						if( senkou_span_a <= 43.6467 )
							ret := 0.136646
						if( senkou_span_a > 43.6467 )
							ret := 0.662983
		if( senkou_span_b_displaced > 42.6725 )
			if( chinkou_span <= 45.2928 )
				if( basis_minus <= -2.495 )
					ret := 0.737705 // buy
				if( basis_minus > -2.495 )
					ret := -0.385366
			if( chinkou_span > 45.2928 )
				if( basis_minus <= 0.157913 )
					ret := 0.807229 // buy
				if( basis_minus > 0.157913 )
					ret := 0.067164
...
float op_operation = decision_tree_0_CRSR_15Min_92c7c4c7(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
