			...
			if( bearPower > -3.63338 )
				...
				if( Upper_Band > 80.0795 )
					...
					if( BBPower_Color > 0.5 )
						ret := 0.070225
		if( basis > 100.486 )
			if( Lower_Band <= 102.246 )
				if( Upper_Band <= 110.412 )
					ret := 0.857143 // buy
				if( Upper_Band > 110.412 )
					if( bullPower <= -3.50182 )
						ret := -0.120000
					if( bullPower > -3.50182 )
						ret := -0.756757 // sell
			if( Lower_Band > 102.246 )
				if( Lower_Band <= 107.797 )
					if( bbm <= 2.86996 )
						ret := 0.137931
					if( bbm > 2.86996 )
						ret := 0.700000 // buy
...
float op_operation = decision_tree_0_DDOG_1Day_2a512fde(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
