			...
			if( d_k > -0.040977 )
				...
				if( rsi1 > 80.2799 )
					...
					if( VIM > 0.633474 )
						ret := -0.800000 // sell
		if( VIM > 0.692086 )
			if( smoothK_k <= 96.9886 )
				if( d_k <= -13.4377 )
					if( smoothD_d <= 68.2644 )
						ret := 0.000000
					if( smoothD_d > 68.2644 )
						ret := 0.840000 // buy
				if( d_k > -13.4377 )
					if( smoothK_k <= 59.0929 )
						ret := -0.375000
					if( smoothK_k > 59.0929 )
						ret := 0.310062
			if( smoothK_k > 96.9886 )
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_2b4e3d8e(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)
