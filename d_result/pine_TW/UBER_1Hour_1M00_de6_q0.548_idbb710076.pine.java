...
decision_tree_0_UBER_1Hour_bb710076(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)=>
	...
	if( Positive_Money_Flow_Sum <= 2.06257e+09 )
		...
		if( Negative_Money_Flow_Sum > 4.60121e+08 )
			if( MFI <= 69.3193 )
				if( Money_Flow_Ratio <= 1.87092 )
					if( Negative_Money_Flow_Sum <= 4.69326e+08 )
						if( Typical_Price <= 26.8043 )
							ret := 0.923077 // buy
						if( Typical_Price > 26.8043 )
							ret := -0.426415
					if( Negative_Money_Flow_Sum > 4.69326e+08 )
						if( Typical_Price <= 42.7475 )
							ret := -0.099107
						if( Typical_Price > 42.7475 )
							ret := 0.008667
				if( Money_Flow_Ratio > 1.87092 )
					if( Positive_Money_Flow_Sum <= 9.56171e+08 )
						ret := -0.750000 // sell
					if( Positive_Money_Flow_Sum > 9.56171e+08 )
						if( MFI <= 67.1636 )
							ret := 0.743590 // buy
						if( MFI > 67.1636 )
							ret := 0.232877
			if( MFI > 69.3193 )
				if( Raw_Money_Flow <= 925241 )
					if( Negative_Money_Flow <= 77820.5 )
						ret := -0.391304
					if( Negative_Money_Flow > 77820.5 )
						ret := 0.666667
				if( Raw_Money_Flow > 925241 )
					ret := -0.796053 // sell
	if( Positive_Money_Flow_Sum > 2.06257e+09 )
		if( Negative_Money_Flow_Sum <= 2.93469e+09 )
			if( Positive_Money_Flow_Sum <= 2.89367e+09 )
				ret := 0.741803 // buy
			if( Positive_Money_Flow_Sum > 2.89367e+09 )
				if( Positive_Money_Flow <= 7.3911e+07 )
					ret := 0.418605
				if( Positive_Money_Flow > 7.3911e+07 )
					ret := -0.292683
		if( Negative_Money_Flow_Sum > 2.93469e+09 )
...
float op_operation = decision_tree_0_UBER_1Hour_bb710076(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
