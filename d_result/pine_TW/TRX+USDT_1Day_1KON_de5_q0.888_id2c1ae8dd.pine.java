	...
	if( pvi_ema > 2.68324 )
		...
		if( pvimin > 2.89096 )
			if( verde <= -56.7628 )
				ret := 0.750000 // buy
			if( verde > -56.7628 )
				if( verde_mean <= 101.771 )
					if( azul_mean <= -10.2192 )
						ret := -0.228070
					if( azul_mean > -10.2192 )
						ret := -0.024845
				if( verde_mean > 101.771 )
					if( verde_media <= 7.15702 )
						ret := 0.441176
					if( verde_media > 7.15702 )
						ret := 0.029126
...
float op_operation = decision_tree_0_TRXUSDT_1Day_2c1ae8dd(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
