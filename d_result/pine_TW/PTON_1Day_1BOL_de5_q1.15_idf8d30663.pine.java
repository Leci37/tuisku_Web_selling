...
decision_tree_0_PTON_1Day_f8d30663(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( dif_source_BBupper > -28.7602 )
		...
		if( BBlower > 2.52894 )
			if( BBupper <= 17.9621 )
				if( dif_source_BBlower <= 3.39875 )
					if( BBupper <= 9.50626 )
						ret := -0.270677
					if( BBupper > 9.50626 )
						ret := 0.125954
				if( dif_source_BBlower > 3.39875 )
					if( dif_source_BBupper <= -5.3347 )
						ret := 0.500000
					if( dif_source_BBupper > -5.3347 )
						ret := -0.666667
			if( BBupper > 17.9621 )
...
float op_operation = decision_tree_0_PTON_1Day_f8d30663(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
