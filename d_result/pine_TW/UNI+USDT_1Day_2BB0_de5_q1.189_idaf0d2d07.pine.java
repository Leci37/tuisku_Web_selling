			...
			if( Upper_Band <= 20.6344 )
				if( Lower_Band <= 7.98813 )
					...
					if( basis > 8.93478 )
						ret := 0.410959
				if( Lower_Band > 7.98813 )
					if( bearPower <= -0.960877 )
						ret := -0.287356
					if( bearPower > -0.960877 )
						ret := -0.777778 // sell
			if( Upper_Band > 20.6344 )
				if( Lower_Band <= 14.8129 )
					if( bbp <= 1.45287 )
						ret := 0.500000
					if( bbp > 1.45287 )
						ret := 0.879310 // buy
...
float op_operation = decision_tree_0_UNIUSDT_1Day_af0d2d07(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
