...
decision_tree_0_UBER_1Day_8b163499(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)=>
	...
	if( Typical_Price > 30.8503 )
		if( Positive_Money_Flow <= 6.14713e+08 )
			...
			if( Negative_Money_Flow_Sum > 4.35282e+09 )
				if( VIP <= 0.726189 )
					if( Positive_Money_Flow_Sum <= 5.06566e+09 )
						ret := 0.782609 // buy
					if( Positive_Money_Flow_Sum > 5.06566e+09 )
						ret := -1.000000 // sell
				if( VIP > 0.726189 )
		...
		if( Positive_Money_Flow > 6.14713e+08 )
			if( VIM <= 1.06301 )
				if( Positive_Money_Flow_Sum <= 8.21716e+09 )
					if( VIP <= 1.17784 )
						ret := 0.563218
					if( VIP > 1.17784 )
						ret := -0.333333
			...
			if( VIM > 1.06301 )
				if( MFI <= 44.8593 )
					if( Raw_Money_Flow <= 1.62071e+09 )
						ret := -0.250000
					if( Raw_Money_Flow > 1.62071e+09 )
						ret := 0.560000
				if( MFI > 44.8593 )
					if( Typical_Price <= 33.0158 )
						ret := 0.285714
					if( Typical_Price > 33.0158 )
						ret := 0.806818 // buy
...
float op_operation = decision_tree_0_UBER_1Day_8b163499(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
