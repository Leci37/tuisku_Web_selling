...
decision_tree_0_MDB_30Min_4ac92a35(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Typical_Price <= 375.781 )
		...
		if( Typical_Price > 80.7856 )
			...
			if( Positive_Money_Flow_Sum > 4.03932e+07 )
				if( mf <= 0.030801 )
					if( ad <= -12770.2 )
						if( Positive_Money_Flow_Sum <= 3.0521e+08 )
							ret := 0.042542
						if( Positive_Money_Flow_Sum > 3.0521e+08 )
							ret := 0.721519 // buy
					if( ad > -12770.2 )
						if( Typical_Price <= 90.2078 )
							ret := -0.619048
						if( Typical_Price > 90.2078 )
							ret := -0.109069
				if( mf > 0.030801 )
					if( Negative_Money_Flow_Sum <= 1.88074e+06 )
						if( MFI <= 99.8595 )
							ret := 0.611111
						if( MFI > 99.8595 )
							ret := -0.333333
	...
	if( Typical_Price > 375.781 )
		if( MFI <= 20.3812 )
			ret := -0.243850
		if( MFI > 20.3812 )
			if( Positive_Money_Flow_Sum <= 5.42752e+08 )
				if( Positive_Money_Flow_Sum <= 5.12704e+08 )
					if( Negative_Money_Flow_Sum <= 4.09989e+07 )
						ret := -0.280654
					if( Negative_Money_Flow_Sum > 4.09989e+07 )
						ret := -0.053562
				if( Positive_Money_Flow_Sum > 5.12704e+08 )
...
float op_operation = decision_tree_0_MDB_30Min_4ac92a35(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
