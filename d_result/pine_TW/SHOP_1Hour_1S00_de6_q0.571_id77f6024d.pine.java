	...
	if( rsi1 <= 38.8688 )
		...
		if( d > 0.901148 )
			...
			if( k > 76.6984 )
				...
				if( rsi1 > 35.5107 )
					if( d_k <= -6.3467 )
						if( smoothD_d <= 75.7271 )
							ret := 0.588235
						if( smoothD_d > 75.7271 )
							ret := -0.111111
					if( d_k > -6.3467 )
						if( smoothK_k <= 78.7122 )
							ret := -0.750000 // sell
						if( smoothK_k > 78.7122 )
							ret := -0.015873
	if( rsi1 > 38.8688 )
				...
				if( rsi1 <= 74.6925 )
					if( d_k <= 15.6981 )
						...
						if( rsi1 > 68.908 )
							ret := 0.186020
					if( d_k > 15.6981 )
						if( smoothD_d <= 81.1749 )
							ret := -0.567568
						if( smoothD_d > 81.1749 )
							ret := 0.078431
				if( rsi1 > 74.6925 )
					if( rsi1 <= 86.7315 )
						if( smoothK_k <= 88.6212 )
							ret := -0.191882
						if( smoothK_k > 88.6212 )
							ret := 0.050725
					if( rsi1 > 86.7315 )
						if( smoothD_d <= 94.4096 )
							ret := 0.363388
						if( smoothD_d > 94.4096 )
							ret := -0.031008
...
float op_operation = decision_tree_0_SHOP_1Hour_77f6024d(d_k, d, rsi1, k, smoothD_d, smoothK_k)
