...
decision_tree_0_TTD_1Day_fca3a6a2(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)=>
	...
	if( tema > 51.9748 )
		if( MFI_Low <= 11.7461 )
			...
			if( Raw_Money_Flow > 1.36139e+08 )
				if( ema1 <= 81.1785 )
					if( Positive_Money_Flow_Sum <= 1.53298e+09 )
						ret := 0.578125
					if( Positive_Money_Flow_Sum > 1.53298e+09 )
						ret := -0.740741 // sell
				if( ema1 > 81.1785 )
		...
		if( MFI_Low > 11.7461 )
			if( ema12 <= -26.4132 )
				if( Positive_Money_Flow_Sum <= 5.85706e+09 )
					if( ema2 <= 810.653 )
						ret := 0.951220 // buy
					if( ema2 > 810.653 )
						ret := 0.000000
				if( Positive_Money_Flow_Sum > 5.85706e+09 )
					if( Negative_Money_Flow_Sum <= 2.1539e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 2.1539e+09 )
						ret := 0.000000
			if( ema12 > -26.4132 )
				if( Positive_Money_Flow <= 4.30749e+07 )
...
float op_operation = decision_tree_0_TTD_1Day_fca3a6a2(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
