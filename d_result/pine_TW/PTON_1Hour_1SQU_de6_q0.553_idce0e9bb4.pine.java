				...
				if( lowerKC <= 2.98427 )
					if( upperKC <= 3.10199 )
						...
						if( sqzOnInt > 0.5 )
							ret := 1.000000 // buy
					if( upperKC > 3.10199 )
						if( priceRange <= 0.0799 )
							ret := -0.238095
						if( priceRange > 0.0799 )
							ret := -0.957447 // sell
				if( lowerKC > 2.98427 )
					if( priceRange <= 0.085784 )
						if( dev <= 0.139711 )
							ret := 0.400000
						if( dev > 0.139711 )
							ret := 0.000000
...
float op_operation = decision_tree_0_PTON_1Hour_ce0e9bb4(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
