			...
			if( Negative_Money_Flow_Sum > 7.916e+08 )
				...
				if( VIM > 0.985387 )
					...
					if( VIP > 1.09105 )
						ret := 0.285714
		if( Positive_Money_Flow_Sum > 1.65838e+09 )
			if( Negative_Money_Flow_Sum <= 3.38374e+09 )
				if( Typical_Price <= 469.416 )
					if( Positive_Money_Flow_Sum <= 2.24199e+09 )
						ret := -0.234483
					if( Positive_Money_Flow_Sum > 2.24199e+09 )
						ret := -0.730496 // sell
				if( Typical_Price > 469.416 )
					if( Money_Flow_Ratio <= 1.7513 )
						ret := 0.307692
					if( Money_Flow_Ratio > 1.7513 )
						ret := 0.018182
			if( Negative_Money_Flow_Sum > 3.38374e+09 )
				if( Typical_Price <= 1395.79 )
					if( Typical_Price <= 1024.6 )
						ret := -0.725806 // sell
					if( Typical_Price > 1024.6 )
						ret := -0.416667
				if( Typical_Price > 1395.79 )
					if( Negative_Money_Flow_Sum <= 5.41254e+09 )
						ret := 0.222222
					if( Negative_Money_Flow_Sum > 5.41254e+09 )
						ret := -0.654545
...
float op_operation = decision_tree_0_MELI_1Day_e56845ae(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
