				...
				if( pvi <= -0.00653 )
					...
					if( source > 3.37274 )
						...
						if( nvi_ema > 0.327057 )
							ret := -0.265625
				if( pvi > -0.00653 )
					if( azul_mean <= 2.41335 )
						if( verde_media <= 17.8819 )
							ret := -0.064516
						if( verde_media > 17.8819 )
							ret := -0.599700
					if( azul_mean > 2.41335 )
...
float op_operation = decision_tree_0_GME_30Min_0247dcbd(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
