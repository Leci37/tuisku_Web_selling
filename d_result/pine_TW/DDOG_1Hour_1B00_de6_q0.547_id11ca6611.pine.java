				...
				if( bullPower <= 2.55725 )
					if( bbp <= -1.87769 )
						...
						if( bbp > -4.7506 )
							ret := -0.423810
					if( bbp > -1.87769 )
						if( bearPower <= -2.27098 )
							ret := 0.341040
						if( bearPower > -2.27098 )
							ret := -0.180000
				if( bullPower > 2.55725 )
					if( bearPower <= -3.70887 )
						if( bbp <= 1.20657 )
							ret := 0.288889
						if( bbp > 1.20657 )
							ret := -1.000000 // sell
					if( bearPower > -3.70887 )
						if( bullPower <= 3.47214 )
							ret := -0.561111
						if( bullPower > 3.47214 )
							ret := -0.281046
			if( bbp > 9.3677 )
				if( bbm <= 4.54511 )
					ret := 0.666667
				if( bbm > 4.54511 )
					if( bullPower <= 8.94568 )
						ret := 0.928571 // buy
					if( bullPower > 8.94568 )
						if( bullPower <= 11.2844 )
							ret := -0.892857 // sell
						if( bullPower > 11.2844 )
							ret := 0.666667
...
float op_operation = decision_tree_0_DDOG_1Hour_11ca6611(bearPower, bbm, bbp, bullPower, BBPower_Color)
