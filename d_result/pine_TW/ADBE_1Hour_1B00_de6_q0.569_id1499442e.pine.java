...
decision_tree_0_ADBE_1Hour_1499442e(bullPower, bbp, bearPower, bbm, BBPower_Color)=>
	...
	if( bearPower > -4.26706 )
		if( bbp <= 1.56371 )
				...
				if( bearPower <= -2.87345 )
					...
					if( bbm > 4.29422 )
						...
						if( bbp > -1.61003 )
							ret := 0.000000
				if( bearPower > -2.87345 )
					if( bullPower <= -2.34042 )
						if( bearPower <= -2.75428 )
							ret := -0.732143 // sell
						if( bearPower > -2.75428 )
							ret := -0.215116
					if( bullPower > -2.34042 )
			...
			if( bbm > 5.34348 )
				if( bbp <= -1.03946 )
					if( bullPower <= 2.51846 )
						if( bullPower <= 2.43836 )
							ret := -0.512605
						if( bullPower > 2.43836 )
							ret := 1.000000 // buy
					if( bullPower > 2.51846 )
						if( bearPower <= -4.03447 )
							ret := -1.000000 // sell
						if( bearPower > -4.03447 )
							ret := -0.714286 // sell
				if( bbp > -1.03946 )
					if( bbm <= 6.31078 )
						if( bearPower <= -2.42788 )
							ret := -0.420690
						if( bearPower > -2.42788 )
							ret := 0.439024
					if( bbm > 6.31078 )
						...
						if( bullPower > 3.3305 )
							ret := -0.113333
		if( bbp > 1.56371 )
			if( bearPower <= -1.60987 )
				if( bullPower <= 3.98772 )
					if( bbm <= 5.9921 )
						if( bbp <= 1.68819 )
							ret := 0.600000
						if( bbp > 1.68819 )
...
float op_operation = decision_tree_0_ADBE_1Hour_1499442e(bullPower, bbp, bearPower, bbm, BBPower_Color)
