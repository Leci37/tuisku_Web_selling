	...
	if( Lower_Band > 34.3423 )
		if( Upper_Band <= 225.348 )
			if( Lower_Band <= 167.176 )
				...
				if( Upper_Band > 145.816 )
					if( basis <= 141.356 )
						if( bearPower <= -8.04421 )
							ret := 0.185185
						if( bearPower > -8.04421 )
							ret := -0.608696
					if( basis > 141.356 )
						if( bearPower <= -2.09477 )
							ret := -0.300587
						if( bearPower > -2.09477 )
							ret := -0.044255
			if( Lower_Band > 167.176 )
				if( bbp <= -10.0179 )
					if( Upper_Band <= 199.705 )
						ret := -0.666667
					if( Upper_Band > 199.705 )
						if( Upper_Band <= 218.914 )
							ret := 0.872340 // buy
						if( Upper_Band > 218.914 )
							ret := 0.277778
				if( bbp > -10.0179 )
					if( bullPower <= 9.98419 )
						if( Lower_Band <= 171.698 )
							ret := 0.320000
						if( Lower_Band > 171.698 )
							ret := 0.071766
					if( bullPower > 9.98419 )
		...
		if( Upper_Band > 225.348 )
			if( basis <= 292.412 )
				if( basis <= 280.437 )
					if( Lower_Band <= 194.637 )
						if( basis <= 218.588 )
							ret := -0.968750 // sell
						if( basis > 218.588 )
							ret := 0.000000
					if( Lower_Band > 194.637 )
						if( Upper_Band <= 284.791 )
							ret := -0.135246
						if( Upper_Band > 284.791 )
							ret := -0.750000 // sell
				if( basis > 280.437 )
					if( bbm <= 1.28684 )
						if( Lower_Band <= 278.313 )
							ret := 0.904762 // buy
						if( Lower_Band > 278.313 )
							ret := 0.181818
					if( bbm > 1.28684 )
						...
						if( basis > 281.002 )
							ret := -0.049180
			if( basis > 292.412 )
				if( bullPower <= -0.413344 )
					ret := -0.250000
				if( bullPower > -0.413344 )
					if( Upper_Band <= 299.806 )
						ret := 0.000000
					if( Upper_Band > 299.806 )
						if( Upper_Band <= 305.247 )
							ret := -1.000000 // sell
						if( Upper_Band > 305.247 )
							ret := -0.500000
...
float op_operation = decision_tree_0_ETSY_1Hour_0f25f8e4(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
