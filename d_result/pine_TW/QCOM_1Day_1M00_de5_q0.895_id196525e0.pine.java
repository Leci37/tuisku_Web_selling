		...
		if( Negative_Money_Flow_Sum <= 7.38159e+09 )
			if( Typical_Price <= 116.164 )
				...
				if( Positive_Money_Flow_Sum > 4.11901e+10 )
					ret := -1.000000 // sell
			if( Typical_Price > 116.164 )
				if( Typical_Price <= 173.989 )
					if( Positive_Money_Flow_Sum <= 2.34024e+10 )
						ret := -0.434783
					if( Positive_Money_Flow_Sum > 2.34024e+10 )
						ret := 0.600000
				if( Typical_Price > 173.989 )
					if( Raw_Money_Flow <= 1.96383e+09 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 1.96383e+09 )
						ret := 0.000000
		if( Negative_Money_Flow_Sum > 7.38159e+09 )
			if( Raw_Money_Flow <= 1.36212e+09 )
				if( Negative_Money_Flow <= 9.92046e+08 )
					if( Typical_Price <= 146.542 )
						ret := 0.866667 // buy
					if( Typical_Price > 146.542 )
						ret := 0.125000
				if( Negative_Money_Flow > 9.92046e+08 )
					if( Typical_Price <= 148.934 )
						ret := -0.828571 // sell
					if( Typical_Price > 148.934 )
						ret := 0.300000
			if( Raw_Money_Flow > 1.36212e+09 )
				if( Typical_Price <= 182.302 )
					if( Negative_Money_Flow <= 2.52649e+09 )
						ret := -0.832487 // sell
					if( Negative_Money_Flow > 2.52649e+09 )
						ret := -0.052632
				if( Typical_Price > 182.302 )
					if( Negative_Money_Flow_Sum <= 1.42277e+10 )
						ret := -0.604651
					if( Negative_Money_Flow_Sum > 1.42277e+10 )
						ret := 0.117647
...
float op_operation = decision_tree_0_QCOM_1Day_196525e0(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
