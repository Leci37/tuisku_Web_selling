				...
				if( BBupper > 101.199 )
					...
					if( BBlower > 93.8286 )
						...
						if( vrsi > 28.8092 )
							ret := -0.107784
		if( BBupper > 123.846 )
			if( dif_source_BBupper <= -8.42876 )
				if( BBlower <= 100.097 )
					if( BBlower <= 89.4878 )
						ret := 0.674699
					if( BBlower > 89.4878 )
						if( dif_source_BBupper <= -35.865 )
							ret := 0.500000
						if( dif_source_BBupper > -35.865 )
							ret := -0.911111 // sell
				if( BBlower > 100.097 )
					if( dif_source_BBlower <= 11.4557 )
						ret := 0.723214 // buy
					if( dif_source_BBlower > 11.4557 )
						ret := 0.279570
			if( dif_source_BBupper > -8.42876 )
...
float op_operation = decision_tree_0_RIVN_30Min_638e68c9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
