				...
				if( upperKC <= 274.323 )
					...
					if( rangema > 5.26597 )
						...
						if( upperBB > 269.557 )
							ret := -0.655172
				if( upperKC > 274.323 )
					if( avgHighLow <= 287.573 )
						if( avgHighLow <= 286.502 )
							ret := 0.241241
						if( avgHighLow > 286.502 )
							ret := 0.881818 // buy
					if( avgHighLow > 287.573 )
...
float op_operation = decision_tree_0_EPAM_30Min_fb7381cb(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
