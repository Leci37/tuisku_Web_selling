...
decision_tree_0_NVDA_1Day_b3b08433(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Raw_Money_Flow > 7.5243e+09 )
		if( MFI_Low <= 13.0581 )
			if( Positive_Money_Flow_Sum <= 8.97444e+10 )
				if( Typical_Price <= 219.607 )
					if( Money_Flow_Ratio <= 0.467597 )
						ret := 0.735294 // buy
					if( Money_Flow_Ratio > 0.467597 )
						ret := -0.200000
				if( Typical_Price > 219.607 )
					if( ad_mf <= -3.18839e+07 )
						ret := 0.055556
					if( ad_mf > -3.18839e+07 )
						ret := -0.743590 // sell
			if( Positive_Money_Flow_Sum > 8.97444e+10 )
				if( Positive_Money_Flow <= 2.88421e+10 )
					if( Raw_Money_Flow <= 4.05569e+10 )
						ret := 0.782609 // buy
					if( Raw_Money_Flow > 4.05569e+10 )
						ret := 0.966667 // buy
				if( Positive_Money_Flow > 2.88421e+10 )
					ret := 0.500000
		if( MFI_Low > 13.0581 )
			if( Typical_Price <= 382.658 )
				if( Negative_Money_Flow_Sum <= 4.19048e+10 )
					if( ad_mf <= -2.9216e+07 )
						ret := 0.833333 // buy
					if( ad_mf > -2.9216e+07 )
						ret := 0.234568
				if( Negative_Money_Flow_Sum > 4.19048e+10 )
					if( Negative_Money_Flow_Sum <= 1.00264e+11 )
						ret := -0.232614
					if( Negative_Money_Flow_Sum > 1.00264e+11 )
						ret := -0.612308
			if( Typical_Price > 382.658 )
				if( Positive_Money_Flow_Sum <= 3.86251e+11 )
					if( Positive_Money_Flow_Sum <= 2.34338e+11 )
						ret := -0.042471
					if( Positive_Money_Flow_Sum > 2.34338e+11 )
						ret := 0.587629
				if( Positive_Money_Flow_Sum > 3.86251e+11 )
...
float op_operation = decision_tree_0_NVDA_1Day_b3b08433(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
