			...
			if( ad <= -869148 )
				if( ad_mf <= -3.41056e+06 )
					...
					if( bearPower > -3.27508 )
						ret := 0.000000
				if( ad_mf > -3.41056e+06 )
					if( ad_mf <= -2.95008e+06 )
						ret := 0.900000 // buy
					if( ad_mf > -2.95008e+06 )
						ret := -0.113208
			if( ad > -869148 )
				if( bullPower <= 2.22083 )
					if( ad_mf <= 404016 )
						ret := -0.543689
					if( ad_mf > 404016 )
						ret := -0.134752
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_61985d8f(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)
