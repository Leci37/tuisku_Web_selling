			...
			if( MFI <= 51.6722 )
				...
				if( MFI_Low > 11.9656 )
					...
					if( ema12 > 9.15102 )
						ret := -0.383333
			if( MFI > 51.6722 )
				if( Negative_Money_Flow_Sum <= 4.42381e+09 )
					if( MFI_Low <= 53.2018 )
						ret := 1.000000 // buy
					if( MFI_Low > 53.2018 )
						ret := 0.437500
				if( Negative_Money_Flow_Sum > 4.42381e+09 )
					if( Positive_Money_Flow_Sum <= 2.16252e+10 )
						ret := -0.298969
					if( Positive_Money_Flow_Sum > 2.16252e+10 )
						ret := 0.046070
		if( MFI_High > -2.29335 )
			if( MFI_Low <= 60.9533 )
				if( Raw_Money_Flow <= 1.45799e+09 )
					ret := -0.444444
				if( Raw_Money_Flow > 1.45799e+09 )
					if( ema3 <= 1125.28 )
						ret := -0.978723 // sell
...
float op_operation = decision_tree_0_GOOG_1Day_217c241e(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
