			...
			if( Positive_Money_Flow_Sum <= 2.74767e+08 )
				...
				if( Negative_Money_Flow_Sum > 2.21363e+08 )
					...
					if( Raw_Money_Flow > 4.35657e+07 )
						ret := -0.891304 // sell
			if( Positive_Money_Flow_Sum > 2.74767e+08 )
				if( Raw_Money_Flow <= 1.10567e+08 )
					if( ema2 <= 0.118841 )
						ret := 0.090698
					if( ema2 > 0.118841 )
						ret := -0.500000
				if( Raw_Money_Flow > 1.10567e+08 )
					if( Negative_Money_Flow_Sum <= 1.24117e+09 )
						ret := 0.203488
					if( Negative_Money_Flow_Sum > 1.24117e+09 )
						ret := 0.776119 // buy
		if( Positive_Money_Flow_Sum > 1.35408e+09 )
			if( ema1 <= 0.133 )
				if( Negative_Money_Flow_Sum <= 6.83555e+08 )
					ret := 0.647059
				if( Negative_Money_Flow_Sum > 6.83555e+08 )
					if( Raw_Money_Flow <= 2.00647e+08 )
						ret := -0.255814
					if( Raw_Money_Flow > 2.00647e+08 )
						ret := -0.849315 // sell
			if( ema1 > 0.133 )
				if( ema3 <= 0.220514 )
					if( Positive_Money_Flow <= 5.02646e+08 )
						ret := -0.147541
					if( Positive_Money_Flow > 5.02646e+08 )
						ret := 0.383929
				if( ema3 > 0.220514 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_1eef6f88(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
