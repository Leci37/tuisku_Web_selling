				...
				if( bbp <= 1.29301 )
					...
					if( ema13 > 0.593407 )
						...
						if( tema > 35.5285 )
							ret := -0.437500
				if( bbp > 1.29301 )
					if( bearPower <= 0.460694 )
						ret := -0.111111
					if( bearPower > 0.460694 )
						if( bullPower <= 0.87253 )
							ret := -0.666667
						if( bullPower > 0.87253 )
							ret := -0.955556 // sell
			if( ema2 > 35.6536 )
...
float op_operation = decision_tree_0_DDOG_30Min_17985370(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
