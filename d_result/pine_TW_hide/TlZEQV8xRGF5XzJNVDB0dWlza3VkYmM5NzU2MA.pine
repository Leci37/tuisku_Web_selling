			...
			if( ema13 <= -6.54926 )
				...
				if( tema > 273.272 )
					...
					if( ema13 > -9.10891 )
						ret := -0.256410
			if( ema13 > -6.54926 )
				if( Positive_Money_Flow_Sum <= 2.7534e+10 )
					if( Positive_Money_Flow_Sum <= 2.13445e+10 )
						ret := -0.101695
					if( Positive_Money_Flow_Sum > 2.13445e+10 )
						ret := 0.516129
				if( Positive_Money_Flow_Sum > 2.7534e+10 )
...
float op_operation = decision_tree_0_NVDA_1Day_dbc97560(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
