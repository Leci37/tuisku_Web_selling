			...
			if( tenkan_sen > 64731.2 )
				...
				if( chinkou_span > 65440.6 )
					...
					if( senkou_span_a_displaced > 68430.7 )
						ret := 0.413333
	if( senkou_span_b > 68906.2 )
		if( senkou_span_a_displaced <= 70232.6 )
			if( chinkou_span <= 69380.7 )
				if( senkou_span_b_displaced <= 69753.2 )
					if( basis_max <= 141.285 )
						ret := -0.805405 // sell
					if( basis_max > 141.285 )
						ret := -0.420000
				if( senkou_span_b_displaced > 69753.2 )
					if( senkou_span_b <= 69684.6 )
						ret := 0.234043
					if( senkou_span_b > 69684.6 )
						ret := -0.607143
			if( chinkou_span > 69380.7 )
				if( senkou_span_a <= 70095.3 )
					if( senkou_span_b_displaced <= 68397 )
						ret := 0.684211
					if( senkou_span_b_displaced > 68397 )
						ret := 0.050847
				if( senkou_span_a > 70095.3 )
					if( basis_max <= -177.164 )
						ret := -0.311688
					if( basis_max > -177.164 )
						ret := -0.666667
		if( senkou_span_a_displaced > 70232.6 )
			if( senkou_span_b <= 70819 )
				if( tenkan_sen <= 68686.6 )
					if( senkou_span_a_displaced <= 72880.9 )
						ret := 1.000000 // buy
					if( senkou_span_a_displaced > 72880.9 )
						ret := 0.750000 // buy
				if( tenkan_sen > 68686.6 )
					if( senkou_span_b_displaced <= 69926 )
						ret := 0.561224
					if( senkou_span_b_displaced > 69926 )
						ret := -0.017699
			if( senkou_span_b > 70819 )
				if( senkou_span_b_displaced <= 70034.9 )
					if( senkou_span_a_displaced <= 71705 )
						ret := -0.076923
					if( senkou_span_a_displaced > 71705 )
						ret := 0.571429
				if( senkou_span_b_displaced > 70034.9 )
					if( basis_minus <= 53.3206 )
						ret := -0.658537
					if( basis_minus > 53.3206 )
						ret := -0.941176 // sell
...
float op_operation = decision_tree_0_BTCUSDT_1Hour_cb03beff(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
