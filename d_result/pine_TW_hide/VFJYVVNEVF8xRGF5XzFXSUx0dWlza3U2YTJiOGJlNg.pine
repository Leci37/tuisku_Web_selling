	...
	if( Color_con2 > 9.80902 )
		if( lowerBand <= -2.07479 )
			...
			if( upperBand > 60.9331 )
				ret := 1.000000 // buy
		if( lowerBand > -2.07479 )
			if( Color_con1 <= 0.6726 )
				if( wvf <= 31.1209 )
					if( Color_con2 <= 10.515 )
						ret := 0.444444
					if( Color_con2 > 10.515 )
						ret := 1.000000 // buy
				if( wvf > 31.1209 )
					ret := 1.000000 // buy
			if( Color_con1 > 0.6726 )
				if( Color_con2 <= 22.2328 )
					if( lowerBand <= 0.672795 )
						ret := 0.833333 // buy
					if( lowerBand > 0.672795 )
						ret := 0.076923
				if( Color_con2 > 22.2328 )
...
float op_operation = decision_tree_0_TRXUSDT_1Day_6a2b8be6(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
