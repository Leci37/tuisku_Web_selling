...
decision_tree_0_RBLX_1Hour_9c483788(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)=>
				...
				if( pvi_ema > 0.479423 )
					if( nvimin <= -0.434902 )
						...
						if( nvi > -0.625151 )
							ret := 0.612431
					if( nvimin > -0.434902 )
						if( marron_mean <= 5.96698 )
							ret := -0.800000 // sell
						if( marron_mean > 5.96698 )
							ret := 0.250000
			if( stoc > 31.9391 )
				if( azul_mean <= 15.0019 )
					if( stoc <= 67.1719 )
						if( media_azul <= 95.0905 )
							ret := 0.071900
						if( media_azul > 95.0905 )
							ret := -0.279152
					if( stoc > 67.1719 )
	...
	if( tprice > 38.4047 )
		if( nvi_ema <= 0.207395 )
			if( azul <= 67.0357 )
				if( xrsi <= 20.3871 )
					if( azul_mean <= -14.3428 )
						if( verde_mean <= -23.2891 )
							ret := 0.392157
						if( verde_mean > -23.2891 )
							ret := -0.603175
					if( azul_mean > -14.3428 )
						if( verde_azul <= -64.5344 )
							ret := -0.200000
						if( verde_azul > -64.5344 )
							ret := 0.763975 // buy
				if( xrsi > 20.3871 )
			...
			if( azul > 67.0357 )
				if( pvi <= 0.851555 )
					if( verde_media <= 10.6932 )
						if( BollOsc <= -17.0628 )
							ret := 0.833333 // buy
						if( BollOsc > -17.0628 )
							ret := -0.062500
					if( verde_media > 10.6932 )
						if( azul_mean <= 80.6565 )
							ret := 0.953125 // buy
						if( azul_mean > 80.6565 )
							ret := 0.384615
				if( pvi > 0.851555 )
...
float op_operation = decision_tree_0_RBLX_1Hour_9c483788(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
