			...
			if( lowerBand <= -2.94282 )
				...
				if( Color_con1 > -9.4626 )
					...
					if( wvf > 18.5096 )
						ret := 1.000000 // buy
			if( lowerBand > -2.94282 )
				if( Color_con2 <= -3.30753 )
					if( Color_con1 <= -1.33822 )
						if( wvf <= 6.62356 )
							ret := -0.171762
						if( wvf > 6.62356 )
							ret := -0.473118
					if( Color_con1 > -1.33822 )
						if( Color_con1 <= -0.542611 )
							ret := 0.303571
						if( Color_con1 > -0.542611 )
							ret := -0.120000
				if( Color_con2 > -3.30753 )
					if( upperBand <= 1.60912 )
						if( Color_con2 <= -2.24986 )
							ret := 0.011111
						if( Color_con2 > -2.24986 )
							ret := -0.335366
					if( upperBand > 1.60912 )
						if( Color_con1 <= -6.37566 )
							ret := -0.320819
						if( Color_con1 > -6.37566 )
							ret := -0.005323
	if( midLine > 24.4346 )
...
float op_operation = decision_tree_0_TWLO_1Hour_3c527052(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
