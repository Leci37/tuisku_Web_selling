				...
				if( Raw_Money_Flow > 5.35458e+06 )
					...
					if( Positive_Money_Flow_Sum > 2.37427e+08 )
						...
						if( d > 27.6419 )
							ret := 0.583333
		if( Positive_Money_Flow > 616.794 )
			if( Money_Flow_Ratio <= 33.3211 )
				if( MFI_Low <= -18.3438 )
					ret := 0.804878 // buy
				if( MFI_Low > -18.3438 )
					if( Raw_Money_Flow <= 11258.7 )
						if( Typical_Price <= 24.6563 )
							ret := -0.296448
						if( Typical_Price > 24.6563 )
							ret := 0.032895
					if( Raw_Money_Flow > 11258.7 )
						if( Negative_Money_Flow_Sum <= 1.06298e+08 )
							ret := -0.030778
						if( Negative_Money_Flow_Sum > 1.06298e+08 )
							ret := -0.221413
			if( Money_Flow_Ratio > 33.3211 )
				if( Positive_Money_Flow <= 267664 )
					if( Negative_Money_Flow_Sum <= 343420 )
						ret := 0.933333 // buy
					if( Negative_Money_Flow_Sum > 343420 )
						if( d <= 91.3543 )
							ret := 0.842105 // buy
						if( d > 91.3543 )
							ret := 0.000000
				if( Positive_Money_Flow > 267664 )
					if( Positive_Money_Flow <= 1.48079e+07 )
						if( k <= 87.8697 )
							ret := 0.315789
						if( k > 87.8697 )
							ret := -0.458333
...
float op_operation = decision_tree_0_ASAN_1Hour_a50b78e7(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
