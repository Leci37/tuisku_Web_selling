		...
		if( MFI <= 56.6594 )
			if( MFI_Low <= 10.4062 )
				...
				if( Negative_Money_Flow_Sum > 5.61398e+09 )
					ret := 0.600000
			if( MFI_Low > 10.4062 )
				if( Negative_Money_Flow_Sum <= 1.74393e+09 )
					if( MFI_Low <= 33.4169 )
						ret := 0.459459
					if( MFI_Low > 33.4169 )
						ret := -0.777778 // sell
				if( Negative_Money_Flow_Sum > 1.74393e+09 )
					...
					if( MFI_High > -32.2261 )
						ret := -0.727848 // sell
		if( MFI > 56.6594 )
			if( Negative_Money_Flow_Sum <= 3.89811e+09 )
				if( Positive_Money_Flow <= 4.54598e+08 )
					if( Typical_Price <= 0.073736 )
						ret := 0.809524 // buy
					if( Typical_Price > 0.073736 )
						ret := -0.319797
				if( Positive_Money_Flow > 4.54598e+08 )
					if( Positive_Money_Flow_Sum <= 3.87256e+09 )
						ret := -0.666667
					if( Positive_Money_Flow_Sum > 3.87256e+09 )
						ret := 0.640777
			if( Negative_Money_Flow_Sum > 3.89811e+09 )
				if( Money_Flow_Ratio <= 1.83425 )
					if( Negative_Money_Flow_Sum <= 1.18053e+10 )
						ret := -0.250000
					if( Negative_Money_Flow_Sum > 1.18053e+10 )
						ret := 0.666667
				if( Money_Flow_Ratio > 1.83425 )
					if( Negative_Money_Flow_Sum <= 7.26819e+09 )
						ret := -0.746479 // sell
					if( Negative_Money_Flow_Sum > 7.26819e+09 )
						ret := -0.291667
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_b7ed4703(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
