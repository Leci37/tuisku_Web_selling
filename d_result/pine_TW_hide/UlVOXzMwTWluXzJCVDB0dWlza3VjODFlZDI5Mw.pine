				...
				if( bullPower > 0.179681 )
					if( ema13 <= -0.175608 )
						...
						if( ema2 > 24.1224 )
							ret := 0.642857
					if( ema13 > -0.175608 )
						if( bearPower <= 0.508388 )
							ret := -0.727273 // sell
						if( bearPower > 0.508388 )
							ret := 0.500000
			if( ema2 > 24.4813 )
				if( bullPower <= -1.03861 )
					if( bbm <= 0.30818 )
						if( ema2 <= 47.1024 )
							ret := 0.111111
						if( ema2 > 47.1024 )
...
float op_operation = decision_tree_0_RUN_30Min_c81ed293(bbm, bearPower, bbp, bullPower, BBPower_Color, ema1, tema, ema12, ema2, ema3, ema13)
