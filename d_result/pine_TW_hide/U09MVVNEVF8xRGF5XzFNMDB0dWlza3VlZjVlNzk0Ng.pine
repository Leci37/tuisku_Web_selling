			...
			if( Typical_Price <= 35.3503 )
				if( MFI_Low <= 38.1138 )
					...
					if( Raw_Money_Flow > 3.53834e+08 )
						ret := -0.769231 // sell
				if( MFI_Low > 38.1138 )
					if( Positive_Money_Flow_Sum <= 1.26993e+09 )
						ret := -1.000000 // sell
					if( Positive_Money_Flow_Sum > 1.26993e+09 )
						ret := -0.142857
			if( Typical_Price > 35.3503 )
				if( MFI_High <= -20.7695 )
					if( Negative_Money_Flow <= 1.03267e+06 )
						ret := -0.333333
					if( Negative_Money_Flow > 1.03267e+06 )
						ret := -0.735385 // sell
				if( MFI_High > -20.7695 )
					if( Typical_Price <= 123.164 )
						ret := 0.102041
					if( Typical_Price > 123.164 )
						ret := -0.525424
		if( Negative_Money_Flow_Sum > 2.66522e+09 )
			if( Raw_Money_Flow <= 6.55306e+08 )
				if( Positive_Money_Flow_Sum <= 1.45916e+09 )
					if( Positive_Money_Flow <= 4.75294e+06 )
						ret := 0.250000
					if( Positive_Money_Flow > 4.75294e+06 )
						ret := -0.888889 // sell
				if( Positive_Money_Flow_Sum > 1.45916e+09 )
					if( Typical_Price <= 160.121 )
						ret := 0.477679
					if( Typical_Price > 160.121 )
						ret := 0.069767
			if( Raw_Money_Flow > 6.55306e+08 )
				if( Raw_Money_Flow <= 9.19257e+08 )
					if( Money_Flow_Ratio <= 1.36745 )
						ret := 0.033333
					if( Money_Flow_Ratio > 1.36745 )
						ret := -0.676923
				if( Raw_Money_Flow > 9.19257e+08 )
					if( Positive_Money_Flow_Sum <= 1.16925e+10 )
						ret := 0.469388
					if( Positive_Money_Flow_Sum > 1.16925e+10 )
						ret := -0.578947
...
float op_operation = decision_tree_0_SOLUSDT_1Day_ef5e7946(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
