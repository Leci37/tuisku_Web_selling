				...
				if( basis_minus > 0.091632 )
					...
					if( basis_max > -0.0275 )
						...
						if( senkou_span_a_displaced > 64.3525 )
							ret := -0.857143 // sell
		if( chinkou_span > 62.4596 )
			if( tenkan_sen <= 62.5211 )
				if( basis_max <= -0.715428 )
					if( chinkou_span <= 63.168 )
						ret := 1.000000 // buy
					if( chinkou_span > 63.168 )
						ret := -1.000000 // sell
				if( basis_max > -0.715428 )
					if( basis_minus <= 0.663166 )
						if( basis_minus <= 0.231362 )
							ret := 0.760714 // buy
						if( basis_minus > 0.231362 )
							ret := 0.358491
					if( basis_minus > 0.663166 )
						ret := 0.963636 // buy
			if( tenkan_sen > 62.5211 )
				if( basis_minus <= -0.022076 )
					if( chinkou_span <= 82.0395 )
						if( senkou_span_b <= 78.4123 )
							ret := 0.051320
						if( senkou_span_b > 78.4123 )
							ret := -0.210449
					if( chinkou_span > 82.0395 )
						if( kinjun_sen <= 82.1508 )
							ret := 0.691429
						if( kinjun_sen > 82.1508 )
							ret := 0.078151
				if( basis_minus > -0.022076 )
					if( chinkou_span <= 64.037 )
						if( senkou_span_a_displaced <= 62.5156 )
							ret := 0.247475
						if( senkou_span_a_displaced > 62.5156 )
							ret := -0.547748
					if( chinkou_span > 64.037 )
						if( senkou_span_a <= 63.8268 )
							ret := 0.598425
						if( senkou_span_a > 63.8268 )
							ret := -0.033165
...
float op_operation = decision_tree_0_TTD_5Min_0518b235(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
