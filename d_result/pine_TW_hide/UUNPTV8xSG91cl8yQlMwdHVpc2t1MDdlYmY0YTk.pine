			...
			if( bearPower > -4.38355 )
				if( rsi1 <= 13.9455 )
					if( rsi1 <= 4.573 )
						ret := -0.588235
					if( rsi1 > 4.573 )
						if( bullPower <= -1.06336 )
							ret := 0.179612
						if( bullPower > -1.06336 )
							ret := 0.630252
				if( rsi1 > 13.9455 )
					if( bbp <= 1.00033 )
						if( smoothK_k <= 84.3315 )
							ret := -0.016962
						if( smoothK_k > 84.3315 )
							ret := 0.134761
					if( bbp > 1.00033 )
...
float op_operation = decision_tree_0_QCOM_1Hour_07ebf4a9(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)
