	...
	if( Lower_Band <= 3.05661 )
		...
		if( Upper_Band > 3.33177 )
			...
			if( Lower_Band > 3.05402 )
				ret := -1.000000 // sell
	if( Lower_Band > 3.05661 )
		if( bullPower <= -0.262766 )
			if( basis <= 44.4054 )
				if( bbp <= -1.07473 )
					if( Upper_Band <= 39.5242 )
						if( bbp <= -2.08235 )
							ret := 0.610329
						if( bbp > -2.08235 )
							ret := 0.216216
					if( Upper_Band > 39.5242 )
						if( Upper_Band <= 46.2161 )
							ret := 0.798780 // buy
						if( Upper_Band > 46.2161 )
							ret := -0.318182
				if( bbp > -1.07473 )
					if( bullPower <= -0.469225 )
						if( bbp <= -1.07228 )
							ret := -0.500000
						if( bbp > -1.07228 )
							ret := 0.900000 // buy
					if( bullPower > -0.469225 )
						if( Lower_Band <= 9.56314 )
							ret := -0.264151
						if( Lower_Band > 9.56314 )
							ret := 0.089613
			if( basis > 44.4054 )
				if( Upper_Band <= 118.242 )
					if( basis <= 97.4505 )
						if( basis <= 93.3203 )
							ret := 0.045872
						if( basis > 93.3203 )
				...
				if( basis <= 9.83405 )
					...
					if( bbp > -0.004846 )
						...
						if( basis > 7.57309 )
							ret := 0.113856
				if( basis > 9.83405 )
					if( Upper_Band <= 19.5105 )
						if( basis <= 14.3148 )
							ret := -0.062075
						if( basis > 14.3148 )
							ret := -0.413292
					if( Upper_Band > 19.5105 )
						if( Lower_Band <= 17.7544 )
							ret := 1.000000 // buy
						if( Lower_Band > 17.7544 )
							ret := -0.019065
			if( bbp > 1.48199 )
				if( Lower_Band <= 24.0609 )
					if( Lower_Band <= 18.1252 )
						if( Upper_Band <= 15.5648 )
							ret := -0.260870
						if( Upper_Band > 15.5648 )
							ret := 1.000000 // buy
					if( Lower_Band > 18.1252 )
						if( bullPower <= 0.928906 )
							ret := 1.000000 // buy
						if( bullPower > 0.928906 )
							ret := -0.740741 // sell
				if( Lower_Band > 24.0609 )
					if( basis <= 43.8849 )
						if( Upper_Band <= 38.4456 )
							ret := 0.206897
						if( Upper_Band > 38.4456 )
							ret := 0.657459
					if( basis > 43.8849 )
...
float op_operation = decision_tree_0_PTON_30Min_f952a5d0(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
