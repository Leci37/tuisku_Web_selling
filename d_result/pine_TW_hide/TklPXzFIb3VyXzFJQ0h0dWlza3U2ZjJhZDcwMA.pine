			...
			if( basis_max <= 0.490639 )
				...
				if( chinkou_span > 41.0307 )
					if( senkou_span_a <= 40.9963 )
						ret := 0.664336
					if( senkou_span_a > 40.9963 )
						if( senkou_span_b_displaced <= 39.69 )
							ret := -0.969697 // sell
						if( senkou_span_b_displaced > 39.69 )
							ret := 0.142857
			if( basis_max > 0.490639 )
				if( senkou_span_b_displaced <= 46.1806 )
					if( chinkou_span <= 42.9542 )
						if( basis_minus <= -2.37878 )
							ret := 0.811321 // buy
						if( basis_minus > -2.37878 )
							ret := 0.123457
					if( chinkou_span > 42.9542 )
						ret := 0.882353 // buy
				if( senkou_span_b_displaced > 46.1806 )
					if( tenkan_sen <= 44.0915 )
						if( basis_max <= 1.55992 )
							ret := -0.612903
						if( basis_max > 1.55992 )
							ret := 1.000000 // buy
					if( tenkan_sen > 44.0915 )
						ret := 0.961538 // buy
		if( senkou_span_a > 45.69 )
			if( basis_minus <= 0.863345 )
				if( chinkou_span <= 51.2263 )
					if( senkou_span_b_displaced <= 51.4989 )
						if( senkou_span_a_displaced <= 48.059 )
							ret := -0.283688
						if( senkou_span_a_displaced > 48.059 )
							ret := 0.338710
					if( senkou_span_b_displaced > 51.4989 )
...
float op_operation = decision_tree_0_NIO_1Hour_6f2ad700(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
