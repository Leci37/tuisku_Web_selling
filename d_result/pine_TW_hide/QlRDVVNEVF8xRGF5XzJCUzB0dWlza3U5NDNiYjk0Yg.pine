			...
			if( bullPower <= 949.927 )
				if( bullPower <= 580.916 )
					...
					if( bbm > 540.26 )
						ret := -0.625000
				if( bullPower > 580.916 )
					if( smoothD_d <= 29.2311 )
						ret := 0.076923
					if( smoothD_d > 29.2311 )
						ret := 0.577778
			if( bullPower > 949.927 )
				if( bearPower <= 833.675 )
					if( d_k <= -8.63687 )
						ret := 0.112500
					if( d_k > -8.63687 )
						ret := -0.492063
			...
			if( bbp <= 11621.8 )
				if( bbp <= 2185.03 )
					...
					if( d_k > -2.25641 )
						ret := 0.174419
				if( bbp > 2185.03 )
					if( smoothD_d <= 96.5288 )
						ret := 0.795580 // buy
					if( smoothD_d > 96.5288 )
						ret := 0.227273
			if( bbp > 11621.8 )
				if( bullPower <= 9088.91 )
					if( rsi1 <= 92.958 )
						ret := -1.000000 // sell
					if( rsi1 > 92.958 )
						ret := 0.000000
...
float op_operation = decision_tree_0_BTCUSDT_1Day_943bb94b(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
