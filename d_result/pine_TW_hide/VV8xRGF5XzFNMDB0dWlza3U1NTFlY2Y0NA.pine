...
decision_tree_0_U_1Day_551ecf44(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)=>
	...
	if( Typical_Price > 37.3747 )
		...
		if( Positive_Money_Flow_Sum > 2.75234e+09 )
			if( MFI_High <= -18.0112 )
				if( Positive_Money_Flow_Sum <= 3.15662e+09 )
					if( Negative_Money_Flow <= 4.21818e+08 )
						ret := -0.863014 // sell
					if( Negative_Money_Flow > 4.21818e+08 )
						ret := -0.285714
				if( Positive_Money_Flow_Sum > 3.15662e+09 )
					if( Typical_Price <= 106.58 )
						ret := 0.016949
					if( Typical_Price > 106.58 )
						ret := -0.704918 // sell
			if( MFI_High > -18.0112 )
				if( Positive_Money_Flow_Sum <= 9.77548e+09 )
					if( MFI <= 66.3072 )
						ret := 0.291667
					if( MFI > 66.3072 )
						ret := -0.115000
				if( Positive_Money_Flow_Sum > 9.77548e+09 )
					if( Negative_Money_Flow <= 7.82866e+08 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow > 7.82866e+08 )
						ret := -0.500000
...
float op_operation = decision_tree_0_U_1Day_551ecf44(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
