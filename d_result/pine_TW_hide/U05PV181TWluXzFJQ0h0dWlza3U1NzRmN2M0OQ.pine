				...
				if( chinkou_span <= 110.433 )
					...
					if( chinkou_span > 108.558 )
						...
						if( basis_minus > -1.46812 )
							ret := -0.043993
				if( chinkou_span > 110.433 )
					if( tenkan_sen <= 110.677 )
						if( kinjun_sen <= 109.623 )
							ret := -0.225806
						if( kinjun_sen > 109.623 )
							ret := 0.718905 // buy
					if( tenkan_sen > 110.677 )
						if( chinkou_span <= 113.566 )
							ret := 0.139442
						if( chinkou_span > 113.566 )
							ret := 0.771429 // buy
		if( senkou_span_a > 112.265 )
			if( chinkou_span <= 112.095 )
				if( basis_max <= 0.11245 )
					ret := -0.838284 // sell
				if( basis_max > 0.11245 )
					if( basis_max <= 0.182071 )
						ret := 0.750000 // buy
					if( basis_max > 0.182071 )
						ret := -0.720930 // sell
			if( chinkou_span > 112.095 )
				if( senkou_span_b <= 232.098 )
					if( chinkou_span <= 223.187 )
						if( senkou_span_b <= 215.615 )
							ret := 0.028677
						if( senkou_span_b > 215.615 )
							ret := -0.517241
					if( chinkou_span > 223.187 )
...
float op_operation = decision_tree_0_SNOW_5Min_574f7c49(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
