			...
			if( senkou_span_b_displaced > 4361.4 )
				...
				if( basis_max > -426.217 )
					...
					if( senkou_span_a_displaced > 5326.95 )
						ret := 0.747368 // buy
		if( tenkan_sen > 8131.69 )
			if( senkou_span_a_displaced <= 40095.3 )
				if( chinkou_span <= 13565.1 )
					if( tenkan_sen <= 10086.5 )
						ret := 0.204461
					if( tenkan_sen > 10086.5 )
						ret := -0.457143
				if( chinkou_span > 13565.1 )
					if( senkou_span_b_displaced <= 18506.3 )
						ret := 0.613497
					if( senkou_span_b_displaced > 18506.3 )
						ret := 0.184544
			if( senkou_span_a_displaced > 40095.3 )
				if( chinkou_span <= 55003.6 )
					if( tenkan_sen <= 36011.7 )
						ret := 0.292683
					if( tenkan_sen > 36011.7 )
						ret := -0.492239
				if( chinkou_span > 55003.6 )
					if( basis_minus <= 116.795 )
						ret := 0.465839
					if( basis_minus > 116.795 )
						ret := -0.273723
...
float op_operation = decision_tree_0_BTCUSDT_1Day_223a72a2(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
