...
decision_tree_0_MSFT_1Day_b98a3fd2(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema13 > 0.036665 )
		if( Positive_Money_Flow_Sum <= 1.03444e+11 )
			if( ema13 <= 7.33505 )
				if( MFI_High <= -5.91127 )
					if( Positive_Money_Flow_Sum <= 6.65927e+10 )
						ret := -0.042570
					if( Positive_Money_Flow_Sum > 6.65927e+10 )
						ret := -0.351032
				if( MFI_High > -5.91127 )
					if( Negative_Money_Flow_Sum <= 2.23598e+10 )
						ret := 0.115789
					if( Negative_Money_Flow_Sum > 2.23598e+10 )
						ret := 0.960000 // buy
			if( ema13 > 7.33505 )
				if( Negative_Money_Flow <= 9.18757e+09 )
					if( tema <= 252.621 )
						ret := -0.710526 // sell
					if( tema > 252.621 )
						ret := -0.299578
				if( Negative_Money_Flow > 9.18757e+09 )
					if( Negative_Money_Flow_Sum <= 4.34913e+10 )
						ret := -0.142857
					if( Negative_Money_Flow_Sum > 4.34913e+10 )
						ret := 0.478261
		if( Positive_Money_Flow_Sum > 1.03444e+11 )
...
float op_operation = decision_tree_0_MSFT_1Day_b98a3fd2(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
