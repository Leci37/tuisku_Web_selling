	...
	if( vrsi > 42.5734 )
		...
		if( BBlower > 10.4013 )
			if( BBlower <= 66.6782 )
				if( BBlower <= 61.7616 )
					if( BBupper <= 27.1746 )
						if( dif_source_BBupper <= 0.881139 )
							ret := 0.000892
						if( dif_source_BBupper > 0.881139 )
							ret := -0.670330
					if( BBupper > 27.1746 )
						...
						if( BBupper > 81.2519 )
							ret := 0.339394
				if( BBlower > 61.7616 )
					if( dif_source_BBlower <= 8.07597 )
						if( dif_source_BBupper <= -3.9233 )
							ret := 0.113314
						if( dif_source_BBupper > -3.9233 )
							ret := 0.490099
					if( dif_source_BBlower > 8.07597 )
			...
			if( BBlower > 66.6782 )
				if( vrsi <= 43.0599 )
					ret := 0.666667
				if( vrsi > 43.0599 )
					if( dif_source_BBupper <= -5.85633 )
						if( dif_source_BBupper <= -14.0997 )
							ret := -0.362205
						if( dif_source_BBupper > -14.0997 )
							ret := 0.090090
					if( dif_source_BBupper > -5.85633 )
...
float op_operation = decision_tree_0_PINS_30Min_a0941de1(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
