		...
		if( MFI_Low <= 35.5817 )
			if( Raw_Money_Flow <= 5.64333e+09 )
				if( Typical_Price <= 98.7903 )
					if( Negative_Money_Flow <= 1.97301e+09 )
						ret := -0.818182 // sell
					if( Negative_Money_Flow > 1.97301e+09 )
						ret := 0.111111
				if( Typical_Price > 98.7903 )
					if( Money_Flow_Ratio <= 0.815895 )
						ret := 0.750000 // buy
					if( Money_Flow_Ratio > 0.815895 )
						ret := -0.222222
			if( Raw_Money_Flow > 5.64333e+09 )
				if( mf <= -0.076624 )
					...
					if( mf > -0.250202 )
						ret := 0.160920
				if( mf > -0.076624 )
					if( Positive_Money_Flow_Sum <= 6.45443e+10 )
						ret := -0.661905
					if( Positive_Money_Flow_Sum > 6.45443e+10 )
						ret := -0.175439
		if( MFI_Low > 35.5817 )
			if( Negative_Money_Flow <= 1.26876e+10 )
				if( mf <= 0.280649 )
					if( mf <= -0.072766 )
						ret := 0.000000
					if( mf > -0.072766 )
...
float op_operation = decision_tree_0_AMD_1Day_49ce8cf8(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
