...
decision_tree_0_ABNB_30Min_2036d41f(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)=>
	...
	if( Negative_Money_Flow_Sum > 1.17026e+08 )
		if( ema13 <= 6.81133 )
			if( Typical_Price <= 115.813 )
				if( Negative_Money_Flow_Sum <= 9.15562e+08 )
					if( ema12 <= -1.91088 )
						ret := 0.541176
					if( ema12 > -1.91088 )
						ret := 0.100499
				if( Negative_Money_Flow_Sum > 9.15562e+08 )
					...
					if( Negative_Money_Flow_Sum > 2.04289e+09 )
						ret := 0.296296
			if( Typical_Price > 115.813 )
				if( Positive_Money_Flow <= 1.8728e+07 )
					if( Money_Flow_Ratio <= 5.77356 )
						ret := 0.007889
					if( Money_Flow_Ratio > 5.77356 )
						ret := 0.459016
				if( Positive_Money_Flow > 1.8728e+07 )
					if( Negative_Money_Flow_Sum <= 8.18444e+08 )
						ret := -0.123970
					if( Negative_Money_Flow_Sum > 8.18444e+08 )
						ret := 0.286408
		if( ema13 > 6.81133 )
			if( Raw_Money_Flow <= 2.75465e+08 )
				if( Negative_Money_Flow_Sum <= 4.55493e+08 )
					if( Raw_Money_Flow <= 2.20061e+07 )
						ret := -0.857143 // sell
					if( Raw_Money_Flow > 2.20061e+07 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 4.55493e+08 )
...
float op_operation = decision_tree_0_ABNB_30Min_2036d41f(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
