...
decision_tree_0_LTCUSDT_1Day_9f88a996(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Typical_Price > 60.9952 )
		if( Positive_Money_Flow_Sum <= 4.07824e+09 )
			...
			if( Negative_Money_Flow_Sum > 4.58211e+08 )
				if( VIP <= 0.747397 )
					if( Typical_Price <= 67.4417 )
						ret := -0.125000
					if( Typical_Price > 67.4417 )
						ret := 0.844444 // buy
				if( VIP > 0.747397 )
					if( Positive_Money_Flow_Sum <= 2.22764e+08 )
						ret := -0.666667
					if( Positive_Money_Flow_Sum > 2.22764e+08 )
						ret := 0.134969
		if( Positive_Money_Flow_Sum > 4.07824e+09 )
			if( VIP <= 1.00605 )
				ret := -0.625000
			if( VIP > 1.00605 )
				if( Positive_Money_Flow_Sum <= 4.64041e+09 )
					if( MFI_Low <= 53.6267 )
						ret := -0.714286 // sell
					if( MFI_Low > 53.6267 )
						ret := -0.944444 // sell
				if( Positive_Money_Flow_Sum > 4.64041e+09 )
					if( Negative_Money_Flow <= 8.49785e+08 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow > 8.49785e+08 )
						ret := -0.900000 // sell
...
float op_operation = decision_tree_0_LTCUSDT_1Day_9f88a996(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
