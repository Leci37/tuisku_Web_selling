			...
			if( Positive_Money_Flow_Sum > 4.22106e+08 )
				...
				if( Negative_Money_Flow_Sum > 2.25044e+09 )
					...
					if( Negative_Money_Flow > 3.23105e+08 )
						ret := -0.500000
	if( Typical_Price > 328.05 )
		if( Raw_Money_Flow <= 3.49109e+08 )
			if( Positive_Money_Flow_Sum <= 1.07749e+09 )
				if( Negative_Money_Flow_Sum <= 4.63932e+08 )
					if( Raw_Money_Flow <= 8.07495e+07 )
						ret := -0.714286 // sell
					if( Raw_Money_Flow > 8.07495e+07 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 4.63932e+08 )
					...
					if( Negative_Money_Flow > 3.01089e+08 )
						ret := -0.833333 // sell
			if( Positive_Money_Flow_Sum > 1.07749e+09 )
				if( Typical_Price <= 419.85 )
					if( Negative_Money_Flow <= 1.35246e+08 )
						ret := -0.767123 // sell
					if( Negative_Money_Flow > 1.35246e+08 )
						ret := -0.294118
				if( Typical_Price > 419.85 )
					if( Raw_Money_Flow <= 2.48746e+08 )
						ret := -0.248588
					if( Raw_Money_Flow > 2.48746e+08 )
						ret := 0.415094
		if( Raw_Money_Flow > 3.49109e+08 )
			if( MFI_High <= -58.0462 )
				ret := -1.000000 // sell
			if( MFI_High > -58.0462 )
				if( Raw_Money_Flow <= 7.90422e+08 )
					if( Negative_Money_Flow <= 4.52193e+08 )
						ret := -0.750000 // sell
					if( Negative_Money_Flow > 4.52193e+08 )
						ret := -0.222222
				if( Raw_Money_Flow > 7.90422e+08 )
...
float op_operation = decision_tree_0_EPAM_1Day_f6b5969a(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
