			...
			if( MFI <= 49.8767 )
				if( Positive_Money_Flow <= 67349.8 )
					...
					if( Positive_Money_Flow_Sum > 1.30233e+08 )
						ret := 0.187500
				if( Positive_Money_Flow > 67349.8 )
					if( Negative_Money_Flow <= 21593.4 )
						ret := 0.614286
					if( Negative_Money_Flow > 21593.4 )
						ret := 1.000000 // buy
			if( MFI > 49.8767 )
				if( Raw_Money_Flow <= 8.30495e+06 )
					if( Negative_Money_Flow_Sum <= 3.70402e+07 )
						ret := 0.333333
					if( Negative_Money_Flow_Sum > 3.70402e+07 )
						ret := -0.810811 // sell
				if( Raw_Money_Flow > 8.30495e+06 )
					if( Positive_Money_Flow_Sum <= 2.35359e+08 )
						ret := 0.619718
					if( Positive_Money_Flow_Sum > 2.35359e+08 )
						ret := 0.040323
		if( Typical_Price > 50.9722 )
			if( Negative_Money_Flow <= 1.75219e+07 )
				if( Positive_Money_Flow <= 8.73983e+08 )
					if( Money_Flow_Ratio <= 0.866146 )
						ret := 0.273171
					if( Money_Flow_Ratio > 0.866146 )
						ret := -0.003425
				if( Positive_Money_Flow > 8.73983e+08 )
					if( Negative_Money_Flow_Sum <= 1.49211e+09 )
						ret := 0.166667
					if( Negative_Money_Flow_Sum > 1.49211e+09 )
						ret := -0.629630
			if( Negative_Money_Flow > 1.75219e+07 )
				if( Negative_Money_Flow_Sum <= 2.54384e+09 )
					if( Positive_Money_Flow_Sum <= 6.77579e+09 )
						ret := -0.294207
					if( Positive_Money_Flow_Sum > 6.77579e+09 )
						ret := -0.891304 // sell
				if( Negative_Money_Flow_Sum > 2.54384e+09 )
					if( Negative_Money_Flow_Sum <= 4.91669e+09 )
						ret := 0.107143
					if( Negative_Money_Flow_Sum > 4.91669e+09 )
						ret := -0.472000
...
float op_operation = decision_tree_0_TTD_1Day_79d96a15(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
