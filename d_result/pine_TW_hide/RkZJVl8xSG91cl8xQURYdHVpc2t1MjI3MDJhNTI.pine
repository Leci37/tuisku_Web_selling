				...
				if( adx > 31.8038 )
					...
					if( diMinus > 25.6169 )
						...
						if( diMinus > 39.8052 )
							ret := 0.397380
	if( adx > 74.5428 )
		if( smoothedTrueRange <= 1.05535 )
			if( adx <= 80.8736 )
				if( dx <= 20.9011 )
					ret := -1.000000 // sell
				if( dx > 20.9011 )
					if( smoothedTrueRange <= 1.04276 )
						ret := 0.313433
					if( smoothedTrueRange > 1.04276 )
						ret := -1.000000 // sell
			if( adx > 80.8736 )
...
float op_operation = decision_tree_0_FFIV_1Hour_22702a52(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
