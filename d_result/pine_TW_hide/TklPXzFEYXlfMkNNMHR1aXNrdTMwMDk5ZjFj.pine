			...
			if( ad > -7.20275e+07 )
				...
				if( Typical_Price > 18.5283 )
					...
					if( Negative_Money_Flow_Sum > 2.21175e+10 )
						ret := 0.333333
		if( ad > -5.19413e+07 )
			if( Typical_Price <= 19.4254 )
				if( Positive_Money_Flow <= 8.3796e+08 )
					if( Positive_Money_Flow_Sum <= 5.13947e+09 )
						ret := -0.126126
					if( Positive_Money_Flow_Sum > 5.13947e+09 )
						ret := 0.291262
				if( Positive_Money_Flow > 8.3796e+08 )
					if( Money_Flow_Ratio <= 2.0379 )
						ret := 0.727273 // buy
					if( Money_Flow_Ratio > 2.0379 )
						ret := 0.044444
			if( Typical_Price > 19.4254 )
				if( MFI_Low <= 41.1833 )
					if( Money_Flow_Ratio <= 1.06566 )
						ret := -0.354086
					if( Money_Flow_Ratio > 1.06566 )
						ret := -0.707792 // sell
				if( MFI_Low > 41.1833 )
					if( Negative_Money_Flow_Sum <= 1.43035e+10 )
						ret := -0.122222
					if( Negative_Money_Flow_Sum > 1.43035e+10 )
						ret := 0.732143 // buy
...
float op_operation = decision_tree_0_NIO_1Day_30099f1c(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
