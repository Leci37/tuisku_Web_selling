	...
	if( bearPower > 0.339021 )
		if( bbp <= 2.05536 )
			if( basis <= 42.8292 )
				if( bbp <= 1.54073 )
					if( bbp <= 1.43605 )
						if( bearPower <= 0.388775 )
							ret := -0.099291
						if( bearPower > 0.388775 )
							ret := -0.380142
					if( bbp > 1.43605 )
						if( Lower_Band <= 30.4185 )
							ret := 0.589744
						if( Lower_Band > 30.4185 )
							ret := -0.145833
				if( bbp > 1.54073 )
					if( Upper_Band <= 39.3121 )
						if( basis <= 27.1687 )
							ret := 0.000000
						if( basis > 27.1687 )
							ret := -0.699482
					if( Upper_Band > 39.3121 )
						...
						if( basis > 40.2858 )
							ret := -0.638554
			if( basis > 42.8292 )
				if( Lower_Band <= 42.0603 )
					if( bearPower <= 0.544892 )
						if( Lower_Band <= 41.2959 )
							ret := 0.666667
						if( Lower_Band > 41.2959 )
							ret := 0.955556 // buy
					if( bearPower > 0.544892 )
						ret := 0.100000
				if( Lower_Band > 42.0603 )
					if( Upper_Band <= 47.2719 )
						if( basis <= 45.4352 )
							ret := -0.311927
						if( basis > 45.4352 )
							ret := -0.944444 // sell
					if( Upper_Band > 47.2719 )
						if( Lower_Band <= 54.3756 )
							ret := 0.161137
						if( Lower_Band > 54.3756 )
							ret := -0.140845
		if( bbp > 2.05536 )
			if( Lower_Band <= 45.6616 )
				if( basis <= 45.6969 )
					if( Lower_Band <= 40.5457 )
						if( bearPower <= 0.942786 )
							ret := -0.064103
						if( bearPower > 0.942786 )
							ret := 0.407258
					if( Lower_Band > 40.5457 )
						if( Lower_Band <= 43.2176 )
							ret := -0.307692
						if( Lower_Band > 43.2176 )
							ret := -1.000000 // sell
				if( basis > 45.6969 )
					if( basis <= 48.0974 )
						...
						if( bbm > 0.406358 )
							ret := 0.939024 // buy
					if( basis > 48.0974 )
						if( Lower_Band <= 44.2788 )
							ret := 0.000000
						if( Lower_Band > 44.2788 )
							ret := -0.285714
			if( Lower_Band > 45.6616 )
				if( Upper_Band <= 66.4071 )
					if( bearPower <= 1.0937 )
						if( basis <= 56.7265 )
							ret := 0.083333
						if( basis > 56.7265 )
					...
					if( bearPower > 1.0937 )
						...
						if( basis > 53.0905 )
							ret := -0.807407 // sell
				if( Upper_Band > 66.4071 )
					if( Upper_Band <= 73.2375 )
						if( bullPower <= 1.78754 )
							ret := 1.000000 // buy
						if( bullPower > 1.78754 )
							ret := 0.620690
					if( Upper_Band > 73.2375 )
...
float op_operation = decision_tree_0_DOCN_30Min_8d09891a(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
