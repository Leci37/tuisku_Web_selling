			...
			if( rsi1 > 56.8727 )
				...
				if( smoothK_k > 24.1619 )
					...
					if( d_k > -6.68292 )
						ret := 1.000000 // buy
		if( d > 27.4428 )
			if( smoothD_d <= 90.9352 )
				if( VIP <= 1.3607 )
					if( smoothK_k <= 81.3037 )
						ret := 0.145768
					if( smoothK_k > 81.3037 )
						ret := 0.427873
				if( VIP > 1.3607 )
			...
			if( smoothD_d > 90.9352 )
				if( VIP <= 1.02699 )
					if( smoothK_k <= 88.5676 )
						ret := -0.500000
					if( smoothK_k > 88.5676 )
						ret := 0.800000 // buy
				if( VIP > 1.02699 )
					if( smoothD_d <= 93.7452 )
						ret := -0.600000
					if( smoothD_d > 93.7452 )
						ret := -0.271357
...
float op_operation = decision_tree_0_AMZN_1Day_6f2e3e5b(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)
