				...
				if( basis_max > 0.650469 )
					...
					if( senkou_span_b > 25.896 )
						...
						if( senkou_span_b_displaced > 30.1068 )
							ret := 1.000000 // buy
			if( chinkou_span > 21.8088 )
				if( chinkou_span <= 29.0001 )
					if( tenkan_sen <= 27.3545 )
						if( chinkou_span <= 27.2188 )
							ret := -0.066169
						if( chinkou_span > 27.2188 )
							ret := 0.626482
					if( tenkan_sen > 27.3545 )
						if( tenkan_sen <= 29.3916 )
							ret := -0.270199
						if( tenkan_sen > 29.3916 )
							ret := -0.700000 // sell
				if( chinkou_span > 29.0001 )
					if( tenkan_sen <= 29.2498 )
						if( senkou_span_b <= 28.4013 )
							ret := 0.754190 // buy
						if( senkou_span_b > 28.4013 )
							ret := 0.352436
					if( tenkan_sen > 29.2498 )
						if( chinkou_span <= 31.3386 )
							ret := -0.263381
						if( chinkou_span > 31.3386 )
							ret := 0.019082
	if( chinkou_span > 80.8735 )
		if( chinkou_span <= 85.3674 )
			if( senkou_span_b_displaced <= 78.524 )
				ret := 0.980392 // buy
			if( senkou_span_b_displaced > 78.524 )
				if( senkou_span_a_displaced <= 78.547 )
					ret := 1.000000 // buy
				if( senkou_span_a_displaced > 78.547 )
					if( kinjun_sen <= 78.0988 )
						ret := 0.600000
					if( kinjun_sen > 78.0988 )
						ret := 0.000000
		if( chinkou_span > 85.3674 )
...
float op_operation = decision_tree_0_UBER_1Hour_aa33512f(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
