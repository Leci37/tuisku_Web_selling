			...
			if( Typical_Price > 6.09958 )
				if( Negative_Money_Flow_Sum <= 4.68949e+08 )
					...
					if( Money_Flow_Ratio > 4.29831 )
						ret := 0.555556
				if( Negative_Money_Flow_Sum > 4.68949e+08 )
					if( Typical_Price <= 23.3533 )
						ret := 0.415094
					if( Typical_Price > 23.3533 )
						ret := -0.340909
		if( ad_mf > 3.09836e+06 )
			if( Typical_Price <= 24.8867 )
				if( Raw_Money_Flow <= 3.70482e+07 )
					if( Positive_Money_Flow <= 2.74969e+07 )
						ret := 0.000000
					if( Positive_Money_Flow > 2.74969e+07 )
						ret := 0.166667
				if( Raw_Money_Flow > 3.70482e+07 )
					if( Negative_Money_Flow_Sum <= 1.30747e+08 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 1.30747e+08 )
						ret := 0.735294 // buy
			if( Typical_Price > 24.8867 )
				if( Typical_Price <= 31.178 )
					if( ad_mf <= 4.26842e+06 )
						ret := -0.222222
					if( ad_mf > 4.26842e+06 )
						ret := -1.000000 // sell
				if( Typical_Price > 31.178 )
...
float op_operation = decision_tree_0_UNIUSDT_1Day_d151f648(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
