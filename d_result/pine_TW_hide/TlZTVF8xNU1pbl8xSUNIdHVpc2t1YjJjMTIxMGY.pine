			...
			if( senkou_span_b_displaced <= 16.3576 )
				...
				if( basis_minus > -0.341187 )
					...
					if( senkou_span_b_displaced > 16.252 )
						ret := 0.717949 // buy
			if( senkou_span_b_displaced > 16.3576 )
				if( senkou_span_a_displaced <= 17.6363 )
					if( senkou_span_b_displaced <= 17.0784 )
						ret := -0.361974
					if( senkou_span_b_displaced > 17.0784 )
						ret := -0.867089 // sell
				if( senkou_span_a_displaced > 17.6363 )
					if( basis_minus <= -0.347878 )
						ret := 0.389831
					if( basis_minus > -0.347878 )
						ret := -1.000000 // sell
		if( chinkou_span > 16.316 )
			if( tenkan_sen <= 17.2123 )
				if( kinjun_sen <= 16.273 )
					if( basis_max <= -0.391875 )
						ret := -0.300000
					if( basis_max > -0.391875 )
						ret := 0.672451
				if( kinjun_sen > 16.273 )
					if( senkou_span_b_displaced <= 16.246 )
						ret := -0.418803
					if( senkou_span_b_displaced > 16.246 )
						ret := 0.322581
			if( tenkan_sen > 17.2123 )
				if( basis_max <= 0.042308 )
					if( chinkou_span <= 17.4607 )
						ret := -0.440208
					if( chinkou_span > 17.4607 )
						ret := -0.025111
				if( basis_max > 0.042308 )
					if( chinkou_span <= 17.2838 )
						ret := -0.561404
					if( chinkou_span > 17.2838 )
						ret := 0.062628
...
float op_operation = decision_tree_0_NVST_15Min_b2c1210f(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
