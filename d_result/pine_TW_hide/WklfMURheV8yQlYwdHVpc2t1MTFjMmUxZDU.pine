			...
			if( bearPower <= 0.169687 )
				if( bullPower <= 0.893743 )
					...
					if( VIP > 1.06063 )
						ret := -0.162791
				if( bullPower > 0.893743 )
					if( bullPower <= 0.973654 )
						ret := -1.000000 // sell
					if( bullPower > 0.973654 )
						ret := -0.312500
			if( bearPower > 0.169687 )
				if( bearPower <= 0.66563 )
					if( VIP_VIM <= 0.345751 )
						ret := 0.147059
					if( VIP_VIM > 0.345751 )
						ret := 0.750000 // buy
				if( bearPower > 0.66563 )
					if( bearPower <= 1.35292 )
						ret := -0.555556
					if( bearPower > 1.35292 )
						ret := 0.000000
		if( bbm > 1.67105 )
			if( bbm <= 2.205 )
				if( bearPower <= -2.60135 )
					if( bbp <= -4.19476 )
						ret := -0.800000 // sell
					if( bbp > -4.19476 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_ZI_1Day_11c2e1d5(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP_VIM, VIP, VIM)
