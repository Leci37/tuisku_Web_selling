			...
			if( VIM <= 1.03144 )
				...
				if( VIP_VIM > 0.037125 )
					...
					if( VIM > 0.918628 )
						ret := -0.954545 // sell
			if( VIM > 1.03144 )
				if( bullPower <= 0.691064 )
					ret := -0.680000
				if( bullPower > 0.691064 )
					ret := -0.925926 // sell
		if( bearPower > -1.45566 )
			if( bearPower <= 1.07097 )
				if( VIP <= 1.16536 )
					if( bbp <= 0.576217 )
						ret := 0.075294
					if( bbp > 0.576217 )
				...
				if( VIP > 1.16536 )
					...
					if( VIP > 1.27821 )
						ret := -0.268293
			if( bearPower > 1.07097 )
				if( bearPower <= 1.62931 )
					if( VIM <= 0.770209 )
						ret := 0.150000
					if( VIM > 0.770209 )
						ret := -0.718750 // sell
				if( bearPower > 1.62931 )
					if( bullPower <= 7.19458 )
						ret := 0.201681
					if( bullPower > 7.19458 )
						ret := -0.640000
...
float op_operation = decision_tree_0_PINS_1Day_669010b3(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
