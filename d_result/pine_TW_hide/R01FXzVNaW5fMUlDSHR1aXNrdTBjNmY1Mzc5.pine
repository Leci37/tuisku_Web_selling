			...
			if( tenkan_sen <= 28.7891 )
				if( senkou_span_b_displaced <= 29.8246 )
					...
					if( chinkou_span > 30.1571 )
						ret := 0.377953
				if( senkou_span_b_displaced > 29.8246 )
					if( chinkou_span <= 29.03 )
						ret := 0.508475
					if( chinkou_span > 29.03 )
						ret := -0.319149
			if( tenkan_sen > 28.7891 )
				if( chinkou_span <= 36.8736 )
					if( senkou_span_a_displaced <= 34.5769 )
						ret := 0.189538
					if( senkou_span_a_displaced > 34.5769 )
						ret := -0.265267
				if( chinkou_span > 36.8736 )
					if( basis_max <= -1.61125 )
						ret := -0.338983
					if( basis_max > -1.61125 )
						ret := 0.625000
		if( senkou_span_b > 52.6405 )
			if( senkou_span_a <= 60.0565 )
				if( kinjun_sen <= 58.6519 )
					if( basis_max <= 0.949771 )
						ret := -0.763158 // sell
					if( basis_max > 0.949771 )
						ret := 0.206107
				if( kinjun_sen > 58.6519 )
					if( basis_max <= 0.364274 )
						ret := 0.942857 // buy
					if( basis_max > 0.364274 )
						ret := 0.200000
			if( senkou_span_a > 60.0565 )
				if( senkou_span_b <= 58.3301 )
					if( senkou_span_a_displaced <= 51.1457 )
						ret := -0.800000 // sell
					if( senkou_span_a_displaced > 51.1457 )
						ret := 0.500000
				if( senkou_span_b > 58.3301 )
...
float op_operation = decision_tree_0_GME_5Min_0c6f5379(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
