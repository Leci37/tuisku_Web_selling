			...
			if( BBlower <= 30.9143 )
				if( BBlower <= 24.1802 )
					...
					if( BBlower > -196.095 )
						ret := -0.061856
				if( BBlower > 24.1802 )
					if( dif_source_BBlower <= 78.2116 )
						ret := 0.578947
					if( dif_source_BBlower > 78.2116 )
						ret := -0.444444
			if( BBlower > 30.9143 )
				if( dif_source_BBupper <= -239.814 )
					if( BBlower <= 1014.71 )
						ret := 0.759615 // buy
					if( BBlower > 1014.71 )
						ret := -0.514286
				if( dif_source_BBupper > -239.814 )
					if( dif_source_BBlower <= 927.467 )
						ret := -0.067882
					if( dif_source_BBlower > 927.467 )
						ret := -0.833333 // sell
...
float op_operation = decision_tree_0_SHOP_1Day_4cc76295(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
