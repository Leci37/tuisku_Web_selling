...
decision_tree_0_DOCN_1Hour_b280fc84(d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
				...
				if( smoothD_d <= 33.4552 )
					...
					if( d > 4.26108 )
						...
						if( rsi1 > 34.2358 )
							ret := 0.053381
				if( smoothD_d > 33.4552 )
					if( smoothK_k <= 44.0456 )
						if( rsi1 <= 30.0401 )
							ret := -0.571429
						if( rsi1 > 30.0401 )
							ret := -0.977778 // sell
					if( smoothK_k > 44.0456 )
						if( smoothD_d <= 44.1094 )
							ret := 0.172414
						if( smoothD_d > 44.1094 )
							ret := -0.445355
			if( rsi1 > 61.7918 )
				if( smoothK_k <= 49.0328 )
					if( d <= 31.291 )
						if( k <= 12.1618 )
							ret := 0.909091 // buy
						if( k > 12.1618 )
							ret := -0.312500
					if( d > 31.291 )
						if( smoothD_d <= 34.2815 )
							ret := 0.937500 // buy
						if( smoothD_d > 34.2815 )
							ret := 0.588235
				if( smoothK_k > 49.0328 )
					if( smoothD_d <= 85.6296 )
						if( d_k <= -5.74396 )
							ret := -0.602740
						if( d_k > -5.74396 )
							ret := -0.140000
	...
	if( d_k > -4.05968 )
		...
		if( rsi1 > 85.8097 )
			...
			if( k > 91.7491 )
				if( rsi1 <= 95.7722 )
					if( smoothK_k <= 91.6374 )
						if( d_k <= 1.39607 )
							ret := -0.937500 // sell
						if( d_k > 1.39607 )
							ret := -0.714286 // sell
					if( smoothK_k > 91.6374 )
						if( smoothK_k <= 95.6056 )
							ret := -0.100000
						if( smoothK_k > 95.6056 )
							ret := -0.536232
				if( rsi1 > 95.7722 )
...
float op_operation = decision_tree_0_DOCN_1Hour_b280fc84(d, d_k, smoothK_k, k, rsi1, smoothD_d)
