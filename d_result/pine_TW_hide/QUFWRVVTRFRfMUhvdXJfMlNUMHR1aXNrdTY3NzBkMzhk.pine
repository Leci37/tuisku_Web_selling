	...
	if( d_k > 0.621168 )
		...
		if( rsi1 > 48.8461 )
			if( ema12 <= 0.635696 )
				if( ema12 <= -0.106759 )
					if( ema12 <= -3.23976 )
						if( smoothK_k <= 52.4902 )
							ret := 0.071429
						if( smoothK_k > 52.4902 )
							ret := -0.625000
					if( ema12 > -3.23976 )
						if( smoothD_d <= 94.2233 )
							ret := 0.472857
						if( smoothD_d > 94.2233 )
							ret := -0.333333
				if( ema12 > -0.106759 )
					if( rsi1 <= 52.9042 )
						if( smoothD_d <= 70.0188 )
							ret := -0.004021
						if( smoothD_d > 70.0188 )
							ret := -0.501176
					if( rsi1 > 52.9042 )
			...
			if( ema12 > 0.635696 )
				...
				if( d_k > 8.0806 )
					if( rsi1 <= 62.6012 )
						if( smoothD_d <= 69.2725 )
							ret := -0.315470
						if( smoothD_d > 69.2725 )
							ret := -0.578947
					if( rsi1 > 62.6012 )
						if( smoothD_d <= 85.5028 )
							ret := -0.026119
						if( smoothD_d > 85.5028 )
							ret := -0.584746
...
float op_operation = decision_tree_0_AAVEUSDT_1Hour_6770d38d(rsi1, smoothK_k, d_k, k, d, smoothD_d, ema3, tema, ema2, ema12, ema13, ema1)
