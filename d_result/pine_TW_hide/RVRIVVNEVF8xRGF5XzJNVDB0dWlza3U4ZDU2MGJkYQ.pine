			...
			if( ema1 > 141.91 )
				if( Negative_Money_Flow <= 528565 )
					...
					if( ema13 > -72.2057 )
						ret := 0.225945
				if( Negative_Money_Flow > 528565 )
					if( Negative_Money_Flow <= 8.31802e+07 )
						ret := -0.262542
					if( Negative_Money_Flow > 8.31802e+07 )
						ret := 0.076652
		if( ema2 > 3214.7 )
			if( ema13 <= -341.895 )
				ret := 0.833333 // buy
			if( ema13 > -341.895 )
				if( Negative_Money_Flow <= 1.13296e+09 )
					if( Negative_Money_Flow_Sum <= 7.61204e+09 )
						ret := -0.756098 // sell
					if( Negative_Money_Flow_Sum > 7.61204e+09 )
						ret := -0.414062
				if( Negative_Money_Flow > 1.13296e+09 )
					if( Positive_Money_Flow_Sum <= 1.80969e+10 )
						ret := 0.133333
					if( Positive_Money_Flow_Sum > 1.80969e+10 )
						ret := -0.789474 // sell
...
float op_operation = decision_tree_0_ETHUSDT_1Day_8d560bda(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
