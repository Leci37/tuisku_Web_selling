...
decision_tree_0_SNOW_1Day_401bc95e(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)=>
	...
	if( Color_con2 > -3.04263 )
		...
		if( midLine > 10.3001 )
			if( midLine <= 16.5486 )
				if( Color_con1 <= -5.28946 )
					if( upperBand <= 24.7602 )
						ret := -1.000000 // sell
					if( upperBand > 24.7602 )
						ret := -0.589286
				if( Color_con1 > -5.28946 )
					if( lowerBand <= 0.128601 )
						ret := -0.800000 // sell
					if( lowerBand > 0.128601 )
						ret := 0.278689
			if( midLine > 16.5486 )
				if( wvf <= 37.0352 )
					if( lowerBand <= -1.21968 )
						ret := -0.625000
					if( lowerBand > -1.21968 )
						ret := 0.520408
				if( wvf > 37.0352 )
					if( lowerBand <= 3.22673 )
						ret := 1.000000 // buy
					if( lowerBand > 3.22673 )
						ret := 0.857143 // buy
...
float op_operation = decision_tree_0_SNOW_1Day_401bc95e(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
