	...
	if( senkou_span_b > 216.46 )
		if( chinkou_span <= 220.642 )
			if( tenkan_sen <= 222.76 )
				if( senkou_span_b_displaced <= 229.8 )
					if( chinkou_span <= 216.597 )
						if( senkou_span_b_displaced <= 223.065 )
							ret := -0.431034
						if( senkou_span_b_displaced > 223.065 )
							ret := -0.809091 // sell
					if( chinkou_span > 216.597 )
		...
		if( chinkou_span > 220.642 )
			if( chinkou_span <= 284.3 )
				if( senkou_span_a <= 242.134 )
					if( senkou_span_b_displaced <= 220.323 )
						if( kinjun_sen <= 225.341 )
							ret := 0.312500
						if( kinjun_sen > 225.341 )
							ret := -0.847458 // sell
					if( senkou_span_b_displaced > 220.323 )
						if( senkou_span_b <= 226.948 )
							ret := 0.517986
						if( senkou_span_b > 226.948 )
							ret := 0.074074
				if( senkou_span_a > 242.134 )
					if( tenkan_sen <= 265.446 )
						if( chinkou_span <= 272.46 )
							ret := -0.421569
						if( chinkou_span > 272.46 )
							ret := 0.600000
					if( tenkan_sen > 265.446 )
...
float op_operation = decision_tree_0_ETSY_1Hour_17186d06(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
