		...
		if( bbp <= 3.60158 )
			...
			if( Upper_Band > 303.013 )
				...
				if( bbm > 6.7355 )
					ret := 0.923077 // buy
		if( bbp > 3.60158 )
			if( bullPower <= 7.54612 )
				if( basis <= 236.765 )
					if( bbm <= 0.679606 )
						if( Upper_Band <= 104.471 )
							ret := 0.300000
						if( Upper_Band > 104.471 )
							ret := -0.207447
					if( bbm > 0.679606 )
						if( Lower_Band <= 106.537 )
							ret := 0.119186
						if( Lower_Band > 106.537 )
							ret := 0.402581
				if( basis > 236.765 )
					if( Upper_Band <= 247.085 )
						ret := -0.604651
					if( Upper_Band > 247.085 )
						if( basis <= 254.155 )
							ret := -0.226190
...
float op_operation = decision_tree_0_PYPL_1Hour_52910be8(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
