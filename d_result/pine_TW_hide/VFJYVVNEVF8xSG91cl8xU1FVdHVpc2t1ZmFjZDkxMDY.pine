...
float op_operation = decision_tree_0_TRXUSDT_1Hour_facd9106(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
