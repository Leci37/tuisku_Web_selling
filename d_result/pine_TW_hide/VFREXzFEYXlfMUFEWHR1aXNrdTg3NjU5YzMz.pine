			...
			if( adx <= 18.3336 )
				...
				if( adx > 10.0456 )
					...
					if( diPlus > 16.1071 )
						ret := 0.503497
			if( adx > 18.3336 )
				if( smoothedTrueRange <= 1.83799 )
					if( smoothedDirectionalMovementMinus <= 0.08825 )
						ret := 1.000000 // buy
					if( smoothedDirectionalMovementMinus > 0.08825 )
						ret := 0.571429
				if( smoothedTrueRange > 1.83799 )
					...
					if( adx > 42.0069 )
						ret := 0.120205
		if( smoothedDirectionalMovementPlus > 5.2431 )
			if( trueRange <= 31.9734 )
				if( smoothedDirectionalMovementPlus <= 6.72697 )
					if( diMinus <= 20.2468 )
						ret := 0.566038
					if( diMinus > 20.2468 )
						ret := 0.847826 // buy
				if( smoothedDirectionalMovementPlus > 6.72697 )
					...
					if( adx > 29.904 )
						ret := -0.327586
			if( trueRange > 31.9734 )
				if( smoothedDirectionalMovementPlus <= 16.5422 )
					if( directionalMovementPlus <= 0.05144 )
						ret := 0.078431
					if( directionalMovementPlus > 0.05144 )
						ret := -0.612903
				if( smoothedDirectionalMovementPlus > 16.5422 )
...
float op_operation = decision_tree_0_TTD_1Day_87659c33(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
