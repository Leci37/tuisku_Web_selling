				...
				if( ad_mf > -1.03574e+06 )
					...
					if( ad_mf > 1.39038e+06 )
						...
						if( bearPower > 1.28296 )
							ret := 0.381356
			if( mf > 0.257715 )
				if( bearPower <= -0.190329 )
					if( bbm <= 1.69831 )
						if( ad_mf <= 6.03651e+06 )
							ret := 0.237245
						if( ad_mf > 6.03651e+06 )
							ret := 0.761364 // buy
					if( bbm > 1.69831 )
						if( bullPower <= 1.25218 )
							ret := 0.251046
						if( bullPower > 1.25218 )
							ret := -0.095541
				if( bearPower > -0.190329 )
					if( bullPower <= 7.78893 )
						if( ad_mf <= -1.34496e+07 )
							ret := -0.545455
						if( ad_mf > -1.34496e+07 )
							ret := 0.060216
					if( bullPower > 7.78893 )
						if( bullPower <= 11.8974 )
							ret := 0.782609 // buy
						if( bullPower > 11.8974 )
							ret := -0.111111
		if( ad > 1.70176e+07 )
			if( bullPower <= 8.28523 )
				if( ad_mf <= 4.12805e+07 )
					if( bbm <= 1.841 )
						if( bullPower <= -0.785076 )
							ret := -0.545455
						if( bullPower > -0.785076 )
							ret := 0.312500
					if( bbm > 1.841 )
...
float op_operation = decision_tree_0_AAPL_1Hour_b84526d5(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)
