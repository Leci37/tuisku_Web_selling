...
decision_tree_0_FFIV_1Day_4b5f4fea(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower > 107.485 )
		...
		if( dif_source_BBupper > -100.132 )
			if( BBupper <= 238.167 )
				if( dif_source_BBupper <= -45.4455 )
					if( dif_source_BBlower <= 17.4447 )
						ret := 0.627778
					if( dif_source_BBlower > 17.4447 )
						ret := -0.114754
				if( dif_source_BBupper > -45.4455 )
...
float op_operation = decision_tree_0_FFIV_1Day_4b5f4fea(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
