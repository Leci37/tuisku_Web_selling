			...
			if( MFI_High > -19.9262 )
				...
				if( Positive_Money_Flow > 2.87359e+08 )
					...
					if( Negative_Money_Flow_Sum > 2.037e+09 )
						ret := 0.000000
		if( Typical_Price > 24.493 )
			if( Negative_Money_Flow <= 1.96529e+08 )
				if( Positive_Money_Flow_Sum <= 5.03336e+09 )
					if( Negative_Money_Flow_Sum <= 5.56868e+09 )
						ret := -0.390826
					if( Negative_Money_Flow_Sum > 5.56868e+09 )
						ret := 0.653846
				if( Positive_Money_Flow_Sum > 5.03336e+09 )
					if( Typical_Price <= 73.6825 )
						ret := 0.270833
					if( Typical_Price > 73.6825 )
						ret := -0.379747
			if( Negative_Money_Flow > 1.96529e+08 )
				if( Money_Flow_Ratio <= 3.54319 )
					if( Money_Flow_Ratio <= 1.14017 )
						ret := -0.067024
					if( Money_Flow_Ratio > 1.14017 )
						ret := 0.336585
				if( Money_Flow_Ratio > 3.54319 )
					if( Typical_Price <= 46.0164 )
						ret := -0.166667
					if( Typical_Price > 46.0164 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_PINS_1Day_bbc8a5e7(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
