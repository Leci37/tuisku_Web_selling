					...
					if( basis > 76.5243 )
						...
						if( upper_6 > 77.4958 )
							...
							if( upper_2 > 77.8654 )
								ret := -0.580882
	if( lower_1 > 76.8552 )
		if( basis_minus <= 3.33502 )
			if( upper_3 <= 77.9085 )
				if( upper_5 <= 78.0042 )
					if( basis_minus <= 0.431596 )
						if( upper_6 <= 78.0573 )
							ret := 0.743421 // buy
						if( upper_6 > 78.0573 )
							ret := -0.300000
...
float op_operation = decision_tree_0_UBER_1Min_237aca31(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)
