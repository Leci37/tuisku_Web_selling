	...
	if( wvf > 0.770517 )
		if( sDev <= 2.50062 )
			...
			if( midLine > 5.21329 )
				ret := 0.898734 // buy
		if( sDev > 2.50062 )
			if( upperBand <= 5.43458 )
				if( wvf <= 3.6413 )
					if( upperBand <= 4.12305 )
						if( Color_con2 <= 0.098883 )
							ret := -1.000000 // sell
						if( Color_con2 > 0.098883 )
							ret := 0.333333
					if( upperBand > 4.12305 )
						if( Color_con2 <= 0.962225 )
							ret := 0.555556
						if( Color_con2 > 0.962225 )
							ret := -0.500000
				if( wvf > 3.6413 )
...
float op_operation = decision_tree_0_DDOG_5Min_f1a22d76(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
