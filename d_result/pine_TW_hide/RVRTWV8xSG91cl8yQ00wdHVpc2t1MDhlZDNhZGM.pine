		...
		if( Positive_Money_Flow <= 1.13849e+06 )
			if( MFI <= 93.9974 )
				if( Negative_Money_Flow_Sum <= 7.70147e+08 )
					if( Negative_Money_Flow_Sum <= 6.4905e+08 )
						if( MFI_Low <= 72.5353 )
							ret := 0.055972
						if( MFI_Low > 72.5353 )
							ret := -0.561983
					if( Negative_Money_Flow_Sum > 6.4905e+08 )
						if( Raw_Money_Flow <= 1.29574e+08 )
							ret := -0.800000 // sell
						if( Raw_Money_Flow > 1.29574e+08 )
							ret := 0.666667
				if( Negative_Money_Flow_Sum > 7.70147e+08 )
					ret := 0.850000 // buy
			if( MFI > 93.9974 )
				if( Positive_Money_Flow_Sum <= 8.84459e+08 )
					if( Raw_Money_Flow <= 11355.5 )
						ret := -0.888889 // sell
					if( Raw_Money_Flow > 11355.5 )
						ret := 0.691892
				if( Positive_Money_Flow_Sum > 8.84459e+08 )
					ret := -0.523810
		if( Positive_Money_Flow > 1.13849e+06 )
			if( Negative_Money_Flow_Sum <= 2.58541e+08 )
				if( Typical_Price <= 92.2539 )
					ret := -0.070861
				if( Typical_Price > 92.2539 )
					if( Negative_Money_Flow_Sum <= 1.31415e+08 )
						if( Raw_Money_Flow <= 2.26565e+06 )
							ret := -0.650000
						if( Raw_Money_Flow > 2.26565e+06 )
							ret := -0.011226
					if( Negative_Money_Flow_Sum > 1.31415e+08 )
						if( Positive_Money_Flow_Sum <= 3.7727e+08 )
							ret := 0.240824
						if( Positive_Money_Flow_Sum > 3.7727e+08 )
							ret := -0.098101
			if( Negative_Money_Flow_Sum > 2.58541e+08 )
				if( Typical_Price <= 174.671 )
					ret := -0.302374
				if( Typical_Price > 174.671 )
					ret := 0.150985
...
float op_operation = decision_tree_0_ETSY_1Hour_08ed3adc(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
