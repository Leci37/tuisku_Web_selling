			...
			if( wvf <= 4.77727 )
				if( Color_con2 <= -10.2979 )
					...
					if( wvf > 4.42179 )
						ret := 0.818182 // buy
				if( Color_con2 > -10.2979 )
					if( Color_con1 <= -5.16145 )
						ret := 0.790323 // buy
					if( Color_con1 > -5.16145 )
						ret := -0.450000
			if( wvf > 4.77727 )
				if( Color_con1 <= -4.909 )
					if( Color_con2 <= -27.0342 )
						ret := 0.695652
					if( Color_con2 > -27.0342 )
						ret := -0.523901
				if( Color_con1 > -4.909 )
					if( upperBand <= 27.8829 )
						ret := 0.010000
					if( upperBand > 27.8829 )
						ret := -0.805556 // sell
		if( upperBand > 30.7183 )
			if( wvf <= 27.164 )
				if( Color_con1 <= -28.5554 )
					if( sDev <= 21.1154 )
						ret := -0.619718
					if( sDev > 21.1154 )
						ret := 0.454545
				if( Color_con1 > -28.5554 )
					if( Color_con1 <= -8.22936 )
						ret := 0.686170
					if( Color_con1 > -8.22936 )
						ret := -0.263158
			if( wvf > 27.164 )
...
float op_operation = decision_tree_0_SNAP_1Day_9b0ffabf(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
