		...
		if( Positive_Money_Flow_Sum <= 4.89717e+09 )
			if( Negative_Money_Flow_Sum <= 2.77553e+09 )
				if( Negative_Money_Flow_Sum <= 5.25744e+08 )
					if( Negative_Money_Flow_Sum <= 4.368e+08 )
						ret := 0.636364
					if( Negative_Money_Flow_Sum > 4.368e+08 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 5.25744e+08 )
					if( Typical_Price <= 204.661 )
						ret := -0.028436
					if( Typical_Price > 204.661 )
						ret := -0.240356
			if( Negative_Money_Flow_Sum > 2.77553e+09 )
				if( Negative_Money_Flow_Sum <= 4.70037e+09 )
					if( mf <= 0.224863 )
						ret := -0.614035
					if( mf > 0.224863 )
						ret := 0.400000
				if( Negative_Money_Flow_Sum > 4.70037e+09 )
					if( Typical_Price <= 267.311 )
						ret := 0.625000
					if( Typical_Price > 267.311 )
						ret := -0.214286
		if( Positive_Money_Flow_Sum > 4.89717e+09 )
			if( Negative_Money_Flow_Sum <= 1.56595e+09 )
				if( Raw_Money_Flow <= 3.32301e+08 )
					ret := -0.285714
				if( Raw_Money_Flow > 3.32301e+08 )
					ret := 0.000000
			if( Negative_Money_Flow_Sum > 1.56595e+09 )
				if( Negative_Money_Flow_Sum <= 2.92276e+09 )
					if( Typical_Price <= 277.309 )
						ret := 0.968750 // buy
					if( Typical_Price > 277.309 )
						ret := 0.428571
				if( Negative_Money_Flow_Sum > 2.92276e+09 )
...
float op_operation = decision_tree_0_ADSK_1Day_7f8e1840(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
