			...
			if( bbp <= -0.179003 )
				...
				if( bullPower > -0.045571 )
					...
					if( bbp > -0.189387 )
						ret := 0.250000
			if( bbp > -0.179003 )
				if( bullPower <= -0.015029 )
					if( bbp <= -0.147886 )
						ret := 0.268293
					if( bbp > -0.147886 )
						ret := -0.549296
				if( bullPower > -0.015029 )
					if( bearPower <= 0.064287 )
						ret := 0.276853
					if( bearPower > 0.064287 )
						ret := -0.131148
		if( bbm > 0.137476 )
			if( bbm <= 5.52984 )
				...
				if( bbm > 3.41404 )
					...
					if( bbp > 0.155186 )
						ret := 0.237410
			if( bbm > 5.52984 )
				if( bearPower <= 2.95292 )
					if( bbp <= 8.033 )
						ret := -0.306122
					if( bbp > 8.033 )
						ret := -0.935484 // sell
				if( bearPower > 2.95292 )
					if( bearPower <= 6.88219 )
						ret := 0.800000 // buy
					if( bearPower > 6.88219 )
						ret := -0.375000
...
float op_operation = decision_tree_0_APPS_1Day_17aa8dd3(bullPower, bbp, bearPower, bbm, BBPower_Color)
