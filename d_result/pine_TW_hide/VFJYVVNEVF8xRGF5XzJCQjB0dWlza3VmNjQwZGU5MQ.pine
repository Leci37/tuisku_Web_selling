			...
			if( bearPower > 0.001159 )
				...
				if( Lower_Band > 0.013215 )
					...
					if( Upper_Band > 0.025861 )
						ret := -1.000000 // sell
	if( Lower_Band > 0.015802 )
		if( bullPower <= 0.005104 )
			if( bullPower <= -0.004707 )
				if( bullPower <= -0.006539 )
					if( bbp <= -0.029508 )
						ret := 0.833333 // buy
					if( bbp > -0.029508 )
						ret := 1.000000 // buy
				if( bullPower > -0.006539 )
					if( bearPower <= -0.01098 )
						ret := -0.125000
					if( bearPower > -0.01098 )
						ret := 0.642857
			if( bullPower > -0.004707 )
				if( bullPower <= -0.001435 )
					if( bearPower <= -0.005519 )
						ret := -0.064935
					if( bearPower > -0.005519 )
						ret := -0.591549
				if( bullPower > -0.001435 )
					if( Upper_Band <= 0.118342 )
						ret := -0.014357
					if( Upper_Band > 0.118342 )
						ret := -0.367150
		if( bullPower > 0.005104 )
			if( basis <= 0.027561 )
				ret := -1.000000 // sell
			if( basis > 0.027561 )
				if( Lower_Band <= 0.051567 )
					if( Lower_Band <= 0.02128 )
						ret := -0.333333
					if( Lower_Band > 0.02128 )
						ret := 0.732759 // buy
				if( Lower_Band > 0.051567 )
...
float op_operation = decision_tree_0_TRXUSDT_1Day_f640de91(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
