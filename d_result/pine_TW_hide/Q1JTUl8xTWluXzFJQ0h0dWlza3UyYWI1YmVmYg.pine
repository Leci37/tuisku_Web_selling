	...
	if( senkou_span_b > 6.53758 )
		if( chinkou_span <= 6.51753 )
			...
			if( kinjun_sen > 6.5457 )
				ret := -0.705090 // sell
		if( chinkou_span > 6.51753 )
			if( basis_max <= -0.00027 )
				if( senkou_span_a_displaced <= 11.7149 )
					if( basis_minus <= -0.011256 )
						if( basis_minus <= -0.023533 )
							ret := -0.086390
						if( basis_minus > -0.023533 )
							ret := -0.332251
					if( basis_minus > -0.011256 )
						if( chinkou_span <= 11.7275 )
							ret := -0.046065
						if( chinkou_span > 11.7275 )
							ret := 0.324324
				if( senkou_span_a_displaced > 11.7149 )
					if( chinkou_span <= 11.7692 )
						ret := -0.700758 // sell
					if( chinkou_span > 11.7692 )
						ret := 0.009434
			if( basis_max > -0.00027 )
				if( tenkan_sen <= 6.55323 )
					if( senkou_span_a_displaced <= 6.58943 )
						if( basis_minus <= -0.006928 )
							ret := 0.164706
						if( basis_minus > -0.006928 )
							ret := 0.831325 // buy
					if( senkou_span_a_displaced > 6.58943 )
						ret := 0.769737 // buy
				if( tenkan_sen > 6.55323 )
					if( chinkou_span <= 6.57479 )
						if( senkou_span_b_displaced <= 6.70712 )
							ret := -0.261765
						if( senkou_span_b_displaced > 6.70712 )
							ret := -0.895425 // sell
					if( chinkou_span > 6.57479 )
						if( chinkou_span <= 11.5404 )
							ret := 0.016406
						if( chinkou_span > 11.5404 )
							ret := 0.292802
...
float op_operation = decision_tree_0_CRSR_1Min_2ab5befb(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
