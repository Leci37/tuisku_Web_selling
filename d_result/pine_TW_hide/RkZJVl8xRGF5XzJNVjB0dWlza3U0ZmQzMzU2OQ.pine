...
decision_tree_0_FFIV_1Day_4fd33569(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( VIM > 0.831566 )
		if( Typical_Price <= 122.05 )
			if( MFI_Low <= 54.3982 )
				if( Positive_Money_Flow_Sum <= 9.39723e+08 )
					if( Typical_Price <= 115.855 )
						ret := 0.810000 // buy
					if( Typical_Price > 115.855 )
						ret := 0.447761
				if( Positive_Money_Flow_Sum > 9.39723e+08 )
					if( Negative_Money_Flow_Sum <= 7.83326e+08 )
						ret := 0.571429
					if( Negative_Money_Flow_Sum > 7.83326e+08 )
						ret := -0.777778 // sell
			if( MFI_Low > 54.3982 )
		...
		if( Typical_Price > 122.05 )
			if( VIP <= 0.832133 )
				if( Negative_Money_Flow_Sum <= 1.2181e+09 )
					if( VIP <= 0.805754 )
						ret := -0.671533
					if( VIP > 0.805754 )
						ret := -0.115385
			...
			if( VIP > 0.832133 )
				if( VIM <= 1.09293 )
					...
					if( MFI_High > -18.7632 )
						ret := 0.178058
				if( VIM > 1.09293 )
					if( Negative_Money_Flow <= 1.13895e+06 )
						ret := 0.047297
					if( Negative_Money_Flow > 1.13895e+06 )
						ret := 0.422764
...
float op_operation = decision_tree_0_FFIV_1Day_4fd33569(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
