			...
			if( Negative_Money_Flow > 86249.2 )
				...
				if( d > 15.005 )
					...
					if( MFI > 98.516 )
						ret := 0.250000
	if( rsi1 > 50.8214 )
		if( Money_Flow_Ratio <= 146.787 )
			if( Negative_Money_Flow_Sum <= 3.15089e+07 )
				if( Typical_Price <= 88.1159 )
					if( d <= 69.7776 )
						ret := -0.012887
					if( d > 69.7776 )
						ret := 0.221729
				if( Typical_Price > 88.1159 )
					if( Positive_Money_Flow_Sum <= 1.32274e+08 )
						ret := -0.006340
					if( Positive_Money_Flow_Sum > 1.32274e+08 )
						ret := 0.390728
			if( Negative_Money_Flow_Sum > 3.15089e+07 )
				if( Negative_Money_Flow <= 18587.2 )
					if( Raw_Money_Flow <= 2.73038e+06 )
						ret := -0.290494
					if( Raw_Money_Flow > 2.73038e+06 )
						ret := -0.065765
				if( Negative_Money_Flow > 18587.2 )
					if( Positive_Money_Flow_Sum <= 4.59221e+08 )
						ret := -0.005403
					if( Positive_Money_Flow_Sum > 4.59221e+08 )
						ret := 0.833333 // buy
		if( Money_Flow_Ratio > 146.787 )
			if( Raw_Money_Flow <= 49720.2 )
				if( smoothD_d <= 77.2579 )
					if( MFI_Low <= 79.765 )
						ret := 0.625000
					if( MFI_Low > 79.765 )
						ret := -0.294118
				if( smoothD_d > 77.2579 )
					...
					if( d_k > 0.798991 )
						ret := -1.000000 // sell
			if( Raw_Money_Flow > 49720.2 )
				if( Money_Flow_Ratio <= 218.334 )
					if( Negative_Money_Flow_Sum <= 194737 )
						ret := -0.076923
					if( Negative_Money_Flow_Sum > 194737 )
						ret := -0.688889
				if( Money_Flow_Ratio > 218.334 )
					if( Typical_Price <= 98.4507 )
						ret := -0.454545
					if( Typical_Price > 98.4507 )
						ret := -0.969231 // sell
...
float op_operation = decision_tree_0_DDOG_5Min_334c7fb8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
