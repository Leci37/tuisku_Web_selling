	...
	if( Lower_Band > 57.3715 )
		if( bearPower <= -8.36092 )
			...
			if( bullPower > -3.44145 )
				ret := 0.777778 // buy
		if( bearPower > -8.36092 )
			if( Upper_Band <= 78.5553 )
				if( Upper_Band <= 71.1018 )
					if( Lower_Band <= 58.8977 )
						ret := -1.000000 // sell
					if( Lower_Band > 58.8977 )
						ret := -0.857143 // sell
				if( Upper_Band > 71.1018 )
					if( bearPower <= -2.14602 )
						ret := 1.000000 // buy
					if( bearPower > -2.14602 )
						ret := 0.571429
			if( Upper_Band > 78.5553 )
				if( bearPower <= 3.49971 )
					if( basis <= 81.3208 )
						ret := -0.607595
					if( basis > 81.3208 )
						ret := -0.921053 // sell
...
float op_operation = decision_tree_0_APPS_1Day_155b3b8c(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
