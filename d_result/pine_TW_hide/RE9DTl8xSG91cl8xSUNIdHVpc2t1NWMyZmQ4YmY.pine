			...
			if( basis_max > -0.389765 )
				...
				if( chinkou_span > 50.9772 )
					...
					if( tenkan_sen > 54.5893 )
						ret := -0.603211
	if( chinkou_span > 59.0813 )
		if( senkou_span_b <= 77.281 )
			if( chinkou_span <= 76.3375 )
				if( tenkan_sen <= 56.329 )
					ret := 0.878788 // buy
				if( tenkan_sen > 56.329 )
					if( senkou_span_a <= 69.7999 )
						if( chinkou_span <= 62.5074 )
							ret := 0.076613
						if( chinkou_span > 62.5074 )
							ret := 0.726257 // buy
					if( senkou_span_a > 69.7999 )
						if( senkou_span_b_displaced <= 80.9977 )
							ret := -0.495726
						if( senkou_span_b_displaced > 80.9977 )
							ret := 0.785714 // buy
			if( chinkou_span > 76.3375 )
				ret := 0.777778 // buy
		if( senkou_span_b > 77.281 )
			if( senkou_span_a_displaced <= 78.234 )
				ret := -0.723684 // sell
			if( senkou_span_a_displaced > 78.234 )
				if( chinkou_span <= 102.994 )
					if( basis_minus <= 2.36395 )
						if( senkou_span_a_displaced <= 91.4039 )
							ret := 0.226611
						if( senkou_span_a_displaced > 91.4039 )
							ret := -0.310680
					if( basis_minus > 2.36395 )
						ret := -0.651042
				if( chinkou_span > 102.994 )
					if( senkou_span_b_displaced <= 94.4652 )
						ret := -0.625000
					if( senkou_span_b_displaced > 94.4652 )
...
float op_operation = decision_tree_0_DOCN_1Hour_5c2fd8bf(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
