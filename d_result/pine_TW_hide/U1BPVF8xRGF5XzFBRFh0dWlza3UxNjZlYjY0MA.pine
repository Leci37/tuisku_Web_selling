	...
	if( trueRange > 17.8657 )
		if( dx <= 50.4639 )
			if( diPlus <= 20.8992 )
				ret := 0.400000
			if( diPlus > 20.8992 )
				if( smoothedDirectionalMovementMinus <= 1.8476 )
					ret := 0.200000
				if( smoothedDirectionalMovementMinus > 1.8476 )
					if( adx <= 34.1936 )
						ret := -0.962500 // sell
...
float op_operation = decision_tree_0_SPOT_1Day_166eb640(dx, diMinus, directionalMovementMinus, adx, diPlus, directionalMovementPlus, smoothedTrueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, trueRange)
