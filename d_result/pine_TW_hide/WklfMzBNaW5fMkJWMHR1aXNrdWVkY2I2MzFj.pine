				...
				if( bbm > 2.00259 )
					...
					if( VIP_VIM > -0.366497 )
						...
						if( VIP > 0.785911 )
							ret := 0.449153
			if( VIP_VIM > -0.098025 )
				if( bearPower <= -0.654426 )
					if( bearPower <= -0.906548 )
						if( bbm <= 0.160319 )
							ret := 0.825000 // buy
						if( bbm > 0.160319 )
							ret := 0.023504
					if( bearPower > -0.906548 )
						...
						if( VIP > 1.23289 )
							ret := 0.074074
				if( bearPower > -0.654426 )
					if( bullPower <= -0.040182 )
						if( bbp <= -0.65439 )
							ret := 0.218750
						if( bbp > -0.65439 )
							ret := -0.177043
					if( bullPower > -0.040182 )
						if( bearPower <= -0.606143 )
							ret := -0.534091
						if( bearPower > -0.606143 )
							ret := 0.143809
	if( bbp > 0.085707 )
		...
		if( VIP_VIM > 0.108533 )
			if( VIP <= 1.69121 )
				if( bbp <= 5.6025 )
					if( bullPower <= 0.604211 )
						if( bullPower <= 0.344351 )
							ret := -0.013545
						if( bullPower > 0.344351 )
							ret := 0.152464
					if( bullPower > 0.604211 )
...
float op_operation = decision_tree_0_ZI_30Min_edcb631c(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP_VIM, VIP, VIM)
