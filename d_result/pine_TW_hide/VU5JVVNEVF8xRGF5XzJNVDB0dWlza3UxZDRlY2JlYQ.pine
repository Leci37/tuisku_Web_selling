			...
			if( ema12 <= -0.514213 )
				...
				if( ema2 > 16.0361 )
					...
					if( ema12 > -1.4857 )
						ret := -0.469388
			if( ema12 > -0.514213 )
				if( Negative_Money_Flow <= 4.59536e+06 )
					if( ema12 <= 0.194467 )
						ret := -0.392523
					if( ema12 > 0.194467 )
						ret := 0.156250
				if( Negative_Money_Flow > 4.59536e+06 )
					if( Negative_Money_Flow_Sum <= 1.94484e+08 )
						ret := -0.697778
					if( Negative_Money_Flow_Sum > 1.94484e+08 )
						ret := -0.355140
		if( Raw_Money_Flow > 4.08245e+07 )
			if( ema1 <= 27.9726 )
				if( Negative_Money_Flow_Sum <= 4.27744e+08 )
					if( ema13 <= 1.18109 )
						ret := -0.336449
					if( ema13 > 1.18109 )
						ret := 0.328125
				if( Negative_Money_Flow_Sum > 4.27744e+08 )
					if( Typical_Price <= 24.3355 )
						ret := 0.533333
					if( Typical_Price > 24.3355 )
						ret := -0.092593
			if( ema1 > 27.9726 )
				if( Positive_Money_Flow_Sum <= 1.31072e+09 )
					if( Negative_Money_Flow_Sum <= 2.40794e+08 )
						ret := 0.750000 // buy
					if( Negative_Money_Flow_Sum > 2.40794e+08 )
						ret := -0.686747
				if( Positive_Money_Flow_Sum > 1.31072e+09 )
					if( Negative_Money_Flow_Sum <= 5.08384e+08 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 5.08384e+08 )
						ret := 0.428571
...
float op_operation = decision_tree_0_UNIUSDT_1Day_1d4ecbea(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
