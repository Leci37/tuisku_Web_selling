		...
		if( Raw_Money_Flow <= 1.72524e+06 )
			...
			if( Negative_Money_Flow_Sum > 2.27829e+08 )
				if( Short_Long_Diff <= 0.410229 )
					if( MFI_Low <= 30.0261 )
						if( Positive_Money_Flow_Sum <= 3.71936e+08 )
							ret := 0.035234
						if( Positive_Money_Flow_Sum > 3.71936e+08 )
							ret := -0.301250
					if( MFI_Low > 30.0261 )
						ret := -0.179872
				if( Short_Long_Diff > 0.410229 )
					if( Positive_Money_Flow_Sum <= 5.971e+08 )
						if( Negative_Money_Flow_Sum <= 6.02591e+08 )
							ret := 0.732984 // buy
						if( Negative_Money_Flow_Sum > 6.02591e+08 )
							ret := -1.000000 // sell
					if( Positive_Money_Flow_Sum > 5.971e+08 )
						if( Positive_Money_Flow_Sum <= 2.36571e+09 )
							ret := -0.110865
						if( Positive_Money_Flow_Sum > 2.36571e+09 )
							ret := 0.744186 // buy
		if( Raw_Money_Flow > 1.72524e+06 )
			if( MFI_Low <= -6.94566 )
				ret := 0.431280
			if( MFI_Low > -6.94566 )
				if( Negative_Money_Flow_Sum <= 4.65333e+08 )
					if( Positive_Money_Flow <= 5.89524e+08 )
						if( Short_Long_Diff <= -0.067393 )
							ret := -0.053234
						if( Short_Long_Diff > -0.067393 )
							ret := 0.089969
					if( Positive_Money_Flow > 5.89524e+08 )
				...
				if( Negative_Money_Flow_Sum > 4.65333e+08 )
					if( Long_MA <= 46.4626 )
						if( Typical_Price <= 22.4076 )
							ret := 0.727273 // buy
						if( Typical_Price > 22.4076 )
							ret := -0.230128
					if( Long_MA > 46.4626 )
						if( Negative_Money_Flow_Sum <= 6.6236e+08 )
							ret := 0.198428
						if( Negative_Money_Flow_Sum > 6.6236e+08 )
							ret := -0.138376
...
float op_operation = decision_tree_0_UBER_1Hour_eab2bb51(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
