...
decision_tree_0_PYPL_1Day_e7c16fd8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( Typical_Price > 74.0066 )
			...
			if( rsi1 <= 49.1171 )
				if( Raw_Money_Flow <= 8.40815e+08 )
					...
					if( MFI_High > -28.9899 )
						ret := -0.024390
				if( Raw_Money_Flow > 8.40815e+08 )
					if( smoothD_d <= 32.7049 )
						ret := -0.225146
					if( smoothD_d > 32.7049 )
						ret := 0.263780
			if( rsi1 > 49.1171 )
				if( Typical_Price <= 97.5818 )
					if( MFI <= 49.8194 )
						ret := -0.847826 // sell
					if( MFI > 49.8194 )
						ret := -0.203931
		...
		if( Negative_Money_Flow > 2.61299e+09 )
			if( rsi1 <= 18.9023 )
				if( Raw_Money_Flow <= 3.6942e+09 )
					ret := 1.000000 // buy
				if( Raw_Money_Flow > 3.6942e+09 )
					ret := -0.600000
			if( rsi1 > 18.9023 )
				if( Typical_Price <= 181.986 )
					if( k <= 62.2616 )
						ret := -0.928571 // sell
					if( k > 62.2616 )
						ret := 1.000000 // buy
				if( Typical_Price > 181.986 )
					if( Negative_Money_Flow_Sum <= 1.48619e+10 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 1.48619e+10 )
						ret := -0.279070
...
float op_operation = decision_tree_0_PYPL_1Day_e7c16fd8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
