		...
		if( BBlower <= -224.801 )
			...
			if( dif_source_BBlower > 2029.87 )
				if( vrsi <= 65.7081 )
					ret := -1.000000 // sell
				if( vrsi > 65.7081 )
					if( dif_source_BBupper <= 718.821 )
						ret := -0.250000
					if( dif_source_BBupper > 718.821 )
						ret := -1.000000 // sell
		if( BBlower > -224.801 )
			if( BBupper <= 285.825 )
				if( dif_source_BBupper <= 30.5408 )
					if( dif_source_BBlower <= 78.7908 )
						ret := 0.735294 // buy
					if( dif_source_BBlower > 78.7908 )
						ret := 0.346154
				if( dif_source_BBupper > 30.5408 )
					...
					if( BBlower > 72.5171 )
						ret := -1.000000 // sell
			if( BBupper > 285.825 )
				if( dif_source_BBupper <= -21.1761 )
					if( dif_source_BBupper <= -113.856 )
						ret := 0.123139
					if( dif_source_BBupper > -113.856 )
						ret := -0.255474
				if( dif_source_BBupper > -21.1761 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_0caacdaa(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
