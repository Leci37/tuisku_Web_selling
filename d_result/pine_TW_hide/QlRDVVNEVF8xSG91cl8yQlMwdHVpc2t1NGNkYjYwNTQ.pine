...
decision_tree_0_BTCUSDT_1Hour_4cdb6054(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( d_k <= 0.654737 )
		...
		if( rsi1 > 52.6659 )
			...
			if( bearPower > -109.469 )
				if( rsi1 <= 65.0322 )
					if( bbp <= 879.86 )
						if( bearPower <= -29.5156 )
							ret := 0.268612
						if( bearPower > -29.5156 )
							ret := 0.069260
					if( bbp > 879.86 )
						if( smoothK_k <= 79.0863 )
							ret := -0.427746
						if( smoothK_k > 79.0863 )
							ret := -0.039683
				if( rsi1 > 65.0322 )
					if( bearPower <= -7.53078 )
						if( d <= 18.1819 )
							ret := 0.083333
						if( d > 18.1819 )
							ret := 0.646507
	...
	if( d_k > 0.654737 )
		if( rsi1 <= 33.5764 )
			...
			if( bbp > -0.750362 )
				if( bbm <= 150.725 )
					if( bullPower <= 52.1483 )
						if( bearPower <= -27.1916 )
							ret := -1.000000 // sell
						if( bearPower > -27.1916 )
							ret := -0.666667
					if( bullPower > 52.1483 )
				...
				if( bbm > 150.725 )
					...
					if( d_k > 26.512 )
						ret := -0.545455
		if( rsi1 > 33.5764 )
			if( bullPower <= 329.751 )
				if( rsi1 <= 51.1234 )
					if( bullPower <= 65.5784 )
						if( rsi1 <= 43.3781 )
							ret := -0.111495
						if( rsi1 > 43.3781 )
							ret := 0.064502
...
float op_operation = decision_tree_0_BTCUSDT_1Hour_4cdb6054(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
