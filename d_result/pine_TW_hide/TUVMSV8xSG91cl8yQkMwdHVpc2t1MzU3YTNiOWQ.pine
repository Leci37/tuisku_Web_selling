				...
				if( BBPower_Color > 0.5 )
					if( mf <= 0.134461 )
						...
						if( ad_mf > 195984 )
							ret := -0.300000
					if( mf > 0.134461 )
						if( bullPower <= 26.2722 )
							ret := -0.421053
						if( bullPower > 26.2722 )
							ret := 0.272727
	if( mf > 0.226194 )
		if( ad_mf <= -0.237201 )
			if( bearPower <= 20.6929 )
				if( bearPower <= -16.6646 )
					if( bbm <= 22.8483 )
						ret := -0.750000 // sell
					if( bbm > 22.8483 )
						ret := -0.181818
				...
				if( bullPower > 27.9597 )
					if( mf <= 0.305803 )
						...
						if( bbm > 11.449 )
							ret := 0.266667
					if( mf > 0.305803 )
						if( bullPower <= 43.6623 )
							ret := 0.023256
						if( bullPower > 43.6623 )
							ret := 0.625000
		if( ad_mf > -0.237201 )
			if( ad_mf <= 4696.16 )
				if( bullPower <= 12.7892 )
					if( bbp <= 8.82849 )
						if( bullPower <= 4.59438 )
							ret := 0.641026
						if( bullPower > 4.59438 )
							ret := 0.083333
					if( bbp > 8.82849 )
...
float op_operation = decision_tree_0_MELI_1Hour_357a3b9d(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
