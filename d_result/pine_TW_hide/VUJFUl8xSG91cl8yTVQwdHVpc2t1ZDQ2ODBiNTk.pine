	...
	if( Positive_Money_Flow_Sum <= 2.06331e+09 )
		...
		if( Typical_Price > 27.3234 )
			if( MFI <= 4.54427 )
				if( ema3 <= 38.9179 )
					if( ema2 <= 30.8617 )
						if( Negative_Money_Flow_Sum <= 3.58435e+08 )
							ret := -0.250000
						if( Negative_Money_Flow_Sum > 3.58435e+08 )
							ret := 0.884615 // buy
					if( ema2 > 30.8617 )
				...
				if( ema3 > 38.9179 )
					if( ema12 <= -0.36342 )
						...
						if( ema12 > -1.10776 )
							ret := 0.658537
					if( ema12 > -0.36342 )
						if( Positive_Money_Flow_Sum <= 4.21195e+06 )
							ret := -0.025641
						if( Positive_Money_Flow_Sum > 4.21195e+06 )
							ret := 0.500000
			if( MFI > 4.54427 )
				if( Negative_Money_Flow_Sum <= 6.71398e+08 )
					if( ema3 <= 48.7204 )
						if( Negative_Money_Flow_Sum <= 4.53e+08 )
							ret := -0.001050
						if( Negative_Money_Flow_Sum > 4.53e+08 )
							ret := -0.102707
					if( ema3 > 48.7204 )
						if( Raw_Money_Flow <= 4.92006e+07 )
							ret := 0.126653
						if( Raw_Money_Flow > 4.92006e+07 )
							ret := 0.008068
				if( Negative_Money_Flow_Sum > 6.71398e+08 )
					if( ema13 <= -0.155748 )
						if( Raw_Money_Flow <= 58943.8 )
							ret := -0.402062
						if( Raw_Money_Flow > 58943.8 )
							ret := -0.017287
					if( ema13 > -0.155748 )
						if( Positive_Money_Flow <= 4.48513e+08 )
							ret := -0.214503
						if( Positive_Money_Flow > 4.48513e+08 )
							ret := 0.625000
	if( Positive_Money_Flow_Sum > 2.06331e+09 )
		if( Positive_Money_Flow_Sum <= 2.8474e+09 )
			if( ema12 <= -0.175619 )
				ret := -0.166667
			if( ema12 > -0.175619 )
				if( ema12 <= 0.455717 )
					if( Negative_Money_Flow <= 4.53989e+08 )
						if( ema1 <= 66.6469 )
							ret := 0.942029 // buy
						if( ema1 > 66.6469 )
							ret := 0.000000
					if( Negative_Money_Flow > 4.53989e+08 )
						ret := -1.000000 // sell
				if( ema12 > 0.455717 )
					if( Typical_Price <= 35.6685 )
						if( Negative_Money_Flow_Sum <= 2.14015e+08 )
							ret := 1.000000 // buy
						if( Negative_Money_Flow_Sum > 2.14015e+08 )
							ret := 0.888889 // buy
					if( Typical_Price > 35.6685 )
						...
						if( MFI_High > 17.7325 )
							ret := -0.333333
		if( Positive_Money_Flow_Sum > 2.8474e+09 )
			if( Money_Flow_Ratio <= 1.39758 )
				ret := -1.000000 // sell
			if( Money_Flow_Ratio > 1.39758 )
				if( Raw_Money_Flow <= 3.7611e+08 )
					if( Negative_Money_Flow_Sum <= 5.73628e+08 )
						if( Positive_Money_Flow <= 26981.2 )
							ret := 0.466667
						if( Positive_Money_Flow > 26981.2 )
							ret := -0.571429
					if( Negative_Money_Flow_Sum > 5.73628e+08 )
...
float op_operation = decision_tree_0_UBER_1Hour_d4680b59(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
