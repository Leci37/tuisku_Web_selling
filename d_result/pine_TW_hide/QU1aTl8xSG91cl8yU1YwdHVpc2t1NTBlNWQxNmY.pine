...
decision_tree_0_AMZN_1Hour_50e5d16f(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)=>
				...
				if( VIP <= 1.12982 )
					if( k <= 3.77194 )
						...
						if( d_k > 5.48077 )
							ret := -0.361858
					if( k > 3.77194 )
						if( smoothD_d <= 8.71285 )
							ret := 0.367347
						if( smoothD_d > 8.71285 )
							ret := -0.555556
				if( VIP > 1.12982 )
					if( smoothK_k <= 1.81324 )
						if( d_k <= 6.79 )
							ret := -0.233333
						if( d_k > 6.79 )
							ret := 0.642857
	...
	if( d > 13.1445 )
		...
		if( VIP_VIM > 0.693831 )
			if( d_k <= -0.213476 )
				if( smoothD_d <= 93.0129 )
					if( smoothD_d <= 48.8255 )
						if( VIP <= 1.44471 )
							ret := 0.454545
						if( VIP > 1.44471 )
							ret := 0.842105 // buy
					if( smoothD_d > 48.8255 )
						...
						if( k > 78.9435 )
							ret := 0.161290
				if( smoothD_d > 93.0129 )
					if( smoothD_d <= 95.3598 )
						if( smoothD_d <= 94.3037 )
							ret := -0.886364 // sell
						if( smoothD_d > 94.3037 )
							ret := -0.410256
					if( smoothD_d > 95.3598 )
...
float op_operation = decision_tree_0_AMZN_1Hour_50e5d16f(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)
