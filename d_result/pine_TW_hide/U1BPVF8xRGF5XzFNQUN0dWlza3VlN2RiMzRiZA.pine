...
float op_operation = decision_tree_0_SPOT_1Day_e7db34bd(signal, histA_IsDownInt, macd, hist, histA_IsUpInt, histB_IsDownInt, histB_IsUpInt, macd_IsBelowInt, macd_IsAboveInt)
