			...
			if( VIP > 1.37317 )
				...
				if( Typical_Price > 316.527 )
					...
					if( MFI > 66.0849 )
						ret := -0.888889 // sell
		if( VIM > 0.88543 )
			if( Money_Flow_Ratio <= 0.200955 )
				if( MFI_High <= -73.175 )
					ret := 0.800000 // buy
				if( MFI_High > -73.175 )
					if( Raw_Money_Flow <= 2.33733e+08 )
						ret := -0.166667
					if( Raw_Money_Flow > 2.33733e+08 )
						ret := -0.826087 // sell
			if( Money_Flow_Ratio > 0.200955 )
				if( Positive_Money_Flow_Sum <= 8.47183e+09 )
					if( Positive_Money_Flow_Sum <= 1.51535e+09 )
						ret := -0.146341
					if( Positive_Money_Flow_Sum > 1.51535e+09 )
						ret := 0.120837
				if( Positive_Money_Flow_Sum > 8.47183e+09 )
					if( Negative_Money_Flow <= 5.36697e+06 )
						ret := -0.250000
					if( Negative_Money_Flow > 5.36697e+06 )
						ret := -0.842105 // sell
...
float op_operation = decision_tree_0_TWLO_1Day_3ccf8700(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
