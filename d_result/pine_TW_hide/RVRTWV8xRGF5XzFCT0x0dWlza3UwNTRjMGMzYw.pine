			...
			if( dif_source_BBupper > -10.2497 )
				...
				if( dif_source_BBlower > 28.5518 )
					...
					if( dif_source_BBupper > -5.58982 )
						ret := 0.068657
	if( BBlower > 36.9373 )
		if( dif_source_BBupper <= -221.268 )
			if( BBupper <= 296.855 )
				ret := 1.000000 // buy
			if( BBupper > 296.855 )
				ret := 0.000000
		if( dif_source_BBupper > -221.268 )
			if( dif_source_BBlower <= 5.42583 )
				if( BBupper <= 74.1578 )
					if( dif_source_BBupper <= -31.4268 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > -31.4268 )
						ret := -0.810811 // sell
				if( BBupper > 74.1578 )
					...
					if( BBlower > 109.264 )
						ret := 0.833333 // buy
			if( dif_source_BBlower > 5.42583 )
				if( dif_source_BBupper <= -111.638 )
					if( dif_source_BBlower <= 8.6659 )
						ret := 0.000000
					if( dif_source_BBlower > 8.6659 )
						ret := -0.780488 // sell
				if( dif_source_BBupper > -111.638 )
...
float op_operation = decision_tree_0_ETSY_1Day_054c0c3c(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
