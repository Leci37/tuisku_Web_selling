			...
			if( rsi1 <= 72.0662 )
				if( MFI_High <= -43.7449 )
					if( Positive_Money_Flow <= 156000 )
						if( Negative_Money_Flow_Sum <= 4.50115e+07 )
							ret := -0.254417
						if( Negative_Money_Flow_Sum > 4.50115e+07 )
							ret := 0.048977
					if( Positive_Money_Flow > 156000 )
						if( Typical_Price <= 17.5608 )
							ret := 0.428571
						if( Typical_Price > 17.5608 )
							ret := -0.273879
				if( MFI_High > -43.7449 )
					if( Positive_Money_Flow_Sum <= 1.01445e+08 )
						if( Negative_Money_Flow_Sum <= 1.26322e+07 )
							ret := -0.182500
						if( Negative_Money_Flow_Sum > 1.26322e+07 )
							ret := 0.059109
					if( Positive_Money_Flow_Sum > 1.01445e+08 )
						if( Typical_Price <= 33.9198 )
							ret := 0.003992
						if( Typical_Price > 33.9198 )
							ret := -0.278351
			if( rsi1 > 72.0662 )
				if( MFI_Low <= 50.4069 )
					if( Positive_Money_Flow <= 3.95097e+06 )
						if( Negative_Money_Flow <= 2.89042e+06 )
							ret := -0.601036
						if( Negative_Money_Flow > 2.89042e+06 )
							ret := -0.162162
					if( Positive_Money_Flow > 3.95097e+06 )
						ret := -0.214286
				if( MFI_Low > 50.4069 )
					if( smoothD_d <= 66.2572 )
						if( Typical_Price <= 30.0787 )
							ret := -0.706667 // sell
						if( Typical_Price > 30.0787 )
							ret := 0.112903
					if( smoothD_d > 66.2572 )
						if( Positive_Money_Flow_Sum <= 1.26266e+08 )
							ret := 0.084848
						if( Positive_Money_Flow_Sum > 1.26266e+08 )
							ret := -0.372340
...
float op_operation = decision_tree_0_NVST_1Hour_1524cb9f(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
