		...
		if( Positive_Money_Flow_Sum <= 3.89591e+10 )
			if( Negative_Money_Flow_Sum <= 4.05285e+09 )
				if( Negative_Money_Flow_Sum <= 2.64484e+08 )
					if( Typical_Price <= 7427.8 )
						ret := 0.170732
					if( Typical_Price > 7427.8 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 2.64484e+08 )
					if( Typical_Price <= 9498.35 )
						ret := 0.244505
					if( Typical_Price > 9498.35 )
						ret := -0.191057
			if( Negative_Money_Flow_Sum > 4.05285e+09 )
				if( Typical_Price <= 39901.7 )
					if( MFI_High <= -16.3049 )
						ret := 0.469136
					if( MFI_High > -16.3049 )
						ret := 0.810127 // buy
				if( Typical_Price > 39901.7 )
					if( Money_Flow_Ratio <= 3.95575 )
						ret := -0.098592
					if( Money_Flow_Ratio > 3.95575 )
						ret := 0.588235
		if( Positive_Money_Flow_Sum > 3.89591e+10 )
			if( Typical_Price <= 52367.1 )
				if( MFI_Low <= 49.3094 )
					if( Negative_Money_Flow_Sum <= 2.97279e+10 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 2.97279e+10 )
						ret := 0.000000
				if( MFI_Low > 49.3094 )
					if( Positive_Money_Flow_Sum <= 4.16583e+10 )
						ret := 0.769231 // buy
					if( Positive_Money_Flow_Sum > 4.16583e+10 )
						ret := -0.200000
			if( Typical_Price > 52367.1 )
				if( Money_Flow_Ratio <= 2.29274 )
					ret := -0.285714
				if( Money_Flow_Ratio > 2.29274 )
					if( MFI <= 82.2396 )
						ret := -0.903226 // sell
...
float op_operation = decision_tree_0_BTCUSDT_1Day_3a57696b(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
