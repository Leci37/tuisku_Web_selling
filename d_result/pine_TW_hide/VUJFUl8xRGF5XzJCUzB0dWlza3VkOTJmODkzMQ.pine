			...
			if( rsi1 > 72.9033 )
				...
				if( smoothD_d > 87.1363 )
					...
					if( d_k > -2.4126 )
						ret := 0.300000
	if( d_k > -0.10446 )
		if( smoothK_k <= 21.6867 )
			if( bullPower <= 0.964301 )
				if( bbm <= 1.69261 )
					if( bbp <= -3.37726 )
						ret := 0.687500
					if( bbp > -3.37726 )
...
float op_operation = decision_tree_0_UBER_1Day_d92f8931(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)
