			...
			if( Positive_Money_Flow_Sum > 147258 )
				...
				if( Typical_Price > 47.6609 )
					...
					if( Negative_Money_Flow_Sum > 8.5662e+06 )
						ret := 0.006250
	if( MFI > 11.7056 )
		if( Positive_Money_Flow_Sum <= 152361 )
			if( rsi1 <= 61.82 )
				if( Typical_Price <= 30.8021 )
					if( k <= 44.0147 )
						ret := 0.916667 // buy
					if( k > 44.0147 )
						ret := -0.727273 // sell
				if( Typical_Price > 30.8021 )
					if( Positive_Money_Flow_Sum <= 57922.4 )
						ret := 0.500000
					if( Positive_Money_Flow_Sum > 57922.4 )
						ret := -0.517606
			if( rsi1 > 61.82 )
				if( Negative_Money_Flow_Sum <= 164412 )
					ret := 0.909091 // buy
				if( Negative_Money_Flow_Sum > 164412 )
					ret := 0.600000
		if( Positive_Money_Flow_Sum > 152361 )
			if( d_k <= 2.36343 )
				if( Negative_Money_Flow_Sum <= 3.70743e+07 )
					if( Raw_Money_Flow <= 128296 )
						ret := 0.087473
					if( Raw_Money_Flow > 128296 )
						ret := 0.005768
				if( Negative_Money_Flow_Sum > 3.70743e+07 )
					if( Positive_Money_Flow <= 1.24689e+07 )
						ret := -0.292562
					if( Positive_Money_Flow > 1.24689e+07 )
						ret := 0.381579
			if( d_k > 2.36343 )
				if( Raw_Money_Flow <= 34794 )
					if( MFI <= 44.3607 )
						ret := 0.063291
					if( MFI > 44.3607 )
						ret := 0.388383
				if( Raw_Money_Flow > 34794 )
					if( Positive_Money_Flow_Sum <= 3.20023e+08 )
						ret := 0.068620
					if( Positive_Money_Flow_Sum > 3.20023e+08 )
						ret := -0.826087 // sell
...
float op_operation = decision_tree_0_GTLB_5Min_1c531814(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
