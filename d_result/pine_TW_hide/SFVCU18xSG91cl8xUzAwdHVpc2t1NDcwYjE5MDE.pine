...
decision_tree_0_HUBS_1Hour_470b1901(d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( d > 27.7384 )
				...
				if( smoothK_k <= 17.613 )
					if( k <= 14.2296 )
						...
						if( k > 8.5566 )
							ret := -0.300000
					if( k > 14.2296 )
						if( smoothK_k <= 11.8726 )
							ret := 1.000000 // buy
						if( smoothK_k > 11.8726 )
							ret := 0.676923
				if( smoothK_k > 17.613 )
					if( smoothK_k <= 21.0334 )
						if( d <= 29.7264 )
							ret := -0.296296
						if( d > 29.7264 )
							ret := -0.833333 // sell
		...
		if( d > 30.6702 )
			if( d_k <= 22.7386 )
				if( smoothD_d <= 96.7818 )
					if( d_k <= -22.3542 )
						if( smoothK_k <= 65.0546 )
							ret := -0.622222
						if( smoothK_k > 65.0546 )
							ret := -0.092537
					if( d_k > -22.3542 )
...
float op_operation = decision_tree_0_HUBS_1Hour_470b1901(d, d_k, smoothK_k, k, rsi1, smoothD_d)
