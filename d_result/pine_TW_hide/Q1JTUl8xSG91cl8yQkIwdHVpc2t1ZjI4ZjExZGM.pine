			...
			if( basis > 12.0878 )
				if( Lower_Band <= 20.6766 )
					...
					if( basis > 20.9296 )
						ret := 0.574850
				if( Lower_Band > 20.6766 )
					if( Upper_Band <= 23.7197 )
						if( basis <= 22.6514 )
							ret := -0.460870
						if( basis > 22.6514 )
							ret := -0.985075 // sell
					if( Upper_Band > 23.7197 )
						if( bullPower <= 0.595203 )
							ret := -0.209336
						if( bullPower > 0.595203 )
							ret := 0.008380
...
float op_operation = decision_tree_0_CRSR_1Hour_f28f11dc(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
