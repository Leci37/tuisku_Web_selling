...
decision_tree_0_DOCN_1Hour_da8a49eb(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
				...
				if( k <= 66.3023 )
					...
					if( rsi1 > 60.0779 )
						...
						if( bbp > 2.11187 )
							ret := -0.692308
				if( k > 66.3023 )
					if( bullPower <= 0.086075 )
						if( smoothK_k <= 92.9254 )
							ret := -0.288889
						if( smoothK_k > 92.9254 )
							ret := 0.523810
					if( bullPower > 0.086075 )
	...
	if( d_k > -4.11509 )
		if( bullPower <= -1.57888 )
			...
			if( bbp > -10.3061 )
				if( rsi1 <= 30.3276 )
					if( bullPower <= -2.01016 )
						if( smoothD_d <= 7.36146 )
							ret := 0.553571
						if( smoothD_d > 7.36146 )
							ret := 0.929577 // buy
					if( bullPower > -2.01016 )
						if( smoothK_k <= 13.4805 )
							ret := 0.485714
						if( smoothK_k > 13.4805 )
							ret := -0.200000
				if( rsi1 > 30.3276 )
					if( smoothK_k <= 32.2422 )
						if( bearPower <= -3.25441 )
							ret := 0.000000
						if( bearPower > -3.25441 )
							ret := -0.705882 // sell
					if( smoothK_k > 32.2422 )
...
float op_operation = decision_tree_0_DOCN_1Hour_da8a49eb(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
