			...
			if( oscp > -23.7183 )
				...
				if( media > 56.3468 )
					...
					if( stoc > 38.9146 )
						ret := 0.000000
		if( verde_media > -54.8217 )
			if( azul_mean <= 6.92756 )
				if( pvimin <= 1.30593 )
					if( verde_media <= -19.571 )
						ret := -0.753968 // sell
					if( verde_media > -19.571 )
						ret := -0.347368
				if( pvimin > 1.30593 )
...
float op_operation = decision_tree_0_DDOG_1Day_61efd8b9(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
