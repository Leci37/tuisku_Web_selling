	...
	if( Negative_Money_Flow_Sum > 884854 )
		if( Raw_Money_Flow <= 2.6865e+06 )
			if( Negative_Money_Flow_Sum <= 4.93265e+07 )
				...
				if( Typical_Price > 209.174 )
					if( MFI <= 54.4252 )
						if( Positive_Money_Flow_Sum <= 8.45392e+06 )
							ret := -0.124373
						if( Positive_Money_Flow_Sum > 8.45392e+06 )
							ret := -0.544974
					if( MFI > 54.4252 )
						if( Positive_Money_Flow_Sum <= 5.98553e+06 )
							ret := 0.166284
						if( Positive_Money_Flow_Sum > 5.98553e+06 )
							ret := -0.093491
			if( Negative_Money_Flow_Sum > 4.93265e+07 )
		...
		if( Raw_Money_Flow > 2.6865e+06 )
			if( MFI_Low <= 12.0501 )
				if( Typical_Price <= 199.907 )
					if( Money_Flow_Ratio <= 0.345342 )
						ret := -0.112903
					if( Money_Flow_Ratio > 0.345342 )
						ret := 0.705882 // buy
				if( Typical_Price > 199.907 )
			...
			if( MFI_Low > 12.0501 )
				if( MFI_High <= -25.0067 )
					...
					if( MFI_Low > 23.0344 )
						ret := -0.361842
				if( MFI_High > -25.0067 )
					if( Positive_Money_Flow_Sum <= 2.23168e+07 )
						if( Positive_Money_Flow <= 8.67764e+06 )
							ret := 0.198830
						if( Positive_Money_Flow > 8.67764e+06 )
							ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 2.23168e+07 )
						if( Negative_Money_Flow_Sum <= 2.94886e+07 )
							ret := -0.190184
						if( Negative_Money_Flow_Sum > 2.94886e+07 )
							ret := 0.600000
...
float op_operation = decision_tree_0_EPAM_1Min_92fd4d40(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
