			...
			if( Lower_Band > 194.102 )
				...
				if( Upper_Band > 261.545 )
					...
					if( bbm > 22.36 )
						ret := -0.250000
		if( bullPower > -11.3102 )
			if( Lower_Band <= 81.7763 )
				if( bearPower <= 6.46713 )
					if( bearPower <= -8.45067 )
						ret := 0.000000
					if( bearPower > -8.45067 )
						ret := -0.966667 // sell
				if( bearPower > 6.46713 )
					...
					if( bbm > 6.4046 )
						ret := 1.000000 // buy
			if( Lower_Band > 81.7763 )
				if( Lower_Band <= 232.123 )
					if( basis <= 180.053 )
						ret := -0.057096
					if( basis > 180.053 )
						ret := 0.233266
				if( Lower_Band > 232.123 )
					if( Lower_Band <= 250.165 )
						ret := -0.639175
					if( Lower_Band > 250.165 )
						ret := 0.111913
...
float op_operation = decision_tree_0_SPOT_1Day_09a91348(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
