		...
		if( Color_con1 > -6.21559 )
			if( midLine <= 7.37859 )
				if( Color_con2 <= 6.28479 )
					if( lowerBand <= -2.46909 )
						if( Color_con1 <= -2.67424 )
							ret := -0.094340
						if( Color_con1 > -2.67424 )
							ret := -0.635870
					if( lowerBand > -2.46909 )
				...
				if( midLine > 8.26867 )
					if( wvf <= 15.4684 )
						...
						if( sDev > 3.59233 )
							ret := -0.332487
					if( wvf > 15.4684 )
						if( upperBand <= 16.9394 )
							ret := 0.047619
						if( upperBand > 16.9394 )
							ret := 0.725000 // buy
	if( wvf > 21.5564 )
		if( lowerBand <= -3.93052 )
			if( upperBand <= 29.1958 )
				if( Color_con2 <= 18.7571 )
					ret := 0.714286 // buy
				if( Color_con2 > 18.7571 )
					if( Color_con2 <= 25.5918 )
						if( wvf <= 25.5417 )
							ret := -0.300000
						if( wvf > 25.5417 )
							ret := -1.000000 // sell
			...
			if( upperBand > 29.1958 )
				if( sDev <= 19.2505 )
					ret := 0.500000
				if( sDev > 19.2505 )
					if( Color_con1 <= -12.4686 )
						if( sDev <= 29.1286 )
							ret := 1.000000 // buy
						if( sDev > 29.1286 )
							ret := -0.833333 // sell
					if( Color_con1 > -12.4686 )
						if( Color_con1 <= -10.9035 )
							ret := -0.884615 // sell
						if( Color_con1 > -10.9035 )
							ret := -1.000000 // sell
		if( lowerBand > -3.93052 )
			if( lowerBand <= 8.25005 )
				if( Color_con1 <= 2.65041 )
					if( midLine <= 26.1573 )
						if( midLine <= 17.8899 )
							ret := 0.500000
						if( midLine > 17.8899 )
				...
				if( Color_con1 > 2.65041 )
					ret := -1.000000 // sell
			if( lowerBand > 8.25005 )
				if( Color_con2 <= -0.83472 )
					ret := -1.000000 // sell
				if( Color_con2 > -0.83472 )
					if( Color_con1 <= -1.67704 )
						if( lowerBand <= 11.0231 )
							ret := -0.333333
						if( lowerBand > 11.0231 )
							ret := 0.875000 // buy
					if( Color_con1 > -1.67704 )
...
float op_operation = decision_tree_0_SNAP_1Hour_b04ec4f9(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
