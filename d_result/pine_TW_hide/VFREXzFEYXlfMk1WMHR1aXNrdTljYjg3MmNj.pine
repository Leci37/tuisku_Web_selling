			...
			if( Raw_Money_Flow <= 8.54519e+06 )
				...
				if( VIP > 1.14355 )
					...
					if( MFI > 74.5077 )
						ret := 0.000000
			if( Raw_Money_Flow > 8.54519e+06 )
				if( Positive_Money_Flow_Sum <= 2.60472e+08 )
					if( Typical_Price <= 39.495 )
						ret := 0.567901
					if( Typical_Price > 39.495 )
						ret := 0.910448 // buy
				if( Positive_Money_Flow_Sum > 2.60472e+08 )
					if( Positive_Money_Flow <= 1.44706e+08 )
						ret := 0.078431
					if( Positive_Money_Flow > 1.44706e+08 )
						ret := 0.647059
		if( Typical_Price > 50.8582 )
			if( Typical_Price <= 453.841 )
				if( MFI <= 47.5685 )
					if( VIP <= 1.03423 )
						ret := -0.340909
					if( VIP > 1.03423 )
						ret := 0.416667
				if( MFI > 47.5685 )
					if( Positive_Money_Flow_Sum <= 3.69713e+08 )
						ret := -0.491228
					if( Positive_Money_Flow_Sum > 3.69713e+08 )
						ret := 0.044528
			if( Typical_Price > 453.841 )
				if( Money_Flow_Ratio <= 0.931565 )
					if( Typical_Price <= 694.293 )
						ret := 0.678571
					if( Typical_Price > 694.293 )
						ret := 0.000000
				if( Money_Flow_Ratio > 0.931565 )
...
float op_operation = decision_tree_0_TTD_1Day_9cb872cc(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
