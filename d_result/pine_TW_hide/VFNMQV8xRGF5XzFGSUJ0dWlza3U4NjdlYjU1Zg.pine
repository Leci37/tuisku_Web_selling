		...
		if( basis > 807.484 )
			if( basis_max <= -438.159 )
				...
				if( upper_5 > 1282.11 )
					ret := -1.000000 // sell
			if( basis_max > -438.159 )
				if( basis_minus <= 434.508 )
					if( upper_5 <= 1252.21 )
						ret := -0.444444
					if( upper_5 > 1252.21 )
						ret := -0.812500 // sell
				if( basis_minus > 434.508 )
					if( basis_minus <= 435.486 )
						ret := 0.500000
					if( basis_minus > 435.486 )
						ret := -0.100000
...
float op_operation = decision_tree_0_TSLA_1Day_867eb55f(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)
