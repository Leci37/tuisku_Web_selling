			...
			if( Raw_Money_Flow > 2.60244e+08 )
				if( d_k <= -4.06072 )
					...
					if( smoothD_d > 11.4077 )
						ret := -1.000000 // sell
				if( d_k > -4.06072 )
					if( Positive_Money_Flow_Sum <= 6.28739e+08 )
						ret := -0.875000 // sell
					if( Positive_Money_Flow_Sum > 6.28739e+08 )
						ret := -1.000000 // sell
		if( MFI_Low > -3.26705 )
			if( rsi1 <= 67.0137 )
				if( MFI <= 59.1855 )
					...
					if( MFI > 40.7577 )
						ret := -0.177955
				if( MFI > 59.1855 )
					if( Raw_Money_Flow <= 3.82728e+08 )
						ret := 0.610294
					if( Raw_Money_Flow > 3.82728e+08 )
						ret := -0.052863
			if( rsi1 > 67.0137 )
				if( Money_Flow_Ratio <= 3.69226 )
					if( Money_Flow_Ratio <= 2.63494 )
						ret := -0.421053
					if( Money_Flow_Ratio > 2.63494 )
						ret := -0.824176 // sell
				if( Money_Flow_Ratio > 3.69226 )
...
float op_operation = decision_tree_0_TWLO_1Day_44e22431(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, rsi1, d, k, smoothD_d, d_k, smoothK_k)
