		...
		if( senkou_span_a <= 676.703 )
			if( senkou_span_a_displaced <= 578.037 )
				if( senkou_span_a <= 436.696 )
					if( basis_max <= 15.3319 )
						ret := -0.074074
					if( basis_max > 15.3319 )
						ret := -0.823529 // sell
				if( senkou_span_a > 436.696 )
					if( senkou_span_b_displaced <= 573.561 )
						ret := 0.857143 // buy
					if( senkou_span_b_displaced > 573.561 )
						ret := -0.600000
			if( senkou_span_a_displaced > 578.037 )
				if( senkou_span_b <= 549.298 )
					if( kinjun_sen <= 529.125 )
						ret := -1.000000 // sell
					if( kinjun_sen > 529.125 )
						ret := 0.000000
				if( senkou_span_b > 549.298 )
					if( basis_max <= 18.2175 )
						ret := -1.000000 // sell
					if( basis_max > 18.2175 )
						ret := -0.857143 // sell
		if( senkou_span_a > 676.703 )
			if( kinjun_sen <= 794.804 )
				if( basis_minus <= -103.112 )
					ret := 0.000000
				if( basis_minus > -103.112 )
					if( basis_minus <= -19.42 )
						ret := 0.727273 // buy
					if( basis_minus > -19.42 )
						ret := 1.000000 // buy
			if( kinjun_sen > 794.804 )
				if( chinkou_span <= 900.779 )
					if( tenkan_sen <= 702.273 )
						ret := 0.000000
					if( tenkan_sen > 702.273 )
						ret := -0.876190 // sell
				if( chinkou_span > 900.779 )
					if( kinjun_sen <= 968.81 )
						ret := 0.855556 // buy
					if( kinjun_sen > 968.81 )
						ret := -0.193133
...
float op_operation = decision_tree_0_SHOP_1Hour_d9fea729(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
