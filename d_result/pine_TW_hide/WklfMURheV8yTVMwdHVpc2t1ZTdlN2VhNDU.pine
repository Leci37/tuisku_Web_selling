		...
		if( smoothD_d <= 57.4225 )
			...
			if( Negative_Money_Flow > 1.10552e+08 )
				...
				if( d_k > 14.602 )
					ret := 0.000000
		if( smoothD_d > 57.4225 )
			if( Raw_Money_Flow <= 1.84403e+08 )
				if( rsi1 <= 74.0723 )
					if( Money_Flow_Ratio <= 3.38095 )
						ret := 0.175000
					if( Money_Flow_Ratio > 3.38095 )
						ret := 0.851351 // buy
				if( rsi1 > 74.0723 )
					...
					if( d_k > -1.83088 )
						ret := -0.285714
			if( Raw_Money_Flow > 1.84403e+08 )
				if( Negative_Money_Flow_Sum <= 5.57664e+08 )
					if( Positive_Money_Flow_Sum <= 1.11948e+09 )
						ret := 0.928571 // buy
					if( Positive_Money_Flow_Sum > 1.11948e+09 )
						ret := -0.500000
				if( Negative_Money_Flow_Sum > 5.57664e+08 )
...
float op_operation = decision_tree_0_ZI_1Day_e7e7ea45(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, smoothK_k, d_k, k, smoothD_d, rsi1, d)
