			...
			if( smoothD_d <= 30.8229 )
				if( smoothD_d <= 6.76216 )
					...
					if( d > 8.7002 )
						ret := 0.696970
				if( smoothD_d > 6.76216 )
					if( smoothD_d <= 13.5126 )
						ret := -0.243655
					if( smoothD_d > 13.5126 )
						ret := 0.037698
			if( smoothD_d > 30.8229 )
				if( smoothD_d <= 74.3017 )
					if( smoothD_d <= 54.8463 )
						ret := 0.211144
					if( smoothD_d > 54.8463 )
						ret := 0.458647
				if( smoothD_d > 74.3017 )
					if( smoothD_d <= 77.3066 )
						ret := -1.000000 // sell
					if( smoothD_d > 77.3066 )
						ret := 0.000000
		if( smoothK_k > 58.2956 )
			if( d_k <= 8.00526 )
				if( rsi1 <= 44.4001 )
					if( smoothD_d <= 45.0518 )
						ret := -0.714286 // sell
					if( smoothD_d > 45.0518 )
						ret := 0.321429
				if( rsi1 > 44.4001 )
					if( smoothK_k <= 90.3205 )
						ret := -0.258065
					if( smoothK_k > 90.3205 )
						ret := -0.036559
			if( d_k > 8.00526 )
...
float op_operation = decision_tree_0_TWLO_1Day_589fac00(rsi1, d, k, smoothD_d, d_k, smoothK_k)
