			...
			if( Short_MA <= 36.0683 )
				...
				if( Long_MA > 36.2011 )
					...
					if( Short_MA > 32.0668 )
						ret := 0.590909
			if( Short_MA > 36.0683 )
				if( Typical_Price <= 59.7125 )
					if( Positive_Money_Flow_Sum <= 2.36555e+09 )
						ret := -0.634783
					if( Positive_Money_Flow_Sum > 2.36555e+09 )
						ret := -0.061538
				if( Typical_Price > 59.7125 )
					if( Positive_Money_Flow_Sum <= 7.98229e+08 )
						ret := -0.886364 // sell
					if( Positive_Money_Flow_Sum > 7.98229e+08 )
						ret := -0.131004
		if( Short_Long_Diff > 14.6993 )
			if( Positive_Money_Flow_Sum <= 1.14808e+10 )
				if( Short_MA <= 95.6573 )
					ret := 1.000000 // buy
				if( Short_MA > 95.6573 )
					if( Positive_Money_Flow_Sum <= 6.37411e+09 )
						ret := -0.058824
					if( Positive_Money_Flow_Sum > 6.37411e+09 )
						ret := 0.806452 // buy
			if( Positive_Money_Flow_Sum > 1.14808e+10 )
				if( Positive_Money_Flow <= 1.4936e+09 )
					ret := 0.000000
				if( Positive_Money_Flow > 1.4936e+09 )
					ret := -0.437500
...
float op_operation = decision_tree_0_SOLUSDT_1Day_a1ce8052(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
