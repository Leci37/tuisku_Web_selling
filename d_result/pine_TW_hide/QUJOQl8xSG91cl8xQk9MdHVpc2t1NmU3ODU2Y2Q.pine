				...
				if( BBupper > 160.259 )
					...
					if( dif_source_BBupper > -6.81489 )
						...
						if( BBupper > 170.233 )
							ret := -0.183908
			if( BBlower > 144.696 )
				if( dif_source_BBupper <= 2.16767 )
					if( BBlower <= 162.908 )
						if( dif_source_BBupper <= -7.3129 )
							ret := 0.058052
						if( dif_source_BBupper > -7.3129 )
							ret := -0.278775
					if( BBlower > 162.908 )
						if( dif_source_BBlower <= 38.6642 )
							ret := 0.226190
						if( dif_source_BBlower > 38.6642 )
							ret := -0.720000 // sell
				if( dif_source_BBupper > 2.16767 )
					ret := 0.836735 // buy
	if( dif_source_BBlower > 39.9751 )
		if( dif_source_BBupper <= -3.65466 )
			if( dif_source_BBupper <= -7.24978 )
				if( dif_source_BBupper <= -8.28552 )
					ret := 0.009901
				if( dif_source_BBupper > -8.28552 )
					ret := 0.785714 // buy
			if( dif_source_BBupper > -7.24978 )
...
float op_operation = decision_tree_0_ABNB_1Hour_6e7856cd(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
