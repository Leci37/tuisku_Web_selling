				...
				if( MFI_High > -53.1318 )
					if( ema1 <= 227.062 )
						...
						if( Positive_Money_Flow_Sum > 6.79006e+07 )
							ret := -0.082965
					if( ema1 > 227.062 )
						if( Positive_Money_Flow_Sum <= 4.05861e+08 )
							ret := -0.321157
						if( Positive_Money_Flow_Sum > 4.05861e+08 )
							ret := 0.128834
		if( Raw_Money_Flow > 225278 )
			if( ema12 <= -2.58548 )
				if( Positive_Money_Flow_Sum <= 6.25916e+08 )
					if( Raw_Money_Flow <= 2.36024e+06 )
						if( MFI_Low <= -13.5378 )
							ret := 0.575758
						if( MFI_Low > -13.5378 )
							ret := -0.459530
				...
				if( ema2 <= 366.184 )
					...
					if( MFI_High > -66.1077 )
						...
						if( ema12 > 7.92801 )
							ret := 0.423645
				if( ema2 > 366.184 )
					if( Money_Flow_Ratio <= 6.30893 )
						if( Raw_Money_Flow <= 2.47886e+07 )
							ret := 0.092429
						if( Raw_Money_Flow > 2.47886e+07 )
							ret := -0.102489
					if( Money_Flow_Ratio > 6.30893 )
...
float op_operation = decision_tree_0_MDB_1Hour_ed9da60c(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
