...
decision_tree_0_NIO_1Hour_c2653cfd(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)=>
	...
	if( lowerBB > 45.182 )
		if( upperKC <= 49.5871 )
			if( priceRange <= 0.221046 )
				if( avgHighLow <= 47.9013 )
					if( lowerKC <= 45.1305 )
						ret := -1.000000 // sell
					if( lowerKC > 45.1305 )
						ret := 0.000000
...
float op_operation = decision_tree_0_NIO_1Hour_c2653cfd(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
