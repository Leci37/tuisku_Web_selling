		...
		if( wvf <= 18.7471 )
			...
			if( Color_con1 > -14.8688 )
				if( midLine <= 5.34172 )
					ret := 0.843750 // buy
				if( midLine > 5.34172 )
					if( lowerBand <= 4.45654 )
						if( lowerBand <= -4.52251 )
							ret := -0.044944
						if( lowerBand > -4.52251 )
							ret := -0.587611
					if( lowerBand > 4.45654 )
						...
						if( sDev > 5.32234 )
							ret := 0.236181
		if( wvf > 18.7471 )
			if( Color_con2 <= 5.01127 )
				if( lowerBand <= 11.5168 )
					ret := 0.775701 // buy
				if( lowerBand > 11.5168 )
					ret := -1.000000 // sell
			if( Color_con2 > 5.01127 )
...
float op_operation = decision_tree_0_PINS_1Hour_18bfcb8c(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
