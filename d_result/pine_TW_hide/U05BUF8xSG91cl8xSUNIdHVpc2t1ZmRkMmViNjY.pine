		...
		if( chinkou_span <= 11.0544 )
			...
			if( senkou_span_b_displaced > 13.4225 )
				...
				if( senkou_span_b_displaced > 13.849 )
					ret := -0.566667
		if( chinkou_span > 11.0544 )
			if( senkou_span_b_displaced <= 14.6353 )
				if( chinkou_span <= 14.282 )
					if( senkou_span_a <= 11.7706 )
						if( chinkou_span <= 11.6715 )
							ret := 0.045721
						if( chinkou_span > 11.6715 )
							ret := 0.400631
					if( senkou_span_a > 11.7706 )
						if( chinkou_span <= 11.8781 )
							ret := -0.350588
						if( chinkou_span > 11.8781 )
							ret := -0.042112
				if( chinkou_span > 14.282 )
					if( tenkan_sen <= 13.9536 )
						ret := 0.676375
					if( tenkan_sen > 13.9536 )
						if( senkou_span_b <= 15.1147 )
							ret := 0.152620
						if( senkou_span_b > 15.1147 )
							ret := 0.837500 // buy
			if( senkou_span_b_displaced > 14.6353 )
				if( basis_minus <= 4.90625 )
					if( chinkou_span <= 14.6592 )
						if( senkou_span_a <= 14.7393 )
							ret := -0.207006
						if( senkou_span_a > 14.7393 )
							ret := -0.648649
					if( chinkou_span > 14.6592 )
						if( senkou_span_a <= 16.1566 )
							ret := 0.219780
						if( senkou_span_a > 16.1566 )
							ret := -0.035338
				if( basis_minus > 4.90625 )
...
float op_operation = decision_tree_0_SNAP_1Hour_fdd2eb66(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
