			...
			if( bullPower > 0.009219 )
				...
				if( bbm > 1.64106 )
					...
					if( bbp > -0.144522 )
						ret := 0.202020
	if( bbp > 0.30032 )
		if( bullPower <= 2.15938 )
			if( bbp <= 3.0658 )
				if( bearPower <= -0.441396 )
					if( bbp <= 0.556573 )
						ret := -0.878505 // sell
					if( bbp > 0.556573 )
						ret := -0.225352
				if( bearPower > -0.441396 )
					if( bullPower <= 1.76005 )
						if( bbm <= 8.7e-05 )
							ret := -0.154048
						if( bbm > 8.7e-05 )
							ret := -0.038575
					if( bullPower > 1.76005 )
						ret := -0.363158
			if( bbp > 3.0658 )
				if( bearPower <= 1.51049 )
					ret := 0.666667
				if( bearPower > 1.51049 )
					ret := -0.220339
		if( bullPower > 2.15938 )
			if( bullPower <= 4.54809 )
				if( bearPower <= 0.758278 )
					ret := -0.710843 // sell
				if( bearPower > 0.758278 )
					if( bbp <= 3.30963 )
						ret := 1.000000 // buy
					if( bbp > 3.30963 )
						if( bullPower <= 2.59765 )
							ret := -0.628571
						if( bullPower > 2.59765 )
							ret := 0.081081
			if( bullPower > 4.54809 )
...
float op_operation = decision_tree_0_QCOM_5Min_deb8874e(bbp, bullPower, BBPower_Color, bearPower, bbm)
