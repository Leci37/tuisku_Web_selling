			...
			if( Positive_Money_Flow_Sum <= 7.00025e+09 )
				...
				if( Negative_Money_Flow_Sum > 6.15239e+09 )
					...
					if( MFI_Low > 28.6827 )
						ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 7.00025e+09 )
				if( Typical_Price <= 31.2369 )
					if( Negative_Money_Flow_Sum <= 4.89858e+09 )
						ret := -0.615385
					if( Negative_Money_Flow_Sum > 4.89858e+09 )
						ret := 0.500000
				if( Typical_Price > 31.2369 )
					...
					if( rsi1 > 38.9856 )
						ret := -0.550000
		if( k > 92.3604 )
			if( Positive_Money_Flow_Sum <= 9.65602e+09 )
				if( MFI <= 73.3733 )
					if( Raw_Money_Flow <= 1.67104e+09 )
						ret := -0.283582
					if( Raw_Money_Flow > 1.67104e+09 )
						ret := -0.900000 // sell
				if( MFI > 73.3733 )
...
float op_operation = decision_tree_0_UBER_1Day_fbb7d1f6(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, rsi1, d, k, smoothD_d, d_k, smoothK_k)
