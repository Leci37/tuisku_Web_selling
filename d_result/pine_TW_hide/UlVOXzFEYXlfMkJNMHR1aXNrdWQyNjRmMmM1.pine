			...
			if( Negative_Money_Flow_Sum > 2.458e+09 )
				...
				if( Money_Flow_Ratio > 0.742972 )
					...
					if( Negative_Money_Flow > 1.06261e+07 )
						ret := -0.833333 // sell
	if( Positive_Money_Flow_Sum > 3.05718e+09 )
		if( Positive_Money_Flow <= 5.79615e+08 )
			if( Raw_Money_Flow <= 8.16181e+08 )
				if( Typical_Price <= 71.9299 )
					if( Typical_Price <= 31.1435 )
						ret := -0.950000 // sell
					if( Typical_Price > 31.1435 )
						ret := -0.303797
				if( Typical_Price > 71.9299 )
					if( Money_Flow_Ratio <= 1.16964 )
						ret := 0.000000
					if( Money_Flow_Ratio > 1.16964 )
						ret := -0.875000 // sell
			if( Raw_Money_Flow > 8.16181e+08 )
...
float op_operation = decision_tree_0_RUN_1Day_d264f2c5(bbm, bearPower, bbp, bullPower, BBPower_Color, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
