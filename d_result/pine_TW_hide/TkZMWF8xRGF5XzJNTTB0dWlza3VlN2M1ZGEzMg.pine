			...
			if( Long_MA > 353.652 )
				...
				if( Short_MA > 380.309 )
					...
					if( Raw_Money_Flow > 3.00547e+09 )
						ret := -0.427184
	if( Negative_Money_Flow_Sum > 3.9964e+10 )
		if( Positive_Money_Flow_Sum <= 8.29326e+09 )
			if( Typical_Price <= 300.506 )
				ret := 0.600000
			if( Typical_Price > 300.506 )
				ret := 1.000000 // buy
		if( Positive_Money_Flow_Sum > 8.29326e+09 )
			if( Positive_Money_Flow_Sum <= 3.1828e+10 )
				if( Short_Long_Diff <= 3.28315 )
					if( Long_MA <= 485.939 )
						ret := -0.897260 // sell
					if( Long_MA > 485.939 )
						ret := 0.400000
				if( Short_Long_Diff > 3.28315 )
					ret := 0.100000
			if( Positive_Money_Flow_Sum > 3.1828e+10 )
				if( Short_Long_Diff <= -4.16027 )
					if( Raw_Money_Flow <= 5.55203e+09 )
						ret := -0.200000
					if( Raw_Money_Flow > 5.55203e+09 )
						ret := 0.714286 // buy
				if( Short_Long_Diff > -4.16027 )
...
float op_operation = decision_tree_0_NFLX_1Day_e7c5da32(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
