		...
		if( ad_mf <= -9.28495e+06 )
			if( bearPower <= -20.2477 )
				...
				if( ad > -2.61223e+07 )
					ret := 0.956522 // buy
			if( bearPower > -20.2477 )
				if( bullPower <= 0.895418 )
					if( bearPower <= -12.6929 )
						ret := -0.564103
					if( bearPower > -12.6929 )
						ret := -0.981481 // sell
				if( bullPower > 0.895418 )
...
float op_operation = decision_tree_0_NVDA_1Day_b6ebe71f(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
