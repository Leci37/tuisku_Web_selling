			...
			if( tenkan_sen > 540.633 )
				...
				if( senkou_span_a_displaced > 574.314 )
					...
					if( kinjun_sen > 604.042 )
						ret := 0.857143 // buy
	if( senkou_span_b > 576.208 )
		if( chinkou_span <= 524.873 )
			if( kinjun_sen <= 642.458 )
				if( senkou_span_a <= 612.111 )
					if( senkou_span_b_displaced <= 598.63 )
						ret := -0.454545
					if( senkou_span_b_displaced > 598.63 )
						ret := -0.797872 // sell
				if( senkou_span_a > 612.111 )
			...
			if( kinjun_sen > 642.458 )
				ret := -1.000000 // sell
		if( chinkou_span > 524.873 )
			if( senkou_span_b <= 633.203 )
				if( basis_max <= -4.8757 )
					if( senkou_span_b <= 625.122 )
						ret := 0.125000
					if( senkou_span_b > 625.122 )
						ret := -0.444444
				if( basis_max > -4.8757 )
					if( basis_minus <= 27.0942 )
						ret := 0.657895
					if( basis_minus > 27.0942 )
						ret := -0.125000
			if( senkou_span_b > 633.203 )
...
float op_operation = decision_tree_0_ADBE_1Day_ca954c45(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
