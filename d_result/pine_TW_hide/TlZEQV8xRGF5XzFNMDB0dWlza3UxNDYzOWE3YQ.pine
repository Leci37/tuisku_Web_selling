			...
			if( Raw_Money_Flow > 1.10024e+10 )
				if( Typical_Price <= 370.56 )
					...
					if( Typical_Price > 122.892 )
						ret := -0.432377
				if( Typical_Price > 370.56 )
					if( Raw_Money_Flow <= 1.51437e+10 )
						ret := -0.600000
					if( Raw_Money_Flow > 1.51437e+10 )
						ret := 0.108359
		if( Negative_Money_Flow_Sum > 3.54112e+11 )
			if( Money_Flow_Ratio <= 0.606367 )
				if( Positive_Money_Flow <= 3.69977e+10 )
					if( Raw_Money_Flow <= 2.79169e+10 )
						ret := 0.000000
					if( Raw_Money_Flow > 2.79169e+10 )
						ret := 0.923077 // buy
				if( Positive_Money_Flow > 3.69977e+10 )
...
float op_operation = decision_tree_0_NVDA_1Day_14639a7a(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
