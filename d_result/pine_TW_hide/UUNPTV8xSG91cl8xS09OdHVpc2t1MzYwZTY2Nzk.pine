				...
				if( pvi <= 0.812919 )
					if( nvi <= 0.255139 )
						...
						if( azul > -28.1498 )
							ret := -0.042687
					if( nvi > 0.255139 )
						if( media_azul <= -36.7723 )
							ret := -0.687500
						if( media_azul > -36.7723 )
							ret := 0.119667
				if( pvi > 0.812919 )
					if( media_azul <= 86.6206 )
						if( BollOsc <= -52.9786 )
							ret := -0.404624
						if( BollOsc > -52.9786 )
							ret := -0.022208
					if( media_azul > 86.6206 )
						if( verde_mean <= 156.712 )
							ret := -0.269425
						if( verde_mean > 156.712 )
							ret := 0.128492
		if( xrsi > 86.8545 )
...
float op_operation = decision_tree_0_QCOM_1Hour_360e6679(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
