				...
				if( k > 83.5235 )
					...
					if( k > 86.4664 )
						...
						if( rsi1 > 47.4283 )
							ret := 0.045575
	if( bbp > 2.29411 )
		if( smoothK_k <= 92.8651 )
			if( rsi1 <= 85.1402 )
				if( bearPower <= 3.16599 )
					if( k <= 28.7656 )
						if( k <= 7.58391 )
							ret := -0.523810
						if( k > 7.58391 )
...
float op_operation = decision_tree_0_SPOT_5Min_05d10484(bbm, bearPower, bbp, bullPower, BBPower_Color, d_k, d, rsi1, k, smoothD_d, smoothK_k)
