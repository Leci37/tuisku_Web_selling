			...
			if( bbp > 0.105399 )
				if( bbm <= 0.539674 )
					...
					if( bearPower > -0.092571 )
						ret := 0.543131
				if( bbm > 0.539674 )
					if( bearPower <= -0.047959 )
						ret := 0.358974
					if( bearPower > -0.047959 )
						ret := -0.611111
		if( bbp > 0.811431 )
			if( bearPower <= 0.21024 )
				if( bbm <= 0.575573 )
					ret := -0.904762 // sell
				if( bbm > 0.575573 )
					if( bbp <= 1.51442 )
...
float op_operation = decision_tree_0_NIO_1Day_033d77ac(bearPower, bbm, bbp, bullPower, BBPower_Color)
