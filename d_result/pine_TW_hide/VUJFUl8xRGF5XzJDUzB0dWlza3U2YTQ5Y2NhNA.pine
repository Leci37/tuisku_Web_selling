			...
			if( rsi1 <= 44.3069 )
				...
				if( d_k > -9.2151 )
					...
					if( d > 63.0287 )
						ret := 1.000000 // buy
			if( rsi1 > 44.3069 )
				if( ad_mf <= -1.30444e+07 )
					if( ad_mf <= -2.98777e+07 )
						ret := 1.000000 // buy
					if( ad_mf > -2.98777e+07 )
						ret := -0.592593
				if( ad_mf > -1.30444e+07 )
			...
			if( ad <= 2.24557e+07 )
				if( d_k <= 11.058 )
					...
					if( rsi1 > 62.1554 )
						ret := -0.377863
				if( d_k > 11.058 )
					if( ad_mf <= -5.28597e+06 )
						ret := 0.552632
					if( ad_mf > -5.28597e+06 )
						ret := -0.268519
			if( ad > 2.24557e+07 )
				if( rsi1 <= 60.981 )
					if( ad_mf <= 4.39678e+07 )
						ret := -0.927273 // sell
					if( ad_mf > 4.39678e+07 )
						ret := 0.000000
				if( rsi1 > 60.981 )
...
float op_operation = decision_tree_0_UBER_1Day_6a49cca4(ad_mf, mf, ad, rsi1, d, k, smoothD_d, d_k, smoothK_k)
