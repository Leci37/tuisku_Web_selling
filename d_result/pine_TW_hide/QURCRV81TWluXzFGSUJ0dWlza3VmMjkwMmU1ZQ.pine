...
decision_tree_0_ADBE_5Min_f2902e5e(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)=>
	...
	if( upper_2 > 476.451 )
		if( upper_4 <= 478.704 )
			if( lower_2 <= 472.042 )
				if( lower_5 <= 468.751 )
					if( basis_minus <= 8.36203 )
						if( basis_max <= -8.07194 )
							ret := -0.083333
						if( basis_max > -8.07194 )
							ret := 0.375000
					if( basis_minus > 8.36203 )
				...
				if( lower_5 <= 620.15 )
					...
					if( basis > 627.057 )
						...
						if( upper_6 > 638.597 )
							ret := -0.762590 // sell
				if( lower_5 > 620.15 )
					if( basis_minus <= 7.66107 )
						if( lower_6 <= 620.289 )
							ret := -1.000000 // sell
						if( lower_6 > 620.289 )
							ret := -0.714286 // sell
					if( basis_minus > 7.66107 )
						if( basis_minus <= 11.5051 )
							ret := 0.485294
						if( basis_minus > 11.5051 )
							ret := -0.184615
...
float op_operation = decision_tree_0_ADBE_5Min_f2902e5e(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
