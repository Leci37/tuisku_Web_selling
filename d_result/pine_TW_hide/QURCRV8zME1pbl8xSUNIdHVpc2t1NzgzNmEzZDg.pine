				...
				if( kinjun_sen > 528.278 )
					if( chinkou_span <= 530.195 )
						...
						if( senkou_span_a_displaced > 520.167 )
							ret := -0.637931
					if( chinkou_span > 530.195 )
						if( senkou_span_a <= 543.825 )
							ret := 0.294606
						if( senkou_span_a > 543.825 )
							ret := -0.280949
			if( chinkou_span > 561.973 )
				if( kinjun_sen <= 570.629 )
					if( tenkan_sen <= 564.235 )
						if( basis_minus <= -2.97609 )
							ret := 0.433824
						if( basis_minus > -2.97609 )
							ret := 0.756356 // buy
					if( tenkan_sen > 564.235 )
						if( chinkou_span <= 579.694 )
							ret := 0.177936
						if( chinkou_span > 579.694 )
							ret := 0.820312 // buy
				if( kinjun_sen > 570.629 )
					if( chinkou_span <= 586.06 )
						if( chinkou_span <= 566.208 )
							ret := 0.190476
						if( chinkou_span > 566.208 )
							ret := -0.358234
					if( chinkou_span > 586.06 )
						if( tenkan_sen <= 602.983 )
							ret := 0.373958
						if( tenkan_sen > 602.983 )
							ret := -0.025081
		if( basis_minus > 7.89625 )
			if( senkou_span_a <= 669.262 )
				if( senkou_span_b <= 479.43 )
					if( senkou_span_b_displaced <= 385.486 )
						if( senkou_span_b <= 355.962 )
							ret := -0.338614
						if( senkou_span_b > 355.962 )
							ret := 0.353488
					if( senkou_span_b_displaced > 385.486 )
						if( senkou_span_a_displaced <= 431.362 )
							ret := -0.623229
						if( senkou_span_a_displaced > 431.362 )
							ret := -0.225806
				if( senkou_span_b > 479.43 )
					if( senkou_span_a <= 546.211 )
						if( senkou_span_a_displaced <= 520.004 )
							ret := -0.067797
						if( senkou_span_a_displaced > 520.004 )
							ret := 0.576159
					if( senkou_span_a > 546.211 )
						if( chinkou_span <= 556.691 )
							ret := -0.727273 // sell
						if( chinkou_span > 556.691 )
							ret := 0.019231
			if( senkou_span_a > 669.262 )
				if( chinkou_span <= 667.874 )
					if( tenkan_sen <= 672.447 )
						ret := -0.500000
					if( tenkan_sen > 672.447 )
						ret := -1.000000 // sell
				if( chinkou_span > 667.874 )
...
float op_operation = decision_tree_0_ADBE_30Min_7836a3d8(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
