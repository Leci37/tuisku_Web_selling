			...
			if( dif_source_BBupper > -122.997 )
				...
				if( dif_source_BBlower > 68.8119 )
					...
					if( vrsi > 44.8736 )
						ret := -0.369863
		if( BBlower > 176.226 )
			if( dif_source_BBupper <= -148.346 )
				if( dif_source_BBlower <= 60.2229 )
					ret := 1.000000 // buy
				if( dif_source_BBlower > 60.2229 )
					ret := 0.666667
			if( dif_source_BBupper > -148.346 )
				if( dif_source_BBlower <= 57.2123 )
					if( BBlower <= 205.99 )
						ret := 0.857143 // buy
					if( BBlower > 205.99 )
						ret := 0.500000
				if( dif_source_BBlower > 57.2123 )
					if( dif_source_BBupper <= -110.441 )
						ret := -0.588235
					if( dif_source_BBupper > -110.441 )
						ret := 0.000000
...
float op_operation = decision_tree_0_CRWD_1Day_4ebcae31(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
