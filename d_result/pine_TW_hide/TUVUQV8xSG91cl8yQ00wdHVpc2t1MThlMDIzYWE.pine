				...
				if( Positive_Money_Flow <= 3.97884e+06 )
					if( Negative_Money_Flow <= 9.3462e+07 )
						...
						if( MFI > 75.2846 )
							ret := -0.110718
					if( Negative_Money_Flow > 9.3462e+07 )
						if( Positive_Money_Flow_Sum <= 7.62886e+08 )
							ret := 0.097765
						if( Positive_Money_Flow_Sum > 7.62886e+08 )
							ret := -0.064074
				if( Positive_Money_Flow > 3.97884e+06 )
					if( Negative_Money_Flow <= 1.2002e+06 )
						if( Negative_Money_Flow_Sum <= 8.04594e+08 )
							ret := 0.077535
						if( Negative_Money_Flow_Sum > 8.04594e+08 )
							ret := -0.052116
					if( Negative_Money_Flow > 1.2002e+06 )
						if( Typical_Price <= 303.763 )
							ret := -0.381119
						if( Typical_Price > 303.763 )
							ret := 0.040590
	if( Negative_Money_Flow > 1.44263e+09 )
		if( mf <= -0.309055 )
			...
			if( MFI > 24.3036 )
				ret := -0.777778 // sell
		if( mf > -0.309055 )
			if( Raw_Money_Flow <= 3.81952e+09 )
				if( Positive_Money_Flow_Sum <= 7.25616e+09 )
					if( mf <= 0.018805 )
						if( Negative_Money_Flow <= 2.20795e+09 )
							ret := -0.600806
						if( Negative_Money_Flow > 2.20795e+09 )
							ret := 0.160000
					if( mf > 0.018805 )
...
float op_operation = decision_tree_0_META_1Hour_18e023aa(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
