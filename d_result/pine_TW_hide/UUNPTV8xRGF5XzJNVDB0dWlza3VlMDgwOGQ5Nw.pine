			...
			if( Positive_Money_Flow_Sum > 6.37284e+09 )
				...
				if( ema12 > 0.429821 )
					...
					if( ema3 > 122.219 )
						ret := 0.484211
	if( ema2 > 135.379 )
		if( Positive_Money_Flow_Sum <= 9.38109e+09 )
			if( Negative_Money_Flow <= 1.14732e+09 )
				if( MFI_High <= -42.3823 )
					if( Raw_Money_Flow <= 1.64755e+09 )
						ret := -0.859375 // sell
					if( Raw_Money_Flow > 1.64755e+09 )
						ret := 0.428571
				if( MFI_High > -42.3823 )
			...
			if( ema13 <= 3.67406 )
				...
				if( ema12 > -5.92401 )
					...
					if( ema2 > 205.739 )
						ret := 0.428571
			if( ema13 > 3.67406 )
				if( Negative_Money_Flow_Sum <= 6.62e+09 )
					if( Positive_Money_Flow_Sum <= 1.57863e+10 )
						ret := -0.597561
					if( Positive_Money_Flow_Sum > 1.57863e+10 )
						ret := 0.318182
				if( Negative_Money_Flow_Sum > 6.62e+09 )
					if( Positive_Money_Flow_Sum <= 1.85708e+10 )
						ret := 0.384615
					if( Positive_Money_Flow_Sum > 1.85708e+10 )
						ret := -0.500000
...
float op_operation = decision_tree_0_QCOM_1Day_e0808d97(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
