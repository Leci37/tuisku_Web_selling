	...
	if( MFI > 66.6957 )
		...
		if( Positive_Money_Flow > 3.15229e+08 )
			if( bearPower <= 0.093596 )
				if( Negative_Money_Flow_Sum <= 2.83164e+09 )
					ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 2.83164e+09 )
					ret := -0.250000
			if( bearPower > 0.093596 )
				if( bearPower <= 5.12587 )
					if( Raw_Money_Flow <= 5.99656e+08 )
						ret := -0.750000 // sell
					if( Raw_Money_Flow > 5.99656e+08 )
						ret := -1.000000 // sell
				if( bearPower > 5.12587 )
					if( Positive_Money_Flow_Sum <= 8.41673e+09 )
						ret := 0.428571
					if( Positive_Money_Flow_Sum > 8.41673e+09 )
						ret := -0.590909
...
float op_operation = decision_tree_0_SNOW_1Day_e7cb5902(bbm, bearPower, bbp, bullPower, BBPower_Color, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
