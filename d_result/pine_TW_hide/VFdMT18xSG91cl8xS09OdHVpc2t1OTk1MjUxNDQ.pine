	...
	if( nvi > 1.04365 )
		if( nvi <= 1.32737 )
			if( pvi <= -0.33935 )
				if( media <= 9.29747 )
					if( tprice <= 74.3999 )
						if( marron_mean <= -5.19452 )
							ret := -0.440000
						if( marron_mean > -5.19452 )
							ret := 0.170455
					if( tprice > 74.3999 )
						if( azul_mean <= -13.1641 )
							ret := -0.971014 // sell
						if( azul_mean > -13.1641 )
							ret := -0.454545
				if( media > 9.29747 )
...
float op_operation = decision_tree_0_TWLO_1Hour_99525144(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
