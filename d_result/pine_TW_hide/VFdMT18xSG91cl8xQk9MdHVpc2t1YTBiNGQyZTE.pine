	...
	if( BBlower > 348.152 )
		if( BBupper <= 408.862 )
			...
			if( dif_source_BBlower > 4.30769 )
				...
				if( vrsi > 42.2151 )
					if( BBlower <= 368.023 )
						if( dif_source_BBlower <= 11.066 )
							ret := 0.310345
						if( dif_source_BBlower > 11.066 )
							ret := -0.633333
					if( BBlower > 368.023 )
						if( dif_source_BBupper <= -17.7606 )
							ret := 0.956522 // buy
						if( dif_source_BBupper > -17.7606 )
							ret := 0.086957
		if( BBupper > 408.862 )
			if( BBupper <= 452.934 )
				if( dif_source_BBlower <= 4.22391 )
					ret := 0.200000
				if( dif_source_BBlower > 4.22391 )
					if( dif_source_BBupper <= -44.779 )
						ret := -0.943662 // sell
					if( dif_source_BBupper > -44.779 )
						if( dif_source_BBlower <= 13.8003 )
							ret := -0.164179
						if( dif_source_BBlower > 13.8003 )
							ret := -0.731343 // sell
			if( BBupper > 452.934 )
				if( dif_source_BBupper <= -81.9419 )
					if( dif_source_BBlower <= -16.0163 )
						ret := 1.000000 // buy
					if( dif_source_BBlower > -16.0163 )
						ret := -0.974359 // sell
				if( dif_source_BBupper > -81.9419 )
					if( dif_source_BBupper <= -51.8605 )
						if( BBlower <= 377.123 )
							ret := 0.812500 // buy
						if( BBlower > 377.123 )
							ret := -1.000000 // sell
...
float op_operation = decision_tree_0_TWLO_1Hour_a0b4d2e1(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
