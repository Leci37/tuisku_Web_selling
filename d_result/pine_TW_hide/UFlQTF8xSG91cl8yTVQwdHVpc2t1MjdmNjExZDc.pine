...
decision_tree_0_PYPL_1Hour_27f611d7(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
				...
				if( Raw_Money_Flow <= 8.39407e+07 )
					if( ema1 <= 75.0718 )
						...
						if( MFI > 69.743 )
							ret := 0.650000
					if( ema1 > 75.0718 )
						if( Negative_Money_Flow <= 485155 )
							ret := -0.200323
						if( Negative_Money_Flow > 485155 )
							ret := 0.011925
				if( Raw_Money_Flow > 8.39407e+07 )
					if( tema <= 90.8946 )
						if( Positive_Money_Flow <= 3.21597e+08 )
							ret := -0.118033
						if( Positive_Money_Flow > 3.21597e+08 )
							ret := 0.555556
					if( tema > 90.8946 )
	...
	if( Negative_Money_Flow_Sum > 3.25075e+09 )
		if( ema12 <= -2.16744 )
			if( Positive_Money_Flow_Sum <= 1.44445e+09 )
				if( Typical_Price <= 258.205 )
					ret := 0.780488 // buy
				if( Typical_Price > 258.205 )
					ret := -0.090909
			if( Positive_Money_Flow_Sum > 1.44445e+09 )
				if( Typical_Price <= 202.618 )
					ret := -0.818182 // sell
				if( Typical_Price > 202.618 )
					if( Negative_Money_Flow <= 6.39451e+08 )
						ret := 0.600000
					if( Negative_Money_Flow > 6.39451e+08 )
						ret := -0.900000 // sell
		if( ema12 > -2.16744 )
...
float op_operation = decision_tree_0_PYPL_1Hour_27f611d7(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
