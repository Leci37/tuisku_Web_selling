			...
			if( dx <= 42.5981 )
				...
				if( diMinus > 10.2179 )
					...
					if( trueRange > 72.7098 )
						ret := -0.418605
			if( dx > 42.5981 )
				if( smoothedDirectionalMovementMinus <= 5.19271 )
					if( dx <= 75.9426 )
						ret := 0.654545
					if( dx > 75.9426 )
						ret := 0.071429
				if( smoothedDirectionalMovementMinus > 5.19271 )
					if( directionalMovementPlus <= 59.9531 )
						ret := -0.524793
					if( directionalMovementPlus > 59.9531 )
						ret := 0.151163
		if( diMinus > 12.1257 )
			if( smoothedDirectionalMovementPlus <= 8.80857 )
				if( diPlus <= 21.1313 )
					if( adx <= 74.7627 )
						ret := -0.039689
					if( adx > 74.7627 )
						ret := -0.525000
				if( diPlus > 21.1313 )
					if( smoothedTrueRange <= 23.1475 )
						ret := -0.137681
					if( smoothedTrueRange > 23.1475 )
						ret := -0.708861 // sell
			if( smoothedDirectionalMovementPlus > 8.80857 )
				if( diPlus <= 22.0706 )
					if( trueRange <= 123.645 )
						ret := 0.173640
					if( trueRange > 123.645 )
						ret := -0.201365
				if( diPlus > 22.0706 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_5e565683(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
