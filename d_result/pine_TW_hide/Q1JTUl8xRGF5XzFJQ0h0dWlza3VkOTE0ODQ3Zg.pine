		...
		if( senkou_span_b_displaced <= 14.7782 )
			if( senkou_span_a_displaced <= 12.7679 )
				...
				if( chinkou_span > 14.4285 )
					ret := -0.818182 // sell
			if( senkou_span_a_displaced > 12.7679 )
				if( tenkan_sen <= 15.6586 )
					if( basis_max <= 0.531377 )
						ret := -0.090909
					if( basis_max > 0.531377 )
						ret := -1.000000 // sell
				if( tenkan_sen > 15.6586 )
					if( tenkan_sen <= 16.6358 )
						ret := -1.000000 // sell
					if( tenkan_sen > 16.6358 )
						ret := -0.666667
		if( senkou_span_b_displaced > 14.7782 )
			if( basis_max <= 0.167855 )
				if( senkou_span_b_displaced <= 17.0155 )
					if( basis_minus <= 0.584335 )
						ret := 0.530612
					if( basis_minus > 0.584335 )
						ret := -0.093023
				if( senkou_span_b_displaced > 17.0155 )
					if( senkou_span_b <= 28.2371 )
						ret := -0.661538
					if( senkou_span_b > 28.2371 )
						ret := -0.166667
			if( basis_max > 0.167855 )
				if( senkou_span_b <= 34.3299 )
					if( chinkou_span <= 16.156 )
						ret := 0.008264
					if( chinkou_span > 16.156 )
						ret := 0.503401
				if( senkou_span_b > 34.3299 )
					if( kinjun_sen <= 39.1653 )
						ret := -0.108108
					if( kinjun_sen > 39.1653 )
						ret := -0.785714 // sell
...
float op_operation = decision_tree_0_CRSR_1Day_d914847f(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
