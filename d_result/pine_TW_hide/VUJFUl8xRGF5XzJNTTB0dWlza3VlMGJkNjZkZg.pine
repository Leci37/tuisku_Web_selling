...
decision_tree_0_UBER_1Day_e0bd66df(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)=>
	...
	if( Typical_Price > 31.7118 )
		...
		if( Short_Long_Diff > -1.45031 )
			if( MFI_High <= -24.8049 )
				if( Short_MA <= 45.0134 )
					if( Negative_Money_Flow_Sum <= 5.06896e+09 )
						ret := 0.095745
					if( Negative_Money_Flow_Sum > 5.06896e+09 )
						ret := -0.618785
				if( Short_MA > 45.0134 )
					...
					if( MFI_Low > 32.7052 )
						ret := -0.500000
			if( MFI_High > -24.8049 )
				if( Short_Long_Diff <= 1.18696 )
					if( Positive_Money_Flow_Sum <= 7.19976e+09 )
						ret := -0.180851
					if( Positive_Money_Flow_Sum > 7.19976e+09 )
						ret := 0.470199
				if( Short_Long_Diff > 1.18696 )
					if( Typical_Price <= 45.5956 )
						ret := -0.345679
					if( Typical_Price > 45.5956 )
						ret := -0.006803
...
float op_operation = decision_tree_0_UBER_1Day_e0bd66df(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
