				...
				if( Positive_Money_Flow_Sum > 3.72283e+08 )
					if( Short_MA <= 359.417 )
						...
						if( Long_MA > 228.6 )
							ret := -0.774194 // sell
					if( Short_MA > 359.417 )
						if( Negative_Money_Flow <= 73331.7 )
							ret := -0.315283
						if( Negative_Money_Flow > 73331.7 )
							ret := 0.061303
			if( Positive_Money_Flow_Sum > 9.00926e+08 )
				if( MFI_Low <= 42.7328 )
					if( Typical_Price <= 776.417 )
						ret := 1.000000 // buy
					if( Typical_Price > 776.417 )
						ret := 0.000000
				if( MFI_Low > 42.7328 )
					if( Typical_Price <= 581.903 )
						if( Negative_Money_Flow <= 5.3808e+07 )
							ret := 0.000000
						if( Negative_Money_Flow > 5.3808e+07 )
							ret := 0.714286 // buy
					if( Typical_Price > 581.903 )
						if( Short_Long_Diff <= 21.8021 )
							ret := -1.000000 // sell
						if( Short_Long_Diff > 21.8021 )
							ret := 0.000000
		if( Raw_Money_Flow > 1.83849e+08 )
			if( MFI_High <= -51.2071 )
				ret := 0.400000
			if( MFI_High > -51.2071 )
				if( Typical_Price <= 464.837 )
					if( Raw_Money_Flow <= 1.95461e+08 )
						ret := 1.000000 // buy
					if( Raw_Money_Flow > 1.95461e+08 )
						ret := -0.333333
				if( Typical_Price > 464.837 )
					if( Raw_Money_Flow <= 3.94535e+08 )
						ret := -0.862745 // sell
					if( Raw_Money_Flow > 3.94535e+08 )
						ret := 0.000000
...
float op_operation = decision_tree_0_HUBS_1Hour_9426dfc6(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
