			...
			if( VIP_VIM > 0.038928 )
				...
				if( Typical_Price > 275.018 )
					...
					if( Typical_Price > 375.826 )
						ret := -0.116129
	if( Typical_Price > 542.594 )
		if( Raw_Money_Flow <= 1.39685e+09 )
			if( VIP <= 1.07745 )
				if( Raw_Money_Flow <= 1.10666e+09 )
					if( VIP <= 1.0426 )
						ret := 1.000000 // buy
					if( VIP > 1.0426 )
						ret := 0.800000 // buy
				if( Raw_Money_Flow > 1.10666e+09 )
					...
					if( VIP > 0.953025 )
						ret := 0.545455
			if( VIP > 1.07745 )
				if( Money_Flow_Ratio <= 0.687016 )
					ret := -1.000000 // sell
				if( Money_Flow_Ratio > 0.687016 )
					if( Typical_Price <= 551.398 )
						ret := -0.777778 // sell
					if( Typical_Price > 551.398 )
						ret := 0.000000
		if( Raw_Money_Flow > 1.39685e+09 )
			if( VIM <= 1.41906 )
				if( Raw_Money_Flow <= 4.396e+09 )
					if( VIP <= 1.30593 )
						ret := -0.736264 // sell
					if( VIP > 1.30593 )
						ret := 0.071429
...
float op_operation = decision_tree_0_ADBE_1Day_8b23c25d(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
