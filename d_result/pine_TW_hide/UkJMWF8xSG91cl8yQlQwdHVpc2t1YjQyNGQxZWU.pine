				...
				if( ema2 > 27.5018 )
					...
					if( bbm > 0.93158 )
						...
						if( ema3 > 30.7882 )
							ret := -0.300477
	if( ema3 > 40.7785 )
		if( bearPower <= -1.03772 )
			if( tema <= 128.22 )
				if( ema13 <= -0.222234 )
					if( bullPower <= -4.00777 )
						if( bullPower <= -4.90637 )
							ret := 0.000000
						if( bullPower > -4.90637 )
							ret := -0.828571 // sell
					if( bullPower > -4.00777 )
						if( bullPower <= -2.56664 )
							ret := 0.370370
						if( bullPower > -2.56664 )
							ret := 0.007311
				if( ema13 > -0.222234 )
					...
					if( ema13 > 2.12859 )
						...
						if( bbm > 5.10296 )
							ret := -1.000000 // sell
			if( tema > 128.22 )
				if( bearPower <= -2.31531 )
					ret := -0.846154 // sell
				if( bearPower > -2.31531 )
					ret := -1.000000 // sell
		if( bearPower > -1.03772 )
			if( ema13 <= -0.572253 )
				if( bullPower <= 0.791344 )
					if( ema1 <= 99.269 )
						if( ema2 <= 96.8656 )
							ret := -0.327569
						if( ema2 > 96.8656 )
...
float op_operation = decision_tree_0_RBLX_1Hour_b424d1ee(bbp, bullPower, BBPower_Color, bearPower, bbm, ema2, ema1, ema12, ema3, ema13, tema)
