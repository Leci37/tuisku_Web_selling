...
decision_tree_0_MSFT_1Day_c6ffadf0(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Money_Flow_Ratio > 1.10814 )
		if( Long_MA <= 206.875 )
			if( Typical_Price <= 142.571 )
				if( Positive_Money_Flow_Sum <= 3.07408e+10 )
					if( Short_MA <= 55.32 )
						ret := -0.505155
					if( Short_MA > 55.32 )
						ret := 0.245652
				if( Positive_Money_Flow_Sum > 3.07408e+10 )
					if( Positive_Money_Flow <= 3.15494e+09 )
						ret := -0.423729
					if( Positive_Money_Flow > 3.15494e+09 )
						ret := -0.837500 // sell
			if( Typical_Price > 142.571 )
				if( Negative_Money_Flow_Sum <= 3.83531e+10 )
					if( Short_Long_Diff <= 7.84839 )
						ret := 0.265060
					if( Short_Long_Diff > 7.84839 )
						ret := -0.722222 // sell
				if( Negative_Money_Flow_Sum > 3.83531e+10 )
					...
					if( MFI_High > -24.3045 )
						ret := 0.845070 // buy
		if( Long_MA > 206.875 )
			if( Negative_Money_Flow_Sum <= 5.01912e+10 )
				if( Short_Long_Diff <= 0.418782 )
					if( Long_MA <= 258.673 )
						ret := 0.807692 // buy
					if( Long_MA > 258.673 )
						ret := 0.117647
				if( Short_Long_Diff > 0.418782 )
					...
					if( Short_MA > 254.623 )
						ret := -0.099526
			if( Negative_Money_Flow_Sum > 5.01912e+10 )
				if( Positive_Money_Flow_Sum <= 7.20766e+10 )
					if( Raw_Money_Flow <= 9.59948e+09 )
						ret := 0.264706
					if( Raw_Money_Flow > 9.59948e+09 )
						ret := -0.529412
				if( Positive_Money_Flow_Sum > 7.20766e+10 )
...
float op_operation = decision_tree_0_MSFT_1Day_c6ffadf0(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
