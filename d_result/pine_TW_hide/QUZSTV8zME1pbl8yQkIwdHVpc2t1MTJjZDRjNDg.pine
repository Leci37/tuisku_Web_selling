			...
			if( Upper_Band > 16.7939 )
				...
				if( bbp > 1.5568 )
					...
					if( basis > 19.1364 )
						ret := -0.555556
	if( Lower_Band > 17.2953 )
		if( Upper_Band <= 18.0227 )
			ret := -0.768519 // sell
		if( Upper_Band > 18.0227 )
			if( basis <= 17.9458 )
				if( Lower_Band <= 17.6737 )
					if( bearPower <= -0.015035 )
						ret := 0.780702 // buy
					if( bearPower > -0.015035 )
						ret := 0.239130
				if( Lower_Band > 17.6737 )
			...
			if( basis > 17.9458 )
				...
				if( Lower_Band > 17.6433 )
					if( basis <= 156.803 )
						if( Lower_Band <= 152.194 )
							ret := -0.018097
						if( Lower_Band > 152.194 )
							ret := 0.508621
					if( basis > 156.803 )
						if( Lower_Band <= 162.019 )
							ret := -0.406915
						if( Lower_Band > 162.019 )
							ret := 1.000000 // buy
...
float op_operation = decision_tree_0_AFRM_30Min_12cd4c48(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
