...
decision_tree_0_DDOG_30Min_c8e01192(d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( d_k > 10.7108 )
			...
			if( k <= 2.99487 )
				...
				if( rsi1 > 30.2993 )
					...
					if( rsi1 > 34.9445 )
						ret := 0.333333
			if( k > 2.99487 )
				if( smoothK_k <= 28.1729 )
					if( smoothD_d <= 28.9363 )
						if( k <= 10.9879 )
							ret := 0.067073
						if( k > 10.9879 )
							ret := 0.600000
		...
		if( rsi1 > 35.5661 )
			if( k <= 5.93042 )
				if( rsi1 <= 63.3567 )
					if( smoothD_d <= 15.0721 )
						if( d_k <= 11.556 )
							ret := 0.606061
						if( d_k > 11.556 )
							ret := 0.096000
					if( smoothD_d > 15.0721 )
						if( smoothD_d <= 15.7545 )
							ret := -0.700000 // sell
						if( smoothD_d > 15.7545 )
							ret := -0.230415
				if( rsi1 > 63.3567 )
...
float op_operation = decision_tree_0_DDOG_30Min_c8e01192(d, d_k, smoothK_k, k, rsi1, smoothD_d)
