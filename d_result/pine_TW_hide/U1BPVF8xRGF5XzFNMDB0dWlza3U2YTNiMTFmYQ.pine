	...
	if( Raw_Money_Flow > 3.97482e+08 )
		if( Money_Flow_Ratio <= 0.57047 )
			...
			if( Raw_Money_Flow > 9.51748e+08 )
				ret := -0.636364
		if( Money_Flow_Ratio > 0.57047 )
			if( Money_Flow_Ratio <= 3.03344 )
				if( Negative_Money_Flow <= 4.0486e+08 )
					if( Negative_Money_Flow_Sum <= 2.44246e+09 )
						ret := -0.345679
					if( Negative_Money_Flow_Sum > 2.44246e+09 )
						ret := -0.750000 // sell
				if( Negative_Money_Flow > 4.0486e+08 )
					if( Negative_Money_Flow_Sum <= 2.6351e+09 )
						ret := -0.586957
					if( Negative_Money_Flow_Sum > 2.6351e+09 )
						ret := 0.058824
			if( Money_Flow_Ratio > 3.03344 )
				if( Typical_Price <= 210.161 )
					if( Negative_Money_Flow_Sum <= 7.3539e+08 )
						ret := -0.923077 // sell
					if( Negative_Money_Flow_Sum > 7.3539e+08 )
						ret := -0.111111
				if( Typical_Price > 210.161 )
					if( Positive_Money_Flow_Sum <= 5.85814e+09 )
						ret := 0.705882 // buy
					if( Positive_Money_Flow_Sum > 5.85814e+09 )
						ret := -0.043478
...
float op_operation = decision_tree_0_SPOT_1Day_6a3b11fa(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
