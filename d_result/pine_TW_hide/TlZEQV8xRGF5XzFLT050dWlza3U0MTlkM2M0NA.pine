...
decision_tree_0_NVDA_1Day_419d3c44(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)=>
	...
	if( pvi > 0.677112 )
		...
		if( nvimax > 2.47359 )
			if( BollOsc <= -18.9109 )
				if( verde_media <= -48.9204 )
					if( nvimax <= 2.65795 )
						ret := -0.871795 // sell
					if( nvimax > 2.65795 )
						ret := 0.058824
				if( verde_media > -48.9204 )
					if( marron_mean <= 22.9998 )
						ret := -0.164706
					if( marron_mean > 22.9998 )
						ret := 0.691358
			if( BollOsc > -18.9109 )
...
float op_operation = decision_tree_0_NVDA_1Day_419d3c44(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
