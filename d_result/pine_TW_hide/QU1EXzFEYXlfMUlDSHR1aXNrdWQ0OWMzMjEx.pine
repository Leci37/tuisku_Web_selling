			...
			if( basis_minus > 4.52705 )
				...
				if( basis_max > -1.94568 )
					...
					if( senkou_span_a_displaced > 82.7097 )
						ret := -0.485714
	if( senkou_span_b_displaced > 88.0371 )
		if( chinkou_span <= 136.207 )
			if( basis_max <= 4.82945 )
				if( kinjun_sen <= 84.1289 )
					if( senkou_span_a <= 82.4328 )
						ret := -0.156863
					if( senkou_span_a > 82.4328 )
						ret := 1.000000 // buy
				if( kinjun_sen > 84.1289 )
					if( basis_minus <= -2.43742 )
						ret := -0.666667
					if( basis_minus > -2.43742 )
						ret := -0.342593
			if( basis_max > 4.82945 )
				if( senkou_span_b_displaced <= 137.321 )
					if( chinkou_span <= 93.248 )
						ret := -0.200000
					if( chinkou_span > 93.248 )
						ret := 0.787879 // buy
				if( senkou_span_b_displaced > 137.321 )
					ret := -0.444444
		if( chinkou_span > 136.207 )
			if( senkou_span_a_displaced <= 161.869 )
				if( basis_max <= -5.61124 )
					if( basis_minus <= 15.9964 )
						ret := 0.000000
					if( basis_minus > 15.9964 )
						ret := -1.000000 // sell
				if( basis_max > -5.61124 )
					if( chinkou_span <= 176.64 )
						ret := 0.666667
					if( chinkou_span > 176.64 )
						ret := 0.117647
			if( senkou_span_a_displaced > 161.869 )
				if( senkou_span_a <= 159.186 )
					if( tenkan_sen <= 150.575 )
						ret := 0.833333 // buy
					if( tenkan_sen > 150.575 )
						ret := 0.000000
				if( senkou_span_a > 159.186 )
					if( senkou_span_a_displaced <= 194.762 )
						ret := -0.822785 // sell
					if( senkou_span_a_displaced > 194.762 )
						ret := -0.428571
...
float op_operation = decision_tree_0_AMD_1Day_d49c3211(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
