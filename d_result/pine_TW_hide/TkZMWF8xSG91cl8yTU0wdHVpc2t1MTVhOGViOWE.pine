				...
				if( Negative_Money_Flow_Sum > 8.83329e+08 )
					...
					if( Short_MA > 175.296 )
						...
						if( MA_Cross > 83.2602 )
							ret := 1.000000 // buy
			if( Long_MA > 181.695 )
				if( Money_Flow_Ratio <= 17936.8 )
					if( MFI_Low <= -3.91648 )
						if( Positive_Money_Flow_Sum <= 4.82697e+08 )
							ret := 0.068311
						if( Positive_Money_Flow_Sum > 4.82697e+08 )
							ret := 0.411458
					if( MFI_Low > -3.91648 )
						if( Short_Long_Diff <= -10.4106 )
							ret := -0.425101
						if( Short_Long_Diff > -10.4106 )
							ret := -0.033435
				if( Money_Flow_Ratio > 17936.8 )
					ret := 1.000000 // buy
	if( Negative_Money_Flow_Sum > 6.9054e+09 )
		if( Raw_Money_Flow <= 6.62283e+08 )
			ret := -0.904762 // sell
		if( Raw_Money_Flow > 6.62283e+08 )
			if( Negative_Money_Flow_Sum <= 7.04444e+09 )
				ret := -0.777778 // sell
			if( Negative_Money_Flow_Sum > 7.04444e+09 )
				if( Long_MA <= 324.1 )
					ret := -0.100000
...
float op_operation = decision_tree_0_NFLX_1Hour_15a8eb9a(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
