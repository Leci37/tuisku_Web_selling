		...
		if( midLine <= 4.00132 )
			...
			if( upperBand > 9.48842 )
				...
				if( Color_con1 > -6.62998 )
					ret := 1.000000 // buy
		if( midLine > 4.00132 )
			if( upperBand <= 10.7918 )
				if( Color_con2 <= -3.49997 )
					if( upperBand <= 8.5144 )
						ret := 0.043478
					if( upperBand > 8.5144 )
						ret := -0.718085 // sell
...
float op_operation = decision_tree_0_AMD_1Day_51bef140(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
