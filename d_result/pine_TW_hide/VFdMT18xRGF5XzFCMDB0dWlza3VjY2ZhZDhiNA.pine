			...
			if( bullPower > 7.4832 )
				if( bbm <= 3.22757 )
					...
					if( bbm > 2.51225 )
						ret := 0.777778 // buy
				if( bbm > 3.22757 )
					if( bearPower <= 17.3699 )
						ret := -0.261580
					if( bearPower > 17.3699 )
						ret := -0.861111 // sell
		if( bullPower > 34.6906 )
			if( bullPower <= 43.6744 )
				if( bearPower <= 23.7242 )
					ret := 0.750000 // buy
				if( bearPower > 23.7242 )
					ret := 1.000000 // buy
			if( bullPower > 43.6744 )
...
float op_operation = decision_tree_0_TWLO_1Day_ccfad8b4(bbp, bullPower, BBPower_Color, bearPower, bbm)
