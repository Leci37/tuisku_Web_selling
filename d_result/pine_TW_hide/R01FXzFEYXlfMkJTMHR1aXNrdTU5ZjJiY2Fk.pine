...
decision_tree_0_GME_1Day_59f2bcad(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( smoothD_d > 38.3486 )
			...
			if( bbp <= 0.712437 )
				if( smoothD_d <= 87.4359 )
					...
					if( rsi1 > 70.5202 )
						ret := -0.533333
				if( smoothD_d > 87.4359 )
					if( bullPower <= 0.105594 )
						ret := 0.241379
					if( bullPower > 0.105594 )
						ret := 0.724638 // buy
			if( bbp > 0.712437 )
				if( smoothK_k <= 35.4378 )
					if( rsi1 <= 54.2399 )
						ret := -1.000000 // sell
					if( rsi1 > 54.2399 )
						ret := -0.700000 // sell
		...
		if( smoothD_d > 91.0576 )
			if( bbm <= 12.57 )
				if( d_k <= -0.003414 )
					if( bearPower <= 0.827653 )
						ret := -0.314286
					if( bearPower > 0.827653 )
						ret := -0.789474 // sell
				if( d_k > -0.003414 )
					if( bullPower <= 16.8155 )
						ret := 0.104478
					if( bullPower > 16.8155 )
						ret := -0.909091 // sell
			if( bbm > 12.57 )
...
float op_operation = decision_tree_0_GME_1Day_59f2bcad(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
