	...
	if( d > 0.234388 )
		if( bearPower <= -2.4107 )
			...
			if( d_k > 25.4709 )
				if( k <= 12.7638 )
					if( d_k <= 29.6741 )
						if( smoothK_k <= 0.188006 )
							ret := 0.923077 // buy
						if( smoothK_k > 0.188006 )
							ret := -0.250000
					if( d_k > 29.6741 )
						if( smoothD_d <= 40.3279 )
							ret := -0.880000 // sell
						if( smoothD_d > 40.3279 )
							ret := 0.000000
				if( k > 12.7638 )
					if( rsi1 <= 40.584 )
						...
						if( bbp > -15.6051 )
							ret := 0.838710 // buy
					if( rsi1 > 40.584 )
						if( bearPower <= -3.74996 )
							ret := 0.615385
						if( bearPower > -3.74996 )
							ret := -0.320000
		if( bearPower > -2.4107 )
			if( bearPower <= 2.21482 )
				if( d_k <= -27.7313 )
					if( bbm <= 5.075 )
						if( rsi1 <= 70.6012 )
							ret := 0.604651
...
float op_operation = decision_tree_0_SPOT_1Hour_5a190be0(bbm, bearPower, bbp, bullPower, BBPower_Color, d_k, d, rsi1, k, smoothD_d, smoothK_k)
