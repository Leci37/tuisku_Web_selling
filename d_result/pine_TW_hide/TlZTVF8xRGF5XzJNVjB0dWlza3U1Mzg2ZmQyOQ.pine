	...
	if( Positive_Money_Flow_Sum > 2.48818e+09 )
		...
		if( VIM > 0.800967 )
			if( Negative_Money_Flow_Sum <= 2.21293e+09 )
				ret := 1.000000 // buy
			if( Negative_Money_Flow_Sum > 2.21293e+09 )
				if( Positive_Money_Flow_Sum <= 2.84172e+09 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 2.84172e+09 )
					ret := 0.000000
...
float op_operation = decision_tree_0_NVST_1Day_5386fd29(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
