	...
	if( Color_con1 <= 1.18261 )
		...
		if( Color_con1 > -8.63967 )
			if( sDev <= 3.64235 )
				...
				if( Color_con2 > -0.060614 )
					if( sDev <= 2.62563 )
						if( Color_con1 <= -0.156498 )
							ret := 0.012899
						if( Color_con1 > -0.156498 )
							ret := 0.211982
					if( sDev > 2.62563 )
						if( lowerBand <= -1.18528 )
							ret := -0.253086
						if( lowerBand > -1.18528 )
							ret := 0.326007
			if( sDev > 3.64235 )
				...
				if( midLine > 11.9805 )
					ret := 0.850000 // buy
	if( Color_con1 > 1.18261 )
		if( Color_con2 <= 5.0807 )
			if( Color_con2 <= 2.91451 )
				if( Color_con2 <= -2.69641 )
					ret := -1.000000 // sell
				if( Color_con2 > -2.69641 )
					ret := 0.720588 // buy
			if( Color_con2 > 2.91451 )
				if( Color_con1 <= 1.85546 )
					ret := -0.190476
				if( Color_con1 > 1.85546 )
					if( Color_con2 <= 3.00785 )
						ret := -1.000000 // sell
					if( Color_con2 > 3.00785 )
						ret := 0.777778 // buy
		if( Color_con2 > 5.0807 )
...
float op_operation = decision_tree_0_SPOT_1Hour_4645c03a(Color_con1, Color_con2, colInt, rangeHigh, midLine, sDev, rangeLow, upperBand, lowerBand, wvf)
