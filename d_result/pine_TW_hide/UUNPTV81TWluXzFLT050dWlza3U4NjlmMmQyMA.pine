			...
			if( verde_mean <= 30.3793 )
				...
				if( nvi > 0.070253 )
					...
					if( xmf > 37.4262 )
						ret := -0.100000
			if( verde_mean > 30.3793 )
				if( verde_azul <= 120.939 )
					if( verde_media <= -42.1462 )
						ret := 0.000000
					if( verde_media > -42.1462 )
						ret := 0.903226 // buy
				if( verde_azul > 120.939 )
...
float op_operation = decision_tree_0_QCOM_5Min_869f2d20(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
