		...
		if( k > 98.9332 )
			if( d_k <= -0.329014 )
				...
				if( rsi1 > 78.8814 )
					ret := 0.015873
			if( d_k > -0.329014 )
				if( smoothD_d <= 96.9923 )
					if( rsi1 <= 85.0922 )
						if( smoothD_d <= 96.8613 )
							ret := -0.050633
						if( smoothD_d > 96.8613 )
							ret := -0.489362
					if( rsi1 > 85.0922 )
						if( smoothD_d <= 96.2681 )
							ret := -0.866667 // sell
						if( smoothD_d > 96.2681 )
							ret := 0.416667
				if( smoothD_d > 96.9923 )
...
float op_operation = decision_tree_0_TTD_1Hour_559c8316(rsi1, d, k, smoothD_d, d_k, smoothK_k)
