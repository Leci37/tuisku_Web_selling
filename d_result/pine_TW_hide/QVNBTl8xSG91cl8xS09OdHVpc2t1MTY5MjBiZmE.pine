				...
				if( media <= 48.7197 )
					...
					if( oscp > 6.83698 )
						...
						if( tprice > 58.4936 )
							ret := 0.200000
				if( media > 48.7197 )
					if( verde_mean <= 64.2017 )
						if( azul_mean <= -10.4967 )
							ret := -0.838710 // sell
						if( azul_mean > -10.4967 )
							ret := 0.067961
					if( verde_mean > 64.2017 )
				...
				if( pvimax > 0.41199 )
					...
					if( pvimax > 0.854876 )
						...
						if( azul > 5.8803 )
							ret := -0.611765
	if( nvim > 1.1437 )
		if( verde_media <= 25.7734 )
			if( azul <= 11.1989 )
				if( stoc <= 9.79227 )
					if( marron_mean <= -14.2627 )
						if( azul <= -27.8211 )
							ret := -1.000000 // sell
						if( azul > -27.8211 )
							ret := 1.000000 // buy
					if( marron_mean > -14.2627 )
						...
						if( source > 68.3096 )
							ret := -0.485714
				if( stoc > 9.79227 )
					if( marron_mean <= 98.5889 )
						if( azul_mean <= 0.488277 )
							ret := -0.411546
						if( azul_mean > 0.488277 )
							ret := -0.018325
					if( marron_mean > 98.5889 )
						if( azul_mean <= -2.32779 )
							ret := 0.500000
						if( azul_mean > -2.32779 )
							ret := -0.849462 // sell
			if( azul > 11.1989 )
...
float op_operation = decision_tree_0_ASAN_1Hour_16920bfa(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
