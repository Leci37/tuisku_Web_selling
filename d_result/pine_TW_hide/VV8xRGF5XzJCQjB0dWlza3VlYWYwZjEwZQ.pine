		...
		if( basis <= 87.8143 )
			...
			if( bullPower > 1.43772 )
				if( bbp <= 0.598549 )
					ret := 0.000000
				if( bbp > 0.598549 )
					if( Lower_Band <= 35.4023 )
						ret := -0.884615 // sell
					if( Lower_Band > 35.4023 )
						ret := -0.500000
		if( basis > 87.8143 )
			if( Lower_Band <= 92.3051 )
				if( basis <= 104.686 )
					if( bullPower <= 9.45705 )
						ret := 0.176471
					if( bullPower > 9.45705 )
						ret := -0.571429
				if( basis > 104.686 )
					...
					if( bearPower > 10.7 )
						ret := -0.333333
			if( Lower_Band > 92.3051 )
				if( Lower_Band <= 135.531 )
					if( bbm <= 6.67803 )
						ret := -0.360902
					if( bbm > 6.67803 )
						ret := 0.127451
				if( Lower_Band > 135.531 )
					if( bullPower <= -6.97701 )
						ret := 0.000000
					if( bullPower > -6.97701 )
						ret := -0.886792 // sell
...
float op_operation = decision_tree_0_U_1Day_eaf0f10e(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
