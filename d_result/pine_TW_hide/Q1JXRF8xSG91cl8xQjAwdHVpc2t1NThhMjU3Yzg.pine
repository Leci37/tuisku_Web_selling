				...
				if( bbp <= 0.501128 )
					...
					if( bbp > 0.269083 )
						...
						if( bbm > 0.294377 )
							ret := -0.465116
				if( bbp > 0.501128 )
					if( bearPower <= 0.391679 )
						if( bullPower <= 0.267843 )
							ret := 0.000000
						if( bullPower > 0.267843 )
							ret := 0.591065
					if( bearPower > 0.391679 )
...
float op_operation = decision_tree_0_CRWD_1Hour_58a257c8(bearPower, bbm, bbp, bullPower, BBPower_Color)
