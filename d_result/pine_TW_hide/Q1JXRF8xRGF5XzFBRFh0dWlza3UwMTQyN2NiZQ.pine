...
decision_tree_0_CRWD_1Day_01427cbe(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)=>
	...
	if( smoothedDirectionalMovementPlus > 1.32366 )
		if( trueRange <= 9.76396 )
			...
			if( diPlus > 27.0661 )
				if( dx <= 16.2441 )
					if( directionalMovementPlus <= 2.69995 )
						ret := 0.681818
					if( directionalMovementPlus > 2.69995 )
						ret := -0.300000
				if( dx > 16.2441 )
			...
			if( adx <= 32.8418 )
				if( diPlus <= 30.6231 )
					...
					if( diMinus > 23.5132 )
						ret := 0.032967
				if( diPlus > 30.6231 )
					if( smoothedDirectionalMovementPlus <= 3.21786 )
						ret := 0.850000 // buy
					if( smoothedDirectionalMovementPlus > 3.21786 )
						ret := 0.194444
			if( adx > 32.8418 )
				if( smoothedDirectionalMovementMinus <= 1.14062 )
					if( directionalMovementPlus <= 5.695 )
						ret := -0.558824
					if( directionalMovementPlus > 5.695 )
						ret := 0.444444
				if( smoothedDirectionalMovementMinus > 1.14062 )
					if( smoothedTrueRange <= 9.494 )
						ret := 0.869565 // buy
					if( smoothedTrueRange > 9.494 )
						ret := 0.423077
...
float op_operation = decision_tree_0_CRWD_1Day_01427cbe(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
