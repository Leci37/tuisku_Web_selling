	...
	if( bbm > 0.574499 )
		...
		if( ema13 > -0.150489 )
			if( ema1 <= 476.308 )
				...
				if( ema3 > 339.593 )
					if( ema2 <= 348.751 )
						if( bearPower <= 0.930502 )
							ret := -0.122302
						if( bearPower > 0.930502 )
							ret := -0.967742 // sell
					if( ema2 > 348.751 )
						if( bearPower <= -2.21157 )
							ret := -0.527273
						if( bearPower > -2.21157 )
							ret := 0.184814
			if( ema1 > 476.308 )
				if( ema2 <= 477.504 )
					if( bearPower <= -0.653241 )
						if( ema1 <= 476.39 )
							ret := -1.000000 // sell
						if( ema1 > 476.39 )
							ret := 0.405405
...
float op_operation = decision_tree_0_ADBE_5Min_abf1b173(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)
