				...
				if( bbm > 0.189861 )
					...
					if( VIP > 1.164 )
						...
						if( VIP_VIM > 0.315281 )
							ret := -0.228261
			if( bullPower > 0.509245 )
				if( bullPower <= 1.04883 )
					if( bullPower <= 0.882253 )
						if( bbm <= 0.569506 )
							ret := 0.097303
						if( bbm > 0.569506 )
							ret := 0.585714
...
float op_operation = decision_tree_0_U_1Hour_63199502(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)
