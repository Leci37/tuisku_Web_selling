				...
				if( bbp <= 2.01419 )
					if( d <= 62.948 )
						...
						if( d_k > 26.0208 )
							ret := 0.245146
					if( d > 62.948 )
						if( smoothK_k <= 41.8331 )
							ret := -0.518519
						if( smoothK_k > 41.8331 )
							ret := -0.130208
				if( bbp > 2.01419 )
					if( bullPower <= 8.88377 )
						if( k <= 47.54 )
							ret := -0.399491
						if( k > 47.54 )
							ret := 0.265306
					if( bullPower > 8.88377 )
						ret := 0.976190 // buy
			if( smoothK_k > 46.1962 )
				if( smoothK_k <= 82.2145 )
					if( smoothK_k <= 80.0799 )
					...
					if( smoothK_k > 80.0799 )
						...
						if( rsi1 > 78.9923 )
							ret := 0.654206
				if( smoothK_k > 82.2145 )
					if( bullPower <= 10.6188 )
						if( bullPower <= 2.16348 )
							ret := -0.035082
						if( bullPower > 2.16348 )
							ret := 0.120541
					if( bullPower > 10.6188 )
...
float op_operation = decision_tree_0_AAPL_1Hour_8ea33eca(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
