		...
		if( Typical_Price <= 39.7827 )
			if( MFI_Low <= 29.4644 )
				...
				if( bearPower > -2.65639 )
					ret := -1.000000 // sell
			if( MFI_Low > 29.4644 )
				if( Positive_Money_Flow_Sum <= 1.20933e+09 )
					if( MFI_Low <= 47.6286 )
						ret := 0.000000
					if( MFI_Low > 47.6286 )
						ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 1.20933e+09 )
					if( Money_Flow_Ratio <= 3.11585 )
						ret := 0.333333
					if( Money_Flow_Ratio > 3.11585 )
						ret := -1.000000 // sell
		if( Typical_Price > 39.7827 )
			if( Money_Flow_Ratio <= 1.14372 )
				ret := 0.000000
			if( Money_Flow_Ratio > 1.14372 )
				if( Typical_Price <= 44.4722 )
					ret := -1.000000 // sell
				if( Typical_Price > 44.4722 )
					if( Typical_Price <= 44.75 )
						ret := 0.000000
					if( Typical_Price > 44.75 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_CRSR_1Day_8977b5d9(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
