			...
			if( tprice > 553.781 )
				...
				if( media_azul > 17.1661 )
					if( pvi_ema <= -0.090879 )
						ret := 0.971429 // buy
					if( pvi_ema > -0.090879 )
						if( azul_mean <= -55.6876 )
							ret := -0.176364
						if( azul_mean > -55.6876 )
							ret := 0.061664
		if( verde_media > 24.3466 )
			if( pvimax <= -0.010069 )
				if( verde_media <= 85.5362 )
					if( oscp <= 53.353 )
						if( pvimin <= -0.076412 )
							ret := 0.182573
						if( pvimin > -0.076412 )
...
float op_operation = decision_tree_0_NFLX_1Min_a73fcf9f(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
