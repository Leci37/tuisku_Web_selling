				...
				if( bbp > 2.25401 )
					if( bbm <= 1.01741 )
						...
						if( bbp > 3.07721 )
							ret := -0.720000 // sell
					if( bbm > 1.01741 )
						if( bearPower <= 1.35346 )
							ret := 0.133668
						if( bearPower > 1.35346 )
							ret := -0.108033
		if( bbm > 4.35865 )
			if( bbm <= 5.2475 )
				if( bullPower <= 1.40016 )
					if( bbm <= 4.53011 )
						ret := -0.705882 // sell
					if( bbm > 4.53011 )
						ret := 0.043478
...
float op_operation = decision_tree_0_FFIV_1Hour_c9302b4b(bearPower, bbm, bbp, bullPower, BBPower_Color)
