			...
			if( bearPower > 4.05531 )
				if( Lower_Band <= 324.462 )
					if( bullPower <= 6.03399 )
						if( Upper_Band <= 368.535 )
							ret := 0.720339 // buy
						if( Upper_Band > 368.535 )
							ret := 0.000000
					if( bullPower > 6.03399 )
						if( Lower_Band <= 313.99 )
							ret := 0.112540
						if( Lower_Band > 313.99 )
							ret := 0.708738 // buy
				if( Lower_Band > 324.462 )
					if( bearPower <= 5.03168 )
						if( basis <= 384.779 )
							ret := 0.307692
						if( basis > 384.779 )
							ret := -0.900000 // sell
					if( bearPower > 5.03168 )
						if( Upper_Band <= 388.818 )
							ret := -0.650000
						if( Upper_Band > 388.818 )
							ret := -0.193548
	if( Lower_Band > 385.559 )
		if( Upper_Band <= 465.624 )
			if( Upper_Band <= 397.009 )
				ret := 0.400000
			if( Upper_Band > 397.009 )
				if( Upper_Band <= 402.737 )
					ret := -0.903846 // sell
				if( Upper_Band > 402.737 )
					if( bearPower <= -6.23178 )
						if( Lower_Band <= 394.49 )
							ret := 0.380952
						if( Lower_Band > 394.49 )
							ret := -0.270588
					if( bearPower > -6.23178 )
...
float op_operation = decision_tree_0_TWLO_1Hour_f1baa116(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
