			...
			if( tenkan_sen > 269.24 )
				...
				if( basis_max > -0.106018 )
					...
					if( chinkou_span > 269.521 )
						ret := 0.183908
	if( basis_minus > 3.46002 )
		if( basis_max <= -0.095816 )
			if( basis_max <= -5.58097 )
				if( senkou_span_a <= 209.066 )
					if( senkou_span_a_displaced <= 199.779 )
						ret := 1.000000 // buy
					if( senkou_span_a_displaced > 199.779 )
						ret := -1.000000 // sell
				if( senkou_span_a > 209.066 )
					ret := 1.000000 // buy
			if( basis_max > -5.58097 )
				if( chinkou_span <= 269.9 )
					if( senkou_span_b_displaced <= 219.301 )
						ret := -0.610390
					if( senkou_span_b_displaced > 219.301 )
						ret := -0.948454 // sell
				if( chinkou_span > 269.9 )
					if( senkou_span_b_displaced <= 265.7 )
						ret := -0.777778 // sell
					if( senkou_span_b_displaced > 265.7 )
						ret := 1.000000 // buy
		if( basis_max > -0.095816 )
			if( senkou_span_b <= 265.635 )
				if( kinjun_sen <= 219.718 )
					if( senkou_span_b_displaced <= 203.89 )
						ret := -0.090909
					if( senkou_span_b_displaced > 203.89 )
						ret := 0.833333 // buy
				if( kinjun_sen > 219.718 )
					if( senkou_span_a <= 236.325 )
						ret := -1.000000 // sell
					if( senkou_span_a > 236.325 )
						ret := 0.142857
			if( senkou_span_b > 265.635 )
				if( senkou_span_a <= 271.275 )
					ret := 1.000000 // buy
				if( senkou_span_a > 271.275 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_ADSK_1Min_70abf143(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
