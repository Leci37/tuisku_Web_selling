		...
		if( Negative_Money_Flow_Sum > 4.48957e+08 )
			if( Positive_Money_Flow_Sum <= 3.85667e+08 )
				...
				if( Negative_Money_Flow_Sum > 9.86632e+08 )
					ret := 1.000000 // buy
			if( Positive_Money_Flow_Sum > 3.85667e+08 )
				if( Raw_Money_Flow <= 4.41533e+08 )
					if( Negative_Money_Flow_Sum <= 2.39836e+09 )
						ret := -0.225352
					if( Negative_Money_Flow_Sum > 2.39836e+09 )
						ret := -0.680000
				if( Raw_Money_Flow > 4.41533e+08 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_e3974ac9(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
