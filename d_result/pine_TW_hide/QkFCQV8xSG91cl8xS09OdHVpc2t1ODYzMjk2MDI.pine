...
decision_tree_0_BABA_1Hour_86329602(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)=>
	...
	if( nvi_ema <= 0.016324 )
		...
		if( nvi_ema > -0.109628 )
			...
			if( azul_mean > -5.64899 )
				if( tprice <= 260.745 )
					if( verde_media <= 38.2293 )
						if( azul_mean <= 23.6264 )
							ret := 0.204373
						if( azul_mean > 23.6264 )
							ret := -0.061571
					if( verde_media > 38.2293 )
...
float op_operation = decision_tree_0_BABA_1Hour_86329602(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
