			...
			if( MFI > 60.32 )
				...
				if( Typical_Price > 99.7779 )
					...
					if( MFI_Low > 47.5413 )
						ret := 0.142857
	if( Positive_Money_Flow_Sum > 3.34153e+09 )
		if( Raw_Money_Flow <= 5.91227e+08 )
			if( MFI_High <= -25.888 )
				if( Raw_Money_Flow <= 3.54042e+08 )
					if( MFI_High <= -29.1524 )
						ret := 0.384615
					if( MFI_High > -29.1524 )
						ret := -0.750000 // sell
				if( Raw_Money_Flow > 3.54042e+08 )
					if( Raw_Money_Flow <= 4.67955e+08 )
						ret := -0.641026
					if( Raw_Money_Flow > 4.67955e+08 )
						ret := -0.927273 // sell
			if( MFI_High > -25.888 )
				if( Typical_Price <= 102.179 )
					if( Positive_Money_Flow_Sum <= 4.19699e+09 )
						ret := -0.287879
					if( Positive_Money_Flow_Sum > 4.19699e+09 )
						ret := 0.650794
				if( Typical_Price > 102.179 )
					if( Positive_Money_Flow_Sum <= 4.48714e+09 )
						ret := -0.152778
					if( Positive_Money_Flow_Sum > 4.48714e+09 )
						ret := -0.674699
		if( Raw_Money_Flow > 5.91227e+08 )
			if( Typical_Price <= 101.8 )
				if( MFI_Low <= 48.5537 )
					if( MFI <= 56.1568 )
						ret := 0.357143
					if( MFI > 56.1568 )
				...
				if( MFI_Low > 48.5537 )
					ret := 0.222222
			if( Typical_Price > 101.8 )
				if( Positive_Money_Flow_Sum <= 7.29928e+09 )
					if( Negative_Money_Flow <= 6.25814e+08 )
						ret := -0.240506
					if( Negative_Money_Flow > 6.25814e+08 )
						ret := 0.529412
				if( Positive_Money_Flow_Sum > 7.29928e+09 )
...
float op_operation = decision_tree_0_DDOG_1Day_6d1dc644(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
