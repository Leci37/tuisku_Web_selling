				...
				if( basis > 84.2225 )
					if( Lower_Band <= 81.9828 )
						...
						if( bbp > 2.05906 )
							ret := 0.952381 // buy
					if( Lower_Band > 81.9828 )
						if( bullPower <= 1.88943 )
							ret := -0.062338
						if( bullPower > 1.88943 )
							ret := -0.609023
		if( Lower_Band > 97.3377 )
			if( Upper_Band <= 131.912 )
				if( bbm <= 0.489558 )
					if( bbp <= 5.01498 )
						if( bbp <= -3.16695 )
							ret := 0.666667
					...
					if( bbp > 5.01498 )
						ret := 0.000000
				if( bbm > 0.489558 )
					if( Lower_Band <= 109.064 )
						if( Upper_Band <= 114.985 )
							ret := 0.170213
						if( Upper_Band > 114.985 )
							ret := 0.879310 // buy
					if( Lower_Band > 109.064 )
			...
			if( Upper_Band > 131.912 )
				if( bbm <= 1.51333 )
					if( bullPower <= -0.727546 )
						ret := -1.000000 // sell
					if( bullPower > -0.727546 )
						ret := 0.083333
				if( bbm > 1.51333 )
					if( Upper_Band <= 134.014 )
						if( bbp <= -0.839714 )
							ret := -0.500000
						if( bbp > -0.839714 )
							ret := -1.000000 // sell
					if( Upper_Band > 134.014 )
						if( bearPower <= -6.25025 )
							ret := -1.000000 // sell
						if( bearPower > -6.25025 )
							ret := 0.714286 // buy
...
float op_operation = decision_tree_0_DOCN_1Hour_0885434c(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
