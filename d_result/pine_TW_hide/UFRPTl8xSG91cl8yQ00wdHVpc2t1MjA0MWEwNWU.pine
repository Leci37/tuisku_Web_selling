			...
			if( MFI > 71.4799 )
				...
				if( Typical_Price > 9.505 )
					...
					if( mf > 0.098722 )
						ret := -0.306250
	if( Raw_Money_Flow > 645965 )
		if( Positive_Money_Flow <= 8.1137e+08 )
			if( Raw_Money_Flow <= 2.1765e+08 )
				if( Negative_Money_Flow_Sum <= 1.18507e+09 )
					if( Negative_Money_Flow_Sum <= 9.8129e+08 )
						ret := 0.037827
					if( Negative_Money_Flow_Sum > 9.8129e+08 )
						ret := 0.598253
				if( Negative_Money_Flow_Sum > 1.18507e+09 )
					if( Positive_Money_Flow_Sum <= 1.73394e+08 )
						ret := 0.657895
					if( Positive_Money_Flow_Sum > 1.73394e+08 )
						ret := -0.327411
			if( Raw_Money_Flow > 2.1765e+08 )
				if( mf <= -0.172908 )
					...
					if( MFI_Low > 13.2871 )
						ret := -0.685185
				if( mf > -0.172908 )
					if( Typical_Price <= 89.5135 )
						ret := 0.672566
					if( Typical_Price > 89.5135 )
						ret := 0.170956
		if( Positive_Money_Flow > 8.1137e+08 )
			if( ad_mf <= 1.18726e+07 )
				if( MFI <= 99.2109 )
					if( ad_mf <= 2.65713e+06 )
						ret := -1.000000 // sell
					if( ad_mf > 2.65713e+06 )
						ret := -0.789474 // sell
				if( MFI > 99.2109 )
...
float op_operation = decision_tree_0_PTON_1Hour_2041a05e(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
