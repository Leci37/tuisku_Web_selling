...
decision_tree_0_SPOT_5Min_afb2567f(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)=>
	...
	if( bbp > 1.43773 )
		if( basis <= 305.269 )
			if( Upper_Band <= 311.072 )
				if( bullPower <= 4.69058 )
					if( Upper_Band <= 304.587 )
						ret := -0.033609
					if( Upper_Band > 304.587 )
						ret := 0.371951
				if( bullPower > 4.69058 )
					if( Lower_Band <= 150.021 )
						ret := 0.608696
					if( Lower_Band > 150.021 )
						ret := -0.662069
			if( Upper_Band > 311.072 )
			...
			if( Lower_Band <= 327.253 )
				...
				if( bbp > 1.69752 )
					...
					if( bearPower > 3.4279 )
						ret := -1.000000 // sell
			if( Lower_Band > 327.253 )
				if( Upper_Band <= 334.313 )
					if( bbp <= 1.91021 )
						ret := -0.466667
					if( bbp > 1.91021 )
						ret := 0.583333
				if( Upper_Band > 334.313 )
					if( Lower_Band <= 336.166 )
						ret := -0.309091
					if( Lower_Band > 336.166 )
						ret := -0.040519
...
float op_operation = decision_tree_0_SPOT_5Min_afb2567f(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
