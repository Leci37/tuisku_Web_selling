...
decision_tree_0_DOGEUSDT_1Day_62c1e1ed(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Typical_Price > 0.065206 )
		if( Positive_Money_Flow_Sum <= 7.32134e+09 )
			...
			if( Raw_Money_Flow > 4.93563e+08 )
				if( VIP <= 1.20583 )
					if( Negative_Money_Flow_Sum <= 1.76474e+09 )
						ret := 0.187500
					if( Negative_Money_Flow_Sum > 1.76474e+09 )
						ret := 0.754237 // buy
				if( VIP > 1.20583 )
					...
					if( Negative_Money_Flow_Sum > 4.51569e+08 )
						ret := -0.812500 // sell
		if( Positive_Money_Flow_Sum > 7.32134e+09 )
			if( Negative_Money_Flow_Sum <= 1.82388e+10 )
				if( VIM <= 0.563134 )
					ret := 0.750000 // buy
				if( VIM > 0.563134 )
					if( Positive_Money_Flow_Sum <= 8.73099e+09 )
						ret := -0.574468
					if( Positive_Money_Flow_Sum > 8.73099e+09 )
						ret := -0.914530 // sell
			if( Negative_Money_Flow_Sum > 1.82388e+10 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_62c1e1ed(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
