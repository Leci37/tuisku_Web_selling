			...
			if( bbp > 11.346 )
				if( bbp <= 21.4907 )
					...
					if( VIM > 0.737487 )
						ret := 0.172619
				if( bbp > 21.4907 )
					if( bullPower <= 40.6818 )
						ret := -0.310000
					if( bullPower > 40.6818 )
						ret := -1.000000 // sell
		if( bearPower > 16.7763 )
			if( bearPower <= 26.0277 )
				ret := -1.000000 // sell
			if( bearPower > 26.0277 )
				if( bullPower <= 61.6633 )
					ret := 0.000000
				if( bullPower > 61.6633 )
					if( bearPower <= 31.6535 )
						ret := 0.000000
					if( bearPower > 31.6535 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_SNOW_1Day_98892d7b(bbm, bearPower, bbp, bullPower, BBPower_Color, VIP_VIM, VIM, VIP)
