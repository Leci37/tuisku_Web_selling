				...
				if( BBlower > 96.2279 )
					...
					if( BBlower > 97.8583 )
						...
						if( dif_source_BBupper > -4.04099 )
							ret := 0.148771
		if( BBupper > 119.394 )
			if( dif_source_BBlower <= 40.501 )
				if( BBupper <= 210.628 )
					if( dif_source_BBlower <= -2.11907 )
						if( BBupper <= 131.433 )
							ret := -0.627376
						if( BBupper > 131.433 )
							ret := 0.018349
					if( dif_source_BBlower > -2.11907 )
						...
						if( BBupper > 194.265 )
							ret := 0.177346
				if( BBupper > 210.628 )
					if( dif_source_BBlower <= -0.863139 )
						if( dif_source_BBupper <= -34.6386 )
							ret := 0.712121 // buy
						if( dif_source_BBupper > -34.6386 )
							ret := -0.191489
					if( dif_source_BBlower > -0.863139 )
						if( dif_source_BBupper <= -35.1366 )
							ret := 0.493506
						if( dif_source_BBupper > -35.1366 )
							ret := -0.302980
			if( dif_source_BBlower > 40.501 )
...
float op_operation = decision_tree_0_ABNB_30Min_1e00fbc4(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
