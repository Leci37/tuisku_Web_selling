			...
			if( d_k <= -2.1021 )
				if( Negative_Money_Flow_Sum <= 8.65632e+09 )
					...
					if( d > 18.2631 )
						ret := -0.184049
				if( Negative_Money_Flow_Sum > 8.65632e+09 )
					if( Typical_Price <= 359.099 )
						ret := 0.600000
					if( Typical_Price > 359.099 )
						ret := -0.307692
			if( d_k > -2.1021 )
				if( rsi1 <= 51.6261 )
					if( Negative_Money_Flow_Sum <= 4.55676e+09 )
						ret := 0.653846
					if( Negative_Money_Flow_Sum > 4.55676e+09 )
						ret := -0.381148
				if( rsi1 > 51.6261 )
					...
					if( MFI > 48.4441 )
						ret := 0.363636
		if( d_k > 9.77339 )
			if( Negative_Money_Flow <= 5.54996e+07 )
				if( rsi1 <= 35.0972 )
					if( smoothD_d <= 30.315 )
						ret := 0.000000
					if( smoothD_d > 30.315 )
			...
			if( Negative_Money_Flow > 5.54996e+07 )
				if( MFI <= 48.8731 )
					if( Positive_Money_Flow_Sum <= 3.15723e+09 )
						ret := 0.466667
					if( Positive_Money_Flow_Sum > 3.15723e+09 )
						ret := 0.871429 // buy
				if( MFI > 48.8731 )
					if( Typical_Price <= 234.449 )
						ret := 0.580645
					if( Typical_Price > 234.449 )
						ret := -0.181818
...
float op_operation = decision_tree_0_CRWD_1Day_6a689a56(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
