				...
				if( senkou_span_a > 23.0703 )
					...
					if( chinkou_span > 22.7476 )
						...
						if( tenkan_sen > 23.745 )
							ret := -0.349003
			if( chinkou_span > 24.6513 )
				if( senkou_span_b <= 24.2943 )
					ret := 0.683109
				if( senkou_span_b > 24.2943 )
					if( chinkou_span <= 26.4901 )
						if( senkou_span_a <= 23.8656 )
							ret := -0.920000 // sell
						if( senkou_span_a > 23.8656 )
							ret := 0.104215
					if( chinkou_span > 26.4901 )
						ret := 0.751397 // buy
		if( senkou_span_a_displaced > 25.2861 )
			if( senkou_span_a_displaced <= 86.0694 )
				if( chinkou_span <= 26.0888 )
					if( kinjun_sen <= 25.9137 )
						if( chinkou_span <= 25.385 )
							ret := -0.197550
						if( chinkou_span > 25.385 )
							ret := 0.549296
					if( kinjun_sen > 25.9137 )
						if( basis_minus <= 0.152263 )
							ret := -0.401731
						if( basis_minus > 0.152263 )
							ret := -0.733138 // sell
				if( chinkou_span > 26.0888 )
					if( kinjun_sen <= 26.9768 )
						if( basis_minus <= -0.244078 )
							ret := 0.481949
						if( basis_minus > -0.244078 )
							ret := 0.119565
					if( kinjun_sen > 26.9768 )
						if( chinkou_span <= 28.5948 )
							ret := -0.211318
						if( chinkou_span > 28.5948 )
							ret := 0.028318
			if( senkou_span_a_displaced > 86.0694 )
...
float op_operation = decision_tree_0_PINS_1Hour_0275de4f(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
