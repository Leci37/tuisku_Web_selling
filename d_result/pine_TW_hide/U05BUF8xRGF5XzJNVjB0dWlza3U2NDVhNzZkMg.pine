			...
			if( Negative_Money_Flow > 3.52634e+08 )
				...
				if( MFI_High > -28.84 )
					...
					if( VIP > 1.22952 )
						ret := 0.400000
		if( Negative_Money_Flow_Sum > 2.43603e+09 )
			if( Typical_Price <= 10.2452 )
				if( Raw_Money_Flow <= 2.57177e+08 )
					if( Positive_Money_Flow_Sum <= 2.26284e+09 )
						ret := 0.034483
					if( Positive_Money_Flow_Sum > 2.26284e+09 )
						ret := 0.888889 // buy
				if( Raw_Money_Flow > 2.57177e+08 )
					if( Positive_Money_Flow_Sum <= 8.97061e+08 )
						ret := -0.400000
					if( Positive_Money_Flow_Sum > 8.97061e+08 )
						ret := 0.740000 // buy
			if( Typical_Price > 10.2452 )
				if( VIM <= 1.38482 )
					if( Money_Flow_Ratio <= 2.21789 )
						ret := 0.006329
					if( Money_Flow_Ratio > 2.21789 )
						ret := -0.475000
				if( VIM > 1.38482 )
...
float op_operation = decision_tree_0_SNAP_1Day_645a76d2(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)
