			...
			if( Positive_Money_Flow_Sum > 4.01596e+10 )
				...
				if( VIM > 0.831667 )
					...
					if( Positive_Money_Flow_Sum > 4.06087e+10 )
						ret := 0.153846
	if( Negative_Money_Flow_Sum > 4.00512e+10 )
		if( Positive_Money_Flow_Sum <= 3.63154e+10 )
			if( Positive_Money_Flow_Sum <= 1.50439e+10 )
				if( VIM <= 1.68132 )
					if( Typical_Price <= 354.909 )
						ret := 0.181818
					if( Typical_Price > 354.909 )
						ret := 1.000000 // buy
				if( VIM > 1.68132 )
			...
			if( Positive_Money_Flow_Sum > 1.50439e+10 )
				if( VIP_VIM <= 0.027928 )
					if( Negative_Money_Flow_Sum <= 7.53456e+10 )
						ret := -0.867257 // sell
					if( Negative_Money_Flow_Sum > 7.53456e+10 )
						ret := 0.000000
				if( VIP_VIM > 0.027928 )
					if( Typical_Price <= 402.929 )
						ret := 0.375000
					if( Typical_Price > 402.929 )
						ret := -1.000000 // sell
		if( Positive_Money_Flow_Sum > 3.63154e+10 )
			if( Raw_Money_Flow <= 4.55033e+09 )
				if( Negative_Money_Flow <= 1.68163e+09 )
					ret := -1.000000 // sell
				if( Negative_Money_Flow > 1.68163e+09 )
					ret := 0.000000
			if( Raw_Money_Flow > 4.55033e+09 )
				if( Money_Flow_Ratio <= 0.830366 )
					if( MFI_High <= -36.5923 )
						ret := 1.000000 // buy
					if( MFI_High > -36.5923 )
						ret := 0.000000
...
float op_operation = decision_tree_0_NFLX_1Day_d24ace3a(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
