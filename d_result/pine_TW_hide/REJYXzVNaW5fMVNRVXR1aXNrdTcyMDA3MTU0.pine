...
decision_tree_0_DBX_5Min_72007154(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)=>
	...
	if( avgHighLow > 26.9078 )
		if( basis <= 26.9612 )
			if( avgHighLow <= 27.0063 )
				ret := -0.359413
			if( avgHighLow > 27.0063 )
				ret := -0.897959 // sell
		if( basis > 26.9612 )
			if( rangema <= 0.284697 )
				if( priceRange <= 0.400536 )
					if( dev <= 0.477592 )
						if( upperBB <= 32.5811 )
							ret := -0.035452
						if( upperBB > 32.5811 )
...
float op_operation = decision_tree_0_DBX_5Min_72007154(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
