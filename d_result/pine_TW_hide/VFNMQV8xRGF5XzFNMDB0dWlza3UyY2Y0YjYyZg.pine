		...
		if( Typical_Price <= 1009.25 )
			if( MFI_High <= -67.043 )
				...
				if( Typical_Price > 211.831 )
					ret := 0.000000
			if( MFI_High > -67.043 )
				if( Typical_Price <= 146.518 )
					if( Typical_Price <= 126.465 )
						ret := 0.692308
					if( Typical_Price > 126.465 )
						ret := 1.000000 // buy
				if( Typical_Price > 146.518 )
					if( Negative_Money_Flow_Sum <= 1.57627e+11 )
						ret := -0.308855
					if( Negative_Money_Flow_Sum > 1.57627e+11 )
						ret := -0.017991
		if( Typical_Price > 1009.25 )
			if( MFI_High <= -14.3771 )
				if( Money_Flow_Ratio <= 1.20239 )
					if( Positive_Money_Flow <= 1.89952e+10 )
						ret := -0.894737 // sell
					if( Positive_Money_Flow > 1.89952e+10 )
						ret := -0.300000
				if( Money_Flow_Ratio > 1.20239 )
					if( Raw_Money_Flow <= 2.73154e+10 )
						ret := -0.090909
					if( Raw_Money_Flow > 2.73154e+10 )
						ret := 0.666667
			if( MFI_High > -14.3771 )
				if( Raw_Money_Flow <= 5.15958e+10 )
					ret := -1.000000 // sell
				if( Raw_Money_Flow > 5.15958e+10 )
					ret := -0.833333 // sell
...
float op_operation = decision_tree_0_TSLA_1Day_2cf4b62f(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
