				...
				if( ma <= 14.4919 )
					if( lowerBB <= 13.3917 )
						...
						if( rangema > 0.353699 )
							ret := -1.000000 // sell
					if( lowerBB > 13.3917 )
						if( priceRange <= 0.220187 )
							ret := -0.372340
						if( priceRange > 0.220187 )
							ret := -0.867925 // sell
				if( ma > 14.4919 )
					if( avgHighLow <= 18.2942 )
						if( lowerBB <= 17.1648 )
							ret := 0.066010
						if( lowerBB > 17.1648 )
							ret := 0.274119
...
float op_operation = decision_tree_0_ASAN_30Min_174d5b33(val, sqzOnInt, lowerBB, lowerKC, upperKC, dev, rangema, sqzOffInt, upperBB, priceRange, noSqzInt, ma, basis, avgHighLow)
