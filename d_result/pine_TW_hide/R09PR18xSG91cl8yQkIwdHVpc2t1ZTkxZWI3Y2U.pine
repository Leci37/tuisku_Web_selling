				...
				if( bbp <= 76.2276 )
					...
					if( bullPower > -13.022 )
						...
						if( basis > 2546.41 )
							ret := 0.752632 // buy
				if( bbp > 76.2276 )
					if( Lower_Band <= 2478.03 )
						ret := 0.666667
					if( Lower_Band > 2478.03 )
						ret := -1.000000 // sell
		if( basis > 2581.53 )
			if( bearPower <= -12.9869 )
				if( bbm <= 0.295 )
					if( Upper_Band <= 2771.87 )
						if( bullPower <= -19.0803 )
							ret := 1.000000 // buy
						if( bullPower > -19.0803 )
							ret := 0.000000
					if( Upper_Band > 2771.87 )
						if( Upper_Band <= 2952.96 )
							ret := -0.222222
						if( Upper_Band > 2952.96 )
							ret := 0.571429
				if( bbm > 0.295 )
					if( bbp <= -54.43 )
						if( Upper_Band <= 2892.23 )
							ret := 0.020408
						if( Upper_Band > 2892.23 )
							ret := 0.710526 // buy
					if( bbp > -54.43 )
			...
			if( bearPower > -12.9869 )
				if( bbm <= 4.16264 )
					if( Upper_Band <= 2852.26 )
						if( Upper_Band <= 2821.41 )
							ret := 0.181818
						if( Upper_Band > 2821.41 )
							ret := 0.847222 // buy
					if( Upper_Band > 2852.26 )
...
float op_operation = decision_tree_0_GOOG_1Hour_e91eb7ce(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
