		...
		if( Typical_Price <= 386.922 )
			if( Negative_Money_Flow_Sum <= 7.10112e+08 )
				if( Typical_Price <= 260.087 )
					if( Negative_Money_Flow_Sum <= 3.42475e+08 )
						ret := -0.418338
					if( Negative_Money_Flow_Sum > 3.42475e+08 )
						ret := 0.464286
				if( Typical_Price > 260.087 )
					...
					if( ad_mf > -44360.6 )
						ret := 0.291925
			if( Negative_Money_Flow_Sum > 7.10112e+08 )
				if( Typical_Price <= 370.791 )
					if( ad <= 163375 )
						ret := 0.974359 // buy
					if( ad > 163375 )
						ret := 0.500000
				if( Typical_Price > 370.791 )
					if( Positive_Money_Flow_Sum <= 8.54195e+08 )
						ret := 0.882353 // buy
					if( Positive_Money_Flow_Sum > 8.54195e+08 )
						ret := -0.833333 // sell
		if( Typical_Price > 386.922 )
			if( Negative_Money_Flow_Sum <= 6.84288e+08 )
				if( ad_mf <= -109515 )
					ret := 0.444444
				if( ad_mf > -109515 )
					if( Raw_Money_Flow <= 6.15745e+07 )
						ret := -0.312500
					if( Raw_Money_Flow > 6.15745e+07 )
						ret := -0.804878 // sell
			if( Negative_Money_Flow_Sum > 6.84288e+08 )
				if( Positive_Money_Flow <= 883261 )
					if( Negative_Money_Flow <= 1.57203e+08 )
						ret := -0.166667
					if( Negative_Money_Flow > 1.57203e+08 )
						ret := -0.833333 // sell
				if( Positive_Money_Flow > 883261 )
					if( Negative_Money_Flow_Sum <= 7.21818e+08 )
						ret := -0.700000 // sell
					if( Negative_Money_Flow_Sum > 7.21818e+08 )
						ret := -0.978723 // sell
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_c44c37d0(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
