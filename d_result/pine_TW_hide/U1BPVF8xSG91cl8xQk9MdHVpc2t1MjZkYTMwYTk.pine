...
decision_tree_0_SPOT_1Hour_26da30a9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)=>
	...
	if( BBlower > 231.17 )
		...
		if( dif_source_BBlower > 1.4616 )
			if( BBlower <= 305.767 )
				if( dif_source_BBlower <= 47.0782 )
					if( BBupper <= 278.4 )
						ret := 0.233954
					if( BBupper > 278.4 )
						if( dif_source_BBupper <= -3.45988 )
							ret := -0.178100
						if( dif_source_BBupper > -3.45988 )
							ret := 0.296651
				if( dif_source_BBlower > 47.0782 )
...
float op_operation = decision_tree_0_SPOT_1Hour_26da30a9(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
