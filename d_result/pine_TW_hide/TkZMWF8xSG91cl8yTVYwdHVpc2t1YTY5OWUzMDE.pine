				...
				if( VIP <= 1.31287 )
					...
					if( Negative_Money_Flow_Sum > 5.51481e+08 )
						...
						if( VIP_VIM > 0.342763 )
							ret := 0.134100
				if( VIP > 1.31287 )
					if( Positive_Money_Flow <= 6.87025e+08 )
						if( Money_Flow_Ratio <= 3.33395 )
							ret := 0.361111
						if( Money_Flow_Ratio > 3.33395 )
							ret := -0.378378
					if( Positive_Money_Flow > 6.87025e+08 )
						if( Positive_Money_Flow_Sum <= 7.58369e+09 )
							ret := 0.626263
						if( Positive_Money_Flow_Sum > 7.58369e+09 )
							ret := -1.000000 // sell
	if( Negative_Money_Flow_Sum > 5.23774e+09 )
		if( MFI_Low <= 32.7159 )
			if( VIP_VIM <= -0.412914 )
				if( Positive_Money_Flow <= 17034.6 )
					ret := -0.064516
				if( Positive_Money_Flow > 17034.6 )
					if( Positive_Money_Flow <= 2.46977e+06 )
						ret := -0.850000 // sell
					if( Positive_Money_Flow > 2.46977e+06 )
						if( VIP <= 0.824319 )
							ret := -0.357143
...
float op_operation = decision_tree_0_NFLX_1Hour_a699e301(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
