...
decision_tree_0_ZI_1Day_abfc06a5(ad, ad_mf, mf)=>
	...
	if( mf > 0.055159 )
		if( mf <= 0.126025 )
			if( ad_mf <= -3.21893e+06 )
				if( mf <= 0.071264 )
					if( ad_mf <= -3.53141e+06 )
						ret := 0.250000
					if( ad_mf > -3.53141e+06 )
						ret := -1.000000 // sell
				if( mf > 0.071264 )
			...
			if( ad_mf > -3.21893e+06 )
				...
				if( ad_mf > 2.02049e+06 )
					...
					if( ad > 2.59914e+06 )
						ret := -0.289474
		if( mf > 0.126025 )
			if( ad_mf <= 9.42217e+06 )
				if( ad_mf <= -2.01325e+06 )
					if( ad <= -3.05189e+06 )
						ret := -0.033333
					if( ad > -3.05189e+06 )
						ret := 0.900000 // buy
				if( ad_mf > -2.01325e+06 )
					if( ad_mf <= -1.69474e+06 )
						ret := -0.727273 // sell
					if( ad_mf > -1.69474e+06 )
						ret := 0.000000
			if( ad_mf > 9.42217e+06 )
...
float op_operation = decision_tree_0_ZI_1Day_abfc06a5(ad, ad_mf, mf)
