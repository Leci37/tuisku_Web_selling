				...
				if( smoothD_d <= 60.0715 )
					...
					if( smoothD_d > 31.996 )
						...
						if( bbm > 0.036804 )
							ret := 0.450413
				if( smoothD_d > 60.0715 )
					if( smoothK_k <= 83.4533 )
						if( bearPower <= 0.050418 )
							ret := 0.933333 // buy
						if( bearPower > 0.050418 )
							ret := -0.605882
					if( smoothK_k > 83.4533 )
...
float op_operation = decision_tree_0_CRSR_5Min_ecbc2fdc(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
