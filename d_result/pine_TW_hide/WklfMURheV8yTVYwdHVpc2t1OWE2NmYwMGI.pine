			...
			if( VIM <= 1.17252 )
				if( Typical_Price <= 11.5391 )
					...
					if( VIP_VIM > -0.210533 )
						ret := -1.000000 // sell
				if( Typical_Price > 11.5391 )
					if( Typical_Price <= 16.9083 )
						ret := -0.035714
					if( Typical_Price > 16.9083 )
						ret := -0.615385
			if( VIM > 1.17252 )
				if( Positive_Money_Flow <= 2.05836e+07 )
					if( VIP_VIM <= -0.325925 )
						ret := 0.157895
					if( VIP_VIM > -0.325925 )
						ret := 0.750000 // buy
				if( Positive_Money_Flow > 2.05836e+07 )
					if( Raw_Money_Flow <= 1.10993e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 1.10993e+08 )
						ret := -0.363636
		if( Typical_Price > 19.7464 )
			if( Negative_Money_Flow_Sum <= 7.80816e+08 )
				if( VIP <= 0.884016 )
					ret := 1.000000 // buy
				if( VIP > 0.884016 )
					if( Negative_Money_Flow_Sum <= 5.10695e+08 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow_Sum > 5.10695e+08 )
						ret := -0.428571
			if( Negative_Money_Flow_Sum > 7.80816e+08 )
				if( Typical_Price <= 45.0879 )
					if( MFI_Low <= 31.6938 )
						ret := 0.530075
					if( MFI_Low > 31.6938 )
						ret := -0.240000
				if( Typical_Price > 45.0879 )
					if( Positive_Money_Flow_Sum <= 1.47619e+09 )
						ret := -0.491525
					if( Positive_Money_Flow_Sum > 1.47619e+09 )
						ret := 0.575758
...
float op_operation = decision_tree_0_ZI_1Day_9a66f00b(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, VIP_VIM, VIP, VIM)
