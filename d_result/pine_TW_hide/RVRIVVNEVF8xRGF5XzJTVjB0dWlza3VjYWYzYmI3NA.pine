...
decision_tree_0_ETHUSDT_1Day_caf3bb74(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)=>
	...
	if( rsi1 > 49.4174 )
		if( d <= 86.6807 )
			if( smoothD_d <= 74.4478 )
				if( k <= 74.4173 )
					if( smoothD_d <= 49.4864 )
						ret := 0.194611
					if( smoothD_d > 49.4864 )
						ret := -0.254355
				if( k > 74.4173 )
					if( smoothD_d <= 55.3022 )
						ret := -0.428571
					if( smoothD_d > 55.3022 )
						ret := 0.636364
			if( smoothD_d > 74.4478 )
		...
		if( d > 86.6807 )
			if( VIP_VIM <= 0.090673 )
				if( d_k <= -5.73873 )
					ret := -1.000000 // sell
				if( d_k > -5.73873 )
					if( smoothK_k <= 74.8002 )
						ret := 1.000000 // buy
					if( smoothK_k > 74.8002 )
						ret := -0.291667
			if( VIP_VIM > 0.090673 )
				if( smoothD_d <= 90.5162 )
					if( VIP <= 1.11319 )
						ret := 0.298246
					if( VIP > 1.11319 )
						ret := 0.695455
				if( smoothD_d > 90.5162 )
					if( smoothK_k <= 95.8028 )
						ret := -0.107143
					if( smoothK_k > 95.8028 )
						ret := 0.542857
...
float op_operation = decision_tree_0_ETHUSDT_1Day_caf3bb74(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)
