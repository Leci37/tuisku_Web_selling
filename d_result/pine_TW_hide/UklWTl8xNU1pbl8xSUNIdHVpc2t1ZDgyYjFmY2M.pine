			...
			if( kinjun_sen <= 13.6671 )
				...
				if( basis_max > -2.1e-05 )
					if( chinkou_span <= 11.219 )
						ret := -0.697479
					if( chinkou_span > 11.219 )
						if( senkou_span_a_displaced <= 13.9847 )
							ret := 0.008459
						if( senkou_span_a_displaced > 13.9847 )
							ret := -0.967742 // sell
			if( kinjun_sen > 13.6671 )
				if( basis_max <= 0.303434 )
					ret := -0.657343
				if( basis_max > 0.303434 )
					ret := 0.173913
		if( chinkou_span > 13.3778 )
			if( senkou_span_a <= 13.5932 )
				if( chinkou_span <= 13.7219 )
					ret := 0.336387
				if( chinkou_span > 13.7219 )
					ret := 0.600832
			if( senkou_span_a > 13.5932 )
				if( tenkan_sen <= 63.5055 )
					if( chinkou_span <= 13.9073 )
						if( basis_max <= 0.006689 )
							ret := -0.538663
						if( basis_max > 0.006689 )
							ret := -0.214286
					if( chinkou_span > 13.9073 )
						if( senkou_span_a <= 14.0088 )
							ret := 0.519540
						if( senkou_span_a > 14.0088 )
							ret := 0.012257
				if( tenkan_sen > 63.5055 )
					if( senkou_span_b_displaced <= 80.8975 )
						if( chinkou_span <= 64.8295 )
							ret := -0.578402
						if( chinkou_span > 64.8295 )
							ret := -0.127451
					if( senkou_span_b_displaced > 80.8975 )
						if( senkou_span_a_displaced <= 81.48 )
							ret := 0.625000
						if( senkou_span_a_displaced > 81.48 )
							ret := -0.010594
...
float op_operation = decision_tree_0_RIVN_15Min_d82b1fcc(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
