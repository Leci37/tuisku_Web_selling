			...
			if( senkou_span_a_displaced > 13.1187 )
				...
				if( chinkou_span > 31.9784 )
					...
					if( basis_max > -0.269962 )
						ret := 0.525510
	if( senkou_span_a_displaced > 52.6413 )
		if( senkou_span_b <= 57.925 )
			if( senkou_span_b <= 51.4144 )
				if( basis_minus <= -0.246763 )
					ret := -0.750000 // sell
				if( basis_minus > -0.246763 )
					if( tenkan_sen <= 50.9407 )
						ret := -0.916667 // sell
					if( tenkan_sen > 50.9407 )
						ret := -1.000000 // sell
			if( senkou_span_b > 51.4144 )
				if( senkou_span_a <= 55.2455 )
					if( senkou_span_a_displaced <= 58.2513 )
						ret := 0.219512
					if( senkou_span_a_displaced > 58.2513 )
						ret := -0.073171
				if( senkou_span_a > 55.2455 )
					...
					if( basis_max > 0.7705 )
						ret := -0.714286 // sell
		if( senkou_span_b > 57.925 )
			if( senkou_span_a <= 62.4694 )
				if( chinkou_span <= 46.95 )
					if( basis_max <= 0.770926 )
						ret := 0.000000
					if( basis_max > 0.770926 )
						ret := -0.812500 // sell
				if( chinkou_span > 46.95 )
					if( senkou_span_b <= 60.1769 )
						ret := -0.250000
					if( senkou_span_b > 60.1769 )
						ret := -1.000000 // sell
			if( senkou_span_a > 62.4694 )
...
float op_operation = decision_tree_0_LYFT_1Day_5c9e4941(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
