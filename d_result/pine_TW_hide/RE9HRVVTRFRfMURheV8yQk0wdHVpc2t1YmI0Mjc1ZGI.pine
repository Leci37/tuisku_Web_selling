			...
			if( bearPower > 0.00082 )
				...
				if( Raw_Money_Flow > 3.43333e+08 )
					...
					if( MFI_High > 15.2933 )
						ret := 0.750000 // buy
	if( Negative_Money_Flow_Sum > 4.84004e+08 )
		if( bullPower <= -0.032612 )
			ret := 1.000000 // buy
		if( bullPower > -0.032612 )
			if( Typical_Price <= 0.27984 )
				if( bbm <= 0.016673 )
					if( Negative_Money_Flow_Sum <= 2.28334e+09 )
						ret := -0.021918
					if( Negative_Money_Flow_Sum > 2.28334e+09 )
						ret := -0.477707
				if( bbm > 0.016673 )
					if( bullPower <= 0.033664 )
						ret := 0.381720
					if( bullPower > 0.033664 )
						ret := -0.328571
			if( Typical_Price > 0.27984 )
				if( bullPower <= 0.032232 )
					if( Money_Flow_Ratio <= 0.878296 )
						ret := -0.466667
					if( Money_Flow_Ratio > 0.878296 )
						ret := -1.000000 // sell
				if( bullPower > 0.032232 )
					if( Positive_Money_Flow <= 5.30886e+08 )
						ret := -0.772727 // sell
					if( Positive_Money_Flow > 5.30886e+08 )
						ret := 0.333333
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_bb4275db(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
