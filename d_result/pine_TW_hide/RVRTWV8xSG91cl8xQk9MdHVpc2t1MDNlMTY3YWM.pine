			...
			if( dif_source_BBupper > -31.6928 )
				...
				if( BBlower > 29.3316 )
					...
					if( BBlower > 36.5714 )
						ret := -0.029142
		if( BBlower > 238.283 )
			if( dif_source_BBupper <= -57.4402 )
				if( dif_source_BBlower <= -20.4272 )
					ret := 1.000000 // buy
				if( dif_source_BBlower > -20.4272 )
					if( vrsi <= 11.3193 )
						ret := -0.500000
...
float op_operation = decision_tree_0_ETSY_1Hour_03e167ac(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
