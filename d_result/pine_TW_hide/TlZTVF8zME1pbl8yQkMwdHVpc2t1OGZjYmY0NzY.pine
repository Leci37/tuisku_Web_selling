				...
				if( mf > 0.105563 )
					if( ad <= 111973 )
						...
						if( ad > 76346.6 )
							ret := 0.161572
					if( ad > 111973 )
						if( bullPower <= 0.251667 )
							ret := -0.177570
						if( bullPower > 0.251667 )
							ret := -0.654321
			if( ad > 154027 )
				if( ad <= 157242 )
					if( bullPower <= 0.199075 )
						ret := 1.000000 // buy
					if( bullPower > 0.199075 )
						ret := 0.636364
				if( ad > 157242 )
					if( bullPower <= 0.047623 )
						if( bearPower <= -0.30522 )
							ret := 0.270270
						if( bearPower > -0.30522 )
							ret := -0.304598
					if( bullPower > 0.047623 )
						if( bullPower <= 0.144268 )
							ret := 0.344538
						if( bullPower > 0.144268 )
							ret := 0.064384
		if( bullPower > 0.630587 )
...
float op_operation = decision_tree_0_NVST_30Min_8fcbf476(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
