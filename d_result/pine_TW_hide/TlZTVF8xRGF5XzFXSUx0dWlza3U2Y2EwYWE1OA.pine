			...
			if( lowerBand <= 1.8285 )
				...
				if( lowerBand > -0.532535 )
					...
					if( sDev > 24.772 )
						ret := 1.000000 // buy
			if( lowerBand > 1.8285 )
				if( upperBand <= 69.0247 )
					if( Color_con1 <= -12.6355 )
						ret := 0.590361
					if( Color_con1 > -12.6355 )
						ret := 0.214286
				if( upperBand > 69.0247 )
					if( lowerBand <= 7.80113 )
						ret := 0.800000 // buy
					if( lowerBand > 7.80113 )
						ret := -0.888889 // sell
		if( Color_con1 > -10.5885 )
			if( lowerBand <= 0.290549 )
				if( Color_con1 <= -6.05563 )
					if( Color_con2 <= -9.50186 )
						ret := 0.133333
					if( Color_con2 > -9.50186 )
						ret := -0.569231
				if( Color_con1 > -6.05563 )
					...
					if( midLine > 7.23236 )
						ret := -0.875000 // sell
			if( lowerBand > 0.290549 )
				if( Color_con1 <= -4.47036 )
					if( sDev <= 6.42926 )
						ret := 0.076271
					if( sDev > 6.42926 )
						ret := -0.430380
				if( Color_con1 > -4.47036 )
					if( Color_con2 <= -3.10716 )
						ret := -0.710744 // sell
					if( Color_con2 > -3.10716 )
						ret := -0.293814
...
float op_operation = decision_tree_0_NVST_1Day_6ca0aa58(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
