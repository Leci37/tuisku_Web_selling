...
float op_operation = decision_tree_0_DDOG_30Min_8bb2deb0(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
