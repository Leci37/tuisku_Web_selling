		...
		if( vrsi <= 8.94369 )
			...
			if( dif_source_BBupper > -0.173948 )
				...
				if( vrsi > 8.68409 )
					ret := 1.000000 // buy
		if( vrsi > 8.94369 )
			if( dif_source_BBlower <= 0.030554 )
				if( dif_source_BBlower <= 0.029931 )
					if( dif_source_BBlower <= 0.023865 )
						ret := 0.057851
					if( dif_source_BBlower > 0.023865 )
						ret := -0.316667
				if( dif_source_BBlower > 0.029931 )
					if( dif_source_BBupper <= -0.099356 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > -0.099356 )
						ret := -1.000000 // sell
			if( dif_source_BBlower > 0.030554 )
				if( BBlower <= 0.093342 )
					if( dif_source_BBlower <= 0.580882 )
						ret := -0.286424
					if( dif_source_BBlower > 0.580882 )
						ret := -0.764706 // sell
				if( BBlower > 0.093342 )
					if( dif_source_BBupper <= -0.192097 )
						ret := -0.210526
					if( dif_source_BBupper > -0.192097 )
						ret := -0.833333 // sell
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_9ea707c1(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
