			...
			if( dif_source_BBlower <= 3.20685 )
				if( BBupper <= 23.4027 )
					...
					if( vrsi > 60.3019 )
						ret := -0.066649
				if( BBupper > 23.4027 )
					if( dif_source_BBupper <= -3.85339 )
						ret := 0.123209
					if( dif_source_BBupper > -3.85339 )
						ret := 0.619048
			if( dif_source_BBlower > 3.20685 )
				if( vrsi <= 93.4444 )
					if( dif_source_BBupper <= -0.698709 )
						ret := -0.327037
					if( dif_source_BBupper > -0.698709 )
						ret := -0.007292
				if( vrsi > 93.4444 )
					...
					if( BBlower > 17.9127 )
						ret := -0.292683
		if( BBlower > 20.4438 )
			if( dif_source_BBlower <= 2.86552 )
				if( dif_source_BBlower <= -1.62453 )
					if( BBupper <= 152.815 )
						ret := -0.868852 // sell
					if( BBupper > 152.815 )
						ret := 0.000000
				if( dif_source_BBlower > -1.62453 )
					...
					if( BBlower > 59.2515 )
						ret := 0.325581
			if( dif_source_BBlower > 2.86552 )
				if( dif_source_BBupper <= -49.8671 )
					if( BBupper <= 156.369 )
						ret := 0.892308 // buy
					if( BBupper > 156.369 )
						ret := 0.000000
				if( dif_source_BBupper > -49.8671 )
					if( dif_source_BBlower <= 30.6069 )
						ret := -0.044157
					if( dif_source_BBlower > 30.6069 )
						ret := -0.701299 // sell
...
float op_operation = decision_tree_0_ASAN_30Min_0a24118c(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
