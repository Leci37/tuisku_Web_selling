...
decision_tree_0_ABNB_30Min_9fd48e32(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)=>
	...
	if( basis_max <= -6.81711 )
		...
		if( lower_1 > 189.595 )
			...
			if( upper_2 > 208.002 )
				if( lower_2 <= 194.675 )
					if( basis_max <= -28.6334 )
						if( lower_4 <= 182.4 )
							ret := 0.071429
						if( lower_4 > 182.4 )
							ret := -0.705882 // sell
					if( basis_max > -28.6334 )
						if( basis_minus <= 25.3335 )
							ret := 0.088235
						if( basis_minus > 25.3335 )
							ret := 0.753623 // buy
				if( lower_2 > 194.675 )
...
float op_operation = decision_tree_0_ABNB_30Min_9fd48e32(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
