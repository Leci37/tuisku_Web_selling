...
decision_tree_0_ETSY_1Day_6bf85677(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Positive_Money_Flow_Sum > 1.10197e+09 )
		if( Positive_Money_Flow_Sum <= 3.79338e+09 )
			if( Typical_Price <= 133.6 )
				if( Positive_Money_Flow_Sum <= 1.76365e+09 )
					if( Negative_Money_Flow_Sum <= 1.55982e+09 )
						ret := -0.462963
					if( Negative_Money_Flow_Sum > 1.55982e+09 )
						ret := -0.059459
				if( Positive_Money_Flow_Sum > 1.76365e+09 )
					if( Positive_Money_Flow_Sum <= 2.46734e+09 )
						ret := 0.261981
					if( Positive_Money_Flow_Sum > 2.46734e+09 )
						ret := -0.169811
			if( Typical_Price > 133.6 )
				if( Positive_Money_Flow_Sum <= 2.59777e+09 )
					if( Raw_Money_Flow <= 3.10337e+08 )
						ret := 0.571429
					if( Raw_Money_Flow > 3.10337e+08 )
						ret := -0.808333 // sell
				if( Positive_Money_Flow_Sum > 2.59777e+09 )
		...
		if( Positive_Money_Flow_Sum > 3.79338e+09 )
			if( MFI_High <= -37.1344 )
				if( Raw_Money_Flow <= 5.43574e+08 )
					if( Money_Flow_Ratio <= 0.714098 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 0.714098 )
						ret := -0.857143 // sell
				if( Raw_Money_Flow > 5.43574e+08 )
					ret := -0.285714
			if( MFI_High > -37.1344 )
				if( Raw_Money_Flow <= 8.22745e+08 )
					if( Negative_Money_Flow_Sum <= 3.92066e+09 )
						ret := 0.095101
					if( Negative_Money_Flow_Sum > 3.92066e+09 )
						ret := 0.609756
				if( Raw_Money_Flow > 8.22745e+08 )
...
float op_operation = decision_tree_0_ETSY_1Day_6bf85677(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
