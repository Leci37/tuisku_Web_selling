		...
		if( Typical_Price <= 34.2609 )
			if( MFI_Low <= 24.4492 )
				...
				if( Negative_Money_Flow_Sum > 3.70995e+07 )
					ret := 0.800000 // buy
			if( MFI_Low > 24.4492 )
				if( Positive_Money_Flow <= 70.8003 )
					if( MFI_Low <= 49.0958 )
						ret := 0.634146
					if( MFI_Low > 49.0958 )
						ret := -0.225806
				if( Positive_Money_Flow > 70.8003 )
					...
					if( d_k > 1.22287 )
						ret := 0.461538
		if( Typical_Price > 34.2609 )
			if( Money_Flow_Ratio <= 0.373194 )
				if( Positive_Money_Flow_Sum <= 4.18452e+07 )
					if( k <= 35.5689 )
						ret := -0.451923
					if( k > 35.5689 )
						ret := 0.052632
				if( Positive_Money_Flow_Sum > 4.18452e+07 )
					if( Positive_Money_Flow <= 5214.24 )
						ret := -0.197674
					if( Positive_Money_Flow > 5214.24 )
						ret := -0.617801
			if( Money_Flow_Ratio > 0.373194 )
				if( d_k <= -13.2504 )
					if( Negative_Money_Flow_Sum <= 2.21889e+07 )
						ret := 0.019753
					if( Negative_Money_Flow_Sum > 2.21889e+07 )
						ret := -0.183942
				if( d_k > -13.2504 )
...
float op_operation = decision_tree_0_DDOG_30Min_392aea13(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
