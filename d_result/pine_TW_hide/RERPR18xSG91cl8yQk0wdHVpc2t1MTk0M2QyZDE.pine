	...
	if( Positive_Money_Flow > 2124.74 )
		if( Typical_Price <= 34.4697 )
			...
			if( Positive_Money_Flow_Sum > 1.15666e+08 )
				ret := -0.727273 // sell
		if( Typical_Price > 34.4697 )
			if( Negative_Money_Flow_Sum <= 9.53485e+07 )
				if( Positive_Money_Flow_Sum <= 4.83873e+07 )
					if( Money_Flow_Ratio <= 2.04664 )
						if( Negative_Money_Flow_Sum <= 5.92837e+07 )
							ret := -0.240418
						if( Negative_Money_Flow_Sum > 5.92837e+07 )
							ret := 0.507576
					if( Money_Flow_Ratio > 2.04664 )
						...
						if( bbm > 0.152165 )
							ret := 0.904110 // buy
				if( Positive_Money_Flow_Sum > 4.83873e+07 )
					if( bearPower <= 1.13466 )
						if( Raw_Money_Flow <= 1.49961e+07 )
							ret := -0.249792
						if( Raw_Money_Flow > 1.49961e+07 )
							ret := -0.054054
					if( bearPower > 1.13466 )
						if( Negative_Money_Flow_Sum <= 75336.2 )
							ret := 0.866667 // buy
						if( Negative_Money_Flow_Sum > 75336.2 )
							ret := -0.434622
			if( Negative_Money_Flow_Sum > 9.53485e+07 )
				if( Negative_Money_Flow_Sum <= 2.26053e+08 )
					if( MFI <= 28.3318 )
						ret := -0.251064
					if( MFI > 28.3318 )
						ret := 0.059083
				if( Negative_Money_Flow_Sum > 2.26053e+08 )
					if( Positive_Money_Flow_Sum <= 4.7966e+07 )
						ret := -0.491379
					if( Positive_Money_Flow_Sum > 4.7966e+07 )
						if( bearPower <= -4.06339 )
							ret := 0.243902
						if( bearPower > -4.06339 )
							ret := -0.127268
...
float op_operation = decision_tree_0_DDOG_1Hour_1943d2d1(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
