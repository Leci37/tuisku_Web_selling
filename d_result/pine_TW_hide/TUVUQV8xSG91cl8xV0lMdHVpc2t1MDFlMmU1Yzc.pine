				...
				if( wvf > 2.8647 )
					...
					if( upperBand > 7.29264 )
						...
						if( Color_con2 > -4.69254 )
							ret := 0.096336
			if( wvf > 5.63625 )
				if( Color_con1 <= -3.62283 )
					if( midLine <= 8.67478 )
						if( lowerBand <= -1.20868 )
							ret := 0.363636
						if( lowerBand > -1.20868 )
							ret := -0.510823
					if( midLine > 8.67478 )
						if( Color_con1 <= -4.81562 )
							ret := 0.952381 // buy
						if( Color_con1 > -4.81562 )
							ret := -0.142857
				if( Color_con1 > -3.62283 )
	...
	if( midLine > 9.1051 )
		...
		if( midLine > 12.5042 )
			if( lowerBand <= -0.9821 )
				ret := -0.852941 // sell
			if( lowerBand > -0.9821 )
				if( lowerBand <= 4.48804 )
					ret := 0.900000 // buy
				if( lowerBand > 4.48804 )
					if( wvf <= 9.36766 )
						ret := -0.882353 // sell
					if( wvf > 9.36766 )
						if( Color_con1 <= -4.65456 )
							ret := 0.684211
						if( Color_con1 > -4.65456 )
							ret := -0.500000
...
float op_operation = decision_tree_0_META_1Hour_01e2e5c7(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
