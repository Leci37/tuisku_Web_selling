			...
			if( ema13 > 0.040566 )
				...
				if( d > 85.1991 )
					...
					if( d > 92.2271 )
						ret := 0.538462
	if( rsi1 > 52.5762 )
		if( smoothK_k <= 96.2347 )
			if( smoothD_d <= 92.2003 )
				if( ema13 <= 0.0153 )
					if( d_k <= -19.1504 )
						if( ema13 <= -0.03514 )
							ret := -0.527273
...
float op_operation = decision_tree_0_ZI_5Min_069021e3(smoothK_k, d_k, k, smoothD_d, rsi1, d, ema2, tema, ema12, ema3, ema1, ema13)
