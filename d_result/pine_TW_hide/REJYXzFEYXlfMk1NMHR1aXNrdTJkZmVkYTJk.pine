			...
			if( Long_MA <= 28.0988 )
				if( Raw_Money_Flow <= 7.71339e+07 )
					...
					if( Negative_Money_Flow_Sum > 2.82862e+08 )
						ret := 0.242424
				if( Raw_Money_Flow > 7.71339e+07 )
					if( Positive_Money_Flow_Sum <= 3.83765e+08 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 3.83765e+08 )
						ret := -0.615385
			if( Long_MA > 28.0988 )
				if( Typical_Price <= 29.9466 )
					if( Positive_Money_Flow_Sum <= 4.01738e+08 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 4.01738e+08 )
						ret := 0.800000 // buy
				if( Typical_Price > 29.9466 )
					ret := 0.333333
		if( Positive_Money_Flow_Sum > 4.26558e+08 )
			if( Raw_Money_Flow <= 7.03337e+07 )
				if( Money_Flow_Ratio <= 1.70478 )
					if( MFI <= 38.7617 )
						ret := -0.853659 // sell
					if( MFI > 38.7617 )
						ret := -0.100671
				if( Money_Flow_Ratio > 1.70478 )
					...
					if( Long_MA > 22.287 )
						ret := -0.760563 // sell
			if( Raw_Money_Flow > 7.03337e+07 )
				if( Raw_Money_Flow <= 1.73442e+08 )
					if( Negative_Money_Flow_Sum <= 9.81786e+08 )
						ret := 0.013699
					if( Negative_Money_Flow_Sum > 9.81786e+08 )
						ret := -0.326667
				if( Raw_Money_Flow > 1.73442e+08 )
					if( Short_Long_Diff <= -0.346186 )
						ret := -0.037736
					if( Short_Long_Diff > -0.346186 )
						ret := -0.648148
...
float op_operation = decision_tree_0_DBX_1Day_2dfeda2d(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
