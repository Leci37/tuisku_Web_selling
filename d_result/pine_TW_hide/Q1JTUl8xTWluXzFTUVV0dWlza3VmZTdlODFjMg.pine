...
float op_operation = decision_tree_0_CRSR_1Min_fe7e81c2(val, sqzOnInt, lowerBB, lowerKC, upperKC, dev, rangema, sqzOffInt, upperBB, priceRange, noSqzInt, ma, basis, avgHighLow)
