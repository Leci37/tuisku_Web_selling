			...
			if( bullPower <= 2.20038 )
				...
				if( bbp > 2.95798 )
					...
					if( bearPower > 1.2278 )
						ret := 0.600000
			if( bullPower > 2.20038 )
				if( bearPower <= 1.62535 )
					if( bbm <= 1.14236 )
						ret := -0.975000 // sell
					if( bbm > 1.14236 )
						ret := -0.800000 // sell
				if( bearPower > 1.62535 )
					if( bullPower <= 2.62423 )
						ret := 0.000000
					if( bullPower > 2.62423 )
						ret := -0.500000
		if( bbp > 4.93235 )
			if( bullPower <= 7.23748 )
				if( bbp <= 5.17359 )
					if( bullPower <= 3.18453 )
						ret := 0.500000
					if( bullPower > 3.18453 )
						ret := 0.857143 // buy
				if( bbp > 5.17359 )
					if( bearPower <= 1.27212 )
						ret := -0.909091 // sell
					if( bearPower > 1.27212 )
						ret := 0.119266
			if( bullPower > 7.23748 )
...
float op_operation = decision_tree_0_PINS_1Day_33f5a566(bearPower, bbm, bbp, bullPower, BBPower_Color)
