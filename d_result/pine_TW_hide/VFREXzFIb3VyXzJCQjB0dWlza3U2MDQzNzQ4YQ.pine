				...
				if( Upper_Band <= 50.9848 )
					...
					if( bbm > 0.02 )
						...
						if( bullPower > 0.22817 )
							ret := 0.756098 // buy
				if( Upper_Band > 50.9848 )
					if( bearPower <= 0.206413 )
						if( bearPower <= -1.86967 )
							ret := 0.044488
						if( bearPower > -1.86967 )
							ret := -0.062914
					if( bearPower > 0.206413 )
						if( Lower_Band <= 57.575 )
							ret := -0.106529
						if( Lower_Band > 57.575 )
							ret := 0.069036
		if( Upper_Band > 825.663 )
			if( Lower_Band <= 802.263 )
				if( Lower_Band <= 778.285 )
					if( Lower_Band <= 752.074 )
						ret := -0.722772 // sell
					if( Lower_Band > 752.074 )
						ret := 0.172414
				if( Lower_Band > 778.285 )
					ret := -0.789157 // sell
			if( Lower_Band > 802.263 )
				if( Upper_Band <= 915.127 )
					if( bearPower <= -1.35376 )
						ret := 0.410448
					if( bearPower > -1.35376 )
						if( Lower_Band <= 854.512 )
							ret := 0.058140
						if( Lower_Band > 854.512 )
							ret := -0.703704 // sell
				if( Upper_Band > 915.127 )
...
float op_operation = decision_tree_0_TTD_1Hour_6043748a(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
