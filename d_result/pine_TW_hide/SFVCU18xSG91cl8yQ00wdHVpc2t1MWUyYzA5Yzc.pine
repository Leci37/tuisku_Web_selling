				...
				if( mf <= -0.034252 )
					...
					if( Positive_Money_Flow_Sum > 2.97428e+07 )
						...
						if( Negative_Money_Flow > 10358.3 )
							ret := 0.002446
				if( mf > -0.034252 )
					if( Negative_Money_Flow_Sum <= 4.52147e+08 )
						if( Raw_Money_Flow <= 2.51078e+07 )
							ret := 0.003692
						if( Raw_Money_Flow > 2.51078e+07 )
							ret := 0.096339
					if( Negative_Money_Flow_Sum > 4.52147e+08 )
						...
						if( MFI > 27.0793 )
							ret := 0.659722
		if( Positive_Money_Flow_Sum > 3.75485e+08 )
			if( Raw_Money_Flow <= 1.12488e+08 )
				if( mf <= -0.040029 )
					if( Typical_Price <= 676.718 )
						if( ad <= 504.575 )
							ret := 0.279279
						if( ad > 504.575 )
							ret := -0.433333
					if( Typical_Price > 676.718 )
						ret := 0.829268 // buy
				if( mf > -0.040029 )
					if( Typical_Price <= 408.411 )
						if( Money_Flow_Ratio <= 2.67042 )
							ret := -0.722222 // sell
						if( Money_Flow_Ratio > 2.67042 )
							ret := -0.286713
					if( Typical_Price > 408.411 )
...
float op_operation = decision_tree_0_HUBS_1Hour_1e2c09c7(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
