			...
			if( mf > -0.100549 )
				...
				if( Typical_Price > 291.802 )
					...
					if( Money_Flow_Ratio > 1.50245 )
						ret := -0.267857
	if( mf > 0.115151 )
		if( Negative_Money_Flow_Sum <= 6.74952e+08 )
			if( Positive_Money_Flow_Sum <= 1.04215e+09 )
				if( MFI_Low <= 24.7265 )
					if( Raw_Money_Flow <= 2.58243e+07 )
						ret := 0.800000 // buy
					if( Raw_Money_Flow > 2.58243e+07 )
						ret := 0.000000
				if( MFI_Low > 24.7265 )
					if( Typical_Price <= 179.168 )
						ret := -0.148248
					if( Typical_Price > 179.168 )
						ret := -0.449438
			if( Positive_Money_Flow_Sum > 1.04215e+09 )
				if( mf <= 0.368011 )
					if( Raw_Money_Flow <= 1.31409e+08 )
						ret := 0.144737
					if( Raw_Money_Flow > 1.31409e+08 )
						ret := 0.729167 // buy
				if( mf > 0.368011 )
					ret := -1.000000 // sell
		if( Negative_Money_Flow_Sum > 6.74952e+08 )
			if( Negative_Money_Flow_Sum <= 2.23777e+09 )
				if( Raw_Money_Flow <= 9.2718e+07 )
					if( mf <= 0.149304 )
						ret := 0.666667
					if( mf > 0.149304 )
						ret := 0.000000
				if( Raw_Money_Flow > 9.2718e+07 )
					if( Negative_Money_Flow <= 1.28446e+08 )
						ret := -0.760000 // sell
					if( Negative_Money_Flow > 1.28446e+08 )
						ret := -0.244444
			if( Negative_Money_Flow_Sum > 2.23777e+09 )
...
float op_operation = decision_tree_0_EPAM_1Day_a63f8b74(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
