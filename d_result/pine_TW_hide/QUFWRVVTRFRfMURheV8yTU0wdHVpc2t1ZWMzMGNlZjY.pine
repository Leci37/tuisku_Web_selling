			...
			if( Positive_Money_Flow_Sum <= 1.16426e+08 )
				if( Long_MA <= 136.738 )
					...
					if( Long_MA > 104.021 )
						ret := 1.000000 // buy
				if( Long_MA > 136.738 )
					if( Negative_Money_Flow <= 8.24007e+06 )
						ret := -0.222222
					if( Negative_Money_Flow > 8.24007e+06 )
						ret := 0.562500
			if( Positive_Money_Flow_Sum > 1.16426e+08 )
				if( Short_Long_Diff <= -25.347 )
					if( MFI_High <= -28.7996 )
						ret := 0.326733
					if( MFI_High > -28.7996 )
						ret := -0.588235
				if( Short_Long_Diff > -25.347 )
					if( Positive_Money_Flow_Sum <= 2.0742e+08 )
						ret := -0.677686
					if( Positive_Money_Flow_Sum > 2.0742e+08 )
						ret := -0.162162
		if( MA_Cross > 2.95233 )
			if( Positive_Money_Flow <= 9.62147e+07 )
				if( MA_Cross <= 129.578 )
					ret := -1.000000 // sell
				if( MA_Cross > 129.578 )
					if( Raw_Money_Flow <= 5.65932e+07 )
						ret := 0.000000
					if( Raw_Money_Flow > 5.65932e+07 )
						ret := -0.944444 // sell
			if( Positive_Money_Flow > 9.62147e+07 )
				if( Positive_Money_Flow_Sum <= 7.75005e+08 )
					ret := 0.000000
				if( Positive_Money_Flow_Sum > 7.75005e+08 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_ec30cef6(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
