				...
				if( BBupper > 335.977 )
					...
					if( dif_source_BBlower > 37.2689 )
						...
						if( vrsi > 62.5198 )
							ret := 0.020408
		if( dif_source_BBupper > 1.62966 )
			if( dif_source_BBlower <= 43.6681 )
				if( BBupper <= 375.068 )
					ret := 0.663507
				if( BBupper > 375.068 )
					if( dif_source_BBlower <= 34.7106 )
						if( BBupper <= 391.621 )
							ret := -0.555556
						if( BBupper > 391.621 )
							ret := 0.114418
					if( dif_source_BBlower > 34.7106 )
						if( dif_source_BBlower <= 39.8836 )
							ret := -0.694118
						if( dif_source_BBlower > 39.8836 )
							ret := 1.000000 // buy
			if( dif_source_BBlower > 43.6681 )
...
float op_operation = decision_tree_0_NFLX_5Min_ac2607a7(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
