	...
	if( lowerBand <= 1.55863 )
		...
		if( wvf > 3.44068 )
			...
			if( lowerBand > 1.02088 )
				ret := 0.127983
	if( lowerBand > 1.55863 )
		if( upperBand <= 7.32535 )
			if( upperBand <= 6.62459 )
				ret := 0.231111
			if( upperBand > 6.62459 )
				ret := 0.718750 // buy
		if( upperBand > 7.32535 )
			if( Color_con2 <= 0.942845 )
				if( sDev <= 2.75338 )
					if( midLine <= 5.20636 )
						ret := 0.190476
					if( midLine > 5.20636 )
						if( upperBand <= 8.48758 )
							ret := -0.710744 // sell
						if( upperBand > 8.48758 )
							ret := -0.183486
				if( sDev > 2.75338 )
					if( sDev <= 8.652 )
						...
						if( sDev > 7.03977 )
							ret := 0.484018
					if( sDev > 8.652 )
						if( lowerBand <= 5.80917 )
							ret := -0.741573 // sell
						if( lowerBand > 5.80917 )
							ret := 0.347826
			if( Color_con2 > 0.942845 )
				if( lowerBand <= 2.35647 )
					ret := -0.148148
				if( lowerBand > 2.35647 )
					ret := 0.590090
...
float op_operation = decision_tree_0_HUBS_1Hour_a1eee3a0(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
