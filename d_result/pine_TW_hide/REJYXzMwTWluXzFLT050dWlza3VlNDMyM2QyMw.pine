				...
				if( verde_media <= -27.5034 )
					...
					if( pvimin > -0.087766 )
						...
						if( pvimin > -0.054806 )
							ret := 0.457143
				if( verde_media > -27.5034 )
					if( azul_mean <= -6.56286 )
						if( verde_mean <= 87.3397 )
							ret := 0.329815
						if( verde_mean > 87.3397 )
							ret := -0.023401
					if( azul_mean > -6.56286 )
						...
						if( media > 111.587 )
							ret := -0.202797
		if( azul > 38.6542 )
			if( media_azul <= -23.0351 )
				if( verde <= 33.2605 )
					if( media_azul <= -49.0255 )
						ret := -0.846154 // sell
					if( media_azul > -49.0255 )
						ret := 0.142857
				if( verde > 33.2605 )
					if( BollOsc <= 94.971 )
						if( azul_mean <= 46.1036 )
							ret := -0.955556 // sell
						if( azul_mean > 46.1036 )
							ret := -0.710145 // sell
					if( BollOsc > 94.971 )
						ret := 0.000000
			if( media_azul > -23.0351 )
				if( verde_media <= 35.4426 )
					if( azul_mean <= 16.4611 )
						if( source <= 21.515 )
							ret := 0.142857
						if( source > 21.515 )
							ret := -0.743363 // sell
...
float op_operation = decision_tree_0_DBX_30Min_e4323d23(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
