				...
				if( Negative_Money_Flow_Sum > 1.7574e+07 )
					...
					if( Negative_Money_Flow > 3.54536e+06 )
						...
						if( Raw_Money_Flow > 1.33714e+07 )
							ret := 0.320652
		if( Positive_Money_Flow > 318.58 )
			if( Negative_Money_Flow_Sum <= 2.64992e+07 )
				if( mf <= -0.172768 )
					if( Negative_Money_Flow_Sum <= 7.60219e+06 )
						if( Positive_Money_Flow <= 8564.59 )
							ret := 0.800000 // buy
						if( Positive_Money_Flow > 8564.59 )
							ret := -0.038689
					if( Negative_Money_Flow_Sum > 7.60219e+06 )
						if( Typical_Price <= 27.5375 )
							ret := 0.334928
						if( Typical_Price > 27.5375 )
							ret := -0.118943
				if( mf > -0.172768 )
					if( Negative_Money_Flow_Sum <= 940023 )
						if( Positive_Money_Flow_Sum <= 2.81591e+06 )
							ret := -0.525362
						if( Positive_Money_Flow_Sum > 2.81591e+06 )
							ret := -0.108466
					if( Negative_Money_Flow_Sum > 940023 )
						if( Negative_Money_Flow_Sum <= 1.58618e+06 )
							ret := 0.114372
						if( Negative_Money_Flow_Sum > 1.58618e+06 )
							ret := -0.053672
			if( Negative_Money_Flow_Sum > 2.64992e+07 )
				if( Negative_Money_Flow_Sum <= 2.84438e+07 )
					ret := -0.691406
				if( Negative_Money_Flow_Sum > 2.84438e+07 )
					if( mf <= 0.170734 )
						if( MFI <= 11.1114 )
...
float op_operation = decision_tree_0_DBX_5Min_4202e17f(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
