			...
			if( MFI_Low > 30.6632 )
				...
				if( Negative_Money_Flow > 2.03919e+07 )
					...
					if( bbm > 0.674194 )
						ret := -0.627907
	if( Positive_Money_Flow_Sum > 1.05471e+10 )
		if( bearPower <= 6.38517 )
			if( bbm <= 3.04084 )
				if( Positive_Money_Flow_Sum <= 1.12882e+10 )
					if( Typical_Price <= 150.15 )
						ret := -0.588235
					if( Typical_Price > 150.15 )
						ret := 0.500000
				if( Positive_Money_Flow_Sum > 1.12882e+10 )
					if( Raw_Money_Flow <= 9.30853e+08 )
						ret := -0.508772
					if( Raw_Money_Flow > 9.30853e+08 )
						ret := 0.296610
			if( bbm > 3.04084 )
				if( Typical_Price <= 190.113 )
					if( bbp <= 6.53659 )
						ret := -0.668050
					if( bbp > 6.53659 )
						ret := -0.367021
				if( Typical_Price > 190.113 )
					if( Negative_Money_Flow_Sum <= 1.36024e+10 )
						ret := -0.764706 // sell
					if( Negative_Money_Flow_Sum > 1.36024e+10 )
						ret := 0.482759
		if( bearPower > 6.38517 )
			...
			if( MFI > 66.2839 )
				if( bbm <= 3.67996 )
					if( Negative_Money_Flow_Sum <= 3.57735e+09 )
						ret := -0.250000
					if( Negative_Money_Flow_Sum > 3.57735e+09 )
						ret := 0.878049 // buy
				if( bbm > 3.67996 )
					if( Positive_Money_Flow_Sum <= 1.4402e+10 )
						ret := -0.666667
					if( Positive_Money_Flow_Sum > 1.4402e+10 )
						ret := 0.419355
...
float op_operation = decision_tree_0_QCOM_1Day_1530b323(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
