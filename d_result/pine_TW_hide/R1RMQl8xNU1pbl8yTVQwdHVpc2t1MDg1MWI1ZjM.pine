			...
			if( Negative_Money_Flow_Sum > 2.11711e+07 )
				if( ema12 <= -0.30837 )
					...
					if( Positive_Money_Flow > 9.7804e+06 )
						ret := -0.446809
				if( ema12 > -0.30837 )
					if( Raw_Money_Flow <= 38723 )
						if( Negative_Money_Flow <= 20.4427 )
							ret := -0.046218
						if( Negative_Money_Flow > 20.4427 )
							ret := 0.451902
					if( Raw_Money_Flow > 38723 )
						...
						if( MFI_Low > 61.3817 )
							ret := 0.911765 // buy
	if( Typical_Price > 49.5733 )
		if( Raw_Money_Flow <= 2.27042e+07 )
			if( tema <= 49.4108 )
				ret := -0.803571 // sell
			if( tema > 49.4108 )
				if( Positive_Money_Flow <= 1.25167e+07 )
					if( Positive_Money_Flow_Sum <= 1.53901e+06 )
						if( Positive_Money_Flow_Sum <= 695728 )
							ret := 0.004167
						if( Positive_Money_Flow_Sum > 695728 )
							ret := 0.590909
					if( Positive_Money_Flow_Sum > 1.53901e+06 )
						if( Negative_Money_Flow_Sum <= 5.29981e+06 )
							ret := -0.176913
						if( Negative_Money_Flow_Sum > 5.29981e+06 )
							ret := -0.041144
				if( Positive_Money_Flow > 1.25167e+07 )
		...
		if( Raw_Money_Flow > 2.27042e+07 )
			if( tema <= 104.006 )
				if( Positive_Money_Flow_Sum <= 3.68058e+07 )
					ret := 0.034483
				if( Positive_Money_Flow_Sum > 3.68058e+07 )
					ret := -0.629268
			if( tema > 104.006 )
...
float op_operation = decision_tree_0_GTLB_15Min_0851b5f3(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
