		...
		if( Positive_Money_Flow_Sum <= 6.10762e+10 )
			if( Negative_Money_Flow <= 6.54716e+09 )
				if( VIM <= 0.630432 )
					ret := 0.727273 // buy
				if( VIM > 0.630432 )
					if( Positive_Money_Flow_Sum <= 4.99612e+10 )
						ret := -0.078014
					if( Positive_Money_Flow_Sum > 4.99612e+10 )
						ret := 0.306667
			if( Negative_Money_Flow > 6.54716e+09 )
				if( Typical_Price <= 237.14 )
					ret := 1.000000 // buy
				if( Typical_Price > 237.14 )
					ret := 0.500000
		if( Positive_Money_Flow_Sum > 6.10762e+10 )
			if( Positive_Money_Flow_Sum <= 7.83278e+10 )
				if( VIP_VIM <= 0.264367 )
					if( Raw_Money_Flow <= 8.12877e+09 )
						ret := -0.318584
					if( Raw_Money_Flow > 8.12877e+09 )
						ret := -0.820896 // sell
				if( VIP_VIM > 0.264367 )
			...
			if( Positive_Money_Flow_Sum > 7.83278e+10 )
				if( MFI_Low <= 44.867 )
					if( Typical_Price <= 313.641 )
						ret := -0.711111 // sell
					if( Typical_Price > 313.641 )
						ret := -0.153846
				if( MFI_Low > 44.867 )
					if( Typical_Price <= 305.716 )
						ret := 0.571429
					if( Typical_Price > 305.716 )
						ret := 0.080460
...
float op_operation = decision_tree_0_MSFT_1Day_22e1e166(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
