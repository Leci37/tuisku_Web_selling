			...
			if( mf > -0.012691 )
				...
				if( ad > -3.63404e+06 )
					...
					if( mf > -0.000578 )
						ret := -0.114613
		if( mf > 0.181703 )
			if( ad_mf <= -2.16271e+06 )
				if( ad_mf <= -2.61455e+06 )
					if( ad_mf <= -2.97693e+06 )
						ret := 0.555556
					if( ad_mf > -2.97693e+06 )
						ret := -1.000000 // sell
				if( ad_mf > -2.61455e+06 )
					ret := 1.000000 // buy
			if( ad_mf > -2.16271e+06 )
				if( ad_mf <= 2.49775e+06 )
					if( ad_mf <= 1.39214e+06 )
						ret := -0.243243
					if( ad_mf > 1.39214e+06 )
						ret := -0.630137
				if( ad_mf > 2.49775e+06 )
...
float op_operation = decision_tree_0_DDOG_1Day_57340d95(mf, ad_mf, ad)
