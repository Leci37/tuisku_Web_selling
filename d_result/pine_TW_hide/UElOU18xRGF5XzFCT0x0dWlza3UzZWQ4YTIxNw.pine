...
decision_tree_0_PINS_1Day_3ed8a217(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower > 14.4626 )
		...
		if( BBlower > 15.6906 )
			if( BBupper <= 45.928 )
				if( dif_source_BBupper <= -2.09363 )
					if( dif_source_BBlower <= 6.0371 )
						ret := 0.290640
					if( dif_source_BBlower > 6.0371 )
						ret := 0.025974
				if( dif_source_BBupper > -2.09363 )
...
float op_operation = decision_tree_0_PINS_1Day_3ed8a217(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
