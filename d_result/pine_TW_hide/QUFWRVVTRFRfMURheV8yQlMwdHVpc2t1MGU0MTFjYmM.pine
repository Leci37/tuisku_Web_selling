			...
			if( d_k > 3.5548 )
				...
				if( smoothD_d > 21.4649 )
					...
					if( bullPower > 63.5089 )
						ret := 0.840000 // buy
	if( smoothD_d > 67.2508 )
		if( bullPower <= -7.17296 )
			if( d <= 75.8234 )
				ret := -0.727273 // sell
			if( d > 75.8234 )
				ret := -1.000000 // sell
		if( bullPower > -7.17296 )
			if( smoothK_k <= 94.1125 )
				if( bearPower <= 29.8962 )
					if( d_k <= -13.5505 )
						ret := 1.000000 // buy
					if( d_k > -13.5505 )
						ret := 0.363450
				if( bearPower > 29.8962 )
					ret := -0.818182 // sell
			if( smoothK_k > 94.1125 )
				if( bullPower <= 3.45109 )
					if( smoothD_d <= 90.3943 )
						ret := 0.357143
					if( smoothD_d > 90.3943 )
						ret := 0.750000 // buy
				if( bullPower > 3.45109 )
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_0e411cbc(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
