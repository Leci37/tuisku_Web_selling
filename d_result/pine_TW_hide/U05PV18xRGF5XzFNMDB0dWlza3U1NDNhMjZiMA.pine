			...
			if( Money_Flow_Ratio <= 1.72069 )
				...
				if( Negative_Money_Flow_Sum > 2.68088e+09 )
					...
					if( Positive_Money_Flow > 7.67358e+08 )
						ret := 0.529412
			if( Money_Flow_Ratio > 1.72069 )
				if( Negative_Money_Flow <= 1.72346e+08 )
					if( Money_Flow_Ratio <= 1.82658 )
						ret := 0.777778 // buy
					if( Money_Flow_Ratio > 1.82658 )
						ret := 0.034483
				if( Negative_Money_Flow > 1.72346e+08 )
					if( Money_Flow_Ratio <= 1.87048 )
						ret := 0.000000
					if( Money_Flow_Ratio > 1.87048 )
						ret := 1.000000 // buy
		if( Positive_Money_Flow_Sum > 7.63538e+09 )
			if( Typical_Price <= 130.466 )
				ret := 0.600000
			if( Typical_Price > 130.466 )
				if( Positive_Money_Flow <= 3.22963e+06 )
					if( Typical_Price <= 352.657 )
						ret := -0.074074
					if( Typical_Price > 352.657 )
						ret := -0.750000 // sell
				if( Positive_Money_Flow > 3.22963e+06 )
					if( Negative_Money_Flow <= 1.247e+07 )
						ret := -0.400000
					if( Negative_Money_Flow > 1.247e+07 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_SNOW_1Day_543a26b0(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
