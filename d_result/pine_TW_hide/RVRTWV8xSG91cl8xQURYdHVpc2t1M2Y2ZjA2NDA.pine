				...
				if( directionalMovementMinus > 0.620524 )
					...
					if( diPlus > 7.25322 )
						...
						if( dx > 59.105 )
							ret := 0.717742 // buy
		if( smoothedDirectionalMovementPlus > 0.130753 )
			if( directionalMovementMinus <= 2.63195 )
				if( diPlus <= 15.8291 )
					if( adx <= 31.0559 )
						if( diMinus <= 36.316 )
							ret := 0.107616
					...
					if( adx > 31.0559 )
						...
						if( adx > 35.8978 )
							ret := -0.178797
				if( diPlus > 15.8291 )
					if( smoothedDirectionalMovementMinus <= 1.0375 )
						if( dx <= 40.0935 )
							ret := -0.052449
						if( dx > 40.0935 )
							ret := 0.035811
			...
			if( directionalMovementMinus > 2.63195 )
				if( dx <= 72.176 )
					if( adx <= 15.3211 )
						ret := -0.600000
					if( adx > 15.3211 )
						if( smoothedDirectionalMovementMinus <= 1.68214 )
							ret := 0.300905
						if( smoothedDirectionalMovementMinus > 1.68214 )
							ret := 0.916667 // buy
				if( dx > 72.176 )
...
float op_operation = decision_tree_0_ETSY_1Hour_3f6f0640(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
