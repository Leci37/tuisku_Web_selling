...
decision_tree_0_ETHUSDT_1Day_3ad67958(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Money_Flow_Ratio > 0.314506 )
		if( MFI <= 65.9394 )
			...
			if( Negative_Money_Flow_Sum > 2.69791e+08 )
				if( VIM <= 1.24929 )
					if( Positive_Money_Flow_Sum <= 7.66907e+09 )
						ret := -0.018822
					if( Positive_Money_Flow_Sum > 7.66907e+09 )
						ret := -0.260658
				if( VIM > 1.24929 )
					if( Raw_Money_Flow <= 1.26413e+08 )
						ret := 0.280000
					if( Raw_Money_Flow > 1.26413e+08 )
						ret := 0.738095 // buy
		if( MFI > 65.9394 )
			if( Positive_Money_Flow_Sum <= 4.00099e+07 )
				if( Typical_Price <= 331.25 )
					ret := 0.142857
				if( Typical_Price > 331.25 )
					if( VIP <= 1.17091 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_ETHUSDT_1Day_3ad67958(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
