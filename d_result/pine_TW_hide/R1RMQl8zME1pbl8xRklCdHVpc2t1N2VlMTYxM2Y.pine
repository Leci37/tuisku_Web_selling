				...
				if( lower_2 > 52.1897 )
					if( lower_2 <= 56.7374 )
						...
						if( lower_2 > 56.3115 )
							ret := 0.905000 // buy
					if( lower_2 > 56.7374 )
						if( basis_minus <= 6.8237 )
							ret := -0.161290
						if( basis_minus > 6.8237 )
							ret := 0.243902
		if( basis > 63.6366 )
			if( basis_max <= -7.45469 )
				if( lower_3 <= 63.9807 )
					if( upper_4 <= 75.2484 )
						if( upper_2 <= 69.4345 )
							ret := -0.357466
				...
				if( lower_3 > 63.9807 )
					if( basis <= 81.3765 )
						...
						if( upper_1 > 84.0626 )
							ret := 0.806202 // buy
					if( basis > 81.3765 )
						if( basis_minus <= 17.3456 )
							ret := -0.700000 // sell
						if( basis_minus > 17.3456 )
							ret := -0.075188
			if( basis_max > -7.45469 )
				if( basis_minus <= 5.7568 )
					if( basis_minus <= 2.90868 )
						if( lower_6 <= 60.8413 )
							ret := -0.500000
						if( lower_6 > 60.8413 )
							ret := -0.971429 // sell
					if( basis_minus > 2.90868 )
						if( basis_minus <= 4.59044 )
							ret := -0.262500
						if( basis_minus > 4.59044 )
							ret := 0.319149
				if( basis_minus > 5.7568 )
...
float op_operation = decision_tree_0_GTLB_30Min_7ee1613f(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
