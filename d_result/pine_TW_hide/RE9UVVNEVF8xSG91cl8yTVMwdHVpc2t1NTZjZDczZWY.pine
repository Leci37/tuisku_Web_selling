...
decision_tree_0_DOTUSDT_1Hour_56cd73ef(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( rsi1 > 49.5298 )
		if( d_k <= 0.170871 )
			if( MFI_Low <= 38.0653 )
				if( Money_Flow_Ratio <= 0.745398 )
					if( smoothK_k <= 81.4995 )
						ret := 0.601244
					if( smoothK_k > 81.4995 )
						ret := 0.336752
				if( Money_Flow_Ratio > 0.745398 )
			...
			if( MFI_Low > 38.0653 )
				if( rsi1 <= 62.5272 )
					...
					if( rsi1 > 56.9871 )
						ret := 0.078652
				if( rsi1 > 62.5272 )
					if( Positive_Money_Flow_Sum <= 1.25633e+08 )
						ret := 0.358922
					if( Positive_Money_Flow_Sum > 1.25633e+08 )
						ret := 0.082936
		if( d_k > 0.170871 )
			if( Positive_Money_Flow <= 30789.1 )
				if( rsi1 <= 60.2934 )
					if( Money_Flow_Ratio <= 1.55213 )
						ret := 0.161869
					if( Money_Flow_Ratio > 1.55213 )
						ret := -0.157143
				if( rsi1 > 60.2934 )
			...
			if( Positive_Money_Flow > 30789.1 )
				if( rsi1 <= 69.2883 )
					if( Money_Flow_Ratio <= 2.14991 )
						ret := -0.083990
					if( Money_Flow_Ratio > 2.14991 )
						ret := -0.436698
				if( rsi1 > 69.2883 )
					if( smoothD_d <= 75.7678 )
						ret := 0.289157
					if( smoothD_d > 75.7678 )
						ret := -0.046181
...
float op_operation = decision_tree_0_DOTUSDT_1Hour_56cd73ef(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
