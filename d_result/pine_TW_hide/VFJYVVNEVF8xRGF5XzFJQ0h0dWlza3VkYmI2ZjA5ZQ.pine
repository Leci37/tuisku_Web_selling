			...
			if( senkou_span_a_displaced <= 0.068208 )
				...
				if( basis_minus > -0.003673 )
					...
					if( chinkou_span > 0.085704 )
						ret := 0.616883
			if( senkou_span_a_displaced > 0.068208 )
				if( basis_minus <= 0.005776 )
					if( chinkou_span <= 0.08031 )
						ret := -0.378947
					if( chinkou_span > 0.08031 )
						ret := 0.106173
				if( basis_minus > 0.005776 )
					if( basis_max <= 0.003765 )
						ret := -0.654255
					if( basis_max > 0.003765 )
						ret := 0.875000 // buy
...
float op_operation = decision_tree_0_TRXUSDT_1Day_dbb6f09e(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
