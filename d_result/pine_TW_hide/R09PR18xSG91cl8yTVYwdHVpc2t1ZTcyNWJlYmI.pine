			...
			if( Negative_Money_Flow_Sum <= 3.18675e+09 )
				if( Positive_Money_Flow_Sum <= 6.57498e+08 )
					...
					if( Money_Flow_Ratio > 1.22411 )
						ret := -0.739130 // sell
				if( Positive_Money_Flow_Sum > 6.57498e+08 )
					if( Negative_Money_Flow <= 4.90984e+08 )
						if( Negative_Money_Flow_Sum <= 3.14009e+09 )
							ret := -0.024746
						if( Negative_Money_Flow_Sum > 3.14009e+09 )
							ret := 0.680000
					if( Negative_Money_Flow > 4.90984e+08 )
			...
			if( Negative_Money_Flow_Sum > 3.18675e+09 )
				if( MFI_Low <= 23.7968 )
					...
					if( VIM > 1.21769 )
						ret := -0.743590 // sell
				if( MFI_Low > 23.7968 )
					if( Positive_Money_Flow <= 3.34024e+08 )
						ret := -0.751938 // sell
					if( Positive_Money_Flow > 3.34024e+08 )
						ret := -0.083333
	if( VIP > 1.55314 )
		if( VIM <= 1.44384 )
			if( Positive_Money_Flow_Sum <= 1.9575e+09 )
				if( Positive_Money_Flow_Sum <= 1.84522e+09 )
					ret := -0.104839
				if( Positive_Money_Flow_Sum > 1.84522e+09 )
					ret := 0.794118 // buy
			if( Positive_Money_Flow_Sum > 1.9575e+09 )
...
float op_operation = decision_tree_0_GOOG_1Hour_e725bebb(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
