		...
		if( Long_MA > 123.915 )
			...
			if( Negative_Money_Flow_Sum > 3.55399e+09 )
				if( MFI_Low <= 2.91076 )
					ret := 0.714286 // buy
				if( MFI_Low > 2.91076 )
					if( Negative_Money_Flow <= 4.80619e+08 )
						ret := -0.897959 // sell
					if( Negative_Money_Flow > 4.80619e+08 )
						ret := -0.562500
...
float op_operation = decision_tree_0_U_1Day_7c225c23(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
