		...
		if( bearPower > -8.30736 )
			if( Upper_Band <= 31.9657 )
				if( bullPower <= -0.084131 )
					ret := -0.333333
				if( bullPower > -0.084131 )
					if( Lower_Band <= 26.0104 )
						ret := -1.000000 // sell
					if( Lower_Band > 26.0104 )
						ret := -0.692308
			if( Upper_Band > 31.9657 )
				if( basis <= 59.0922 )
					if( Upper_Band <= 62.9623 )
						ret := -0.005693
					if( Upper_Band > 62.9623 )
						ret := 0.460000
				if( basis > 59.0922 )
					if( Upper_Band <= 65.5353 )
						ret := -0.863636 // sell
					if( Upper_Band > 65.5353 )
						ret := -0.218750
...
float op_operation = decision_tree_0_LYFT_1Day_52c1942c(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
