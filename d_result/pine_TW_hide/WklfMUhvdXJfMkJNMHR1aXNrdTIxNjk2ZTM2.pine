		...
		if( MFI_High <= -12.1266 )
			if( Positive_Money_Flow <= 2.31736e+06 )
				...
				if( Negative_Money_Flow > 51122.3 )
					ret := -0.048643
			if( Positive_Money_Flow > 2.31736e+06 )
				if( Typical_Price <= 49.076 )
					if( Money_Flow_Ratio <= 1.5373 )
						ret := 0.111810
					if( Money_Flow_Ratio > 1.5373 )
						if( Positive_Money_Flow <= 4.44912e+07 )
							ret := -0.282468
						if( Positive_Money_Flow > 4.44912e+07 )
							ret := 0.702703 // buy
				if( Typical_Price > 49.076 )
					...
					if( MFI > 23.4912 )
						ret := -0.241611
		if( MFI_High > -12.1266 )
			if( Money_Flow_Ratio <= 9.27306 )
				if( Positive_Money_Flow_Sum <= 3.71609e+07 )
					ret := 0.740260 // buy
				if( Positive_Money_Flow_Sum > 3.71609e+07 )
					if( Negative_Money_Flow_Sum <= 6.23418e+07 )
						if( Typical_Price <= 53.3127 )
							ret := 0.028971
						if( Typical_Price > 53.3127 )
							ret := -0.338462
					if( Negative_Money_Flow_Sum > 6.23418e+07 )
...
float op_operation = decision_tree_0_ZI_1Hour_21696e36(bbp, bullPower, BBPower_Color, bearPower, bbm, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
