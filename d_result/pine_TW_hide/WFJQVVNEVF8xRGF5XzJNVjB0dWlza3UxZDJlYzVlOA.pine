...
decision_tree_0_XRPUSDT_1Day_1d2ec5e8(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, VIP_VIM, VIP, VIM)=>
	...
	if( Positive_Money_Flow > 1.31474e+09 )
		if( Negative_Money_Flow_Sum <= 1.75545e+10 )
			...
			if( Money_Flow_Ratio > 3.96371 )
				if( VIM <= 0.655605 )
					if( Positive_Money_Flow <= 1.60802e+09 )
						ret := -0.600000
					if( Positive_Money_Flow > 1.60802e+09 )
						ret := -0.950000 // sell
				if( VIM > 0.655605 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_1d2ec5e8(Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum, VIP_VIM, VIP, VIM)
