	...
	if( bullPower > -0.129434 )
		...
		if( bearPower > 0.096761 )
			if( bbm <= 0.01768 )
				ret := -0.620347
			if( bbm > 0.01768 )
				if( bullPower <= 0.782958 )
					if( bbp <= 0.590573 )
						if( bullPower <= 0.276515 )
							ret := -0.213922
						if( bullPower > 0.276515 )
							ret := 0.492958
					if( bbp > 0.590573 )
...
float op_operation = decision_tree_0_CRSR_5Min_45e34cf8(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
