...
decision_tree_0_AAVEUSDT_1Day_ead5bd5f(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)=>
	...
	if( midLine > 9.13818 )
		...
		if( sDev > 15.2135 )
			if( midLine <= 30.2239 )
				if( upperBand <= 34.8684 )
					if( Color_con2 <= -4.99039 )
						ret := 0.366412
					if( Color_con2 > -4.99039 )
						ret := -0.367347
				if( upperBand > 34.8684 )
					if( lowerBand <= 1.50403 )
						ret := -0.164659
					if( lowerBand > 1.50403 )
						ret := -0.700000 // sell
			if( midLine > 30.2239 )
				if( Color_con1 <= -20.976 )
					if( lowerBand <= 25.5724 )
						ret := -0.033333
					if( lowerBand > 25.5724 )
						ret := 0.852941 // buy
				if( Color_con1 > -20.976 )
					if( upperBand <= 68.0836 )
						ret := 0.566667
					if( upperBand > 68.0836 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_ead5bd5f(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
