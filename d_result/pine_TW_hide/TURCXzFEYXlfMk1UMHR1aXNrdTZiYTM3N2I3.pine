			...
			if( MFI_Low > 35.1421 )
				...
				if( Money_Flow_Ratio > 3.67002 )
					...
					if( MFI > 83.8544 )
						ret := 0.071429
	if( ema1 > 344.098 )
		if( Raw_Money_Flow <= 2.56649e+08 )
			if( ema2 <= 483.033 )
				if( ema2 <= 364.397 )
					ret := 0.000000
				if( ema2 > 364.397 )
					if( Negative_Money_Flow <= 1.29405e+08 )
						ret := 0.750000 // buy
					if( Negative_Money_Flow > 1.29405e+08 )
						ret := 0.117647
			if( ema2 > 483.033 )
				if( Raw_Money_Flow <= 2.26498e+08 )
					ret := -0.375000
				if( Raw_Money_Flow > 2.26498e+08 )
					ret := -1.000000 // sell
		if( Raw_Money_Flow > 2.56649e+08 )
			if( Negative_Money_Flow_Sum <= 4.63244e+09 )
				if( Money_Flow_Ratio <= 0.665618 )
					if( Negative_Money_Flow_Sum <= 3.90756e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 3.90756e+09 )
						ret := -0.550000
				if( Money_Flow_Ratio > 0.665618 )
...
float op_operation = decision_tree_0_MDB_1Day_6ba377b7(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
