...
decision_tree_0_SPOT_1Hour_edc613bc(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)=>
	...
	if( media_azul > 29.686 )
		if( media <= 81.5915 )
			if( nvimax <= 0.363091 )
				if( stoc <= 13.1366 )
					if( verde_mean <= -4.0881 )
						if( source <= 260.681 )
							ret := 0.394737
						if( source > 260.681 )
							ret := -0.611111
					if( verde_mean > -4.0881 )
						if( verde_azul <= 67.2271 )
							ret := 0.873418 // buy
						if( verde_azul > 67.2271 )
							ret := -0.250000
				if( stoc > 13.1366 )
					if( azul_mean <= -41.0365 )
						if( stoc <= 39.9314 )
							ret := -0.863636 // sell
						if( stoc > 39.9314 )
							ret := 0.200000
		...
		if( media > 81.5915 )
			if( marron <= 68.8933 )
				if( xrsi <= 47.7375 )
					if( BollOsc <= -21.7544 )
						if( azul_mean <= 6.64377 )
							ret := 0.578947
						if( azul_mean > 6.64377 )
							ret := -0.111111
					if( BollOsc > -21.7544 )
						if( verde_mean <= 86.2151 )
							ret := -0.423729
						if( verde_mean > 86.2151 )
							ret := 0.047619
				if( xrsi > 47.7375 )
					...
					if( nvimax > 1.07436 )
						...
						if( verde > 70.5796 )
							ret := 0.428571
			if( marron > 68.8933 )
				if( azul_mean <= 19.8769 )
					if( verde_mean <= 161.757 )
						if( pvimax <= 0.52668 )
							ret := -0.102188
						if( pvimax > 0.52668 )
							ret := -0.740000 // sell
...
float op_operation = decision_tree_0_SPOT_1Hour_edc613bc(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
