		...
		if( Upper_Band > 75.4934 )
			if( BBPower_Color <= 0.5 )
				...
				if( basis > 79.3956 )
					ret := -0.833333 // sell
			if( BBPower_Color > 0.5 )
				if( bearPower <= 4.05723 )
					ret := 0.631757
				if( bearPower > 4.05723 )
					ret := -0.812500 // sell
	if( Lower_Band > 72.14 )
		if( Upper_Band <= 89.9451 )
			if( bullPower <= -1.25215 )
				if( bearPower <= -5.27854 )
					ret := 0.666667
				if( bearPower > -5.27854 )
					ret := -0.878049 // sell
			if( bullPower > -1.25215 )
				if( Lower_Band <= 75.8965 )
					if( bbm <= 1.3722 )
						ret := -0.638418
					if( bbm > 1.3722 )
						if( Upper_Band <= 87.0889 )
							ret := -0.168675
						if( Upper_Band > 87.0889 )
							ret := 0.866667 // buy
				if( Lower_Band > 75.8965 )
					if( bullPower <= 0.605596 )
						if( bearPower <= -3.15989 )
							ret := -0.475000
						if( bearPower > -3.15989 )
							ret := 0.388535
					if( bullPower > 0.605596 )
						if( Upper_Band <= 84.4847 )
							ret := 0.260870
						if( Upper_Band > 84.4847 )
							ret := -0.256158
		if( Upper_Band > 89.9451 )
...
float op_operation = decision_tree_0_APPS_1Hour_1694253f(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
