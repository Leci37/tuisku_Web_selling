				...
				if( bearPower <= -0.233214 )
					if( Typical_Price <= 35.3306 )
						...
						if( Typical_Price > 13.5983 )
							ret := -0.188487
					if( Typical_Price > 35.3306 )
						if( Positive_Money_Flow_Sum <= 814477 )
							ret := -0.837209 // sell
						if( Positive_Money_Flow_Sum > 814477 )
							ret := -0.010893
				if( bearPower > -0.233214 )
					if( Positive_Money_Flow_Sum <= 5.7911e+08 )
						if( Positive_Money_Flow_Sum <= 2.97759e+08 )
							ret := 0.004787
						if( Positive_Money_Flow_Sum > 2.97759e+08 )
							ret := -0.192308
					if( Positive_Money_Flow_Sum > 5.7911e+08 )
						if( Negative_Money_Flow_Sum <= 2.39665e+08 )
							ret := 0.084034
						if( Negative_Money_Flow_Sum > 2.39665e+08 )
							ret := 0.685185
			if( bbm > 0.78995 )
				if( bullPower <= -0.451166 )
					if( Raw_Money_Flow <= 7.56472e+07 )
						if( Positive_Money_Flow <= 2.37358e+07 )
							ret := 0.634058
						if( Positive_Money_Flow > 2.37358e+07 )
							ret := -0.200000
					if( Raw_Money_Flow > 7.56472e+07 )
						if( Positive_Money_Flow_Sum <= 1.95589e+08 )
							ret := 0.125000
						if( Positive_Money_Flow_Sum > 1.95589e+08 )
							ret := -0.666667
				if( bullPower > -0.451166 )
					if( Typical_Price <= 59.1904 )
						if( Raw_Money_Flow <= 2.7434e+08 )
							ret := 0.108696
						if( Raw_Money_Flow > 2.7434e+08 )
							ret := -0.866667 // sell
					if( Typical_Price > 59.1904 )
						if( Negative_Money_Flow_Sum <= 1.87942e+08 )
							ret := 0.028571
						if( Negative_Money_Flow_Sum > 1.87942e+08 )
							ret := -0.334728
...
float op_operation = decision_tree_0_LYFT_1Hour_e408d601(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
