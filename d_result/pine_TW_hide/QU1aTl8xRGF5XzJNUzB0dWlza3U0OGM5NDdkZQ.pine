			...
			if( Raw_Money_Flow <= 1.65875e+10 )
				if( Negative_Money_Flow_Sum <= 1.68518e+10 )
					...
					if( d_k > -4.24653 )
						ret := -0.693548
				if( Negative_Money_Flow_Sum > 1.68518e+10 )
					if( Negative_Money_Flow_Sum <= 6.58211e+10 )
						ret := 0.111111
					if( Negative_Money_Flow_Sum > 6.58211e+10 )
						ret := -0.132275
			if( Raw_Money_Flow > 1.65875e+10 )
				...
				if( k > 27.2326 )
					...
					if( d_k > -14.9639 )
						ret := -0.760417 // sell
		if( Negative_Money_Flow_Sum > 1.33509e+11 )
			if( Typical_Price <= 3050.7 )
				if( Positive_Money_Flow_Sum <= 4.18825e+10 )
					ret := -0.307692
				if( Positive_Money_Flow_Sum > 4.18825e+10 )
					if( Negative_Money_Flow_Sum <= 1.37905e+11 )
						ret := 0.666667
					if( Negative_Money_Flow_Sum > 1.37905e+11 )
						ret := 1.000000 // buy
			if( Typical_Price > 3050.7 )
				if( Positive_Money_Flow <= 1.24347e+10 )
					ret := 0.133333
				if( Positive_Money_Flow > 1.24347e+10 )
					ret := -0.400000
...
float op_operation = decision_tree_0_AMZN_1Day_48c947de(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
