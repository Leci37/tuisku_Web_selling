...
decision_tree_0_GTLB_15Min_84be9474(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)=>
				...
				if( verde_mean > 125.332 )
					...
					if( pvi_ema > -0.821905 )
						...
						if( stoc > 90.4369 )
							ret := 0.960000 // buy
		if( verde_mean > 154.045 )
			if( azul_mean <= -10.6678 )
				if( azul <= -27.2232 )
					if( verde_azul <= 207.127 )
						ret := 0.937500 // buy
					if( verde_azul > 207.127 )
						ret := 0.090909
				if( azul > -27.2232 )
	...
	if( source > 44.0606 )
		if( verde <= 4.69198 )
			if( verde_azul <= -85.7756 )
				if( media_azul <= -36.5939 )
					if( xmf <= 34.1672 )
						ret := 0.000000
					if( xmf > 34.1672 )
						ret := 0.733333 // buy
				...
				if( oscp > -8.38003 )
					if( BollOsc <= -59.1938 )
						...
						if( nvimin > 1.22415 )
							ret := 0.357143
					if( BollOsc > -59.1938 )
						if( verde_media <= -13.9053 )
							ret := 0.173684
						if( verde_media > -13.9053 )
							ret := 0.744681 // buy
		if( verde > 4.69198 )
			if( verde_media <= 24.9736 )
				if( verde_mean <= 107.808 )
					if( tprice <= 54.3295 )
						if( pvim <= -1.43682 )
							ret := -0.612903
						if( pvim > -1.43682 )
...
float op_operation = decision_tree_0_GTLB_15Min_84be9474(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
