		...
		if( Raw_Money_Flow <= 9.73927e+08 )
			if( ad <= -2.25186e+06 )
				if( mf <= 0.03704 )
					ret := 0.111111
				if( mf > 0.03704 )
					if( Negative_Money_Flow <= 7.05161e+08 )
						ret := 0.857143 // buy
					if( Negative_Money_Flow > 7.05161e+08 )
						ret := 0.500000
			if( ad > -2.25186e+06 )
				if( mf <= 0.136879 )
					...
					if( ad_mf > -154640 )
						ret := 0.205357
				if( mf > 0.136879 )
					if( Positive_Money_Flow <= 2.17131e+08 )
						ret := 0.000000
					if( Positive_Money_Flow > 2.17131e+08 )
						ret := -0.487179
		if( Raw_Money_Flow > 9.73927e+08 )
			if( mf <= 0.108177 )
				if( Positive_Money_Flow_Sum <= 1.16053e+10 )
					if( MFI_Low <= 40.0651 )
						ret := 0.200000
					if( MFI_Low > 40.0651 )
						ret := -0.535714
				if( Positive_Money_Flow_Sum > 1.16053e+10 )
					if( Positive_Money_Flow <= 1.04094e+09 )
						ret := 0.714286 // buy
					if( Positive_Money_Flow > 1.04094e+09 )
						ret := 0.000000
			if( mf > 0.108177 )
				if( ad <= -1.65449e+06 )
					if( Negative_Money_Flow_Sum <= 5.1687e+09 )
						ret := -0.363636
					if( Negative_Money_Flow_Sum > 5.1687e+09 )
						ret := -1.000000 // sell
				if( ad > -1.65449e+06 )
					if( Typical_Price <= 324.477 )
						ret := -0.258621
					if( Typical_Price > 324.477 )
						ret := -0.846154 // sell
...
float op_operation = decision_tree_0_SNOW_1Day_f27899bf(mf, ad, ad_mf, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
