			...
			if( bearPower > -11.7004 )
				...
				if( Positive_Money_Flow > 1.99368e+07 )
					...
					if( MFI_Low > 11.0213 )
						ret := 0.000000
	if( Positive_Money_Flow_Sum > 2.85561e+09 )
		if( Typical_Price <= 276.512 )
			if( Typical_Price <= 212.727 )
				if( bbp <= 22.5274 )
					if( bullPower <= -7.61095 )
						ret := 0.461538
					if( bullPower > -7.61095 )
						ret := -0.535714
				if( bbp > 22.5274 )
					if( Positive_Money_Flow <= 3.39021e+08 )
						ret := 0.000000
					if( Positive_Money_Flow > 3.39021e+08 )
						ret := 0.666667
			if( Typical_Price > 212.727 )
				if( Typical_Price <= 255.229 )
					if( Positive_Money_Flow_Sum <= 3.49626e+09 )
						ret := 0.716981 // buy
					if( Positive_Money_Flow_Sum > 3.49626e+09 )
						ret := 0.220588
				if( Typical_Price > 255.229 )
					if( Negative_Money_Flow_Sum <= 5.09672e+09 )
						ret := -0.244898
					if( Negative_Money_Flow_Sum > 5.09672e+09 )
						ret := 0.592593
		if( Typical_Price > 276.512 )
			if( Negative_Money_Flow_Sum <= 8.55077e+09 )
				if( bearPower <= 18.407 )
					if( Positive_Money_Flow <= 4.19992e+08 )
						ret := -0.434783
					if( Positive_Money_Flow > 4.19992e+08 )
						ret := -0.831858 // sell
				if( bearPower > 18.407 )
					if( Negative_Money_Flow <= 3.94598e+07 )
						ret := 0.250000
					if( Negative_Money_Flow > 3.94598e+07 )
						ret := 1.000000 // buy
			if( Negative_Money_Flow_Sum > 8.55077e+09 )
...
float op_operation = decision_tree_0_SPOT_1Day_dea3e5ee(bbm, bearPower, bbp, bullPower, BBPower_Color, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
