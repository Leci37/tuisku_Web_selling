...
decision_tree_0_PINS_1Day_5c91f7b6(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( d_k > 8.18552 )
		...
		if( bullPower > -1.55831 )
			if( rsi1 <= 46.0232 )
				if( smoothD_d <= 71.4804 )
					if( smoothK_k <= 42.1234 )
						ret := 0.683673
					if( smoothK_k > 42.1234 )
						ret := 1.000000 // buy
				if( smoothD_d > 71.4804 )
			...
			if( rsi1 > 46.0232 )
				if( rsi1 <= 53.313 )
					if( smoothK_k <= 56.5541 )
						ret := -0.247191
					if( smoothK_k > 56.5541 )
						ret := 0.400000
				if( rsi1 > 53.313 )
					if( smoothD_d <= 48.2507 )
						ret := 0.105263
					if( smoothD_d > 48.2507 )
						ret := 0.560976
...
float op_operation = decision_tree_0_PINS_1Day_5c91f7b6(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
