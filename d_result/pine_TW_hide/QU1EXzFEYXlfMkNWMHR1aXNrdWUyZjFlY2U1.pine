		...
		if( ad_mf <= 9.28138e+07 )
			if( VIM <= 0.677385 )
				...
				if( VIM > 0.615535 )
					ret := 1.000000 // buy
			if( VIM > 0.677385 )
				if( ad_mf <= 7.28236e+07 )
					if( ad <= 6.97819e+07 )
						ret := -0.709677 // sell
					if( ad > 6.97819e+07 )
						ret := 0.000000
				if( ad_mf > 7.28236e+07 )
					if( ad_mf <= 7.60271e+07 )
						ret := -0.896552 // sell
					if( ad_mf > 7.60271e+07 )
						ret := -0.696629
		if( ad_mf > 9.28138e+07 )
			if( ad_mf <= 1.29762e+08 )
				if( VIP <= 1.11315 )
					if( mf <= 0.088094 )
						ret := 0.724138 // buy
					if( mf > 0.088094 )
...
float op_operation = decision_tree_0_AMD_1Day_e2f1ece5(ad, mf, ad_mf, VIP, VIM, VIP_VIM)
