			...
			if( ad > 6.67054e+06 )
				...
				if( bullPower > 3.96511 )
					...
					if( bullPower > 8.85504 )
						ret := 0.300000
	if( ad_mf > 1.16695e+07 )
		if( ad_mf <= 1.99889e+07 )
			if( bearPower <= -1.76199 )
				if( bearPower <= -11.5477 )
					ret := -0.250000
				if( bearPower > -11.5477 )
					if( ad <= 1.51438e+07 )
						ret := -0.781250 // sell
					if( ad > 1.51438e+07 )
						ret := -0.952381 // sell
			if( bearPower > -1.76199 )
				if( ad_mf <= 1.23527e+07 )
					if( bbm <= 2.64281 )
						ret := -1.000000 // sell
					if( bbm > 2.64281 )
						ret := 1.000000 // buy
				if( ad_mf > 1.23527e+07 )
					if( ad_mf <= 1.49899e+07 )
						ret := -0.744681 // sell
					if( ad_mf > 1.49899e+07 )
						ret := 0.076923
		if( ad_mf > 1.99889e+07 )
...
float op_operation = decision_tree_0_PYPL_1Day_e0439d3f(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
