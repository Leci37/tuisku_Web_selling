	...
	if( ema13 > -0.69835 )
		if( ema1 <= 28.7037 )
			...
			if( tema > 27.9277 )
				ret := 0.833333 // buy
		if( ema1 > 28.7037 )
			if( Negative_Money_Flow_Sum <= 9.44964e+08 )
				if( ema13 <= 1.10583 )
					if( Money_Flow_Ratio <= 0.690868 )
						if( MFI_Low <= -19.8033 )
							ret := -0.723404 // sell
						if( MFI_Low > -19.8033 )
							ret := 0.108390
					if( Money_Flow_Ratio > 0.690868 )
						if( Negative_Money_Flow_Sum <= 2.41537e+08 )
							ret := 0.025094
						if( Negative_Money_Flow_Sum > 2.41537e+08 )
							ret := -0.109927
				if( ema13 > 1.10583 )
					if( Positive_Money_Flow_Sum <= 1.03218e+08 )
						if( Typical_Price <= 185.82 )
							ret := 0.881579 // buy
						if( Typical_Price > 185.82 )
							ret := -0.666667
					if( Positive_Money_Flow_Sum > 1.03218e+08 )
						if( Money_Flow_Ratio <= 0.487732 )
							ret := 0.781250 // buy
						if( Money_Flow_Ratio > 0.487732 )
							ret := 0.071303
			if( Negative_Money_Flow_Sum > 9.44964e+08 )
				if( ema12 <= 16.0626 )
					if( Positive_Money_Flow_Sum <= 1.7572e+09 )
						if( Positive_Money_Flow <= 1.08591e+08 )
							ret := -0.323020
						if( Positive_Money_Flow > 1.08591e+08 )
							ret := 0.237179
					if( Positive_Money_Flow_Sum > 1.7572e+09 )
...
float op_operation = decision_tree_0_SHOP_1Hour_8822387f(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
