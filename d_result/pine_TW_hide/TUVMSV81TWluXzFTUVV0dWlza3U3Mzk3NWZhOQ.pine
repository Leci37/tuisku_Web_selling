...
decision_tree_0_MELI_5Min_73975fa9(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)=>
	...
	if( upperKC > 1208.93 )
		if( lowerBB <= 1202.03 )
			if( avgHighLow <= 1202.17 )
				if( avgHighLow <= 1198.76 )
					if( lowerBB <= 1186.76 )
						ret := -0.937500 // sell
					if( lowerBB > 1186.76 )
						ret := -0.125000
				if( avgHighLow > 1198.76 )
					if( priceRange <= 2.56524 )
						ret := 0.142857
					if( priceRange > 2.56524 )
						if( dev <= 15.4208 )
							ret := 0.791667 // buy
...
float op_operation = decision_tree_0_MELI_5Min_73975fa9(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
