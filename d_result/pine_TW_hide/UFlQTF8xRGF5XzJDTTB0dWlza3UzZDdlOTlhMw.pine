		...
		if( mf <= -0.162232 )
			if( ad <= -2.0864e+06 )
				...
				if( Positive_Money_Flow_Sum > 1.43927e+10 )
					ret := -1.000000 // sell
			if( ad > -2.0864e+06 )
				if( Positive_Money_Flow <= 1.20241e+09 )
					if( Typical_Price <= 90.8484 )
						ret := -0.857143 // sell
					if( Typical_Price > 90.8484 )
						ret := -0.379310
				if( Positive_Money_Flow > 1.20241e+09 )
			...
			if( MFI_Low <= 26.3252 )
				...
				if( ad > -5.39971e+06 )
					...
					if( mf > 0.167441 )
						ret := -0.714286 // sell
			if( MFI_Low > 26.3252 )
				if( Typical_Price <= 113.406 )
					if( Raw_Money_Flow <= 1.19269e+09 )
						ret := -0.132039
					if( Raw_Money_Flow > 1.19269e+09 )
						ret := -0.570552
				if( Typical_Price > 113.406 )
					if( Typical_Price <= 288.756 )
						ret := 0.143389
					if( Typical_Price > 288.756 )
						ret := -0.686275
...
float op_operation = decision_tree_0_PYPL_1Day_3d7e99a3(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
