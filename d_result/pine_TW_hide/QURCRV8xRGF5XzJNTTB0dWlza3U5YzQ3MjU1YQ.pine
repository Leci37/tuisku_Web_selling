		...
		if( Raw_Money_Flow <= 1.72873e+09 )
			if( MFI_Low <= 15.0091 )
				...
				if( Negative_Money_Flow > 1.0669e+09 )
					ret := 0.000000
			if( MFI_Low > 15.0091 )
				if( Negative_Money_Flow_Sum <= 1.45139e+10 )
					if( Positive_Money_Flow <= 1.75567e+08 )
						ret := 0.216667
					if( Positive_Money_Flow > 1.75567e+08 )
						ret := -0.242991
				if( Negative_Money_Flow_Sum > 1.45139e+10 )
					...
					if( MFI > 44.7579 )
						ret := -0.555556
		if( Raw_Money_Flow > 1.72873e+09 )
			if( Short_Long_Diff <= 20.5604 )
				if( Positive_Money_Flow_Sum <= 1.40685e+10 )
					if( Positive_Money_Flow_Sum <= 1.29706e+10 )
						ret := -0.714286 // sell
					if( Positive_Money_Flow_Sum > 1.29706e+10 )
						ret := -0.157895
				if( Positive_Money_Flow_Sum > 1.40685e+10 )
...
float op_operation = decision_tree_0_ADBE_1Day_9c47255a(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
