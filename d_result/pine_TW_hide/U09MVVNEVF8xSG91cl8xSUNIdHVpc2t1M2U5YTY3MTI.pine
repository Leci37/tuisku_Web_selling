			...
			if( basis_minus > -0.001937 )
				...
				if( senkou_span_a_displaced > 1.549 )
					...
					if( senkou_span_a_displaced > 1.6751 )
						ret := -0.555556
		if( chinkou_span > 1.63817 )
			if( kinjun_sen <= 143.928 )
				if( chinkou_span <= 141.983 )
					if( senkou_span_b <= 130.448 )
						ret := 0.063061
					if( senkou_span_b > 130.448 )
						ret := -0.105433
				if( chinkou_span > 141.983 )
					if( tenkan_sen <= 136.63 )
						ret := 0.716049 // buy
					if( tenkan_sen > 136.63 )
						ret := 0.319728
			if( kinjun_sen > 143.928 )
				if( senkou_span_b <= 140.058 )
					if( tenkan_sen <= 146.891 )
						ret := 0.000000
					if( tenkan_sen > 146.891 )
						ret := -0.662921
				if( senkou_span_b > 140.058 )
					if( chinkou_span <= 151.211 )
						ret := -0.321453
					if( chinkou_span > 151.211 )
						ret := 0.058371
...
float op_operation = decision_tree_0_SOLUSDT_1Hour_3e9a6712(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
