		...
		if( senkou_span_a_displaced <= 52.4312 )
			...
			if( senkou_span_a_displaced > 28.3687 )
				...
				if( senkou_span_b > 61.9575 )
					ret := 0.250000
		if( senkou_span_a_displaced > 52.4312 )
			if( kinjun_sen <= 79.4122 )
				if( basis_max <= -3.10626 )
					ret := 0.000000
				if( basis_max > -3.10626 )
					if( chinkou_span <= 59.21 )
						ret := 0.000000
					if( chinkou_span > 59.21 )
						ret := -0.774194 // sell
			if( kinjun_sen > 79.4122 )
				if( tenkan_sen <= 82.1925 )
					if( chinkou_span <= 74.1955 )
						ret := 0.038462
					if( chinkou_span > 74.1955 )
						ret := 0.800000 // buy
				if( tenkan_sen > 82.1925 )
...
float op_operation = decision_tree_0_APPS_1Day_4092fc49(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
