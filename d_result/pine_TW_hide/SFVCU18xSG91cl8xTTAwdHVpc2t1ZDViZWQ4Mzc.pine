...
decision_tree_0_HUBS_1Hour_d5bed837(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
		...
		if( Raw_Money_Flow > 3.89112e+06 )
			...
			if( MFI > 6.91212 )
				if( Typical_Price <= 250.091 )
					if( MFI <= 60.5033 )
						if( Typical_Price <= 152.578 )
							ret := 0.184484
						if( Typical_Price > 152.578 )
							ret := -0.060018
					if( MFI > 60.5033 )
						if( Positive_Money_Flow_Sum <= 1.27866e+08 )
							ret := -0.289784
						if( Positive_Money_Flow_Sum > 1.27866e+08 )
							ret := -0.088091
				if( Typical_Price > 250.091 )
					if( Negative_Money_Flow_Sum <= 8.35956e+07 )
						if( Positive_Money_Flow_Sum <= 2.83517e+08 )
							ret := 0.227783
						if( Positive_Money_Flow_Sum > 2.83517e+08 )
							ret := -0.049451
					if( Negative_Money_Flow_Sum > 8.35956e+07 )
	...
	if( Positive_Money_Flow_Sum > 3.69186e+08 )
		if( Typical_Price <= 407.213 )
			if( Positive_Money_Flow_Sum <= 3.72145e+08 )
				ret := 0.416667
			if( Positive_Money_Flow_Sum > 3.72145e+08 )
				if( Raw_Money_Flow <= 1.93141e+07 )
					if( Positive_Money_Flow <= 7.65445e+06 )
						...
						if( MFI > 81.1769 )
							ret := -0.062500
					if( Positive_Money_Flow > 7.65445e+06 )
						if( Negative_Money_Flow_Sum <= 1.40019e+08 )
							ret := 0.923077 // buy
						if( Negative_Money_Flow_Sum > 1.40019e+08 )
							ret := -0.750000 // sell
				if( Raw_Money_Flow > 1.93141e+07 )
					if( Money_Flow_Ratio <= 4.67357 )
						if( Positive_Money_Flow_Sum <= 4.29894e+08 )
							ret := -0.566667
						if( Positive_Money_Flow_Sum > 4.29894e+08 )
							ret := -0.870370 // sell
					if( Money_Flow_Ratio > 4.67357 )
						if( Positive_Money_Flow_Sum <= 4.50342e+08 )
							ret := -0.833333 // sell
						if( Positive_Money_Flow_Sum > 4.50342e+08 )
							ret := 0.357143
		if( Typical_Price > 407.213 )
			if( Positive_Money_Flow <= 7.7141e+06 )
				if( Positive_Money_Flow_Sum <= 6.01716e+08 )
					if( Negative_Money_Flow_Sum <= 3.43473e+08 )
						if( Negative_Money_Flow_Sum <= 2.75242e+08 )
							ret := -0.054913
						if( Negative_Money_Flow_Sum > 2.75242e+08 )
							ret := -0.686747
					if( Negative_Money_Flow_Sum > 3.43473e+08 )
						...
						if( MFI_Low > 31.1092 )
							ret := 0.416667
				if( Positive_Money_Flow_Sum > 6.01716e+08 )
					if( Money_Flow_Ratio <= 0.822151 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 0.822151 )
						if( Negative_Money_Flow_Sum <= 7.79217e+08 )
							ret := 0.413793
						if( Negative_Money_Flow_Sum > 7.79217e+08 )
							ret := 1.000000 // buy
			if( Positive_Money_Flow > 7.7141e+06 )
				...
				if( Positive_Money_Flow_Sum > 5.08354e+08 )
					if( MFI_High <= 2.24709 )
						...
						if( Negative_Money_Flow_Sum > 4.30046e+08 )
							ret := -0.106061
					if( MFI_High > 2.24709 )
						if( Positive_Money_Flow <= 9.08541e+07 )
							ret := 0.370370
						if( Positive_Money_Flow > 9.08541e+07 )
							ret := -0.461538
...
float op_operation = decision_tree_0_HUBS_1Hour_d5bed837(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
