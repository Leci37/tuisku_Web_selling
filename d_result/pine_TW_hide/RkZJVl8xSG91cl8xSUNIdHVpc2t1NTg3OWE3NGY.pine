			...
			if( senkou_span_b > 128.7 )
				if( basis_max <= -0.001379 )
					...
					if( senkou_span_a_displaced > 126.041 )
						ret := -0.605565
				if( basis_max > -0.001379 )
					if( senkou_span_b <= 144.681 )
						ret := -0.061538
					if( senkou_span_b > 144.681 )
						ret := -0.718391 // sell
		if( chinkou_span > 138.075 )
			if( senkou_span_a <= 140.7 )
				if( tenkan_sen <= 137.478 )
					if( chinkou_span <= 140.638 )
						ret := 0.523364
					if( chinkou_span > 140.638 )
						ret := 0.785714 // buy
				if( tenkan_sen > 137.478 )
					if( senkou_span_b <= 138.65 )
						ret := 0.024823
					if( senkou_span_b > 138.65 )
						ret := 0.451677
			if( senkou_span_a > 140.7 )
				if( chinkou_span <= 145.024 )
					if( senkou_span_a <= 146.71 )
						ret := -0.155578
					if( senkou_span_a > 146.71 )
						ret := -0.763393 // sell
				if( chinkou_span > 145.024 )
					if( tenkan_sen <= 143.051 )
						ret := 0.677419
					if( tenkan_sen > 143.051 )
						ret := 0.010916
...
float op_operation = decision_tree_0_FFIV_1Hour_5879a74f(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
