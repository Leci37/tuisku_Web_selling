	...
	if( Typical_Price > 534.082 )
		if( Money_Flow_Ratio <= 0.392474 )
			...
			if( bbp > -53.066 )
				ret := 1.000000 // buy
		if( Money_Flow_Ratio > 0.392474 )
			if( bearPower <= -2.18311 )
				if( bbp <= -70.394 )
					ret := 0.800000 // buy
				if( bbp > -70.394 )
					if( Raw_Money_Flow <= 1.01251e+09 )
						ret := 0.083333
					if( Raw_Money_Flow > 1.01251e+09 )
						ret := -0.716157 // sell
			if( bearPower > -2.18311 )
				if( Raw_Money_Flow <= 1.73945e+09 )
					if( Raw_Money_Flow <= 1.61244e+09 )
						ret := -0.016807
					if( Raw_Money_Flow > 1.61244e+09 )
						ret := 0.636364
				if( Raw_Money_Flow > 1.73945e+09 )
					if( bullPower <= 28.6049 )
						ret := -0.818182 // sell
					if( bullPower > 28.6049 )
						ret := 0.100000
...
float op_operation = decision_tree_0_ADBE_1Day_6a8a383d(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
