			...
			if( Negative_Money_Flow > 3.18241e+08 )
				...
				if( ad > -649384 )
					...
					if( mf > 0.067129 )
						ret := 0.750000 // buy
	if( mf > 0.168669 )
		if( Typical_Price <= 17.4017 )
			if( Raw_Money_Flow <= 4.72214e+06 )
				ret := -1.000000 // sell
			if( Raw_Money_Flow > 4.72214e+06 )
				if( Positive_Money_Flow_Sum <= 1.66236e+08 )
					if( MFI_Low <= 61.2713 )
						ret := 1.000000 // buy
					if( MFI_Low > 61.2713 )
						ret := 0.000000
				if( Positive_Money_Flow_Sum > 1.66236e+08 )
					if( Typical_Price <= 11.117 )
						ret := -1.000000 // sell
					if( Typical_Price > 11.117 )
						ret := 0.696429
		if( Typical_Price > 17.4017 )
			if( MFI_Low <= 51.9278 )
				if( Positive_Money_Flow_Sum <= 3.8105e+09 )
					if( Positive_Money_Flow_Sum <= 1.50329e+09 )
						ret := 0.142857
					if( Positive_Money_Flow_Sum > 1.50329e+09 )
						ret := 0.978723 // buy
				if( Positive_Money_Flow_Sum > 3.8105e+09 )
					if( Raw_Money_Flow <= 8.01495e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 8.01495e+08 )
						ret := -1.000000 // sell
			if( MFI_Low > 51.9278 )
				if( Money_Flow_Ratio <= 9.25518 )
					if( Positive_Money_Flow_Sum <= 1.92795e+09 )
						ret := -0.617647
					if( Positive_Money_Flow_Sum > 1.92795e+09 )
						ret := 0.277778
				if( Money_Flow_Ratio > 9.25518 )
					if( Raw_Money_Flow <= 4.21404e+08 )
						ret := 0.875000 // buy
					if( Raw_Money_Flow > 4.21404e+08 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_ab156b22(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
