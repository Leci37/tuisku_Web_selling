	...
	if( upperKC > 47.1471 )
		...
		if( upperBB > 47.1191 )
			if( lowerBB <= 43.5287 )
				...
				if( upperBB > 48.9471 )
					if( rangema <= 1.00719 )
						if( priceRange <= 0.63027 )
							ret := 1.000000 // buy
						if( priceRange > 0.63027 )
							ret := 0.882353 // buy
					if( rangema > 1.00719 )
						if( avgHighLow <= 45.6106 )
							ret := 0.964286 // buy
						if( avgHighLow > 45.6106 )
							ret := -0.080000
			if( lowerBB > 43.5287 )
				...
				if( ma > 46.7382 )
					if( lowerBB <= 54.0639 )
						if( avgHighLow <= 48.6275 )
							ret := -0.072514
						if( avgHighLow > 48.6275 )
							ret := 0.028684
					if( lowerBB > 54.0639 )
						if( priceRange <= 0.580558 )
							ret := -0.020969
						if( priceRange > 0.580558 )
							ret := -0.127534
...
float op_operation = decision_tree_0_GTLB_15Min_4869f484(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
