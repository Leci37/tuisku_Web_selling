...
decision_tree_0_TTD_1Day_6bafac87(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)=>
	...
	if( bbp > 3.79348 )
		...
		if( Upper_Band > 52.9909 )
			if( basis <= 59.4954 )
				if( basis <= 47.5465 )
					if( bullPower <= 4.19763 )
						ret := 0.000000
					if( bullPower > 4.19763 )
						ret := 1.000000 // buy
				if( basis > 47.5465 )
					if( Lower_Band <= 46.0532 )
						ret := -0.821705 // sell
					if( Lower_Band > 46.0532 )
						ret := 0.133333
			if( basis > 59.4954 )
...
float op_operation = decision_tree_0_TTD_1Day_6bafac87(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
