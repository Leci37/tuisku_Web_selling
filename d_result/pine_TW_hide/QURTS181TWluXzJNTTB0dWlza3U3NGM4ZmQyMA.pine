		...
		if( Positive_Money_Flow_Sum <= 1.00421e+08 )
			...
			if( Negative_Money_Flow > 2.33484e+06 )
				...
				if( Positive_Money_Flow_Sum > 9.62122e+07 )
					ret := -0.867925 // sell
		if( Positive_Money_Flow_Sum > 1.00421e+08 )
			if( Negative_Money_Flow_Sum <= 2.12796e+07 )
				if( Positive_Money_Flow_Sum <= 1.09836e+08 )
					ret := -0.687500
				if( Positive_Money_Flow_Sum > 1.09836e+08 )
					if( Positive_Money_Flow_Sum <= 1.13822e+08 )
						ret := 0.281250
					if( Positive_Money_Flow_Sum > 1.13822e+08 )
						if( MFI <= 89.8803 )
							ret := -0.731707 // sell
			...
			if( Negative_Money_Flow_Sum > 2.12796e+07 )
				if( Short_MA <= 211.356 )
					if( Short_Long_Diff <= 0.862101 )
						ret := 0.535000
					if( Short_Long_Diff > 0.862101 )
						ret := -0.452381
				if( Short_MA > 211.356 )
					if( Short_Long_Diff <= -0.548556 )
						if( Raw_Money_Flow <= 1.46575e+06 )
							ret := 0.163934
						if( Raw_Money_Flow > 1.46575e+06 )
							ret := -0.687831
					if( Short_Long_Diff > -0.548556 )
...
float op_operation = decision_tree_0_ADSK_5Min_74c8fd20(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
