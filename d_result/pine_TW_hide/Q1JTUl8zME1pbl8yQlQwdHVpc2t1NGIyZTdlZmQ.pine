	...
	if( bullPower > -0.2769 )
		...
		if( bullPower > 0.042075 )
			...
			if( ema3 > 6.25685 )
				if( bbm <= 0.222966 )
					if( ema12 <= 0.217025 )
						if( bearPower <= 0.104658 )
							ret := -0.145881
						if( bearPower > 0.104658 )
							ret := -0.315858
					if( ema12 > 0.217025 )
						if( bearPower <= 0.42744 )
							ret := 0.191901
						if( bearPower > 0.42744 )
							ret := -0.312500
				if( bbm > 0.222966 )
					if( bullPower <= 0.700838 )
						if( bbp <= 0.470333 )
							ret := -0.018883
						if( bbp > 0.470333 )
							ret := 0.301954
...
float op_operation = decision_tree_0_CRSR_30Min_4b2e7efd(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)
