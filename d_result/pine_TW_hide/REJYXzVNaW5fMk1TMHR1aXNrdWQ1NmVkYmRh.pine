			...
			if( Positive_Money_Flow_Sum > 3.50282e+07 )
				...
				if( Negative_Money_Flow_Sum > 3.72465e+06 )
					...
					if( Negative_Money_Flow > 74.4541 )
						ret := 0.691943
	if( rsi1 > 54.6621 )
		if( Raw_Money_Flow <= 105383 )
			if( Negative_Money_Flow_Sum <= 1.29626e+06 )
				if( Typical_Price <= 31.2337 )
					ret := -0.846491 // sell
				if( Typical_Price > 31.2337 )
					ret := 0.285714
			if( Negative_Money_Flow_Sum > 1.29626e+06 )
		...
		if( Raw_Money_Flow > 105383 )
			if( MFI <= 66.8123 )
				if( d_k <= 10.2928 )
					if( Raw_Money_Flow <= 6.81376e+06 )
						ret := -0.133255
					if( Raw_Money_Flow > 6.81376e+06 )
						ret := 0.241758
				if( d_k > 10.2928 )
					if( Raw_Money_Flow <= 2.22985e+06 )
						ret := 0.112849
					if( Raw_Money_Flow > 2.22985e+06 )
						ret := -0.360656
			if( MFI > 66.8123 )
				if( d <= 77.9389 )
					...
					if( MFI_Low > 48.6499 )
						ret := -0.117293
				if( d > 77.9389 )
					if( Positive_Money_Flow_Sum <= 5.26778e+07 )
						ret := 0.108052
					if( Positive_Money_Flow_Sum > 5.26778e+07 )
						ret := -0.555556
...
float op_operation = decision_tree_0_DBX_5Min_d56edbda(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
