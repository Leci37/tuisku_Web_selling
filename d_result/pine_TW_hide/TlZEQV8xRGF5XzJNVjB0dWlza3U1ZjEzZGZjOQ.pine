			...
			if( Typical_Price > 352 )
				...
				if( Positive_Money_Flow_Sum > 3.9799e+10 )
					...
					if( Negative_Money_Flow_Sum > 6.46966e+10 )
						ret := 0.365772
	if( Positive_Money_Flow_Sum > 3.72459e+11 )
		if( Raw_Money_Flow <= 3.82273e+10 )
			ret := 0.625000
		if( Raw_Money_Flow > 3.82273e+10 )
			if( MFI <= 58.1182 )
				ret := 0.142857
			if( MFI > 58.1182 )
				if( Positive_Money_Flow <= 8.17432e+07 )
					if( Negative_Money_Flow_Sum <= 1.76503e+11 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 1.76503e+11 )
						ret := 0.666667
				if( Positive_Money_Flow > 8.17432e+07 )
...
float op_operation = decision_tree_0_NVDA_1Day_5f13dfc9(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
