...
decision_tree_0_SPOT_30Min_16ca5e27(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)=>
	...
	if( vrsi > 30.6999 )
		...
		if( BBlower > 251.544 )
			if( BBlower <= 279.256 )
				if( vrsi <= 90.0366 )
					if( dif_source_BBupper <= -84.5528 )
						ret := 0.781250 // buy
					if( dif_source_BBupper > -84.5528 )
						ret := -0.347767
				if( vrsi > 90.0366 )
					if( dif_source_BBlower <= 33.1506 )
						ret := 0.145161
					if( dif_source_BBlower > 33.1506 )
						ret := 0.655172
			if( BBlower > 279.256 )
				if( BBlower <= 314.348 )
					if( dif_source_BBlower <= 52.6012 )
						ret := 0.032873
					if( dif_source_BBlower > 52.6012 )
						ret := -0.477987
				if( BBlower > 314.348 )
					if( dif_source_BBupper <= -35.5918 )
						ret := -0.862069 // sell
					if( dif_source_BBupper > -35.5918 )
						ret := -0.202206
...
float op_operation = decision_tree_0_SPOT_30Min_16ca5e27(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
