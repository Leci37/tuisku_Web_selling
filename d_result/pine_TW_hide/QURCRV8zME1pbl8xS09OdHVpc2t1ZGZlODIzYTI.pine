				...
				if( BollOsc > -27.6084 )
					...
					if( azul_mean > 39.4944 )
						...
						if( nvimax > 1.43931 )
							ret := 0.776786 // buy
		if( verde_media > 16.4059 )
			if( azul_mean <= 13.3511 )
				if( nvimax <= 0.000344 )
					if( BollOsc <= 46.5288 )
						if( azul_mean <= -19.7129 )
							ret := -1.000000 // sell
						if( azul_mean > -19.7129 )
							ret := 0.867257 // buy
					if( BollOsc > 46.5288 )
...
float op_operation = decision_tree_0_ADBE_30Min_dfe823a2(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
