			...
			if( Raw_Money_Flow > 2.68552e+06 )
				...
				if( Positive_Money_Flow_Sum > 7.13357e+07 )
					...
					if( VIM > 1.14319 )
						ret := -0.789474 // sell
	if( Negative_Money_Flow > 6.68164 )
		if( Raw_Money_Flow <= 37487.3 )
			if( Negative_Money_Flow_Sum <= 541336 )
				if( MFI <= 72.2935 )
					if( Positive_Money_Flow <= 499.64 )
						ret := -0.527778
					if( Positive_Money_Flow > 499.64 )
						ret := -0.960000 // sell
				if( MFI > 72.2935 )
					if( Negative_Money_Flow_Sum <= 164100 )
						ret := 0.620000
					if( Negative_Money_Flow_Sum > 164100 )
						ret := -0.178571
			if( Negative_Money_Flow_Sum > 541336 )
				if( MFI <= 31.4776 )
					...
					if( VIP_VIM > 0.139337 )
						ret := -0.492537
				if( MFI > 31.4776 )
					if( Positive_Money_Flow_Sum <= 1.06189e+07 )
						ret := 0.135417
					if( Positive_Money_Flow_Sum > 1.06189e+07 )
						ret := 0.414791
		if( Raw_Money_Flow > 37487.3 )
			if( Positive_Money_Flow_Sum <= 458429 )
				if( Raw_Money_Flow <= 69326.8 )
					if( Money_Flow_Ratio <= 0.323143 )
						ret := 0.153846
					if( Money_Flow_Ratio > 0.323143 )
						ret := -0.560976
				if( Raw_Money_Flow > 69326.8 )
					if( Positive_Money_Flow_Sum <= 60477.4 )
						ret := -0.166667
					if( Positive_Money_Flow_Sum > 60477.4 )
						ret := 0.625000
			if( Positive_Money_Flow_Sum > 458429 )
				if( VIM <= 1.44687 )
					if( Positive_Money_Flow_Sum <= 3.65273e+06 )
						ret := -0.032683
					if( Positive_Money_Flow_Sum > 3.65273e+06 )
						ret := 0.100687
				if( VIM > 1.44687 )
					if( Raw_Money_Flow <= 164816 )
						ret := 0.089286
					if( Raw_Money_Flow > 164816 )
						ret := -0.129891
...
float op_operation = decision_tree_0_DOCN_15Min_48a7f278(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
