	...
	if( Raw_Money_Flow > 8.27778e+09 )
		if( Typical_Price <= 88.5233 )
			if( Raw_Money_Flow <= 9.06173e+09 )
				ret := 0.000000
			if( Raw_Money_Flow > 9.06173e+09 )
				if( Negative_Money_Flow <= 1.18531e+10 )
					ret := 1.000000 // buy
				if( Negative_Money_Flow > 1.18531e+10 )
					if( MFI <= 49.8926 )
						ret := 0.000000
			...
			if( smoothD_d <= 84.7649 )
				if( k <= 29.0082 )
					...
					if( rsi1 > 19.4693 )
						ret := -0.608696
				if( k > 29.0082 )
					if( Typical_Price <= 149.608 )
						ret := 0.241379
					if( Typical_Price > 149.608 )
						ret := -0.263158
			if( smoothD_d > 84.7649 )
				if( Positive_Money_Flow_Sum <= 1.00694e+11 )
					if( Typical_Price <= 121.187 )
						ret := -0.086957
					if( Typical_Price > 121.187 )
						ret := -0.555556
				if( Positive_Money_Flow_Sum > 1.00694e+11 )
					if( Negative_Money_Flow <= 1.43943e+10 )
						ret := -0.964912 // sell
					if( Negative_Money_Flow > 1.43943e+10 )
						ret := 0.000000
...
float op_operation = decision_tree_0_AMD_1Day_d19b8d3a(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
