			...
			if( Positive_Money_Flow_Sum <= 1.16415e+09 )
				...
				if( Positive_Money_Flow > 21977.4 )
					...
					if( MFI > 84.7599 )
						ret := -0.200000
			if( Positive_Money_Flow_Sum > 1.16415e+09 )
				if( Negative_Money_Flow_Sum <= 7.74323e+08 )
					if( Negative_Money_Flow_Sum <= 6.47215e+08 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 6.47215e+08 )
						ret := 0.928571 // buy
				if( Negative_Money_Flow_Sum > 7.74323e+08 )
					...
					if( MFI_Low > 26.9589 )
						ret := 0.052632
		if( Typical_Price > 373.474 )
			if( Negative_Money_Flow_Sum <= 1.48903e+09 )
				if( Negative_Money_Flow <= 2.8993e+08 )
					if( Positive_Money_Flow_Sum <= 2.25676e+09 )
						ret := -0.666667
					if( Positive_Money_Flow_Sum > 2.25676e+09 )
						ret := -0.980769 // sell
				if( Negative_Money_Flow > 2.8993e+08 )
...
float op_operation = decision_tree_0_HUBS_1Day_28e173be(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
