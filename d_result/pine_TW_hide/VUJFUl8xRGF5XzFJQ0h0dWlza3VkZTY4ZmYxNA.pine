		...
		if( chinkou_span <= 57.1829 )
			if( senkou_span_b_displaced <= 35.6471 )
				if( senkou_span_b_displaced <= 32.774 )
					if( senkou_span_b <= 33.589 )
						ret := -0.262032
					if( senkou_span_b > 33.589 )
						ret := -0.690909
				if( senkou_span_b_displaced > 32.774 )
					if( chinkou_span <= 36.285 )
						ret := 0.933333 // buy
					if( chinkou_span > 36.285 )
						ret := 0.235772
			if( senkou_span_b_displaced > 35.6471 )
				if( basis_minus <= -1.1475 )
					if( senkou_span_b <= 38.3427 )
						ret := -0.435294
					if( senkou_span_b > 38.3427 )
						ret := 0.367521
				if( basis_minus > -1.1475 )
					if( chinkou_span <= 44.03 )
						ret := -0.747423 // sell
					if( chinkou_span > 44.03 )
						ret := -0.385027
		if( chinkou_span > 57.1829 )
			if( kinjun_sen <= 68.45 )
				if( tenkan_sen <= 54.3888 )
					if( basis_max <= -0.401875 )
						ret := 0.000000
					if( basis_max > -0.401875 )
						ret := 0.884615 // buy
				if( tenkan_sen > 54.3888 )
					if( basis_minus <= 8.435 )
						ret := 0.457364
					if( basis_minus > 8.435 )
						ret := -0.818182 // sell
			if( kinjun_sen > 68.45 )
				if( senkou_span_b_displaced <= 69.8985 )
					ret := -0.025000
				if( senkou_span_b_displaced > 69.8985 )
					if( senkou_span_a <= 70.62 )
						ret := 0.000000
					if( senkou_span_a > 70.62 )
						ret := -0.944444 // sell
...
float op_operation = decision_tree_0_UBER_1Day_de68ff14(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
