			...
			if( basis > 45.0866 )
				if( Upper_Band <= 48.6504 )
					if( bearPower <= 0.164518 )
						if( Lower_Band <= 43.6266 )
							ret := 0.916667 // buy
						if( Lower_Band > 43.6266 )
							ret := 0.194444
					if( bearPower > 0.164518 )
						if( Lower_Band <= 43.2267 )
							ret := 0.555556
						if( Lower_Band > 43.2267 )
							ret := 0.970588 // buy
				if( Upper_Band > 48.6504 )
					...
					if( bbm > 0.4025 )
						ret := -0.666667
		if( Lower_Band > 44.2801 )
			if( bullPower <= -0.619593 )
				if( Lower_Band <= 45.1621 )
					ret := 0.000000
				if( Lower_Band > 45.1621 )
					ret := 1.000000 // buy
			if( bullPower > -0.619593 )
				if( bbp <= -0.110619 )
					...
					if( bbm > 0.341011 )
						...
						if( basis > 49.6259 )
							ret := -0.130435
				if( bbp > -0.110619 )
					if( Lower_Band <= 46.5437 )
						if( Upper_Band <= 47.5499 )
							ret := -0.444444
						if( Upper_Band > 47.5499 )
							ret := 0.397260
					if( Lower_Band > 46.5437 )
...
float op_operation = decision_tree_0_NVST_1Hour_10c2a0ba(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
