	...
	if( mf > 0.45051 )
		if( bullPower <= 0.385148 )
			...
			if( mf > 0.505017 )
				ret := 0.818182 // buy
		if( bullPower > 0.385148 )
			if( bearPower <= 9.34841 )
				if( bullPower <= 6.86278 )
					if( bbp <= 7.05657 )
						if( bearPower <= -0.008443 )
							ret := 0.461538
						if( bearPower > -0.008443 )
							ret := 0.044248
					if( bbp > 7.05657 )
...
float op_operation = decision_tree_0_GOOG_1Hour_d0a6c6de(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
