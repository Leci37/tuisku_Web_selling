			...
			if( Raw_Money_Flow <= 2.11159e+10 )
				if( VIM <= 1.28182 )
					...
					if( Positive_Money_Flow_Sum > 1.42947e+11 )
						ret := -0.696429
				if( VIM > 1.28182 )
					if( Money_Flow_Ratio <= 0.427643 )
						ret := -0.269231
					if( Money_Flow_Ratio > 0.427643 )
						ret := -0.925926 // sell
			if( Raw_Money_Flow > 2.11159e+10 )
				if( Negative_Money_Flow_Sum <= 1.42691e+11 )
					if( Positive_Money_Flow <= 3.16084e+10 )
						ret := -0.942029 // sell
					if( Positive_Money_Flow > 3.16084e+10 )
						ret := 0.000000
				if( Negative_Money_Flow_Sum > 1.42691e+11 )
					ret := 0.000000
		if( Negative_Money_Flow_Sum > 1.45234e+11 )
			if( Typical_Price <= 2512.11 )
				if( VIP <= 0.756719 )
					ret := 0.666667
				if( VIP > 0.756719 )
					ret := -1.000000 // sell
			if( Typical_Price > 2512.11 )
				if( Positive_Money_Flow <= 1.16625e+10 )
					if( VIP <= 0.575129 )
						ret := 0.000000
					if( VIP > 0.575129 )
						ret := 0.900000 // buy
				if( Positive_Money_Flow > 1.16625e+10 )
					if( Negative_Money_Flow_Sum <= 1.53188e+11 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 1.53188e+11 )
						ret := 0.166667
...
float op_operation = decision_tree_0_AMZN_1Day_d645b50b(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
