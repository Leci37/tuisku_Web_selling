...
decision_tree_0_AMD_1Hour_7bf44810(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)=>
				...
				if( basis > 20.1392 )
					...
					if( bullPower > 0.162969 )
						...
						if( Lower_Band > 19.7847 )
							ret := 0.127660
			if( basis > 21.0058 )
				if( Upper_Band <= 183.389 )
					if( bbp <= -1.87932 )
						if( Upper_Band <= 58.7014 )
							ret := 0.378378
						if( Upper_Band > 58.7014 )
							ret := -0.114795
					if( bbp > -1.87932 )
						if( bearPower <= -1.20665 )
							ret := 0.140674
						if( bearPower > -1.20665 )
							ret := 0.001374
				if( Upper_Band > 183.389 )
	...
	if( Lower_Band > 168.853 )
		if( basis <= 196.698 )
			if( bbp <= 5.25288 )
				if( Upper_Band <= 185.378 )
					if( basis <= 176.039 )
						ret := -0.573248
					if( basis > 176.039 )
						ret := -0.105376
				if( Upper_Band > 185.378 )
					if( bearPower <= -4.59138 )
						ret := 0.120000
					if( bearPower > -4.59138 )
						ret := -0.718182 // sell
			if( bbp > 5.25288 )
...
float op_operation = decision_tree_0_AMD_1Hour_7bf44810(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
