			...
			if( bbm > 2.11511 )
				...
				if( bearPower > 19.0355 )
					...
					if( k > 97.3842 )
						ret := -1.000000 // sell
	if( d_k > 5.54141 )
		if( bearPower <= -1.72506 )
			if( smoothD_d <= 11.1918 )
				if( bbp <= -19.073 )
					if( bullPower <= -5.70465 )
						ret := 0.800000 // buy
					if( bullPower > -5.70465 )
						ret := -0.666667
				if( bbp > -19.073 )
		...
		if( bearPower > -1.72506 )
			if( d <= 94.4103 )
				if( bullPower <= 1.66387 )
					if( rsi1 <= 49.1357 )
						ret := 0.441860
					if( rsi1 > 49.1357 )
						ret := -0.085714
				if( bullPower > 1.66387 )
					if( bearPower <= 0.436247 )
						ret := 0.745098 // buy
					if( bearPower > 0.436247 )
						ret := 0.364341
			if( d > 94.4103 )
...
float op_operation = decision_tree_0_TWLO_1Day_5f5ecd25(bbp, bullPower, BBPower_Color, bearPower, bbm, rsi1, d, k, smoothD_d, d_k, smoothK_k)
