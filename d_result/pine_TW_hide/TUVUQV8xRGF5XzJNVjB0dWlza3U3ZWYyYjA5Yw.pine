			...
			if( Typical_Price <= 246.927 )
				if( Positive_Money_Flow_Sum <= 5.95518e+10 )
					...
					if( MFI_Low > 47.9871 )
						ret := 0.317204
				if( Positive_Money_Flow_Sum > 5.95518e+10 )
					if( Typical_Price <= 130.872 )
						ret := 0.200000
					if( Typical_Price > 130.872 )
						ret := -0.703704 // sell
			if( Typical_Price > 246.927 )
				if( VIM <= 1.13718 )
					if( Positive_Money_Flow_Sum <= 4.10379e+10 )
						ret := 0.405797
					if( Positive_Money_Flow_Sum > 4.10379e+10 )
						ret := -0.123881
				if( VIM > 1.13718 )
					...
					if( VIP_VIM > -0.396265 )
						ret := 0.563910
		if( MFI_Low > 57.0147 )
			if( Positive_Money_Flow_Sum <= 7.86048e+10 )
				if( VIP <= 1.35064 )
					if( MFI_High <= 2.06255 )
						ret := 0.808824 // buy
					if( MFI_High > 2.06255 )
						ret := 0.000000
				if( VIP > 1.35064 )
					if( Typical_Price <= 375.083 )
						ret := 0.058824
					if( Typical_Price > 375.083 )
						ret := 0.857143 // buy
			if( Positive_Money_Flow_Sum > 7.86048e+10 )
				if( Raw_Money_Flow <= 1.15833e+10 )
					ret := 0.000000
				if( Raw_Money_Flow > 1.15833e+10 )
					ret := -0.800000 // sell
...
float op_operation = decision_tree_0_META_1Day_7ef2b09c(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
