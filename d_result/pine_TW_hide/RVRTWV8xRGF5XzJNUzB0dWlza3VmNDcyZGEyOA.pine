			...
			if( d <= 93.3314 )
				...
				if( d > 48.5925 )
					...
					if( Typical_Price > 55.952 )
						ret := -0.588957
			if( d > 93.3314 )
				if( Positive_Money_Flow <= 2.55098e+08 )
					if( rsi1 <= 72.0629 )
						ret := 0.151515
					if( rsi1 > 72.0629 )
						ret := 0.823529 // buy
				if( Positive_Money_Flow > 2.55098e+08 )
					if( Money_Flow_Ratio <= 3.46939 )
						ret := -0.806452 // sell
					if( Money_Flow_Ratio > 3.46939 )
						ret := 0.250000
		if( Negative_Money_Flow_Sum > 1.54109e+09 )
			if( Negative_Money_Flow_Sum <= 2.82416e+09 )
				if( Typical_Price <= 182.227 )
					if( Negative_Money_Flow_Sum <= 2.25806e+09 )
						ret := 0.083333
					if( Negative_Money_Flow_Sum > 2.25806e+09 )
						ret := 0.470803
				if( Typical_Price > 182.227 )
					...
					if( k > 75.9046 )
						ret := -0.083333
			if( Negative_Money_Flow_Sum > 2.82416e+09 )
				if( Positive_Money_Flow_Sum <= 3.85272e+09 )
					if( Money_Flow_Ratio <= 0.636775 )
						ret := -0.084906
					if( Money_Flow_Ratio > 0.636775 )
						ret := -0.497976
				if( Positive_Money_Flow_Sum > 3.85272e+09 )
					if( Negative_Money_Flow_Sum <= 4.5388e+09 )
						ret := -0.053254
					if( Negative_Money_Flow_Sum > 4.5388e+09 )
						ret := 0.657143
...
float op_operation = decision_tree_0_ETSY_1Day_f472da28(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
