			...
			if( Negative_Money_Flow_Sum > 2.61013e+08 )
				...
				if( Money_Flow_Ratio > 6.93841 )
					...
					if( Typical_Price > 14.0331 )
						ret := 1.000000 // buy
	if( Typical_Price > 176.52 )
		if( Negative_Money_Flow_Sum <= 2.12279e+09 )
			if( Money_Flow_Ratio <= 3.41894 )
				if( Positive_Money_Flow_Sum <= 2.53791e+09 )
					if( ad <= 24977.8 )
						ret := 0.000000
					if( ad > 24977.8 )
						ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 2.53791e+09 )
					if( ad_mf <= 1.91286e+06 )
						ret := 0.928571 // buy
					if( ad_mf > 1.91286e+06 )
						ret := 0.000000
			if( Money_Flow_Ratio > 3.41894 )
				if( Positive_Money_Flow_Sum <= 8.79723e+09 )
					ret := 0.000000
				if( Positive_Money_Flow_Sum > 8.79723e+09 )
					if( ad_mf <= -805583 )
						ret := 0.000000
		...
		if( Negative_Money_Flow_Sum > 2.12279e+09 )
			if( mf <= -0.15104 )
				...
				if( MFI_High > -1.80063 )
					ret := 1.000000 // buy
			if( mf > -0.15104 )
				if( Negative_Money_Flow_Sum <= 2.52734e+10 )
					if( MFI <= 29.5443 )
						ret := 0.000000
					if( MFI > 29.5443 )
						ret := -0.857143 // sell
...
float op_operation = decision_tree_0_GME_1Day_79d6d18f(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
