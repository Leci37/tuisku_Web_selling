		...
		if( bullPower <= 7.74147 )
			...
			if( VIM > 1.10719 )
				...
				if( VIP_VIM > -0.211119 )
					ret := -0.900000 // sell
		if( bullPower > 7.74147 )
			if( bearPower <= 4.24363 )
				if( VIP <= 1.258 )
					if( bullPower <= 10.2987 )
						ret := 0.389610
					if( bullPower > 10.2987 )
						ret := -0.521739
				if( VIP > 1.258 )
...
float op_operation = decision_tree_0_PYPL_1Day_690f313e(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
