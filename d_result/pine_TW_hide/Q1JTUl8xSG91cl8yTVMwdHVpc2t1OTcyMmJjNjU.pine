		...
		if( Negative_Money_Flow <= 40.5572 )
			if( Negative_Money_Flow_Sum <= 1.16653e+07 )
				...
				if( Positive_Money_Flow > 3.18290e+06 )
					ret := -0.704819 // sell
			if( Negative_Money_Flow_Sum > 1.16653e+07 )
				if( Typical_Price <= 38.6247 )
					if( Money_Flow_Ratio <= 3.08693 )
						if( Negative_Money_Flow_Sum <= 3.28329e+07 )
							ret := -0.010417
						if( Negative_Money_Flow_Sum > 3.28329e+07 )
							ret := 0.315068
					if( Money_Flow_Ratio > 3.08693 )
				...
				if( Typical_Price > 38.6247 )
					ret := -0.163498
		if( Negative_Money_Flow > 40.5572 )
			if( Negative_Money_Flow <= 11649.8 )
				if( Typical_Price <= 20.7141 )
					if( Money_Flow_Ratio <= 0.046891 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 0.046891 )
						if( Negative_Money_Flow_Sum <= 2.86815e+06 )
							ret := 0.294915
						if( Negative_Money_Flow_Sum > 2.86815e+06 )
							ret := 0.607034
				if( Typical_Price > 20.7141 )
					if( Raw_Money_Flow <= 394310 )
						if( d <= 48.7119 )
							ret := 0.279720
						if( d > 48.7119 )
							ret := -0.195312
					if( Raw_Money_Flow > 394310 )
						ret := 1.000000 // buy
			if( Negative_Money_Flow > 11649.8 )
				if( Positive_Money_Flow <= 9.8249e+06 )
					if( Negative_Money_Flow <= 1.65026e+07 )
						if( Raw_Money_Flow <= 2.01909e+06 )
							ret := 0.109783
						if( Raw_Money_Flow > 2.01909e+06 )
							ret := -0.029218
					if( Negative_Money_Flow > 1.65026e+07 )
...
float op_operation = decision_tree_0_CRSR_1Hour_9722bc65(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
