...
float op_operation = decision_tree_0_EPAM_1Min_21f6d9af(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
