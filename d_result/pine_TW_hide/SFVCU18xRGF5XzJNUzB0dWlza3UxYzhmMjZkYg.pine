		...
		if( smoothD_d <= 37.8645 )
			...
			if( MFI_High > -5.66653 )
				...
				if( d > 15.8312 )
					ret := 0.111111
		if( smoothD_d > 37.8645 )
			if( Positive_Money_Flow_Sum <= 2.53462e+09 )
				if( Raw_Money_Flow <= 9.23375e+07 )
					if( Positive_Money_Flow_Sum <= 2.16657e+08 )
						ret := 0.309278
					if( Positive_Money_Flow_Sum > 2.16657e+08 )
						ret := -0.316109
				if( Raw_Money_Flow > 9.23375e+07 )
					if( Raw_Money_Flow <= 3.94446e+08 )
						ret := 0.254453
					if( Raw_Money_Flow > 3.94446e+08 )
						ret := -0.642857
			if( Positive_Money_Flow_Sum > 2.53462e+09 )
...
float op_operation = decision_tree_0_HUBS_1Day_1c8f26db(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
