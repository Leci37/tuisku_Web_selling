			...
			if( smoothedDirectionalMovementPlus <= 1.00382 )
				if( directionalMovementMinus <= 0.510258 )
					...
					if( smoothedTrueRange > 4.10317 )
						ret := -0.511111
				if( directionalMovementMinus > 0.510258 )
					if( smoothedDirectionalMovementMinus <= 1.82206 )
						ret := 0.069149
					if( smoothedDirectionalMovementMinus > 1.82206 )
						ret := 0.666667
			if( smoothedDirectionalMovementPlus > 1.00382 )
				...
				if( dx > 34.4836 )
					...
					if( adx > 34.2826 )
						ret := -0.441860
		if( diPlus > 39.9487 )
			if( trueRange <= 4.53686 )
				if( smoothedDirectionalMovementMinus <= 0.320531 )
					if( smoothedDirectionalMovementMinus <= 0.256076 )
						ret := -0.428571
					if( smoothedDirectionalMovementMinus > 0.256076 )
						ret := -1.000000 // sell
				if( smoothedDirectionalMovementMinus > 0.320531 )
...
float op_operation = decision_tree_0_QCOM_1Day_14c48657(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
