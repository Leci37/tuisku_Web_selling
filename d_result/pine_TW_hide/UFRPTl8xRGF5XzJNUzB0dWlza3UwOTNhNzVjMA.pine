		...
		if( Positive_Money_Flow <= 1.2763e+09 )
			if( Raw_Money_Flow <= 1.21226e+08 )
				...
				if( smoothD_d > 84.079 )
					ret := 0.000000
			if( Raw_Money_Flow > 1.21226e+08 )
				if( Negative_Money_Flow_Sum <= 7.4303e+08 )
					if( rsi1 <= 82.4958 )
						ret := -0.979167 // sell
					if( rsi1 > 82.4958 )
						ret := -0.733333 // sell
...
float op_operation = decision_tree_0_PTON_1Day_093a75c0(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
