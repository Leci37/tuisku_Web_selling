...
decision_tree_0_TSLA_1Day_713d5063(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)=>
	...
	if( vrsi > 56.0671 )
		if( dif_source_BBupper <= 251.82 )
			if( BBlower <= -53.8325 )
				if( BBlower <= -150.451 )
					if( dif_source_BBlower <= 377.917 )
						ret := -0.300000
					if( dif_source_BBlower > 377.917 )
						ret := -1.000000 // sell
				if( BBlower > -150.451 )
					if( dif_source_BBlower <= 310.948 )
						ret := 0.920000 // buy
					if( dif_source_BBlower > 310.948 )
						ret := 0.741667 // buy
			if( BBlower > -53.8325 )
				if( BBupper <= 1193.42 )
					...
					if( BBlower > 12.1089 )
						ret := 0.257393
				if( BBupper > 1193.42 )
					if( dif_source_BBlower <= 1147.06 )
						ret := -0.529070
					if( dif_source_BBlower > 1147.06 )
						ret := 0.888889 // buy
		if( dif_source_BBupper > 251.82 )
			if( dif_source_BBupper <= 339.437 )
				if( BBupper <= 1027.62 )
					if( dif_source_BBlower <= 731.193 )
						ret := -0.714286 // sell
					if( dif_source_BBlower > 731.193 )
						ret := -1.000000 // sell
				if( BBupper > 1027.62 )
...
float op_operation = decision_tree_0_TSLA_1Day_713d5063(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
