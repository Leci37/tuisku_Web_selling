			...
			if( midLine <= 12.753 )
				...
				if( lowerBand > -0.619501 )
					...
					if( midLine > 8.57449 )
						ret := 0.271429
			if( midLine > 12.753 )
				if( upperBand <= 23.2941 )
					if( Color_con2 <= -1.51971 )
						ret := -0.792453 // sell
					if( Color_con2 > -1.51971 )
						ret := -0.260870
				if( upperBand > 23.2941 )
					if( lowerBand <= -4.10697 )
						ret := 0.736842 // buy
					if( lowerBand > -4.10697 )
						ret := -0.106145
		if( midLine > 16.8797 )
			if( wvf <= 21.5826 )
				...
				if( sDev > 9.74405 )
					...
					if( midLine > 17.6595 )
						ret := -1.000000 // sell
			if( wvf > 21.5826 )
				if( upperBand <= 42.7914 )
					if( Color_con1 <= -3.22865 )
						ret := 0.766169 // buy
					if( Color_con1 > -3.22865 )
						ret := 0.000000
				if( upperBand > 42.7914 )
					if( Color_con2 <= 18.1541 )
						ret := -0.205128
					if( Color_con2 > 18.1541 )
						ret := 1.000000 // buy
...
float op_operation = decision_tree_0_TWLO_1Day_ba92d16e(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
