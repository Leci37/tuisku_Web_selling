			...
			if( Money_Flow_Ratio <= 0.21654 )
				if( Raw_Money_Flow <= 2.57759e+08 )
					...
					if( Typical_Price > 45.3857 )
						ret := 0.850000 // buy
				if( Raw_Money_Flow > 2.57759e+08 )
					if( Negative_Money_Flow_Sum <= 8.03044e+09 )
						ret := -0.893333 // sell
					if( Negative_Money_Flow_Sum > 8.03044e+09 )
						ret := 0.700000 // buy
			if( Money_Flow_Ratio > 0.21654 )
				if( bullPower <= -11.412 )
					if( Typical_Price <= 338.892 )
						ret := 0.619048
					if( Typical_Price > 338.892 )
						ret := -0.375000
				if( bullPower > -11.412 )
					if( Typical_Price <= 212.864 )
						ret := -0.069788
					if( Typical_Price > 212.864 )
						ret := 0.122396
		if( MFI > 66.3231 )
			if( Raw_Money_Flow <= 3.7287e+08 )
				if( Positive_Money_Flow_Sum <= 4.68447e+09 )
					if( Positive_Money_Flow_Sum <= 3.02175e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 3.02175e+09 )
						ret := 0.111111
				if( Positive_Money_Flow_Sum > 4.68447e+09 )
					ret := -0.818182 // sell
			if( Raw_Money_Flow > 3.7287e+08 )
				if( Raw_Money_Flow <= 8.06062e+08 )
					if( Raw_Money_Flow <= 6.38766e+08 )
						ret := -0.404040
					if( Raw_Money_Flow > 6.38766e+08 )
						ret := -0.849315 // sell
				if( Raw_Money_Flow > 8.06062e+08 )
					if( Positive_Money_Flow_Sum <= 6.0184e+09 )
						ret := -0.800000 // sell
					if( Positive_Money_Flow_Sum > 6.0184e+09 )
						ret := 0.216667
...
float op_operation = decision_tree_0_TWLO_1Day_71e64342(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
