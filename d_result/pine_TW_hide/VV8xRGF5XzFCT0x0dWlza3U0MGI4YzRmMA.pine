			...
			if( dif_source_BBupper > -149.602 )
				if( BBupper <= 161.485 )
					...
					if( dif_source_BBupper > -18.5921 )
						ret := -0.477011
				if( BBupper > 161.485 )
					if( dif_source_BBlower <= -16.0499 )
						ret := 1.000000 // buy
					if( dif_source_BBlower > -16.0499 )
						ret := -0.680751
		if( BBlower > 71.5926 )
			if( dif_source_BBupper <= -79.7108 )
				if( vrsi <= 35.4219 )
					if( dif_source_BBlower <= 20.8771 )
						ret := 0.333333
					if( dif_source_BBlower > 20.8771 )
						ret := 1.000000 // buy
				if( vrsi > 35.4219 )
...
float op_operation = decision_tree_0_U_1Day_40b8c4f0(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
