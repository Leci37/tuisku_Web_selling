			...
			if( rsi1 > 61.7723 )
				...
				if( Typical_Price > 61.3317 )
					...
					if( Money_Flow_Ratio > 1.2751 )
						ret := -0.301370
	if( Raw_Money_Flow > 7.83573e+08 )
		if( Positive_Money_Flow_Sum <= 2.31063e+10 )
			if( Negative_Money_Flow_Sum <= 2.4513e+10 )
				if( rsi1 <= 66.1491 )
					if( Negative_Money_Flow <= 2.1527e+09 )
						ret := -0.109804
					if( Negative_Money_Flow > 2.1527e+09 )
						ret := -0.673077
				if( rsi1 > 66.1491 )
					if( Negative_Money_Flow <= 2.81306e+09 )
						ret := -0.495798
					if( Negative_Money_Flow > 2.81306e+09 )
						ret := 0.800000 // buy
			if( Negative_Money_Flow_Sum > 2.4513e+10 )
				if( Raw_Money_Flow <= 1.82482e+09 )
					if( Typical_Price <= 610.574 )
						ret := 0.000000
					if( Typical_Price > 610.574 )
						ret := -1.000000 // sell
				if( Raw_Money_Flow > 1.82482e+09 )
					if( Positive_Money_Flow_Sum <= 6.53972e+09 )
						ret := -0.250000
					if( Positive_Money_Flow_Sum > 6.53972e+09 )
						ret := 0.863636 // buy
		if( Positive_Money_Flow_Sum > 2.31063e+10 )
			if( Positive_Money_Flow <= 2.6703e+09 )
				if( Typical_Price <= 947.151 )
					if( d_k <= -0.255807 )
						ret := -0.250000
					if( d_k > -0.255807 )
						ret := 0.944444 // buy
...
float op_operation = decision_tree_0_SHOP_1Day_6e91e95d(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
