...
decision_tree_0_RUN_1Day_4dfba40d(bbm, bearPower, bbp, bullPower, BBPower_Color, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( tema > 24.213 )
		...
		if( ema13 > 3.01188 )
			if( ema1 <= 72.3273 )
				if( bearPower <= 1.05242 )
					if( bearPower <= -1.32023 )
						ret := 0.200000
					if( bearPower > -1.32023 )
						ret := 0.925373 // buy
				if( bearPower > 1.05242 )
...
float op_operation = decision_tree_0_RUN_1Day_4dfba40d(bbm, bearPower, bbp, bullPower, BBPower_Color, ema1, tema, ema12, ema2, ema3, ema13)
