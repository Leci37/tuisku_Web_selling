		...
		if( ad <= -302.028 )
			if( bbm <= 0.169812 )
				...
				if( bearPower > 0.006864 )
					ret := -0.165306
			if( bbm > 0.169812 )
				if( bullPower <= 1.08742 )
					if( ad <= -13056.1 )
						ret := 0.059561
					if( ad > -13056.1 )
						if( bullPower <= 0.340089 )
							ret := 0.105691
						if( bullPower > 0.340089 )
							ret := 0.522310
				if( bullPower > 1.08742 )
					ret := -0.311203
		if( ad > -302.028 )
			if( bullPower <= 0.037209 )
				if( ad_mf <= -0.265221 )
					if( bearPower <= 0.008623 )
						ret := 0.157895
					if( bearPower > 0.008623 )
						ret := 0.758621 // buy
				if( ad_mf > -0.265221 )
...
float op_operation = decision_tree_0_CRSR_30Min_4914f611(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)
