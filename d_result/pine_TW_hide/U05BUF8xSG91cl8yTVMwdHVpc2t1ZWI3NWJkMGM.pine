	...
	if( MFI > 6.578 )
		if( Negative_Money_Flow <= 7.34983 )
			...
			if( Raw_Money_Flow > 8.81316e+08 )
				ret := 0.741379 // buy
		if( Negative_Money_Flow > 7.34983 )
			if( Raw_Money_Flow <= 3.6764e+07 )
				if( Positive_Money_Flow_Sum <= 3.60424e+08 )
					if( Positive_Money_Flow <= 6211.61 )
						if( Positive_Money_Flow_Sum <= 3.39253e+08 )
							ret := 0.126346
						if( Positive_Money_Flow_Sum > 3.39253e+08 )
							ret := 0.608696
					if( Positive_Money_Flow > 6211.61 )
						if( Money_Flow_Ratio <= 0.178508 )
							ret := -0.070064
						if( Money_Flow_Ratio > 0.178508 )
							ret := 0.287688
				if( Positive_Money_Flow_Sum > 3.60424e+08 )
					if( Typical_Price <= 11.9655 )
						if( smoothD_d <= 0.341696 )
							ret := -0.625000
						if( smoothD_d > 0.341696 )
							ret := 0.520468
					if( Typical_Price > 11.9655 )
			...
			if( Raw_Money_Flow > 3.6764e+07 )
				if( k <= 92.2256 )
					if( Positive_Money_Flow_Sum <= 1.03251e+09 )
						if( MFI_High <= -41.5622 )
							ret := 0.035938
						if( MFI_High > -41.5622 )
							ret := -0.097512
					if( Positive_Money_Flow_Sum > 1.03251e+09 )
						if( Money_Flow_Ratio <= 4.31741 )
							ret := 0.572222
						if( Money_Flow_Ratio > 4.31741 )
							ret := -0.363636
				if( k > 92.2256 )
					if( smoothD_d <= 74.0505 )
						ret := 0.807692 // buy
					if( smoothD_d > 74.0505 )
						ret := 0.169611
...
float op_operation = decision_tree_0_SNAP_1Hour_eb75bd0c(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
