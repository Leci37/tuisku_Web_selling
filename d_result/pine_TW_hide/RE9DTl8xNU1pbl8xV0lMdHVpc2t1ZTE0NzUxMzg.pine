...
decision_tree_0_DOCN_15Min_e1475138(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( wvf <= 0.16025 )
		...
		if( Color_con2 > -6.80672 )
			...
			if( lowerBand > -0.946015 )
				if( wvf <= 0.00848 )
					if( Color_con1 <= -0.887263 )
						if( upperBand <= 2.52707 )
							ret := -0.638710
						if( upperBand > 2.52707 )
							ret := -0.325000
					if( Color_con1 > -0.887263 )
						ret := 0.833333 // buy
				if( wvf > 0.00848 )
					if( Color_con2 <= -1.19251 )
						if( Color_con1 <= -1.59914 )
							ret := -0.174803
						if( Color_con1 > -1.59914 )
							ret := -0.515625
					if( Color_con2 > -1.19251 )
						if( Color_con2 <= -1.00577 )
							ret := 0.785714 // buy
						if( Color_con2 > -1.00577 )
							ret := 0.000000
	if( wvf > 0.16025 )
		if( Color_con2 <= -4.10963 )
			if( wvf <= 3.11868 )
				if( lowerBand <= -1.30815 )
					if( sDev <= 8.28487 )
						if( upperBand <= 12.5744 )
							ret := 0.085315
						if( upperBand > 12.5744 )
							ret := 0.683544
					if( sDev > 8.28487 )
				...
				if( lowerBand > 0.752631 )
					...
					if( lowerBand > 2.5738 )
						...
						if( sDev > 2.48145 )
							ret := 0.033835
		if( Color_con2 > -4.10963 )
			if( lowerBand <= 2.34514 )
				if( midLine <= 1.58286 )
					if( upperBand <= 3.02643 )
						if( wvf <= 3.40906 )
							ret := 0.034345
						if( wvf > 3.40906 )
							ret := 0.507042
					if( upperBand > 3.02643 )
						...
						if( colInt > 0.5 )
							ret := 0.053846
				if( midLine > 1.58286 )
					if( Color_con1 <= -6.5724 )
						if( midLine <= 10.3003 )
							ret := 0.531250
						if( midLine > 10.3003 )
							ret := -0.833333 // sell
					if( Color_con1 > -6.5724 )
						if( upperBand <= 18.8994 )
							ret := -0.018211
						if( upperBand > 18.8994 )
							ret := -0.684211
			if( lowerBand > 2.34514 )
				if( sDev <= 3.21961 )
					if( sDev <= 1.13528 )
						if( Color_con2 <= -0.448246 )
							ret := 0.300000
						if( Color_con2 > -0.448246 )
							ret := 0.754098 // buy
					if( sDev > 1.13528 )
						if( Color_con1 <= -5.70785 )
							ret := -0.550725
						if( Color_con1 > -5.70785 )
							ret := 0.058854
				if( sDev > 3.21961 )
					if( lowerBand <= 5.15468 )
						if( wvf <= 13.6361 )
							ret := 0.605042
						if( wvf > 13.6361 )
							ret := -0.090909
...
float op_operation = decision_tree_0_DOCN_15Min_e1475138(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
