				...
				if( VIP <= 1.82604 )
					...
					if( MFI_High > -45.7713 )
						...
						if( VIM > 1.81526 )
							ret := 0.684211
				if( VIP > 1.82604 )
					if( Negative_Money_Flow_Sum <= 2.19452e+07 )
						ret := -0.374169
					if( Negative_Money_Flow_Sum > 2.19452e+07 )
						ret := 1.000000 // buy
	if( Raw_Money_Flow > 770194 )
		if( Typical_Price <= 32.8302 )
			if( VIM <= 0.875075 )
				ret := 0.436464
			if( VIM > 0.875075 )
				if( MFI_High <= -52.5429 )
				...
				if( MFI_High > -52.5429 )
					ret := 0.082312
		if( Typical_Price > 32.8302 )
			if( Positive_Money_Flow_Sum <= 2.37635e+06 )
				if( Negative_Money_Flow_Sum <= 2.37944e+07 )
					ret := 0.273936
				if( Negative_Money_Flow_Sum > 2.37944e+07 )
					ret := -0.789474 // sell
			if( Positive_Money_Flow_Sum > 2.37635e+06 )
...
float op_operation = decision_tree_0_DOCN_5Min_38bc91b9(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
