		...
		if( Short_Long_Diff > 1.5558 )
			if( Negative_Money_Flow_Sum <= 6.10405e+07 )
				...
				if( Raw_Money_Flow > 1.5198e+07 )
					ret := 0.190476
			if( Negative_Money_Flow_Sum > 6.10405e+07 )
				if( Typical_Price <= 84.5131 )
					if( Negative_Money_Flow_Sum <= 7.29543e+07 )
						ret := 0.600000
					if( Negative_Money_Flow_Sum > 7.29543e+07 )
						ret := -0.481013
				if( Typical_Price > 84.5131 )
					if( Negative_Money_Flow_Sum <= 1.03376e+08 )
						if( Short_Long_Diff <= 1.78574 )
							ret := -0.777778 // sell
						if( Short_Long_Diff > 1.78574 )
							ret := 0.484848
					if( Negative_Money_Flow_Sum > 1.03376e+08 )
						ret := 0.892857 // buy
	if( Raw_Money_Flow > 2.19037e+07 )
		if( Negative_Money_Flow_Sum <= 2.46646e+08 )
			if( Positive_Money_Flow_Sum <= 1.21956e+08 )
				if( Negative_Money_Flow_Sum <= 4.56444e+07 )
					ret := -0.407407
				if( Negative_Money_Flow_Sum > 4.56444e+07 )
					if( Positive_Money_Flow_Sum <= 1.06254e+08 )
						ret := 0.051903
					if( Positive_Money_Flow_Sum > 1.06254e+08 )
						ret := 0.743590 // buy
			if( Positive_Money_Flow_Sum > 1.21956e+08 )
				if( Positive_Money_Flow_Sum <= 2.50847e+08 )
					ret := 0.602564
				if( Positive_Money_Flow_Sum > 2.50847e+08 )
					if( Typical_Price <= 73.7546 )
						ret := 0.800000 // buy
					if( Typical_Price > 73.7546 )
						if( Long_MA <= 102.652 )
							ret := -0.631579
...
float op_operation = decision_tree_0_DOCN_1Hour_8c050d06(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
