			...
			if( Negative_Money_Flow_Sum <= 2.18799e+09 )
				if( ema12 <= 7.05491 )
					...
					if( Negative_Money_Flow_Sum > 1.98935e+09 )
						ret := 0.823529 // buy
				if( ema12 > 7.05491 )
					if( Positive_Money_Flow_Sum <= 9.84583e+09 )
						ret := -0.692308
					if( Positive_Money_Flow_Sum > 9.84583e+09 )
						ret := -0.125000
			if( Negative_Money_Flow_Sum > 2.18799e+09 )
				if( Positive_Money_Flow <= 1.02121e+09 )
					if( ema3 <= 224.234 )
						ret := -0.855856 // sell
					if( ema3 > 224.234 )
						ret := 0.250000
...
float op_operation = decision_tree_0_GME_1Day_6f6a8dcb(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
