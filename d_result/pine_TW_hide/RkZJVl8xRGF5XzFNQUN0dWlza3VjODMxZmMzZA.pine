...
float op_operation = decision_tree_0_FFIV_1Day_c831fc3d(macd, macd_IsBelowInt, signal, histB_IsUpInt, macd_IsAboveInt, histB_IsDownInt, histA_IsUpInt, hist, histA_IsDownInt)
