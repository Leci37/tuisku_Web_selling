...
float op_operation = decision_tree_0_SNAP_1Hour_b9e5e6d7(signal, histA_IsDownInt, macd, hist, histA_IsUpInt, histB_IsDownInt, histB_IsUpInt, macd_IsBelowInt, macd_IsAboveInt)
