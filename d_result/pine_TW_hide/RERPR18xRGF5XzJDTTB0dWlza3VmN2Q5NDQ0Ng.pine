...
decision_tree_0_DDOG_1Day_f7d94446(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( mf > 0.037846 )
		if( Positive_Money_Flow_Sum <= 3.77512e+09 )
			if( MFI_High <= -24.8837 )
				if( Typical_Price <= 149.06 )
					if( Raw_Money_Flow <= 1.94403e+08 )
						ret := 0.173913
					if( Raw_Money_Flow > 1.94403e+08 )
						ret := -0.484163
				if( Typical_Price > 149.06 )
					if( Negative_Money_Flow <= 6.0798e+08 )
						ret := 0.714286 // buy
					if( Negative_Money_Flow > 6.0798e+08 )
						ret := 1.000000 // buy
			if( MFI_High > -24.8837 )
				if( Negative_Money_Flow <= 1.6354e+07 )
					if( Raw_Money_Flow <= 1.12846e+08 )
						ret := -0.347826
					if( Raw_Money_Flow > 1.12846e+08 )
						ret := 0.322581
				if( Negative_Money_Flow > 1.6354e+07 )
		...
		if( Positive_Money_Flow_Sum > 3.77512e+09 )
			if( MFI_Low <= 35.0936 )
				if( Typical_Price <= 125.438 )
					ret := 0.692308
				if( Typical_Price > 125.438 )
					ret := 0.083333
			if( MFI_Low > 35.0936 )
				if( Negative_Money_Flow <= 1.28544e+06 )
					if( MFI <= 65.4844 )
						ret := 0.137931
					if( MFI > 65.4844 )
						ret := -0.409091
				if( Negative_Money_Flow > 1.28544e+06 )
					if( Typical_Price <= 104.163 )
						ret := 0.055556
					if( Typical_Price > 104.163 )
						ret := -0.849315 // sell
...
float op_operation = decision_tree_0_DDOG_1Day_f7d94446(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
