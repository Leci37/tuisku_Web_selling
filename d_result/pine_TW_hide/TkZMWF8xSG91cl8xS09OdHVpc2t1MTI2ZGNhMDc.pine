				...
				if( stoc > 94.7484 )
					if( pvimax <= 1.01774 )
						...
						if( nvimin > -0.187565 )
							ret := -1.000000 // sell
					if( pvimax > 1.01774 )
						if( azul_mean <= 14.8651 )
							ret := -0.555556
						if( azul_mean > 14.8651 )
							ret := 0.000000
	if( nvim > -0.124389 )
		if( azul_mean <= 15.3172 )
			if( pvi_ema <= -0.260602 )
				if( xrsi <= 42.6106 )
					if( nvimax <= -0.002398 )
						if( azul_mean <= -28.6463 )
							ret := -0.785714 // sell
						if( azul_mean > -28.6463 )
							ret := 0.753247 // buy
					if( nvimax > -0.002398 )
						...
						if( pvi > -0.405781 )
							ret := -0.374384
				if( xrsi > 42.6106 )
					if( media_azul <= 107.376 )
						if( verde_mean <= 117.912 )
							ret := 0.332268
						if( verde_mean > 117.912 )
							ret := 0.807143 // buy
					if( media_azul > 107.376 )
...
float op_operation = decision_tree_0_NFLX_1Hour_126dca07(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
