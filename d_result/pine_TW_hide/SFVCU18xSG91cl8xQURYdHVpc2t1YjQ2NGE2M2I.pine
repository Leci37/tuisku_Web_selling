...
decision_tree_0_HUBS_1Hour_b464a63b(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)=>
			...
			if( adx <= 17.0746 )
				...
				if( diPlus > 22.5259 )
					...
					if( trueRange > 5.25629 )
						ret := -0.250000
			if( adx > 17.0746 )
				if( smoothedDirectionalMovementMinus <= 9.06879 )
					if( adx <= 32.9624 )
						if( trueRange <= 9.79728 )
							ret := -0.177665
						if( trueRange > 9.79728 )
							ret := 0.204040
					if( adx > 32.9624 )
	...
	if( smoothedDirectionalMovementPlus > 3.50905 )
		if( dx <= 87.4996 )
			if( diMinus <= 39.1823 )
				if( smoothedTrueRange <= 10.2803 )
					if( directionalMovementMinus <= 1.29972 )
						ret := -0.633745
					if( directionalMovementMinus > 1.29972 )
						if( adx <= 30.6331 )
							ret := 0.612903
						if( adx > 30.6331 )
							ret := -0.533333
				if( smoothedTrueRange > 10.2803 )
					if( directionalMovementMinus <= 16.095 )
						if( directionalMovementMinus <= 8.35969 )
							ret := -0.150424
						if( directionalMovementMinus > 8.35969 )
							ret := 0.740741 // buy
					if( directionalMovementMinus > 16.095 )
...
float op_operation = decision_tree_0_HUBS_1Hour_b464a63b(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
