	...
	if( Lower_Band <= 4022.72 )
		...
		if( Upper_Band > 4192.46 )
			if( Upper_Band <= 4317.39 )
				if( bbm <= 112.982 )
					if( bbp <= 64.3221 )
						if( Lower_Band <= 3926.45 )
							ret := 0.915254 // buy
						if( Lower_Band > 3926.45 )
							ret := 0.500000
					if( bbp > 64.3221 )
						if( bearPower <= 29.0156 )
							ret := 0.000000
						if( bearPower > 29.0156 )
							ret := 0.611111
				if( bbm > 112.982 )
					if( basis <= 4089.66 )
						if( bullPower <= -9.92216 )
							ret := 0.500000
						if( bullPower > -9.92216 )
							ret := -0.928571 // sell
					if( basis > 4089.66 )
						ret := 0.857143 // buy
			if( Upper_Band > 4317.39 )
				if( Lower_Band <= 3994.47 )
					if( bullPower <= 5.32618 )
						if( Lower_Band <= 3859.52 )
							ret := 0.888889 // buy
						if( Lower_Band > 3859.52 )
							ret := 0.192308
					if( bullPower > 5.32618 )
				...
				if( Lower_Band > 3994.47 )
					ret := -1.000000 // sell
	if( Lower_Band > 4022.72 )
		if( Upper_Band <= 4180.21 )
			if( Upper_Band <= 4103.2 )
				ret := 0.000000
			if( Upper_Band > 4103.2 )
				if( bullPower <= 5.49558 )
					if( bbp <= -66.0627 )
						ret := -0.600000
					if( bbp > -66.0627 )
						ret := -0.100000
				if( bullPower > 5.49558 )
					...
					if( bbm > 46.3848 )
						ret := -0.636364
		if( Upper_Band > 4180.21 )
			if( bullPower <= 33.7404 )
				if( bullPower <= -73.5629 )
					if( basis <= 4451.65 )
						ret := -0.222222
					if( basis > 4451.65 )
						if( Upper_Band <= 4747.36 )
							ret := -0.833333 // sell
						if( Upper_Band > 4747.36 )
							ret := -1.000000 // sell
				if( bullPower > -73.5629 )
			...
			if( bullPower > 33.7404 )
				if( basis <= 4261.96 )
					if( bullPower <= 43.7645 )
						if( basis <= 4144.04 )
							ret := 0.263158
						if( basis > 4144.04 )
							ret := -0.560000
					if( bullPower > 43.7645 )
						if( Upper_Band <= 4401.57 )
							ret := -0.872881 // sell
						if( Upper_Band > 4401.57 )
							ret := -0.611111
				if( basis > 4261.96 )
					if( Lower_Band <= 4415.08 )
						if( Lower_Band <= 4293.6 )
							ret := -0.185393
						if( Lower_Band > 4293.6 )
							ret := 0.780488 // buy
					if( Lower_Band > 4415.08 )
...
float op_operation = decision_tree_0_ETHUSDT_1Hour_85890413(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
