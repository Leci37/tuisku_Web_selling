				...
				if( BBupper <= 129.876 )
					...
					if( BBupper > 107.369 )
						...
						if( vrsi > 33.4167 )
							ret := 0.625000
				if( BBupper > 129.876 )
					if( dif_source_BBupper <= -40.7032 )
						if( dif_source_BBlower <= 10.8108 )
							ret := 0.371429
						if( dif_source_BBlower > 10.8108 )
							ret := 1.000000 // buy
					if( dif_source_BBupper > -40.7032 )
	...
	if( dif_source_BBupper > -3.25027 )
		if( BBlower <= 47.1475 )
			if( dif_source_BBlower <= 12.6054 )
				...
				if( BBlower > 39.2681 )
					if( BBupper <= 52.4629 )
						if( dif_source_BBlower <= 3.38523 )
							ret := -0.264151
						if( dif_source_BBlower > 3.38523 )
							ret := -0.677419
					if( BBupper > 52.4629 )
						if( dif_source_BBlower <= 10.024 )
							ret := -0.440000
						if( dif_source_BBlower > 10.024 )
							ret := 0.244444
			if( dif_source_BBlower > 12.6054 )
				if( vrsi <= 56.0245 )
					if( dif_source_BBlower <= 13.5567 )
						if( BBupper <= 41.5155 )
							ret := 0.055556
						if( BBupper > 41.5155 )
							ret := -0.604651
		...
		if( BBlower > 47.1475 )
			if( BBupper <= 88.1793 )
				if( vrsi <= 90.3631 )
					if( dif_source_BBupper <= 0.873718 )
						if( dif_source_BBlower <= 12.8589 )
							ret := 0.184332
						if( dif_source_BBlower > 12.8589 )
							ret := 0.506452
					if( dif_source_BBupper > 0.873718 )
			...
			if( BBupper > 88.1793 )
				if( BBlower <= 74.6375 )
					...
					if( dif_source_BBupper > 1.41898 )
						ret := 0.000000
				if( BBlower > 74.6375 )
					if( dif_source_BBupper <= 2.4707 )
						if( dif_source_BBlower <= 8.68577 )
							ret := -0.550000
						if( dif_source_BBlower > 8.68577 )
							ret := 0.059896
					if( dif_source_BBupper > 2.4707 )
						if( dif_source_BBupper <= 3.77723 )
							ret := -0.960000 // sell
						if( dif_source_BBupper > 3.77723 )
							ret := -0.333333
...
float op_operation = decision_tree_0_DOCN_30Min_81813fe4(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
