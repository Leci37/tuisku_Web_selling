	...
	if( ema12 > -0.964755 )
		if( Money_Flow_Ratio <= 1118.12 )
			...
			if( ema13 > -1.32752 )
				if( ema12 <= -0.672962 )
					if( tema <= 79.0895 )
						if( Raw_Money_Flow <= 2.52259e+06 )
							ret := 0.909091 // buy
						if( Raw_Money_Flow > 2.52259e+06 )
							ret := 0.096296
					if( tema > 79.0895 )
						if( Raw_Money_Flow <= 8.08017e+06 )
							ret := -0.703390 // sell
						if( Raw_Money_Flow > 8.08017e+06 )
							ret := -0.171429
				if( ema12 > -0.672962 )
					if( Negative_Money_Flow_Sum <= 1.5425e+09 )
						...
						if( MFI_Low > 79.6597 )
							ret := -0.280822
					if( Negative_Money_Flow_Sum > 1.5425e+09 )
						if( Negative_Money_Flow_Sum <= 1.97265e+09 )
							ret := -0.109890
						if( Negative_Money_Flow_Sum > 1.97265e+09 )
							ret := -0.003354
		if( Money_Flow_Ratio > 1118.12 )
			if( Raw_Money_Flow <= 1.18848e+09 )
				if( MFI_Low <= 79.9704 )
					ret := 0.905405 // buy
				if( MFI_Low > 79.9704 )
					ret := 0.351351
...
float op_operation = decision_tree_0_AMD_1Hour_b685adcd(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
