			...
			if( Typical_Price > 2605.79 )
				...
				if( Negative_Money_Flow > 1.40842e+09 )
					...
					if( Typical_Price > 2815.87 )
						ret := 0.400000
	if( rsi1 > 45.1121 )
		if( Positive_Money_Flow_Sum <= 3.6118e+10 )
			if( Typical_Price <= 147.873 )
				if( d <= 57.3629 )
					ret := 0.000000
				if( d > 57.3629 )
					if( smoothK_k <= 93.4206 )
						ret := 0.873684 // buy
					if( smoothK_k > 93.4206 )
						ret := 0.333333
			if( Typical_Price > 147.873 )
				if( Raw_Money_Flow <= 1.85641e+09 )
					if( Typical_Price <= 2092.13 )
						ret := 0.137713
					if( Typical_Price > 2092.13 )
						ret := -0.200913
				if( Raw_Money_Flow > 1.85641e+09 )
					if( Typical_Price <= 3076.15 )
						ret := 0.646341
					if( Typical_Price > 3076.15 )
						ret := -0.066667
		if( Positive_Money_Flow_Sum > 3.6118e+10 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_ea2a5469(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
