	...
	if( Negative_Money_Flow_Sum <= 9.1067e+09 )
		...
		if( Negative_Money_Flow_Sum > 4.06771e+09 )
			...
			if( Typical_Price > 153.925 )
				...
				if( Positive_Money_Flow_Sum > 2.86457e+09 )
					if( MFI_Low <= 19.4846 )
						if( Raw_Money_Flow <= 7.89028e+06 )
							ret := -0.658793
						if( Raw_Money_Flow > 7.89028e+06 )
							ret := -0.267071
					if( MFI_Low > 19.4846 )
						if( Money_Flow_Ratio <= 0.883613 )
							ret := 0.078835
						if( Money_Flow_Ratio > 0.883613 )
							ret := -0.209111
	if( Negative_Money_Flow_Sum > 9.1067e+09 )
		if( bbp <= -5.12369 )
			if( Positive_Money_Flow <= 2.78746e+09 )
				if( Positive_Money_Flow_Sum <= 2.1677e+07 )
					ret := -0.133333
				if( Positive_Money_Flow_Sum > 2.1677e+07 )
					ret := 0.666667
			if( Positive_Money_Flow > 2.78746e+09 )
				ret := -0.909091 // sell
		if( bbp > -5.12369 )
			if( Positive_Money_Flow_Sum <= 7.24029e+09 )
				if( Negative_Money_Flow_Sum <= 9.29008e+09 )
					ret := 0.712329 // buy
				if( Negative_Money_Flow_Sum > 9.29008e+09 )
					if( bbp <= 0.459909 )
						if( Raw_Money_Flow <= 7.25708e+06 )
							ret := -0.462810
						if( Raw_Money_Flow > 7.25708e+06 )
							ret := 0.041801
					if( bbp > 0.459909 )
						if( Money_Flow_Ratio <= 0.119278 )
							ret := -0.909091 // sell
						if( Money_Flow_Ratio > 0.119278 )
							ret := 0.629630
			if( Positive_Money_Flow_Sum > 7.24029e+09 )
...
float op_operation = decision_tree_0_MSFT_1Hour_4c9ee6e2(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
