...
decision_tree_0_RIVN_1Hour_975ce558(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( MFI <= 46.8797 )
		...
		if( Negative_Money_Flow_Sum > 7.61541e+08 )
			if( ema3 <= 118.829 )
				if( ema3 <= 55.063 )
					if( ema13 <= -3.27341 )
						ret := 1.000000 // buy
					if( ema13 > -3.27341 )
						if( Negative_Money_Flow_Sum <= 2.18514e+09 )
							ret := -0.185383
						if( Negative_Money_Flow_Sum > 2.18514e+09 )
							ret := -0.701493 // sell
				if( ema3 > 55.063 )
			...
			if( ema3 > 118.829 )
				if( ema2 <= 162.996 )
					if( Typical_Price <= 152.691 )
						if( MFI_High <= -63.0392 )
							ret := 0.875000 // buy
						if( MFI_High > -63.0392 )
							ret := -0.287879
					if( Typical_Price > 152.691 )
						if( Raw_Money_Flow <= 4.86443e+08 )
							ret := 0.000000
						if( Raw_Money_Flow > 4.86443e+08 )
							ret := 1.000000 // buy
				if( ema2 > 162.996 )
	...
	if( MFI > 46.8797 )
		if( ema13 <= 7.90518 )
			if( ema3 <= 128.579 )
				if( Negative_Money_Flow_Sum <= 5.95487e+08 )
					if( ema2 <= 40.0534 )
						if( MFI_High <= 6.91066 )
							ret := 0.059792
						if( MFI_High > 6.91066 )
				...
				if( Negative_Money_Flow_Sum > 5.95487e+08 )
					...
					if( ema12 > 1.00932 )
						...
						if( tema > 68.6457 )
							ret := -0.296296
			if( ema3 > 128.579 )
				if( Positive_Money_Flow <= 8.17122e+08 )
					if( Money_Flow_Ratio <= 0.964384 )
						ret := 0.000000
					if( Money_Flow_Ratio > 0.964384 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow > 8.17122e+08 )
...
float op_operation = decision_tree_0_RIVN_1Hour_975ce558(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
