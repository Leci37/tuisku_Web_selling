	...
	if( dif_source_BBlower > -0.52506 )
		if( dif_source_BBupper <= -70.9038 )
			...
			if( BBlower > 63.8528 )
				ret := 0.285714
		if( dif_source_BBupper > -70.9038 )
			if( dif_source_BBupper <= -58.9274 )
				if( dif_source_BBupper <= -64.5136 )
					ret := 0.055556
				if( dif_source_BBupper > -64.5136 )
					if( BBupper <= 154.462 )
						if( BBlower <= 52.6264 )
					...
					if( BBupper > 154.462 )
						ret := -0.400000
			if( dif_source_BBupper > -58.9274 )
				if( dif_source_BBupper <= -22.8824 )
					if( dif_source_BBlower <= 7.02438 )
						if( BBupper <= 84.7176 )
							ret := -0.134111
						if( BBupper > 84.7176 )
							ret := 0.431193
					if( dif_source_BBlower > 7.02438 )
						if( dif_source_BBupper <= -38.1979 )
							ret := 0.151899
						if( dif_source_BBupper > -38.1979 )
							ret := 0.706215 // buy
				if( dif_source_BBupper > -22.8824 )
...
float op_operation = decision_tree_0_ASAN_1Hour_960a637a(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
