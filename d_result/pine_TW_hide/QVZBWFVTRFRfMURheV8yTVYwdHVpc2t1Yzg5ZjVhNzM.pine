...
decision_tree_0_AVAXUSDT_1Day_c89f5a73(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)=>
	...
	if( Typical_Price > 22.9381 )
		if( Raw_Money_Flow <= 2.469e+08 )
			...
			if( MFI > 36.1082 )
				if( VIM <= 0.857896 )
					if( Negative_Money_Flow_Sum <= 8.34132e+07 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow_Sum > 8.34132e+07 )
						ret := -0.709677 // sell
				if( VIM > 0.857896 )
					...
					if( MFI > 68.4465 )
						ret := 0.660714
		if( Raw_Money_Flow > 2.469e+08 )
			if( Typical_Price <= 108.75 )
				if( MFI <= 30.1458 )
					if( Negative_Money_Flow_Sum <= 2.10164e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 2.10164e+09 )
						ret := 1.000000 // buy
				if( MFI > 30.1458 )
			...
			if( Typical_Price > 108.75 )
				if( VIP <= 1.13853 )
					if( Positive_Money_Flow <= 4.38404e+08 )
						ret := -1.000000 // sell
					if( Positive_Money_Flow > 4.38404e+08 )
						ret := 0.000000
				if( VIP > 1.13853 )
					if( Positive_Money_Flow <= 5.99917e+08 )
						ret := 0.000000
					if( Positive_Money_Flow > 5.99917e+08 )
						ret := -0.800000 // sell
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_c89f5a73(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
