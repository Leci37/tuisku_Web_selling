...
decision_tree_0_AAPL_30Min_965d9656(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)=>
	...
	if( chinkou_span <= 223.959 )
		...
		if( tenkan_sen > 220.984 )
			ret := -0.474503
	if( chinkou_span > 223.959 )
		if( senkou_span_a_displaced <= 220.874 )
			ret := 0.605042
		if( senkou_span_a_displaced > 220.874 )
			if( basis_minus <= -5.17347 )
				if( basis_max <= 2.99211 )
					ret := 0.649596
				if( basis_max > 2.99211 )
					if( basis_max <= 3.97532 )
						ret := -0.428571
					if( basis_max > 3.97532 )
						ret := 0.738095 // buy
			if( basis_minus > -5.17347 )
				if( chinkou_span <= 321.488 )
					if( senkou_span_b <= 318.889 )
						if( tenkan_sen <= 226.174 )
							if( senkou_span_b_displaced <= 221 )
								ret := -0.273973
							if( senkou_span_b_displaced > 221 )
								ret := 0.441130
						if( tenkan_sen > 226.174 )
					...
					if( senkou_span_b > 318.889 )
						ret := -0.517241
				if( chinkou_span > 321.488 )
					if( tenkan_sen <= 505.51 )
						if( senkou_span_b <= 340.262 )
							ret := 0.465879
						if( senkou_span_b > 340.262 )
							if( basis_max <= -2.76018 )
								ret := 0.682243
							if( basis_max > -2.76018 )
								ret := 0.106250
					if( tenkan_sen > 505.51 )
...
float op_operation = decision_tree_0_AAPL_30Min_965d9656(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
