			...
			if( BBupper > 211.133 )
				if( vrsi <= 71.6015 )
					...
					if( BBlower > 290.375 )
						ret := 0.129032
				if( vrsi > 71.6015 )
					if( dif_source_BBlower <= 32.1388 )
						ret := -0.714286 // sell
					if( dif_source_BBlower > 32.1388 )
						ret := 0.529412
		if( dif_source_BBupper > -60.6984 )
			if( BBupper <= 388.424 )
				if( dif_source_BBlower <= 23.6287 )
					if( BBupper <= 192.935 )
						ret := 0.128205
					if( BBupper > 192.935 )
						ret := -0.540000
				if( dif_source_BBlower > 23.6287 )
					if( dif_source_BBlower <= 240.273 )
						ret := 0.130518
					if( dif_source_BBlower > 240.273 )
						ret := -0.829787 // sell
			if( BBupper > 388.424 )
				if( dif_source_BBlower <= 166.492 )
					if( dif_source_BBlower <= 89.5473 )
						ret := 0.000000
					if( dif_source_BBlower > 89.5473 )
						ret := -0.910256 // sell
				if( dif_source_BBlower > 166.492 )
...
float op_operation = decision_tree_0_META_1Day_c7fa7b2e(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
