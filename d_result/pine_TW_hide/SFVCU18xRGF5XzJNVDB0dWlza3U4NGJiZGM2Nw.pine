		...
		if( ema12 <= -3.17417 )
			if( MFI_High <= -42.0042 )
				if( Negative_Money_Flow_Sum <= 4.60044e+09 )
					if( Positive_Money_Flow_Sum <= 1.77692e+09 )
						ret := -0.222222
					if( Positive_Money_Flow_Sum > 1.77692e+09 )
						ret := -0.920000 // sell
				if( Negative_Money_Flow_Sum > 4.60044e+09 )
					if( Raw_Money_Flow <= 5.93969e+08 )
						ret := -0.578947
					if( Raw_Money_Flow > 5.93969e+08 )
						ret := 0.307692
			if( MFI_High > -42.0042 )
				if( ema12 <= -8.1837 )
					if( Negative_Money_Flow_Sum <= 2.95756e+09 )
						ret := 0.862069 // buy
					if( Negative_Money_Flow_Sum > 2.95756e+09 )
						ret := -0.200000
				if( ema12 > -8.1837 )
					...
					if( ema3 > 719.1 )
						ret := -1.000000 // sell
		if( ema12 > -3.17417 )
			if( Negative_Money_Flow_Sum <= 1.4876e+09 )
				if( ema13 <= 33.6654 )
					if( ema12 <= 9.0806 )
						ret := 0.125000
					if( ema12 > 9.0806 )
						ret := -0.183673
				if( ema13 > 33.6654 )
					if( Positive_Money_Flow <= 1.62896e+08 )
						ret := -0.807692 // sell
					if( Positive_Money_Flow > 1.62896e+08 )
						ret := -0.100000
			if( Negative_Money_Flow_Sum > 1.4876e+09 )
...
float op_operation = decision_tree_0_HUBS_1Day_84bbdc67(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
