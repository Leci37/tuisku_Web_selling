			...
			if( basis <= 38.4954 )
				if( Upper_Band <= 33.3081 )
					...
					if( basis > 24.0569 )
						ret := 0.373134
				if( Upper_Band > 33.3081 )
					if( Lower_Band <= 28.7587 )
						ret := -0.418440
					if( Lower_Band > 28.7587 )
						ret := -0.774725 // sell
			if( basis > 38.4954 )
				if( basis <= 39.4618 )
					if( bullPower <= 1.51506 )
						ret := 0.904762 // buy
					if( bullPower > 1.51506 )
						ret := 0.545455
				if( basis > 39.4618 )
					...
					if( bbm > 2.48475 )
						ret := -0.346667
		if( bbp > 5.42932 )
			if( Upper_Band <= 49.9935 )
				if( Lower_Band <= 29.3884 )
					if( basis <= 24.1148 )
						ret := 0.833333 // buy
					if( basis > 24.1148 )
						ret := -0.050000
			...
			if( Upper_Band > 49.9935 )
				if( bbp <= 5.87995 )
					if( Lower_Band <= 57.3964 )
						ret := -0.090909
					if( Lower_Band > 57.3964 )
						ret := 1.000000 // buy
				if( bbp > 5.87995 )
					if( bullPower <= 5.54582 )
						ret := -0.085714
					if( bullPower > 5.54582 )
						ret := -0.533333
...
float op_operation = decision_tree_0_UBER_1Day_e5016684(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
