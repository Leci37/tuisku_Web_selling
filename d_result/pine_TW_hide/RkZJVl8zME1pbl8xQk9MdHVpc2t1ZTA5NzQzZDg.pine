...
decision_tree_0_FFIV_30Min_e09743d8(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower > 86.2462 )
		if( BBupper <= 151.309 )
			if( dif_source_BBlower <= 30.8949 )
				if( BBlower <= 143.637 )
					if( dif_source_BBlower <= -4.41753 )
						if( BBlower <= 131.759 )
							ret := 0.835821 // buy
						if( BBlower > 131.759 )
							ret := -0.136364
					if( dif_source_BBlower > -4.41753 )
						if( dif_source_BBupper <= -21.3958 )
							ret := -0.417062
						if( dif_source_BBupper > -21.3958 )
							ret := 0.042509
				if( BBlower > 143.637 )
					if( dif_source_BBlower <= 5.01087 )
						if( dif_source_BBlower <= -1.06351 )
							ret := 0.000000
						if( dif_source_BBlower > -1.06351 )
							ret := -0.941176 // sell
					if( dif_source_BBlower > 5.01087 )
				...
				if( BBlower > 140.667 )
					if( BBlower <= 142.922 )
						...
						if( vrsi > 5.41826 )
							ret := 0.366843
					if( BBlower > 142.922 )
						if( dif_source_BBupper <= -53.1913 )
							ret := 0.716049 // buy
						if( dif_source_BBupper > -53.1913 )
							ret := 0.010642
			if( vrsi > 59.525 )
				if( dif_source_BBlower <= 2.50598 )
					if( BBlower <= 154.27 )
						if( dif_source_BBupper <= -21.012 )
							ret := 0.700000 // buy
						if( dif_source_BBupper > -21.012 )
							ret := 0.237500
					if( BBlower > 154.27 )
						...
						if( BBupper > 216.335 )
							ret := 0.590476
				if( dif_source_BBlower > 2.50598 )
					if( dif_source_BBupper <= -6.44761 )
						if( dif_source_BBupper <= -49.5074 )
							ret := 0.625000
						if( dif_source_BBupper > -49.5074 )
							ret := -0.217040
					if( dif_source_BBupper > -6.44761 )
...
float op_operation = decision_tree_0_FFIV_30Min_e09743d8(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
