			...
			if( BBupper <= 434.687 )
				...
				if( BBlower > 233.849 )
					...
					if( BBupper > 426.415 )
						ret := 0.571429
			if( BBupper > 434.687 )
				if( dif_source_BBlower <= -19.1659 )
					ret := 1.000000 // buy
				if( dif_source_BBlower > -19.1659 )
					if( dif_source_BBlower <= -14.359 )
						ret := -0.200000
					if( dif_source_BBlower > -14.359 )
						ret := -0.951220 // sell
		if( vrsi > 33.3558 )
			if( vrsi <= 74.5425 )
				if( BBupper <= 445.881 )
					...
					if( BBlower > 216.428 )
						ret := -0.491935
				if( BBupper > 445.881 )
					if( dif_source_BBupper <= -293.692 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > -293.692 )
						ret := -0.750000 // sell
			if( vrsi > 74.5425 )
				if( BBupper <= 432.132 )
					if( dif_source_BBupper <= -86.4039 )
						ret := 1.000000 // buy
					if( dif_source_BBupper > -86.4039 )
						ret := 0.040000
				if( BBupper > 432.132 )
...
float op_operation = decision_tree_0_TWLO_1Day_1628fa1d(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
