			...
			if( ema13 <= 2.44129 )
				if( bbm <= 0.97736 )
					...
					if( ema13 > 2.14628 )
						ret := -0.846154 // sell
				if( bbm > 0.97736 )
					if( bearPower <= -1.49404 )
						if( bbm <= 1.655 )
							ret := 1.000000 // buy
						if( bbm > 1.655 )
							ret := 0.250000
					if( bearPower > -1.49404 )
						if( bullPower <= -0.199154 )
							ret := -0.777778 // sell
						if( bullPower > -0.199154 )
							ret := 0.088983
			if( ema13 > 2.44129 )
...
float op_operation = decision_tree_0_FFIV_30Min_612611b7(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
