		...
		if( Positive_Money_Flow_Sum <= 1.4025e+11 )
			if( Negative_Money_Flow_Sum <= 1.40395e+11 )
				if( Positive_Money_Flow_Sum <= 9.84993e+10 )
					if( Negative_Money_Flow <= 1.72871e+10 )
						ret := -0.186695
					if( Negative_Money_Flow > 1.72871e+10 )
						ret := -0.866667 // sell
				if( Positive_Money_Flow_Sum > 9.84993e+10 )
					...
					if( Long_MA > 3161.21 )
						ret := -0.402439
			if( Negative_Money_Flow_Sum > 1.40395e+11 )
				if( Positive_Money_Flow <= 1.23573e+10 )
					if( Short_Long_Diff <= -205.77 )
						ret := -0.428571
					if( Short_Long_Diff > -205.77 )
						ret := 0.831169 // buy
				if( Positive_Money_Flow > 1.23573e+10 )
					...
					if( Short_MA > 3165.96 )
						ret := -1.000000 // sell
		if( Positive_Money_Flow_Sum > 1.4025e+11 )
			if( Typical_Price <= 3136.08 )
				if( Positive_Money_Flow_Sum <= 1.60085e+11 )
					if( Negative_Money_Flow_Sum <= 6.95728e+10 )
						ret := 0.428571
					if( Negative_Money_Flow_Sum > 6.95728e+10 )
						ret := 0.000000
				if( Positive_Money_Flow_Sum > 1.60085e+11 )
...
float op_operation = decision_tree_0_AMZN_1Day_51685a73(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
