			...
			if( Negative_Money_Flow_Sum <= 6.20131e+08 )
				...
				if( Positive_Money_Flow_Sum > 1.45195e+09 )
					...
					if( Positive_Money_Flow > 3.28658e+08 )
						ret := 0.000000
			if( Negative_Money_Flow_Sum > 6.20131e+08 )
				if( Negative_Money_Flow_Sum <= 9.58675e+08 )
					if( Raw_Money_Flow <= 4.47904e+07 )
						ret := -0.260870
					if( Raw_Money_Flow > 4.47904e+07 )
						ret := 0.603376
				if( Negative_Money_Flow_Sum > 9.58675e+08 )
					if( Negative_Money_Flow <= 1.52864e+08 )
						ret := -0.171429
					if( Negative_Money_Flow > 1.52864e+08 )
						ret := 0.394366
		if( Positive_Money_Flow_Sum > 4.16064e+09 )
			if( Positive_Money_Flow <= 8.21018e+08 )
				if( MFI_Low <= 65.1337 )
					ret := -1.000000 // sell
				if( MFI_Low > 65.1337 )
					ret := -0.750000 // sell
...
float op_operation = decision_tree_0_LTCUSDT_1Day_569c1d6e(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
