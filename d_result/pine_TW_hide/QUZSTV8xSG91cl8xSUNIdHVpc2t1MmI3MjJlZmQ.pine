	...
	if( senkou_span_b > 17.8355 )
		if( chinkou_span <= 18.68 )
			...
			if( kinjun_sen > 18.8861 )
				ret := -0.689531
		if( chinkou_span > 18.68 )
			if( tenkan_sen <= 21.4983 )
				if( chinkou_span <= 20.7225 )
					if( tenkan_sen <= 17.8849 )
						ret := 0.786517 // buy
					if( tenkan_sen > 17.8849 )
						...
						if( basis_max > 0.007436 )
							ret := 0.204013
				if( chinkou_span > 20.7225 )
					if( basis_minus <= -3.08669 )
						ret := -0.562500
					if( basis_minus > -3.08669 )
						ret := 0.647191
			if( tenkan_sen > 21.4983 )
				if( senkou_span_a_displaced <= 120.363 )
					if( chinkou_span <= 23.5543 )
						if( senkou_span_b <= 23.6567 )
							ret := -0.180247
						if( senkou_span_b > 23.6567 )
							ret := -0.563830
					if( chinkou_span > 23.5543 )
						if( tenkan_sen <= 24.8289 )
							ret := 0.456172
						if( tenkan_sen > 24.8289 )
							ret := -0.015253
				if( senkou_span_a_displaced > 120.363 )
					if( senkou_span_b_displaced <= 133.965 )
						if( chinkou_span <= 130.397 )
							ret := -0.658120
						if( chinkou_span > 130.397 )
							ret := 0.238095
					if( senkou_span_b_displaced > 133.965 )
...
float op_operation = decision_tree_0_AFRM_1Hour_2b722efd(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
