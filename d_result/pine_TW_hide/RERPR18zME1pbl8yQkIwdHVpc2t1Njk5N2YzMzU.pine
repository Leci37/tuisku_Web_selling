		...
		if( Upper_Band > 95.7338 )
			if( basis <= 193.615 )
				if( bearPower <= -6.28125 )
					if( Lower_Band <= 155.475 )
						ret := 0.631579
					if( Lower_Band > 155.475 )
						ret := -0.291667
				if( bearPower > -6.28125 )
					if( Upper_Band <= 99.6049 )
						if( Upper_Band <= 98.7553 )
							ret := -0.093501
						if( Upper_Band > 98.7553 )
							ret := -0.308257
					if( Upper_Band > 99.6049 )
						if( bullPower <= 1.73813 )
							ret := -0.019768
						if( bullPower > 1.73813 )
							ret := 0.253700
			if( basis > 193.615 )
				ret := -0.817073 // sell
	if( bbp > 2.11043 )
		if( Lower_Band <= 157.77 )
			if( bbp <= 6.48859 )
				if( Upper_Band <= 32.2261 )
					ret := 1.000000 // buy
				if( Upper_Band > 32.2261 )
					if( Upper_Band <= 43.3876 )
						ret := -0.621849
					if( Upper_Band > 43.3876 )
						if( bearPower <= 2.62823 )
							ret := -0.157985
						if( bearPower > 2.62823 )
							ret := 0.489362
			if( bbp > 6.48859 )
...
float op_operation = decision_tree_0_DDOG_30Min_6997f335(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
