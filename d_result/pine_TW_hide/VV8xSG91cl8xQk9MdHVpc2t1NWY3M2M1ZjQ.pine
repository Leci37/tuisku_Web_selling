...
decision_tree_0_U_1Hour_5f73c5f4(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)=>
	...
	if( BBlower <= 31.6357 )
		...
		if( dif_source_BBupper > -10.7268 )
			if( dif_source_BBlower <= -0.670925 )
				...
				if( dif_source_BBupper > -8.66328 )
					if( BBlower <= 24.0383 )
						if( dif_source_BBlower <= -0.848433 )
							ret := 1.000000 // buy
						if( dif_source_BBlower > -0.848433 )
							ret := 0.750000 // buy
					if( BBlower > 24.0383 )
						if( dif_source_BBlower <= -0.834716 )
							ret := 0.818182 // buy
						if( dif_source_BBlower > -0.834716 )
							ret := 0.357143
			if( dif_source_BBlower > -0.670925 )
				if( dif_source_BBupper <= -1.18885 )
					if( BBlower <= 25.0106 )
						if( vrsi <= 67.8593 )
							ret := 0.096591
						if( vrsi > 67.8593 )
	...
	if( BBlower > 31.6357 )
		if( BBlower <= 69.4593 )
			if( BBlower <= 39.6992 )
				if( dif_source_BBlower <= 9.33306 )
					if( dif_source_BBupper <= -13.5459 )
						if( BBupper <= 47.8901 )
							ret := 0.313433
						if( BBupper > 47.8901 )
							ret := 0.870370 // buy
					if( dif_source_BBupper > -13.5459 )
						if( dif_source_BBupper <= -1.39516 )
							ret := -0.113112
						if( dif_source_BBupper > -1.39516 )
							ret := 0.191176
				if( dif_source_BBlower > 9.33306 )
					if( dif_source_BBupper <= 0.302776 )
						if( vrsi <= 21.0829 )
							ret := 0.176471
						if( vrsi > 21.0829 )
							ret := -0.589372
					if( dif_source_BBupper > 0.302776 )
						if( dif_source_BBlower <= 10.6905 )
							ret := -0.368421
						if( dif_source_BBlower > 10.6905 )
							ret := 0.129032
			if( BBlower > 39.6992 )
				...
				if( dif_source_BBupper > -29.6069 )
					...
					if( BBupper > 98.4209 )
						...
						if( BBlower > 92.4823 )
							ret := 0.228733
			if( BBlower > 95.411 )
				if( dif_source_BBupper <= -20.3998 )
					if( BBupper <= 155.095 )
						if( dif_source_BBlower <= -3.63598 )
							ret := 0.600000
						if( dif_source_BBlower > -3.63598 )
							ret := -0.478056
					if( BBupper > 155.095 )
...
float op_operation = decision_tree_0_U_1Hour_5f73c5f4(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
