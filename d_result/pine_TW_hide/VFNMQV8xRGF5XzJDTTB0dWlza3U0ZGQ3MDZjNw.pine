			...
			if( Negative_Money_Flow_Sum > 6.88953e+10 )
				...
				if( MFI > 78.2 )
					...
					if( ad > 1.95346e+07 )
						ret := 0.142857
	if( Negative_Money_Flow_Sum > 9.22432e+10 )
		if( Typical_Price <= 847.535 )
			if( Positive_Money_Flow_Sum <= 6.14549e+10 )
				if( Negative_Money_Flow <= 2.38556e+10 )
					if( Typical_Price <= 181.693 )
						ret := -1.000000 // sell
					if( Typical_Price > 181.693 )
						ret := -0.646154
				if( Negative_Money_Flow > 2.38556e+10 )
					if( Money_Flow_Ratio <= 0.066707 )
						ret := -0.666667
					if( Money_Flow_Ratio > 0.066707 )
						ret := 0.800000 // buy
			if( Positive_Money_Flow_Sum > 6.14549e+10 )
				if( Money_Flow_Ratio <= 0.366601 )
					if( Negative_Money_Flow_Sum <= 2.85661e+11 )
						ret := 0.694444
					if( Negative_Money_Flow_Sum > 2.85661e+11 )
						ret := 1.000000 // buy
				if( Money_Flow_Ratio > 0.366601 )
					if( Positive_Money_Flow_Sum <= 4.28808e+11 )
						ret := -0.092823
					if( Positive_Money_Flow_Sum > 4.28808e+11 )
						ret := 0.863636 // buy
		if( Typical_Price > 847.535 )
			if( Raw_Money_Flow <= 1.31031e+10 )
				if( Money_Flow_Ratio <= 1.00751 )
					ret := 1.000000 // buy
				if( Money_Flow_Ratio > 1.00751 )
					ret := 0.000000
			if( Raw_Money_Flow > 1.31031e+10 )
				if( Typical_Price <= 1576.24 )
					if( Negative_Money_Flow_Sum <= 1.40281e+11 )
						ret := -0.032787
					if( Negative_Money_Flow_Sum > 1.40281e+11 )
						ret := -0.601156
				if( Typical_Price > 1576.24 )
...
float op_operation = decision_tree_0_TSLA_1Day_4dd706c7(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
