			...
			if( bullPower <= -1.79235 )
				if( Typical_Price <= 276.849 )
					...
					if( Positive_Money_Flow_Sum > 1.61184e+09 )
						ret := 0.230216
				if( Typical_Price > 276.849 )
					if( bullPower <= -15.1436 )
						ret := 0.600000
					if( bullPower > -15.1436 )
						ret := -1.000000 // sell
			if( bullPower > -1.79235 )
				if( Money_Flow_Ratio <= 0.912418 )
					if( MFI_Low <= 23.0942 )
						ret := -0.115789
					if( MFI_Low > 23.0942 )
						ret := -0.826667 // sell
				if( Money_Flow_Ratio > 0.912418 )
					if( Typical_Price <= 176.49 )
						ret := -0.541667
					if( Typical_Price > 176.49 )
						ret := 0.250000
		if( Typical_Price > 293.343 )
			if( Positive_Money_Flow_Sum <= 2.00835e+09 )
				if( MFI_Low <= 1.64297 )
					if( bbp <= -108.006 )
						ret := 1.000000 // buy
					if( bbp > -108.006 )
						ret := -0.055556
				if( MFI_Low > 1.64297 )
					if( Negative_Money_Flow <= 2.23287e+08 )
						ret := -0.500000
					if( Negative_Money_Flow > 2.23287e+08 )
						ret := -0.885714 // sell
			if( Positive_Money_Flow_Sum > 2.00835e+09 )
				if( Negative_Money_Flow_Sum <= 4.54203e+09 )
					if( Money_Flow_Ratio <= 1.49887 )
						ret := -0.012146
					if( Money_Flow_Ratio > 1.49887 )
						ret := -0.427451
				if( Negative_Money_Flow_Sum > 4.54203e+09 )
...
float op_operation = decision_tree_0_MDB_1Day_ed7513c4(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
