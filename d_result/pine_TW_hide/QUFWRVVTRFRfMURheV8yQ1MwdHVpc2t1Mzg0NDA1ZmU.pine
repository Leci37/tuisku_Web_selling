...
decision_tree_0_AAVEUSDT_1Day_384405fe(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( d_k > -0.330683 )
		if( ad_mf <= -39374.7 )
			if( mf <= 0.195996 )
				if( smoothK_k <= 78.9231 )
					if( smoothD_d <= 11.9328 )
						ret := 0.125000
					if( smoothD_d > 11.9328 )
						ret := -0.308642
				if( smoothK_k > 78.9231 )
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_384405fe(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)
