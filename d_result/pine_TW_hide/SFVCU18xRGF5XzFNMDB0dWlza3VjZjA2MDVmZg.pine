			...
			if( Negative_Money_Flow_Sum > 1.0489e+09 )
				...
				if( MFI > 54.6691 )
					...
					if( Raw_Money_Flow > 1.81992e+08 )
						ret := -0.151163
	if( Positive_Money_Flow_Sum > 2.54496e+09 )
		if( Negative_Money_Flow <= 7.19751e+06 )
			if( MFI_Low <= 53.0834 )
				if( MFI <= 59.2971 )
					if( Positive_Money_Flow_Sum <= 3.16328e+09 )
						ret := 0.360000
					if( Positive_Money_Flow_Sum > 3.16328e+09 )
						ret := -0.611111
				if( MFI > 59.2971 )
					if( Raw_Money_Flow <= 2.19752e+08 )
						ret := 0.083333
					if( Raw_Money_Flow > 2.19752e+08 )
						ret := -0.634921
			if( MFI_Low > 53.0834 )
				if( MFI <= 84.7873 )
					if( Typical_Price <= 542.353 )
						ret := 0.689655
					if( Typical_Price > 542.353 )
						ret := 0.000000
				if( MFI > 84.7873 )
					if( Positive_Money_Flow_Sum <= 3.00517e+09 )
						ret := -1.000000 // sell
					if( Positive_Money_Flow_Sum > 3.00517e+09 )
						ret := 0.000000
		if( Negative_Money_Flow > 7.19751e+06 )
			if( Positive_Money_Flow <= 7.73696e+07 )
				if( Positive_Money_Flow_Sum <= 3.20304e+09 )
					if( Raw_Money_Flow <= 7.50878e+08 )
						ret := -0.626984
					if( Raw_Money_Flow > 7.50878e+08 )
						ret := 0.400000
				if( Positive_Money_Flow_Sum > 3.20304e+09 )
					if( Typical_Price <= 809.186 )
						ret := -0.037037
					if( Typical_Price > 809.186 )
						ret := -1.000000 // sell
			if( Positive_Money_Flow > 7.73696e+07 )
				if( Positive_Money_Flow_Sum <= 2.69538e+09 )
					ret := -0.500000
				if( Positive_Money_Flow_Sum > 2.69538e+09 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_HUBS_1Day_cf0605ff(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
