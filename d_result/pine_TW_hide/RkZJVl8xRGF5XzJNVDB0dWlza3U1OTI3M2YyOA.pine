...
decision_tree_0_FFIV_1Day_59273f28(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema1 > 140.811 )
			...
			if( MFI_Low <= 33.9114 )
				if( Negative_Money_Flow_Sum <= 1.33974e+09 )
					...
					if( ema3 > 165.657 )
						ret := 0.162500
				if( Negative_Money_Flow_Sum > 1.33974e+09 )
					if( Negative_Money_Flow_Sum <= 1.64331e+09 )
						ret := -0.939394 // sell
					if( Negative_Money_Flow_Sum > 1.64331e+09 )
						ret := 0.363636
			if( MFI_Low > 33.9114 )
		...
		if( Positive_Money_Flow_Sum > 7.89222e+08 )
			if( MFI <= 52.7876 )
				if( Negative_Money_Flow_Sum <= 1.26022e+09 )
					if( Raw_Money_Flow <= 1.1351e+08 )
						ret := -0.285714
					if( Raw_Money_Flow > 1.1351e+08 )
						ret := -0.884058 // sell
				if( Negative_Money_Flow_Sum > 1.26022e+09 )
					if( Positive_Money_Flow <= 1.14874e+08 )
						ret := 0.672727
					if( Positive_Money_Flow > 1.14874e+08 )
						ret := -0.627451
			if( MFI > 52.7876 )
				if( Positive_Money_Flow_Sum <= 1.50685e+09 )
					if( Negative_Money_Flow <= 8.4962e+07 )
						ret := 0.114108
					if( Negative_Money_Flow > 8.4962e+07 )
						ret := 0.550725
				if( Positive_Money_Flow_Sum > 1.50685e+09 )
					if( Typical_Price <= 156.077 )
						ret := -0.931034 // sell
					if( Typical_Price > 156.077 )
						ret := -0.096154
...
float op_operation = decision_tree_0_FFIV_1Day_59273f28(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
