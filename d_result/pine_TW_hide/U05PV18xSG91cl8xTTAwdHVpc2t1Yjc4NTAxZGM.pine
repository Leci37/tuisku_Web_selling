	...
	if( Negative_Money_Flow_Sum <= 8.00766e+08 )
		...
		if( Negative_Money_Flow_Sum > 7.88101e+08 )
			...
			if( Typical_Price > 232.207 )
				ret := 0.000000
	if( Negative_Money_Flow_Sum > 8.00766e+08 )
		if( Negative_Money_Flow_Sum <= 8.76882e+08 )
			if( Positive_Money_Flow_Sum <= 2.36574e+08 )
				if( Positive_Money_Flow <= 169.105 )
					ret := 0.261261
				if( Positive_Money_Flow > 169.105 )
					if( Negative_Money_Flow_Sum <= 8.71062e+08 )
						if( MFI_High <= -61.7355 )
							ret := -0.819672 // sell
						if( MFI_High > -61.7355 )
							ret := 0.166667
		...
		if( Negative_Money_Flow_Sum > 8.76882e+08 )
			if( MFI_Low <= 39.2607 )
				if( Money_Flow_Ratio <= 0.720694 )
					if( Typical_Price <= 352.632 )
						if( Money_Flow_Ratio <= 0.678884 )
							ret := -0.033280
						if( Money_Flow_Ratio > 0.678884 )
							ret := -0.634615
					if( Typical_Price > 352.632 )
						ret := -0.741071 // sell
				if( Money_Flow_Ratio > 0.720694 )
					if( Negative_Money_Flow_Sum <= 1.3987e+09 )
						if( Positive_Money_Flow_Sum <= 1.4769e+09 )
							ret := -0.095745
						if( Positive_Money_Flow_Sum > 1.4769e+09 )
							ret := 0.740741 // buy
					if( Negative_Money_Flow_Sum > 1.3987e+09 )
...
float op_operation = decision_tree_0_SNOW_1Hour_b78501dc(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
