...
decision_tree_0_ADSK_1Day_000025bf(bullPower, bbp, bearPower, bbm, BBPower_Color, VIP, VIM, VIP_VIM)=>
	...
	if( VIP > 1.0323 )
		if( bbp <= -21.1198 )
			if( bullPower <= -9.39435 )
				if( bullPower <= -10.0595 )
					ret := 0.000000
				if( bullPower > -10.0595 )
					if( VIM <= 1.29421 )
						ret := -1.000000 // sell
			...
			if( bbm <= 0.935 )
				...
				if( VIP_VIM > 0.610579 )
					...
					if( VIP_VIM > 0.789492 )
						ret := 1.000000 // buy
			if( bbm > 0.935 )
				if( bullPower <= -0.269319 )
					if( VIP <= 1.22487 )
						ret := 0.280000
					if( VIP > 1.22487 )
						ret := 1.000000 // buy
				if( bullPower > -0.269319 )
					if( bullPower <= 3.16933 )
						ret := -0.282238
					if( bullPower > 3.16933 )
						ret := -0.053971
...
float op_operation = decision_tree_0_ADSK_1Day_000025bf(bullPower, bbp, bearPower, bbm, BBPower_Color, VIP, VIM, VIP_VIM)
