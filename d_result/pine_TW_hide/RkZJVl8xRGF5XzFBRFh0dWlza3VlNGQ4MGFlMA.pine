...
decision_tree_0_FFIV_1Day_e4d80ae0(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)=>
	...
	if( smoothedDirectionalMovementMinus > 2.05544 )
		if( dx <= 68.5213 )
			if( diMinus <= 44.349 )
				if( smoothedTrueRange <= 9.17367 )
					if( directionalMovementMinus <= 0.714582 )
						ret := -1.000000 // sell
					if( directionalMovementMinus > 0.714582 )
						ret := -0.562500
				if( smoothedTrueRange > 9.17367 )
			...
			if( diMinus > 44.349 )
				ret := 0.833333 // buy
		if( dx > 68.5213 )
			if( smoothedDirectionalMovementPlus <= 0.228572 )
				if( adx <= 49.7882 )
					ret := -0.833333 // sell
				if( adx > 49.7882 )
					ret := -0.125000
			if( smoothedDirectionalMovementPlus > 0.228572 )
				if( smoothedDirectionalMovementPlus <= 0.314198 )
					ret := 1.000000 // buy
				if( smoothedDirectionalMovementPlus > 0.314198 )
					if( adx <= 40.7463 )
						ret := 0.666667
...
float op_operation = decision_tree_0_FFIV_1Day_e4d80ae0(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
