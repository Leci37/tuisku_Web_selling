			...
			if( BBupper <= 5.90119 )
				...
				if( vrsi > 59.4847 )
					...
					if( BBlower > 5.36159 )
						ret := -0.363636
			if( BBupper > 5.90119 )
				if( dif_source_BBlower <= 1.04352 )
					if( vrsi <= 91.9799 )
						if( dif_source_BBupper <= -21.4665 )
							ret := 0.967742 // buy
						if( dif_source_BBupper > -21.4665 )
							ret := -0.082515
					if( vrsi > 91.9799 )
						if( dif_source_BBupper <= -1.45145 )
							ret := -0.490040
						if( dif_source_BBupper > -1.45145 )
							ret := -0.231707
				if( dif_source_BBlower > 1.04352 )
					...
					if( BBupper > 83.3294 )
						...
						if( vrsi > 68.0901 )
							ret := -0.659483
	if( BBlower > 71.4745 )
		if( dif_source_BBupper <= -13.605 )
			if( dif_source_BBlower <= -0.584812 )
				if( dif_source_BBlower <= -3.03602 )
					ret := 0.500000
				if( dif_source_BBlower > -3.03602 )
					ret := -0.750000 // sell
			if( dif_source_BBlower > -0.584812 )
...
float op_operation = decision_tree_0_RUN_30Min_45430828(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
