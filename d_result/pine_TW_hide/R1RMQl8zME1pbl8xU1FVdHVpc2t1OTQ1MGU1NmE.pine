				...
				if( val > 0.075867 )
					if( val <= 0.094629 )
						...
						if( val > 0.085626 )
							ret := -0.833333 // sell
					if( val > 0.094629 )
						if( avgHighLow <= 45.6838 )
							ret := -0.285714
						if( avgHighLow > 45.6838 )
							ret := 0.466667
			if( avgHighLow > 46.6919 )
				if( avgHighLow <= 46.8165 )
					if( basis <= 46.898 )
						if( val <= -0.038434 )
							ret := 0.600000
						if( val > -0.038434 )
...
float op_operation = decision_tree_0_GTLB_30Min_9450e56a(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
