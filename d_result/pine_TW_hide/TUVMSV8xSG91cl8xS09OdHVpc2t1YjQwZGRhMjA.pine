				...
				if( tprice <= 1020.7 )
					if( media <= 38.2334 )
						...
						if( media > 30.1495 )
							ret := -0.818182 // sell
					if( media > 38.2334 )
						if( verde_media <= 65.9501 )
							ret := 0.886179 // buy
						if( verde_media > 65.9501 )
							ret := 0.473684
				if( tprice > 1020.7 )
					if( media_azul <= 78.3527 )
						if( nvi <= 1.05362 )
							ret := 0.283951
						if( nvi > 1.05362 )
							ret := 0.830189 // buy
...
float op_operation = decision_tree_0_MELI_1Hour_b40dda20(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
