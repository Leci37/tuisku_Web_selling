			...
			if( Negative_Money_Flow_Sum <= 2.56842e+09 )
				if( Money_Flow_Ratio <= 1.34138 )
					...
					if( Typical_Price > 24.6388 )
						ret := 0.085586
				if( Money_Flow_Ratio > 1.34138 )
					if( Positive_Money_Flow_Sum <= 2.5925e+09 )
						ret := 0.750000 // buy
					if( Positive_Money_Flow_Sum > 2.5925e+09 )
						ret := -0.286585
			if( Negative_Money_Flow_Sum > 2.56842e+09 )
				if( Money_Flow_Ratio <= 1.39116 )
					if( Typical_Price <= 71.9424 )
						ret := -0.158850
					if( Typical_Price > 71.9424 )
						ret := -0.885714 // sell
				if( Money_Flow_Ratio > 1.39116 )
					if( Money_Flow_Ratio <= 3.18112 )
						ret := 0.445714
					if( Money_Flow_Ratio > 3.18112 )
						ret := -0.850000 // sell
...
float op_operation = decision_tree_0_PINS_1Day_67816553(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
