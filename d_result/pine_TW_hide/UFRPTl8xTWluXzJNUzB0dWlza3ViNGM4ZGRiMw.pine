			...
			if( Positive_Money_Flow > 0.154385 )
				...
				if( smoothK_k > 30.662 )
					...
					if( d_k > 4.70301 )
						ret := -0.104895
		if( Raw_Money_Flow > 6555.78 )
			if( Positive_Money_Flow_Sum <= 1.14429e+07 )
				if( Negative_Money_Flow <= 43.6715 )
					if( Positive_Money_Flow <= 1.23406e+06 )
						ret := -0.041216
					if( Positive_Money_Flow > 1.23406e+06 )
						ret := 0.262032
				if( Negative_Money_Flow > 43.6715 )
					if( Positive_Money_Flow_Sum <= 1.73584e+06 )
						ret := 0.025556
					if( Positive_Money_Flow_Sum > 1.73584e+06 )
						ret := 0.188566
			if( Positive_Money_Flow_Sum > 1.14429e+07 )
				if( rsi1 <= 55.1971 )
					ret := 0.343750
				if( rsi1 > 55.1971 )
					if( Positive_Money_Flow_Sum <= 1.21439e+07 )
						ret := -0.767123 // sell
					if( Positive_Money_Flow_Sum > 1.21439e+07 )
						ret := -0.308550
...
float op_operation = decision_tree_0_PTON_1Min_b4c8ddb3(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
