		...
		if( tenkan_sen <= 48.8132 )
			if( basis_minus <= 6.66862 )
				if( basis_minus <= -3.48625 )
					ret := 0.000000
				if( basis_minus > -3.48625 )
					if( senkou_span_b <= 41.66 )
						ret := 0.775194 // buy
					if( senkou_span_b > 41.66 )
						ret := -1.000000 // sell
			if( basis_minus > 6.66862 )
				if( senkou_span_a_displaced <= 23.4275 )
					if( kinjun_sen <= 38.325 )
						ret := 0.000000
					if( kinjun_sen > 38.325 )
						ret := 1.000000 // buy
				if( senkou_span_a_displaced > 23.4275 )
					ret := 0.000000
		if( tenkan_sen > 48.8132 )
			if( senkou_span_a_displaced <= 40.6761 )
				if( tenkan_sen <= 49.0125 )
					ret := 0.000000
				if( tenkan_sen > 49.0125 )
					if( senkou_span_b_displaced <= 38.3633 )
						ret := -0.909091 // sell
					if( senkou_span_b_displaced > 38.3633 )
						ret := 0.000000
			if( senkou_span_a_displaced > 40.6761 )
...
float op_operation = decision_tree_0_NIO_1Day_2f61ca7f(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
