			...
			if( smoothD_d > 13.6295 )
				if( Negative_Money_Flow <= 2.46637e+07 )
					...
					if( smoothD_d > 17.5475 )
						ret := -0.093023
				if( Negative_Money_Flow > 2.46637e+07 )
					if( Negative_Money_Flow_Sum <= 4.49423e+08 )
						ret := 0.878049 // buy
					if( Negative_Money_Flow_Sum > 4.49423e+08 )
						ret := 0.451613
		if( Positive_Money_Flow_Sum > 4.37434e+08 )
			if( Raw_Money_Flow <= 7.93382e+07 )
				if( Money_Flow_Ratio <= 0.634407 )
					if( Typical_Price <= 22.9258 )
						ret := 0.000000
					if( Typical_Price > 22.9258 )
						ret := -0.923077 // sell
				if( Money_Flow_Ratio > 0.634407 )
...
float op_operation = decision_tree_0_DBX_1Day_51b8d5e9(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
