				...
				if( Typical_Price > 334.812 )
					if( Raw_Money_Flow <= 197042 )
						...
						if( Positive_Money_Flow_Sum > 4.40245e+08 )
							ret := 0.541667
					if( Raw_Money_Flow > 197042 )
						if( Negative_Money_Flow_Sum <= 4.28402e+08 )
							ret := -0.088944
						if( Negative_Money_Flow_Sum > 4.28402e+08 )
							ret := -0.367491
		if( mf > 0.192913 )
			if( Negative_Money_Flow_Sum <= 1.37519e+08 )
				if( Money_Flow_Ratio <= 1.73417 )
					ret := -0.555556
				if( Money_Flow_Ratio > 1.73417 )
					if( MFI <= 80.6909 )
						ret := 0.668142
					if( MFI > 80.6909 )
						if( Positive_Money_Flow_Sum <= 4.96168e+08 )
							ret := -0.187970
						if( Positive_Money_Flow_Sum > 4.96168e+08 )
							ret := 0.338150
			if( Negative_Money_Flow_Sum > 1.37519e+08 )
				if( MFI_Low <= 63.9473 )
					if( Typical_Price <= 1200.01 )
						if( ad_mf <= -0.198117 )
							ret := 0.304167
						if( ad_mf > -0.198117 )
							ret := 0.027375
					if( Typical_Price > 1200.01 )
						if( Raw_Money_Flow <= 655826 )
							ret := -0.500000
						if( Raw_Money_Flow > 655826 )
							ret := -0.003505
				if( MFI_Low > 63.9473 )
...
float op_operation = decision_tree_0_MELI_1Hour_c3ade7c8(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
