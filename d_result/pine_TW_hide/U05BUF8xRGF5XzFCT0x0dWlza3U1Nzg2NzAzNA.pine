...
decision_tree_0_SNAP_1Day_57867034(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)=>
	...
	if( BBlower > 11.3446 )
		if( dif_source_BBlower <= 29.0786 )
			...
			if( dif_source_BBupper > -64.2319 )
				if( BBlower <= 23.1244 )
					if( dif_source_BBlower <= -1.85886 )
						ret := 0.800000 // buy
					if( dif_source_BBlower > -1.85886 )
						ret := -0.744565 // sell
				if( BBlower > 23.1244 )
					if( dif_source_BBupper <= -54.8425 )
						ret := 0.863636 // buy
					if( dif_source_BBupper > -54.8425 )
						ret := -0.580645
		if( dif_source_BBlower > 29.0786 )
			if( BBlower <= 41.4372 )
				if( dif_source_BBlower <= 38.6969 )
					if( dif_source_BBupper <= -6.58292 )
						ret := 0.850000 // buy
					if( dif_source_BBupper > -6.58292 )
						ret := -0.142857
				if( dif_source_BBlower > 38.6969 )
					if( dif_source_BBupper <= -14.9508 )
						ret := 0.500000
					if( dif_source_BBupper > -14.9508 )
						ret := -0.147059
			if( BBlower > 41.4372 )
...
float op_operation = decision_tree_0_SNAP_1Day_57867034(crossunder_rsi_bbupperInt, BBlower, dif_source_BBlower, dif_source_BBupper, vrsi, BBupper, crossover_rsi_bblowerInt)
