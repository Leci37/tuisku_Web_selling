			...
			if( ad <= -1.16512e+06 )
				...
				if( Negative_Money_Flow > 1.47904e+10 )
					...
					if( ad > -5.11276e+06 )
						ret := 0.125000
			if( ad > -1.16512e+06 )
				if( Raw_Money_Flow <= 1.18669e+10 )
					if( ad_mf <= 4.68654e+06 )
						ret := 0.750000 // buy
					if( ad_mf > 4.68654e+06 )
						ret := 0.125000
				if( Raw_Money_Flow > 1.18669e+10 )
					if( ad_mf <= 1.43366e+06 )
						ret := -0.777778 // sell
					if( ad_mf > 1.43366e+06 )
						ret := 0.571429
		if( MFI_Low > 4.77804 )
			if( Negative_Money_Flow_Sum <= 1.49093e+11 )
				if( Negative_Money_Flow <= 8.60395e+09 )
					if( Positive_Money_Flow_Sum <= 1.45515e+11 )
						ret := -0.030395
					if( Positive_Money_Flow_Sum > 1.45515e+11 )
						ret := -0.948276 // sell
				if( Negative_Money_Flow > 8.60395e+09 )
					if( Positive_Money_Flow_Sum <= 5.33675e+10 )
						ret := -0.679558
					if( Positive_Money_Flow_Sum > 5.33675e+10 )
						ret := -0.344988
			if( Negative_Money_Flow_Sum > 1.49093e+11 )
				if( Positive_Money_Flow <= 2.80698e+09 )
					if( Raw_Money_Flow <= 1.57186e+10 )
						ret := 0.714286 // buy
					if( Raw_Money_Flow > 1.57186e+10 )
						ret := 0.961538 // buy
				if( Positive_Money_Flow > 2.80698e+09 )
...
float op_operation = decision_tree_0_AMZN_1Day_6db987a5(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
