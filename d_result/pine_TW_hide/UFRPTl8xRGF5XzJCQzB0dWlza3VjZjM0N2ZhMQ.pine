			...
			if( bbm > 0.299107 )
				if( bbm <= 1.50258 )
					...
					if( bbp > -0.746088 )
						ret := 0.641975
				if( bbm > 1.50258 )
					if( ad_mf <= -9.77965e+06 )
						ret := -0.571429
					if( ad_mf > -9.77965e+06 )
						ret := 0.047619
		if( mf > -0.08528 )
			if( mf <= 0.035993 )
				if( ad_mf <= 1.24645e+06 )
					if( bearPower <= 0.857636 )
						ret := -0.012987
					if( bearPower > 0.857636 )
						ret := 0.809524 // buy
				if( ad_mf > 1.24645e+06 )
...
float op_operation = decision_tree_0_PTON_1Day_cf347fa1(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
