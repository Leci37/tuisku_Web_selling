...
decision_tree_0_DOTUSDT_1Day_41925bcc(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( tema > 35.4245 )
		if( MFI <= 64.3568 )
			if( ema13 <= -0.770343 )
				if( ema3 <= 46.8117 )
					if( Positive_Money_Flow <= 8.41253e+07 )
						ret := -0.714286 // sell
					if( Positive_Money_Flow > 8.41253e+07 )
						ret := -1.000000 // sell
				if( ema3 > 46.8117 )
			...
			if( ema13 > -0.770343 )
				if( ema2 <= 45.8778 )
					if( Positive_Money_Flow_Sum <= 4.9325e+09 )
						ret := 0.403226
					if( Positive_Money_Flow_Sum > 4.9325e+09 )
						ret := -0.833333 // sell
				if( ema2 > 45.8778 )
		...
		if( MFI > 64.3568 )
			if( ema1 <= 39.1836 )
				if( Money_Flow_Ratio <= 1.9739 )
					ret := -0.625000
				if( Money_Flow_Ratio > 1.9739 )
					ret := -1.000000 // sell
			if( ema1 > 39.1836 )
				if( Typical_Price <= 41.5573 )
					ret := -0.100000
				if( Typical_Price > 41.5573 )
					if( Positive_Money_Flow_Sum <= 5.60172e+09 )
						ret := -1.000000 // sell
					if( Positive_Money_Flow_Sum > 5.60172e+09 )
						ret := -0.714286 // sell
...
float op_operation = decision_tree_0_DOTUSDT_1Day_41925bcc(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
