			...
			if( tenkan_sen <= 150.467 )
				...
				if( chinkou_span > 139.747 )
					if( tenkan_sen <= 141.57 )
						ret := 0.600000
					if( tenkan_sen > 141.57 )
						if( basis_minus <= 4.19553 )
							ret := -0.209917
						if( basis_minus > 4.19553 )
							ret := 0.523810
			if( tenkan_sen > 150.467 )
				if( chinkou_span <= 146.694 )
					ret := -0.724816 // sell
				if( chinkou_span > 146.694 )
					if( senkou_span_a <= 160.837 )
						if( basis_max <= 0.023288 )
							ret := -0.462687
						if( basis_max > 0.023288 )
							ret := 0.212121
					if( senkou_span_a > 160.837 )
						ret := -0.841270 // sell
		if( chinkou_span > 148.597 )
			if( tenkan_sen <= 150.566 )
				ret := 0.490511
			if( tenkan_sen > 150.566 )
				if( chinkou_span <= 156.376 )
					if( kinjun_sen <= 153.202 )
						ret := 0.178010
					if( kinjun_sen > 153.202 )
						if( senkou_span_a <= 163.488 )
							ret := -0.378882
						if( senkou_span_a > 163.488 )
							ret := -0.825397 // sell
				if( chinkou_span > 156.376 )
					if( senkou_span_a <= 161.941 )
						if( senkou_span_a_displaced <= 147.885 )
							ret := -0.208333
						if( senkou_span_a_displaced > 147.885 )
							ret := 0.385659
					if( senkou_span_a > 161.941 )
						if( chinkou_span <= 179.634 )
							ret := -0.206544
						if( chinkou_span > 179.634 )
							ret := 0.035298
...
float op_operation = decision_tree_0_SNOW_1Hour_0b56afb5(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
