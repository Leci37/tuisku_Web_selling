				...
				if( dif_source_BBlower > 0.618191 )
					...
					if( dif_source_BBupper > -1.25553 )
						...
						if( dif_source_BBlower > 2.55472 )
							ret := 0.272727
		if( BBlower > 30.5412 )
			if( dif_source_BBupper <= -0.603925 )
				if( vrsi <= 34.5238 )
					if( BBlower <= 31.1274 )
						ret := -1.000000 // sell
					if( BBlower > 31.1274 )
						if( dif_source_BBlower <= 0.534185 )
							ret := -1.000000 // sell
						if( dif_source_BBlower > 0.534185 )
							ret := 0.000000
				if( vrsi > 34.5238 )
			...
			if( dif_source_BBupper > -0.603925 )
				ret := 0.000000
	if( vrsi > 43.1148 )
		if( dif_source_BBlower <= 3.00718 )
			if( BBupper <= 23.6677 )
				if( vrsi <= 75.7048 )
					if( BBupper <= 22.9345 )
						if( dif_source_BBupper <= -4.40581 )
							ret := -0.473684
						if( dif_source_BBupper > -4.40581 )
							ret := 0.067832
					if( BBupper > 22.9345 )
		...
		if( dif_source_BBlower > 3.00718 )
			if( BBupper <= 23.6893 )
				if( BBupper <= 22.506 )
					if( vrsi <= 73.6968 )
						if( dif_source_BBlower <= 3.70755 )
							ret := -0.300000
						if( dif_source_BBlower > 3.70755 )
							ret := -0.783333 // sell
					if( vrsi > 73.6968 )
						if( dif_source_BBupper <= -0.322241 )
							ret := -0.964286 // sell
						if( dif_source_BBupper > -0.322241 )
							ret := 0.479452
				if( BBupper > 22.506 )
					if( BBlower <= 19.0458 )
						...
						if( vrsi > 74.2378 )
							ret := -0.466667
					if( BBlower > 19.0458 )
						if( dif_source_BBupper <= -0.582357 )
							ret := 0.000000
						if( dif_source_BBupper > -0.582357 )
							ret := -0.660131
			if( BBupper > 23.6893 )
				if( BBlower <= 20.6463 )
					if( dif_source_BBupper <= -0.394043 )
						if( dif_source_BBlower <= 3.62344 )
							ret := 0.421053
						if( dif_source_BBlower > 3.62344 )
							ret := -0.037037
					if( dif_source_BBupper > -0.394043 )
						if( dif_source_BBlower <= 5.21999 )
							ret := -0.428571
						if( dif_source_BBlower > 5.21999 )
							ret := -1.000000 // sell
				if( BBlower > 20.6463 )
...
float op_operation = decision_tree_0_DBX_1Hour_be9a2077(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
