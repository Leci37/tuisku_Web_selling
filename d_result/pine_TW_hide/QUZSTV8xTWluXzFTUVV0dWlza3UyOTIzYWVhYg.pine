				...
				if( ma <= 33.2202 )
					...
					if( priceRange > 0.28311 )
						...
						if( rangema > 0.237145 )
							ret := 0.307692
				if( ma > 33.2202 )
					if( avgHighLow <= 38.0383 )
						if( avgHighLow <= 36.4875 )
							if( ma <= 36.2861 )
								if( upperBB <= 36.4279 )
									ret := 0.000000
								if( upperBB > 36.4279 )
...
float op_operation = decision_tree_0_AFRM_1Min_2923aeab(val, sqzOnInt, lowerBB, lowerKC, upperKC, dev, rangema, sqzOffInt, upperBB, priceRange, noSqzInt, ma, basis, avgHighLow)
