	...
	if( smoothedDirectionalMovementPlus > 8.16083 )
		if( dx <= 24.2761 )
			if( adx <= 20.1433 )
				ret := -1.000000 // sell
			if( adx > 20.1433 )
				if( smoothedTrueRange <= 34.7375 )
					ret := 0.142857
				if( smoothedTrueRange > 34.7375 )
					if( smoothedDirectionalMovementPlus <= 8.93235 )
						ret := 0.750000 // buy
					if( smoothedDirectionalMovementPlus > 8.93235 )
						ret := 1.000000 // buy
		if( dx > 24.2761 )
			if( smoothedTrueRange <= 23.0795 )
				if( directionalMovementPlus <= 9.59773 )
					if( directionalMovementMinus <= 0.196629 )
						ret := 0.050000
					if( directionalMovementMinus > 0.196629 )
						ret := -0.500000
				if( directionalMovementPlus > 9.59773 )
					if( smoothedDirectionalMovementPlus <= 8.59817 )
						ret := -1.000000 // sell
					if( smoothedDirectionalMovementPlus > 8.59817 )
						ret := -0.636364
			if( smoothedTrueRange > 23.0795 )
				if( smoothedDirectionalMovementPlus <= 12.6632 )
					if( directionalMovementPlus <= 36.0144 )
						ret := -0.948718 // sell
					if( directionalMovementPlus > 36.0144 )
						ret := -0.500000
				if( smoothedDirectionalMovementPlus > 12.6632 )
...
float op_operation = decision_tree_0_HUBS_1Day_a8bef5d7(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
