				...
				if( priceRange > 6.98065 )
					if( ma <= 1026.94 )
						...
						if( dev > 28.3636 )
							ret := -0.538462
					if( ma > 1026.94 )
						if( priceRange <= 39.1494 )
							ret := -0.029657
						if( priceRange > 39.1494 )
							ret := 0.248826
		if( upperBB > 2845.13 )
			if( avgHighLow <= 2847.44 )
				if( ma <= 2829.37 )
					if( avgHighLow <= 2807.27 )
						if( val <= -1.53674 )
							ret := -0.846154 // sell
						if( val > -1.53674 )
							ret := 0.166667
					if( avgHighLow > 2807.27 )
						if( priceRange <= 21.6661 )
							ret := 0.157895
						if( priceRange > 21.6661 )
							ret := 0.700000 // buy
				if( ma > 2829.37 )
...
float op_operation = decision_tree_0_GOOG_1Hour_ee6fcadf(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
