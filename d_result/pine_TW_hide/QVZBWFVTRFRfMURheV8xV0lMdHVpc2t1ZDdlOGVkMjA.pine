			...
			if( Color_con1 > -6.99074 )
				...
				if( midLine > 12.0267 )
					...
					if( upperBand > 36.5339 )
						ret := 0.730769 // buy
	if( upperBand > 66.5206 )
		if( Color_con2 <= 6.45994 )
			if( Color_con1 <= -13.912 )
				if( sDev <= 19.7732 )
					if( Color_con1 <= -25.1273 )
						ret := 0.000000
					if( Color_con1 > -25.1273 )
						ret := -1.000000 // sell
				if( sDev > 19.7732 )
					if( lowerBand <= 20.2789 )
						ret := -0.518519
					if( lowerBand > 20.2789 )
						ret := -1.000000 // sell
			if( Color_con1 > -13.912 )
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_d7e8ed20(rangeHigh, rangeLow, midLine, sDev, lowerBand, wvf, Color_con1, colInt, Color_con2, upperBand)
