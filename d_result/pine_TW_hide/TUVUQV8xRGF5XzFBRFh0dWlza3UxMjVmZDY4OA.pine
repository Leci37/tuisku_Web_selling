			...
			if( trueRange > 13.3422 )
				...
				if( diPlus > 40.7189 )
					...
					if( directionalMovementPlus > 2.2 )
						ret := 0.000000
	if( smoothedDirectionalMovementMinus > 4.11071 )
		if( trueRange <= 18.7433 )
			if( smoothedTrueRange <= 17.4079 )
				if( adx <= 64.236 )
					if( smoothedDirectionalMovementPlus <= 2.10757 )
						ret := -0.666667
					if( smoothedDirectionalMovementPlus > 2.10757 )
						ret := -1.000000 // sell
				if( adx > 64.236 )
					ret := 0.666667
			if( smoothedTrueRange > 17.4079 )
				if( smoothedDirectionalMovementPlus <= 2.06345 )
					if( diMinus <= 52.1393 )
						ret := 1.000000 // buy
					if( diMinus > 52.1393 )
						ret := 0.000000
				if( smoothedDirectionalMovementPlus > 2.06345 )
					ret := -0.400000
		if( trueRange > 18.7433 )
			if( smoothedDirectionalMovementMinus <= 6.5425 )
				if( trueRange <= 20.4807 )
					ret := 1.000000 // buy
				if( trueRange > 20.4807 )
					if( diMinus <= 33.7792 )
						ret := 0.000000
...
float op_operation = decision_tree_0_META_1Day_125fd688(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
