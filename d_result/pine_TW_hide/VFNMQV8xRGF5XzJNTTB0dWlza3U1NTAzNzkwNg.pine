			...
			if( Short_MA <= 214.177 )
				if( Negative_Money_Flow_Sum <= 8.49168e+10 )
					...
					if( Long_MA > 186.989 )
						ret := 0.575758
				if( Negative_Money_Flow_Sum > 8.49168e+10 )
					if( Raw_Money_Flow <= 2.35e+10 )
						ret := -0.388889
					if( Raw_Money_Flow > 2.35e+10 )
						ret := 0.656250
			if( Short_MA > 214.177 )
				if( Typical_Price <= 416.988 )
					if( Long_MA <= 315.126 )
						ret := 0.061290
					if( Long_MA > 315.126 )
						ret := -0.381443
				if( Typical_Price > 416.988 )
					...
					if( MFI_High > -18.3673 )
						ret := 0.158046
		if( MFI > 86.1541 )
			if( Positive_Money_Flow <= 3.79054e+10 )
				if( Negative_Money_Flow_Sum <= 9.94254e+09 )
					if( Positive_Money_Flow <= 5.179e+09 )
						ret := 0.750000 // buy
					if( Positive_Money_Flow > 5.179e+09 )
						ret := 0.500000
				if( Negative_Money_Flow_Sum > 9.94254e+09 )
...
float op_operation = decision_tree_0_TSLA_1Day_55037906(Short_Long_Diff, MA_Cross, Short_MA, Long_MA, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
