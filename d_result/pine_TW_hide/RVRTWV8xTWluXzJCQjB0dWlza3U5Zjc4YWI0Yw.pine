				...
				if( bbp <= 0.108905 )
					if( basis <= 49.0905 )
						...
						if( basis > 48.7449 )
							ret := 0.861538 // buy
					if( basis > 49.0905 )
						if( Lower_Band <= 49.4712 )
							ret := 0.254545
						if( Lower_Band > 49.4712 )
							ret := 0.666667
				if( bbp > 0.108905 )
					if( Upper_Band <= 49.102 )
						if( bbp <= 0.159672 )
							ret := -1.000000 // sell
						if( bbp > 0.159672 )
							ret := 1.000000 // buy
					if( Upper_Band > 49.102 )
						if( Lower_Band <= 48.9582 )
							ret := -0.810811 // sell
						if( Lower_Band > 48.9582 )
							ret := -0.048780
			if( basis > 49.7362 )
				if( basis <= 49.9626 )
					if( bullPower <= 0.061459 )
						if( bbm <= 0.05115 )
							ret := -0.448529
						if( bbm > 0.05115 )
							ret := 0.408163
				...
				if( basis > 49.9626 )
					if( basis <= 69.2494 )
						if( Upper_Band <= 68.9715 )
							ret := -0.009911
						if( Upper_Band > 68.9715 )
							ret := 0.213836
					if( basis > 69.2494 )
						if( bearPower <= 0.153687 )
							ret := -0.299790
						if( bearPower > 0.153687 )
							ret := 0.714286 // buy
		if( bearPower > 0.301877 )
			if( bbm <= 0.052508 )
				if( basis <= 52.3839 )
					if( bbp <= 0.892757 )
						if( Lower_Band <= 50.9518 )
							ret := -0.250000
						if( Lower_Band > 50.9518 )
							ret := -1.000000 // sell
					if( bbp > 0.892757 )
						if( Upper_Band <= 51.9989 )
							ret := -1.000000 // sell
						if( Upper_Band > 51.9989 )
							ret := 1.000000 // buy
				if( basis > 52.3839 )
					if( bullPower <= 0.58072 )
						if( Upper_Band <= 54.8493 )
							ret := -0.880952 // sell
						if( Upper_Band > 54.8493 )
							ret := -0.404651
					if( bullPower > 0.58072 )
						...
						if( bbp > 2.28705 )
							ret := 0.333333
			if( bbm > 0.052508 )
				if( Lower_Band <= 51.6352 )
					ret := 1.000000 // buy
				if( Lower_Band > 51.6352 )
					if( Lower_Band <= 60.0733 )
						if( bbm <= 0.185205 )
							ret := -0.669014
						if( bbm > 0.185205 )
							ret := -0.250000
					if( Lower_Band > 60.0733 )
						if( Upper_Band <= 64.1579 )
							ret := 0.607477
						if( Upper_Band > 64.1579 )
							ret := -0.250000
...
float op_operation = decision_tree_0_ETSY_1Min_9f78ab4c(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
