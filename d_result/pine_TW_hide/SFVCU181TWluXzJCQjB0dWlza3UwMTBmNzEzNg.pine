...
decision_tree_0_HUBS_5Min_010f7136(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( basis <= 610.361 )
		...
		if( bearPower > 1.33223 )
			if( Upper_Band <= 419.153 )
				ret := 0.697674
			if( Upper_Band > 419.153 )
				if( Upper_Band <= 618.093 )
					if( bbm <= 0.180791 )
						if( Lower_Band <= 412.368 )
							ret := 1.000000 // buy
						if( Lower_Band > 412.368 )
							ret := 0.009921
					if( bbm > 0.180791 )
						if( Upper_Band <= 437.481 )
							ret := -0.452381
						if( Upper_Band > 437.481 )
							ret := -0.127253
				if( Upper_Band > 618.093 )
	...
	if( basis > 610.361 )
		if( basis <= 676.075 )
			if( Upper_Band <= 689.004 )
				if( Lower_Band <= 605.313 )
					if( Upper_Band <= 625.958 )
						ret := -0.533569
					if( Upper_Band > 625.958 )
						if( Upper_Band <= 632.276 )
							ret := 0.258333
						if( Upper_Band > 632.276 )
							ret := -0.644068
				if( Lower_Band > 605.313 )
					if( bbm <= 0.629432 )
						if( Lower_Band <= 646.674 )
							ret := -0.013761
						if( Lower_Band > 646.674 )
							ret := 0.403509
					if( bbm > 0.629432 )
						if( Lower_Band <= 633.897 )
							ret := -0.053248
						if( Lower_Band > 633.897 )
							ret := -0.242188
			if( Upper_Band > 689.004 )
...
float op_operation = decision_tree_0_HUBS_5Min_010f7136(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
