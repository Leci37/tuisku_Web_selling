			...
			if( basis > 20.895 )
				...
				if( basis > 22.6904 )
					...
					if( basis > 23.7967 )
						ret := 0.380952
	if( Lower_Band > 21.5926 )
		if( Upper_Band <= 45.1418 )
			if( basis <= 25.1587 )
				if( Upper_Band <= 26.6181 )
					ret := -0.857143 // sell
				if( Upper_Band > 26.6181 )
					if( Upper_Band <= 26.7506 )
						ret := 1.000000 // buy
					if( Upper_Band > 26.7506 )
						ret := 0.066667
			if( basis > 25.1587 )
				if( Upper_Band <= 37.0559 )
					if( basis <= 29.4652 )
						ret := -0.578947
					if( basis > 29.4652 )
						ret := -0.873239 // sell
				if( Upper_Band > 37.0559 )
					if( bullPower <= 0.001326 )
						ret := 0.078947
					if( bullPower > 0.001326 )
						ret := -0.742857 // sell
		if( Upper_Band > 45.1418 )
			if( Upper_Band <= 54.7977 )
				if( bullPower <= 1.4542 )
					ret := 0.125000
				if( bullPower > 1.4542 )
					if( bearPower <= 2.45444 )
						ret := 0.806452 // buy
					if( bearPower > 2.45444 )
						ret := 0.083333
			if( Upper_Band > 54.7977 )
				if( basis <= 66.6869 )
					if( Upper_Band <= 64.4648 )
						ret := -0.251101
					if( Upper_Band > 64.4648 )
						ret := 0.411111
				if( basis > 66.6869 )
					if( bearPower <= -7.94355 )
						ret := 0.000000
					if( bearPower > -7.94355 )
						ret := -0.716667 // sell
...
float op_operation = decision_tree_0_RUN_1Day_f0d39ec9(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
