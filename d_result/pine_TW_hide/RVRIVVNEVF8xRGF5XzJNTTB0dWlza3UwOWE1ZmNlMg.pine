			...
			if( Money_Flow_Ratio <= 0.255247 )
				...
				if( Short_Long_Diff > -167.808 )
					...
					if( Negative_Money_Flow > 6.64878e+07 )
						ret := -0.344828
			if( Money_Flow_Ratio > 0.255247 )
				if( Positive_Money_Flow_Sum <= 1.15571e+09 )
					if( Short_MA <= 92.1387 )
						ret := 1.000000 // buy
					if( Short_MA > 92.1387 )
						ret := -0.205270
				if( Positive_Money_Flow_Sum > 1.15571e+09 )
					...
					if( Long_MA > 3259.8 )
						ret := -0.310954
		if( MFI_High > -8.99043 )
			if( Positive_Money_Flow_Sum <= 1.49461e+09 )
				if( Raw_Money_Flow <= 7.63199e+07 )
					ret := 0.777778 // buy
				if( Raw_Money_Flow > 7.63199e+07 )
					if( Short_Long_Diff <= 68.664 )
						ret := -0.363636
					if( Short_Long_Diff > 68.664 )
						ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 1.49461e+09 )
				if( Long_MA <= 3040.13 )
					if( Short_Long_Diff <= 34.593 )
						ret := 0.785714 // buy
					if( Short_Long_Diff > 34.593 )
						ret := 0.416268
				if( Long_MA > 3040.13 )
					if( Money_Flow_Ratio <= 2.53186 )
						ret := 0.750000 // buy
					if( Money_Flow_Ratio > 2.53186 )
						ret := -0.448276
...
float op_operation = decision_tree_0_ETHUSDT_1Day_09a5fce2(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
