				...
				if( d_k > -4.7026 )
					...
					if( bbp > -1.78643 )
						...
						if( rsi1 > 25.6279 )
							ret := -0.133489
	if( smoothD_d > 25.5315 )
		if( bearPower <= -0.082161 )
			if( d <= 87.6235 )
				if( rsi1 <= 36.2282 )
					if( bullPower <= -1.47021 )
						if( bbp <= -6.94036 )
							ret := 1.000000 // buy
						if( bbp > -6.94036 )
							ret := -0.789474 // sell
				...
				if( rsi1 > 36.2282 )
					if( rsi1 <= 41.2912 )
						if( bullPower <= 0.298421 )
							ret := -0.230769
						if( bullPower > 0.298421 )
							ret := 0.270270
					if( rsi1 > 41.2912 )
						if( smoothD_d <= 34.7396 )
							ret := 0.164948
						if( smoothD_d > 34.7396 )
							ret := -0.003514
			if( d > 87.6235 )
				...
				if( k > 73.2411 )
					if( d <= 99.8513 )
						...
						if( d_k > 10.6404 )
							ret := 0.432432
					if( d > 99.8513 )
						if( bearPower <= -0.144937 )
							ret := 0.937500 // buy
						if( bearPower > -0.144937 )
							ret := -0.166667
		if( bearPower > -0.082161 )
			if( bbm <= 0.007632 )
				if( smoothK_k <= 86.3936 )
					if( bullPower <= 0.179207 )
						if( bbm <= 0.00186 )
							ret := -0.024793
						if( bbm > 0.00186 )
							ret := -0.500000
				...
				if( smoothK_k > 86.3936 )
					if( k <= 90.3975 )
						if( bearPower <= 0.172651 )
							ret := 0.916667 // buy
						if( bearPower > 0.172651 )
							ret := 0.000000
					if( k > 90.3975 )
						if( bullPower <= 1.15031 )
							ret := 0.022727
						if( bullPower > 1.15031 )
							ret := 1.000000 // buy
			if( bbm > 0.007632 )
...
float op_operation = decision_tree_0_LYFT_1Hour_da922fc7(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
