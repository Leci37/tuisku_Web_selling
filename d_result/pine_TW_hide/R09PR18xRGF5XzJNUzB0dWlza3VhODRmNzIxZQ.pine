			...
			if( smoothK_k <= 44.6495 )
				if( MFI <= 49.686 )
					...
					if( d > 9.60444 )
						ret := 0.046154
				if( MFI > 49.686 )
					if( Negative_Money_Flow_Sum <= 2.45702e+10 )
						ret := 0.300000
					if( Negative_Money_Flow_Sum > 2.45702e+10 )
						ret := -0.882353 // sell
			if( smoothK_k > 44.6495 )
				if( MFI_High <= -42.8311 )
					if( Positive_Money_Flow_Sum <= 1.16072e+10 )
						ret := 0.620690
					if( Positive_Money_Flow_Sum > 1.16072e+10 )
						ret := -0.333333
				if( MFI_High > -42.8311 )
			...
			if( d_k <= -5.49557 )
				...
				if( Raw_Money_Flow > 2.81435e+09 )
					...
					if( d_k > -6.05004 )
						ret := 0.500000
			if( d_k > -5.49557 )
				if( Negative_Money_Flow_Sum <= 3.07631e+10 )
					if( smoothD_d <= 58.4568 )
						ret := -0.750000 // sell
					if( smoothD_d > 58.4568 )
						ret := 0.444444
				if( Negative_Money_Flow_Sum > 3.07631e+10 )
					if( Negative_Money_Flow <= 4.38392e+09 )
						ret := -0.783784 // sell
					if( Negative_Money_Flow > 4.38392e+09 )
						ret := -0.300000
...
float op_operation = decision_tree_0_GOOG_1Day_a84f721e(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
