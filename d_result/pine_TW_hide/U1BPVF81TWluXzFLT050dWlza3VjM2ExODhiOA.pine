...
decision_tree_0_SPOT_5Min_c3a188b8(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)=>
	...
	if( verde > -14.9629 )
		...
		if( xrsi > 60.1397 )
				...
				if( pvimax <= 0.963744 )
					if( pvimax <= 0.783092 )
						...
						if( pvim > 0.778001 )
							ret := 0.693333
					if( pvimax > 0.783092 )
						if( marron_mean <= 116.756 )
							ret := -0.151653
						if( marron_mean > 116.756 )
							ret := -0.693750
				if( pvimax > 0.963744 )
					if( azul_mean <= 4.36531 )
						if( source <= 302.572 )
							ret := 0.315131
						if( source > 302.572 )
							ret := 0.010163
			...
			if( pvi_ema > 1.18614 )
				if( tprice <= 316.516 )
					if( media_azul <= 106.405 )
						ret := -0.578652
					if( media_azul > 106.405 )
						ret := 0.171875
				if( tprice > 316.516 )
					if( verde <= 160.893 )
						if( media_azul <= 61.5676 )
							ret := -0.375342
						if( media_azul > 61.5676 )
							ret := 0.041899
					if( verde > 160.893 )
...
float op_operation = decision_tree_0_SPOT_5Min_c3a188b8(nvimin, azul, nvim, marron_mean, marron, nvimax, pvi, pvi_ema, oscp, verde, source, stoc, verde_mean, xrsi, media, xmf, tprice, pvimin, media_azul, verde_media, BollOsc, pvimax, nvi_ema, azul_mean, pvim, nvi, verde_azul)
