			...
			if( basis_max > -20.8429 )
				...
				if( chinkou_span > 1559.32 )
					...
					if( kinjun_sen > 1668.42 )
						ret := 0.071429
	if( senkou_span_b > 1576.87 )
		if( chinkou_span <= 1902.5 )
			if( basis_max <= 50.259 )
				if( senkou_span_b_displaced <= 1478.79 )
					if( basis_max <= -14.5988 )
						ret := 0.018868
					if( basis_max > -14.5988 )
						ret := -0.866667 // sell
				if( senkou_span_b_displaced > 1478.79 )
					if( basis_minus <= -133.186 )
						ret := -0.058824
					if( basis_minus > -133.186 )
						ret := -0.916667 // sell
			if( basis_max > 50.259 )
				if( basis_minus <= -117.405 )
					ret := 1.000000 // buy
				if( basis_minus > -117.405 )
					if( tenkan_sen <= 1507.4 )
						ret := -0.846154 // sell
					if( tenkan_sen > 1507.4 )
						ret := 0.129032
		if( chinkou_span > 1902.5 )
			if( kinjun_sen <= 1706.57 )
				ret := 1.000000 // buy
			if( kinjun_sen > 1706.57 )
				ret := 0.000000
...
float op_operation = decision_tree_0_MELI_1Day_6dca67b2(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
