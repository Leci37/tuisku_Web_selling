...
decision_tree_0_ZI_1Hour_83e7b558(wvf, sDev, upperBand, Color_con2, colInt, rangeHigh, Color_con1, lowerBand, midLine, rangeLow)=>
	...
	if( sDev <= 2.65361 )
		...
		if( Color_con1 > -3.3051 )
				...
				if( midLine <= 0.765296 )
					...
					if( lowerBand > -0.605781 )
						...
						if( Color_con1 > -1.25304 )
							ret := -0.030303
				if( midLine > 0.765296 )
					if( upperBand <= 2.05971 )
						if( Color_con2 <= -1.9709 )
							ret := -0.588235
						if( Color_con2 > -1.9709 )
							ret := -0.965517 // sell
					if( upperBand > 2.05971 )
			...
			if( midLine > 1.06683 )
				if( midLine <= 3.00309 )
					if( Color_con2 <= -1.51625 )
						if( wvf <= 1.42485 )
							ret := -0.027352
						if( wvf > 1.42485 )
							ret := 0.188000
					if( Color_con2 > -1.51625 )
						if( lowerBand <= 0.88511 )
							ret := -0.120654
						if( lowerBand > 0.88511 )
							ret := 0.272189
				if( midLine > 3.00309 )
					if( upperBand <= 7.79149 )
						if( Color_con1 <= -1.88884 )
							ret := -0.334000
						if( Color_con1 > -1.88884 )
							ret := -0.126819
					if( upperBand > 7.79149 )
						if( upperBand <= 8.16348 )
							ret := 0.739130 // buy
						if( upperBand > 8.16348 )
							ret := -0.207317
	if( sDev > 2.65361 )
		if( lowerBand <= -1.60763 )
			if( wvf <= 12.6914 )
				if( midLine <= 2.74603 )
					if( Color_con2 <= 2.7906 )
						if( Color_con2 <= -4.38755 )
							ret := -0.204225
						if( Color_con2 > -4.38755 )
							ret := -0.614679
					if( Color_con2 > 2.7906 )
						...
						if( wvf > 8.78384 )
							ret := 0.800000 // buy
				if( midLine > 2.74603 )
					if( Color_con1 <= -1.42698 )
						if( Color_con1 <= -2.24826 )
							ret := -0.009498
						if( Color_con1 > -2.24826 )
							ret := -0.666667
					if( Color_con1 > -1.42698 )
						if( upperBand <= 8.10985 )
							ret := 1.000000 // buy
						if( upperBand > 8.10985 )
							ret := 0.437500
			if( wvf > 12.6914 )
				if( Color_con1 <= 1.58401 )
					if( Color_con1 <= -7.10816 )
						if( midLine <= 14.1221 )
							ret := -1.000000 // sell
						if( midLine > 14.1221 )
							ret := -0.750000 // sell
				...
				if( midLine <= 8.13236 )
					...
					if( wvf > 11.2601 )
						...
						if( midLine > 7.52404 )
							ret := 0.234043
				if( midLine > 8.13236 )
					if( lowerBand <= 5.56303 )
						if( wvf <= 10.5614 )
							ret := -0.432099
						if( wvf > 10.5614 )
							ret := 0.006390
					if( lowerBand > 5.56303 )
						if( Color_con2 <= -7.2653 )
							ret := -0.562500
						if( Color_con2 > -7.2653 )
							ret := 0.321267
			if( midLine > 16.0356 )
...
float op_operation = decision_tree_0_ZI_1Hour_83e7b558(wvf, sDev, upperBand, Color_con2, colInt, rangeHigh, Color_con1, lowerBand, midLine, rangeLow)
