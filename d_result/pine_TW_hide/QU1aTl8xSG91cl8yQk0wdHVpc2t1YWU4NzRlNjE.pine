				...
				if( Negative_Money_Flow_Sum > 1.03946e+09 )
					if( Typical_Price <= 2416.02 )
						...
						if( Negative_Money_Flow > 2.24127e+09 )
							ret := 0.381395
					if( Typical_Price > 2416.02 )
						if( Negative_Money_Flow_Sum <= 1.5603e+10 )
							ret := -0.141182
						if( Negative_Money_Flow_Sum > 1.5603e+10 )
							ret := -0.553299
	if( bearPower > -0.600547 )
		if( Negative_Money_Flow_Sum <= 5.65898e+09 )
			if( Positive_Money_Flow <= 2.84912e+09 )
				if( Positive_Money_Flow_Sum <= 2.12343e+10 )
					if( Typical_Price <= 116.549 )
						if( bbm <= 1.28371 )
							ret := 0.108065
						if( bbm > 1.28371 )
							ret := 0.490775
			...
			if( Positive_Money_Flow > 2.84912e+09 )
				ret := 0.553191
		if( Negative_Money_Flow_Sum > 5.65898e+09 )
			if( Typical_Price <= 2303.21 )
				if( bearPower <= 0.968419 )
					if( Negative_Money_Flow_Sum <= 6.16561e+09 )
						ret := -0.484615
					if( Negative_Money_Flow_Sum > 6.16561e+09 )
						ret := 0.182836
				if( bearPower > 0.968419 )
					ret := -0.495913
			if( Typical_Price > 2303.21 )
				if( Money_Flow_Ratio <= 0.481162 )
					ret := -0.405128
				if( Money_Flow_Ratio > 0.481162 )
					if( Raw_Money_Flow <= 1.73256e+07 )
						ret := 0.285319
					if( Raw_Money_Flow > 1.73256e+07 )
						ret := -0.122120
...
float op_operation = decision_tree_0_AMZN_1Hour_ae874e61(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
