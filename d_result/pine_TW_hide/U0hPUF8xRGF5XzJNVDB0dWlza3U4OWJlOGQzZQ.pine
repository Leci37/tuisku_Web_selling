...
decision_tree_0_SHOP_1Day_89be8d3e(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( Raw_Money_Flow > 8.06361e+08 )
		...
		if( ema13 > -119.617 )
			if( ema12 <= -1.09628 )
				if( Negative_Money_Flow_Sum <= 1.56102e+10 )
					if( ema13 <= -29.4414 )
						ret := 0.534884
					if( ema13 > -29.4414 )
						ret := 0.078603
				if( Negative_Money_Flow_Sum > 1.56102e+10 )
					if( Money_Flow_Ratio <= 0.711781 )
						ret := -0.070175
					if( Money_Flow_Ratio > 0.711781 )
						ret := -0.861538 // sell
			if( ema12 > -1.09628 )
				if( Money_Flow_Ratio <= 1.6925 )
					if( Positive_Money_Flow_Sum <= 6.97687e+09 )
						ret := 0.094828
					if( Positive_Money_Flow_Sum > 6.97687e+09 )
						ret := -0.607656
				if( Money_Flow_Ratio > 1.6925 )
...
float op_operation = decision_tree_0_SHOP_1Day_89be8d3e(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
