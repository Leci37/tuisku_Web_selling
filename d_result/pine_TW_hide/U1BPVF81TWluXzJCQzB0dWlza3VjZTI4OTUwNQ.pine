				...
				if( ad_mf > 0.088676 )
					if( ad_mf <= 0.140048 )
						...
						if( mf > -0.1256 )
							ret := -0.159011
					if( ad_mf > 0.140048 )
						if( bullPower <= -0.314576 )
							ret := 0.080798
						if( bullPower > -0.314576 )
							ret := -0.030299
	if( bbp > 1.86213 )
		if( mf <= 0.213793 )
			if( bearPower <= 1.03317 )
				if( ad_mf <= -366.431 )
					if( bbp <= 2.14553 )
						if( ad_mf <= -5451.61 )
							ret := -0.357488
				...
				if( ad <= 112938 )
					...
					if( ad_mf > 3588.85 )
						...
						if( ad > 12831.1 )
							ret := -0.024390
				if( ad > 112938 )
					if( bearPower <= 0.57086 )
						ret := 0.000000
					if( bearPower > 0.57086 )
						ret := 1.000000 // buy
			if( ad > 125339 )
				if( bullPower <= 2.22812 )
					ret := -0.500000
				if( bullPower > 2.22812 )
					if( mf <= 0.235545 )
						ret := 0.000000
...
float op_operation = decision_tree_0_SPOT_5Min_ce289505(bbm, bearPower, bbp, bullPower, BBPower_Color, mf, ad, ad_mf)
