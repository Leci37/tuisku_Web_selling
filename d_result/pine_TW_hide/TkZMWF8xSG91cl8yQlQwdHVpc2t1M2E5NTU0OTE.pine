			...
			if( ema12 <= 7.00801 )
				if( tema <= 316.811 )
					...
					if( ema1 > 313.988 )
						ret := 1.000000 // buy
				if( tema > 316.811 )
					if( bearPower <= -27.7096 )
						if( bbm <= 37.3959 )
							ret := 0.958333 // buy
						if( bbm > 37.3959 )
							ret := -0.571429
					if( bearPower > -27.7096 )
						if( bearPower <= -18.4719 )
							ret := -0.959184 // sell
						if( bearPower > -18.4719 )
							ret := -0.440994
			if( ema12 > 7.00801 )
				if( bearPower <= 1.94394 )
					ret := -0.800000 // sell
				if( bearPower > 1.94394 )
					if( bbm <= 12.6417 )
						ret := -0.166667
...
float op_operation = decision_tree_0_NFLX_1Hour_3a955491(bearPower, bbm, bbp, bullPower, BBPower_Color, ema12, ema3, ema13, tema, ema1, ema2)
