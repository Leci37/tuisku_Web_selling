			...
			if( Positive_Money_Flow > 1.94337e+07 )
				...
				if( Positive_Money_Flow_Sum > 8.78096e+08 )
					...
					if( d_k > -0.089781 )
						ret := 0.068966
		if( Raw_Money_Flow > 1.17597e+08 )
			if( Typical_Price <= 315.909 )
				if( Negative_Money_Flow_Sum <= 1.72503e+09 )
					if( Positive_Money_Flow_Sum <= 1.66234e+09 )
						ret := 0.084967
					if( Positive_Money_Flow_Sum > 1.66234e+09 )
						ret := -0.666667
				if( Negative_Money_Flow_Sum > 1.72503e+09 )
					...
					if( d > 3.15396 )
						ret := 0.779070 // buy
			if( Typical_Price > 315.909 )
				if( Negative_Money_Flow_Sum <= 2.28402e+09 )
					if( MFI_High <= -32.1446 )
						ret := 0.197452
					if( MFI_High > -32.1446 )
						ret := -0.318008
...
float op_operation = decision_tree_0_EPAM_1Day_71bc4222(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
