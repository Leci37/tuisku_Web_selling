...
decision_tree_0_EPAM_1Hour_13bebc40(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)=>
	...
	if( pvi > 0.909106 )
		if( stoc <= 92.0172 )
			if( azul_mean <= -17.1339 )
				if( xmf <= 66.133 )
					if( azul_mean <= -45.5497 )
						ret := -0.909091 // sell
					if( azul_mean > -45.5497 )
						if( azul <= -20.9319 )
							ret := 0.515625
...
float op_operation = decision_tree_0_EPAM_1Hour_13bebc40(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
