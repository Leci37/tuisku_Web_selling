			...
			if( ad_mf > 225852 )
				...
				if( ad > 5.27504e+06 )
					...
					if( ad > 7.10371e+06 )
						ret := 0.257732
		if( smoothD_d > 35.4313 )
			if( smoothD_d <= 57.8875 )
				if( rsi1 <= 35.982 )
					if( smoothK_k <= 37.9502 )
						ret := 0.111111
					if( smoothK_k > 37.9502 )
						ret := 0.600000
				if( rsi1 > 35.982 )
...
float op_operation = decision_tree_0_DOTUSDT_1Day_3c8ead42(mf, ad_mf, ad, d, d_k, smoothK_k, k, rsi1, smoothD_d)
