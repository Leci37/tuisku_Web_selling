...
decision_tree_0_DOCN_30Min_59d4f100(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( Money_Flow_Ratio > 0.636088 )
		if( d_k <= 4.49746 )
			...
			if( Raw_Money_Flow > 51340.1 )
				if( d <= 96.9029 )
					if( Negative_Money_Flow <= 2.79963e+06 )
						if( Negative_Money_Flow <= 114570 )
							ret := 0.068953
						if( Negative_Money_Flow > 114570 )
							ret := -0.134985
					if( Negative_Money_Flow > 2.79963e+06 )
				...
				if( d > 96.9029 )
					ret := -0.200331
		if( d_k > 4.49746 )
			if( Positive_Money_Flow_Sum <= 1.90194e+07 )
				if( Positive_Money_Flow_Sum <= 7.43925e+06 )
					ret := -0.457143
				if( Positive_Money_Flow_Sum > 7.43925e+06 )
					if( Positive_Money_Flow_Sum <= 1.09402e+07 )
						if( Positive_Money_Flow <= 1.23082e+06 )
							ret := 0.442857
						if( Positive_Money_Flow > 1.23082e+06 )
							ret := -0.301887
					if( Positive_Money_Flow_Sum > 1.09402e+07 )
						if( Raw_Money_Flow <= 14084 )
							ret := -0.500000
						if( Raw_Money_Flow > 14084 )
							ret := -0.023502
			if( Positive_Money_Flow_Sum > 1.90194e+07 )
				if( Negative_Money_Flow_Sum <= 2.14123e+06 )
					ret := 0.679612
				if( Negative_Money_Flow_Sum > 2.14123e+06 )
					if( Negative_Money_Flow_Sum <= 3.73069e+06 )
						ret := -0.586957
					if( Negative_Money_Flow_Sum > 3.73069e+06 )
						ret := 0.229909
...
float op_operation = decision_tree_0_DOCN_30Min_59d4f100(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
