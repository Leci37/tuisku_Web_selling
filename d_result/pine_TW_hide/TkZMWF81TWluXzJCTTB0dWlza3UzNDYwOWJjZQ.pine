			...
			if( bbp <= 1.02266 )
				if( Money_Flow_Ratio <= 3.09776 )
					if( Positive_Money_Flow_Sum <= 350734 )
						ret := -0.863636 // sell
					if( Positive_Money_Flow_Sum > 350734 )
						if( Typical_Price <= 640.136 )
							ret := 0.166551
						if( Typical_Price > 640.136 )
							ret := -0.333333
				if( Money_Flow_Ratio > 3.09776 )
					if( Positive_Money_Flow_Sum <= 1.73474e+06 )
						ret := -0.545455
					if( Positive_Money_Flow_Sum > 1.73474e+06 )
						ret := -0.941176 // sell
			if( bbp > 1.02266 )
				if( Positive_Money_Flow_Sum <= 1.09376e+06 )
					if( Typical_Price <= 476.011 )
						if( Money_Flow_Ratio <= 0.788683 )
							ret := -0.152542
						if( Money_Flow_Ratio > 0.788683 )
							ret := 0.431818
					if( Typical_Price > 476.011 )
						if( Raw_Money_Flow <= 129509 )
							ret := 1.000000 // buy
						if( Raw_Money_Flow > 129509 )
							ret := 0.437500
				if( Positive_Money_Flow_Sum > 1.09376e+06 )
					if( Typical_Price <= 440.589 )
						if( Negative_Money_Flow_Sum <= 1.69295e+06 )
							ret := -0.255319
						if( Negative_Money_Flow_Sum > 1.69295e+06 )
							ret := -0.686667
					if( Typical_Price > 440.589 )
						if( Positive_Money_Flow <= 430272 )
							ret := -0.179331
						if( Positive_Money_Flow > 430272 )
							ret := 0.550000
	if( Positive_Money_Flow_Sum > 2.01129e+06 )
		if( Negative_Money_Flow_Sum <= 1.26063e+08 )
			if( bullPower <= -0.238626 )
				if( Money_Flow_Ratio <= 6.87791 )
					if( Positive_Money_Flow_Sum <= 3.9951e+06 )
						if( bearPower <= -2.73961 )
							ret := -0.243697
						if( bearPower > -2.73961 )
							ret := 0.294363
					if( Positive_Money_Flow_Sum > 3.9951e+06 )
						if( Negative_Money_Flow_Sum <= 3.83507e+06 )
							ret := -0.354037
						if( Negative_Money_Flow_Sum > 3.83507e+06 )
							ret := 0.069760
				if( Money_Flow_Ratio > 6.87791 )
					if( Typical_Price <= 520.491 )
						if( Negative_Money_Flow <= 93184.8 )
							ret := -0.285714
						if( Negative_Money_Flow > 93184.8 )
							ret := 0.468750
					if( Typical_Price > 520.491 )
						...
						if( MFI_High > 15.1133 )
							ret := 0.423077
			if( bullPower > -0.238626 )
				if( Positive_Money_Flow_Sum <= 4.76589e+07 )
					if( Typical_Price <= 423.919 )
						if( Negative_Money_Flow <= 575648 )
							ret := 0.016165
						if( Negative_Money_Flow > 575648 )
							ret := 0.262411
					if( Typical_Price > 423.919 )
						if( bullPower <= 6.16461 )
							ret := -0.090419
						if( bullPower > 6.16461 )
							ret := -0.916667 // sell
				if( Positive_Money_Flow_Sum > 4.76589e+07 )
					if( bbm <= 1.2083 )
						if( bullPower <= 2.35836 )
							ret := -0.001532
						if( bullPower > 2.35836 )
							ret := 0.238095
					if( bbm > 1.2083 )
		...
		if( Negative_Money_Flow_Sum > 1.26063e+08 )
			if( bbp <= 17.8484 )
				...
				if( Positive_Money_Flow_Sum > 7.88758e+08 )
					if( MFI_High <= 6.1609 )
						if( bearPower <= -4.05523 )
							ret := 0.200000
						if( bearPower > -4.05523 )
							ret := -0.457686
					if( MFI_High > 6.1609 )
						if( Positive_Money_Flow_Sum <= 3.80075e+09 )
							ret := 0.677966
						if( Positive_Money_Flow_Sum > 3.80075e+09 )
							ret := -1.000000 // sell
			if( bbp > 17.8484 )
...
float op_operation = decision_tree_0_NFLX_5Min_34609bce(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
