			...
			if( basis_minus > -4.59716 )
				if( chinkou_span <= 169.655 )
					...
					if( senkou_span_b > 169.828 )
						ret := 0.018182
				if( chinkou_span > 169.655 )
					if( basis_max <= -4.26281 )
						ret := -0.242236
					if( basis_max > -4.26281 )
						ret := 0.468900
		if( basis_max > 13.7358 )
			if( senkou_span_b <= 247.525 )
				if( chinkou_span <= 167.56 )
					ret := 0.000000
				if( chinkou_span > 167.56 )
					ret := 0.250000
			if( senkou_span_b > 247.525 )
				if( kinjun_sen <= 320.007 )
					if( basis_minus <= -28.3898 )
						ret := 1.000000 // buy
					if( basis_minus > -28.3898 )
						ret := 0.500000
				if( kinjun_sen > 320.007 )
					if( tenkan_sen <= 300.999 )
						ret := -0.400000
					if( tenkan_sen > 300.999 )
						ret := 0.750000 // buy
...
float op_operation = decision_tree_0_SNOW_1Day_539eff3f(tenkan_sen, basis_minus, cross_up_tenkan_kinjunInt, senkou_span_a, cross_dn_tenkan_kinjunInt, senkou_span_b, chinkou_span, senkou_span_a_displaced, senkou_span_b_displaced, kinjun_sen, basis_max)
