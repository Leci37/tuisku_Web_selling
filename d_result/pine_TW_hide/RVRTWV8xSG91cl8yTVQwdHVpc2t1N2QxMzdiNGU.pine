...
decision_tree_0_ETSY_1Hour_7d137b4e(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( Negative_Money_Flow_Sum <= 2.1923e+08 )
		...
		if( ema2 > 40.7743 )
			...
			if( Positive_Money_Flow > 14168.5 )
				if( MFI_High <= -75.1905 )
					if( Negative_Money_Flow_Sum <= 1.97095e+08 )
						if( ema12 <= -0.318624 )
							ret := 1.000000 // buy
						if( ema12 > -0.318624 )
							ret := 0.000000
	...
	if( Negative_Money_Flow_Sum > 2.1923e+08 )
		if( Positive_Money_Flow_Sum <= 1.06025e+08 )
			if( Typical_Price <= 123.921 )
				if( ema12 <= -0.657658 )
					if( ema13 <= -2.76207 )
						if( Negative_Money_Flow_Sum <= 3.92971e+08 )
							ret := -0.497110
						if( Negative_Money_Flow_Sum > 3.92971e+08 )
							ret := 0.232759
					if( ema13 > -2.76207 )
						...
						if( ema2 > 99.7497 )
							ret := -0.036364
				if( ema12 > -0.657658 )
					if( Negative_Money_Flow_Sum <= 2.36036e+08 )
						if( Negative_Money_Flow <= 4.7627e+07 )
							ret := -0.687898
						if( Negative_Money_Flow > 4.7627e+07 )
							ret := 0.363636
					if( Negative_Money_Flow_Sum > 2.36036e+08 )
						if( Money_Flow_Ratio <= 0.370758 )
							ret := -0.248466
						if( Money_Flow_Ratio > 0.370758 )
							ret := 0.592593
			if( Typical_Price > 123.921 )
		...
		if( Positive_Money_Flow_Sum > 1.06025e+08 )
			if( Negative_Money_Flow_Sum <= 3.27741e+08 )
				if( ema13 <= -0.420316 )
					if( ema12 <= -0.338466 )
						if( Negative_Money_Flow_Sum <= 2.72485e+08 )
							ret := -0.018545
						if( Negative_Money_Flow_Sum > 2.72485e+08 )
							ret := -0.250302
					if( ema12 > -0.338466 )
						if( Raw_Money_Flow <= 3.15548e+06 )
							ret := -0.650307
						if( Raw_Money_Flow > 3.15548e+06 )
							ret := -0.236641
				if( ema13 > -0.420316 )
					if( ema12 <= 2.76993 )
						if( Negative_Money_Flow_Sum <= 2.45577e+08 )
							ret := 0.161893
						if( Negative_Money_Flow_Sum > 2.45577e+08 )
							ret := -0.073084
					if( ema12 > 2.76993 )
						if( Positive_Money_Flow_Sum <= 8.20143e+08 )
							ret := -0.650943
						if( Positive_Money_Flow_Sum > 8.20143e+08 )
							ret := 1.000000 // buy
			if( Negative_Money_Flow_Sum > 3.27741e+08 )
...
float op_operation = decision_tree_0_ETSY_1Hour_7d137b4e(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
