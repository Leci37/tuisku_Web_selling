				...
				if( Typical_Price > 1342.89 )
					...
					if( Negative_Money_Flow_Sum > 7.81671e+07 )
						...
						if( MFI > 48.695 )
							ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 8.35811e+07 )
				if( Raw_Money_Flow <= 1.57744e+06 )
					ret := -0.864865 // sell
				if( Raw_Money_Flow > 1.57744e+06 )
					if( Typical_Price <= 1832.96 )
						if( Negative_Money_Flow_Sum <= 1.03451e+08 )
							ret := -1.000000 // sell
						if( Negative_Money_Flow_Sum > 1.03451e+08 )
							ret := 0.714286 // buy
					if( Typical_Price > 1832.96 )
						if( Positive_Money_Flow_Sum <= 4.21217e+07 )
							ret := -1.000000 // sell
						if( Positive_Money_Flow_Sum > 4.21217e+07 )
							ret := 0.800000 // buy
		if( Positive_Money_Flow > 1.48006e+06 )
			if( Negative_Money_Flow_Sum <= 8.81991e+07 )
				if( Positive_Money_Flow_Sum <= 1.88698e+08 )
					if( Positive_Money_Flow <= 1.22076e+07 )
						if( Negative_Money_Flow_Sum <= 7.21056e+07 )
							ret := 0.025355
						if( Negative_Money_Flow_Sum > 7.21056e+07 )
							ret := 0.647059
					if( Positive_Money_Flow > 1.22076e+07 )
						if( Negative_Money_Flow_Sum <= 3.1748e+07 )
							ret := 0.634241
						if( Negative_Money_Flow_Sum > 3.1748e+07 )
							ret := -0.059211
				if( Positive_Money_Flow_Sum > 1.88698e+08 )
...
float op_operation = decision_tree_0_MELI_1Min_c1d4114d(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
