...
decision_tree_0_HUBS_1Hour_900b421c(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)=>
	...
	if( ad_mf > 111225 )
		...
		if( ad_mf > 139945 )
			if( bbm <= 9.71177 )
				if( ad_mf <= 154382 )
					if( bullPower <= 6.82939 )
						ret := 0.870968 // buy
					if( bullPower > 6.82939 )
						ret := -0.071429
				if( ad_mf > 154382 )
					if( bullPower <= 2.97083 )
						if( mf <= 0.215595 )
							ret := -0.118421
						if( mf > 0.215595 )
							ret := -0.782609 // sell
...
float op_operation = decision_tree_0_HUBS_1Hour_900b421c(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
