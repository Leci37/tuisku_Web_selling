	...
	if( smoothedDirectionalMovementMinus > 0.212197 )
				...
				if( diMinus <= 20.9759 )
					...
					if( dx > 12.0669 )
						...
						if( diMinus > 16.0328 )
							ret := 0.085847
				if( diMinus > 20.9759 )
					if( smoothedDirectionalMovementPlus <= 0.865574 )
						if( directionalMovementPlus <= 0.004626 )
							ret := 0.009091
						if( directionalMovementPlus > 0.004626 )
							ret := -0.133612
					if( smoothedDirectionalMovementPlus > 0.865574 )
						if( trueRange <= 3.39647 )
							ret := 0.104478
						if( trueRange > 3.39647 )
							ret := 0.666667
			if( directionalMovementMinus > 0.187894 )
				if( diMinus <= 55.8062 )
					if( directionalMovementPlus <= 1.50615 )
						if( diMinus <= 50.2158 )
							ret := 0.034479
						if( diMinus > 50.2158 )
							ret := -0.304933
		...
		if( smoothedDirectionalMovementPlus > 1.13464 )
			if( dx <= 19.5544 )
				ret := -0.600000
			if( dx > 19.5544 )
				if( smoothedDirectionalMovementMinus <= 3.07696 )
					if( diMinus <= 10.5395 )
						ret := -0.442231
					if( diMinus > 10.5395 )
						ret := -0.102616
...
float op_operation = decision_tree_0_CRWD_1Hour_6244e265(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
