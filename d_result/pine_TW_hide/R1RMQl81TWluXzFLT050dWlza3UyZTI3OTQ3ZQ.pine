			...
			if( azul_mean > -45.6594 )
				...
				if( oscp > 60.2308 )
					...
					if( azul_mean > -4.56575 )
						ret := 0.000000
	if( BollOsc > 26.0023 )
		if( marron_mean <= 48.7175 )
			if( verde <= 66.1759 )
				if( verde_mean <= 40.5472 )
					if( BollOsc <= 36.9931 )
						ret := -0.595238
					if( BollOsc > 36.9931 )
						ret := 0.090909
				if( verde_mean > 40.5472 )
					ret := 1.000000 // buy
			if( verde > 66.1759 )
				if( media_azul <= -94.0575 )
					if( source <= 49.1121 )
						ret := 1.000000 // buy
					if( source > 49.1121 )
						ret := -0.333333
				if( media_azul > -94.0575 )
					if( media_azul <= 38.6248 )
						ret := -0.867052 // sell
					if( media_azul > 38.6248 )
						ret := -0.444444
		if( marron_mean > 48.7175 )
			if( BollOsc <= 71.0367 )
				...
				if( tprice > 45.9094 )
					...
					if( marron > 120.689 )
						ret := -0.368547
			if( BollOsc > 71.0367 )
				if( verde_azul <= 131.464 )
					if( verde_azul <= 70.4857 )
						ret := -0.014599
					if( verde_azul > 70.4857 )
						ret := -0.784615 // sell
				if( verde_azul > 131.464 )
					if( marron_mean <= 103.325 )
						ret := -0.386861
					if( marron_mean > 103.325 )
						ret := 0.243902
...
float op_operation = decision_tree_0_GTLB_5Min_2e27947e(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
