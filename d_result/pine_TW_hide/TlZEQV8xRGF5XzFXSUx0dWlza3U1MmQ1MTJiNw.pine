...
decision_tree_0_NVDA_1Day_52d512b7(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)=>
	...
	if( upperBand > 30.76 )
		if( wvf <= 30.8934 )
			if( sDev <= 7.93328 )
				if( Color_con1 <= -10.2664 )
					ret := 0.375000
				if( Color_con1 > -10.2664 )
					ret := 1.000000 // buy
			if( sDev > 7.93328 )
				if( wvf <= 3.33924 )
					if( Color_con2 <= -25.0494 )
						ret := 0.000000
					if( Color_con2 > -25.0494 )
						ret := 0.850000 // buy
				if( wvf > 3.33924 )
					if( lowerBand <= 24.9418 )
						ret := -0.620879
					if( lowerBand > 24.9418 )
						ret := 1.000000 // buy
		if( wvf > 30.8934 )
			if( sDev <= 13.9959 )
				if( Color_con2 <= 0.82788 )
					if( Color_con2 <= -2.36444 )
						ret := -0.500000
					if( Color_con2 > -2.36444 )
						ret := -0.933333 // sell
				if( Color_con2 > 0.82788 )
...
float op_operation = decision_tree_0_NVDA_1Day_52d512b7(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
