		...
		if( bbm <= 0.730981 )
			if( bearPower <= -0.336122 )
				...
				if( bbp > -0.370768 )
					ret := 0.681481
			if( bearPower > -0.336122 )
				if( bullPower <= 0.660242 )
					if( bullPower <= 0.648055 )
						if( bullPower <= -0.296663 )
							ret := 0.638889
						if( bullPower > -0.296663 )
							ret := 0.035413
					if( bullPower > 0.648055 )
				...
				if( bullPower > 0.660242 )
					if( bbp <= 1.38385 )
						if( bearPower <= 0.358008 )
							ret := 0.160839
						if( bearPower > 0.358008 )
							ret := 0.575064
					if( bbp > 1.38385 )
						if( bearPower <= 2.43128 )
							ret := 0.059524
						if( bearPower > 2.43128 )
							ret := -0.640000
		if( bbm > 0.730981 )
			if( bullPower <= 5.69761 )
				if( bbp <= 9.07371 )
					if( bbp <= 0.617921 )
						if( bearPower <= -0.188228 )
							ret := -0.164000
						if( bearPower > -0.188228 )
							ret := -0.781250 // sell
					if( bbp > 0.617921 )
						if( bullPower <= 0.744885 )
							ret := 0.763158 // buy
						if( bullPower > 0.744885 )
							ret := -0.076583
				if( bbp > 9.07371 )
...
float op_operation = decision_tree_0_AFRM_1Hour_aae533ce(bullPower, bbp, bearPower, bbm, BBPower_Color)
