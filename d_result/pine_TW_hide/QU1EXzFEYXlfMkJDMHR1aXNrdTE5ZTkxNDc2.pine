			...
			if( mf > -0.086802 )
				if( mf <= 0.295239 )
					...
					if( ad > 7.28236e+07 )
						ret := -0.870370 // sell
				if( mf > 0.295239 )
					if( bearPower <= 0.631352 )
						ret := -1.000000 // sell
					if( bearPower > 0.631352 )
						ret := 0.428571
		if( ad > 9.25348e+07 )
			if( bearPower <= 2.35927 )
				if( bearPower <= 0.150664 )
					if( ad <= 1.22972e+08 )
						ret := 0.937500 // buy
					if( ad > 1.22972e+08 )
						ret := -0.384615
				if( bearPower > 0.150664 )
					if( bullPower <= 2.45134 )
						ret := -0.916667 // sell
					if( bullPower > 2.45134 )
						ret := -0.185185
			if( bearPower > 2.35927 )
...
float op_operation = decision_tree_0_AMD_1Day_19e91476(bullPower, bbp, bearPower, bbm, BBPower_Color, ad, mf, ad_mf)
