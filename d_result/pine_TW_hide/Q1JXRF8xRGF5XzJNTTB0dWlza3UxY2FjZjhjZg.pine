			...
			if( Positive_Money_Flow_Sum <= 4.05579e+09 )
				...
				if( Long_MA > 57.8544 )
					...
					if( Typical_Price > 66.9301 )
						ret := 0.642857
			if( Positive_Money_Flow_Sum > 4.05579e+09 )
				if( Raw_Money_Flow <= 4.52741e+08 )
					if( Long_MA <= 107.466 )
						ret := 0.000000
					if( Long_MA > 107.466 )
						ret := -0.875000 // sell
				if( Raw_Money_Flow > 4.52741e+08 )
					if( Short_Long_Diff <= 1.48219 )
						ret := -0.312500
					if( Short_Long_Diff > 1.48219 )
						ret := 0.408602
		if( Long_MA > 127.881 )
			if( Positive_Money_Flow_Sum <= 2.98598e+09 )
				if( Typical_Price <= 152.413 )
					if( Negative_Money_Flow_Sum <= 4.36031e+09 )
						ret := 0.808511 // buy
					if( Negative_Money_Flow_Sum > 4.36031e+09 )
						ret := 0.400000
				if( Typical_Price > 152.413 )
					...
					if( Long_MA > 161.352 )
						ret := 0.333333
			if( Positive_Money_Flow_Sum > 2.98598e+09 )
				if( Negative_Money_Flow_Sum <= 4.24856e+09 )
					if( Short_Long_Diff <= 10.2178 )
						ret := -0.417219
					if( Short_Long_Diff > 10.2178 )
						ret := 0.124031
				if( Negative_Money_Flow_Sum > 4.24856e+09 )
					if( Short_Long_Diff <= 3.46122 )
						ret := -0.082658
					if( Short_Long_Diff > 3.46122 )
						ret := 0.333333
...
float op_operation = decision_tree_0_CRWD_1Day_1cacf8cf(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
