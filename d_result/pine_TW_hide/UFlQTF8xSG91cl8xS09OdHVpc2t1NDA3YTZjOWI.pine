...
decision_tree_0_PYPL_1Hour_407a6c9b(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)=>
	...
	if( nvi > 1.47351 )
				...
				if( verde <= 130.954 )
					if( media <= 103.405 )
						...
						if( media > 89.0243 )
							ret := 0.085852
					if( media > 103.405 )
						if( verde_azul <= 126.094 )
							ret := -0.511111
						if( verde_azul > 126.094 )
							ret := 0.333333
				if( verde > 130.954 )
					if( verde <= 137.283 )
						if( media_azul <= 92.1984 )
							ret := -0.121212
						if( media_azul > 92.1984 )
							ret := 0.722222 // buy
					if( verde > 137.283 )
		...
		if( pvi_ema > -1.25039 )
			...
			if( pvi_ema > -0.059728 )
				if( azul <= -5.00825 )
					if( azul_mean <= -6.06831 )
						ret := -0.928571 // sell
					if( azul_mean > -6.06831 )
						ret := 0.823529 // buy
				if( azul > -5.00825 )
					if( nvi <= 1.50595 )
						if( media_azul <= 49.6448 )
							ret := -0.050000
						if( media_azul > 49.6448 )
							ret := -0.956522 // sell
					if( nvi > 1.50595 )
...
float op_operation = decision_tree_0_PYPL_1Hour_407a6c9b(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
