...
decision_tree_0_ADSK_1Day_432b255e(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)=>
	...
	if( Typical_Price > 204.309 )
		if( VIM <= 1.23755 )
			if( Negative_Money_Flow_Sum <= 3.35617e+09 )
				if( Positive_Money_Flow <= 5.10873e+08 )
					if( Positive_Money_Flow_Sum <= 2.26768e+09 )
						ret := 0.084034
					if( Positive_Money_Flow_Sum > 2.26768e+09 )
						ret := -0.271676
				if( Positive_Money_Flow > 5.10873e+08 )
					if( Negative_Money_Flow_Sum <= 2.25946e+09 )
						ret := 0.612245
					if( Negative_Money_Flow_Sum > 2.25946e+09 )
						ret := -0.045455
			if( Negative_Money_Flow_Sum > 3.35617e+09 )
				if( Positive_Money_Flow_Sum <= 3.41164e+09 )
					if( Raw_Money_Flow <= 3.13367e+08 )
						ret := 0.250000
					if( Raw_Money_Flow > 3.13367e+08 )
						ret := -0.652174
				if( Positive_Money_Flow_Sum > 3.41164e+09 )
					if( Negative_Money_Flow_Sum <= 4.12325e+09 )
						ret := -0.153846
					if( Negative_Money_Flow_Sum > 4.12325e+09 )
						ret := 0.375000
		if( VIM > 1.23755 )
			if( Typical_Price <= 246.246 )
				if( Typical_Price <= 227.139 )
					if( VIP <= 0.989793 )
						ret := 0.500000
					if( VIP > 0.989793 )
						ret := -0.625000
				if( Typical_Price > 227.139 )
					if( Negative_Money_Flow_Sum <= 4.55845e+09 )
						ret := -1.000000 // sell
					if( Negative_Money_Flow_Sum > 4.55845e+09 )
						ret := 0.000000
			if( Typical_Price > 246.246 )
				if( Typical_Price <= 279.657 )
					if( Money_Flow_Ratio <= 0.408593 )
						ret := 0.958333 // buy
					if( Money_Flow_Ratio > 0.408593 )
						ret := 0.562500
				if( Typical_Price > 279.657 )
...
float op_operation = decision_tree_0_ADSK_1Day_432b255e(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
