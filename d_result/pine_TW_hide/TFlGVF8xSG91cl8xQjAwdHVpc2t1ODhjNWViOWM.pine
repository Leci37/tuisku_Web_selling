		...
		if( bbp <= -0.266468 )
			if( bbp <= -1.87783 )
				...
				if( bbm > 3.64945 )
					ret := -1.000000 // sell
			if( bbp > -1.87783 )
				if( bearPower <= -0.157972 )
					if( bullPower <= -0.061835 )
						if( bbp <= -0.370943 )
							ret := -0.067264
						if( bbp > -0.370943 )
							ret := 0.172816
					if( bullPower > -0.061835 )
						if( bearPower <= -0.886348 )
							ret := 0.082492
						if( bearPower > -0.886348 )
							ret := -0.217446
				if( bearPower > -0.157972 )
					if( bbm <= 0.008696 )
						if( bearPower <= -0.133765 )
							ret := -0.873016 // sell
						if( bearPower > -0.133765 )
							ret := -0.200000
					if( bbm > 0.008696 )
						if( bullPower <= -0.12965 )
							ret := 0.400000
						if( bullPower > -0.12965 )
							ret := -0.375000
		if( bbp > -0.266468 )
			if( bullPower <= 2.28329 )
				if( bbm <= 1.58025 )
					if( bullPower <= -0.119359 )
						if( bearPower <= -0.132199 )
							ret := -0.200000
						if( bearPower > -0.132199 )
							ret := 0.885714 // buy
					if( bullPower > -0.119359 )
				...
				if( bbm > 1.58025 )
					if( BBPower_Color <= 0.5 )
						...
						if( bbp > -0.229088 )
							ret := -0.487179
					if( BBPower_Color > 0.5 )
						if( bearPower <= -1.50306 )
							ret := -1.000000 // sell
						if( bearPower > -1.50306 )
							ret := 0.618605
			if( bullPower > 2.28329 )
				if( bearPower <= -1.58628 )
					ret := 0.866667 // buy
				if( bearPower > -1.58628 )
					if( bearPower <= 2.57328 )
						if( bbm <= 0.889741 )
							ret := 0.000000
						if( bbm > 0.889741 )
							ret := -0.520231
...
float op_operation = decision_tree_0_LYFT_1Hour_88c5eb9c(bearPower, bbm, bbp, bullPower, BBPower_Color)
