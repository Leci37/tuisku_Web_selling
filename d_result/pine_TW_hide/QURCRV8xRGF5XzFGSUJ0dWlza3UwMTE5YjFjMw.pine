		...
		if( basis_minus <= 296.813 )
			...
			if( upper_5 > 744.526 )
				...
				if( upper_5 > 746.38 )
					ret := 0.769231 // buy
		if( basis_minus > 296.813 )
			if( basis_minus <= 298.123 )
				if( basis_minus <= 297.285 )
					ret := 0.833333 // buy
				if( basis_minus > 297.285 )
					ret := 1.000000 // buy
			if( basis_minus > 298.123 )
...
float op_operation = decision_tree_0_ADBE_1Day_0119b1c3(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
