			...
			if( chinkou_span > 103.653 )
				...
				if( senkou_span_a_displaced > 91.6693 )
					...
					if( basis_max > 1.20696 )
						ret := 0.598086
	if( senkou_span_a_displaced > 212.268 )
		if( tenkan_sen <= 145.425 )
			if( chinkou_span <= 140.809 )
				ret := 1.000000 // buy
			if( chinkou_span > 140.809 )
				if( senkou_span_b <= 198.89 )
					ret := -1.000000 // sell
				if( senkou_span_b > 198.89 )
					ret := 0.000000
		if( tenkan_sen > 145.425 )
			if( chinkou_span <= 209.325 )
				if( senkou_span_b_displaced <= 209.224 )
					if( kinjun_sen <= 242.49 )
						ret := -0.058824
					if( kinjun_sen > 242.49 )
						ret := -1.000000 // sell
				if( senkou_span_b_displaced > 209.224 )
					if( senkou_span_b <= 200.329 )
						ret := -0.428571
					if( senkou_span_b > 200.329 )
						ret := -0.925466 // sell
			if( chinkou_span > 209.325 )
				if( senkou_span_b_displaced <= 201.888 )
					ret := 1.000000 // buy
				if( senkou_span_b_displaced > 201.888 )
					ret := 0.000000
...
float op_operation = decision_tree_0_ETSY_1Day_f0ebf27c(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
