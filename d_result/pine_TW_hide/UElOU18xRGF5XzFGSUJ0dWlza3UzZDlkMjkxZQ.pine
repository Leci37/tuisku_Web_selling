...
decision_tree_0_PINS_1Day_3d9d291e(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( lower_2 > 16.788 )
		if( lower_5 <= -2.52187 )
			...
			if( lower_6 > -17.9462 )
				if( upper_2 <= 66.6759 )
					if( basis_max <= -59.5432 )
						ret := 0.785714 // buy
					if( basis_max > -59.5432 )
						ret := 0.968750 // buy
				if( upper_2 > 66.6759 )
					if( basis_max <= -61.4896 )
						ret := 0.000000
					if( basis_max > -61.4896 )
						ret := -1.000000 // sell
		if( lower_5 > -2.52187 )
...
float op_operation = decision_tree_0_PINS_1Day_3d9d291e(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
