		...
		if( basis_max <= -0.233095 )
			...
			if( lower_2 > 0.813522 )
				if( lower_6 <= 0.637935 )
					ret := -0.544444
				if( lower_6 > 0.637935 )
					if( basis_minus <= 0.242568 )
						ret := 0.761905 // buy
					if( basis_minus > 0.242568 )
						if( basis_max <= -0.561914 )
							ret := 0.318033
						if( basis_max > -0.561914 )
							ret := -0.063460
		if( basis_max > -0.233095 )
...
float op_operation = decision_tree_0_XRPUSDT_1Hour_b46db3f9(basis_minus, lower_4, lower_6, upper_1, upper_3, lower_2, basis, upper_4, upper_5, lower_1, upper_6, lower_3, basis_max, lower_5, upper_2)
