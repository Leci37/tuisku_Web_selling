		...
		if( bbp > 15.2578 )
			if( bearPower <= 4.2355 )
				...
				if( Lower_Band > 1877.33 )
					ret := 0.125000
			if( bearPower > 4.2355 )
				if( Upper_Band <= 1452.87 )
					if( bbp <= 18.6784 )
						ret := -0.555556
					if( bbp > 18.6784 )
						if( bullPower <= 24.9955 )
							ret := -1.000000 // sell
						if( bullPower > 24.9955 )
							ret := 0.000000
				if( Upper_Band > 1452.87 )
					...
					if( basis > 1628.85 )
						...
						if( bbm > 1.41802 )
							ret := -0.363946
	if( Lower_Band > 2107.67 )
		if( Lower_Band <= 2134.31 )
			if( Upper_Band <= 2168.6 )
				if( Upper_Band <= 2141.96 )
					if( bearPower <= -5.98839 )
						if( bbm <= 2.64788 )
							ret := 0.000000
						if( bbm > 2.64788 )
							ret := 0.894737 // buy
					if( bearPower > -5.98839 )
						...
						if( basis > 2124.39 )
							ret := 0.094262
				if( Upper_Band > 2141.96 )
					if( Upper_Band <= 2148.66 )
						if( Lower_Band <= 2119.93 )
							ret := -0.964912 // sell
						if( Lower_Band > 2119.93 )
							ret := -0.685185
					if( Upper_Band > 2148.66 )
						if( bullPower <= 4.40262 )
							ret := -0.080000
						if( bullPower > 4.40262 )
							ret := -1.000000 // sell
			if( Upper_Band > 2168.6 )
				if( bullPower <= -0.371212 )
					ret := 1.000000 // buy
				if( bullPower > -0.371212 )
					ret := -0.333333
		if( Lower_Band > 2134.31 )
			if( Upper_Band <= 2165.43 )
				if( basis <= 2144.29 )
					ret := -1.000000 // sell
				if( basis > 2144.29 )
					if( basis <= 2144.8 )
...
float op_operation = decision_tree_0_MELI_1Min_294670cf(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
