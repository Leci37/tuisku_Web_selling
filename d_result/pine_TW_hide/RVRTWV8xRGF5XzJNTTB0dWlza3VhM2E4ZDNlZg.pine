			...
			if( Short_Long_Diff <= 6.77373 )
				...
				if( Negative_Money_Flow > 1.23322e+06 )
					...
					if( MA_Cross > 23.9432 )
						ret := 0.500000
			if( Short_Long_Diff > 6.77373 )
				if( Positive_Money_Flow_Sum <= 4.23033e+09 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 4.23033e+09 )
					if( MFI_High <= 0.328309 )
						ret := 0.555556
					if( MFI_High > 0.328309 )
						ret := 0.000000
		if( Negative_Money_Flow_Sum > 1.52817e+09 )
			if( Long_MA <= 219.628 )
				if( Positive_Money_Flow_Sum <= 3.83121e+09 )
					if( Negative_Money_Flow_Sum <= 2.61378e+09 )
						ret := 0.064386
					if( Negative_Money_Flow_Sum > 2.61378e+09 )
						ret := -0.214545
				if( Positive_Money_Flow_Sum > 3.83121e+09 )
					if( Typical_Price <= 127 )
						ret := 0.674419
					if( Typical_Price > 127 )
						ret := 0.170455
			if( Long_MA > 219.628 )
				if( Positive_Money_Flow_Sum <= 5.06764e+09 )
					if( MFI_Low <= 21.6207 )
						ret := -0.848485 // sell
					if( MFI_Low > 21.6207 )
						ret := 0.736842 // buy
				if( Positive_Money_Flow_Sum > 5.06764e+09 )
					if( Positive_Money_Flow_Sum <= 6.76292e+09 )
						ret := -0.897436 // sell
					if( Positive_Money_Flow_Sum > 6.76292e+09 )
						ret := 0.000000
...
float op_operation = decision_tree_0_ETSY_1Day_a3a8d3ef(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
