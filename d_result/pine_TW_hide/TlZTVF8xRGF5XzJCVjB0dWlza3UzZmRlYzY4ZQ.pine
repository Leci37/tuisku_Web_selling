			...
			if( bbm <= 1.04163 )
				...
				if( VIP > 0.893423 )
					...
					if( VIM > 1.08822 )
						ret := -0.693878
			if( bbm > 1.04163 )
				if( bearPower <= 1.16502 )
					if( VIM <= 0.834156 )
						ret := 0.583333
					if( VIM > 0.834156 )
						ret := 0.090164
				if( bearPower > 1.16502 )
					if( bearPower <= 1.23427 )
						ret := -1.000000 // sell
					if( bearPower > 1.23427 )
						ret := -0.083333
...
float op_operation = decision_tree_0_NVST_1Day_3fdec68e(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
