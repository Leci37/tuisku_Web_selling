		...
		if( VIP <= 1.12443 )
			if( Negative_Money_Flow_Sum <= 1.26809e+09 )
				if( Negative_Money_Flow_Sum <= 6.74043e+08 )
					if( Positive_Money_Flow_Sum <= 4.43289e+08 )
						ret := -0.267123
					if( Positive_Money_Flow_Sum > 4.43289e+08 )
						ret := -0.635514
				if( Negative_Money_Flow_Sum > 6.74043e+08 )
					...
					if( VIM > 0.947867 )
						ret := 0.941176 // buy
			if( Negative_Money_Flow_Sum > 1.26809e+09 )
				if( Negative_Money_Flow <= 2.83188e+08 )
					if( Raw_Money_Flow <= 2.50831e+08 )
						ret := -0.937500 // sell
					if( Raw_Money_Flow > 2.50831e+08 )
						ret := -0.500000
				if( Negative_Money_Flow > 2.83188e+08 )
					ret := 1.000000 // buy
		if( VIP > 1.12443 )
			if( Raw_Money_Flow <= 2.50108e+07 )
				if( Positive_Money_Flow_Sum <= 2.50548e+08 )
					if( Typical_Price <= 13.9667 )
						ret := 0.000000
					if( Typical_Price > 13.9667 )
						ret := -0.896552 // sell
				if( Positive_Money_Flow_Sum > 2.50548e+08 )
					ret := 0.000000
			if( Raw_Money_Flow > 2.50108e+07 )
				if( Typical_Price <= 17.9587 )
					if( Positive_Money_Flow_Sum <= 3.89897e+08 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 3.89897e+08 )
						ret := 0.914894 // buy
				if( Typical_Price > 17.9587 )
...
float op_operation = decision_tree_0_ASAN_1Day_4a1a1583(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
