...
float op_operation = decision_tree_0_SNOW_1Day_f8876c2b(signal, histA_IsDownInt, macd, hist, histA_IsUpInt, histB_IsDownInt, histB_IsUpInt, macd_IsBelowInt, macd_IsAboveInt)
