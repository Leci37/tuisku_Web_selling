			...
			if( ad_mf > -8.1602e+08 )
				...
				if( ad_mf > -4.27403e+08 )
					...
					if( mf > -0.041189 )
						ret := -0.287356
		if( ad > -1.05335e+08 )
			if( ad_mf <= 1.52782e+09 )
				if( bearPower <= 0.048933 )
					if( bearPower <= 0.001303 )
						ret := -0.409091
					if( bearPower > 0.001303 )
						ret := 0.121739
				if( bearPower > 0.048933 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_b0730b3f(bbp, bullPower, BBPower_Color, bearPower, bbm, ad, ad_mf, mf)
