			...
			if( rsi1 > 77.2123 )
				...
				if( Negative_Money_Flow_Sum > 6.4516e+08 )
					...
					if( Raw_Money_Flow > 7.29512e+08 )
						ret := -1.000000 // sell
	if( Negative_Money_Flow > 1.3739e+08 )
		if( smoothD_d <= 20.5538 )
			if( Positive_Money_Flow_Sum <= 2.07963e+09 )
				if( MFI_Low <= 23.7206 )
					if( Negative_Money_Flow_Sum <= 1.24945e+09 )
						ret := -0.333333
					if( Negative_Money_Flow_Sum > 1.24945e+09 )
						ret := 0.622222
				if( MFI_Low > 23.7206 )
					ret := -1.000000 // sell
			if( Positive_Money_Flow_Sum > 2.07963e+09 )
				if( Positive_Money_Flow_Sum <= 5.45864e+09 )
					if( Positive_Money_Flow <= 1.69671e+08 )
						ret := 0.957447 // buy
					if( Positive_Money_Flow > 1.69671e+08 )
						ret := -1.000000 // sell
				if( Positive_Money_Flow_Sum > 5.45864e+09 )
					if( Money_Flow_Ratio <= 1.61188 )
						ret := 0.000000
					if( Money_Flow_Ratio > 1.61188 )
						ret := -1.000000 // sell
		if( smoothD_d > 20.5538 )
			if( Typical_Price <= 36.5947 )
				if( rsi1 <= 46.1055 )
					if( d_k <= -12.9684 )
						ret := 0.789474 // buy
					if( d_k > -12.9684 )
						ret := -0.586207
				if( rsi1 > 46.1055 )
					if( Positive_Money_Flow_Sum <= 2.14663e+09 )
						ret := -0.035714
					if( Positive_Money_Flow_Sum > 2.14663e+09 )
						ret := 0.735294 // buy
			if( Typical_Price > 36.5947 )
...
float op_operation = decision_tree_0_DOTUSDT_1Day_5a312367(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
