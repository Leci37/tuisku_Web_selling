			...
			if( Negative_Money_Flow_Sum > 2.26404e+09 )
				...
				if( Typical_Price > 61.4946 )
					...
					if( ema3 > 74.4634 )
						ret := 0.300000
	if( Positive_Money_Flow_Sum > 3.18129e+09 )
		if( Money_Flow_Ratio <= 3.26564 )
			if( ema13 <= -3.64192 )
				ret := 0.000000
			if( ema13 > -3.64192 )
				if( ema1 <= 85.1919 )
					if( Typical_Price <= 70.9081 )
						ret := -0.679487
					if( Typical_Price > 70.9081 )
						ret := -0.960000 // sell
				if( ema1 > 85.1919 )
		...
		if( Money_Flow_Ratio > 3.26564 )
			if( ema13 <= 8.21506 )
				if( Typical_Price <= 58.6518 )
					if( Raw_Money_Flow <= 3.54446e+08 )
						ret := -0.750000 // sell
					if( Raw_Money_Flow > 3.54446e+08 )
						ret := 0.000000
				if( Typical_Price > 58.6518 )
...
float op_operation = decision_tree_0_RUN_1Day_a666c22e(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
