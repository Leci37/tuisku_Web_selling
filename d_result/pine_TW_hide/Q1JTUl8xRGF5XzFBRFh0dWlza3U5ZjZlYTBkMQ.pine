			...
			if( diMinus > 18.4576 )
				if( diPlus <= 18.9786 )
					...
					if( trueRange > 0.561593 )
						ret := 0.364286
				if( diPlus > 18.9786 )
					if( directionalMovementPlus <= 0.464672 )
						ret := -0.089552
					if( directionalMovementPlus > 0.464672 )
						ret := -0.666667
		if( dx > 43.6423 )
			if( smoothedDirectionalMovementPlus <= 1.31698 )
				if( adx <= 61.943 )
					if( smoothedTrueRange <= 3.84465 )
						ret := -0.195710
					if( smoothedTrueRange > 3.84465 )
						ret := 1.000000 // buy
				if( adx > 61.943 )
...
float op_operation = decision_tree_0_CRSR_1Day_9f6ea0d1(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)
