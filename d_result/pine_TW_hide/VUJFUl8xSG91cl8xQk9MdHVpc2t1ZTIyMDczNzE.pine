...
decision_tree_0_UBER_1Hour_e2207371(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)=>
	...
	if( BBupper > 23.2943 )
		...
		if( vrsi > 24.4665 )
			if( BBlower <= 15.0957 )
				if( dif_source_BBupper <= -4.49607 )
					if( vrsi <= 27.768 )
						ret := -1.000000 // sell
					if( vrsi > 27.768 )
						ret := 0.700000 // buy
				if( dif_source_BBupper > -4.49607 )
					if( dif_source_BBlower <= 12.0463 )
						ret := 1.000000 // buy
					if( dif_source_BBlower > 12.0463 )
						ret := -0.866667 // sell
			if( BBlower > 15.0957 )
				if( dif_source_BBlower <= 18.8446 )
					if( BBlower <= 17.0559 )
						ret := -0.479839
					if( BBlower > 17.0559 )
						ret := -0.030473
				if( dif_source_BBlower > 18.8446 )
					if( dif_source_BBupper <= -3.39867 )
						ret := 0.000000
					if( dif_source_BBupper > -3.39867 )
						ret := -0.907407 // sell
...
float op_operation = decision_tree_0_UBER_1Hour_e2207371(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
