			...
			if( BBPower_Color > 0.5 )
				...
				if( Lower_Band > 129.287 )
					...
					if( basis > 161.726 )
						ret := -0.093750
		if( basis > 165.373 )
			if( Lower_Band <= 156.96 )
				if( Upper_Band <= 222.033 )
					if( bbm <= 3.41935 )
						ret := 0.000000
					if( bbm > 3.41935 )
						ret := -0.842593 // sell
				if( Upper_Band > 222.033 )
					if( Upper_Band <= 226.222 )
						ret := 0.833333 // buy
					if( Upper_Band > 226.222 )
						ret := -0.500000
			if( Lower_Band > 156.96 )
				if( Lower_Band <= 197.099 )
					if( basis <= 187.382 )
						ret := -0.211111
					if( basis > 187.382 )
						ret := 0.576687
...
float op_operation = decision_tree_0_NVDA_1Day_7ed679d5(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
