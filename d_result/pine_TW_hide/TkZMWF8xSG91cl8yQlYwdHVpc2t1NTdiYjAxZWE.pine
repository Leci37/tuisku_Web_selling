	...
	if( bullPower <= 4.32585 )
		...
		if( bbm > 5.17058 )
			...
			if( bbm > 5.75174 )
				...
				if( VIM > 1.31862 )
					if( bbm <= 10.0654 )
						if( bullPower <= -3.27932 )
							ret := -0.600000
						if( bullPower > -3.27932 )
							ret := -0.245098
					if( bbm > 10.0654 )
						if( bullPower <= -11.2328 )
							ret := -0.304348
						if( bullPower > -11.2328 )
							ret := 0.722222 // buy
	if( bullPower > 4.32585 )
		if( bullPower <= 15.5874 )
			if( bbm <= 11.1435 )
				if( bbm <= 8.15099 )
					if( bbp <= 14.3028 )
						if( bullPower <= 4.56839 )
							ret := -0.294248
						if( bullPower > 4.56839 )
							ret := -0.044542
					if( bbp > 14.3028 )
				...
				if( bbm > 8.15099 )
					if( bbp <= 4.09297 )
						...
						if( VIM > 0.909692 )
							ret := 0.424710
					if( bbp > 4.09297 )
						if( bullPower <= 10.9854 )
							ret := -0.291667
						if( bullPower > 10.9854 )
							ret := 0.425532
			if( bbm > 11.1435 )
				if( bearPower <= 2.31516 )
					if( bbp <= -5.50394 )
						if( VIP_VIM <= -0.063668 )
							ret := 0.800000 // buy
						if( VIP_VIM > -0.063668 )
...
float op_operation = decision_tree_0_NFLX_1Hour_57bb01ea(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
