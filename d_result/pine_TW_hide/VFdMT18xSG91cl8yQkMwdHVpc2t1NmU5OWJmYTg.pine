				...
				if( bbp > -6.61219 )
					if( mf <= 0.054644 )
						...
						if( ad > -610991 )
							ret := -0.164982
					if( mf > 0.054644 )
						if( bearPower <= 10.1044 )
							ret := 0.059428
						if( bearPower > 10.1044 )
							ret := -0.750000 // sell
	if( ad_mf > 1005 )
		if( ad <= 5184.53 )
			if( bullPower <= -0.027092 )
				if( mf <= -0.491808 )
					ret := -0.875000 // sell
				if( mf > -0.491808 )
					if( ad <= 3107.2 )
						if( bearPower <= -0.699576 )
							ret := 0.128788
						if( bearPower > -0.699576 )
							ret := -0.178295
					if( ad > 3107.2 )
...
float op_operation = decision_tree_0_TWLO_1Hour_6e99bfa8(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)
