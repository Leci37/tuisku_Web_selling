			...
			if( upperBand > 10.2904 )
				...
				if( lowerBand > -0.101105 )
					...
					if( upperBand > 20.7676 )
						ret := -0.247059
	if( wvf > 9.64724 )
		if( lowerBand <= 4.39873 )
			if( Color_con2 <= -1.18778 )
				if( colInt <= 0.5 )
					if( wvf <= 14.8077 )
						ret := -0.027027
					if( wvf > 14.8077 )
				...
				if( colInt > 0.5 )
					ret := 0.750000 // buy
			if( Color_con2 > -1.18778 )
				if( upperBand <= 15.8203 )
					if( upperBand <= 15.2583 )
						ret := -0.275762
					if( upperBand > 15.2583 )
						ret := 0.352941
				if( upperBand > 15.8203 )
		...
		if( lowerBand > 4.39873 )
			if( sDev <= 6.99652 )
				if( upperBand <= 22.4205 )
					if( Color_con1 <= -2.71159 )
						ret := -0.044776
					if( Color_con1 > -2.71159 )
						ret := 0.728972 // buy
				if( upperBand > 22.4205 )
					if( Color_con2 <= 0.401165 )
						ret := 0.975000 // buy
					if( Color_con2 > 0.401165 )
						ret := 0.750000 // buy
			if( sDev > 6.99652 )
				if( sDev <= 12.0063 )
					if( Color_con2 <= 1.85795 )
						ret := -0.231481
					if( Color_con2 > 1.85795 )
						ret := -0.959184 // sell
				if( sDev > 12.0063 )
...
float op_operation = decision_tree_0_ETSY_1Hour_0a2506b2(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
