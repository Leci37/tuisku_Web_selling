			...
			if( Positive_Money_Flow_Sum > 3.21207e+07 )
				...
				if( Negative_Money_Flow_Sum > 9.84723e+06 )
					...
					if( smoothK_k > 81.1702 )
						ret := 0.155538
	if( Negative_Money_Flow_Sum > 1.49024e+09 )
		if( Typical_Price <= 44.3321 )
			if( MFI_Low <= -5.84806 )
				if( smoothD_d <= 9.69448 )
					if( smoothD_d <= -0.373567 )
						ret := 0.169231
					if( smoothD_d > -0.373567 )
						ret := -0.435185
				if( smoothD_d > 9.69448 )
					if( Negative_Money_Flow_Sum <= 1.79191e+09 )
						ret := -0.140000
					if( Negative_Money_Flow_Sum > 1.79191e+09 )
						ret := 0.548387
			if( MFI_Low > -5.84806 )
				if( Negative_Money_Flow_Sum <= 2.55618e+09 )
					if( Negative_Money_Flow_Sum <= 1.50292e+09 )
						ret := 0.795455 // buy
					if( Negative_Money_Flow_Sum > 1.50292e+09 )
						ret := 0.168053
				if( Negative_Money_Flow_Sum > 2.55618e+09 )
		...
		if( Typical_Price > 44.3321 )
			if( MFI <= 27.5764 )
				if( Positive_Money_Flow <= 3.78653e+07 )
					if( k <= 80.1263 )
						ret := -0.498507
					if( k > 80.1263 )
						ret := 0.384615
				if( Positive_Money_Flow > 3.78653e+07 )
					...
					if( d_k > -0.470995 )
						ret := -0.344828
			if( MFI > 27.5764 )
				if( Money_Flow_Ratio <= 1.72428 )
					if( Negative_Money_Flow_Sum <= 9.642e+09 )
						ret := 0.134921
					if( Negative_Money_Flow_Sum > 9.642e+09 )
						ret := -0.708333 // sell
				if( Money_Flow_Ratio > 1.72428 )
...
float op_operation = decision_tree_0_NIO_1Hour_866e87c9(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
