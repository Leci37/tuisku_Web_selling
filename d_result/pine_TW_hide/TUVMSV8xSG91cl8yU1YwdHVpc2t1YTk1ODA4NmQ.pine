...
decision_tree_0_MELI_1Hour_a958086d(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)=>
				...
				if( rsi1 <= 61.4369 )
					if( rsi1 <= 47.3274 )
						...
						if( d_k > 4.24178 )
							ret := 0.375000
					if( rsi1 > 47.3274 )
						if( smoothK_k <= 91.6456 )
							ret := -0.410256
						if( smoothK_k > 91.6456 )
							ret := 0.204878
				if( rsi1 > 61.4369 )
					if( VIP_VIM <= 0.411921 )
						if( smoothK_k <= 95.1393 )
							ret := -0.336449
						if( smoothK_k > 95.1393 )
							ret := -0.623457
					if( VIP_VIM > 0.411921 )
	...
	if( VIP > 1.29497 )
		if( rsi1 <= 91.6333 )
			if( smoothD_d <= 29.8736 )
				if( d <= 8.34672 )
					if( VIM <= 0.894173 )
						if( smoothD_d <= -0.409653 )
							ret := 0.000000
						if( smoothD_d > -0.409653 )
							ret := -0.916667 // sell
					if( VIM > 0.894173 )
			...
			if( smoothD_d > 29.8736 )
				if( VIM <= 0.663133 )
					if( smoothD_d <= 96.5544 )
						if( smoothD_d <= 78.2375 )
							ret := 0.720930 // buy
						if( smoothD_d > 78.2375 )
							ret := 0.210762
					if( smoothD_d > 96.5544 )
...
float op_operation = decision_tree_0_MELI_1Hour_a958086d(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)
