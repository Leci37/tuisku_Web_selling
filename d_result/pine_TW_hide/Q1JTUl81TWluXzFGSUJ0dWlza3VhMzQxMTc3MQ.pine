...
decision_tree_0_CRSR_5Min_a3411771(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)=>
	...
	if( upper_2 > 7.04174 )
		if( lower_1 <= 7.13165 )
			if( basis_minus <= 2.13074 )
				if( basis_minus <= 0.6477 )
					if( basis <= 6.89539 )
						if( upper_6 <= 7.41069 )
							ret := -0.687500
						if( upper_6 > 7.41069 )
				...
				if( basis_minus > 0.6477 )
					...
					if( upper_1 > 6.93628 )
						...
						if( upper_4 > 8.57372 )
							ret := 0.285714
			if( basis_minus > 2.13074 )
				if( basis_max <= -2.18513 )
					ret := 1.000000 // buy
				if( basis_max > -2.18513 )
					if( basis_max <= -2.16305 )
						ret := 0.363636
					if( basis_max > -2.16305 )
						ret := 1.000000 // buy
		if( lower_1 > 7.13165 )
...
float op_operation = decision_tree_0_CRSR_5Min_a3411771(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
