				...
				if( avgHighLow > 207.241 )
					...
					if( avgHighLow > 209.367 )
						...
						if( val > -2.39741 )
							ret := 0.108724
			if( val > -0.312566 )
				if( priceRange <= 4.6147 )
					if( upperKC <= 177.733 )
						if( priceRange <= 1.92151 )
							ret := 0.086207
						if( priceRange > 1.92151 )
							ret := 0.632768
					if( upperKC > 177.733 )
...
float op_operation = decision_tree_0_CRWD_30Min_9e3c9735(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
