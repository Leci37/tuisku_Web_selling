...
decision_tree_0_TSLA_1Day_6f3f062f(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)=>
	...
	if( VIM > 0.952904 )
		if( MFI_High <= -66.8219 )
			if( Positive_Money_Flow <= 2.01444e+10 )
				if( MFI <= 6.11072 )
					ret := -0.666667
				if( MFI > 6.11072 )
					ret := -1.000000 // sell
		...
		if( MFI_High > -66.8219 )
			if( VIP_VIM <= -0.550968 )
				if( Raw_Money_Flow <= 1.91815e+09 )
					if( Negative_Money_Flow_Sum <= 2.62626e+10 )
						ret := 0.272727
					if( Negative_Money_Flow_Sum > 2.62626e+10 )
						ret := -1.000000 // sell
				if( Raw_Money_Flow > 1.91815e+09 )
					if( Money_Flow_Ratio <= 0.172505 )
						ret := -0.083333
					if( Money_Flow_Ratio > 0.172505 )
						ret := 0.681319
			if( VIP_VIM > -0.550968 )
				if( Typical_Price <= 149.008 )
					if( Money_Flow_Ratio <= 0.772962 )
						ret := 0.333333
					if( Money_Flow_Ratio > 0.772962 )
						ret := 1.000000 // buy
				if( Typical_Price > 149.008 )
					if( Typical_Price <= 832.354 )
						ret := -0.116851
					if( Typical_Price > 832.354 )
						ret := -0.487654
...
float op_operation = decision_tree_0_TSLA_1Day_6f3f062f(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
