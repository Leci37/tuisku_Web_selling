			...
			if( bearPower > -0.058419 )
				...
				if( bbp > 0.181165 )
					...
					if( bbp > 0.232181 )
						ret := 0.823529 // buy
	if( bullPower > 0.284572 )
		if( bearPower <= -1.93592 )
			if( bullPower <= 1.45474 )
				if( bearPower <= -2.7499 )
					if( bearPower <= -5.13209 )
						ret := -0.055556
					if( bearPower > -5.13209 )
						ret := -0.727273 // sell
				if( bearPower > -2.7499 )
					if( bullPower <= 0.474209 )
						ret := 0.500000
					if( bullPower > 0.474209 )
						ret := -0.384615
			if( bullPower > 1.45474 )
				if( bullPower <= 2.2034 )
					...
					if( bbp > -1.72564 )
						ret := 0.758621 // buy
				if( bullPower > 2.2034 )
					if( bearPower <= -2.75197 )
						ret := 0.057143
					if( bearPower > -2.75197 )
						ret := -0.851852 // sell
		if( bearPower > -1.93592 )
			if( bbm <= 5.04091 )
				if( bullPower <= 0.318888 )
					if( bearPower <= 0.03641 )
						ret := -0.741935 // sell
					if( bearPower > 0.03641 )
						ret := 0.428571
				if( bullPower > 0.318888 )
					if( bullPower <= 5.85352 )
						ret := -0.002905
					if( bullPower > 5.85352 )
						ret := 0.279070
			if( bbm > 5.04091 )
				if( bbp <= 17.398 )
					if( bullPower <= 8.18111 )
						ret := -0.034884
					if( bullPower > 8.18111 )
						ret := -0.683761
				if( bbp > 17.398 )
					if( bullPower <= 13.4805 )
						ret := 0.809524 // buy
					if( bullPower > 13.4805 )
						ret := -0.377358
...
float op_operation = decision_tree_0_AMD_1Day_f243a637(bullPower, bbp, bearPower, bbm, BBPower_Color)
