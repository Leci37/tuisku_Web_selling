			...
			if( Typical_Price <= 6.0261 )
				...
				if( Negative_Money_Flow_Sum > 3.78811e+08 )
					...
					if( VIM > 0.970319 )
						ret := 0.131313
			if( Typical_Price > 6.0261 )
				if( Negative_Money_Flow_Sum <= 1.26537e+09 )
					if( MFI <= 64.2957 )
						ret := 0.687500
					if( MFI > 64.2957 )
						ret := -0.838710 // sell
				if( Negative_Money_Flow_Sum > 1.26537e+09 )
					...
					if( MFI_Low > 47.5025 )
						ret := 0.311787
		if( VIM > 1.14028 )
			if( Negative_Money_Flow_Sum <= 1.35655e+10 )
				if( Raw_Money_Flow <= 2.26811e+08 )
					if( MFI_Low <= 23.9427 )
						ret := -0.448980
					if( MFI_Low > 23.9427 )
						ret := -0.932432 // sell
				if( Raw_Money_Flow > 2.26811e+08 )
					if( Typical_Price <= 19.4767 )
						ret := -0.256705
					if( Typical_Price > 19.4767 )
						ret := -0.784314 // sell
			if( Negative_Money_Flow_Sum > 1.35655e+10 )
				if( Raw_Money_Flow <= 1.0837e+09 )
					if( Positive_Money_Flow_Sum <= 7.45162e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 7.45162e+09 )
						ret := 0.000000
				if( Raw_Money_Flow > 1.0837e+09 )
					if( Typical_Price <= 43.7361 )
						ret := 0.174603
					if( Typical_Price > 43.7361 )
						ret := -0.769231 // sell
...
float op_operation = decision_tree_0_NIO_1Day_1fdba64d(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
