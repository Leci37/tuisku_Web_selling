		...
		if( chinkou_span <= 302.74 )
			if( senkou_span_b <= 267.56 )
				if( senkou_span_a_displaced <= 240.704 )
					if( chinkou_span <= 283.9 )
						ret := -1.000000 // sell
					if( chinkou_span > 283.9 )
						ret := 0.000000
				if( senkou_span_a_displaced > 240.704 )
					if( basis_minus <= -3.69095 )
						ret := -1.000000 // sell
					if( basis_minus > -3.69095 )
						ret := 0.339623
			if( senkou_span_b > 267.56 )
				if( senkou_span_b_displaced <= 262.382 )
					if( chinkou_span <= 296.76 )
						ret := -0.050000
					if( chinkou_span > 296.76 )
						ret := 1.000000 // buy
				if( senkou_span_b_displaced > 262.382 )
					if( chinkou_span <= 272.626 )
						ret := -0.849462 // sell
					if( chinkou_span > 272.626 )
						ret := -0.541353
		if( chinkou_span > 302.74 )
			if( tenkan_sen <= 419.116 )
				if( senkou_span_a_displaced <= 327.134 )
					if( basis_minus <= 5.74259 )
						ret := 0.852273 // buy
					if( basis_minus > 5.74259 )
						ret := 0.238579
				if( senkou_span_a_displaced > 327.134 )
					if( chinkou_span <= 330.925 )
						ret := -0.773585 // sell
					if( chinkou_span > 330.925 )
						ret := 0.203209
			if( tenkan_sen > 419.116 )
				if( basis_minus <= 9.97125 )
					if( senkou_span_b <= 412.484 )
						ret := -0.454545
					if( senkou_span_b > 412.484 )
						ret := -0.981481 // sell
				if( basis_minus > 9.97125 )
...
float op_operation = decision_tree_0_MSFT_1Day_942458bf(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
