			...
			if( dif_source_BBlower > 85.7724 )
				...
				if( BBlower > 169.173 )
					...
					if( vrsi > 90.4698 )
						ret := 0.000000
		if( dif_source_BBlower > 149.145 )
			if( dif_source_BBlower <= 178.388 )
				if( BBupper <= 309.545 )
					ret := 0.000000
				if( BBupper > 309.545 )
					if( dif_source_BBupper <= -356.42 )
						ret := 0.000000
					if( dif_source_BBupper > -356.42 )
						ret := -0.795455 // sell
			if( dif_source_BBlower > 178.388 )
				if( dif_source_BBlower <= 282.25 )
					if( BBupper <= 414.799 )
						ret := -0.272727
					if( BBupper > 414.799 )
						ret := 0.653846
...
float op_operation = decision_tree_0_AAPL_1Day_bb14c5c1(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
