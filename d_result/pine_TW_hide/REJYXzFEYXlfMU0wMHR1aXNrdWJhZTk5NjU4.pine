		...
		if( Positive_Money_Flow_Sum <= 4.28935e+08 )
			if( Positive_Money_Flow_Sum <= 2.38837e+08 )
				...
				if( MFI_High > -56.149 )
					ret := 0.000000
			if( Positive_Money_Flow_Sum > 2.38837e+08 )
				if( Negative_Money_Flow_Sum <= 3.05366e+08 )
					if( MFI_Low <= 46.8345 )
						ret := 1.000000 // buy
					if( MFI_Low > 46.8345 )
						ret := 0.000000
				if( Negative_Money_Flow_Sum > 3.05366e+08 )
					if( Negative_Money_Flow_Sum <= 3.69398e+08 )
						ret := -0.176471
					if( Negative_Money_Flow_Sum > 3.69398e+08 )
						ret := 0.389474
		if( Positive_Money_Flow_Sum > 4.28935e+08 )
			if( Positive_Money_Flow_Sum <= 1.63428e+09 )
				if( Raw_Money_Flow <= 1.81311e+08 )
					if( Money_Flow_Ratio <= 0.976406 )
						ret := -0.064690
					if( Money_Flow_Ratio > 0.976406 )
						ret := -0.365105
				if( Raw_Money_Flow > 1.81311e+08 )
					if( Raw_Money_Flow <= 6.42352e+08 )
						ret := -0.721311 // sell
					if( Raw_Money_Flow > 6.42352e+08 )
						ret := 1.000000 // buy
			if( Positive_Money_Flow_Sum > 1.63428e+09 )
				if( Typical_Price <= 32.2467 )
					if( Negative_Money_Flow_Sum <= 1.33369e+09 )
						ret := 0.069565
					if( Negative_Money_Flow_Sum > 1.33369e+09 )
						ret := 0.956522 // buy
				if( Typical_Price > 32.2467 )
...
float op_operation = decision_tree_0_DBX_1Day_bae99658(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
