			...
			if( Money_Flow_Ratio <= 3.49265 )
				...
				if( Negative_Money_Flow_Sum > 1.14776e+09 )
					...
					if( Typical_Price > 388.006 )
						ret := -0.010989
			if( Money_Flow_Ratio > 3.49265 )
				if( Raw_Money_Flow <= 3.47037e+07 )
					if( Typical_Price <= 52.4377 )
						ret := 0.000000
					if( Typical_Price > 52.4377 )
						ret := -0.890625 // sell
				if( Raw_Money_Flow > 3.47037e+07 )
					if( Positive_Money_Flow_Sum <= 2.17824e+09 )
						ret := 0.055556
					if( Positive_Money_Flow_Sum > 2.17824e+09 )
						ret := -0.933333 // sell
		if( Raw_Money_Flow > 2.05517e+08 )
			if( Negative_Money_Flow_Sum <= 7.8199e+08 )
				if( bbm <= 16.6905 )
					ret := 0.000000
				if( bbm > 16.6905 )
					if( bearPower <= 21.5759 )
						ret := 0.888889 // buy
					if( bearPower > 21.5759 )
						ret := 0.266667
			if( Negative_Money_Flow_Sum > 7.8199e+08 )
				if( Negative_Money_Flow_Sum <= 2.54606e+09 )
					if( bbm <= 15.5874 )
						ret := -0.069307
					if( bbm > 15.5874 )
						ret := -0.673684
				if( Negative_Money_Flow_Sum > 2.54606e+09 )
					if( Raw_Money_Flow <= 3.41336e+08 )
						ret := 0.677419
					if( Raw_Money_Flow > 3.41336e+08 )
						ret := -0.032258
...
float op_operation = decision_tree_0_HUBS_1Day_fc1fc7c8(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
