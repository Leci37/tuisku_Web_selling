...
decision_tree_0_MELI_1Hour_a7bb4aa0(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)=>
	...
	if( Negative_Money_Flow_Sum > 8.73988e+08 )
		if( MFI_Low <= 17.8344 )
			if( Negative_Money_Flow <= 1.83018e+08 )
				if( VIM <= 1.48333 )
					ret := -0.438619
				if( VIM > 1.48333 )
					if( Negative_Money_Flow <= 2421.6 )
						ret := -0.450980
					if( Negative_Money_Flow > 2421.6 )
						if( Negative_Money_Flow <= 7.59161e+07 )
							ret := 0.680556
						if( Negative_Money_Flow > 7.59161e+07 )
							ret := -0.500000
			if( Negative_Money_Flow > 1.83018e+08 )
				if( Negative_Money_Flow_Sum <= 1.22609e+09 )
					if( VIP_VIM <= -0.63739 )
						ret := -0.533333
					if( VIP_VIM > -0.63739 )
						ret := 0.860465 // buy
				if( Negative_Money_Flow_Sum > 1.22609e+09 )
					if( Negative_Money_Flow_Sum <= 1.44524e+09 )
						ret := -0.638298
					if( Negative_Money_Flow_Sum > 1.44524e+09 )
						ret := 0.400000
		if( MFI_Low > 17.8344 )
			if( VIM <= 0.971973 )
				ret := -0.707317 // sell
			if( VIM > 0.971973 )
				if( Raw_Money_Flow <= 1.45489e+08 )
					if( Negative_Money_Flow_Sum <= 1.08076e+09 )
						if( Positive_Money_Flow <= 1.01701e+08 )
							ret := 0.450000
						if( Positive_Money_Flow > 1.01701e+08 )
							ret := -0.400000
					if( Negative_Money_Flow_Sum > 1.08076e+09 )
						if( Typical_Price <= 1082.65 )
							ret := 0.888889 // buy
						if( Typical_Price > 1082.65 )
							ret := -0.774194 // sell
				if( Raw_Money_Flow > 1.45489e+08 )
...
float op_operation = decision_tree_0_MELI_1Hour_a7bb4aa0(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
