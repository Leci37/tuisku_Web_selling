			...
			if( ad_mf > 1.31219e+06 )
				if( rsi1 <= 54.5732 )
					if( mf <= -0.12408 )
						ret := 0.000000
					if( mf > -0.12408 )
						if( smoothK_k <= 90.8269 )
							ret := -0.841463 // sell
						if( smoothK_k > 90.8269 )
							ret := 0.166667
				if( rsi1 > 54.5732 )
					if( ad_mf <= 1.61972e+06 )
						if( d <= 47.2906 )
							ret := 0.333333
						if( d > 47.2906 )
							ret := -0.744681 // sell
...
float op_operation = decision_tree_0_DBX_1Hour_35827fcc(mf, ad_mf, ad, d, d_k, smoothK_k, k, rsi1, smoothD_d)
