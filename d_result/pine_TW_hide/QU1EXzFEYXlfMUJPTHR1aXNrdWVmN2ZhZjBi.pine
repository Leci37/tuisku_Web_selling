...
decision_tree_0_AMD_1Day_ef7faf0b(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)=>
	...
	if( dif_source_BBlower > 14.6919 )
		if( BBlower <= 5.05086 )
			if( dif_source_BBupper <= -10.7092 )
				...
				if( BBupper > 30.7563 )
					ret := 0.857143 // buy
			if( dif_source_BBupper > -10.7092 )
				if( dif_source_BBupper <= 5.39607 )
					if( dif_source_BBupper <= -9.43124 )
						ret := -0.619048
					if( dif_source_BBupper > -9.43124 )
						ret := -0.914530 // sell
				if( dif_source_BBupper > 5.39607 )
		...
		if( BBlower > 5.05086 )
			...
			if( BBupper > 145.076 )
				if( BBupper <= 158.513 )
					if( dif_source_BBupper <= 11.0689 )
						ret := -0.721612 // sell
					if( dif_source_BBupper > 11.0689 )
						ret := 0.100000
				if( BBupper > 158.513 )
					if( dif_source_BBupper <= -53.9619 )
						ret := 0.703704 // buy
					if( dif_source_BBupper > -53.9619 )
						ret := -0.196347
...
float op_operation = decision_tree_0_AMD_1Day_ef7faf0b(BBupper, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower, vrsi, dif_source_BBupper, crossover_rsi_bblowerInt)
