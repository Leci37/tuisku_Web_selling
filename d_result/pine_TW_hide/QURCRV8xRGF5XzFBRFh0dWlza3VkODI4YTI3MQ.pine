			...
			if( directionalMovementPlus <= 7.57378 )
				if( directionalMovementMinus <= 7.05 )
					...
					if( adx > 25.4505 )
						ret := 0.650888
				if( directionalMovementMinus > 7.05 )
					if( smoothedDirectionalMovementMinus <= 2.5552 )
						ret := -0.800000 // sell
					if( smoothedDirectionalMovementMinus > 2.5552 )
						ret := 0.416667
			if( directionalMovementPlus > 7.57378 )
				if( smoothedTrueRange <= 10.6148 )
					ret := -1.000000 // sell
				if( smoothedTrueRange > 10.6148 )
					ret := 0.714286 // buy
		if( smoothedDirectionalMovementPlus > 2.05757 )
			if( smoothedTrueRange <= 10.7742 )
				if( diMinus <= 36.7435 )
					ret := 1.000000 // buy
				if( diMinus > 36.7435 )
					ret := -0.571429
			if( smoothedTrueRange > 10.7742 )
				if( adx <= 34.6661 )
					if( directionalMovementMinus <= 23.545 )
						ret := 0.105263
					if( directionalMovementMinus > 23.545 )
						ret := 1.000000 // buy
				if( adx > 34.6661 )
					if( directionalMovementMinus <= 7.56265 )
						ret := -0.794118 // sell
					if( directionalMovementMinus > 7.56265 )
						ret := 0.200000
...
float op_operation = decision_tree_0_ADBE_1Day_d828a271(smoothedDirectionalMovementMinus, directionalMovementMinus, diMinus, dx, directionalMovementPlus, smoothedDirectionalMovementPlus, adx, trueRange, smoothedTrueRange, diPlus)
