		...
		if( chinkou_span > 6.27791 )
			...
			if( senkou_span_a > 6.46575 )
				...
				if( senkou_span_a > 6.48118 )
					ret := 0.478571
	if( senkou_span_a_displaced > 6.41545 )
		if( chinkou_span <= 6.36974 )
			if( chinkou_span <= 6.25864 )
				if( tenkan_sen <= 5.88259 )
					ret := 0.272727
				if( tenkan_sen > 5.88259 )
					ret := -0.738889 // sell
			if( chinkou_span > 6.25864 )
				if( kinjun_sen <= 6.60675 )
					if( senkou_span_a_displaced <= 6.51434 )
						ret := -0.785714 // sell
					if( senkou_span_a_displaced > 6.51434 )
						ret := 0.060606
				if( kinjun_sen > 6.60675 )
					if( tenkan_sen <= 6.61869 )
						ret := 1.000000 // buy
					if( tenkan_sen > 6.61869 )
						ret := -0.333333
		if( chinkou_span > 6.36974 )
			if( senkou_span_b <= 6.51372 )
				ret := 0.613924
			if( senkou_span_b > 6.51372 )
				if( basis_max <= 0.001252 )
					if( kinjun_sen <= 20.0699 )
						if( senkou_span_a <= 13.6326 )
							ret := -0.012993
						if( senkou_span_a > 13.6326 )
							ret := -0.099965
					if( kinjun_sen > 20.0699 )
						ret := -0.816901 // sell
				if( basis_max > 0.001252 )
					if( senkou_span_b <= 6.79631 )
						if( tenkan_sen <= 6.69406 )
							ret := 0.154891
						if( tenkan_sen > 6.69406 )
							ret := 0.915789 // buy
					if( senkou_span_b > 6.79631 )
						if( kinjun_sen <= 6.87062 )
							ret := -0.580460
						if( kinjun_sen > 6.87062 )
							ret := 0.024147
...
float op_operation = decision_tree_0_CRSR_5Min_31bde38b(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
