...
decision_tree_0_QCOM_1Day_16ce1ecd(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)=>
	...
	if( upperBand > 17.1191 )
		...
		if( upperBand > 18.2295 )
			if( midLine <= 15.1807 )
				if( lowerBand <= 5.81739 )
					if( Color_con1 <= -5.57374 )
						ret := 0.287449
					if( Color_con1 > -5.57374 )
						ret := -0.389831
				if( lowerBand > 5.81739 )
					if( Color_con1 <= -10.5739 )
						ret := -0.905660 // sell
					if( Color_con1 > -10.5739 )
						ret := -0.030769
			if( midLine > 15.1807 )
				if( Color_con2 <= -6.08825 )
					if( midLine <= 15.7707 )
						ret := -0.818182 // sell
					if( midLine > 15.7707 )
						ret := -0.058824
				if( Color_con2 > -6.08825 )
					if( Color_con1 <= -2.14333 )
						ret := 0.760417 // buy
					if( Color_con1 > -2.14333 )
						ret := -0.545455
...
float op_operation = decision_tree_0_QCOM_1Day_16ce1ecd(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
