...
decision_tree_0_RUN_1Hour_43caf261(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)=>
	...
	if( ema13 <= 1.44982 )
		...
		if( ema2 > 24.2576 )
			...
			if( Negative_Money_Flow > 4.58014e+07 )
				if( MFI <= 18.3497 )
					if( Positive_Money_Flow_Sum <= 5.9073e+07 )
						if( Positive_Money_Flow_Sum <= 4.48982e+07 )
							ret := -0.157143
						if( Positive_Money_Flow_Sum > 4.48982e+07 )
							ret := 0.714286 // buy
					if( Positive_Money_Flow_Sum > 5.9073e+07 )
				...
				if( MFI > 18.3497 )
					if( MFI_Low <= 14.7331 )
						if( Positive_Money_Flow_Sum <= 4.22944e+07 )
							ret := -1.000000 // sell
						if( Positive_Money_Flow_Sum > 4.22944e+07 )
							ret := 0.625000
					if( MFI_Low > 14.7331 )
						if( Negative_Money_Flow <= 1.10794e+08 )
							ret := -0.022923
						if( Negative_Money_Flow > 1.10794e+08 )
							ret := 0.775510 // buy
	if( ema13 > 1.44982 )
		if( Money_Flow_Ratio <= 35.2326 )
			if( ema13 <= 2.87264 )
				if( ema2 <= 54.5181 )
					if( Positive_Money_Flow_Sum <= 1.93369e+08 )
						if( Typical_Price <= 41.3668 )
							ret := 0.478261
						if( Typical_Price > 41.3668 )
							ret := -0.170732
					if( Positive_Money_Flow_Sum > 1.93369e+08 )
						if( Positive_Money_Flow <= 4.21972e+07 )
							ret := 0.593548
						if( Positive_Money_Flow > 4.21972e+07 )
							ret := 0.000000
				if( ema2 > 54.5181 )
					if( Negative_Money_Flow_Sum <= 5.60163e+07 )
						if( ema13 <= 2.30746 )
							ret := -0.697674
						if( ema13 > 2.30746 )
							ret := 0.833333 // buy
					if( Negative_Money_Flow_Sum > 5.60163e+07 )
						if( Raw_Money_Flow <= 958892 )
							ret := 0.465839
						if( Raw_Money_Flow > 958892 )
							ret := -0.084337
			if( ema13 > 2.87264 )
...
float op_operation = decision_tree_0_RUN_1Hour_43caf261(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, ema1, tema, ema12, ema2, ema3, ema13)
