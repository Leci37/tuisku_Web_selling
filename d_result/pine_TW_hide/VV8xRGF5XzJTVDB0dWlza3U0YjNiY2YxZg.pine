...
decision_tree_0_U_1Day_4b3bcf1f(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)=>
	...
	if( ema1 > 37.1742 )
		...
		if( tema > 37.9423 )
			if( ema2 <= 88.4144 )
				if( smoothK_k <= 96.1454 )
					if( smoothK_k <= -2.50498 )
						ret := 0.000000
					if( smoothK_k > -2.50498 )
						ret := -0.777778 // sell
				if( smoothK_k > 96.1454 )
...
float op_operation = decision_tree_0_U_1Day_4b3bcf1f(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)
