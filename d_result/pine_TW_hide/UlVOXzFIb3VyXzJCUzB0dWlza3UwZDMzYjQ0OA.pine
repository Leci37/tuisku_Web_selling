		...
		if( smoothD_d <= 91.2946 )
			if( k <= 96.7649 )
				if( smoothD_d <= 88.7719 )
					if( bbm <= 0.852067 )
						if( bearPower <= 0.03631 )
							ret := 0.621951
						if( bearPower > 0.03631 )
							ret := 0.062500
					if( bbm > 0.852067 )
						if( smoothD_d <= 73.2042 )
							ret := -0.471154
						if( smoothD_d > 73.2042 )
							ret := 0.063492
				if( smoothD_d > 88.7719 )
					if( smoothK_k <= 87.0994 )
						ret := 0.027027
					if( smoothK_k > 87.0994 )
						ret := -0.524390
			if( k > 96.7649 )
...
float op_operation = decision_tree_0_RUN_1Hour_0d33b448(bbm, bearPower, bbp, bullPower, BBPower_Color, d_k, d, rsi1, k, smoothD_d, smoothK_k)
