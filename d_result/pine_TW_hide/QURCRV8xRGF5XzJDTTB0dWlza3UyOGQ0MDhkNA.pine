			...
			if( Typical_Price > 544.447 )
				...
				if( Positive_Money_Flow_Sum > 1.52477e+10 )
					...
					if( Positive_Money_Flow_Sum > 1.77174e+10 )
						ret := -1.000000 // sell
	if( mf > -0.003373 )
		if( Negative_Money_Flow_Sum <= 1.32957e+10 )
			if( Positive_Money_Flow <= 5.06352e+08 )
				if( ad <= -2.89531e+06 )
					if( Typical_Price <= 247.529 )
						ret := -0.363636
					if( Typical_Price > 247.529 )
						ret := 0.756757 // buy
				if( ad > -2.89531e+06 )
					if( Typical_Price <= 370.776 )
						ret := 0.108766
					if( Typical_Price > 370.776 )
						ret := -0.203647
			if( Positive_Money_Flow > 5.06352e+08 )
				if( MFI <= 68.7021 )
					...
					if( MFI_Low > 40.1633 )
						ret := 0.271357
				if( MFI > 68.7021 )
					if( Typical_Price <= 442.639 )
						ret := -0.320574
					if( Typical_Price > 442.639 )
						ret := -0.560345
		if( Negative_Money_Flow_Sum > 1.32957e+10 )
			if( ad <= -1.86171e+06 )
				if( Negative_Money_Flow_Sum <= 1.58544e+10 )
					ret := -0.200000
				if( Negative_Money_Flow_Sum > 1.58544e+10 )
					if( MFI_Low <= 19.9436 )
						ret := 0.250000
					if( MFI_Low > 19.9436 )
						ret := 0.600000
			if( ad > -1.86171e+06 )
				if( Positive_Money_Flow_Sum <= 1.84443e+10 )
					if( MFI_High <= -51.6485 )
						ret := -0.285714
					if( MFI_High > -51.6485 )
						ret := -0.781250 // sell
...
float op_operation = decision_tree_0_ADBE_1Day_28d408d4(ad, mf, ad_mf, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
