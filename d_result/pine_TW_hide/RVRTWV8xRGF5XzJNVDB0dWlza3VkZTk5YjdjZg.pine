...
decision_tree_0_ETSY_1Day_de99b7cf(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema1 > 53.4668 )
		if( ema13 <= -8.40402 )
			if( Money_Flow_Ratio <= 1.08747 )
				if( Negative_Money_Flow_Sum <= 6.20994e+09 )
					if( Raw_Money_Flow <= 4.65654e+08 )
						ret := -0.316667
					if( Raw_Money_Flow > 4.65654e+08 )
						ret := -0.824074 // sell
				if( Negative_Money_Flow_Sum > 6.20994e+09 )
			...
			if( Money_Flow_Ratio > 1.08747 )
				ret := 0.900000 // buy
		if( ema13 > -8.40402 )
			if( Negative_Money_Flow_Sum <= 1.54115e+09 )
				if( ema12 <= 1.79178 )
					if( ema13 <= 0.793364 )
						ret := -0.391304
					if( ema13 > 0.793364 )
						ret := -0.741379 // sell
				if( ema12 > 1.79178 )
					if( Positive_Money_Flow <= 3.42405e+08 )
						ret := -0.295302
					if( Positive_Money_Flow > 3.42405e+08 )
						ret := 0.383562
			if( Negative_Money_Flow_Sum > 1.54115e+09 )
				if( Negative_Money_Flow_Sum <= 4.29423e+09 )
					if( Negative_Money_Flow_Sum <= 2.57865e+09 )
						ret := 0.166421
					if( Negative_Money_Flow_Sum > 2.57865e+09 )
						ret := -0.276978
				if( Negative_Money_Flow_Sum > 4.29423e+09 )
...
float op_operation = decision_tree_0_ETSY_1Day_de99b7cf(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
