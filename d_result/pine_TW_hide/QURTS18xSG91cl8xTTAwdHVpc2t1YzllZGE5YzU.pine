				...
				if( Positive_Money_Flow_Sum <= 7.76146e+07 )
					...
					if( MFI_Low > -3.20664 )
						...
						if( Money_Flow_Ratio > 0.372101 )
							ret := -0.529412
				if( Positive_Money_Flow_Sum > 7.76146e+07 )
					if( Raw_Money_Flow <= 2.39436e+07 )
						if( Typical_Price <= 208.819 )
							ret := 0.618182
						if( Typical_Price > 208.819 )
							ret := 0.121622
					if( Raw_Money_Flow > 2.39436e+07 )
						if( Negative_Money_Flow <= 3.57244e+07 )
							ret := -0.147783
						if( Negative_Money_Flow > 3.57244e+07 )
							ret := 0.237113
		if( Positive_Money_Flow_Sum > 1.18559e+08 )
			if( Positive_Money_Flow_Sum <= 1.26998e+09 )
				if( Positive_Money_Flow_Sum <= 6.29827e+08 )
					if( MFI_High <= -30.6163 )
						if( Raw_Money_Flow <= 1.70436e+06 )
							ret := -0.175097
						if( Raw_Money_Flow > 1.70436e+06 )
							ret := -0.030757
					if( MFI_High > -30.6163 )
						if( Negative_Money_Flow_Sum <= 1.13523e+08 )
							ret := 0.084363
						if( Negative_Money_Flow_Sum > 1.13523e+08 )
							ret := -0.010517
				if( Positive_Money_Flow_Sum > 6.29827e+08 )
					if( Raw_Money_Flow <= 1.54396e+07 )
						if( MFI_High <= -8.74418 )
							ret := 0.025641
						if( MFI_High > -8.74418 )
							ret := -0.644068
					if( Raw_Money_Flow > 1.54396e+07 )
						if( Typical_Price <= 277.169 )
							ret := -0.052239
						if( Typical_Price > 277.169 )
							ret := -0.450704
			if( Positive_Money_Flow_Sum > 1.26998e+09 )
...
float op_operation = decision_tree_0_ADSK_1Hour_c9eda9c5(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
