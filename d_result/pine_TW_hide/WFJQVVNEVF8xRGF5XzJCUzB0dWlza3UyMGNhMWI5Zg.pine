...
decision_tree_0_XRPUSDT_1Day_20ca1b9f(bbp, bullPower, BBPower_Color, bearPower, bbm, smoothK_k, d_k, k, smoothD_d, rsi1, d)=>
	...
	if( d > 70.4939 )
		if( bbp <= -0.045613 )
			...
			if( k > 69.9136 )
				if( bbm <= 0.028639 )
					if( smoothK_k <= 71.9444 )
						ret := -1.000000 // sell
					if( smoothK_k > 71.9444 )
						ret := -0.071429
				if( bbm > 0.028639 )
					if( bearPower <= -0.107635 )
						ret := 0.000000
					if( bearPower > -0.107635 )
						ret := -0.904762 // sell
		if( bbp > -0.045613 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_20ca1b9f(bbp, bullPower, BBPower_Color, bearPower, bbm, smoothK_k, d_k, k, smoothD_d, rsi1, d)
