			...
			if( senkou_span_a_displaced <= 857.812 )
				if( senkou_span_a_displaced <= 836.881 )
					if( chinkou_span <= 670.908 )
						if( senkou_span_b <= 671.545 )
							ret := -0.002353
						if( senkou_span_b > 671.545 )
							ret := -0.610028
					if( chinkou_span > 670.908 )
						if( kinjun_sen <= 769.618 )
							ret := 0.503374
						if( kinjun_sen > 769.618 )
							ret := 0.100437
				if( senkou_span_a_displaced > 836.881 )
					if( senkou_span_b_displaced <= 838.164 )
						if( senkou_span_a <= 883.065 )
							ret := 0.490446
						if( senkou_span_a > 883.065 )
							ret := -0.204545
					if( senkou_span_b_displaced > 838.164 )
						if( senkou_span_a_displaced <= 856.15 )
							ret := 0.756757 // buy
						if( senkou_span_a_displaced > 856.15 )
							ret := 0.300000
			if( senkou_span_a_displaced > 857.812 )
				if( senkou_span_a <= 840.474 )
					if( senkou_span_b <= 868.674 )
						if( senkou_span_b <= 860.688 )
							ret := -1.000000 // sell
						if( senkou_span_b > 860.688 )
							ret := 0.583333
					if( senkou_span_b > 868.674 )
						ret := -0.937500 // sell
				if( senkou_span_a > 840.474 )
					if( chinkou_span <= 1131.36 )
						if( kinjun_sen <= 1117.41 )
							ret := -0.119820
						if( kinjun_sen > 1117.41 )
							ret := -0.664452
					if( chinkou_span > 1131.36 )
						if( tenkan_sen <= 1105.8 )
							ret := 0.737201 // buy
						if( tenkan_sen > 1105.8 )
							ret := -0.018196
...
float op_operation = decision_tree_0_MELI_1Hour_523beb65(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
