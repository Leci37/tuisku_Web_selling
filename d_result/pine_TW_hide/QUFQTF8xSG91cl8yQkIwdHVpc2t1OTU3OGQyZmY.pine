	...
	if( bearPower > -8.41045 )
		if( basis <= 109.414 )
			...
			if( bearPower > 0.235607 )
				if( bbp <= 3.18358 )
					if( bbm <= 1.17325 )
						if( Lower_Band <= 107.253 )
							ret := -0.333333
						if( Lower_Band > 107.253 )
							ret := 0.875000 // buy
					if( bbm > 1.17325 )
						if( Upper_Band <= 112.242 )
							ret := -1.000000 // sell
						if( Upper_Band > 112.242 )
							ret := 1.000000 // buy
				if( bbp > 3.18358 )
					if( Lower_Band <= 102.629 )
						ret := 0.000000
					if( Lower_Band > 102.629 )
						if( bullPower <= 2.37976 )
							ret := 1.000000 // buy
						if( bullPower > 2.37976 )
							ret := 0.000000
		if( basis > 109.414 )
			if( Lower_Band <= 321.16 )
				if( basis <= 318.852 )
					if( basis <= 301.398 )
						if( Upper_Band <= 147.106 )
							ret := 0.055071
						if( Upper_Band > 147.106 )
							ret := -0.046298
					if( basis > 301.398 )
				...
				if( basis > 318.852 )
					if( basis <= 320.489 )
						if( Lower_Band <= 310.429 )
							ret := 1.000000 // buy
						if( Lower_Band > 310.429 )
							ret := -0.721429 // sell
					if( basis > 320.489 )
						if( Upper_Band <= 324.239 )
							ret := 0.695652
						if( Upper_Band > 324.239 )
							ret := -0.468000
			if( Lower_Band > 321.16 )
				if( Lower_Band <= 333.378 )
					if( Upper_Band <= 333.879 )
						if( Lower_Band <= 321.415 )
							ret := 0.833333 // buy
						if( Lower_Band > 321.415 )
							ret := -0.190476
					if( Upper_Band > 333.879 )
						if( bearPower <= 3.51439 )
							ret := 0.968750 // buy
						if( bearPower > 3.51439 )
							ret := 0.285714
				if( Lower_Band > 333.378 )
					if( basis <= 504.763 )
						if( Upper_Band <= 355.781 )
							ret := -0.522727
						if( Upper_Band > 355.781 )
							ret := 0.184232
					if( basis > 504.763 )
...
float op_operation = decision_tree_0_AAPL_1Hour_9578d2ff(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
