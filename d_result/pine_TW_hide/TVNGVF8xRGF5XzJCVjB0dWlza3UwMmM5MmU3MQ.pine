		...
		if( bbp <= -5.99802 )
			...
			if( VIM > 1.13633 )
				...
				if( VIM > 1.18898 )
					ret := 0.000000
		if( bbp > -5.99802 )
			if( bullPower <= 0.439299 )
				if( VIP_VIM <= 0.032596 )
					if( bullPower <= 0.393573 )
						ret := 0.479290
					if( bullPower > 0.393573 )
						ret := 1.000000 // buy
				if( VIP_VIM > 0.032596 )
					...
					if( bbm > 1.22358 )
						ret := 0.437500
			if( bullPower > 0.439299 )
				if( bearPower <= 1.38665 )
					if( bullPower <= 1.7238 )
						ret := -0.159851
					if( bullPower > 1.7238 )
						ret := 0.160112
				if( bearPower > 1.38665 )
					if( bullPower <= 8.31553 )
						ret := -0.347913
					if( bullPower > 8.31553 )
						ret := 0.038278
...
float op_operation = decision_tree_0_MSFT_1Day_02c92e71(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
