			...
			if( Typical_Price <= 137.52 )
				if( Positive_Money_Flow <= 6.05546e+08 )
					...
					if( Negative_Money_Flow > 1.63651e+09 )
						ret := -0.495495
				if( Positive_Money_Flow > 6.05546e+08 )
					if( Money_Flow_Ratio <= 0.621322 )
						ret := 0.309859
					if( Money_Flow_Ratio > 0.621322 )
						ret := -0.350487
			if( Typical_Price > 137.52 )
				if( Negative_Money_Flow_Sum <= 4.98025e+09 )
					if( VIP <= 1.40334 )
						ret := -0.962963 // sell
					if( VIP > 1.40334 )
						ret := -0.125000
				if( Negative_Money_Flow_Sum > 4.98025e+09 )
					if( Money_Flow_Ratio <= 0.44026 )
						ret := -0.525000
					if( Money_Flow_Ratio > 0.44026 )
						ret := 0.316071
		if( Raw_Money_Flow > 2.76341e+09 )
			if( VIP <= 0.837544 )
				if( Negative_Money_Flow_Sum <= 5.00599e+10 )
					if( Negative_Money_Flow <= 2.10666e+09 )
						ret := -0.625000
					if( Negative_Money_Flow > 2.10666e+09 )
						ret := 0.766667 // buy
				if( Negative_Money_Flow_Sum > 5.00599e+10 )
			...
			if( VIP > 0.837544 )
				if( MFI_High <= -20.5806 )
					...
					if( MFI > 18.5629 )
						ret := -0.838983 // sell
				if( MFI_High > -20.5806 )
					if( Positive_Money_Flow_Sum <= 3.37071e+10 )
						ret := 0.384615
					if( Positive_Money_Flow_Sum > 3.37071e+10 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_PYPL_1Day_fb488264(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
