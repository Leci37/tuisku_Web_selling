		...
		if( Positive_Money_Flow_Sum <= 1.39403e+11 )
			if( bullPower <= 42.7578 )
				if( Money_Flow_Ratio <= 0.252013 )
					if( bearPower <= -373.187 )
						ret := -0.500000
					if( bearPower > -373.187 )
						ret := 0.920000 // buy
				if( Money_Flow_Ratio > 0.252013 )
					if( Negative_Money_Flow_Sum <= 4.82209e+10 )
						ret := 0.169014
					if( Negative_Money_Flow_Sum > 4.82209e+10 )
						ret := -0.357810
			if( bullPower > 42.7578 )
				if( Typical_Price <= 2036.07 )
					if( bbp <= 19.518 )
						ret := 0.555556
					if( bbp > 19.518 )
						ret := -0.252033
				if( Typical_Price > 2036.07 )
					...
					if( MFI_Low > 48.7648 )
						ret := 0.612245
		if( Positive_Money_Flow_Sum > 1.39403e+11 )
			if( Typical_Price <= 3119.43 )
				if( Positive_Money_Flow <= 1.8133e+10 )
					if( Negative_Money_Flow <= 1.45547e+10 )
						ret := 0.000000
					if( Negative_Money_Flow > 1.45547e+10 )
						ret := 0.500000
				if( Positive_Money_Flow > 1.8133e+10 )
					ret := -1.000000 // sell
			if( Typical_Price > 3119.43 )
				if( Typical_Price <= 3598.93 )
					if( bullPower <= 5.27578 )
						ret := 0.000000
					if( bullPower > 5.27578 )
						ret := -0.956522 // sell
				if( Typical_Price > 3598.93 )
...
float op_operation = decision_tree_0_AMZN_1Day_9422a9da(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
