			...
			if( senkou_span_b > 216.703 )
				if( chinkou_span <= 317.585 )
					...
					if( tenkan_sen > 247.642 )
						ret := -0.162393
				if( chinkou_span > 317.585 )
					if( senkou_span_a <= 331.216 )
						ret := 0.582418
					if( senkou_span_a > 331.216 )
						ret := -1.000000 // sell
		if( senkou_span_b > 323.07 )
			if( basis_max <= -13.9432 )
				ret := 0.000000
			if( basis_max > -13.9432 )
				if( senkou_span_a_displaced <= 307.649 )
					ret := 0.000000
				if( senkou_span_a_displaced > 307.649 )
					if( senkou_span_b_displaced <= 335.679 )
						ret := -1.000000 // sell
					if( senkou_span_b_displaced > 335.679 )
						ret := -0.888889 // sell
...
float op_operation = decision_tree_0_CRWD_1Day_0fd2341f(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
