			...
			if( bbp <= 42.6449 )
				...
				if( d_k > -3.41221 )
					...
					if( rsi1 > 74.3613 )
						ret := -0.983871 // sell
			if( bbp > 42.6449 )
				if( bearPower <= 14.9531 )
					if( bullPower <= 35.7678 )
						ret := 0.933333 // buy
					if( bullPower > 35.7678 )
						ret := -1.000000 // sell
				if( bearPower > 14.9531 )
...
float op_operation = decision_tree_0_LTCUSDT_1Day_116a816d(bearPower, bbm, bbp, bullPower, BBPower_Color, d, d_k, smoothK_k, k, rsi1, smoothD_d)
