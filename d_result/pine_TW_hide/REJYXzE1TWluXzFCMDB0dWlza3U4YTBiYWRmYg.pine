...
decision_tree_0_DBX_15Min_8a0badfb(bearPower, bbm, bbp, bullPower, BBPower_Color)=>
	...
	if( bbp > 0.039808 )
		if( bbm <= 0.009905 )
			if( bearPower <= 0.101258 )
				if( bearPower <= 0.068477 )
					if( bullPower <= 0.023351 )
						ret := -0.261468
					if( bullPower > 0.023351 )
						ret := 0.066473
				if( bearPower > 0.068477 )
					...
					if( bbp > 0.199933 )
						ret := 0.605263
			if( bearPower > 0.101258 )
				if( bullPower <= 0.280781 )
					if( bbp <= 0.538041 )
						ret := -0.361654
					if( bbp > 0.538041 )
						ret := 0.160000
				if( bullPower > 0.280781 )
					if( bullPower <= 0.46526 )
						ret := -0.794702 // sell
					if( bullPower > 0.46526 )
						ret := -0.944954 // sell
		if( bbm > 0.009905 )
			if( bullPower <= 0.813171 )
				if( bearPower <= -0.393864 )
					if( bbm <= 1.18108 )
						ret := 1.000000 // buy
					if( bbm > 1.18108 )
						ret := 0.222222
				if( bearPower > -0.393864 )
					if( bullPower <= 0.040428 )
						ret := 0.273224
					if( bullPower > 0.040428 )
						ret := -0.070204
			if( bullPower > 0.813171 )
				if( bearPower <= -0.069018 )
					if( bullPower <= 1.70854 )
						ret := -0.831169 // sell
					if( bullPower > 1.70854 )
						ret := 0.428571
				if( bearPower > -0.069018 )
...
float op_operation = decision_tree_0_DBX_15Min_8a0badfb(bearPower, bbm, bbp, bullPower, BBPower_Color)
