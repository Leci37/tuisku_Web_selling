...
decision_tree_0_MSFT_1Hour_bad692a5(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( Negative_Money_Flow_Sum > 8.10358e+09 )
		if( Positive_Money_Flow_Sum <= 5.39862e+09 )
			...
			if( k > 71.827 )
				if( d_k <= -26.9175 )
					if( smoothK_k <= 79.2564 )
						ret := 0.000000
					if( smoothK_k > 79.2564 )
						ret := -1.000000 // sell
				if( d_k > -26.9175 )
					if( Typical_Price <= 294.561 )
						ret := 0.858108 // buy
					if( Typical_Price > 294.561 )
						ret := 0.266667
		if( Positive_Money_Flow_Sum > 5.39862e+09 )
			if( smoothK_k <= 19.8439 )
				if( rsi1 <= 38.2521 )
					if( Positive_Money_Flow_Sum <= 6.79076e+09 )
						ret := -0.541667
					if( Positive_Money_Flow_Sum > 6.79076e+09 )
						ret := 0.666667
				if( rsi1 > 38.2521 )
					...
					if( d > 17.7975 )
						ret := 0.571429
			if( smoothK_k > 19.8439 )
				if( Typical_Price <= 339.136 )
					if( Negative_Money_Flow_Sum <= 9.15189e+09 )
						ret := -0.054054
					if( Negative_Money_Flow_Sum > 9.15189e+09 )
						ret := -0.849624 // sell
				if( Typical_Price > 339.136 )
...
float op_operation = decision_tree_0_MSFT_1Hour_bad692a5(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
