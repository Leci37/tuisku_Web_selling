...
decision_tree_0_AFRM_1Hour_a2425761(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)=>
	...
	if( basis > 10.1403 )
		...
		if( upper_3 > 70.1742 )
			...
			if( upper_1 > 74.0094 )
				if( upper_2 <= 164.005 )
					if( basis_max <= -22.8166 )
						if( upper_4 <= 168.129 )
							ret := -0.142056
						if( upper_4 > 168.129 )
							ret := 0.500000
					if( basis_max > -22.8166 )
						if( basis_max <= -12.0751 )
							ret := 0.188854
						if( basis_max > -12.0751 )
							ret := -0.565217
				if( upper_2 > 164.005 )
...
float op_operation = decision_tree_0_AFRM_1Hour_a2425761(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
