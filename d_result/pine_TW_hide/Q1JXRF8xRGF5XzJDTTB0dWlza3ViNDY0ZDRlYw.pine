			...
			if( ad_mf > -152533 )
				...
				if( MFI > 59.0621 )
					...
					if( Typical_Price > 130.665 )
						ret := -0.611111
	if( Raw_Money_Flow > 6.01114e+08 )
		if( Typical_Price <= 184.501 )
			if( Negative_Money_Flow_Sum <= 3.84756e+09 )
				if( mf <= -0.093598 )
					if( Negative_Money_Flow_Sum <= 1.9941e+09 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 1.9941e+09 )
						ret := -1.000000 // sell
				if( mf > -0.093598 )
					if( Typical_Price <= 93.6006 )
						ret := 1.000000 // buy
					if( Typical_Price > 93.6006 )
						ret := 0.082353
			if( Negative_Money_Flow_Sum > 3.84756e+09 )
				if( Negative_Money_Flow <= 9.92664e+08 )
					if( mf <= 0.233261 )
						ret := 0.640000
					if( mf > 0.233261 )
						ret := -0.363636
				if( Negative_Money_Flow > 9.92664e+08 )
					if( Typical_Price <= 174.121 )
						ret := -0.480000
					if( Typical_Price > 174.121 )
						ret := 0.666667
		if( Typical_Price > 184.501 )
			if( Money_Flow_Ratio <= 6.12402 )
				if( Money_Flow_Ratio <= 0.520183 )
					if( mf <= -0.145204 )
						ret := -0.086957
					if( mf > -0.145204 )
						ret := -0.702128 // sell
...
float op_operation = decision_tree_0_CRWD_1Day_b464d4ec(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
