...
decision_tree_0_NVST_1Day_c5422d38(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( Negative_Money_Flow_Sum > 3.58541e+08 )
		if( smoothK_k <= 6.21737 )
			if( MFI_High <= -43.5667 )
				...
				if( Negative_Money_Flow_Sum > 1.18813e+09 )
					ret := -1.000000 // sell
			if( MFI_High > -43.5667 )
				if( smoothK_k <= 2.38413 )
					if( smoothK_k <= -0.858666 )
						ret := -0.269231
					if( smoothK_k > -0.858666 )
						ret := -0.692308
				if( smoothK_k > 2.38413 )
		...
		if( smoothK_k > 6.21737 )
			if( rsi1 <= 46.6196 )
				if( Typical_Price <= 26.1941 )
					if( Money_Flow_Ratio <= 0.215129 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 0.215129 )
						ret := 0.019868
				if( Typical_Price > 26.1941 )
					if( Typical_Price <= 37.1609 )
						ret := -0.627803
					if( Typical_Price > 37.1609 )
						ret := -0.236111
			if( rsi1 > 46.6196 )
				if( Typical_Price <= 37.9735 )
					if( Positive_Money_Flow <= 5.08994e+07 )
						ret := 0.492754
					if( Positive_Money_Flow > 5.08994e+07 )
						ret := 0.012658
				if( Typical_Price > 37.9735 )
...
float op_operation = decision_tree_0_NVST_1Day_c5422d38(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
