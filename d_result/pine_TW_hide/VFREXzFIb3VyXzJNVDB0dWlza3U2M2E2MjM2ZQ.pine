				...
				if( Positive_Money_Flow_Sum <= 1.37631e+09 )
					...
					if( ema12 > 2.93102 )
						...
						if( tema > 255.746 )
							ret := 0.093270
				if( Positive_Money_Flow_Sum > 1.37631e+09 )
					if( Positive_Money_Flow <= 4173.9 )
						if( ema1 <= 810.793 )
							ret := 0.379310
						if( ema1 > 810.793 )
							ret := -0.785714 // sell
					if( Positive_Money_Flow > 4173.9 )
						if( Positive_Money_Flow <= 2.93083e+06 )
							ret := -0.923077 // sell
						if( Positive_Money_Flow > 2.93083e+06 )
							ret := -0.380282
		if( Negative_Money_Flow_Sum > 9.14554e+08 )
			if( ema3 <= 675.752 )
				if( Negative_Money_Flow <= 4.40557e+06 )
					if( Typical_Price <= 637.264 )
						if( Positive_Money_Flow_Sum <= 4.29727e+08 )
							ret := -0.117647
						if( Positive_Money_Flow_Sum > 4.29727e+08 )
							ret := -0.827586 // sell
					if( Typical_Price > 637.264 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow > 4.40557e+06 )
					if( Raw_Money_Flow <= 3.85576e+08 )
						ret := 0.720930 // buy
					if( Raw_Money_Flow > 3.85576e+08 )
						ret := -1.000000 // sell
			if( ema3 > 675.752 )
				if( Negative_Money_Flow <= 2.4964e+08 )
					ret := -0.817204 // sell
				if( Negative_Money_Flow > 2.4964e+08 )
					if( Negative_Money_Flow <= 2.62964e+08 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow > 2.62964e+08 )
						ret := -0.500000
...
float op_operation = decision_tree_0_TTD_1Hour_63a6236e(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
