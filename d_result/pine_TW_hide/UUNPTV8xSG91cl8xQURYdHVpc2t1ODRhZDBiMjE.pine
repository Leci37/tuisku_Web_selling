		...
		if( adx <= 53.4286 )
			if( diMinus <= 29.805 )
				if( smoothedDirectionalMovementMinus <= 0.18331 )
					if( smoothedDirectionalMovementPlus <= 0.327515 )
						ret := 0.061513
					if( smoothedDirectionalMovementPlus > 0.327515 )
						ret := -0.074414
				if( smoothedDirectionalMovementMinus > 0.18331 )
			...
			if( diMinus > 29.805 )
				if( diPlus <= 31.3058 )
					if( trueRange <= 2.10169 )
						ret := 0.165852
					if( trueRange > 2.10169 )
						ret := -0.144695
				if( diPlus > 31.3058 )
					if( directionalMovementPlus <= 0.010882 )
						ret := -0.235294
					if( directionalMovementPlus > 0.010882 )
						ret := -0.750000 // sell
		if( adx > 53.4286 )
			if( directionalMovementMinus <= 0.005281 )
				if( smoothedDirectionalMovementPlus <= 1.45108 )
					if( adx <= 63.6744 )
						ret := 0.114379
					if( adx > 63.6744 )
						ret := -0.116013
				if( smoothedDirectionalMovementPlus > 1.45108 )
					ret := -0.682927
			if( directionalMovementMinus > 0.005281 )
				if( smoothedDirectionalMovementMinus <= 0.088894 )
					if( diPlus <= 47.8411 )
						ret := -0.080851
					if( diPlus > 47.8411 )
						ret := 0.514851
...
float op_operation = decision_tree_0_QCOM_1Hour_84ad0b21(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
