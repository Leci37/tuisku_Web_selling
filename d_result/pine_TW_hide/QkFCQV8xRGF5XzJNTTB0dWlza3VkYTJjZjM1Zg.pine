		...
		if( Long_MA <= 119.821 )
			if( Money_Flow_Ratio <= 1.08885 )
				if( Negative_Money_Flow_Sum <= 1.26566e+10 )
					ret := 0.057143
				if( Negative_Money_Flow_Sum > 1.26566e+10 )
					if( Negative_Money_Flow <= 4.36352e+09 )
						ret := -0.693252
					if( Negative_Money_Flow > 4.36352e+09 )
						ret := 1.000000 // buy
			if( Money_Flow_Ratio > 1.08885 )
				if( Money_Flow_Ratio <= 1.62466 )
					if( Raw_Money_Flow <= 2.28514e+09 )
						ret := 0.035714
					if( Raw_Money_Flow > 2.28514e+09 )
						ret := 0.613636
				if( Money_Flow_Ratio > 1.62466 )
					if( Negative_Money_Flow_Sum <= 9.67151e+09 )
						ret := -0.012346
					if( Negative_Money_Flow_Sum > 9.67151e+09 )
						ret := -0.637931
		if( Long_MA > 119.821 )
			if( Positive_Money_Flow_Sum <= 1.74071e+10 )
				if( Short_Long_Diff <= -11.7226 )
					if( Typical_Price <= 153.998 )
						ret := -0.384615
					if( Typical_Price > 153.998 )
						ret := 0.750000 // buy
				if( Short_Long_Diff > -11.7226 )
					if( Raw_Money_Flow <= 7.82598e+09 )
						ret := 0.481481
					if( Raw_Money_Flow > 7.82598e+09 )
						ret := 1.000000 // buy
			if( Positive_Money_Flow_Sum > 1.74071e+10 )
				if( Raw_Money_Flow <= 5.67988e+09 )
					if( Negative_Money_Flow_Sum <= 1.38554e+10 )
						ret := 0.116279
					if( Negative_Money_Flow_Sum > 1.38554e+10 )
						ret := -0.132287
				if( Raw_Money_Flow > 5.67988e+09 )
					if( Short_Long_Diff <= 3.52827 )
						ret := 0.360000
					if( Short_Long_Diff > 3.52827 )
						ret := -0.235294
...
float op_operation = decision_tree_0_BABA_1Day_da2cf35f(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
