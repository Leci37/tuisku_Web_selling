			...
			if( Negative_Money_Flow_Sum > 1.39896e+09 )
				...
				if( Short_MA > 204.162 )
					...
					if( Positive_Money_Flow_Sum > 6.51711e+09 )
						ret := -0.090836
	if( Raw_Money_Flow > 1.13014e+08 )
		if( Short_Long_Diff <= -11.0154 )
			if( Short_Long_Diff <= -162.423 )
				ret := -0.400000
			if( Short_Long_Diff > -162.423 )
				if( MFI <= 73.3677 )
					ret := 1.000000 // buy
				if( MFI > 73.3677 )
					ret := 0.600000
		if( Short_Long_Diff > -11.0154 )
			if( Typical_Price <= 155.057 )
				if( Positive_Money_Flow_Sum <= 1.26163e+09 )
					if( Typical_Price <= 122.618 )
						ret := -0.675325
					if( Typical_Price > 122.618 )
						ret := -0.156740
				if( Positive_Money_Flow_Sum > 1.26163e+09 )
					if( Typical_Price <= 113.706 )
						ret := 0.375887
					if( Typical_Price > 113.706 )
						ret := 0.028322
			if( Typical_Price > 155.057 )
				if( Money_Flow_Ratio <= 0.008088 )
					if( Raw_Money_Flow <= 8.41068e+08 )
						ret := 0.812500 // buy
					if( Raw_Money_Flow > 8.41068e+08 )
						ret := 0.224138
				if( Money_Flow_Ratio > 0.008088 )
					if( Positive_Money_Flow_Sum <= 1.75423e+08 )
						ret := -0.769231 // sell
					if( Positive_Money_Flow_Sum > 1.75423e+08 )
						ret := -0.084771
...
float op_operation = decision_tree_0_AAPL_1Hour_8391a9d7(Short_Long_Diff, MA_Cross, Long_MA, Short_MA, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
