			...
			if( Positive_Money_Flow_Sum <= 4.81658e+09 )
				...
				if( Negative_Money_Flow_Sum > 2.94846e+09 )
					...
					if( bbp > -8.19684 )
						ret := -0.479042
			if( Positive_Money_Flow_Sum > 4.81658e+09 )
				if( Negative_Money_Flow_Sum <= 2.15121e+09 )
					if( Money_Flow_Ratio <= 3.00303 )
						ret := -0.800000 // sell
					if( Money_Flow_Ratio > 3.00303 )
						ret := 0.000000
				if( Negative_Money_Flow_Sum > 2.15121e+09 )
					if( Negative_Money_Flow <= 1.40448e+06 )
						ret := 0.416667
					if( Negative_Money_Flow > 1.40448e+06 )
						ret := 0.814815 // buy
...
float op_operation = decision_tree_0_LYFT_1Day_88ef46e8(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
