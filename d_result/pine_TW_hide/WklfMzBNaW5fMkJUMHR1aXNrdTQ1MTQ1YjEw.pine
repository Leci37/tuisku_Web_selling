...
decision_tree_0_ZI_30Min_45145b10(bbp, bullPower, BBPower_Color, bearPower, bbm, ema2, tema, ema12, ema3, ema1, ema13)=>
	...
	if( bearPower > 0.140993 )
				...
				if( bbp <= 0.734428 )
					...
					if( tema > 20.9163 )
						...
						if( ema12 > 0.162417 )
							ret := 0.800000 // buy
				if( bbp > 0.734428 )
					if( bearPower <= 0.674733 )
						if( tema <= 63.5958 )
							ret := -0.580786
						if( tema > 63.5958 )
							ret := 0.000000
					if( bearPower > 0.674733 )
						if( bearPower <= 1.01349 )
							ret := -0.981818 // sell
						if( bearPower > 1.01349 )
							ret := -0.687500
			if( bbm > 0.527424 )
				if( bullPower <= 0.770645 )
					ret := 1.000000 // buy
				if( bullPower > 0.770645 )
					if( ema12 <= 0.187859 )
						if( bearPower <= 0.379308 )
							ret := -0.608108
						if( bearPower > 0.379308 )
							ret := 0.416667
					if( ema12 > 0.187859 )
		...
		if( ema13 > 0.194804 )
			...
			if( tema > 42.7982 )
				if( ema3 <= 46.0861 )
					if( bearPower <= 0.348532 )
						if( bullPower <= 0.597679 )
							ret := -0.183406
						if( bullPower > 0.597679 )
							ret := 0.411215
					if( bearPower > 0.348532 )
...
float op_operation = decision_tree_0_ZI_30Min_45145b10(bbp, bullPower, BBPower_Color, bearPower, bbm, ema2, tema, ema12, ema3, ema1, ema13)
