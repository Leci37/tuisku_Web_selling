...
decision_tree_0_MDB_1Day_27b50181(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( Negative_Money_Flow_Sum > 1.47629e+09 )
		if( d_k <= -2.92881 )
			...
			if( Raw_Money_Flow > 3.96997e+08 )
				if( rsi1 <= 51.6753 )
					if( Negative_Money_Flow_Sum <= 4.50182e+09 )
						ret := 0.261905
					if( Negative_Money_Flow_Sum > 4.50182e+09 )
						ret := 0.711111 // buy
				if( rsi1 > 51.6753 )
					if( Money_Flow_Ratio <= 0.792084 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 0.792084 )
						ret := 0.269841
		if( d_k > -2.92881 )
			if( Typical_Price <= 293.99 )
				if( Positive_Money_Flow_Sum <= 3.0259e+09 )
					if( Raw_Money_Flow <= 2.12558e+08 )
						ret := -0.610619
					if( Raw_Money_Flow > 2.12558e+08 )
						ret := 0.055375
				if( Positive_Money_Flow_Sum > 3.0259e+09 )
			...
			if( Typical_Price > 293.99 )
				if( d <= 40.8064 )
					...
					if( MFI_Low > 0.927677 )
						ret := -0.626230
				if( d > 40.8064 )
					if( Negative_Money_Flow_Sum <= 2.59602e+09 )
						ret := -0.562500
					if( Negative_Money_Flow_Sum > 2.59602e+09 )
						ret := 0.179245
...
float op_operation = decision_tree_0_MDB_1Day_27b50181(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
