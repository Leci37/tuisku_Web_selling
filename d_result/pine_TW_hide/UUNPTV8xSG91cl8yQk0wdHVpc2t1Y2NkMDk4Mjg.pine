	...
	if( Positive_Money_Flow_Sum > 9.89413e+08 )
		if( Typical_Price <= 130.434 )
			if( Positive_Money_Flow_Sum <= 1.09699e+09 )
				ret := -0.230143
			if( Positive_Money_Flow_Sum > 1.09699e+09 )
				if( Money_Flow_Ratio <= 16.1729 )
					if( Raw_Money_Flow <= 1.84697e+08 )
						if( bbm <= 0.51451 )
							ret := 0.036649
						if( bbm > 0.51451 )
							ret := 0.487871
					if( Raw_Money_Flow > 1.84697e+08 )
						if( Positive_Money_Flow_Sum <= 1.26122e+09 )
							ret := 0.472222
						if( Positive_Money_Flow_Sum > 1.26122e+09 )
							ret := -0.401786
				if( Money_Flow_Ratio > 16.1729 )
					ret := 0.731034 // buy
		if( Typical_Price > 130.434 )
			if( bullPower <= 1.48585 )
				if( Positive_Money_Flow_Sum <= 1.09581e+09 )
					if( Negative_Money_Flow_Sum <= 8.76819e+08 )
						if( Negative_Money_Flow <= 1.1887e+06 )
							ret := -0.128319
						if( Negative_Money_Flow > 1.1887e+06 )
							ret := 0.666667
					if( Negative_Money_Flow_Sum > 8.76819e+08 )
						ret := -0.469231
				if( Positive_Money_Flow_Sum > 1.09581e+09 )
					if( Typical_Price <= 139.421 )
						ret := -0.057471
					if( Typical_Price > 139.421 )
						if( Money_Flow_Ratio <= 2.3418 )
							ret := -0.323591
						if( Money_Flow_Ratio > 2.3418 )
							ret := -0.614035
			if( bullPower > 1.48585 )
				if( Money_Flow_Ratio <= 4.68295 )
					if( bbp <= 6.68128 )
						ret := 0.008357
					if( bbp > 6.68128 )
						ret := 0.573333
...
float op_operation = decision_tree_0_QCOM_1Hour_ccd09828(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
