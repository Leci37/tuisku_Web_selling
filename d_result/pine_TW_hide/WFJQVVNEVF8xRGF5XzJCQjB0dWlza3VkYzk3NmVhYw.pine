			...
			if( bbp > -0.08127 )
				...
				if( Upper_Band > 0.327478 )
					...
					if( Upper_Band > 0.640965 )
						ret := -0.247012
	if( Upper_Band > 0.704423 )
		if( Lower_Band <= 1.01776 )
			if( bullPower <= 0.039685 )
				if( bbp <= -0.276735 )
					if( basis <= 1.07014 )
						ret := -0.125000
					if( basis > 1.07014 )
				...
				if( bbp > -0.276735 )
					...
					if( basis > 1.04817 )
						ret := -0.743902 // sell
			if( bullPower > 0.039685 )
				if( Lower_Band <= 0.483004 )
					if( Upper_Band <= 0.788815 )
						ret := 0.333333
					if( Upper_Band > 0.788815 )
						ret := -0.700000 // sell
				if( Lower_Band > 0.483004 )
					if( Upper_Band <= 0.720726 )
						ret := -0.916667 // sell
					if( Upper_Band > 0.720726 )
						ret := 0.331361
		if( Lower_Band > 1.01776 )
			if( Upper_Band <= 1.23444 )
				ret := 0.076923
			if( Upper_Band > 1.23444 )
				if( bbp <= -0.03712 )
					if( bearPower <= -0.293388 )
						ret := -1.000000 // sell
					if( bearPower > -0.293388 )
						ret := -0.363636
				if( bbp > -0.03712 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_dc976eac(basis, Lower_Band, Upper_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
