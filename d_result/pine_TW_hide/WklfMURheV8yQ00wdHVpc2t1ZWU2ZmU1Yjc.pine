	...
	if( mf > -0.096414 )
			...
			if( Money_Flow_Ratio <= 3.26606 )
				...
				if( mf > 0.282117 )
					...
					if( MFI_High > -31.245 )
						ret := -0.166667
			if( Money_Flow_Ratio > 3.26606 )
				if( Typical_Price <= 27.899 )
					if( Positive_Money_Flow_Sum <= 1.07601e+09 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 1.07601e+09 )
						ret := 0.939394 // buy
				if( Typical_Price > 27.899 )
		...
		if( Raw_Money_Flow > 2.22229e+08 )
			if( MFI_Low <= 1.94843 )
				ret := 0.833333 // buy
			if( MFI_Low > 1.94843 )
				if( Negative_Money_Flow_Sum <= 9.32342e+08 )
					if( Positive_Money_Flow_Sum <= 4.03498e+09 )
						ret := 0.035714
					if( Positive_Money_Flow_Sum > 4.03498e+09 )
						ret := -1.000000 // sell
				if( Negative_Money_Flow_Sum > 9.32342e+08 )
					if( Typical_Price <= 25.7042 )
						ret := 0.400000
					if( Typical_Price > 25.7042 )
						ret := -0.757895 // sell
...
float op_operation = decision_tree_0_ZI_1Day_ee6fe5b7(ad, ad_mf, mf, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
