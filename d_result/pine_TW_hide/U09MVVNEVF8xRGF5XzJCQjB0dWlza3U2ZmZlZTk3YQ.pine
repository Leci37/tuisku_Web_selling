			...
			if( bearPower > 0.400431 )
				...
				if( basis > 19.2841 )
					...
					if( basis > 54.3588 )
						ret := 0.716418 // buy
		if( basis > 100.661 )
			if( Lower_Band <= 148.364 )
				if( bbm <= 13.3001 )
					if( Upper_Band <= 197.924 )
						ret := -0.219780
					if( Upper_Band > 197.924 )
						ret := -0.857143 // sell
				if( bbm > 13.3001 )
					if( bearPower <= 6.72157 )
						ret := 0.857143 // buy
					if( bearPower > 6.72157 )
						ret := -0.296296
			if( Lower_Band > 148.364 )
				if( Upper_Band <= 254.13 )
					if( basis <= 179.554 )
						ret := -0.818182 // sell
					if( basis > 179.554 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_SOLUSDT_1Day_6ffee97a(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
