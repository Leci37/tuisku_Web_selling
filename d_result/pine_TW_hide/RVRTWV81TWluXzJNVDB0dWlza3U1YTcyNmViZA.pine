			...
			if( Negative_Money_Flow <= 43.9008 )
				...
				if( ema2 > 61.8847 )
					...
					if( Raw_Money_Flow > 2.41024e+07 )
						ret := 0.620000
			if( Negative_Money_Flow > 43.9008 )
				if( Negative_Money_Flow <= 784467 )
					if( Negative_Money_Flow_Sum <= 5.01863e+07 )
						if( MFI <= 56.6217 )
							ret := 0.647368
						if( MFI > 56.6217 )
							ret := -0.350000
				...
				if( Negative_Money_Flow > 784467 )
					...
					if( ema12 > -0.637899 )
						...
						if( ema2 > 92.9256 )
							ret := -0.214022
		if( ema12 > 0.018634 )
			if( Typical_Price <= 99.9901 )
				if( Positive_Money_Flow_Sum <= 4.95927e+07 )
					if( Negative_Money_Flow <= 2.22195e+06 )
						if( Positive_Money_Flow_Sum <= 192596 )
							ret := 0.394737
						if( Positive_Money_Flow_Sum > 192596 )
							ret := -0.277544
					if( Negative_Money_Flow > 2.22195e+06 )
						if( Money_Flow_Ratio <= 1.12269 )
							ret := 0.238532
						if( Money_Flow_Ratio > 1.12269 )
							ret := -0.826087 // sell
				if( Positive_Money_Flow_Sum > 4.95927e+07 )
					if( Negative_Money_Flow_Sum <= 7.43408e+07 )
						if( ema12 <= 0.765999 )
							ret := -0.093834
						if( ema12 > 0.765999 )
							ret := 0.888889 // buy
...
float op_operation = decision_tree_0_ETSY_5Min_5a726ebd(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
