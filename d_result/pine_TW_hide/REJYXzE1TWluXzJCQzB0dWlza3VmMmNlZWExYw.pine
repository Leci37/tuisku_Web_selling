...
decision_tree_0_DBX_15Min_f2ceea1c(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)=>
	...
	if( bullPower > -0.017865 )
		...
		if( ad_mf > -58.2119 )
			if( ad <= 2752.37 )
				if( bullPower <= 0.101363 )
					ret := -0.039561
				if( bullPower > 0.101363 )
					if( bullPower <= 0.277617 )
						if( ad_mf <= 0.348559 )
							ret := -0.228384
						if( ad_mf > 0.348559 )
							ret := -0.412492
...
float op_operation = decision_tree_0_DBX_15Min_f2ceea1c(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
