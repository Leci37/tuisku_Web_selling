...
float op_operation = decision_tree_0_DOGEUSDT_1Day_5e585718(macd, macd_IsBelowInt, signal, histB_IsUpInt, macd_IsAboveInt, histB_IsDownInt, histA_IsUpInt, hist, histA_IsDownInt)
