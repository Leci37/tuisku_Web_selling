			...
			if( bbp > 40.2343 )
				...
				if( VIM > 0.961895 )
					...
					if( bbm > 20.0245 )
						ret := 0.500000
		if( VIP > 1.17413 )
			if( bearPower <= 16.8021 )
				if( bullPower <= 21.9741 )
					if( bullPower <= 10.0651 )
						ret := -0.693182
					if( bullPower > 10.0651 )
						ret := -0.096618
				if( bullPower > 21.9741 )
...
float op_operation = decision_tree_0_MDB_1Day_d6da0d5e(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
