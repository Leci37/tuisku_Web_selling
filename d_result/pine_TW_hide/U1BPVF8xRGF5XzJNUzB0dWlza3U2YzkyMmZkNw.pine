			...
			if( Negative_Money_Flow_Sum > 3.93566e+09 )
				...
				if( k > 79.7191 )
					...
					if( Negative_Money_Flow > 2.72255e+08 )
						ret := -0.714286 // sell
	if( Raw_Money_Flow > 3.58908e+08 )
		if( Positive_Money_Flow_Sum <= 7.7992e+09 )
			if( smoothK_k <= 61.7145 )
				if( Positive_Money_Flow_Sum <= 3.52236e+09 )
					if( Positive_Money_Flow_Sum <= 1.86226e+09 )
						ret := -0.202532
					if( Positive_Money_Flow_Sum > 1.86226e+09 )
						ret := 0.307229
				if( Positive_Money_Flow_Sum > 3.52236e+09 )
					if( Negative_Money_Flow_Sum <= 2.19116e+09 )
						ret := 0.250000
					if( Negative_Money_Flow_Sum > 2.19116e+09 )
						ret := -0.485207
			if( smoothK_k > 61.7145 )
				if( Positive_Money_Flow_Sum <= 3.53996e+09 )
					if( Money_Flow_Ratio <= 1.38818 )
						ret := -0.382353
					if( Money_Flow_Ratio > 1.38818 )
						ret := -0.828283 // sell
				if( Positive_Money_Flow_Sum > 3.53996e+09 )
					if( Positive_Money_Flow <= 5.92978e+08 )
						ret := -0.487805
					if( Positive_Money_Flow > 5.92978e+08 )
						ret := 0.075000
		if( Positive_Money_Flow_Sum > 7.7992e+09 )
...
float op_operation = decision_tree_0_SPOT_1Day_6c922fd7(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
