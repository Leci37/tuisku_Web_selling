			...
			if( MFI_Low > 24.6133 )
				...
				if( MFI_Low > 36.0647 )
					...
					if( MFI_Low > 43.4811 )
						ret := 1.000000 // buy
	if( Typical_Price > 204.755 )
		if( Positive_Money_Flow_Sum <= 3.43996e+09 )
			if( ema12 <= -8.04359 )
				if( ema2 <= 301.091 )
					if( ema2 <= 233.294 )
						ret := 0.100000
			...
			if( ema12 > -8.04359 )
				if( MFI <= 28.8828 )
					...
					if( ema12 > -2.54191 )
						ret := 0.333333
				if( MFI > 28.8828 )
					if( Positive_Money_Flow_Sum <= 2.50366e+09 )
						ret := 0.017493
					if( Positive_Money_Flow_Sum > 2.50366e+09 )
						ret := -0.457093
		if( Positive_Money_Flow_Sum > 3.43996e+09 )
			if( Negative_Money_Flow_Sum <= 1.46271e+09 )
				if( Positive_Money_Flow <= 2.49505e+08 )
					if( Positive_Money_Flow_Sum <= 4.07948e+09 )
						ret := -0.935484 // sell
					if( Positive_Money_Flow_Sum > 4.07948e+09 )
						ret := 0.000000
				if( Positive_Money_Flow > 2.49505e+08 )
					if( Positive_Money_Flow_Sum <= 4.11326e+09 )
						ret := 0.347826
					if( Positive_Money_Flow_Sum > 4.11326e+09 )
						ret := -0.357143
			if( Negative_Money_Flow_Sum > 1.46271e+09 )
...
float op_operation = decision_tree_0_ADSK_1Day_c2265b37(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
