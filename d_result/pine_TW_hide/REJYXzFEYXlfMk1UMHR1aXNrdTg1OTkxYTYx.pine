			...
			if( Positive_Money_Flow_Sum <= 1.77371e+09 )
				if( Positive_Money_Flow_Sum <= 4.0225e+08 )
					...
					if( MFI_Low > 26.3852 )
						ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 4.0225e+08 )
					if( Raw_Money_Flow <= 1.28816e+08 )
						ret := -0.511111
					if( Raw_Money_Flow > 1.28816e+08 )
						ret := -0.807229 // sell
			if( Positive_Money_Flow_Sum > 1.77371e+09 )
				if( ema13 <= 1.82283 )
					if( Raw_Money_Flow <= 1.53902e+08 )
						ret := 0.000000
					if( Raw_Money_Flow > 1.53902e+08 )
						ret := 0.925926 // buy
				if( ema13 > 1.82283 )
					...
					if( tema > 25.7648 )
						ret := -0.250000
		if( ema3 > 24.8388 )
			if( Positive_Money_Flow_Sum <= 4.16341e+08 )
				if( MFI_Low <= -0.538702 )
					ret := -0.111111
				if( MFI_Low > -0.538702 )
					if( ema2 <= 27.5783 )
					...
					if( ema2 > 27.5783 )
						ret := 0.880000 // buy
			if( Positive_Money_Flow_Sum > 4.16341e+08 )
				if( Positive_Money_Flow_Sum <= 2.24246e+09 )
					if( MFI_Low <= 28.4259 )
						ret := -0.069565
					if( MFI_Low > 28.4259 )
						ret := -0.340909
...
float op_operation = decision_tree_0_DBX_1Day_85991a61(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
