...
decision_tree_0_DOTUSDT_1Day_30d97ec6(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)=>
	...
	if( VIP > 1.23994 )
		if( VIM <= 0.783745 )
			if( bbp <= 14.3228 )
				if( bearPower <= 1.14337 )
					if( bearPower <= 0.263919 )
						ret := 1.000000 // buy
					if( bearPower > 0.263919 )
						ret := 0.266667
				if( bearPower > 1.14337 )
					if( bearPower <= 2.52869 )
						ret := 0.833333 // buy
					if( bearPower > 2.52869 )
						ret := 1.000000 // buy
			if( bbp > 14.3228 )
...
float op_operation = decision_tree_0_DOTUSDT_1Day_30d97ec6(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
