...
decision_tree_0_ADSK_1Hour_182b6b8f(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)=>
	...
	if( VIP > 1.34872 )
		if( VIM <= 1.0003 )
			if( smoothD_d <= 96.4911 )
				if( smoothD_d <= 95.8628 )
					if( d <= 91.8664 )
						ret := 0.058763
					if( d > 91.8664 )
						ret := 0.268080
			...
			if( smoothD_d > 96.4911 )
				...
				if( VIM > 0.831825 )
					ret := -0.428571
		if( VIM > 1.0003 )
			if( smoothK_k <= 92.0879 )
				if( d <= 86.9754 )
					if( smoothK_k <= -2.42704 )
						ret := 0.684211
					if( smoothK_k > -2.42704 )
						ret := -0.030888
				if( d > 86.9754 )
					...
					if( k > 93.4679 )
						ret := 0.842105 // buy
			if( smoothK_k > 92.0879 )
				if( smoothD_d <= 96.1186 )
					if( smoothD_d <= 75.1387 )
						ret := 0.333333
					if( smoothD_d > 75.1387 )
						ret := -0.678832
				if( smoothD_d > 96.1186 )
...
float op_operation = decision_tree_0_ADSK_1Hour_182b6b8f(rsi1, smoothK_k, d_k, k, d, smoothD_d, VIP, VIM, VIP_VIM)
