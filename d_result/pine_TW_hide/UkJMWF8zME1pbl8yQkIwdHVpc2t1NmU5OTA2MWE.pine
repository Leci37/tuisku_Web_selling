			...
			if( bullPower > 1.69159 )
				...
				if( bbp > 3.92793 )
					...
					if( bbp > 7.15938 )
						ret := 1.000000 // buy
	if( Lower_Band > 40.3368 )
		if( bullPower <= -0.196268 )
			if( bbm <= 0.823376 )
				if( basis <= 122.693 )
					if( Upper_Band <= 80.0048 )
						if( Upper_Band <= 76.6986 )
							ret := 0.146310
						if( Upper_Band > 76.6986 )
							ret := -0.208163
					if( Upper_Band > 80.0048 )
						if( Upper_Band <= 82.3288 )
							ret := 0.538793
						if( Upper_Band > 82.3288 )
							ret := 0.143963
				if( basis > 122.693 )
				...
				if( Upper_Band > 110.99 )
					if( basis <= 121.668 )
						...
						if( bbm > 2.45566 )
							ret := -0.040000
					if( basis > 121.668 )
						if( bearPower <= -2.36309 )
							ret := -0.400000
						if( bearPower > -2.36309 )
							ret := 0.666667
		if( bullPower > -0.196268 )
			if( basis <= 54.5489 )
				if( Lower_Band <= 48.4176 )
					if( Lower_Band <= 41.2846 )
						if( basis <= 42.4702 )
							ret := -0.228336
						if( basis > 42.4702 )
							ret := -0.663265
					if( Lower_Band > 41.2846 )
						...
						if( bbp > -0.512435 )
							ret := -0.044614
				if( Lower_Band > 48.4176 )
					if( Upper_Band <= 51.9085 )
						if( bearPower <= -0.730786 )
							ret := -0.062500
						if( bearPower > -0.730786 )
							ret := -0.685015
					if( Upper_Band > 51.9085 )
						if( Upper_Band <= 55.2651 )
							ret := 0.377358
						if( Upper_Band > 55.2651 )
							ret := -0.637681
			if( basis > 54.5489 )
				if( basis <= 66.3049 )
					if( bullPower <= -0.120658 )
						if( bbp <= -0.392707 )
							ret := -0.384615
						if( bbp > -0.392707 )
							ret := -1.000000 // sell
					if( bullPower > -0.120658 )
						if( bearPower <= -0.745135 )
							ret := 0.765957 // buy
						if( bearPower > -0.745135 )
							ret := 0.180804
				if( basis > 66.3049 )
					if( bbp <= 0.193306 )
						if( Upper_Band <= 79.6395 )
							ret := 0.170776
						if( Upper_Band > 79.6395 )
							ret := -0.065000
					if( bbp > 0.193306 )
...
float op_operation = decision_tree_0_RBLX_30Min_6e99061a(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
