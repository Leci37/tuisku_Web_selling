			...
			if( chinkou_span > 18.445 )
				...
				if( senkou_span_b > 20.1322 )
					...
					if( basis_max > -0.686677 )
						ret := 0.846154 // buy
	if( senkou_span_a_displaced > 20.2501 )
		if( kinjun_sen <= 28.0346 )
			if( basis_minus <= -9.82275 )
				if( senkou_span_a_displaced <= 26.2515 )
					if( senkou_span_a <= 18.7243 )
						ret := 0.000000
					if( senkou_span_a > 18.7243 )
						ret := 1.000000 // buy
				if( senkou_span_a_displaced > 26.2515 )
					ret := 0.000000
			if( basis_minus > -9.82275 )
				if( basis_max <= 0.773355 )
					if( senkou_span_b_displaced <= 24.776 )
						ret := 0.000000
					if( senkou_span_b_displaced > 24.776 )
						ret := -0.760563 // sell
				if( basis_max > 0.773355 )
					if( basis_max <= 1.21382 )
						ret := -0.940171 // sell
					if( basis_max > 1.21382 )
						ret := -0.363636
		if( kinjun_sen > 28.0346 )
			if( kinjun_sen <= 37.7651 )
				if( kinjun_sen <= 37.4714 )
					if( kinjun_sen <= 33.7896 )
						ret := 0.150327
					if( kinjun_sen > 33.7896 )
						ret := -0.666667
				if( kinjun_sen > 37.4714 )
					if( senkou_span_a_displaced <= 34.6499 )
						ret := 0.973684 // buy
					if( senkou_span_a_displaced > 34.6499 )
						ret := 0.062500
			if( kinjun_sen > 37.7651 )
				if( senkou_span_a_displaced <= 33.0984 )
					ret := 0.000000
				if( senkou_span_a_displaced > 33.0984 )
					if( senkou_span_a <= 47.745 )
						ret := -0.866667 // sell
					if( senkou_span_a > 47.745 )
						ret := 0.000000
...
float op_operation = decision_tree_0_DOTUSDT_1Day_5b418830(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
