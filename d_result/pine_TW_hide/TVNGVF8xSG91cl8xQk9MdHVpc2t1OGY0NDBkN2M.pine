...
decision_tree_0_MSFT_1Hour_8f440d7c(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( dif_source_BBlower > -4.47184 )
		...
		if( dif_source_BBupper > -15.7065 )
			if( BBlower <= 100.68 )
				if( dif_source_BBlower <= -0.082188 )
					ret := -0.969231 // sell
				if( dif_source_BBlower > -0.082188 )
					if( vrsi <= 19.794 )
						if( BBupper <= 113.396 )
					...
					if( vrsi > 19.794 )
						...
						if( BBlower > 94.477 )
							ret := -0.165789
			if( BBlower > 100.68 )
				if( dif_source_BBlower <= 30.7912 )
					if( dif_source_BBlower <= 3.92094 )
						if( vrsi <= 86.4522 )
							ret := 0.115733
						if( vrsi > 86.4522 )
							ret := 0.351351
...
float op_operation = decision_tree_0_MSFT_1Hour_8f440d7c(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
