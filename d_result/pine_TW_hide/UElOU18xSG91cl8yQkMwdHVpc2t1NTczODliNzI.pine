...
decision_tree_0_PINS_1Hour_57389b72(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)=>
				...
				if( bbp > 0.575171 )
					...
					if( BBPower_Color > 0.5 )
						...
						if( bbp > 1.28891 )
							ret := -0.656250
		if( ad_mf > -24980.6 )
			if( bullPower <= 0.507187 )
				if( BBPower_Color <= 0.5 )
					if( bullPower <= 0.379234 )
						if( mf <= 0.338159 )
							ret := 0.195711
						if( mf > 0.338159 )
							ret := 0.675926
	...
	if( ad_mf > -0.377795 )
		if( ad <= 4367.09 )
			if( bullPower <= -0.260489 )
				if( bullPower <= -1.74758 )
					if( bearPower <= -3.4568 )
						ret := 0.000000
					if( bearPower > -3.4568 )
						if( ad <= 3185.22 )
				...
				if( bbp > 0.344144 )
					...
					if( bbp > 1.35283 )
						...
						if( ad_mf > 2999 )
							ret := 0.000000
		if( ad > 4367.09 )
			if( bearPower <= 0.448989 )
				if( bbm <= 0.619669 )
					if( ad_mf <= 4572.07 )
						if( bearPower <= -0.268541 )
							ret := 0.916667 // buy
						if( bearPower > -0.268541 )
							ret := 0.166667
					if( ad_mf > 4572.07 )
				...
				if( bbm <= 1.89086 )
					if( mf <= 0.356903 )
						...
						if( mf > 0.176534 )
							ret := 0.415020
					if( mf > 0.356903 )
						if( bearPower <= 0.514517 )
							ret := 0.400000
						if( bearPower > 0.514517 )
							ret := -0.210526
				if( bbm > 1.89086 )
					if( bullPower <= 3.96215 )
						ret := -1.000000 // sell
					if( bullPower > 3.96215 )
						ret := 0.142857
...
float op_operation = decision_tree_0_PINS_1Hour_57389b72(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
