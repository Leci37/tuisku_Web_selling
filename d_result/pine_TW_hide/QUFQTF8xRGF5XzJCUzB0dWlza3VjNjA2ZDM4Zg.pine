...
decision_tree_0_AAPL_1Day_c606d38f(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( smoothK_k > 1.33703 )
		...
		if( d_k > 20.0326 )
			...
			if( d > 30.4541 )
				if( bbm <= 2.7275 )
					if( bullPower <= 1.31883 )
						ret := 0.600000
					if( bullPower > 1.31883 )
						ret := 0.000000
				if( bbm > 2.7275 )
					if( bullPower <= -2.76265 )
						ret := 1.000000 // buy
					if( bullPower > -2.76265 )
						ret := 0.785714 // buy
...
float op_operation = decision_tree_0_AAPL_1Day_c606d38f(bullPower, bbp, bearPower, bbm, BBPower_Color, rsi1, smoothK_k, d_k, k, d, smoothD_d)
