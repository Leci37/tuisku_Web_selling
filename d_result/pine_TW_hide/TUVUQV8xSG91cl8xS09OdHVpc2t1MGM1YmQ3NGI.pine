...
decision_tree_0_META_1Hour_0c5bd74b(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)=>
	...
	if( pvi_ema > -0.039941 )
		...
		if( tprice > 143.073 )
			if( nvimin <= 0.671413 )
				if( verde_mean <= 229.556 )
					if( tprice <= 592.653 )
						if( azul_mean <= 98.9001 )
							ret := 0.016098
						if( azul_mean > 98.9001 )
							ret := -0.950000 // sell
					if( tprice > 592.653 )
...
float op_operation = decision_tree_0_META_1Hour_0c5bd74b(verde_mean, verde, marron, media_azul, verde_media, nvi_ema, stoc, azul, verde_azul, pvi_ema, tprice, pvi, marron_mean, pvimax, azul_mean, xrsi, nvimin, media, source, oscp, nvim, xmf, pvimin, BollOsc, nvi, pvim, nvimax)
