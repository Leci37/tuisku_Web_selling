...
decision_tree_0_AVAXUSDT_1Day_2643f78c(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)=>
	...
	if( tema > 25.2046 )
		if( Negative_Money_Flow <= 2.0821e+08 )
			...
			if( Positive_Money_Flow_Sum > 6.32676e+08 )
				if( ema2 <= 39.4083 )
					if( Negative_Money_Flow_Sum <= 8.34521e+08 )
						ret := -0.259887
					if( Negative_Money_Flow_Sum > 8.34521e+08 )
						ret := -0.755102 // sell
				if( ema2 > 39.4083 )
		...
		if( Negative_Money_Flow > 2.0821e+08 )
			if( ema2 <= 60.5416 )
				if( Negative_Money_Flow_Sum <= 2.46958e+09 )
					if( ema3 <= 40.2566 )
						ret := 0.900000 // buy
					if( ema3 > 40.2566 )
						ret := 0.125000
				if( Negative_Money_Flow_Sum > 2.46958e+09 )
					ret := 1.000000 // buy
			if( ema2 > 60.5416 )
				if( Positive_Money_Flow_Sum <= 5.69838e+09 )
					if( ema2 <= 111.306 )
						ret := 0.307692
					if( ema2 > 111.306 )
						ret := -0.888889 // sell
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_2643f78c(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
