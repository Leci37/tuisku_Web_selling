		...
		if( bbp <= 7.15519 )
			...
			if( bbm > 1.75156 )
				...
				if( bbp > 6.75905 )
					ret := -0.818182 // sell
		if( bbp > 7.15519 )
			if( bearPower <= 9.22756 )
				if( bearPower <= 5.65282 )
					if( bbm <= 9.70365 )
						ret := -0.103448
					if( bbm > 9.70365 )
						ret := -0.764706 // sell
				if( bearPower > 5.65282 )
					if( bullPower <= 16.1485 )
						ret := 0.884615 // buy
					if( bullPower > 16.1485 )
						ret := -0.250000
			if( bearPower > 9.22756 )
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_23b7ce01(bullPower, bbp, bearPower, bbm, BBPower_Color)
