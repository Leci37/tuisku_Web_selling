	...
	if( Positive_Money_Flow <= 2.72554e+09 )
		...
		if( bearPower > -1.45832 )
			if( Money_Flow_Ratio <= 2.05886 )
				...
				if( Negative_Money_Flow_Sum > 1.15775e+09 )
					if( MFI <= 18.6129 )
						if( Negative_Money_Flow_Sum <= 3.77581e+09 )
							ret := 0.178344
						if( Negative_Money_Flow_Sum > 3.77581e+09 )
							ret := 0.681159
					if( MFI > 18.6129 )
						if( Negative_Money_Flow_Sum <= 1.39041e+09 )
							ret := 0.297134
						if( Negative_Money_Flow_Sum > 1.39041e+09 )
							ret := 0.062219
			if( Money_Flow_Ratio > 2.05886 )
				if( Negative_Money_Flow_Sum <= 8.55999e+08 )
					if( Typical_Price <= 158.986 )
						if( Positive_Money_Flow <= 2.11698e+08 )
							ret := -0.481894
						if( Positive_Money_Flow > 2.11698e+08 )
							ret := 0.207650
					if( Typical_Price > 158.986 )
						if( Raw_Money_Flow <= 3.09235e+08 )
							ret := 0.200780
						if( Raw_Money_Flow > 3.09235e+08 )
							ret := -0.020101
				if( Negative_Money_Flow_Sum > 8.55999e+08 )
					if( Negative_Money_Flow <= 1.55422e+09 )
						if( Typical_Price <= 571.99 )
							ret := -0.171952
						if( Typical_Price > 571.99 )
							ret := 0.141818
					if( Negative_Money_Flow > 1.55422e+09 )
						ret := 0.468208
	if( Positive_Money_Flow > 2.72554e+09 )
		if( bullPower <= 2.00469 )
			if( Typical_Price <= 948.46 )
				ret := -0.196030
			if( Typical_Price > 948.46 )
				ret := 0.827586 // buy
		if( bullPower > 2.00469 )
			if( Positive_Money_Flow <= 9.88522e+09 )
				ret := 0.335938
			if( Positive_Money_Flow > 9.88522e+09 )
				ret := -0.400000
...
float op_operation = decision_tree_0_NVDA_1Hour_e7476e56(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
