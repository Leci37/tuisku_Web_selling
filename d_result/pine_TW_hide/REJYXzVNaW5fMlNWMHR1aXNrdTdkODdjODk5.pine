				...
				if( rsi1 > 41.941 )
					if( VIP_VIM <= -0.627624 )
						...
						if( VIP > 4.99952 )
							ret := -0.727273 // sell
					if( VIP_VIM > -0.627624 )
						if( smoothK_k <= 53.6413 )
							ret := -0.049819
						if( smoothK_k > 53.6413 )
							ret := 0.039609
	if( rsi1 > 57.0842 )
		if( VIM <= 1.1425 )
			if( smoothD_d <= 92.6385 )
				if( VIP_VIM <= 0.362664 )
					if( d_k <= -29.9445 )
						if( rsi1 <= 57.5622 )
							ret := -1.000000 // sell
			...
			if( smoothD_d > 92.6385 )
				if( d <= 99.8194 )
					if( smoothK_k <= 90.4594 )
						if( rsi1 <= 81.9471 )
							ret := -0.405882
						if( rsi1 > 81.9471 )
							ret := 0.818182 // buy
					if( smoothK_k > 90.4594 )
						if( smoothK_k <= 94.2505 )
							ret := 0.329508
						if( smoothK_k > 94.2505 )
							ret := 0.081081
				if( d > 99.8194 )
		...
		if( VIM > 1.1425 )
			if( rsi1 <= 60.6004 )
				if( VIP_VIM <= 0.13794 )
					if( VIM <= 2.53614 )
						if( smoothD_d <= 22.1409 )
							ret := 0.647059
						if( smoothD_d > 22.1409 )
							ret := -0.238739
					if( VIM > 2.53614 )
						if( smoothK_k <= 77.4954 )
							ret := 0.972222 // buy
						if( smoothK_k > 77.4954 )
							ret := -0.181818
				if( VIP_VIM > 0.13794 )
				...
				if( d <= 40.3076 )
					if( VIM <= 1.45317 )
						...
						if( VIM > 1.43491 )
							ret := 0.333333
					if( VIM > 1.45317 )
						if( smoothK_k <= 8.27229 )
							ret := -0.720000 // sell
						if( smoothK_k > 8.27229 )
							ret := -0.983333 // sell
				if( d > 40.3076 )
					if( smoothK_k <= 26.7781 )
						ret := 0.666667
					if( smoothK_k > 26.7781 )
						if( rsi1 <= 73.6503 )
							ret := -0.362184
...
float op_operation = decision_tree_0_DBX_5Min_7d87c899(d, d_k, smoothK_k, k, rsi1, smoothD_d, VIP, VIP_VIM, VIM)
