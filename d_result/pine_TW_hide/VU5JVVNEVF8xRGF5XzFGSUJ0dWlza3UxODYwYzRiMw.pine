...
decision_tree_0_UNIUSDT_1Day_1860c4b3(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)=>
	...
	if( lower_1 > 7.60202 )
		if( upper_2 <= 32.8375 )
			...
			if( upper_5 > 15.2466 )
				if( lower_2 <= 5.86697 )
					if( basis_minus <= 38.3628 )
						ret := -0.942857 // sell
					if( basis_minus > 38.3628 )
						ret := 0.000000
				if( lower_2 > 5.86697 )
					if( basis_minus <= 18.7164 )
						ret := -0.577836
					if( basis_minus > 18.7164 )
						ret := -0.016807
		if( upper_2 > 32.8375 )
			if( lower_4 <= 15.5756 )
				if( basis_max <= -20.1735 )
					if( upper_6 <= 47.7069 )
						ret := 0.000000
					if( upper_6 > 47.7069 )
						ret := 0.865169 // buy
...
float op_operation = decision_tree_0_UNIUSDT_1Day_1860c4b3(lower_6, lower_3, basis_max, lower_1, upper_2, upper_6, upper_4, lower_2, basis_minus, upper_3, lower_5, upper_1, lower_4, basis, upper_5)
