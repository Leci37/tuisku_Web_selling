			...
			if( Positive_Money_Flow_Sum > 2.65686e+11 )
				...
				if( bbm > 31.7991 )
					...
					if( MFI > 91.7298 )
						ret := 0.400000
	if( Negative_Money_Flow_Sum > 1.061e+11 )
		if( Typical_Price <= 1009.25 )
			if( bearPower <= -1.53296 )
				if( Money_Flow_Ratio <= 0.701431 )
					if( MFI_High <= -67.043 )
						ret := -0.794872 // sell
					if( MFI_High > -67.043 )
						ret := 0.010504
				if( Money_Flow_Ratio > 0.701431 )
					if( Negative_Money_Flow_Sum <= 1.65091e+11 )
						ret := -0.611570
					if( Negative_Money_Flow_Sum > 1.65091e+11 )
						ret := -0.132597
			if( bearPower > -1.53296 )
				if( Negative_Money_Flow_Sum <= 1.13292e+11 )
					if( Typical_Price <= 390.436 )
						ret := -0.818182 // sell
					if( Typical_Price > 390.436 )
						ret := -0.133333
				if( Negative_Money_Flow_Sum > 1.13292e+11 )
					if( Positive_Money_Flow <= 1.86766e+10 )
						ret := -0.017699
					if( Positive_Money_Flow > 1.86766e+10 )
						ret := 0.548673
		if( Typical_Price > 1009.25 )
			if( MFI_High <= -14.3771 )
				if( MFI <= 54.5911 )
					if( Positive_Money_Flow <= 1.89952e+10 )
						ret := -0.894737 // sell
					if( Positive_Money_Flow > 1.89952e+10 )
						ret := -0.300000
				if( MFI > 54.5911 )
...
float op_operation = decision_tree_0_TSLA_1Day_ecdb913d(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
