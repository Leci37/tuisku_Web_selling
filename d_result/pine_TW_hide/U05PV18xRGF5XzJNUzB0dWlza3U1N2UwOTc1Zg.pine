		...
		if( MFI_High <= -38.9012 )
			if( smoothK_k <= 70.6691 )
				...
				if( Positive_Money_Flow > 1.41129e+09 )
					ret := 0.230769
			if( smoothK_k > 70.6691 )
				if( Positive_Money_Flow_Sum <= 4.80051e+09 )
					ret := 0.928571 // buy
				if( Positive_Money_Flow_Sum > 4.80051e+09 )
					ret := 0.187500
		if( MFI_High > -38.9012 )
			if( MFI <= 52.5031 )
				if( rsi1 <= 50.9841 )
					if( Negative_Money_Flow_Sum <= 1.08623e+10 )
						ret := 0.568966
					if( Negative_Money_Flow_Sum > 1.08623e+10 )
						ret := 0.031250
				if( rsi1 > 50.9841 )
					if( Typical_Price <= 278.846 )
						ret := -0.692308
					if( Typical_Price > 278.846 )
						ret := -0.100000
			if( MFI > 52.5031 )
				if( Positive_Money_Flow_Sum <= 3.7976e+09 )
					ret := 1.000000 // buy
				if( Positive_Money_Flow_Sum > 3.7976e+09 )
					if( d <= 82.3563 )
						ret := -0.422311
...
float op_operation = decision_tree_0_SNOW_1Day_57e0975f(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
