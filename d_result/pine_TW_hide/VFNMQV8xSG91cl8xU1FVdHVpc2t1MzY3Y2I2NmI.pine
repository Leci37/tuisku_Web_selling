...
float op_operation = decision_tree_0_TSLA_1Hour_367cb66b(lowerBB, noSqzInt, avgHighLow, rangema, sqzOffInt, upperKC, ma, basis, val, sqzOnInt, dev, priceRange, lowerKC, upperBB)
