...
decision_tree_0_QCOM_1Hour_a5847250(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)=>
	...
	if( Positive_Money_Flow_Sum > 9.89413e+08 )
		if( ema3 <= 137.993 )
			if( ema12 <= 1.59304 )
				if( Positive_Money_Flow_Sum <= 1.09564e+09 )
					ret := -0.226171
				if( Positive_Money_Flow_Sum > 1.09564e+09 )
					if( Positive_Money_Flow_Sum <= 1.17396e+09 )
						if( ema3 <= 121.057 )
							ret := 0.639535
						if( ema3 > 121.057 )
							ret := 0.000000
			...
			if( ema12 > 1.59304 )
				ret := 0.625551
		if( ema3 > 137.993 )
			if( Raw_Money_Flow <= 8.85818e+07 )
				if( ema12 <= 1.83539 )
					if( Positive_Money_Flow <= 527.968 )
						if( MFI_High <= 2.79038 )
							ret := 0.043077
						if( MFI_High > 2.79038 )
							ret := -0.622951
			...
			if( Raw_Money_Flow > 8.85818e+07 )
				if( ema12 <= -1.35665 )
					ret := -0.676471
				if( ema12 > -1.35665 )
					if( Positive_Money_Flow_Sum <= 1.07511e+09 )
						ret := 0.331081
					if( Positive_Money_Flow_Sum > 1.07511e+09 )
						ret := -0.116788
...
float op_operation = decision_tree_0_QCOM_1Hour_a5847250(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, ema2, ema1, ema12, ema3, ema13, tema)
