	...
	if( Typical_Price > 294.711 )
		if( Positive_Money_Flow <= 4.03911e+08 )
			if( Money_Flow_Ratio <= 3.78674 )
				if( mf <= -0.147356 )
					if( Negative_Money_Flow <= 5.92048e+08 )
						ret := 0.333333
					if( Negative_Money_Flow > 5.92048e+08 )
						ret := -0.523810
				if( mf > -0.147356 )
					if( Typical_Price <= 413.018 )
						ret := -0.421466
					if( Typical_Price > 413.018 )
						ret := -0.688442
			if( Money_Flow_Ratio > 3.78674 )
				if( Negative_Money_Flow_Sum <= 6.91615e+08 )
					ret := -0.166667
				if( Negative_Money_Flow_Sum > 6.91615e+08 )
					if( Typical_Price <= 365.648 )
						ret := 1.000000 // buy
					if( Typical_Price > 365.648 )
						ret := -0.500000
		if( Positive_Money_Flow > 4.03911e+08 )
			if( ad_mf <= -273948 )
				if( mf <= 0.114342 )
					if( Positive_Money_Flow <= 8.09892e+08 )
						ret := -0.724138 // sell
					if( Positive_Money_Flow > 8.09892e+08 )
						ret := 0.000000
				if( mf > 0.114342 )
					if( Positive_Money_Flow_Sum <= 6.59102e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 6.59102e+09 )
						ret := 0.000000
			if( ad_mf > -273948 )
				if( Positive_Money_Flow_Sum <= 6.02085e+09 )
					if( Positive_Money_Flow <= 8.19146e+08 )
						ret := 0.571429
					if( Positive_Money_Flow > 8.19146e+08 )
						ret := -0.437500
				if( Positive_Money_Flow_Sum > 6.02085e+09 )
...
float op_operation = decision_tree_0_MDB_1Day_526cc134(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
