			...
			if( bullPower <= -235.365 )
				...
				if( basis > 1740.36 )
					...
					if( basis > 2820.43 )
						ret := -1.000000 // sell
			if( bullPower > -235.365 )
				if( bullPower <= -140.342 )
					ret := 0.208333
				if( bullPower > -140.342 )
					if( bullPower <= -108.439 )
						ret := 1.000000 // buy
					if( bullPower > -108.439 )
						ret := 0.658537
		if( bearPower > -173.322 )
			if( bbp <= -55.3411 )
				if( basis <= 1860.83 )
					...
					if( bbm > 66.055 )
						ret := -0.933333 // sell
				if( basis > 1860.83 )
					if( Upper_Band <= 2069.55 )
						ret := -0.918919 // sell
					if( Upper_Band > 2069.55 )
						ret := -0.355450
			if( bbp > -55.3411 )
				if( Lower_Band <= 3196.09 )
					if( basis <= 2341.55 )
						ret := -0.166172
					if( basis > 2341.55 )
						ret := 0.179710
...
float op_operation = decision_tree_0_AMZN_1Day_b8356da2(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
