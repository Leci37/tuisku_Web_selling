				...
				if( smoothedDirectionalMovementPlus > 0.037143 )
					...
					if( adx > 22.3999 )
						...
						if( adx > 55.1895 )
							ret := -0.409253
			if( dx > 74.0347 )
				if( smoothedDirectionalMovementMinus <= 0.371071 )
					if( smoothedTrueRange <= 0.485814 )
						if( adx <= 60.645 )
							ret := 0.336735
						if( adx > 60.645 )
							ret := -0.132075
					if( smoothedTrueRange > 0.485814 )
						if( smoothedDirectionalMovementPlus <= 0.028165 )
							ret := -0.614815
						if( smoothedDirectionalMovementPlus > 0.028165 )
							ret := -0.121212
				if( smoothedDirectionalMovementMinus > 0.371071 )
					if( directionalMovementMinus <= 0.090279 )
						if( smoothedDirectionalMovementMinus <= 0.90375 )
							ret := -0.153285
						if( smoothedDirectionalMovementMinus > 0.90375 )
							ret := 0.875000 // buy
					if( directionalMovementMinus > 0.090279 )
...
float op_operation = decision_tree_0_RBLX_1Hour_efa77704(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
