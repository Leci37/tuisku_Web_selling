			...
			if( basis_max <= 8.09875 )
				...
				if( senkou_span_b_displaced > 105.378 )
					...
					if( basis_minus > -10.6386 )
						ret := -0.714286 // sell
			if( basis_max > 8.09875 )
				if( senkou_span_a_displaced <= 126.707 )
					if( tenkan_sen <= 70.7002 )
						ret := 0.000000
					if( tenkan_sen > 70.7002 )
						ret := 1.000000 // buy
				if( senkou_span_a_displaced > 126.707 )
					ret := 0.000000
		if( senkou_span_b > 112.123 )
			if( senkou_span_a <= 121.404 )
				ret := -1.000000 // sell
			if( senkou_span_a > 121.404 )
				if( chinkou_span <= 73.9921 )
					ret := -1.000000 // sell
				if( chinkou_span > 73.9921 )
					if( tenkan_sen <= 126.644 )
						ret := 0.000000
					if( tenkan_sen > 126.644 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_ASAN_1Day_24a85541(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
