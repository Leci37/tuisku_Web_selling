		...
		if( Lower_Band <= 26.7957 )
			...
			if( Upper_Band > 30.9615 )
				...
				if( basis > 29.9037 )
					ret := 0.000000
		if( Lower_Band > 26.7957 )
			if( Lower_Band <= 27.1104 )
				if( bullPower <= 0.290654 )
					ret := 0.000000
				if( bullPower > 0.290654 )
					if( bearPower <= 0.54094 )
						ret := 0.964286 // buy
					if( bearPower > 0.54094 )
						ret := 0.571429
			if( Lower_Band > 27.1104 )
...
float op_operation = decision_tree_0_NVST_1Day_b3e59663(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
