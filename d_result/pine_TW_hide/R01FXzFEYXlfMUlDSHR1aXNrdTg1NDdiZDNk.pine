	...
	if( senkou_span_a > 212.396 )
		if( senkou_span_a <= 256.407 )
			...
			if( kinjun_sen > 270.705 )
				ret := 0.000000
		if( senkou_span_a > 256.407 )
			if( senkou_span_a <= 258.004 )
				if( chinkou_span <= 173.985 )
					ret := 1.000000 // buy
				if( chinkou_span > 173.985 )
					ret := 0.000000
			if( senkou_span_a > 258.004 )
				if( senkou_span_a_displaced <= 17.3187 )
					ret := 0.000000
				if( senkou_span_a_displaced > 17.3187 )
					if( senkou_span_a_displaced <= 167.192 )
						ret := -1.000000 // sell
					if( senkou_span_a_displaced > 167.192 )
						ret := -0.750000 // sell
...
float op_operation = decision_tree_0_GME_1Day_8547bd3d(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
