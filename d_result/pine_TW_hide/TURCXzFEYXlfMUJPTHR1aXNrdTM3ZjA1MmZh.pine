...
decision_tree_0_MDB_1Day_37f052fa(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( BBlower > 284.967 )
		if( BBlower <= 309.064 )
			...
			if( dif_source_BBlower > 8.90637 )
				if( BBlower <= 293.608 )
					if( dif_source_BBlower <= 165.603 )
						ret := -0.391304
					if( dif_source_BBlower > 165.603 )
						ret := -1.000000 // sell
				if( BBlower > 293.608 )
					if( dif_source_BBupper <= -27.1947 )
						ret := -0.988889 // sell
					if( dif_source_BBupper > -27.1947 )
						ret := 0.000000
		if( BBlower > 309.064 )
			if( BBlower <= 313.664 )
				if( dif_source_BBupper <= -116.843 )
					ret := 1.000000 // buy
				if( dif_source_BBupper > -116.843 )
					ret := 0.000000
			if( BBlower > 313.664 )
...
float op_operation = decision_tree_0_MDB_1Day_37f052fa(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
