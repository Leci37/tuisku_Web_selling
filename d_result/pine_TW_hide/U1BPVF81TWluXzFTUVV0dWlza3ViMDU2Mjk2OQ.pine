...
decision_tree_0_SPOT_5Min_b0562969(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)=>
	...
	if( avgHighLow > 157.266 )
		...
		if( basis > 164.068 )
			...
			if( upperKC > 386.699 )
				if( upperKC <= 386.793 )
					if( priceRange <= 0.536052 )
						ret := -1.000000 // sell
					if( priceRange > 0.536052 )
						ret := 0.000000
				if( upperKC > 386.793 )
					if( priceRange <= 0.598363 )
						ret := -0.866667 // sell
					if( priceRange > 0.598363 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_SPOT_5Min_b0562969(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
