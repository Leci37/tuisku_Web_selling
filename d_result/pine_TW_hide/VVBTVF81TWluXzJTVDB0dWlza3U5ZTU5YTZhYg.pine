...
decision_tree_0_UPST_5Min_9e59a6ab(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)=>
	...
	if( rsi1 <= 49.152 )
		...
		if( ema1 > 24.1863 )
			...
			if( ema2 > 28.3355 )
				if( tema <= 33.2861 )
					if( smoothD_d <= 35.3157 )
						if( smoothD_d <= 7.43409 )
							ret := 0.082480
						if( smoothD_d > 7.43409 )
							ret := 0.217913
					if( smoothD_d > 35.3157 )
	...
	if( rsi1 > 49.152 )
		if( d <= 91.9285 )
			if( ema12 <= 0.212793 )
				if( ema1 <= 37.421 )
					if( d <= 49.0095 )
						if( smoothK_k <= 50.1158 )
							ret := -0.108963
						if( smoothK_k > 50.1158 )
							ret := -0.233777
					if( d > 49.0095 )
						if( smoothD_d <= 51.0066 )
							ret := 0.110588
						if( smoothD_d > 51.0066 )
							ret := -0.068903
				if( ema1 > 37.421 )
...
float op_operation = decision_tree_0_UPST_5Min_9e59a6ab(rsi1, d, k, smoothD_d, d_k, smoothK_k, ema2, ema1, ema12, ema3, ema13, tema)
