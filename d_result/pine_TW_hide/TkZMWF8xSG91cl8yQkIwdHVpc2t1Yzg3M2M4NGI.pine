	...
	if( bbp <= 5.79142 )
		...
		if( Upper_Band > 176.494 )
			...
			if( Upper_Band > 247.129 )
				...
				if( Lower_Band > 263.518 )
					if( bbm <= 8.22053 )
						if( Lower_Band <= 392.398 )
							ret := -0.010215
						if( Lower_Band > 392.398 )
							ret := 0.067872
					if( bbm > 8.22053 )
						if( Lower_Band <= 397.627 )
							ret := 0.069930
						if( Lower_Band > 397.627 )
							ret := -0.288969
	if( bbp > 5.79142 )
		if( bearPower <= 16.9633 )
			if( basis <= 182.813 )
				if( bearPower <= 0.571099 )
					ret := -1.000000 // sell
				if( bearPower > 0.571099 )
					if( bearPower <= 4.26554 )
						if( Upper_Band <= 177.229 )
							ret := 1.000000 // buy
						if( Upper_Band > 177.229 )
							ret := 0.328767
					if( bearPower > 4.26554 )
						if( Lower_Band <= 160.676 )
							ret := 0.000000
						if( Lower_Band > 160.676 )
							ret := 1.000000 // buy
			if( basis > 182.813 )
				if( Lower_Band <= 186.661 )
					if( Lower_Band <= 169.925 )
						ret := 1.000000 // buy
					if( Lower_Band > 169.925 )
						if( Upper_Band <= 193.186 )
							ret := -0.166667
						if( Upper_Band > 193.186 )
							ret := -0.950000 // sell
				if( Lower_Band > 186.661 )
					if( bearPower <= 0.120669 )
						if( basis <= 338.744 )
							ret := -0.750000 // sell
						if( basis > 338.744 )
							ret := -0.325658
					if( bearPower > 0.120669 )
						...
						if( bbm > 7.49948 )
							ret := 0.148559
		if( bearPower > 16.9633 )
			if( Upper_Band <= 591.229 )
				if( bearPower <= 33.0239 )
					if( basis <= 356.652 )
						ret := 0.000000
					if( basis > 356.652 )
						if( bbm <= 10.1843 )
...
float op_operation = decision_tree_0_NFLX_1Hour_c873c84b(basis, Upper_Band, Lower_Band, bearPower, bbm, bbp, bullPower, BBPower_Color)
