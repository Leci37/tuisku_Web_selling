...
decision_tree_0_ETSY_5Min_4cdd9cfa(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)=>
	...
	if( directionalMovementMinus > 0.561545 )
		if( diPlus <= 48.5418 )
			if( diMinus <= 50.9604 )
				if( smoothedDirectionalMovementMinus <= 0.107579 )
					if( adx <= 22.1361 )
						ret := -0.161290
					if( adx > 22.1361 )
						ret := 0.742647 // buy
		...
		if( diPlus > 48.5418 )
			...
			if( dx > 25.9206 )
				if( trueRange <= 0.765 )
					ret := 1.000000 // buy
				if( trueRange > 0.765 )
					if( directionalMovementMinus <= 0.61 )
						ret := -1.000000 // sell
					if( directionalMovementMinus > 0.61 )
						ret := -0.111111
...
float op_operation = decision_tree_0_ETSY_5Min_4cdd9cfa(dx, directionalMovementMinus, diPlus, smoothedDirectionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedTrueRange, directionalMovementPlus, diMinus, adx)
