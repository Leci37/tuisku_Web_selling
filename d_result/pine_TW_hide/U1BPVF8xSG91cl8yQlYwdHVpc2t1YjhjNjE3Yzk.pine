				...
				if( bullPower > -2.12829 )
					...
					if( bullPower > -1.49635 )
						...
						if( bbm > 1.70007 )
							ret := -0.419355
	if( VIP > 0.775733 )
		if( bullPower <= -0.714989 )
			if( bearPower <= -1.91929 )
				if( VIP <= 1.12186 )
					if( VIP_VIM <= -0.673784 )
						if( bearPower <= -4.69289 )
							ret := 0.671875
						if( bearPower > -4.69289 )
							ret := 0.212121
					if( VIP_VIM > -0.673784 )
				...
				if( VIP > 1.12186 )
					if( VIP_VIM <= -0.406317 )
						ret := -0.684211
					if( VIP_VIM > -0.406317 )
						if( bullPower <= -1.96645 )
							ret := 0.703704 // buy
						if( bullPower > -1.96645 )
							ret := 0.160839
			if( bearPower > -1.91929 )
				if( bearPower <= -1.04443 )
					if( VIM <= 1.55726 )
						if( VIP_VIM <= 0.060928 )
							ret := 0.356069
						if( VIP_VIM > 0.060928 )
		...
		if( bullPower > -0.714989 )
			...
			if( bbm > 3e-06 )
				...
				if( bbm > 3.48726 )
					if( bbp <= 7.81756 )
						if( bullPower <= 7.83543 )
							ret := -0.121046
						if( bullPower > 7.83543 )
							ret := 0.729730 // buy
					if( bbp > 7.81756 )
						if( bearPower <= 2.72369 )
							ret := 0.343840
						if( bearPower > 2.72369 )
							ret := -0.133501
...
float op_operation = decision_tree_0_SPOT_1Hour_b8c617c9(bbm, bearPower, bbp, bullPower, BBPower_Color, VIP_VIM, VIM, VIP)
