	...
	if( senkou_span_a_displaced > 44.3987 )
		if( chinkou_span <= 45.9678 )
			...
			if( senkou_span_a > 46.9427 )
				ret := -0.644995
		if( chinkou_span > 45.9678 )
			if( senkou_span_a <= 47.1849 )
				if( tenkan_sen <= 47.1532 )
					if( senkou_span_b <= 45.227 )
						ret := 0.046332
					if( senkou_span_b > 45.227 )
						if( kinjun_sen <= 46.551 )
							ret := 0.625356
						if( kinjun_sen > 46.551 )
							ret := 0.222997
				if( tenkan_sen > 47.1532 )
					ret := -0.106383
			if( senkou_span_a > 47.1849 )
				if( kinjun_sen <= 49.717 )
					if( chinkou_span <= 48.0321 )
						if( senkou_span_b_displaced <= 52.9796 )
							ret := -0.305282
						if( senkou_span_b_displaced > 52.9796 )
							ret := 0.483333
					if( chinkou_span > 48.0321 )
						if( chinkou_span <= 52.7527 )
							ret := 0.209051
						if( chinkou_span > 52.7527 )
							ret := 0.690196
				if( kinjun_sen > 49.717 )
					if( chinkou_span <= 54.1536 )
						if( tenkan_sen <= 53.5068 )
							ret := -0.093142
						if( tenkan_sen > 53.5068 )
							ret := -0.438032
					if( chinkou_span > 54.1536 )
						if( tenkan_sen <= 53.1026 )
							ret := 0.720764 // buy
						if( tenkan_sen > 53.1026 )
							ret := 0.001119
...
float op_operation = decision_tree_0_GTLB_15Min_6e014399(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
