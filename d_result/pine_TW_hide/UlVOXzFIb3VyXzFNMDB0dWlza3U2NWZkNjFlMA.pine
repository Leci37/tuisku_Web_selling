				...
				if( Negative_Money_Flow_Sum <= 5.79223e+07 )
					if( MFI <= 66.4381 )
						...
						if( Raw_Money_Flow > 2.71908e+06 )
							ret := 0.054416
					if( MFI > 66.4381 )
						if( Positive_Money_Flow <= 1.29344e+08 )
							ret := 0.081743
						if( Positive_Money_Flow > 1.29344e+08 )
							ret := 0.944444 // buy
				if( Negative_Money_Flow_Sum > 5.79223e+07 )
					if( Raw_Money_Flow <= 28661.1 )
						...
						if( MFI_Low > 47.7031 )
							ret := 0.000000
					if( Raw_Money_Flow > 28661.1 )
						if( Positive_Money_Flow_Sum <= 3.86047e+08 )
							ret := 0.159498
						if( Positive_Money_Flow_Sum > 3.86047e+08 )
							ret := 0.800000 // buy
			if( Money_Flow_Ratio > 764.994 )
			...
			if( Negative_Money_Flow <= 1.14031e+08 )
				if( Positive_Money_Flow_Sum <= 9.67025e+07 )
					if( Negative_Money_Flow_Sum <= 3.37114e+08 )
						if( Negative_Money_Flow_Sum <= 1.38887e+08 )
							ret := -0.068905
						if( Negative_Money_Flow_Sum > 1.38887e+08 )
							ret := 0.103991
					if( Negative_Money_Flow_Sum > 3.37114e+08 )
						...
						if( Negative_Money_Flow_Sum > 5.41782e+08 )
							ret := 0.769231 // buy
				if( Positive_Money_Flow_Sum > 9.67025e+07 )
					if( Positive_Money_Flow_Sum <= 1.23413e+08 )
						if( Typical_Price <= 19.035 )
							ret := 0.080402
						if( Typical_Price > 19.035 )
							ret := -0.282100
					if( Positive_Money_Flow_Sum > 1.23413e+08 )
						if( Negative_Money_Flow_Sum <= 4.09873e+08 )
							ret := -0.082611
						if( Negative_Money_Flow_Sum > 4.09873e+08 )
							ret := 0.338710
			if( Negative_Money_Flow > 1.14031e+08 )
				if( Money_Flow_Ratio <= 0.29193 )
					if( Negative_Money_Flow_Sum <= 3.53194e+08 )
						ret := 0.750000 // buy
					if( Negative_Money_Flow_Sum > 3.53194e+08 )
						ret := -0.500000
				if( Money_Flow_Ratio > 0.29193 )
					if( Raw_Money_Flow <= 3.22918e+08 )
						if( Money_Flow_Ratio <= 1.31611 )
							ret := 0.692308
						if( Money_Flow_Ratio > 1.31611 )
							ret := 1.000000 // buy
					if( Raw_Money_Flow > 3.22918e+08 )
		...
		if( MFI_High > -11.8241 )
			if( Negative_Money_Flow <= 250095 )
				if( Typical_Price <= 39.2177 )
					if( MFI_Low <= 49.3245 )
						if( Negative_Money_Flow_Sum <= 7.92054e+07 )
							ret := -0.071429
						if( Negative_Money_Flow_Sum > 7.92054e+07 )
							ret := 0.600000
					if( MFI_Low > 49.3245 )
				...
				if( Typical_Price > 39.2177 )
					if( Money_Flow_Ratio <= 8.68497 )
						if( Typical_Price <= 93.15 )
							ret := 0.189845
						if( Typical_Price > 93.15 )
							ret := -0.600000
					if( Money_Flow_Ratio > 8.68497 )
						if( Money_Flow_Ratio <= 10.3456 )
							ret := -0.800000 // sell
						if( Money_Flow_Ratio > 10.3456 )
							ret := -1.000000 // sell
			if( Negative_Money_Flow > 250095 )
				if( Typical_Price <= 20.4684 )
					if( Negative_Money_Flow <= 3.94234e+07 )
						if( Positive_Money_Flow_Sum <= 2.44831e+08 )
							ret := 0.100000
						if( Positive_Money_Flow_Sum > 2.44831e+08 )
							ret := -0.750000 // sell
					if( Negative_Money_Flow > 3.94234e+07 )
						ret := 0.733333 // buy
				if( Typical_Price > 20.4684 )
					if( Positive_Money_Flow_Sum <= 6.66425e+08 )
						if( Positive_Money_Flow <= 46121.2 )
							ret := 0.574144
						if( Positive_Money_Flow > 46121.2 )
							ret := -0.523810
					if( Positive_Money_Flow_Sum > 6.66425e+08 )
...
float op_operation = decision_tree_0_RUN_1Hour_65fd61e0(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
