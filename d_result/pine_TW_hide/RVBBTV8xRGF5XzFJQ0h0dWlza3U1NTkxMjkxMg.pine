...
decision_tree_0_EPAM_1Day_55912912(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)=>
	...
	if( kinjun_sen > 622.546 )
		if( basis_max <= 13.215 )
			if( basis_max <= -0.777723 )
				if( basis_max <= -10.5894 )
					if( basis_minus <= 30.7292 )
						ret := -0.400000
					if( basis_minus > 30.7292 )
						ret := -1.000000 // sell
				if( basis_max > -10.5894 )
					ret := -1.000000 // sell
			if( basis_max > -0.777723 )
				if( chinkou_span <= 444.99 )
					ret := -1.000000 // sell
				if( chinkou_span > 444.99 )
					if( basis_minus <= 5.07372 )
						ret := 0.166667
					if( basis_minus > 5.07372 )
						ret := -0.705882 // sell
		if( basis_max > 13.215 )
...
float op_operation = decision_tree_0_EPAM_1Day_55912912(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
