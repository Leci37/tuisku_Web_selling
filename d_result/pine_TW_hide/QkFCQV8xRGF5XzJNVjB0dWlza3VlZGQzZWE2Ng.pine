...
decision_tree_0_BABA_1Day_edd3ea66(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)=>
	...
	if( Raw_Money_Flow > 1.12096e+09 )
			...
			if( MFI <= 33.2341 )
				...
				if( Negative_Money_Flow > 2.96485e+08 )
					...
					if( Raw_Money_Flow > 2.41334e+09 )
						ret := 0.980769 // buy
			if( MFI > 33.2341 )
				if( Typical_Price <= 86.5925 )
					if( Positive_Money_Flow_Sum <= 8.81603e+09 )
						ret := 1.000000 // buy
					if( Positive_Money_Flow_Sum > 8.81603e+09 )
						ret := 0.000000
				if( Typical_Price > 86.5925 )
		...
		if( VIP > 0.744583 )
			if( VIM <= 1.2869 )
				if( Typical_Price <= 193.588 )
					if( Typical_Price <= 120.229 )
						ret := -0.070659
					if( Typical_Price > 120.229 )
						ret := 0.173589
				if( Typical_Price > 193.588 )
					...
					if( VIM > 1.0691 )
						ret := 0.056034
			if( VIM > 1.2869 )
				if( Typical_Price <= 83.4366 )
					if( MFI_High <= -39.3716 )
						ret := 0.750000 // buy
					if( MFI_High > -39.3716 )
						ret := 0.066667
				if( Typical_Price > 83.4366 )
					if( Negative_Money_Flow <= 3.04093e+09 )
						ret := -0.734463 // sell
					if( Negative_Money_Flow > 3.04093e+09 )
						ret := 0.050000
...
float op_operation = decision_tree_0_BABA_1Day_edd3ea66(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
