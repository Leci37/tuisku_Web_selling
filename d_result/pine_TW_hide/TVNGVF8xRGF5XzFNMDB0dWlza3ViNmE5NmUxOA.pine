...
decision_tree_0_MSFT_1Day_b6a96e18(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Positive_Money_Flow_Sum > 6.61828e+10 )
		if( Positive_Money_Flow_Sum <= 1.03444e+11 )
			if( MFI_Low <= 26.432 )
				if( Positive_Money_Flow <= 1.14696e+10 )
					if( MFI_Low <= 22.6948 )
						ret := 0.285714
					if( MFI_Low > 22.6948 )
						ret := 0.911765 // buy
				if( Positive_Money_Flow > 1.14696e+10 )
					if( Raw_Money_Flow <= 1.24468e+10 )
						ret := -1.000000 // sell
					if( Raw_Money_Flow > 1.24468e+10 )
						ret := 0.250000
			if( MFI_Low > 26.432 )
				if( MFI <= 75.9959 )
					if( Negative_Money_Flow_Sum <= 2.67375e+10 )
						ret := -0.894737 // sell
					if( Negative_Money_Flow_Sum > 2.67375e+10 )
						ret := -0.335950
				if( MFI > 75.9959 )
					if( Negative_Money_Flow_Sum <= 2.27444e+10 )
						ret := -0.178571
					if( Negative_Money_Flow_Sum > 2.27444e+10 )
						ret := 0.594595
		if( Positive_Money_Flow_Sum > 1.03444e+11 )
			if( Positive_Money_Flow_Sum <= 1.12092e+11 )
				if( Typical_Price <= 362.244 )
					if( Money_Flow_Ratio <= 3.61192 )
						ret := 0.784314 // buy
					if( Money_Flow_Ratio > 3.61192 )
						ret := 0.000000
				if( Typical_Price > 362.244 )
...
float op_operation = decision_tree_0_MSFT_1Day_b6a96e18(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
