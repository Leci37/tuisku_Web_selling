				...
				if( nvimax <= -1.44755 )
					...
					if( verde_mean > 80.2361 )
						...
						if( nvimin > -2.12677 )
							ret := -0.024785
				if( nvimax > -1.44755 )
					if( marron_mean <= -12.05 )
						if( verde_azul <= 7.35496 )
							ret := 0.106918
						if( verde_azul > 7.35496 )
							ret := 0.946237 // buy
					if( marron_mean > -12.05 )
						if( verde_mean <= 57.8862 )
							ret := -0.122257
						if( verde_mean > 57.8862 )
							ret := 0.001960
	if( media > 82.3822 )
		if( tprice <= 127.557 )
			...
			if( nvim > -2.19555 )
				if( source <= 106.547 )
					if( verde_azul <= 3.16616 )
						ret := 0.631068
					if( verde_azul > 3.16616 )
						if( azul_mean <= 6.11031 )
							ret := 0.130988
						if( azul_mean > 6.11031 )
							ret := -0.018902
				if( source > 106.547 )
...
float op_operation = decision_tree_0_AFRM_30Min_dac0f0f3(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
