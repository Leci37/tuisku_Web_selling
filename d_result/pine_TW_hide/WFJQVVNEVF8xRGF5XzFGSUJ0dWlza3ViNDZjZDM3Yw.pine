...
decision_tree_0_XRPUSDT_1Day_b46cd37c(basis_minus, lower_4, lower_6, upper_1, upper_3, lower_2, basis, upper_4, upper_5, lower_1, upper_6, lower_3, basis_max, lower_5, upper_2)=>
	...
	if( lower_5 > -0.233362 )
		...
		if( lower_3 > 0.203429 )
			if( lower_2 <= 0.25447 )
				if( lower_4 <= 0.20004 )
					if( basis_max <= -0.390713 )
						ret := 0.500000
					if( basis_max > -0.390713 )
						ret := -0.852941 // sell
				if( lower_4 > 0.20004 )
					if( basis_max <= -0.201649 )
						ret := 0.200000
					if( basis_max > -0.201649 )
						ret := 1.000000 // buy
			if( lower_2 > 0.25447 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_b46cd37c(basis_minus, lower_4, lower_6, upper_1, upper_3, lower_2, basis, upper_4, upper_5, lower_1, upper_6, lower_3, basis_max, lower_5, upper_2)
