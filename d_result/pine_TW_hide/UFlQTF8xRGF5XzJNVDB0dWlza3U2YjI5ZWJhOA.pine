...
decision_tree_0_PYPL_1Day_6b29eba8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( Negative_Money_Flow_Sum > 1.73649e+10 )
		...
		if( Raw_Money_Flow > 2.48798e+09 )
			if( tema <= 182.562 )
				if( Positive_Money_Flow_Sum <= 9.39049e+09 )
					if( MFI <= 26.5073 )
						ret := -0.733333 // sell
					if( MFI > 26.5073 )
						ret := 1.000000 // buy
			...
			if( tema > 182.562 )
				if( ema12 <= -10.4958 )
					if( Negative_Money_Flow_Sum <= 5.32378e+10 )
						ret := 1.000000 // buy
					if( Negative_Money_Flow_Sum > 5.32378e+10 )
						ret := 0.166667
				if( ema12 > -10.4958 )
					if( Typical_Price <= 185.362 )
						ret := 0.444444
					if( Typical_Price > 185.362 )
						ret := -0.750000 // sell
...
float op_operation = decision_tree_0_PYPL_1Day_6b29eba8(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
