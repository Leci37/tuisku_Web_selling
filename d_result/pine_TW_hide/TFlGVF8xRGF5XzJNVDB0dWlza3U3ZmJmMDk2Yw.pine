...
decision_tree_0_LYFT_1Day_7fbf096c(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)=>
	...
	if( ema2 > 13.9687 )
		if( MFI_High <= -50.207 )
			if( Positive_Money_Flow_Sum <= 1.10841e+09 )
				if( ema3 <= 15.3235 )
					ret := -0.333333
				if( ema3 > 15.3235 )
					if( ema13 <= -1.17504 )
					...
					if( ema13 > -1.17504 )
						ret := -0.200000
			if( Positive_Money_Flow_Sum > 1.10841e+09 )
				if( Typical_Price <= 33.5213 )
					if( ema13 <= -7.87588 )
						ret := 0.600000
					if( ema13 > -7.87588 )
						ret := -0.956522 // sell
				if( Typical_Price > 33.5213 )
					if( Raw_Money_Flow <= 5.4866e+08 )
						ret := 0.491803
					if( Raw_Money_Flow > 5.4866e+08 )
						ret := -0.888889 // sell
		if( MFI_High > -50.207 )
			if( Negative_Money_Flow_Sum <= 1.34758e+09 )
				if( ema1 <= 41.6915 )
					if( Positive_Money_Flow <= 4.00976e+08 )
						ret := -0.761628 // sell
					if( Positive_Money_Flow > 4.00976e+08 )
						ret := 0.250000
				if( ema1 > 41.6915 )
					if( Positive_Money_Flow_Sum <= 3.69075e+09 )
						ret := -0.216867
					if( Positive_Money_Flow_Sum > 3.69075e+09 )
						ret := 0.227273
			if( Negative_Money_Flow_Sum > 1.34758e+09 )
				if( MFI_Low <= 26.1962 )
					if( Positive_Money_Flow_Sum <= 1.81568e+09 )
						ret := -0.114537
					if( Positive_Money_Flow_Sum > 1.81568e+09 )
						ret := -0.602210
				if( MFI_Low > 26.1962 )
					if( Typical_Price <= 44.7951 )
						ret := 0.287500
					if( Typical_Price > 44.7951 )
						ret := -0.095506
...
float op_operation = decision_tree_0_LYFT_1Day_7fbf096c(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, ema12, ema3, ema13, tema, ema1, ema2)
