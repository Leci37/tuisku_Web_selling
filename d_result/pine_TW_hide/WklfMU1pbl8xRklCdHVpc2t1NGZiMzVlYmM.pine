				...
				if( upper_5 <= 9.63359 )
					if( lower_5 <= 9.41521 )
						...
						if( lower_6 > 9.38908 )
							ret := -0.607143
					if( lower_5 > 9.41521 )
						if( basis_minus <= 0.123165 )
							ret := 0.847826 // buy
						if( basis_minus > 0.123165 )
							ret := -0.080000
				if( upper_5 > 9.63359 )
					if( upper_5 <= 9.662 )
						if( basis_minus <= 0.095289 )
							ret := -0.291667
						if( basis_minus > 0.095289 )
							ret := 0.122642
					if( upper_5 > 9.662 )
	...
	if( basis > 9.60411 )
		...
		if( upper_3 > 16.6662 )
			...
			if( upper_2 > 17.3632 )
				...
				if( upper_3 > 17.9128 )
					if( lower_3 <= 14.07 )
						if( basis_minus <= 3.91819 )
							ret := -0.861111 // sell
						if( basis_minus > 3.91819 )
							ret := 0.000000
					if( lower_3 > 14.07 )
						if( basis_minus <= 3.78504 )
							ret := -0.857143 // sell
						if( basis_minus > 3.78504 )
							ret := 0.090909
...
float op_operation = decision_tree_0_ZI_1Min_4fb35ebc(basis_minus, lower_4, lower_6, upper_1, upper_3, lower_2, basis, upper_4, upper_5, lower_1, upper_6, lower_3, basis_max, lower_5, upper_2)
