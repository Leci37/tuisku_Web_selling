				...
				if( k > 3.36043 )
					if( Typical_Price <= 603.551 )
						...
						if( rsi1 > 19.5242 )
							ret := -0.247573
					if( Typical_Price > 603.551 )
						if( Typical_Price <= 614.326 )
							ret := 1.000000 // buy
						if( Typical_Price > 614.326 )
							ret := -0.466667
		if( Positive_Money_Flow_Sum > 1.87813e+09 )
			if( Money_Flow_Ratio <= 5.43932 )
				if( Positive_Money_Flow <= 5.11586e+08 )
					if( Typical_Price <= 509.779 )
						if( Positive_Money_Flow_Sum <= 2.1758e+09 )
							ret := 0.114286
						if( Positive_Money_Flow_Sum > 2.1758e+09 )
							ret := 0.706215 // buy
					if( Typical_Price > 509.779 )
						if( Typical_Price <= 628.567 )
							ret := 0.009772
						if( Typical_Price > 628.567 )
							ret := -0.688525
				if( Positive_Money_Flow > 5.11586e+08 )
					if( Raw_Money_Flow <= 1.024e+09 )
						ret := -0.890909 // sell
					if( Raw_Money_Flow > 1.024e+09 )
						ret := 0.210526
			if( Money_Flow_Ratio > 5.43932 )
				if( k <= 65.1072 )
					if( Negative_Money_Flow_Sum <= 4.39382e+08 )
						ret := -0.020833
					if( Negative_Money_Flow_Sum > 4.39382e+08 )
						ret := 0.875000 // buy
				if( k > 65.1072 )
					if( Typical_Price <= 513.229 )
						if( MFI <= 99.0328 )
							ret := 0.871134 // buy
						if( MFI > 99.0328 )
							ret := 0.361702
...
float op_operation = decision_tree_0_ADBE_1Hour_9ad4b8b9(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
