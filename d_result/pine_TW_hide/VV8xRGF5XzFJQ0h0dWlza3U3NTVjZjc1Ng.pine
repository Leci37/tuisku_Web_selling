		...
		if( chinkou_span <= 35.4304 )
			if( kinjun_sen <= 43.2762 )
				if( senkou_span_b <= 34.0168 )
					if( basis_minus <= 2.46451 )
						ret := 0.083333
					if( basis_minus > 2.46451 )
						ret := -0.763158 // sell
				if( senkou_span_b > 34.0168 )
					if( basis_max <= -1.98126 )
						ret := 0.909091 // buy
					if( basis_max > -1.98126 )
						ret := -0.200000
			if( kinjun_sen > 43.2762 )
				if( chinkou_span <= 29.06 )
					ret := 0.000000
				if( chinkou_span > 29.06 )
					if( senkou_span_a_displaced <= 39.2925 )
						ret := -0.695652
					if( senkou_span_a_displaced > 39.2925 )
						ret := -0.949153 // sell
		if( chinkou_span > 35.4304 )
			if( senkou_span_b_displaced <= 99.4773 )
				if( senkou_span_b_displaced <= 59.7025 )
					if( basis_max <= -1.95437 )
						ret := 0.666667
					if( basis_max > -1.95437 )
						ret := -0.538462
				if( senkou_span_b_displaced > 59.7025 )
					if( chinkou_span <= 51.2101 )
						ret := 0.806122 // buy
					if( chinkou_span > 51.2101 )
						ret := 0.155340
			if( senkou_span_b_displaced > 99.4773 )
				if( chinkou_span <= 48.09 )
					if( senkou_span_a <= 94.6599 )
						ret := -0.939394 // sell
					if( senkou_span_a > 94.6599 )
						ret := -0.250000
				if( chinkou_span > 48.09 )
					if( senkou_span_b <= 157.663 )
						ret := 0.014706
					if( senkou_span_b > 157.663 )
						ret := -0.688525
...
float op_operation = decision_tree_0_U_1Day_755cf756(senkou_span_a_displaced, cross_dn_tenkan_kinjunInt, kinjun_sen, chinkou_span, senkou_span_b_displaced, basis_minus, senkou_span_b, senkou_span_a, cross_up_tenkan_kinjunInt, tenkan_sen, basis_max)
