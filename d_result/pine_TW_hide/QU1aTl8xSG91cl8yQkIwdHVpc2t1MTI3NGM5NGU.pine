...
decision_tree_0_AMZN_1Hour_1274c94e(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)=>
				...
				if( bbm > 3.58236 )
					...
					if( Upper_Band > 1796.64 )
						...
						if( Lower_Band > 1581.91 )
							ret := 0.386598
			if( Lower_Band > 1772.2 )
				if( Upper_Band <= 3599.04 )
					if( basis <= 1814.28 )
						ret := -0.805556 // sell
					if( basis > 1814.28 )
						if( Upper_Band <= 1880.53 )
							ret := 0.226027
						if( Upper_Band > 1880.53 )
							ret := -0.145583
				if( Upper_Band > 3599.04 )
	...
	if( bearPower > -0.983144 )
		...
		if( Lower_Band > 82.6532 )
			if( bbp <= 190.753 )
				if( Upper_Band <= 88.8226 )
					if( bullPower <= 0.802 )
						if( Lower_Band <= 85.6933 )
							ret := -0.074074
						if( Lower_Band > 85.6933 )
							ret := -1.000000 // sell
					if( bullPower > 0.802 )
						ret := -0.977273 // sell
				if( Upper_Band > 88.8226 )
					if( Lower_Band <= 88.4955 )
						if( bullPower <= 3.72032 )
							ret := 0.643478
						if( bullPower > 3.72032 )
							ret := -1.000000 // sell
					if( Lower_Band > 88.4955 )
						if( Lower_Band <= 89.6457 )
							ret := -0.712766 // sell
						if( Lower_Band > 89.6457 )
							ret := 0.040448
			if( bbp > 190.753 )
...
float op_operation = decision_tree_0_AMZN_1Hour_1274c94e(Upper_Band, basis, Lower_Band, bullPower, bbp, bearPower, bbm, BBPower_Color)
