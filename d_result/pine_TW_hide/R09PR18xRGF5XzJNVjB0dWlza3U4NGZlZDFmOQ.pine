		...
		if( Negative_Money_Flow <= 1.30823e+09 )
			...
			if( Negative_Money_Flow_Sum > 3.22731e+10 )
				if( MFI <= 34.0404 )
					ret := 0.600000
				if( MFI > 34.0404 )
					if( Positive_Money_Flow <= 3.87699e+09 )
						ret := 0.857143 // buy
					if( Positive_Money_Flow > 3.87699e+09 )
						ret := 1.000000 // buy
		if( Negative_Money_Flow > 1.30823e+09 )
			if( Money_Flow_Ratio <= 0.267547 )
				if( VIP_VIM <= -0.638686 )
					if( Positive_Money_Flow_Sum <= 1.04214e+10 )
						ret := 0.333333
					if( Positive_Money_Flow_Sum > 1.04214e+10 )
						ret := 0.875000 // buy
				if( VIP_VIM > -0.638686 )
					if( Raw_Money_Flow <= 3.46991e+09 )
						ret := 0.125000
					if( Raw_Money_Flow > 3.46991e+09 )
						ret := -0.714286 // sell
			if( Money_Flow_Ratio > 0.267547 )
...
float op_operation = decision_tree_0_GOOG_1Day_84fed1f9(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
