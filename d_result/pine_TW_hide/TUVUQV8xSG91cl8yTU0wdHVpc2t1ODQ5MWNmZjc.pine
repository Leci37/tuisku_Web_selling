			...
			if( Negative_Money_Flow > 1.3006e+09 )
				...
				if( Short_Long_Diff > -1.85826 )
					...
					if( Negative_Money_Flow_Sum > 4.06027e+09 )
						ret := -0.462094
	if( Positive_Money_Flow_Sum > 9.83573e+09 )
		if( Raw_Money_Flow <= 2.87642e+06 )
			if( Raw_Money_Flow <= 1.76479e+06 )
				if( MFI <= 97.5521 )
					ret := -1.000000 // sell
				if( MFI > 97.5521 )
					ret := 0.000000
			if( Raw_Money_Flow > 1.76479e+06 )
				if( Negative_Money_Flow_Sum <= 1.9545e+09 )
					if( Positive_Money_Flow_Sum <= 9.90534e+09 )
						ret := -0.666667
					if( Positive_Money_Flow_Sum > 9.90534e+09 )
						ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 1.9545e+09 )
		...
		if( Raw_Money_Flow > 2.87642e+06 )
			if( MFI <= 93.3057 )
				if( Positive_Money_Flow <= 2.86495e+09 )
					if( MFI_Low <= 71.8228 )
						ret := -0.554622
					if( MFI_Low > 71.8228 )
						ret := 0.423077
				if( Positive_Money_Flow > 2.86495e+09 )
					...
					if( MFI_Low > 64.7825 )
						ret := 0.000000
			if( MFI > 93.3057 )
				if( Positive_Money_Flow_Sum <= 1.18982e+10 )
					if( Long_MA <= 193.098 )
						ret := -0.833333 // sell
					if( Long_MA > 193.098 )
						ret := 0.000000
...
float op_operation = decision_tree_0_META_1Hour_8491cff7(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
