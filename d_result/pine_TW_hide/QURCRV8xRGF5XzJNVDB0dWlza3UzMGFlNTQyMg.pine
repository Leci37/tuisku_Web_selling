			...
			if( Negative_Money_Flow > 1.55183e+09 )
				...
				if( MFI_Low > 10.9111 )
					...
					if( Typical_Price > 378.352 )
						ret := 0.866667 // buy
	if( ema1 > 479.686 )
		if( Raw_Money_Flow <= 1.08911e+09 )
			if( ema13 <= 9.6006 )
				if( Positive_Money_Flow <= 8.31903e+08 )
					if( Positive_Money_Flow_Sum <= 6.4897e+09 )
						ret := 0.526316
					if( Positive_Money_Flow_Sum > 6.4897e+09 )
						ret := -0.400000
				if( Positive_Money_Flow > 8.31903e+08 )
					...
					if( tema > 504.108 )
						ret := 0.821429 // buy
			if( ema13 > 9.6006 )
				if( Negative_Money_Flow_Sum <= 1.03278e+10 )
					if( ema3 <= 514.765 )
						ret := -0.541667
					if( ema3 > 514.765 )
						ret := 0.000000
		...
		if( Raw_Money_Flow > 1.08911e+09 )
			if( ema13 <= -32.7397 )
				if( Positive_Money_Flow_Sum <= 9.85332e+09 )
					if( Typical_Price <= 565.795 )
						ret := 0.769231 // buy
					if( Typical_Price > 565.795 )
						ret := 0.600000
				if( Positive_Money_Flow_Sum > 9.85332e+09 )
...
float op_operation = decision_tree_0_ADBE_1Day_30ae5422(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, ema3, tema, ema2, ema12, ema13, ema1)
