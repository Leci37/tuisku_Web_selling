			...
			if( bearPower > -0.668849 )
				...
				if( bullPower > 0.147568 )
					...
					if( bbp > 0.29029 )
						ret := 0.167323
	if( bbm > 0.652238 )
		if( bearPower <= -3.43855 )
			if( bbm <= 2.32494 )
				if( bearPower <= -5.06683 )
					if( bbp <= -10.7135 )
						ret := 0.166667
					if( bbp > -10.7135 )
						ret := -0.920000 // sell
			...
			if( bbm > 2.32494 )
				if( bbm <= 4.035 )
					if( bullPower <= -2.55635 )
						ret := 0.833333 // buy
					if( bullPower > -2.55635 )
						ret := 0.604167
				if( bbm > 4.035 )
					if( bullPower <= -0.957934 )
						ret := 0.357143
					if( bullPower > -0.957934 )
						ret := -0.625000
		if( bearPower > -3.43855 )
			if( bearPower <= -2.01816 )
				if( bbm <= 3.00115 )
					if( bullPower <= -1.99742 )
						ret := 0.500000
					if( bullPower > -1.99742 )
						ret := -0.726190 // sell
				if( bbm > 3.00115 )
...
float op_operation = decision_tree_0_SNAP_1Day_e1697bd4(bbm, bearPower, bbp, bullPower, BBPower_Color)
