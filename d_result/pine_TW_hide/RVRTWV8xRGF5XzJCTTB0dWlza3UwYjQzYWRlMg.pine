...
decision_tree_0_ETSY_1Day_0b43ade2(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Positive_Money_Flow_Sum > 1.09949e+09 )
			...
			if( bbm <= 8.11495 )
				if( Positive_Money_Flow <= 757656 )
					...
					if( bearPower > 3.53607 )
						ret := 0.772727 // buy
				if( Positive_Money_Flow > 757656 )
					if( Positive_Money_Flow_Sum <= 2.57901e+09 )
						ret := 0.161793
					if( Positive_Money_Flow_Sum > 2.57901e+09 )
						ret := -0.234177
			if( bbm > 8.11495 )
				if( MFI <= 57.3595 )
					if( Negative_Money_Flow_Sum <= 6.12203e+09 )
						ret := -0.785340 // sell
					if( Negative_Money_Flow_Sum > 6.12203e+09 )
						ret := 0.294118
				if( MFI > 57.3595 )
		...
		if( Positive_Money_Flow_Sum > 3.82349e+09 )
			...
			if( Typical_Price > 232.757 )
				if( bbm <= 14.6875 )
					if( Money_Flow_Ratio <= 1.07269 )
						ret := 0.600000
					if( Money_Flow_Ratio > 1.07269 )
						ret := -0.266667
				if( bbm > 14.6875 )
					if( bearPower <= 0.781108 )
						ret := -1.000000 // sell
					if( bearPower > 0.781108 )
						ret := -0.875000 // sell
...
float op_operation = decision_tree_0_ETSY_1Day_0b43ade2(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
