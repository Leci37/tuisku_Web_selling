	...
	if( kinjun_sen > 0.141648 )
		if( chinkou_span <= 0.146026 )
			...
			if( senkou_span_b_displaced > 0.170305 )
				ret := 0.707317 // buy
		if( chinkou_span > 0.146026 )
			if( tenkan_sen <= 0.154067 )
				if( senkou_span_a <= 0.143212 )
					ret := -0.535211
				if( senkou_span_a > 0.143212 )
					if( chinkou_span <= 0.151762 )
						if( tenkan_sen <= 0.145597 )
							ret := 0.717949 // buy
						if( tenkan_sen > 0.145597 )
							ret := 0.029126
					if( chinkou_span > 0.151762 )
						...
						if( tenkan_sen > 0.149 )
							ret := 0.403361
			if( tenkan_sen > 0.154067 )
				if( tenkan_sen <= 0.465073 )
					if( chinkou_span <= 0.387903 )
						if( senkou_span_b <= 0.342358 )
							ret := -0.040029
						if( senkou_span_b > 0.342358 )
							ret := -0.449405
					if( chinkou_span > 0.387903 )
						if( senkou_span_b_displaced <= 0.299342 )
							ret := -0.285714
						if( senkou_span_b_displaced > 0.299342 )
							ret := 0.608791
				if( tenkan_sen > 0.465073 )
					if( basis_max <= 0.018749 )
						if( basis_max <= -0.008526 )
							ret := -0.034483
						if( basis_max > -0.008526 )
							ret := -0.488496
					if( basis_max > 0.018749 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Hour_adb8698d(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
