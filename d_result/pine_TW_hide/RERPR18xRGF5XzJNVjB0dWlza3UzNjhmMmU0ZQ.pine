			...
			if( Money_Flow_Ratio > 0.999187 )
				if( VIP <= 0.990172 )
					...
					if( Negative_Money_Flow_Sum > 1.68817e+09 )
						ret := 0.830769 // buy
				if( VIP > 0.990172 )
					if( Typical_Price <= 96.4304 )
						ret := -0.043478
					if( Typical_Price > 96.4304 )
						ret := 0.457516
		if( Positive_Money_Flow_Sum > 3.4394e+09 )
			if( VIM <= 0.935634 )
				if( Negative_Money_Flow_Sum <= 2.30475e+09 )
					if( MFI <= 65.358 )
						ret := 0.750000 // buy
					if( MFI > 65.358 )
						ret := -0.368421
				if( Negative_Money_Flow_Sum > 2.30475e+09 )
					...
					if( VIP > 1.1362 )
						ret := -0.766990 // sell
			if( VIM > 0.935634 )
				if( Typical_Price <= 101.225 )
					if( MFI_High <= -24.634 )
						ret := -0.019608
					if( MFI_High > -24.634 )
						ret := 0.629630
				if( Typical_Price > 101.225 )
					if( Raw_Money_Flow <= 7.65081e+08 )
						ret := -0.154286
					if( Raw_Money_Flow > 7.65081e+08 )
						ret := -0.750000 // sell
...
float op_operation = decision_tree_0_DDOG_1Day_368f2e4e(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, VIP, VIP_VIM, VIM)
