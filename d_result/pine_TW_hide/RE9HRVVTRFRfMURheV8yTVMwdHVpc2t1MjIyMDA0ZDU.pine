			...
			if( rsi1 > 72.7797 )
				if( MFI_Low <= 65.7521 )
					...
					if( Typical_Price > 0.113645 )
						ret := -0.714286 // sell
				if( MFI_Low > 65.7521 )
					if( smoothD_d <= 96.7883 )
						ret := 0.571429
					if( smoothD_d > 96.7883 )
						ret := -1.000000 // sell
		if( Negative_Money_Flow > 374139 )
			if( Typical_Price <= 0.39205 )
				if( Raw_Money_Flow <= 1.35065e+09 )
					if( Typical_Price <= 0.184177 )
						ret := -0.142303
					if( Typical_Price > 0.184177 )
						ret := -0.497908
				if( Raw_Money_Flow > 1.35065e+09 )
					if( Negative_Money_Flow_Sum <= 5.67436e+09 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 5.67436e+09 )
						ret := 0.939394 // buy
			if( Typical_Price > 0.39205 )
...
float op_operation = decision_tree_0_DOGEUSDT_1Day_222004d5(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price, d, d_k, smoothK_k, k, rsi1, smoothD_d)
