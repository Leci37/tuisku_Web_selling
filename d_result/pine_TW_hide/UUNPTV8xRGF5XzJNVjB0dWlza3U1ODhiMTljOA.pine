		...
		if( MFI_Low <= 38.9822 )
			if( Positive_Money_Flow <= 7.68283e+08 )
				if( Positive_Money_Flow_Sum <= 1.06629e+10 )
					if( Money_Flow_Ratio <= 0.902468 )
						ret := 0.047452
					if( Money_Flow_Ratio > 0.902468 )
						ret := 0.563380
				if( Positive_Money_Flow_Sum > 1.06629e+10 )
					if( Typical_Price <= 140.937 )
						ret := -0.857143 // sell
					if( Typical_Price > 140.937 )
						ret := -0.042105
			if( Positive_Money_Flow > 7.68283e+08 )
			...
			if( VIP_VIM <= 0.299413 )
				if( VIM <= 0.940462 )
					...
					if( MFI_High > -18.4519 )
						ret := 0.250000
				if( VIM > 0.940462 )
					if( Negative_Money_Flow <= 1.98714e+08 )
						ret := -0.730769 // sell
					if( Negative_Money_Flow > 1.98714e+08 )
						ret := -0.974359 // sell
			if( VIP_VIM > 0.299413 )
				if( VIP_VIM <= 0.303524 )
					ret := 1.000000 // buy
				if( VIP_VIM > 0.303524 )
					if( Positive_Money_Flow_Sum <= 1.24305e+10 )
						ret := -1.000000 // sell
					if( Positive_Money_Flow_Sum > 1.24305e+10 )
						ret := -0.076923
...
float op_operation = decision_tree_0_QCOM_1Day_588b19c8(Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow, VIP, VIP_VIM, VIM)
