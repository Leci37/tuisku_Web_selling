			...
			if( smoothedTrueRange > 72.1088 )
				...
				if( trueRange > 51.0973 )
					...
					if( trueRange > 125.909 )
						ret := -0.500000
	if( diPlus > 31.2338 )
		if( smoothedDirectionalMovementPlus <= 34.6623 )
			if( dx <= 77.8125 )
				if( diPlus <= 44.2757 )
					if( diMinus <= 19.31 )
						ret := 0.250489
					if( diMinus > 19.31 )
						ret := -0.311688
				if( diPlus > 44.2757 )
					if( smoothedDirectionalMovementPlus <= 3.01939 )
						ret := -0.428571
					if( smoothedDirectionalMovementPlus > 3.01939 )
						ret := 0.706767 // buy
			if( dx > 77.8125 )
				if( diPlus <= 59.1631 )
					if( directionalMovementPlus <= 8.57556 )
						ret := -0.712121 // sell
					if( directionalMovementPlus > 8.57556 )
						ret := 0.166667
				if( diPlus > 59.1631 )
					if( trueRange <= 51.9426 )
						ret := 1.000000 // buy
					if( trueRange > 51.9426 )
						ret := 0.666667
		if( smoothedDirectionalMovementPlus > 34.6623 )
			if( dx <= 53.1546 )
				...
				if( dx > 49.2413 )
					ret := 0.428571
			if( dx > 53.1546 )
				if( smoothedDirectionalMovementMinus <= 6.72242 )
					ret := -0.100000
				if( smoothedDirectionalMovementMinus > 6.72242 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_TSLA_1Day_23db39df(directionalMovementPlus, directionalMovementMinus, trueRange, smoothedDirectionalMovementPlus, smoothedDirectionalMovementMinus, diPlus, diMinus, smoothedTrueRange, adx, dx)
