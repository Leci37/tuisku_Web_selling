				...
				if( ema13 > 0.819585 )
					...
					if( ad_mf > 5.94332e+06 )
						...
						if( mf > 0.212269 )
							ret := -0.319797
	if( ema12 > 1.59423 )
		if( ad_mf <= 2.22191e+06 )
			if( mf <= 0.346043 )
				if( ad <= -1.73962e+06 )
					if( ad_mf <= -6.16361e+06 )
						if( ad <= -1.53833e+07 )
							ret := 0.812500 // buy
						if( ad > -1.53833e+07 )
							ret := -0.480000
...
float op_operation = decision_tree_0_NVDA_1Hour_ab3629fd(mf, ad_mf, ad, ema12, ema3, ema13, tema, ema1, ema2)
