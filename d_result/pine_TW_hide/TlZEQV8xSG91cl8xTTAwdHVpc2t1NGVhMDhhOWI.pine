			...
			if( MFI_Low > -6.46854 )
				...
				if( Raw_Money_Flow > 6.48439e+09 )
					...
					if( Negative_Money_Flow_Sum > 2.8108e+10 )
						ret := 0.000000
	if( Positive_Money_Flow_Sum > 1.30949e+10 )
		if( Typical_Price <= 567.004 )
			if( Negative_Money_Flow_Sum <= 2.41962e+10 )
				if( MFI_High <= -2.34174 )
					if( MFI_Low <= 56.2715 )
						ret := 0.175367
					if( MFI_Low > 56.2715 )
						ret := 0.570000
				if( MFI_High > -2.34174 )
					if( Raw_Money_Flow <= 3.55905e+08 )
						ret := -0.256554
					if( Raw_Money_Flow > 3.55905e+08 )
						ret := 0.200000
			if( Negative_Money_Flow_Sum > 2.41962e+10 )
				if( Money_Flow_Ratio <= 0.485833 )
					if( Money_Flow_Ratio <= 0.44705 )
						ret := 0.238095
					if( Money_Flow_Ratio > 0.44705 )
						ret := 0.892857 // buy
				if( Money_Flow_Ratio > 0.485833 )
					if( Positive_Money_Flow_Sum <= 2.06933e+10 )
						ret := -0.320000
					if( Positive_Money_Flow_Sum > 2.06933e+10 )
						ret := -0.866667 // sell
		if( Typical_Price > 567.004 )
			if( Negative_Money_Flow_Sum <= 4.34653e+09 )
				if( Typical_Price <= 728.218 )
					if( Negative_Money_Flow_Sum <= 2.29783e+09 )
						ret := 0.604167
					if( Negative_Money_Flow_Sum > 2.29783e+09 )
						ret := 0.217391
				if( Typical_Price > 728.218 )
					if( Negative_Money_Flow <= 2.29011e+08 )
						ret := 0.755396 // buy
					if( Negative_Money_Flow > 2.29011e+08 )
						ret := -0.857143 // sell
			if( Negative_Money_Flow_Sum > 4.34653e+09 )
				if( Typical_Price <= 1198.53 )
					if( MFI_Low <= 63.866 )
						ret := 0.237201
					if( MFI_Low > 63.866 )
						ret := -0.071429
				if( Typical_Price > 1198.53 )
					if( Raw_Money_Flow <= 2.04118e+09 )
						ret := -0.818182 // sell
					if( Raw_Money_Flow > 2.04118e+09 )
						ret := -0.111111
...
float op_operation = decision_tree_0_NVDA_1Hour_4ea08a9b(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
