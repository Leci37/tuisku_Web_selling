...
decision_tree_0_ETSY_1Day_7568793e(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)=>
	...
	if( lowerBB > 42.7573 )
		...
		if( upperBB > 230.619 )
			...
			if( val > -0.972821 )
				if( basis <= 229.378 )
					if( priceRange <= 16.2926 )
						ret := -0.848739 // sell
					if( priceRange > 16.2926 )
						ret := 0.250000
				if( basis > 229.378 )
					if( avgHighLow <= 255.106 )
						ret := 0.480000
					if( avgHighLow > 255.106 )
						ret := -0.826087 // sell
...
float op_operation = decision_tree_0_ETSY_1Day_7568793e(sqzOnInt, priceRange, lowerKC, lowerBB, rangema, noSqzInt, basis, val, ma, dev, sqzOffInt, upperBB, upperKC, avgHighLow)
