...
decision_tree_0_AAVEUSDT_1Day_0b2f6aa3(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)=>
	...
	if( Typical_Price > 85.2109 )
		if( bullPower <= -19.497 )
			if( Raw_Money_Flow <= 2.44824e+07 )
				if( Negative_Money_Flow <= 1.93225e+07 )
					if( bearPower <= -44.2863 )
						ret := 1.000000 // buy
					if( bearPower > -44.2863 )
						ret := 0.000000
				if( Negative_Money_Flow > 1.93225e+07 )
					if( Money_Flow_Ratio <= 0.530674 )
						ret := -1.000000 // sell
					if( Money_Flow_Ratio > 0.530674 )
						ret := 0.000000
			if( Raw_Money_Flow > 2.44824e+07 )
				if( bbm <= 16.875 )
					if( Positive_Money_Flow_Sum <= 2.59366e+08 )
						ret := 0.000000
					if( Positive_Money_Flow_Sum > 2.59366e+08 )
						ret := -1.000000 // sell
				if( bbm > 16.875 )
					if( Negative_Money_Flow_Sum <= 4.19993e+08 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 4.19993e+08 )
						ret := 0.890411 // buy
		if( bullPower > -19.497 )
			if( MFI_Low <= 58.4676 )
				if( Negative_Money_Flow_Sum <= 7.46504e+07 )
					if( bbp <= 9.56871 )
						ret := -0.658824
					if( bbp > 9.56871 )
						ret := 0.043478
				if( Negative_Money_Flow_Sum > 7.46504e+07 )
					...
					if( bbm > 7.62518 )
						ret := -0.216567
			if( MFI_Low > 58.4676 )
				if( bullPower <= 48.9363 )
					if( Typical_Price <= 112.722 )
						ret := 0.038462
					if( Typical_Price > 112.722 )
						ret := 0.808511 // buy
				if( bullPower > 48.9363 )
					if( bullPower <= 62.9742 )
						ret := -0.695652
					if( bullPower > 62.9742 )
						ret := 0.333333
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_0b2f6aa3(bullPower, bbp, bearPower, bbm, BBPower_Color, Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum)
