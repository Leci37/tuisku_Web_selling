		...
		if( VIP <= 0.798647 )
			...
			if( bbp > -0.045063 )
				if( VIM <= 1.19943 )
					ret := 0.000000
				if( VIM > 1.19943 )
					if( bearPower <= -0.020798 )
						ret := -1.000000 // sell
					if( bearPower > -0.020798 )
						ret := 0.000000
		if( VIP > 0.798647 )
			if( VIM <= 0.90801 )
				if( bearPower <= 0.031245 )
					if( VIM <= 0.858377 )
						ret := 0.122754
					if( VIM > 0.858377 )
						ret := 0.497890
				if( bearPower > 0.031245 )
					if( bullPower <= 0.225051 )
						ret := -0.534884
					if( bullPower > 0.225051 )
						ret := 0.043478
			if( VIM > 0.90801 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_b0d610ff(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP_VIM, VIP, VIM)
