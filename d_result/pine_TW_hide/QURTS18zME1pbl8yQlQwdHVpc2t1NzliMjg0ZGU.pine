...
decision_tree_0_ADSK_30Min_79b284de(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)=>
	...
	if( ema1 > 46.4105 )
		...
		if( tema > 50.2123 )
			if( ema3 <= 54.3534 )
				if( bullPower <= 1.36036 )
					if( ema12 <= 0.322148 )
						if( bullPower <= -0.58463 )
							ret := -0.272727
						if( bullPower > -0.58463 )
							ret := 0.687259
					if( ema12 > 0.322148 )
...
float op_operation = decision_tree_0_ADSK_30Min_79b284de(bullPower, bbp, bearPower, bbm, BBPower_Color, ema3, tema, ema2, ema12, ema13, ema1)
