...
float op_operation = decision_tree_0_SHOP_1Hour_90f192ca(avgHighLow, priceRange, upperBB, upperKC, sqzOffInt, dev, ma, sqzOnInt, lowerBB, rangema, basis, lowerKC, val, noSqzInt)
