...
decision_tree_0_UBER_1Day_ae7ef37f(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)=>
	...
	if( stoc > 22.1451 )
		...
		if( xmf > 73.0145 )
			if( nvi_ema <= 0.132082 )
				if( marron_mean <= 118.082 )
					if( verde_media <= 6.96187 )
						ret := -0.666667
					if( verde_media > 6.96187 )
						ret := 0.636986
				if( marron_mean > 118.082 )
			...
			if( nvi_ema > 0.132082 )
				if( tprice <= 63.6226 )
					if( media_azul <= 91.2658 )
						ret := 0.000000
					if( media_azul > 91.2658 )
						ret := -0.909091 // sell
				if( tprice > 63.6226 )
					if( verde_azul <= 129.169 )
						ret := 1.000000 // buy
					if( verde_azul > 129.169 )
						ret := -0.285714
...
float op_operation = decision_tree_0_UBER_1Day_ae7ef37f(nvi, nvi_ema, marron_mean, source, azul, verde_azul, verde_mean, xmf, pvimin, stoc, media, tprice, marron, pvim, pvimax, xrsi, oscp, pvi, nvimax, nvimin, verde, verde_media, azul_mean, nvim, BollOsc, pvi_ema, media_azul)
