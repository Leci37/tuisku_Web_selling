			...
			if( upper_6 <= 690.924 )
				...
				if( lower_5 > 484.153 )
					if( lower_3 <= 496.86 )
						ret := 0.711656 // buy
					if( lower_3 > 496.86 )
						if( basis_minus <= 28.5486 )
							ret := -0.177686
						if( basis_minus > 28.5486 )
							ret := 0.048816
			if( upper_6 > 690.924 )
				if( upper_1 <= 673.366 )
					if( basis_max <= -61.6863 )
						if( basis_minus <= 77.1057 )
							ret := 0.292035
						if( basis_minus > 77.1057 )
							ret := -0.201657
					if( basis_max > -61.6863 )
...
float op_operation = decision_tree_0_ADBE_1Hour_1b6d8a6a(basis_max, upper_1, lower_2, upper_2, lower_3, lower_6, basis_minus, lower_4, upper_4, upper_5, basis, upper_3, lower_5, upper_6, lower_1)
