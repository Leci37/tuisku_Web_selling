			...
			if( ad <= -1.03028e+07 )
				...
				if( ad_mf > -1.08547e+07 )
					...
					if( bbm > 1.10032 )
						ret := 1.000000 // buy
			if( ad > -1.03028e+07 )
				if( ad_mf <= -9.33689e+06 )
					if( bearPower <= 0.54281 )
						ret := -0.894737 // sell
					if( bearPower > 0.54281 )
						ret := 0.000000
				if( ad_mf > -9.33689e+06 )
...
float op_operation = decision_tree_0_MSFT_1Day_e7dc882a(bearPower, bbm, bbp, bullPower, BBPower_Color, mf, ad_mf, ad)
