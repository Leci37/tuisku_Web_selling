			...
			if( upper_3 <= 1841.5 )
				if( upper_4 <= 1948.84 )
					...
					if( lower_6 > 478.872 )
						ret := -0.050000
				if( upper_4 > 1948.84 )
					if( basis_max <= -968.283 )
						ret := -0.777778 // sell
					if( basis_max > -968.283 )
						ret := 0.000000
			if( upper_3 > 1841.5 )
				if( lower_3 <= 1372.43 )
					if( basis_minus <= 851.693 )
						ret := -0.836735 // sell
					if( basis_minus > 851.693 )
						ret := 0.000000
				if( lower_3 > 1372.43 )
...
float op_operation = decision_tree_0_MELI_1Day_463c5723(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
