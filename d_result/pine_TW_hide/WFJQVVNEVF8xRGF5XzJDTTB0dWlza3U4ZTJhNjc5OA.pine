...
decision_tree_0_XRPUSDT_1Day_8e2a6798(ad, ad_mf, mf, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)=>
	...
	if( Typical_Price > 0.615196 )
		if( mf <= -0.08329 )
			if( MFI_High <= -37.1391 )
				if( ad_mf <= -1.61057e+08 )
					ret := 1.000000 // buy
				if( ad_mf > -1.61057e+08 )
					if( Positive_Money_Flow <= 7.57916e+07 )
						ret := 0.571429
					if( Positive_Money_Flow > 7.57916e+07 )
						ret := 1.000000 // buy
			if( MFI_High > -37.1391 )
				ret := -0.600000
		if( mf > -0.08329 )
			if( Negative_Money_Flow_Sum <= 1.701e+10 )
				if( Typical_Price <= 0.848969 )
					if( Typical_Price <= 0.70376 )
						ret := -0.415094
					if( Typical_Price > 0.70376 )
						ret := -0.011278
				if( Typical_Price > 0.848969 )
					if( Raw_Money_Flow <= 4.11839e+08 )
						ret := -0.813084 // sell
					if( Raw_Money_Flow > 4.11839e+08 )
						ret := -0.424390
			if( Negative_Money_Flow_Sum > 1.701e+10 )
				if( Raw_Money_Flow <= 1.40039e+09 )
					ret := 0.800000 // buy
				if( Raw_Money_Flow > 1.40039e+09 )
					ret := 1.000000 // buy
...
float op_operation = decision_tree_0_XRPUSDT_1Day_8e2a6798(ad, ad_mf, mf, Positive_Money_Flow_Sum, MFI, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, MFI_High, Typical_Price, Positive_Money_Flow, Negative_Money_Flow_Sum)
