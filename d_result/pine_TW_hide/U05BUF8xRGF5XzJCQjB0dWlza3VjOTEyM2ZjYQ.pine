			...
			if( bbm > 1.73034 )
				...
				if( Upper_Band > 43.5192 )
					...
					if( basis > 39.9885 )
						ret := 0.500000
		if( bearPower > -4.0685 )
			if( bullPower <= -0.511915 )
				if( Upper_Band <= 17.5712 )
					if( Upper_Band <= 16.8399 )
						ret := 0.400000
					if( Upper_Band > 16.8399 )
						ret := 0.000000
				if( Upper_Band > 17.5712 )
					if( Lower_Band <= 36.6964 )
						ret := -0.655738
					if( Lower_Band > 36.6964 )
						ret := 0.000000
			if( bullPower > -0.511915 )
...
float op_operation = decision_tree_0_SNAP_1Day_c9123fca(basis, Upper_Band, Lower_Band, bbm, bearPower, bbp, bullPower, BBPower_Color)
