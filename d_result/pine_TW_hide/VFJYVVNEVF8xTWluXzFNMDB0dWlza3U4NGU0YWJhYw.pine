		...
		if( Raw_Money_Flow <= 13910.7 )
			if( Negative_Money_Flow_Sum <= 24458.4 )
				...
				if( Typical_Price > 0.123347 )
					ret := 0.600062
			if( Negative_Money_Flow_Sum > 24458.4 )
				if( Typical_Price <= 0.125522 )
					if( Negative_Money_Flow_Sum <= 192343 )
						ret := 0.065814
					if( Negative_Money_Flow_Sum > 192343 )
						ret := 0.231930
				if( Typical_Price > 0.125522 )
					if( Positive_Money_Flow_Sum <= 25680.6 )
						ret := 0.533829
					if( Positive_Money_Flow_Sum > 25680.6 )
						if( Positive_Money_Flow_Sum <= 290672 )
							ret := 0.404677
						if( Positive_Money_Flow_Sum > 290672 )
							ret := 0.281586
		if( Raw_Money_Flow > 13910.7 )
			if( Raw_Money_Flow <= 55972.2 )
				if( Typical_Price <= 0.135011 )
					ret := 0.099511
				if( Typical_Price > 0.135011 )
					if( Raw_Money_Flow <= 23917.3 )
						ret := 0.425170
					if( Raw_Money_Flow > 23917.3 )
						ret := 0.254790
			if( Raw_Money_Flow > 55972.2 )
				if( MFI_High <= -24.3903 )
					if( Typical_Price <= 0.130833 )
						ret := -0.016995
					if( Typical_Price > 0.130833 )
						if( Positive_Money_Flow_Sum <= 344293 )
							ret := 0.162952
						if( Positive_Money_Flow_Sum > 344293 )
							ret := -0.033516
				if( MFI_High > -24.3903 )
					if( Money_Flow_Ratio <= 3.07071 )
						ret := 0.233081
					if( Money_Flow_Ratio > 3.07071 )
						if( Raw_Money_Flow <= 308868 )
							ret := 0.084683
						if( Raw_Money_Flow > 308868 )
							ret := -0.711538 // sell
...
float op_operation = decision_tree_0_TRXUSDT_1Min_84e4abac(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
