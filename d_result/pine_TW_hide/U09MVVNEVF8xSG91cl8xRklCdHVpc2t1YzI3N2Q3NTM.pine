...
decision_tree_0_SOLUSDT_1Hour_c277d753(basis, upper_2, upper_3, lower_2, lower_6, lower_1, basis_minus, lower_3, upper_6, lower_5, lower_4, upper_5, upper_4, basis_max, upper_1)=>
	...
	if( basis > 150.082 )
		if( lower_6 <= 117.149 )
			if( basis_minus <= 43.4168 )
				if( basis_minus <= 40.733 )
					if( upper_6 <= 197.067 )
						ret := -1.000000 // sell
					if( upper_6 > 197.067 )
						ret := -0.777778 // sell
...
float op_operation = decision_tree_0_SOLUSDT_1Hour_c277d753(basis, upper_2, upper_3, lower_2, lower_6, lower_1, basis_minus, lower_3, upper_6, lower_5, lower_4, upper_5, upper_4, basis_max, upper_1)
