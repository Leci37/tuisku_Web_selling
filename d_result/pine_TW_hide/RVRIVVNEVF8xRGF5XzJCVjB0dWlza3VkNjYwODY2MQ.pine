...
decision_tree_0_ETHUSDT_1Day_d6608661(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)=>
	...
	if( VIP_VIM > 0.047379 )
		if( bbm <= 40.5512 )
			if( VIM <= 0.963683 )
				if( bearPower <= 9.50816 )
					if( bullPower <= 33.6808 )
						ret := 0.407197
					if( bullPower > 33.6808 )
						ret := -0.800000 // sell
				if( bearPower > 9.50816 )
					if( bullPower <= 27.5717 )
						ret := -0.500000
					if( bullPower > 27.5717 )
						ret := 0.265537
			if( VIM > 0.963683 )
				if( VIP_VIM <= 0.085806 )
					if( bullPower <= 9.74953 )
						ret := 0.463415
					if( bullPower > 9.74953 )
						ret := -0.307692
				if( VIP_VIM > 0.085806 )
		...
		if( bbm > 40.5512 )
			if( bbp <= 220.503 )
				if( bearPower <= 55.7403 )
					if( bullPower <= -62.8082 )
						ret := 1.000000 // buy
					if( bullPower > -62.8082 )
						ret := -0.067164
				if( bearPower > 55.7403 )
...
float op_operation = decision_tree_0_ETHUSDT_1Day_d6608661(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
