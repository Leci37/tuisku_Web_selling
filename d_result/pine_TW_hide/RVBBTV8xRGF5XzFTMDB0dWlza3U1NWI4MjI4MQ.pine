...
decision_tree_0_EPAM_1Day_55b82281(d, d_k, smoothK_k, k, rsi1, smoothD_d)=>
	...
	if( smoothK_k > 94.2406 )
		if( rsi1 <= 69.5093 )
			...
			if( k > 99.801 )
				if( rsi1 <= 64.3965 )
					if( smoothK_k <= 96.9052 )
						ret := 1.000000 // buy
					if( smoothK_k > 96.9052 )
						ret := 0.038462
				if( rsi1 > 64.3965 )
					if( smoothD_d <= 96.2943 )
						ret := -0.888889 // sell
					if( smoothD_d > 96.2943 )
						ret := 0.000000
		if( rsi1 > 69.5093 )
			if( rsi1 <= 86.1192 )
				if( d <= 98.7438 )
					...
					if( d_k > -1.49777 )
						ret := 0.666667
				if( d > 98.7438 )
					if( smoothD_d <= 95.9649 )
						ret := -0.857143 // sell
					if( smoothD_d > 95.9649 )
						ret := 0.150000
			if( rsi1 > 86.1192 )
				if( smoothD_d <= 95.0787 )
					ret := 0.000000
				if( smoothD_d > 95.0787 )
					if( rsi1 <= 93.6554 )
						ret := -0.947368 // sell
...
float op_operation = decision_tree_0_EPAM_1Day_55b82281(d, d_k, smoothK_k, k, rsi1, smoothD_d)
