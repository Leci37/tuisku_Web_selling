	...
	if( bullPower > -0.115201 )
		if( Upper_Band <= 28.2011 )
			...
			if( basis > 27.7264 )
				ret := 0.508475
		if( Upper_Band > 28.2011 )
			if( Lower_Band <= 27.8447 )
				if( Lower_Band <= 27.2271 )
					if( bbp <= 0.542065 )
						ret := 0.098398
					if( bbp > 0.542065 )
						ret := -0.420408
			...
			if( Lower_Band > 27.8447 )
				if( Upper_Band <= 30.03 )
					if( Lower_Band <= 29.4151 )
						if( Lower_Band <= 29.2822 )
							ret := 0.147754
						if( Lower_Band > 29.2822 )
							ret := -0.495413
					if( Lower_Band > 29.4151 )
...
float op_operation = decision_tree_0_UBER_30Min_9928e383(Upper_Band, basis, Lower_Band, bbp, bullPower, BBPower_Color, bearPower, bbm)
