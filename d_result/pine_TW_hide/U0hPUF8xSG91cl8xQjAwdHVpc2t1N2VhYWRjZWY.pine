	...
	if( bbm > 8.91743 )
		if( bullPower <= -21.537 )
			...
			if( bullPower > -31.2979 )
				ret := 0.412935
		if( bullPower > -21.537 )
			if( bearPower <= -7.31715 )
				if( bullPower <= 3.86828 )
					if( bullPower <= 1.96275 )
						if( bbm <= 26.4605 )
							ret := -0.089375
						if( bbm > 26.4605 )
							ret := -0.392857
...
float op_operation = decision_tree_0_SHOP_1Hour_7eaadcef(bbm, bearPower, bbp, bullPower, BBPower_Color)
