			...
			if( bearPower > -0.998516 )
				if( VIM <= 1.05424 )
					...
					if( bbm > 2.04579 )
						ret := -0.445596
				if( VIM > 1.05424 )
					if( bearPower <= 0.237434 )
						ret := -0.068004
					if( bearPower > 0.237434 )
						ret := -0.687204
		if( VIP > 1.29403 )
			if( VIP_VIM <= 0.648745 )
				if( bullPower <= 1.51308 )
					if( bbp <= 1.29986 )
						ret := 0.148220
					if( bbp > 1.29986 )
						ret := -0.246914
...
float op_operation = decision_tree_0_PINS_1Hour_c8315399(bearPower, bbm, bbp, bullPower, BBPower_Color, VIP, VIP_VIM, VIM)
