			...
			if( Negative_Money_Flow_Sum <= 1.55438e+10 )
				...
				if( Negative_Money_Flow_Sum > 1.49648e+10 )
					...
					if( MFI_High > -30.451 )
						ret := -0.200000
			if( Negative_Money_Flow_Sum > 1.55438e+10 )
				if( ad_mf <= -1.14435e+06 )
					if( Raw_Money_Flow <= 1.75987e+09 )
						ret := -0.500000
					if( Raw_Money_Flow > 1.75987e+09 )
						ret := 0.548387
				if( ad_mf > -1.14435e+06 )
					if( Typical_Price <= 351.121 )
						ret := 1.000000 // buy
					if( Typical_Price > 351.121 )
						ret := -0.621053
		if( MFI > 74.3636 )
			if( ad <= 3.08512e+06 )
				if( Positive_Money_Flow_Sum <= 2.06756e+10 )
					if( Raw_Money_Flow <= 1.94701e+08 )
						ret := -0.153846
					if( Raw_Money_Flow > 1.94701e+08 )
						ret := -0.727273 // sell
				if( Positive_Money_Flow_Sum > 2.06756e+10 )
					ret := 0.000000
			if( ad > 3.08512e+06 )
				if( Negative_Money_Flow_Sum <= 2.44936e+09 )
					ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 2.44936e+09 )
					ret := 0.000000
...
float op_operation = decision_tree_0_SHOP_1Day_d3ab9614(mf, ad, ad_mf, Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow)
