			...
			if( senkou_span_b <= 45.1699 )
				...
				if( senkou_span_a > 42.3213 )
					...
					if( senkou_span_a_displaced > 32.3029 )
						ret := 0.500000
			if( senkou_span_b > 45.1699 )
				if( chinkou_span <= 70.545 )
					if( senkou_span_b <= 47.6422 )
						ret := -0.285714
					if( senkou_span_b > 47.6422 )
						ret := -0.644550
				if( chinkou_span > 70.545 )
					if( tenkan_sen <= 87.405 )
						ret := 0.377778
					if( tenkan_sen > 87.405 )
						ret := -0.800000 // sell
		if( chinkou_span > 81.9034 )
			if( senkou_span_a <= 102.457 )
				if( kinjun_sen <= 106.406 )
					if( kinjun_sen <= 103.068 )
						ret := 0.640777
					if( kinjun_sen > 103.068 )
						ret := -0.333333
				if( kinjun_sen > 106.406 )
					ret := 1.000000 // buy
			if( senkou_span_a > 102.457 )
				if( senkou_span_a <= 107.528 )
					if( senkou_span_a_displaced <= 80.5812 )
						ret := -0.200000
					if( senkou_span_a_displaced > 80.5812 )
						ret := 0.000000
				if( senkou_span_a > 107.528 )
					if( chinkou_span <= 113.538 )
						ret := -1.000000 // sell
					if( chinkou_span > 113.538 )
						ret := -0.250000
...
float op_operation = decision_tree_0_AVAXUSDT_1Day_16551268(basis_max, tenkan_sen, senkou_span_b, senkou_span_b_displaced, kinjun_sen, senkou_span_a, chinkou_span, basis_minus, cross_dn_tenkan_kinjunInt, senkou_span_a_displaced, cross_up_tenkan_kinjunInt)
