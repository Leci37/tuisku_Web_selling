...
decision_tree_0_ETHUSDT_1Day_983716fc(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)=>
	...
	if( Negative_Money_Flow > 2.2195e+07 )
		...
		if( Positive_Money_Flow_Sum > 6.96747e+08 )
			if( MFI <= 51.277 )
				if( Typical_Price <= 2611.02 )
					if( Typical_Price <= 383.983 )
						ret := 0.506024
					if( Typical_Price > 383.983 )
						ret := 0.142857
				if( Typical_Price > 2611.02 )
					...
					if( MFI_High > -37.086 )
						ret := 0.185185
			if( MFI > 51.277 )
				if( Typical_Price <= 1606.36 )
					if( Raw_Money_Flow <= 8.40586e+08 )
						ret := -0.048387
					if( Raw_Money_Flow > 8.40586e+08 )
						ret := 0.683333
				if( Typical_Price > 1606.36 )
					if( Negative_Money_Flow_Sum <= 6.64654e+09 )
						ret := -0.138889
					if( Negative_Money_Flow_Sum > 6.64654e+09 )
						ret := -0.564815
...
float op_operation = decision_tree_0_ETHUSDT_1Day_983716fc(Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
