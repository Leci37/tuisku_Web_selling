			...
			if( Color_con2 > 7.06338 )
				...
				if( wvf > 42.3819 )
					...
					if( Color_con1 > -7.31086 )
						ret := 1.000000 // buy
	if( lowerBand > 6.14137 )
		if( lowerBand <= 12.2169 )
			if( sDev <= 7.76883 )
				if( wvf <= 10.1438 )
					ret := 0.000000
				if( wvf > 10.1438 )
					if( Color_con1 <= -4.99259 )
						ret := 1.000000 // buy
					if( Color_con1 > -4.99259 )
						ret := 0.250000
			if( sDev > 7.76883 )
				if( wvf <= 32.2954 )
					if( Color_con2 <= 0.364141 )
						ret := -0.789809 // sell
					if( Color_con2 > 0.364141 )
						ret := 0.333333
				if( wvf > 32.2954 )
		...
		if( lowerBand > 12.2169 )
			if( wvf <= 15.5134 )
				...
				if( sDev > 14.2102 )
					ret := 0.500000
			if( wvf > 15.5134 )
				if( Color_con2 <= -7.36813 )
					if( lowerBand <= 18.3104 )
						ret := -1.000000 // sell
					if( lowerBand > 18.3104 )
						ret := -0.375000
				if( Color_con2 > -7.36813 )
...
float op_operation = decision_tree_0_CRWD_1Day_c847a4e6(sDev, Color_con1, lowerBand, wvf, upperBand, midLine, Color_con2, rangeLow, colInt, rangeHigh)
