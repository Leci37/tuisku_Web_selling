			...
			if( mf > -0.165786 )
				...
				if( VIP > 1.00559 )
					...
					if( mf > 0.061144 )
						ret := -0.490196
		if( ad_mf > 1.45172e+06 )
			if( ad_mf <= 2.16314e+06 )
				if( VIP <= 1.06282 )
					if( ad_mf <= 1.52414e+06 )
						ret := -0.250000
					if( ad_mf > 1.52414e+06 )
						ret := 0.770270 // buy
				if( VIP > 1.06282 )
			...
			if( ad_mf > 2.16314e+06 )
				if( VIP_VIM <= 0.29396 )
					if( ad_mf <= 3.37119e+06 )
						ret := -0.157895
					if( ad_mf > 3.37119e+06 )
						ret := -0.863636 // sell
				if( VIP_VIM > 0.29396 )
					if( ad_mf <= 3.77605e+06 )
						ret := -0.181818
					if( ad_mf > 3.77605e+06 )
						ret := 0.846154 // buy
...
float op_operation = decision_tree_0_SPOT_1Day_cf1e47ec(mf, ad, ad_mf, VIP_VIM, VIM, VIP)
