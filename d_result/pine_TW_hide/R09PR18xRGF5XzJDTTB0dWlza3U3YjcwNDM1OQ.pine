			...
			if( Negative_Money_Flow_Sum > 3.02827e+10 )
				...
				if( mf > -0.137421 )
					...
					if( Typical_Price > 2916.72 )
						ret := -0.142857
	if( mf > 0.175695 )
		if( Positive_Money_Flow_Sum <= 3.02188e+10 )
			if( Positive_Money_Flow_Sum <= 2.30951e+10 )
				if( Raw_Money_Flow <= 1.34388e+09 )
					if( Positive_Money_Flow_Sum <= 1.06918e+10 )
						ret := 0.600000
					if( Positive_Money_Flow_Sum > 1.06918e+10 )
						ret := -0.166667
				if( Raw_Money_Flow > 1.34388e+09 )
			...
			if( Positive_Money_Flow_Sum > 2.30951e+10 )
				...
				if( Raw_Money_Flow > 4.08355e+09 )
					...
					if( MFI > 63.8666 )
						ret := 0.500000
		if( Positive_Money_Flow_Sum > 3.02188e+10 )
			if( Raw_Money_Flow <= 2.92722e+09 )
				if( mf <= 0.220804 )
					ret := -1.000000 // sell
				if( mf > 0.220804 )
					ret := 0.000000
			if( Raw_Money_Flow > 2.92722e+09 )
				if( Negative_Money_Flow <= 5.0271e+09 )
					if( Typical_Price <= 2901.87 )
						ret := -0.982759 // sell
					if( Typical_Price > 2901.87 )
						ret := 0.000000
				if( Negative_Money_Flow > 5.0271e+09 )
...
float op_operation = decision_tree_0_GOOG_1Day_7b704359(mf, ad_mf, ad, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
