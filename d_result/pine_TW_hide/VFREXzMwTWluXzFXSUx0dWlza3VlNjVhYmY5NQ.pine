...
decision_tree_0_TTD_30Min_e65abf95(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)=>
	...
	if( midLine <= 12.3536 )
		...
		if( Color_con2 > -7.44555 )
			...
			if( lowerBand > -0.316011 )
				if( sDev <= 0.50782 )
					if( Color_con2 <= -2.4795 )
						ret := 0.903846 // buy
					if( Color_con2 > -2.4795 )
						if( lowerBand <= -0.090235 )
							ret := 0.761194 // buy
						if( lowerBand > -0.090235 )
							ret := -0.046512
				if( sDev > 0.50782 )
					if( upperBand <= 1.17652 )
						if( Color_con2 <= -1.8721 )
							ret := 0.067416
						if( Color_con2 > -1.8721 )
							ret := -0.438095
					if( upperBand > 1.17652 )
						if( Color_con2 <= 5.64888 )
							ret := -0.014896
						if( Color_con2 > 5.64888 )
							ret := 0.969697 // buy
	if( midLine > 12.3536 )
		if( Color_con1 <= -6.52633 )
			if( wvf <= 4.50181 )
				if( midLine <= 18.9742 )
					ret := -0.576923
				if( midLine > 18.9742 )
...
float op_operation = decision_tree_0_TTD_30Min_e65abf95(rangeLow, wvf, Color_con1, midLine, sDev, colInt, upperBand, rangeHigh, lowerBand, Color_con2)
