			...
			if( Positive_Money_Flow > 1.15935e+07 )
				...
				if( bbp > -10.3872 )
					...
					if( Positive_Money_Flow > 3.39182e+09 )
						ret := -0.337209
	if( bearPower > 2.39893 )
		if( Raw_Money_Flow <= 1.24566e+09 )
			if( MFI <= 72.3783 )
				if( Negative_Money_Flow_Sum <= 4.52004e+09 )
					ret := 1.000000 // buy
				if( Negative_Money_Flow_Sum > 4.52004e+09 )
					...
					if( BBPower_Color > 0.5 )
						ret := 0.155172
			if( MFI > 72.3783 )
				if( bearPower <= 5.97814 )
					ret := -1.000000 // sell
				if( bearPower > 5.97814 )
					ret := 0.000000
		if( Raw_Money_Flow > 1.24566e+09 )
			if( Typical_Price <= 1269.07 )
				if( bbm <= 10.71 )
					if( MFI_Low <= 33.8498 )
						ret := 0.478261
					if( MFI_Low > 33.8498 )
				...
				if( bbm > 10.71 )
					...
					if( MFI > 66.0565 )
						ret := -0.679487
			if( Typical_Price > 1269.07 )
				if( bullPower <= 64.1268 )
					if( Positive_Money_Flow <= 1.88319e+09 )
						ret := -0.126984
					if( Positive_Money_Flow > 1.88319e+09 )
						ret := 0.250000
				if( bullPower > 64.1268 )
					if( Positive_Money_Flow_Sum <= 3.49806e+10 )
						ret := 0.016529
					if( Positive_Money_Flow_Sum > 3.49806e+10 )
						ret := -0.550725
...
float op_operation = decision_tree_0_GOOG_1Day_5d25fe2d(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
