...
decision_tree_0_APPS_1Day_aaaae547(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)=>
	...
	if( ad > 1.01495e+06 )
		if( rsi1 <= 58.364 )
			if( smoothD_d <= 1.91437 )
				if( ad_mf <= 2.16823e+06 )
					ret := -0.142857
				if( ad_mf > 2.16823e+06 )
					if( rsi1 <= 38.2206 )
						ret := 0.600000
...
float op_operation = decision_tree_0_APPS_1Day_aaaae547(ad, mf, ad_mf, rsi1, smoothK_k, d_k, k, d, smoothD_d)
