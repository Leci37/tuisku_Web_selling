		...
		if( senkou_span_b_displaced > 95.2678 )
			...
			if( chinkou_span > 98.2586 )
				if( kinjun_sen <= 97.5509 )
					ret := 0.732620 // buy
				if( kinjun_sen > 97.5509 )
					if( senkou_span_a_displaced <= 97.795 )
						ret := 0.649123
					if( senkou_span_a_displaced > 97.795 )
						ret := -0.283582
	if( senkou_span_b > 98.5697 )
		if( chinkou_span <= 100.175 )
			if( senkou_span_a <= 102.927 )
				if( senkou_span_b_displaced <= 106.976 )
					if( senkou_span_a <= 101.159 )
						ret := -0.655031
					if( senkou_span_a > 101.159 )
						ret := 0.487179
				if( senkou_span_b_displaced > 106.976 )
					if( senkou_span_b <= 102.648 )
						ret := 0.578947
					if( senkou_span_b > 102.648 )
						ret := -0.240506
			if( senkou_span_a > 102.927 )
				ret := -0.793249 // sell
		if( chinkou_span > 100.175 )
			if( basis_minus <= 7.49239 )
				if( senkou_span_a <= 104.861 )
					if( basis_minus <= -0.661804 )
						ret := 0.501292
					if( basis_minus > -0.661804 )
						ret := 0.051948
				if( senkou_span_a > 104.861 )
					if( chinkou_span <= 126.926 )
						if( senkou_span_a <= 123.037 )
							ret := -0.018547
						if( senkou_span_a > 123.037 )
							ret := -0.461627
					if( chinkou_span > 126.926 )
						if( senkou_span_a <= 130.157 )
							ret := 0.423849
						if( senkou_span_a > 130.157 )
							ret := -0.016382
			if( basis_minus > 7.49239 )
...
float op_operation = decision_tree_0_DDOG_1Hour_a2916cf1(senkou_span_a, basis_minus, chinkou_span, senkou_span_a_displaced, kinjun_sen, senkou_span_b_displaced, cross_up_tenkan_kinjunInt, senkou_span_b, cross_dn_tenkan_kinjunInt, tenkan_sen, basis_max)
