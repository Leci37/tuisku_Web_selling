				...
				if( Positive_Money_Flow_Sum <= 2.20269e+08 )
					if( Negative_Money_Flow_Sum <= 7.04738e+08 )
						...
						if( VIP > 1.03486 )
							ret := 0.117647
					if( Negative_Money_Flow_Sum > 7.04738e+08 )
						if( Negative_Money_Flow_Sum <= 1.9628e+09 )
							ret := 0.179487
						if( Negative_Money_Flow_Sum > 1.9628e+09 )
							ret := -0.431034
				if( Positive_Money_Flow_Sum > 2.20269e+08 )
					if( MFI <= 28.3586 )
						if( Positive_Money_Flow_Sum <= 3.86762e+08 )
							ret := 0.092552
						if( Positive_Money_Flow_Sum > 3.86762e+08 )
							ret := -0.134935
					if( MFI > 28.3586 )
						if( Negative_Money_Flow_Sum <= 5.52365e+08 )
							ret := -0.571429
						if( Negative_Money_Flow_Sum > 5.52365e+08 )
							ret := 0.219344
		if( MFI_Low > 12.8268 )
			if( VIP_VIM <= -0.222481 )
				if( Money_Flow_Ratio <= 1.23596 )
					if( Money_Flow_Ratio <= 1.02765 )
						if( Raw_Money_Flow <= 1.34011e+08 )
							ret := -0.010502
						if( Raw_Money_Flow > 1.34011e+08 )
							ret := -0.225137
					if( Money_Flow_Ratio > 1.02765 )
						if( Raw_Money_Flow <= 151577 )
							ret := 0.750000 // buy
						if( Raw_Money_Flow > 151577 )
							ret := 0.227642
				if( Money_Flow_Ratio > 1.23596 )
					if( Negative_Money_Flow_Sum <= 3.27142e+08 )
						if( MFI <= 64.7624 )
							ret := 0.514286
						if( MFI > 64.7624 )
							ret := -0.309524
					if( Negative_Money_Flow_Sum > 3.27142e+08 )
						if( Money_Flow_Ratio <= 1.83767 )
							ret := -0.377644
						if( Money_Flow_Ratio > 1.83767 )
							ret := -0.726776 // sell
			if( VIP_VIM > -0.222481 )
				if( Positive_Money_Flow_Sum <= 6.34643e+08 )
					if( Positive_Money_Flow_Sum <= 3.92598e+08 )
						if( MFI_Low <= 24.7027 )
							ret := -0.026423
						if( MFI_Low > 24.7027 )
							ret := -0.349593
					if( Positive_Money_Flow_Sum > 3.92598e+08 )
						if( Typical_Price <= 495.72 )
							ret := 0.167792
						if( Typical_Price > 495.72 )
							ret := -0.068279
				if( Positive_Money_Flow_Sum > 6.34643e+08 )
					if( Positive_Money_Flow_Sum <= 2.71315e+09 )
						if( VIP_VIM <= 0.536859 )
							ret := -0.037434
						if( VIP_VIM > 0.536859 )
							ret := 0.087265
					if( Positive_Money_Flow_Sum > 2.71315e+09 )
						if( Raw_Money_Flow <= 2.43184e+07 )
							ret := -0.636364
						if( Raw_Money_Flow > 2.43184e+07 )
							ret := 0.009901
...
float op_operation = decision_tree_0_ADBE_1Hour_27c4b4ab(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, VIP, VIM, VIP_VIM)
