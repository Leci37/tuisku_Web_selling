			...
			if( Negative_Money_Flow_Sum <= 2.45911e+09 )
				if( VIP <= 1.06311 )
					...
					if( Positive_Money_Flow_Sum > 7.23281e+08 )
						ret := -0.572368
				if( VIP > 1.06311 )
					if( Negative_Money_Flow <= 1.82764e+08 )
						ret := -0.083333
					if( Negative_Money_Flow > 1.82764e+08 )
						ret := 1.000000 // buy
			if( Negative_Money_Flow_Sum > 2.45911e+09 )
				if( Negative_Money_Flow <= 6.88749e+06 )
					if( VIM <= 1.21886 )
						ret := 0.142857
					if( VIM > 1.21886 )
						ret := -0.666667
				if( Negative_Money_Flow > 6.88749e+06 )
					if( Negative_Money_Flow <= 3.3877e+08 )
						ret := 0.708861 // buy
					if( Negative_Money_Flow > 3.3877e+08 )
						ret := 0.000000
		if( Positive_Money_Flow_Sum > 3.59587e+09 )
			if( Typical_Price <= 82.7081 )
				if( Raw_Money_Flow <= 7.45743e+08 )
					ret := -1.000000 // sell
				if( Raw_Money_Flow > 7.45743e+08 )
					ret := -0.666667
			if( Typical_Price > 82.7081 )
				if( Positive_Money_Flow_Sum <= 5.14571e+09 )
					ret := -0.250000
				if( Positive_Money_Flow_Sum > 5.14571e+09 )
					ret := -1.000000 // sell
...
float op_operation = decision_tree_0_RUN_1Day_37b2ce4b(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, VIP_VIM, VIM, VIP)
