			...
			if( Negative_Money_Flow_Sum > 9.14554e+08 )
				if( Typical_Price <= 489.487 )
					...
					if( Negative_Money_Flow > 4.40557e+06 )
						ret := 0.730159 // buy
				if( Typical_Price > 489.487 )
					if( Raw_Money_Flow <= 3.29721e+07 )
						ret := -0.881356 // sell
					if( Raw_Money_Flow > 3.29721e+07 )
						if( Typical_Price <= 714.054 )
							ret := -0.018182
						if( Typical_Price > 714.054 )
							ret := -0.695122
		if( bearPower > 0.500445 )
			if( Typical_Price <= 56.4094 )
				if( Typical_Price <= 50.295 )
					if( Negative_Money_Flow_Sum <= 9.7911e+07 )
						ret := 0.000000
					if( Negative_Money_Flow_Sum > 9.7911e+07 )
						ret := 0.653061
				if( Typical_Price > 50.295 )
					ret := 0.651515
			if( Typical_Price > 56.4094 )
				if( Positive_Money_Flow <= 32624.7 )
					if( bearPower <= 3.28119 )
						if( Raw_Money_Flow <= 12646.3 )
							ret := -0.363636
						if( Raw_Money_Flow > 12646.3 )
							ret := 0.166433
					if( bearPower > 3.28119 )
						...
						if( bbm > 1.515 )
							ret := 0.209184
				if( Positive_Money_Flow > 32624.7 )
					if( Money_Flow_Ratio <= 920.542 )
						if( Positive_Money_Flow_Sum <= 1.35027e+09 )
							ret := 0.035456
						if( Positive_Money_Flow_Sum > 1.35027e+09 )
							ret := -0.594059
					if( Money_Flow_Ratio > 920.542 )
...
float op_operation = decision_tree_0_TTD_1Hour_a1150e81(bbp, bullPower, BBPower_Color, bearPower, bbm, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
