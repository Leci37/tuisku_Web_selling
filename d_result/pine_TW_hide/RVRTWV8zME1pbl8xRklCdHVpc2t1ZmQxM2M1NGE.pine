...
decision_tree_0_ETSY_30Min_fd13c54a(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)=>
	...
	if( upper_2 > 50.5906 )
		if( upper_1 <= 231.451 )
			...
			if( upper_2 > 51.4035 )
				if( upper_1 <= 228.622 )
					if( basis_max <= -28.5039 )
						if( lower_6 <= 79.8347 )
							ret := -0.715789 // sell
						if( lower_6 > 79.8347 )
							ret := -0.110938
					if( basis_max > -28.5039 )
						if( basis_max <= -18.7162 )
							ret := 0.061069
						if( basis_max > -18.7162 )
							ret := -0.027166
				if( upper_1 > 228.622 )
...
float op_operation = decision_tree_0_ETSY_30Min_fd13c54a(upper_2, basis, lower_6, basis_minus, lower_5, upper_5, upper_4, basis_max, upper_6, upper_3, lower_2, upper_1, lower_4, lower_1, lower_3)
