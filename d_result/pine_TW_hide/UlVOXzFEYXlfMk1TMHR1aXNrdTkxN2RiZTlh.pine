			...
			if( Typical_Price > 12.0283 )
				...
				if( rsi1 > 43.8323 )
					...
					if( k > 23.5341 )
						ret := 0.193717
	if( Typical_Price > 17.1277 )
		if( Negative_Money_Flow_Sum <= 2.78017e+08 )
			if( Negative_Money_Flow_Sum <= 1.4126e+08 )
				if( Money_Flow_Ratio <= 13.5234 )
					if( Typical_Price <= 24.3309 )
						ret := 0.055556
					if( Typical_Price > 24.3309 )
						ret := 1.000000 // buy
				if( Money_Flow_Ratio > 13.5234 )
					ret := -1.000000 // sell
			if( Negative_Money_Flow_Sum > 1.4126e+08 )
				if( Negative_Money_Flow_Sum <= 1.63928e+08 )
					ret := 0.970588 // buy
				if( Negative_Money_Flow_Sum > 1.63928e+08 )
					if( Positive_Money_Flow <= 3.23528e+06 )
						ret := -0.083333
					if( Positive_Money_Flow > 3.23528e+06 )
						ret := 0.700000 // buy
		if( Negative_Money_Flow_Sum > 2.78017e+08 )
			if( Positive_Money_Flow_Sum <= 1.44635e+09 )
				if( MFI_Low <= 15.7354 )
					if( Typical_Price <= 23.2201 )
						ret := 0.310000
					if( Typical_Price > 23.2201 )
						ret := -0.504505
				if( MFI_Low > 15.7354 )
					if( smoothD_d <= 65.7612 )
						ret := -0.686520
					if( smoothD_d > 65.7612 )
						ret := -0.189474
			if( Positive_Money_Flow_Sum > 1.44635e+09 )
				if( Negative_Money_Flow_Sum <= 1.09266e+09 )
					if( Typical_Price <= 43.2711 )
						ret := -0.524229
					if( Typical_Price > 43.2711 )
						ret := 0.301887
				if( Negative_Money_Flow_Sum > 1.09266e+09 )
					if( Typical_Price <= 65.902 )
						ret := 0.200371
					if( Typical_Price > 65.902 )
						ret := -0.691358
...
float op_operation = decision_tree_0_RUN_1Day_917dbe9a(Negative_Money_Flow_Sum, MFI_High, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Money_Flow_Ratio, Typical_Price, MFI, Positive_Money_Flow_Sum, Positive_Money_Flow, d_k, d, rsi1, k, smoothD_d, smoothK_k)
