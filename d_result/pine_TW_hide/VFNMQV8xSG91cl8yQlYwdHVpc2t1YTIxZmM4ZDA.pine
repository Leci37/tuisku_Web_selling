...
decision_tree_0_TSLA_1Hour_a21fc8d0(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)=>
	...
	if( VIP_VIM > 0.494087 )
		...
		if( bbp > 5.76294 )
			if( VIP_VIM <= 1.09332 )
				if( bbp <= 36.1521 )
					if( bullPower <= 19.3919 )
						if( bearPower <= -0.154838 )
							ret := 0.848485 // buy
						if( bearPower > -0.154838 )
							ret := 0.221274
					if( bullPower > 19.3919 )
...
float op_operation = decision_tree_0_TSLA_1Hour_a21fc8d0(bbp, bullPower, BBPower_Color, bearPower, bbm, VIP, VIP_VIM, VIM)
