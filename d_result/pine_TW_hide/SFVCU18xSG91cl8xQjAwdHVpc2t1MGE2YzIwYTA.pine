			...
			if( bearPower > -0.826269 )
				if( bbp <= 0.335468 )
					...
					if( bearPower > 0.04348 )
						ret := 0.611940
				if( bbp > 0.335468 )
					if( bullPower <= 10.9727 )
						ret := 0.022111
					if( bullPower > 10.9727 )
						ret := 0.420732
		if( bullPower > 11.469 )
			if( bearPower <= -1.46383 )
				if( bearPower <= -4.12852 )
					if( bearPower <= -4.89493 )
						ret := -0.377953
					if( bearPower > -4.89493 )
						ret := 0.857143 // buy
				if( bearPower > -4.12852 )
...
float op_operation = decision_tree_0_HUBS_1Hour_0a6c20a0(bearPower, bbm, bbp, bullPower, BBPower_Color)
