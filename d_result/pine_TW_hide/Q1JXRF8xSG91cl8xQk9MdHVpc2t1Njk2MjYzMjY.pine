...
decision_tree_0_CRWD_1Hour_69626326(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)=>
	...
	if( dif_source_BBupper > -113.568 )
		...
		if( BBlower > 33.615 )
			if( BBupper <= 53.4928 )
				if( dif_source_BBupper <= 3.42146 )
					if( dif_source_BBlower <= 4.40445 )
						if( vrsi <= 66.7701 )
							ret := 0.494253
						if( vrsi > 66.7701 )
							ret := -0.368421
					if( dif_source_BBlower > 4.40445 )
						if( dif_source_BBlower <= 8.98324 )
							ret := 0.966292 // buy
						if( dif_source_BBlower > 8.98324 )
							ret := 0.294118
				if( dif_source_BBupper > 3.42146 )
...
float op_operation = decision_tree_0_CRWD_1Hour_69626326(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
