			...
			if( Negative_Money_Flow_Sum > 7.67733e+07 )
				...
				if( Raw_Money_Flow > 1.65458e+07 )
					...
					if( Negative_Money_Flow_Sum > 8.8318e+07 )
						ret := -0.041009
		if( Typical_Price > 126.648 )
			if( Positive_Money_Flow_Sum <= 2.00046e+08 )
				if( rsi1 <= 25.6311 )
					if( d_k <= 6.64285 )
						ret := 0.000000
					if( d_k > 6.64285 )
						ret := 0.571429
				if( rsi1 > 25.6311 )
					if( Typical_Price <= 281.769 )
						ret := -0.751295 // sell
					if( Typical_Price > 281.769 )
						ret := 0.571429
			if( Positive_Money_Flow_Sum > 2.00046e+08 )
				if( smoothD_d <= 68.4977 )
					if( rsi1 <= 35.9937 )
						ret := 0.487805
					if( rsi1 > 35.9937 )
						ret := -0.329114
				if( smoothD_d > 68.4977 )
					if( Positive_Money_Flow_Sum <= 8.47503e+08 )
						ret := 0.433526
					if( Positive_Money_Flow_Sum > 8.47503e+08 )
						ret := -0.833333 // sell
...
float op_operation = decision_tree_0_AAVEUSDT_1Day_cb1424f2(Negative_Money_Flow, MFI_Low, Money_Flow_Ratio, MFI, Raw_Money_Flow, Positive_Money_Flow, Typical_Price, Positive_Money_Flow_Sum, MFI_High, Negative_Money_Flow_Sum, rsi1, smoothK_k, d_k, k, d, smoothD_d)
