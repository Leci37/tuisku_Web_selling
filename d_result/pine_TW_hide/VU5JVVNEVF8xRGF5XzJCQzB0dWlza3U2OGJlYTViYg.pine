			...
			if( ad <= 8.42196e+06 )
				...
				if( bullPower > -0.672427 )
					...
					if( mf > 0.180165 )
						ret := 0.373832
			if( ad > 8.42196e+06 )
				if( bullPower <= 5.50915 )
					if( mf <= -0.171408 )
						ret := 0.000000
					if( mf > -0.171408 )
						ret := 0.894737 // buy
				if( bullPower > 5.50915 )
					if( bullPower <= 8.90543 )
						ret := 0.000000
					if( bullPower > 8.90543 )
						ret := -1.000000 // sell
...
float op_operation = decision_tree_0_UNIUSDT_1Day_68bea5bb(bbp, bullPower, BBPower_Color, bearPower, bbm, ad_mf, mf, ad)
