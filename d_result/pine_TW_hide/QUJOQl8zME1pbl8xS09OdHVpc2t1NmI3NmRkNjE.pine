				...
				if( marron > 131.7 )
					...
					if( pvi_ema > -0.711554 )
						...
						if( pvi > -0.53966 )
							ret := -0.111111
			if( marron_mean > 106.362 )
				if( azul_mean <= 10.0577 )
					if( pvimax <= -0.585212 )
						if( azul_mean <= -13.7034 )
							ret := 0.375000
						if( azul_mean > -13.7034 )
							ret := -0.630137
					if( pvimax > -0.585212 )
						...
						if( nvi_ema > 0.625164 )
							ret := -0.607143
				if( azul_mean > 10.0577 )
					if( verde_mean <= 117.082 )
						if( verde_azul <= 75.3922 )
							ret := 1.000000 // buy
						if( verde_azul > 75.3922 )
							ret := -0.513514
					if( verde_mean > 117.082 )
				...
				if( nvi > 0.377096 )
					if( media <= 28.8656 )
						...
						if( pvi > -0.422115 )
							ret := -0.114047
					if( media > 28.8656 )
						if( marron_mean <= 40.9476 )
							ret := 0.112718
						if( marron_mean > 40.9476 )
							ret := -0.066713
			if( oscp > 56.4034 )
				if( media <= 82.2997 )
					if( azul_mean <= 10.4076 )
						if( tprice <= 166.589 )
							ret := 0.348485
						if( tprice > 166.589 )
							ret := -0.562500
					if( azul_mean > 10.4076 )
						if( verde_mean <= 117.205 )
							ret := 0.285714
						if( verde_mean > 117.205 )
							ret := -0.850000 // sell
				if( media > 82.2997 )
					if( xrsi <= 86.0172 )
						if( marron_mean <= 99.5129 )
							ret := 0.083333
						if( marron_mean > 99.5129 )
							ret := 0.737705 // buy
					if( xrsi > 86.0172 )
...
float op_operation = decision_tree_0_ABNB_30Min_6b76dd61(oscp, media, media_azul, verde_media, azul, tprice, azul_mean, verde, nvim, marron, pvimin, pvi, nvimax, verde_mean, xmf, source, stoc, pvimax, nvi_ema, nvi, xrsi, pvim, marron_mean, nvimin, BollOsc, verde_azul, pvi_ema)
