				...
				if( dif_source_BBlower > -499.447 )
					if( BBupper <= 2346.14 )
						...
						if( BBupper > 1722.17 )
							ret := 0.604278
					if( BBupper > 2346.14 )
						if( dif_source_BBlower <= -103.339 )
							ret := -0.137931
						if( dif_source_BBlower > -103.339 )
							ret := -0.898876 // sell
		if( dif_source_BBupper > 4.42794 )
			if( dif_source_BBlower <= 286.295 )
				if( BBlower <= 660.892 )
					if( BBupper <= 812.576 )
						if( BBupper <= 465.143 )
							ret := 0.009464
				...
				if( BBupper <= 1110.77 )
					if( BBupper <= 758.893 )
						...
						if( BBlower > 436.269 )
							ret := 0.952381 // buy
					if( BBupper > 758.893 )
						if( dif_source_BBlower <= 290.405 )
							ret := 0.000000
						if( dif_source_BBlower > 290.405 )
							ret := -0.851852 // sell
				if( BBupper > 1110.77 )
					if( dif_source_BBlower <= 553.026 )
						if( BBlower <= 733.004 )
							ret := -0.700000 // sell
						if( BBlower > 733.004 )
							ret := 0.866197 // buy
...
float op_operation = decision_tree_0_TSLA_1Hour_34daf8a0(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
