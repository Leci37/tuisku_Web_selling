			...
			if( dif_source_BBlower > 13.588 )
				if( BBupper <= 68.352 )
					...
					if( BBlower > 45.2614 )
						ret := 0.909091 // buy
				if( BBupper > 68.352 )
					if( dif_source_BBupper <= -3.7283 )
						if( dif_source_BBupper <= -52.0069 )
							ret := 0.230668
						if( dif_source_BBupper > -52.0069 )
							ret := 0.078214
					if( dif_source_BBupper > -3.7283 )
						if( dif_source_BBlower <= 214.813 )
							ret := -0.044033
						if( dif_source_BBlower > 214.813 )
							ret := -0.767857 // sell
	if( BBlower > 744.55 )
...
float op_operation = decision_tree_0_TTD_1Hour_c23f4720(dif_source_BBupper, crossover_rsi_bblowerInt, BBupper, vrsi, crossunder_rsi_bbupperInt, dif_source_BBlower, BBlower)
