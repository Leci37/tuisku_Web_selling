			...
			if( Positive_Money_Flow_Sum <= 1.59874e+09 )
				if( bullPower <= 0.18424 )
					...
					if( bbm > 0.448229 )
						ret := 0.793103 // buy
				if( bullPower > 0.18424 )
					if( Negative_Money_Flow_Sum <= 2.22506e+08 )
						ret := -0.666667
					if( Negative_Money_Flow_Sum > 2.22506e+08 )
						ret := 0.269565
			if( Positive_Money_Flow_Sum > 1.59874e+09 )
				if( Money_Flow_Ratio <= 3.45251 )
					if( Raw_Money_Flow <= 1.12352e+08 )
						ret := -1.000000 // sell
					if( Raw_Money_Flow > 1.12352e+08 )
						ret := -0.500000
				if( Money_Flow_Ratio > 3.45251 )
					ret := 1.000000 // buy
		if( Typical_Price > 22.2457 )
			if( Positive_Money_Flow_Sum <= 4.31189e+08 )
				if( Money_Flow_Ratio <= 1.15011 )
					ret := -0.333333
				if( Money_Flow_Ratio > 1.15011 )
					if( Positive_Money_Flow <= 3.77092e+07 )
						ret := 0.967742 // buy
					if( Positive_Money_Flow > 3.77092e+07 )
						ret := 0.285714
			if( Positive_Money_Flow_Sum > 4.31189e+08 )
				if( Negative_Money_Flow_Sum <= 1.43797e+09 )
					if( Negative_Money_Flow_Sum <= 2.94514e+08 )
						ret := -0.644628
					if( Negative_Money_Flow_Sum > 2.94514e+08 )
						ret := -0.316860
				if( Negative_Money_Flow_Sum > 1.43797e+09 )
					if( Money_Flow_Ratio <= 1.6399 )
						ret := 0.750000 // buy
					if( Money_Flow_Ratio > 1.6399 )
						ret := -0.750000 // sell
...
float op_operation = decision_tree_0_DBX_1Day_eeac036f(bearPower, bbm, bbp, bullPower, BBPower_Color, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
