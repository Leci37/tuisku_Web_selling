			...
			if( Negative_Money_Flow_Sum > 2.21655e+09 )
				if( Short_Long_Diff <= -4.00623 )
					...
					if( Short_Long_Diff > -4.26701 )
						ret := -0.500000
				if( Short_Long_Diff > -4.00623 )
					if( Negative_Money_Flow <= 2.63484e+06 )
						ret := -0.014286
					if( Negative_Money_Flow > 2.63484e+06 )
						ret := 0.635359
		if( Negative_Money_Flow_Sum > 2.94797e+09 )
			if( Positive_Money_Flow_Sum <= 1.72606e+09 )
				if( Short_Long_Diff <= -5.76858 )
					ret := 1.000000 // buy
				if( Short_Long_Diff > -5.76858 )
					if( Negative_Money_Flow_Sum <= 4.34596e+09 )
						ret := 0.333333
					if( Negative_Money_Flow_Sum > 4.34596e+09 )
						ret := -0.666667
			if( Positive_Money_Flow_Sum > 1.72606e+09 )
				if( Long_MA <= 54.5391 )
					...
					if( MFI_Low > 31.2328 )
						ret := 0.250000
				if( Long_MA > 54.5391 )
					if( Negative_Money_Flow_Sum <= 4.2404e+09 )
						ret := -0.857143 // sell
					if( Negative_Money_Flow_Sum > 4.2404e+09 )
						ret := 0.409091
...
float op_operation = decision_tree_0_LYFT_1Day_6528f22c(Short_MA, Long_MA, Short_Long_Diff, MA_Cross, Positive_Money_Flow_Sum, Raw_Money_Flow, MFI_Low, Negative_Money_Flow, Negative_Money_Flow_Sum, Positive_Money_Flow, Money_Flow_Ratio, MFI, MFI_High, Typical_Price)
