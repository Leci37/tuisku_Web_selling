			...
			if( val > -4.3e-05 )
				if( ma <= 0.311212 )
					...
					if( rangema > 0.014719 )
						ret := 0.000000
				if( ma > 0.311212 )
					if( avgHighLow <= 0.458625 )
						ret := -0.050847
					if( avgHighLow > 0.458625 )
						ret := 0.586207
		if( priceRange > 0.012408 )
			if( avgHighLow <= 1.14613 )
				if( upperBB <= 0.312403 )
					if( avgHighLow <= 0.273056 )
						ret := 0.071429
					if( avgHighLow > 0.273056 )
						ret := -0.762500 // sell
				if( upperBB > 0.312403 )
...
float op_operation = decision_tree_0_XRPUSDT_1Day_b0b72e1f(rangema, avgHighLow, upperKC, lowerBB, noSqzInt, ma, upperBB, lowerKC, basis, sqzOnInt, priceRange, dev, val, sqzOffInt)
