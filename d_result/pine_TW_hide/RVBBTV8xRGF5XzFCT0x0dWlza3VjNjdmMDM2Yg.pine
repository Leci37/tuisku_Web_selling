			...
			if( vrsi <= 36.5871 )
				if( BBupper <= 724.395 )
					...
					if( BBlower > 416.961 )
						ret := -0.750000 // sell
				if( BBupper > 724.395 )
					if( dif_source_BBupper <= -128.181 )
						ret := -0.900000 // sell
					if( dif_source_BBupper > -128.181 )
						ret := 0.666667
			if( vrsi > 36.5871 )
				if( BBupper <= 734.742 )
					if( dif_source_BBupper <= -274.883 )
						ret := -0.818182 // sell
					if( dif_source_BBupper > -274.883 )
						ret := -1.000000 // sell
				if( BBupper > 734.742 )
...
float op_operation = decision_tree_0_EPAM_1Day_c67f036b(crossunder_rsi_bbupperInt, BBlower, dif_source_BBupper, crossover_rsi_bblowerInt, vrsi, BBupper, dif_source_BBlower)
