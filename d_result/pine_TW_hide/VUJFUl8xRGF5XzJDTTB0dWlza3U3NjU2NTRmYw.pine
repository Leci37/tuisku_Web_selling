			...
			if( mf > -0.128993 )
				if( Positive_Money_Flow_Sum <= 5.06778e+09 )
					...
					if( Raw_Money_Flow > 1.37502e+09 )
						ret := 0.600000
				if( Positive_Money_Flow_Sum > 5.06778e+09 )
					if( Raw_Money_Flow <= 5.83866e+08 )
						ret := -0.489362
					if( Raw_Money_Flow > 5.83866e+08 )
						ret := 0.142395
		if( Positive_Money_Flow_Sum > 8.2307e+09 )
			if( Positive_Money_Flow_Sum <= 1.20289e+10 )
				if( Typical_Price <= 35.2402 )
					if( Raw_Money_Flow <= 8.82163e+08 )
						ret := 0.692308
					if( Raw_Money_Flow > 8.82163e+08 )
						ret := -0.214286
				if( Typical_Price > 35.2402 )
					if( Typical_Price <= 61.5678 )
						ret := -0.537092
					if( Typical_Price > 61.5678 )
						ret := 0.187500
			if( Positive_Money_Flow_Sum > 1.20289e+10 )
				if( mf <= 0.380626 )
					...
					if( ad > 3.42242e+07 )
						ret := 0.833333 // buy
				if( mf > 0.380626 )
					if( Positive_Money_Flow_Sum <= 1.66396e+10 )
						ret := 0.909091 // buy
					if( Positive_Money_Flow_Sum > 1.66396e+10 )
						ret := 0.000000
...
float op_operation = decision_tree_0_UBER_1Day_765654fc(ad_mf, mf, ad, Typical_Price, MFI_High, Negative_Money_Flow, Positive_Money_Flow, Money_Flow_Ratio, MFI, Negative_Money_Flow_Sum, Positive_Money_Flow_Sum, MFI_Low, Raw_Money_Flow)
